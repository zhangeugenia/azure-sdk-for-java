...
public final class DnsResourceReferencesClientImpl implements DnsResourceReferencesClient {
    ...
    public interface DnsResourceReferencesService {
        ...
        Mono<Response<DnsResourceReferenceResultInner>> getByTargetResources(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") DnsResourceReferenceRequest body, @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<DnsResourceReferenceResultInner>>
        getByTargetResourcesWithResponseAsync(DnsResourceReferenceRequest body) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DnsResourceReferenceResultInner>>
        getByTargetResourcesWithResponseAsync(DnsResourceReferenceRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DnsResourceReferenceResultInner> getByTargetResourcesAsync(DnsResourceReferenceRequest body) {
        return getByTargetResourcesWithResponseAsync(body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DnsResourceReferenceResultInner> getByTargetResourcesWithResponse(DnsResourceReferenceRequest body,
        Context context) {
        return getByTargetResourcesWithResponseAsync(body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DnsResourceReferenceResultInner getByTargetResources(DnsResourceReferenceRequest body) {
        return getByTargetResourcesWithResponse(body, Context.NONE).getValue();
    }
}
