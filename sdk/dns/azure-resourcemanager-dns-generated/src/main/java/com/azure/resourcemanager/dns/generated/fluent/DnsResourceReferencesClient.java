...
public interface DnsResourceReferencesClient {
    ...
    Response<DnsResourceReferenceResultInner> getByTargetResourcesWithResponse(DnsResourceReferenceRequest body,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DnsResourceReferenceResultInner getByTargetResources(DnsResourceReferenceRequest body);
}
