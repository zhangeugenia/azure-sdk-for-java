...
public final class DnssecConfigsClientImpl implements DnssecConfigsClient {
    ...
    public interface DnssecConfigsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") DnssecConfigInner resource, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String zoneName,
        DnssecConfigInner resource, String ifMatch, String ifNoneMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, zoneName, ifMatch, ifNoneMatch, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String zoneName,
        DnssecConfigInner resource, String ifMatch, String ifNoneMatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<DnssecConfigInner>, DnssecConfigInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String zoneName, DnssecConfigInner resource, String ifMatch, String ifNoneMatch) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch);
    ...
    private PollerFlux<PollResult<DnssecConfigInner>, DnssecConfigInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String zoneName, DnssecConfigInner resource) {
    ...
    private PollerFlux<PollResult<DnssecConfigInner>, DnssecConfigInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch, context);
        return this.client.<DnssecConfigInner, DnssecConfigInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<DnssecConfigInner>, DnssecConfigInner> beginCreateOrUpdate(String resourceGroupName,
        String zoneName, DnssecConfigInner resource) {
        final String ifMatch = null;
        final String ifNoneMatch = null;
        return this.beginCreateOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch)
            .getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DnssecConfigInner>, DnssecConfigInner> beginCreateOrUpdate(String resourceGroupName,
        String zoneName, DnssecConfigInner resource, String ifMatch, String ifNoneMatch, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch, context)
            .getSyncPoller();
    }
    ...
    private Mono<DnssecConfigInner> createOrUpdateAsync(String resourceGroupName, String zoneName,
        DnssecConfigInner resource, String ifMatch, String ifNoneMatch) {
        return beginCreateOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch).last()
    ...
    private Mono<DnssecConfigInner> createOrUpdateAsync(String resourceGroupName, String zoneName,
        DnssecConfigInner resource, String ifMatch, String ifNoneMatch, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DnssecConfigInner createOrUpdate(String resourceGroupName, String zoneName, DnssecConfigInner resource) {
        final String ifMatch = null;
        final String ifNoneMatch = null;
        return createOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch).block();
    }
    ...
    public DnssecConfigInner createOrUpdate(String resourceGroupName, String zoneName, DnssecConfigInner resource,
        ...
        return createOrUpdateAsync(resourceGroupName, zoneName, resource, ifMatch, ifNoneMatch, context).block();
    }
