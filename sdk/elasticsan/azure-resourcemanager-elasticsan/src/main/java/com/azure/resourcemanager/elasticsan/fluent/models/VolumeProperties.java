...
public final class VolumeProperties implements JsonSerializable<VolumeProperties> {
    ...
    /**
     * Set the storageTarget property: Storage target information.
     * 
     * @param storageTarget the storageTarget value to set.
     * @return the VolumeProperties object itself.
     */
    public VolumeProperties withStorageTarget(IscsiTargetInfo storageTarget) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("storageTarget", this.storageTarget);
