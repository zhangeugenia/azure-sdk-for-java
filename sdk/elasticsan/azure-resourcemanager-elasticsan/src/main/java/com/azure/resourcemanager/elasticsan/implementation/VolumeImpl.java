...
public final class VolumeImpl implements Volume, Volume.Definition, Volume.Update {
    ...
    public Volume restoreVolume() {
        return serviceManager.volumes().restoreVolume(resourceGroupName, elasticSanName, volumeGroupName, volumeName);
    }

    public Volume restoreVolume(Context context) {
    ...
    public VolumeImpl withStorageTarget(IscsiTargetInfo storageTarget) {
        this.innerModel().withStorageTarget(storageTarget);
        return this;
    }
