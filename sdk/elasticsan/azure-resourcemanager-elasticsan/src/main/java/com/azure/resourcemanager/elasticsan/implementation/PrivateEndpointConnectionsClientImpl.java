...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(ElasticSanClientImpl client) {
    ...
    /**
     * The interface defining all the services for ElasticSanClientPrivateEndpointConnections to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ElasticSanClientPriv")
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String elasticSanName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, elasticSanName, privateEndpointConnectionName, accept,
            Context.NONE);
    }
