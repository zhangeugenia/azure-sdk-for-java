...
import com.azure.resourcemanager.elasticsan.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ElasticSanClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ElasticSanClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ElasticSanClientOper")
