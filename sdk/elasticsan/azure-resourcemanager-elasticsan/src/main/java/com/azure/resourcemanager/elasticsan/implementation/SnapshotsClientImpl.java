...
public final class SnapshotsClientImpl implements SnapshotsClient {
     ...
     */
    SnapshotsClientImpl(ElasticSanClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ElasticSanClientSnapshots to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ElasticSanClientSnap")
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String elasticSanName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, elasticSanName, volumeGroupName, snapshotName, accept,
            Context.NONE);
    }
