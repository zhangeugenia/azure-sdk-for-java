...
/**
 * Initializes a new instance of the ElasticSanClientImpl type.
 */
@ServiceClient(builder = ElasticSanClientBuilder.class)
public final class ElasticSanClientImpl implements ElasticSanClient {
    /**
     * Service host.
     */
    ...
    /**
     * The SkusOperationGroupsClient object to access its operations.
     */
    private final SkusOperationGroupsClient skusOperationGroups;
     ...
     */
    public SkusOperationGroupsClient getSkusOperationGroups() {
        return this.skusOperationGroups;
    }

    /**
     * Initializes an instance of ElasticSanClient client.
     * 
     ...
     */
    ElasticSanClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
        ...
        this.skusOperationGroups = new SkusOperationGroupsClientImpl(this);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ElasticSanClientImpl.class);
}
