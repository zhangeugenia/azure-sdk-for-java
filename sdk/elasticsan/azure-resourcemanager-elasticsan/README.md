...
This package contains Microsoft Azure SDK for ElasticSan Management SDK. (missing-service-description) Add service description. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
