 ...
 */
@Immutable
public final class Phrase implements JsonSerializable<Phrase> {
    /*
    ...
    /**
     * Creates an instance of Phrase class.
     * 
     ...
     */
    @Generated
    private Phrase(int offsetMilliseconds, int durationMilliseconds, String text, double confidence) {
    ...
    /**
     * Reads an instance of Phrase from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Phrase if the JsonReader was pointing to an instance of it, or null if it was pointing to
     * JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the Phrase.
     */
    @Generated
    public static Phrase fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("offsetMilliseconds".equals(fieldName)) {
                    ...
                    words = reader.readArray(reader1 -> Word.fromJson(reader1));
            ...
            Phrase deserializedPhrase = new Phrase(offsetMilliseconds, durationMilliseconds, text, confidence);
            deserializedPhrase.channel = channel;
            deserializedPhrase.speaker = speaker;
            deserializedPhrase.words = words;
            deserializedPhrase.locale = locale;
