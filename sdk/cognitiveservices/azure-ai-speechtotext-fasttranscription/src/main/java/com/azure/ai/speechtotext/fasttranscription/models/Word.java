 ...
 */
@Immutable
public final class Word implements JsonSerializable<Word> {
    /*
    ...
    /**
     * Creates an instance of Word class.
     * 
     ...
     */
    @Generated
    private Word(String text, int offsetMilliseconds, int durationMilliseconds) {
        this.text = text;
     ...
     * @return An instance of Word if the JsonReader was pointing to an instance of it, or null if it was pointing to
     * JSON null.
    ...
    public static Word fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new Word(text, offsetMilliseconds, durationMilliseconds);
        });
    }
}
