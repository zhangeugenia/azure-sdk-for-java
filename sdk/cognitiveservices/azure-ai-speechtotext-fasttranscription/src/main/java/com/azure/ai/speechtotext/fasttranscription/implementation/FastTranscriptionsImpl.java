...
/**
 * An instance of this class provides access to all the operations defined in FastTranscriptions.
 */
public final class FastTranscriptionsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final FastTranscriptionsService service;
    ...
    /**
     * Initializes an instance of FastTranscriptionsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    FastTranscriptionsImpl(SpeechToTextClientImpl client) {
        this.service = RestProxy.create(FastTranscriptionsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for SpeechToTextClientFastTranscriptions to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}/speechtotext")
    @ServiceInterface(name = "SpeechToTextClientFa")
    public interface FastTranscriptionsService {
    ...
    public Mono<Response<BinaryData>> transcribeWithResponseAsync(BinaryData transcribeRequest,
        ...
        return FluxUtil.withContext(context -> service.transcribe(this.client.getEndpoint(), contentType,
            this.client.getServiceVersion().getVersion(), accept, transcribeRequest, requestOptions, context));
    }
    ...
    public Response<BinaryData> transcribeWithResponse(BinaryData transcribeRequest, RequestOptions requestOptions) {
        final String contentType = "multipart/form-data";
        final String accept = "application/json";
        return service.transcribeSync(this.client.getEndpoint(), contentType,
            this.client.getServiceVersion().getVersion(), accept, transcribeRequest, requestOptions, Context.NONE);
    }
}
