...
public final class FastTranscriptionAsyncClient {
    @Generated
    private final FastTranscriptionClientsImpl serviceClient;

    /**
     * Initializes an instance of FastTranscriptionAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    FastTranscriptionAsyncClient(FastTranscriptionClientsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TranscribeResult> transcribe(AudioFileDetails audio, TranscribeConfig definition) {
