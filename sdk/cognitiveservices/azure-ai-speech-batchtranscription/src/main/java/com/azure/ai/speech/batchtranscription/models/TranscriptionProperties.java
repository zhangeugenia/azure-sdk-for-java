...
public final class TranscriptionProperties implements JsonSerializable<TranscriptionProperties> {
    ...
    public static TranscriptionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            LanguageIdentificationProperties languageIdentificationProperties = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("timeToLiveHours".equals(fieldName)) {
                    ...
                    destinationContainer = reader.getString();
                    ...
                    languageIdentificationProperties = LanguageIdentificationProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedTranscriptionProperties.destinationContainer = destinationContainer;
            ...
            deserializedTranscriptionProperties.languageIdentificationProperties = languageIdentificationProperties;
