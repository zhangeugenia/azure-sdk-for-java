...
public final class TranscriptionJob implements JsonSerializable<TranscriptionJob> {
    ...
    /**
     * Get the sourceContainer property: A URL for an Azure blob container that contains the audio files. A container is
     * allowed to have a maximum size of 5GB and a maximum number of 10000 blobs.
     * The maximum size for a blob is 2.5GB.
     * Container SAS should contain 'r' (read) and 'l' (list) permissions.
     * This property will not be returned in a response.
     * 
    ...
    /**
     * Set the sourceContainer property: A URL for an Azure blob container that contains the audio files. A container is
     * allowed to have a maximum size of 5GB and a maximum number of 10000 blobs.
     * The maximum size for a blob is 2.5GB.
     * Container SAS should contain 'r' (read) and 'l' (list) permissions.
     * This property will not be returned in a response.
     ...
     */
    @Generated
    public TranscriptionJob setSourceContainer(String sourceContainer) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("contentContainerUrl", this.sourceContainer);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    ...
                    sourceContainer = reader.getString();
            ...
            deserializedTranscriptionJob.sourceContainer = sourceContainer;
