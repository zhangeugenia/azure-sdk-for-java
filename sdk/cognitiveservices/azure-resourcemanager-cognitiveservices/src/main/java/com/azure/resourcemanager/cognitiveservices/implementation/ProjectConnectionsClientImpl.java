...
public final class ProjectConnectionsClientImpl implements ProjectConnectionsClient {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String accountName, String projectName,
        ...
        return deleteWithResponseAsync(resourceGroupName, accountName, projectName, connectionName, context).block();
    }
    ...
    private Mono<Response<ConnectionPropertiesV2BasicResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName,
            projectName, connectionName, this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> getWithResponse(String resourceGroupName,
        String accountName, String projectName, String connectionName, Context context) {
        return getWithResponseAsync(resourceGroupName, accountName, projectName, connectionName, context).block();
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> updateWithResponse(String resourceGroupName,
        String accountName, String projectName, String connectionName, ConnectionUpdateContent connection,
        Context context) {
        return updateWithResponseAsync(resourceGroupName, accountName, projectName, connectionName, connection, context)
            .block();
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> createWithResponse(String resourceGroupName,
        String accountName, String projectName, String connectionName,
        ConnectionPropertiesV2BasicResourceInner connection, Context context) {
        return createWithResponseAsync(resourceGroupName, accountName, projectName, connectionName, connection, context)
            .block();
    }
    ...
    private Mono<PagedResponse<ConnectionPropertiesV2BasicResourceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName,
                projectName, target, category, this.client.getApiVersion(), includeAll, accept, context)
    ...
    private PagedFlux<ConnectionPropertiesV2BasicResourceInner> listAsync(String resourceGroupName, String accountName,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, accountName, projectName, target, category,
            includeAll, context), nextLink -> listNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<ConnectionPropertiesV2BasicResourceInner> list(String resourceGroupName, String accountName,
        ...
        return new PagedIterable<>(
            listAsync(resourceGroupName, accountName, projectName, target, category, includeAll));
    }
    ...
    public PagedIterable<ConnectionPropertiesV2BasicResourceInner> list(String resourceGroupName, String accountName,
        String projectName, String target, String category, Boolean includeAll, Context context) {
        return new PagedIterable<>(
            listAsync(resourceGroupName, accountName, projectName, target, category, includeAll, context));
    }
