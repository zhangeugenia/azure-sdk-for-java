...
public final class ProjectCapabilityHostsClientImpl implements ProjectCapabilityHostsClient {
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String accountName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, accountName, projectName, capabilityHostname, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String accountName,
        String projectName, String capabilityHostname) {
        return this.beginDeleteAsync(resourceGroupName, accountName, projectName, capabilityHostname).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String accountName,
        String projectName, String capabilityHostname, Context context) {
        return this.beginDeleteAsync(resourceGroupName, accountName, projectName, capabilityHostname, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String projectName,
        ...
        return beginDeleteAsync(resourceGroupName, accountName, projectName, capabilityHostname, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String accountName, String projectName, String capabilityHostname) {
        deleteAsync(resourceGroupName, accountName, projectName, capabilityHostname).block();
    }
    ...
    public void delete(String resourceGroupName, String accountName, String projectName, String capabilityHostname,
        Context context) {
        deleteAsync(resourceGroupName, accountName, projectName, capabilityHostname, context).block();
    }
    ...
    private Mono<Response<CapabilityHostInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName,
            projectName, capabilityHostname, this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<CapabilityHostInner> getWithResponse(String resourceGroupName, String accountName,
        String projectName, String capabilityHostname, Context context) {
        return getWithResponseAsync(resourceGroupName, accountName, projectName, capabilityHostname, context).block();
    }
    ...
    private PollerFlux<PollResult<CapabilityHostInner>, CapabilityHostInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, accountName,
            projectName, capabilityHostname, body, context);
        return this.client.<CapabilityHostInner, CapabilityHostInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<CapabilityHostInner>, CapabilityHostInner> beginCreateOrUpdate(
        String resourceGroupName, String accountName, String projectName, String capabilityHostname,
        CapabilityHostInner body) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, accountName, projectName, capabilityHostname, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CapabilityHostInner>, CapabilityHostInner> beginCreateOrUpdate(
        ...
        CapabilityHostInner body, Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, accountName, projectName, capabilityHostname, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<CapabilityHostInner> createOrUpdateAsync(String resourceGroupName, String accountName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, accountName, projectName, capabilityHostname, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public CapabilityHostInner createOrUpdate(String resourceGroupName, String accountName, String projectName,
        ...
        return createOrUpdateAsync(resourceGroupName, accountName, projectName, capabilityHostname, body).block();
    }
    ...
    public CapabilityHostInner createOrUpdate(String resourceGroupName, String accountName, String projectName,
        ...
        return createOrUpdateAsync(resourceGroupName, accountName, projectName, capabilityHostname, body, context)
            .block();
    }
}
