...
public final class AccountConnectionsClientImpl implements AccountConnectionsClient {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String accountName, String connectionName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, accountName, connectionName, context).block();
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> getWithResponse(String resourceGroupName,
        String accountName, String connectionName, Context context) {
        return getWithResponseAsync(resourceGroupName, accountName, connectionName, context).block();
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> updateWithResponse(String resourceGroupName,
        String accountName, String connectionName, ConnectionUpdateContent connection, Context context) {
        return updateWithResponseAsync(resourceGroupName, accountName, connectionName, connection, context).block();
    }
    ...
    public Response<ConnectionPropertiesV2BasicResourceInner> createWithResponse(String resourceGroupName,
        String accountName, String connectionName, ConnectionPropertiesV2BasicResourceInner connection,
        Context context) {
        return createWithResponseAsync(resourceGroupName, accountName, connectionName, connection, context).block();
    }
    ...
    private Mono<PagedResponse<ConnectionPropertiesV2BasicResourceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName, target,
    ...
    private PagedFlux<ConnectionPropertiesV2BasicResourceInner> listAsync(String resourceGroupName, String accountName,
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, accountName, target, category, includeAll, context),
    ...
    public PagedIterable<ConnectionPropertiesV2BasicResourceInner> list(String resourceGroupName, String accountName) {
        ...
        final String category = null;
        final Boolean includeAll = null;
        return new PagedIterable<>(listAsync(resourceGroupName, accountName, target, category, includeAll));
    }
    ...
    public PagedIterable<ConnectionPropertiesV2BasicResourceInner> list(String resourceGroupName, String accountName,
        String target, String category, Boolean includeAll, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, accountName, target, category, includeAll, context));
    }
