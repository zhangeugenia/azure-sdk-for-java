...
public final class EncryptionScopesClientImpl implements EncryptionScopesClient {
    ...
    public interface EncryptionScopesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EncryptionScopeInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EncryptionScopeInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EncryptionScopeInner> createOrUpdateAsync(
        String resourceGroupName,
        String accountName,
        String encryptionScopeName,
        EncryptionScopeInner encryptionScope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EncryptionScopeInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String accountName,
        String encryptionScopeName,
        EncryptionScopeInner encryptionScope,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, accountName, encryptionScopeName, encryptionScope, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EncryptionScopeInner createOrUpdate(
        String resourceGroupName,
        String accountName,
        String encryptionScopeName,
        EncryptionScopeInner encryptionScope) {
        return createOrUpdateWithResponse(
                resourceGroupName, accountName, encryptionScopeName, encryptionScope, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String encryptionScopeName) {
        return beginDeleteAsync(resourceGroupName, accountName, encryptionScopeName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String accountName, String encryptionScopeName, Context context) {
        return beginDeleteAsync(resourceGroupName, accountName, encryptionScopeName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
