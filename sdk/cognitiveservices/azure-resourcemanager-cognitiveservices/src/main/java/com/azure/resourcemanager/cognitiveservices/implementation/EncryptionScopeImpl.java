...
public final class EncryptionScopeImpl implements EncryptionScope, EncryptionScope.Definition, EncryptionScope.Update {
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, accountName, encryptionScopeName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public EncryptionScope create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getEncryptionScopes()
                .createOrUpdateWithResponse(
                    resourceGroupName, accountName, encryptionScopeName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    EncryptionScopeImpl(
        EncryptionScopeInner innerObject,
