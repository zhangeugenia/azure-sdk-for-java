...
public final class DeploymentsClientImpl implements DeploymentsClient {
    ...
    public interface DeploymentsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("deploymentName") String deploymentName,
            @BodyParam("application/json") PatchResourceTagsAndSku deployment,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DeploymentSkuListResult>> listSkus(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DeploymentInner>, DeploymentInner> beginUpdateAsync(
        String resourceGroupName, String accountName, String deploymentName, PatchResourceTagsAndSku deployment) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DeploymentInner>, DeploymentInner> beginUpdate(
        String resourceGroupName, String accountName, String deploymentName, PatchResourceTagsAndSku deployment) {
    ...
    public SyncPoller<PollResult<DeploymentInner>, DeploymentInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, accountName, deploymentName, deployment, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeploymentInner> updateAsync(
        String resourceGroupName, String accountName, String deploymentName, PatchResourceTagsAndSku deployment) {
        return beginUpdateAsync(resourceGroupName, accountName, deploymentName, deployment)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<DeploymentInner> updateAsync(
        ...
        PatchResourceTagsAndSku deployment,
        Context context) {
        return beginUpdateAsync(resourceGroupName, accountName, deploymentName, deployment, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PagedFlux<SkuResourceInner> listSkusAsync(
        String resourceGroupName, String accountName, String deploymentName) {
        return new PagedFlux<>(
            () -> listSkusSinglePageAsync(resourceGroupName, accountName, deploymentName),
    ...
    private PagedFlux<SkuResourceInner> listSkusAsync(
        String resourceGroupName, String accountName, String deploymentName, Context context) {
        return new PagedFlux<>(
            () -> listSkusSinglePageAsync(resourceGroupName, accountName, deploymentName, context),
