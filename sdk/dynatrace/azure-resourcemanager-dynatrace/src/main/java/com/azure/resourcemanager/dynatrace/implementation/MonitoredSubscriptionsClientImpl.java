...
import com.azure.resourcemanager.dynatrace.models.MonitoredSubscriptionPropertiesList;
...
public final class MonitoredSubscriptionsClientImpl implements MonitoredSubscriptionsClient {
     ...
     */
    MonitoredSubscriptionsClientImpl(DynatraceObservabilityImpl client) {
    ...
    /**
     * The interface defining all the services for DynatraceObservabilityMonitoredSubscriptions to be used by the proxy
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String monitorName, MonitoredSubscriptionPropertiesInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<MonitoredSubscriptionPropertiesInner>, MonitoredSubscriptionPropertiesInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, monitorName, body, context);
        return this.client.<MonitoredSubscriptionPropertiesInner, MonitoredSubscriptionPropertiesInner>getLroResult(
            mono, this.client.getHttpPipeline(), MonitoredSubscriptionPropertiesInner.class,
    ...
    public SyncPoller<PollResult<MonitoredSubscriptionPropertiesInner>, MonitoredSubscriptionPropertiesInner>
        ...
        final MonitoredSubscriptionPropertiesInner body = null;
        return this.beginCreateOrUpdateAsync(resourceGroupName, monitorName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<MonitoredSubscriptionPropertiesInner>, MonitoredSubscriptionPropertiesInner>
        beginCreateOrUpdate(String resourceGroupName, String monitorName, MonitoredSubscriptionPropertiesInner body,
            Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, monitorName, body, context).getSyncPoller();
    }
    ...
    private Mono<MonitoredSubscriptionPropertiesInner> createOrUpdateAsync(String resourceGroupName, String monitorName,
        MonitoredSubscriptionPropertiesInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, monitorName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public MonitoredSubscriptionPropertiesInner createOrUpdate(String resourceGroupName, String monitorName,
        MonitoredSubscriptionPropertiesInner body, Context context) {
        return createOrUpdateAsync(resourceGroupName, monitorName, body, context).block();
    }
