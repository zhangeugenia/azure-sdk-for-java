...
public final class CreateResourceSupportedProperties implements JsonSerializable<CreateResourceSupportedProperties> {
    ...
    /*
     * Indicates if selected subscription supports Dynatrace resource creation, if not it is already being monitored for
    ...
    /**
     * Get the creationSupported property: Indicates if selected subscription supports Dynatrace resource creation, if
