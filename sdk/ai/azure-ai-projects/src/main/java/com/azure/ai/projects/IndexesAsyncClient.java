...
public final class IndexesAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createOrUpdateWithResponse(String name, String version,
        BinaryData pendingUploadRequest, RequestOptions requestOptions) {
        return this.serviceClient.createOrUpdateWithResponseAsync(name, version, pendingUploadRequest, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Index> createOrUpdate(String name, String version, Index pendingUploadRequest) {
