...
public final class OpenAIPageableListOfAgentThread implements JsonSerializable<OpenAIPageableListOfAgentThread> {
     ...
     */
    @Generated
    private final List<AgentThread> data;
     ...
     */
    @Generated
    private OpenAIPageableListOfAgentThread(List<AgentThread> data, String firstId, String lastId, boolean hasMore) {
        this.data = data;
     ...
     */
    @Generated
    public List<AgentThread> getData() {
        return this.data;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> AgentThread.fromJson(reader1));
