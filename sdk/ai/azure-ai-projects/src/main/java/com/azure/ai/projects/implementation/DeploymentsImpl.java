...
public final class DeploymentsImpl {
     ...
     */
    DeploymentsImpl(AIProjectClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AIProjectClientDeployments to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
