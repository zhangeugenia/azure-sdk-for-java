...
public final class StoragePoolsClientImpl implements StoragePoolsClient {
     ...
     */
    StoragePoolsClientImpl(PureStorageBlockManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PureStorageBlockManagementClientStoragePools to be used by the proxy
