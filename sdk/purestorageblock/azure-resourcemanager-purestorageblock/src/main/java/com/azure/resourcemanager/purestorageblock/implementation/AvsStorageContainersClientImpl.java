...
public final class AvsStorageContainersClientImpl implements AvsStorageContainersClient {
     ...
     */
    AvsStorageContainersClientImpl(PureStorageBlockManagementClientImpl client) {
    ...
    /**
     * The interface defining all the services for PureStorageBlockManagementClientAvsStorageContainers to be used by
