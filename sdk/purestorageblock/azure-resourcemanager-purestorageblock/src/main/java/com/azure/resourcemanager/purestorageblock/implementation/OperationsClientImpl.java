...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(PureStorageBlockManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PureStorageBlockManagementClientOperations to be used by the proxy
