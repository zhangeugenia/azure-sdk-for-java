...
public final class ReservationsClientImpl implements ReservationsClient {
     ...
     */
    ReservationsClientImpl(PureStorageBlockManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PureStorageBlockManagementClientReservations to be used by the proxy
