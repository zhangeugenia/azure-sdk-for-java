...
public final class OperationsClientImpl implements OperationsClient {
     ...
     * @return represents a paginated list of operation results along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a paginated list of operation results as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a paginated list of operation results along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
