...
public final class TextTranslationAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> translate2WithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.translate2WithResponseAsync(body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<TranslatedTextItem>> translate2(List<TranslateBodyDetails> body, String clientTraceId) {
        // Generated convenience method for translate2WithResponse
        RequestOptions requestOptions = new RequestOptions();
        if (clientTraceId != null) {
            requestOptions.setHeader(HttpHeaderName.fromString("X-ClientTraceId"), clientTraceId);
        }
        return translate2WithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<TranslatedTextItem>> translate2(List<TranslateBodyDetails> body) {
        // Generated convenience method for translate2WithResponse
        RequestOptions requestOptions = new RequestOptions();
        return translate2WithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_TRANSLATED_TEXT_ITEM));
