...
public final class CustomDomainsClientImpl implements CustomDomainsClient {
    ...
    public interface CustomDomainsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CustomDomainListResult> listByEndpointSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CustomDomainInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("customDomainName") String customDomainName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> disableCustomHttpsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("customDomainName") String customDomainName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> enableCustomHttpsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("customDomainName") String customDomainName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CustomDomainHttpsParameters customDomainHttpsParameters,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CustomDomainListResult> listByEndpointNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list custom domains along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CustomDomainInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        String endpointName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<CustomDomainListResult> res
    ...
    private PagedResponse<CustomDomainInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        Response<CustomDomainListResult> res = service.listByEndpointSync(this.client.getEndpoint(), resourceGroupName,
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        return service.createSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            customDomainName, this.client.getSubscriptionId(), this.client.getApiVersion(), customDomainProperties,
            accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CustomDomainInner>, CustomDomainInner> beginCreate(String resourceGroupName,
        String profileName, String endpointName, String customDomainName,
        CustomDomainParameters customDomainProperties) {
        Response<BinaryData> response = createWithResponse(resourceGroupName, profileName, endpointName,
            customDomainName, customDomainProperties);
    ...
    public CustomDomainInner create(String resourceGroupName, String profileName, String endpointName,
        String customDomainName, CustomDomainParameters customDomainProperties) {
        return beginCreate(resourceGroupName, profileName, endpointName, customDomainName, customDomainProperties)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<CustomDomainInner>, CustomDomainInner> beginDelete(String resourceGroupName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, endpointName, customDomainName);
        return this.client.<CustomDomainInner, CustomDomainInner>getLroResult(response, CustomDomainInner.class,
            CustomDomainInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CustomDomainInner>, CustomDomainInner> beginDelete(String resourceGroupName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, endpointName, customDomainName, context);
        return this.client.<CustomDomainInner, CustomDomainInner>getLroResult(response, CustomDomainInner.class,
            CustomDomainInner.class, context);
    }
    ...
    public CustomDomainInner delete(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        return beginDelete(resourceGroupName, profileName, endpointName, customDomainName).getFinalResult();
    }
    ...
    public CustomDomainInner delete(String resourceGroupName, String profileName, String endpointName,
        String customDomainName, Context context) {
        return beginDelete(resourceGroupName, profileName, endpointName, customDomainName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> disableCustomHttpsWithResponse(String resourceGroupName, String profileName,
        String endpointName, String customDomainName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.disableCustomHttpsSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            customDomainName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CustomDomainInner>, CustomDomainInner> beginDisableCustomHttps(
        String resourceGroupName, String profileName, String endpointName, String customDomainName) {
        Response<BinaryData> response
            = disableCustomHttpsWithResponse(resourceGroupName, profileName, endpointName, customDomainName);
        return this.client.<CustomDomainInner, CustomDomainInner>getLroResult(response, CustomDomainInner.class,
            CustomDomainInner.class, Context.NONE);
    }
    ...
    public CustomDomainInner disableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        return beginDisableCustomHttps(resourceGroupName, profileName, endpointName, customDomainName).getFinalResult();
    }
    ...
    public CustomDomainInner disableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName, Context context) {
        return beginDisableCustomHttps(resourceGroupName, profileName, endpointName, customDomainName, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> enableCustomHttpsWithResponse(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        return service.enableCustomHttpsSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
    ...
    public SyncPoller<PollResult<CustomDomainInner>, CustomDomainInner> beginEnableCustomHttps(String resourceGroupName,
        String profileName, String endpointName, String customDomainName,
        CustomDomainHttpsParameters customDomainHttpsParameters) {
        Response<BinaryData> response = enableCustomHttpsWithResponse(resourceGroupName, profileName, endpointName,
            customDomainName, customDomainHttpsParameters);
        return this.client.<CustomDomainInner, CustomDomainInner>getLroResult(response, CustomDomainInner.class,
            CustomDomainInner.class, Context.NONE);
    }
    ...
    public CustomDomainInner enableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        final CustomDomainHttpsParameters customDomainHttpsParameters = null;
        return beginEnableCustomHttps(resourceGroupName, profileName, endpointName, customDomainName,
            customDomainHttpsParameters).getFinalResult();
    }
    ...
    public CustomDomainInner enableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        ...
        return beginEnableCustomHttps(resourceGroupName, profileName, endpointName, customDomainName,
            customDomainHttpsParameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CustomDomainInner> listByEndpointNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CustomDomainInner> listByEndpointNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CustomDomainsClientImpl.class);
}
