...
public final class ProfilesClientImpl implements ProfilesClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> cdnCanMigrateToAfdWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.cdnCanMigrateToAfd(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> cdnMigrateToAfdWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.cdnMigrateToAfd(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            profileName, this.client.getApiVersion(), migrationParameters, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> migrationAbortWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.migrationAbort(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            profileName, this.client.getApiVersion(), accept, context);
    }
