...
public final class OriginImpl implements Origin, Origin.Definition, Origin.Update {
    ...
    public Origin apply() {
        this.innerObject = serviceManager.serviceClient()
            .getOrigins()
            .update(resourceGroupName, profileName, endpointName, originName, updateOriginUpdateProperties,
                Context.NONE);
        return this;
    }
    ...
    public Origin apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getOrigins()
            .update(resourceGroupName, profileName, endpointName, originName, updateOriginUpdateProperties, context);
        return this;
    }
