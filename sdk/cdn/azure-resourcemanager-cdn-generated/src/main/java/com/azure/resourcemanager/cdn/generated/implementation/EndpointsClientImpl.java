...
public final class EndpointsClientImpl implements EndpointsClient {
    ...
    public interface EndpointsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EndpointListResult> listByProfileSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EndpointInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> loadContentSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") LoadParameters contentFilePaths, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EndpointListResult> listByProfileNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EndpointInner> listByProfileSinglePage(String resourceGroupName, String profileName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<EndpointListResult> res = service.listByProfileSync(this.client.getEndpoint(), resourceGroupName,
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return cDN endpoint is the entity within a CDN profile containing configuration information such as origin,
     * protocol, content caching and delivery behavior along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> startWithResponse(String resourceGroupName, String profileName, String endpointName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return service.startSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<EndpointInner>, EndpointInner> beginStart(String resourceGroupName, String profileName,
        String endpointName) {
        Response<BinaryData> response = startWithResponse(resourceGroupName, profileName, endpointName);
        return this.client.<EndpointInner, EndpointInner>getLroResult(response, EndpointInner.class,
            EndpointInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<EndpointInner>, EndpointInner> beginStart(String resourceGroupName, String profileName,
        String endpointName, Context context) {
        Response<BinaryData> response = startWithResponse(resourceGroupName, profileName, endpointName, context);
        return this.client.<EndpointInner, EndpointInner>getLroResult(response, EndpointInner.class,
            EndpointInner.class, context);
    }
    ...
    public EndpointInner start(String resourceGroupName, String profileName, String endpointName) {
        return beginStart(resourceGroupName, profileName, endpointName).getFinalResult();
    }
    ...
    public EndpointInner start(String resourceGroupName, String profileName, String endpointName, Context context) {
        return beginStart(resourceGroupName, profileName, endpointName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> stopWithResponse(String resourceGroupName, String profileName, String endpointName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return service.stopSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<EndpointInner>, EndpointInner> beginStop(String resourceGroupName, String profileName,
        String endpointName) {
        Response<BinaryData> response = stopWithResponse(resourceGroupName, profileName, endpointName);
        return this.client.<EndpointInner, EndpointInner>getLroResult(response, EndpointInner.class,
            EndpointInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<EndpointInner>, EndpointInner> beginStop(String resourceGroupName, String profileName,
        String endpointName, Context context) {
        Response<BinaryData> response = stopWithResponse(resourceGroupName, profileName, endpointName, context);
        return this.client.<EndpointInner, EndpointInner>getLroResult(response, EndpointInner.class,
            EndpointInner.class, context);
    }
    ...
    public EndpointInner stop(String resourceGroupName, String profileName, String endpointName) {
        return beginStop(resourceGroupName, profileName, endpointName).getFinalResult();
    }
    ...
    public EndpointInner stop(String resourceGroupName, String profileName, String endpointName, Context context) {
        return beginStop(resourceGroupName, profileName, endpointName, context).getFinalResult();
    }
    ...
    private Response<BinaryData> purgeContentWithResponse(String resourceGroupName, String profileName,
        ...
        if (contentFilePaths == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter contentFilePaths is required and cannot be null."));
        } else {
            contentFilePaths.validate();
        }
        final String accept = "application/json";
        return service.purgeContentSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), contentFilePaths, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeContent(String resourceGroupName, String profileName,
        String endpointName, PurgeParameters contentFilePaths) {
        Response<BinaryData> response
            = purgeContentWithResponse(resourceGroupName, profileName, endpointName, contentFilePaths);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeContent(String resourceGroupName, String profileName,
        String endpointName, PurgeParameters contentFilePaths, Context context) {
        Response<BinaryData> response
            = purgeContentWithResponse(resourceGroupName, profileName, endpointName, contentFilePaths, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void purgeContent(String resourceGroupName, String profileName, String endpointName,
        PurgeParameters contentFilePaths) {
        beginPurgeContent(resourceGroupName, profileName, endpointName, contentFilePaths).getFinalResult();
    }
    ...
    public void purgeContent(String resourceGroupName, String profileName, String endpointName,
        ...
        beginPurgeContent(resourceGroupName, profileName, endpointName, contentFilePaths, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> loadContentWithResponse(String resourceGroupName, String profileName,
        String endpointName, LoadParameters contentFilePaths) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.loadContentSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), contentFilePaths, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginLoadContent(String resourceGroupName, String profileName,
        String endpointName, LoadParameters contentFilePaths) {
        Response<BinaryData> response
            = loadContentWithResponse(resourceGroupName, profileName, endpointName, contentFilePaths);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginLoadContent(String resourceGroupName, String profileName,
        String endpointName, LoadParameters contentFilePaths, Context context) {
        Response<BinaryData> response
            = loadContentWithResponse(resourceGroupName, profileName, endpointName, contentFilePaths, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void loadContent(String resourceGroupName, String profileName, String endpointName,
        LoadParameters contentFilePaths) {
        beginLoadContent(resourceGroupName, profileName, endpointName, contentFilePaths).getFinalResult();
    }
    ...
    public void loadContent(String resourceGroupName, String profileName, String endpointName,
        ...
        beginLoadContent(resourceGroupName, profileName, endpointName, contentFilePaths, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EndpointInner> listByProfileNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EndpointInner> listByProfileNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
