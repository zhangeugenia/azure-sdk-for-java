...
public final class PoliciesClientImpl implements PoliciesClient {
    ...
    public interface PoliciesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CdnWebApplicationFirewallPolicyList> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CdnWebApplicationFirewallPolicyInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("policyName") String policyName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CdnWebApplicationFirewallPolicyList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return defines a list of WebApplicationFirewallPolicies for Azure CDN along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CdnWebApplicationFirewallPolicyInner>
        ...
        final String accept = "application/json";
        Response<CdnWebApplicationFirewallPolicyList> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CdnWebApplicationFirewallPolicyInner> listByResourceGroupSinglePage(String resourceGroupName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public Response<CdnWebApplicationFirewallPolicyInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, policyName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String policyName,
        ...
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, policyName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), cdnWebApplicationFirewallPolicy, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CdnWebApplicationFirewallPolicyInner>, CdnWebApplicationFirewallPolicyInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, policyName, cdnWebApplicationFirewallPolicy);
        return this.client.<CdnWebApplicationFirewallPolicyInner, CdnWebApplicationFirewallPolicyInner>getLroResult(
            response, CdnWebApplicationFirewallPolicyInner.class, CdnWebApplicationFirewallPolicyInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CdnWebApplicationFirewallPolicyInner>, CdnWebApplicationFirewallPolicyInner>
        beginCreateOrUpdate(String resourceGroupName, String policyName,
            CdnWebApplicationFirewallPolicyInner cdnWebApplicationFirewallPolicy, Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, policyName, cdnWebApplicationFirewallPolicy, context);
        return this.client.<CdnWebApplicationFirewallPolicyInner, CdnWebApplicationFirewallPolicyInner>getLroResult(
            response, CdnWebApplicationFirewallPolicyInner.class, CdnWebApplicationFirewallPolicyInner.class, context);
    }
    ...
    public CdnWebApplicationFirewallPolicyInner createOrUpdate(String resourceGroupName, String policyName,
        CdnWebApplicationFirewallPolicyInner cdnWebApplicationFirewallPolicy) {
        return beginCreateOrUpdate(resourceGroupName, policyName, cdnWebApplicationFirewallPolicy).getFinalResult();
    }
    ...
    public CdnWebApplicationFirewallPolicyInner createOrUpdate(String resourceGroupName, String policyName,
        CdnWebApplicationFirewallPolicyInner cdnWebApplicationFirewallPolicy, Context context) {
        return beginCreateOrUpdate(resourceGroupName, policyName, cdnWebApplicationFirewallPolicy, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String policyName,
        ...
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, policyName,
            this.client.getSubscriptionId(), this.client.getApiVersion(),
            cdnWebApplicationFirewallPolicyPatchParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CdnWebApplicationFirewallPolicyInner>, CdnWebApplicationFirewallPolicyInner>
        beginUpdate(String resourceGroupName, String policyName,
            CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, policyName, cdnWebApplicationFirewallPolicyPatchParameters);
        return this.client.<CdnWebApplicationFirewallPolicyInner, CdnWebApplicationFirewallPolicyInner>getLroResult(
            response, CdnWebApplicationFirewallPolicyInner.class, CdnWebApplicationFirewallPolicyInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CdnWebApplicationFirewallPolicyInner>, CdnWebApplicationFirewallPolicyInner>
        beginUpdate(String resourceGroupName, String policyName,
            CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters,
            Context context) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, policyName,
    ...
    public CdnWebApplicationFirewallPolicyInner update(String resourceGroupName, String policyName,
        CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters) {
        return beginUpdate(resourceGroupName, policyName, cdnWebApplicationFirewallPolicyPatchParameters)
            .getFinalResult();
    }
    ...
    public CdnWebApplicationFirewallPolicyInner update(String resourceGroupName, String policyName,
        CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters,
        Context context) {
        return beginUpdate(resourceGroupName, policyName, cdnWebApplicationFirewallPolicyPatchParameters, context)
            .getFinalResult();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String policyName, Context context) {
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, policyName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CdnWebApplicationFirewallPolicyInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<CdnWebApplicationFirewallPolicyList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CdnWebApplicationFirewallPolicyInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
