...
public final class EndpointsImpl implements Endpoints {
    ...
    public Response<ValidateCustomDomainOutput> validateCustomDomainWithResponse(String resourceGroupName,
        ...
        Response<ValidateCustomDomainOutputInner> inner = this.serviceClient()
            .validateCustomDomainWithResponse(resourceGroupName, profileName, endpointName, customDomainProperties,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ValidateCustomDomainOutput validateCustomDomain(String resourceGroupName, String profileName,
        ...
        ValidateCustomDomainOutputInner inner = this.serviceClient()
