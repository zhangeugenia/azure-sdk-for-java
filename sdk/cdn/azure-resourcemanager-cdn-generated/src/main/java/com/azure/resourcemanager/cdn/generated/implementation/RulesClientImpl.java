...
public final class RulesClientImpl implements RulesClient {
    ...
    public interface RulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RuleListResult> listByRuleSetSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("ruleSetName") String ruleSetName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RuleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("ruleSetName") String ruleSetName, @PathParam("ruleName") String ruleName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RuleListResult> listByRuleSetNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list rules along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RuleInner> listByRuleSetSinglePage(String resourceGroupName, String profileName,
        String ruleSetName) {
        if (this.client.getEndpoint() == null) {
        ...
        Response<RuleListResult> res
            = service.listByRuleSetSync(this.client.getEndpoint(), resourceGroupName, profileName, ruleSetName,
    ...
    private PagedResponse<RuleInner> listByRuleSetSinglePage(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        Response<RuleListResult> res = service.listByRuleSetSync(this.client.getEndpoint(), resourceGroupName,
            profileName, ruleSetName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<RuleInner> listByRuleSet(String resourceGroupName, String profileName, String ruleSetName) {
        return new PagedIterable<>(() -> listByRuleSetSinglePage(resourceGroupName, profileName, ruleSetName),
            nextLink -> listByRuleSetNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<RuleInner> listByRuleSet(String resourceGroupName, String profileName, String ruleSetName,
        Context context) {
        return new PagedIterable<>(() -> listByRuleSetSinglePage(resourceGroupName, profileName, ruleSetName, context),
            nextLink -> listByRuleSetNextSinglePage(nextLink, context));
    }
    ...
    public Response<RuleInner> getWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, profileName, ruleSetName, ruleName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return friendly Rules name mapping to the any Rules or secret related information along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        ...
        if (rule == null) {
            throw LOGGER.atError().log(new IllegalArgumentException("Parameter rule is required and cannot be null."));
        } else {
            rule.validate();
        }
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, profileName, ruleSetName, ruleName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), rule, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RuleInner>, RuleInner> beginCreate(String resourceGroupName, String profileName,
        String ruleSetName, String ruleName, RuleInner rule) {
        Response<BinaryData> response = createWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, rule);
        return this.client.<RuleInner, RuleInner>getLroResult(response, RuleInner.class, RuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RuleInner>, RuleInner> beginCreate(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, rule, context);
        return this.client.<RuleInner, RuleInner>getLroResult(response, RuleInner.class, RuleInner.class, context);
    }
    ...
    public RuleInner create(String resourceGroupName, String profileName, String ruleSetName, String ruleName,
        RuleInner rule) {
        return beginCreate(resourceGroupName, profileName, ruleSetName, ruleName, rule).getFinalResult();
    }
    ...
    public RuleInner create(String resourceGroupName, String profileName, String ruleSetName, String ruleName,
        ...
        return beginCreate(resourceGroupName, profileName, ruleSetName, ruleName, rule, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        ...
        if (ruleUpdateProperties == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter ruleUpdateProperties is required and cannot be null."));
        } else {
            ruleUpdateProperties.validate();
        }
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, profileName, ruleSetName, ruleName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), ruleUpdateProperties, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RuleInner>, RuleInner> beginUpdate(String resourceGroupName, String profileName,
        String ruleSetName, String ruleName, RuleUpdateParameters ruleUpdateProperties) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties);
        return this.client.<RuleInner, RuleInner>getLroResult(response, RuleInner.class, RuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RuleInner>, RuleInner> beginUpdate(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties, context);
        return this.client.<RuleInner, RuleInner>getLroResult(response, RuleInner.class, RuleInner.class, context);
    }
    ...
    public RuleInner update(String resourceGroupName, String profileName, String ruleSetName, String ruleName,
        ...
        return beginUpdate(resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties)
            .getFinalResult();
    }
    ...
    public RuleInner update(String resourceGroupName, String profileName, String ruleSetName, String ruleName,
        ...
        return beginUpdate(resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        String ruleName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, profileName, ruleSetName, ruleName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        String ruleSetName, String ruleName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, profileName, ruleSetName, ruleName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, context);
    ...
    public void delete(String resourceGroupName, String profileName, String ruleSetName, String ruleName) {
        beginDelete(resourceGroupName, profileName, ruleSetName, ruleName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String profileName, String ruleSetName, String ruleName,
        Context context) {
        beginDelete(resourceGroupName, profileName, ruleSetName, ruleName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RuleInner> listByRuleSetNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<RuleListResult> res
            = service.listByRuleSetNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RuleInner> listByRuleSetNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<RuleListResult> res
            = service.listByRuleSetNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(RulesClientImpl.class);
}
