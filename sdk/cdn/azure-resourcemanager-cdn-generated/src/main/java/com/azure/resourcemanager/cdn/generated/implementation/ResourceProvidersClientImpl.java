...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CheckNameAvailabilityOutputInner> checkNameAvailabilitySync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CheckNameAvailabilityInput checkNameAvailabilityInput,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CheckNameAvailabilityOutputInner> checkNameAvailabilityWithSubscriptionSync(
            @HostParam("$host") String endpoint, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CheckNameAvailabilityInput checkNameAvailabilityInput,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ValidateProbeOutputInner> validateProbeSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ValidateProbeInput validateProbeInput, @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    public Response<CheckEndpointNameAvailabilityOutputInner> checkEndpointNameAvailabilityWithResponse(
        ...
        return service.checkEndpointNameAvailabilitySync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, this.client.getApiVersion(), checkEndpointNameAvailabilityInput, accept, context);
    }
    ...
    private Mono<Response<CheckNameAvailabilityOutputInner>>
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.checkNameAvailabilityWithSubscription(this.client.getEndpoint(),
            this.client.getSubscriptionId(), this.client.getApiVersion(), checkNameAvailabilityInput, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<CheckNameAvailabilityOutputInner> checkNameAvailabilityWithSubscriptionWithResponse(
        ...
        final String accept = "application/json";
        return service.checkNameAvailabilityWithSubscriptionSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), this.client.getApiVersion(), checkNameAvailabilityInput, accept, context);
    }
    ...
    private Mono<Response<ValidateProbeOutputInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateProbe(this.client.getEndpoint(), this.client.getSubscriptionId(),
                this.client.getApiVersion(), validateProbeInput, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<ValidateProbeOutputInner> validateProbeWithResponse(ValidateProbeInput validateProbeInput,
        ...
        if (validateProbeInput == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter validateProbeInput is required and cannot be null."));
        } else {
            validateProbeInput.validate();
        }
        final String accept = "application/json";
        return service.validateProbeSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), validateProbeInput, accept, context);
    }
