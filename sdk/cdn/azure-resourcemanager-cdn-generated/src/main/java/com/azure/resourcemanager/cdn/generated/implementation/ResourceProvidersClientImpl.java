...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    private Mono<Response<CheckNameAvailabilityOutputInner>> checkNameAvailabilityWithSubscriptionWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.checkNameAvailabilityWithSubscription(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), checkNameAvailabilityInput, accept, context);
    }
    ...
    private Mono<Response<ValidateProbeOutputInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateProbe(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), validateProbeInput, accept, context);
    }
