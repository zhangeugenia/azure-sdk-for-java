...
public interface ProfilesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<CanMigrateResultInner>, CanMigrateResultInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MigrateResultInner>, MigrateResultInner> beginCdnMigrateToAfd(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginMigrationAbort(String resourceGroupName, String profileName);
