...
public final class AfdProfilesClientImpl implements AfdProfilesClient {
    ...
    public interface AfdProfilesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CheckEndpointNameAvailabilityOutputInner> checkEndpointNameAvailabilitySync(
            @HostParam("$host") String endpoint, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CheckEndpointNameAvailabilityInput checkEndpointNameAvailabilityInput,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CheckNameAvailabilityOutputInner> checkHostnameAvailabilitySync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CheckHostnameAvailabilityInput checkHostnameAvailabilityInput,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ValidateSecretOutputInner> validateSecretSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ValidateSecretInput validateSecretInput,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<CheckEndpointNameAvailabilityOutputInner> checkEndpointNameAvailabilityWithResponse(
        ...
        final String accept = "application/json";
        return service.checkEndpointNameAvailabilitySync(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    public Response<CheckNameAvailabilityOutputInner> checkHostnameAvailabilityWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.checkHostnameAvailabilitySync(this.client.getEndpoint(), resourceGroupName, profileName,
    ...
    public Response<ValidateSecretOutputInner> validateSecretWithResponse(String resourceGroupName, String profileName,
        ...
        if (validateSecretInput == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter validateSecretInput is required and cannot be null."));
        } else {
            validateSecretInput.validate();
        }
        final String accept = "application/json";
        return service.validateSecretSync(this.client.getEndpoint(), resourceGroupName, profileName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), validateSecretInput, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> upgradeWithResponse(String resourceGroupName, String profileName,
        ProfileUpgradeParameters profileUpgradeParameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.upgradeSync(this.client.getEndpoint(), resourceGroupName, profileName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), profileUpgradeParameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ProfileInner>, ProfileInner> beginUpgrade(String resourceGroupName, String profileName,
        ProfileUpgradeParameters profileUpgradeParameters) {
        Response<BinaryData> response = upgradeWithResponse(resourceGroupName, profileName, profileUpgradeParameters);
    ...
    public SyncPoller<PollResult<ProfileInner>, ProfileInner> beginUpgrade(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = upgradeWithResponse(resourceGroupName, profileName, profileUpgradeParameters, context);
        return this.client.<ProfileInner, ProfileInner>getLroResult(response, ProfileInner.class, ProfileInner.class,
            context);
    }
    ...
    public ProfileInner upgrade(String resourceGroupName, String profileName,
        ProfileUpgradeParameters profileUpgradeParameters) {
        return beginUpgrade(resourceGroupName, profileName, profileUpgradeParameters).getFinalResult();
    }
    ...
    public ProfileInner upgrade(String resourceGroupName, String profileName,
        ProfileUpgradeParameters profileUpgradeParameters, Context context) {
        return beginUpgrade(resourceGroupName, profileName, profileUpgradeParameters, context).getFinalResult();
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AfdProfilesClientImpl.class);
}
