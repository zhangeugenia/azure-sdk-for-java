...
public final class ProfilesImpl implements Profiles {
    ...
    public CanMigrateResult cdnCanMigrateToAfd(String resourceGroupName, String profileName) {
        CanMigrateResultInner inner = this.serviceClient().cdnCanMigrateToAfd(resourceGroupName, profileName);
        if (inner != null) {
            return new CanMigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public CanMigrateResult cdnCanMigrateToAfd(String resourceGroupName, String profileName, Context context) {
        CanMigrateResultInner inner = this.serviceClient().cdnCanMigrateToAfd(resourceGroupName, profileName, context);
        if (inner != null) {
            return new CanMigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrateResult cdnMigrateToAfd(String resourceGroupName, String profileName,
        CdnMigrationToAfdParameters migrationParameters) {
        MigrateResultInner inner
            = this.serviceClient().cdnMigrateToAfd(resourceGroupName, profileName, migrationParameters);
        if (inner != null) {
            return new MigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrateResult cdnMigrateToAfd(String resourceGroupName, String profileName,
        ...
        MigrateResultInner inner
            = this.serviceClient().cdnMigrateToAfd(resourceGroupName, profileName, migrationParameters, context);
        if (inner != null) {
            return new MigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void migrationAbort(String resourceGroupName, String profileName) {
        this.serviceClient().migrationAbort(resourceGroupName, profileName);
    }

    public void migrationAbort(String resourceGroupName, String profileName, Context context) {
        this.serviceClient().migrationAbort(resourceGroupName, profileName, context);
    }
