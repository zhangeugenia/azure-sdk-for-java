...
public final class ProfileImpl implements Profile, Profile.Definition, Profile.Update {
    ...
    public CanMigrateResult cdnCanMigrateToAfd() {
        return serviceManager.profiles().cdnCanMigrateToAfd(resourceGroupName, profileName);
    }

    public CanMigrateResult cdnCanMigrateToAfd(Context context) {
        return serviceManager.profiles().cdnCanMigrateToAfd(resourceGroupName, profileName, context);
    }

    public MigrateResult cdnMigrateToAfd(CdnMigrationToAfdParameters migrationParameters) {
        return serviceManager.profiles().cdnMigrateToAfd(resourceGroupName, profileName, migrationParameters);
    }

    public MigrateResult cdnMigrateToAfd(CdnMigrationToAfdParameters migrationParameters, Context context) {
        return serviceManager.profiles().cdnMigrateToAfd(resourceGroupName, profileName, migrationParameters, context);
    }

    public void migrationAbort() {
        serviceManager.profiles().migrationAbort(resourceGroupName, profileName);
    }

    public void migrationAbort(Context context) {
        serviceManager.profiles().migrationAbort(resourceGroupName, profileName, context);
    }
