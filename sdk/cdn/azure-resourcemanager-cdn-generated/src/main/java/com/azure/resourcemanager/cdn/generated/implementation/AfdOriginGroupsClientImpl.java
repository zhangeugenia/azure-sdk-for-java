...
public final class AfdOriginGroupsClientImpl implements AfdOriginGroupsClient {
    ...
    public interface AfdOriginGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AfdOriginGroupListResult> listByProfileSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AfdOriginGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("originGroupName") String originGroupName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AfdOriginGroupListResult> listByProfileNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AfdOriginGroupInner> listByProfileSinglePage(String resourceGroupName, String profileName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<AfdOriginGroupListResult> res = service.listByProfileSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public Response<AfdOriginGroupInner> getWithResponse(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, profileName, originGroupName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return aFDOrigin group comprising of origins is used for load balancing to origins when the content cannot be
     * served from Azure Front Door along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String profileName,
        ...
        return service.createSync(this.client.getEndpoint(), resourceGroupName, profileName, originGroupName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), originGroup, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AfdOriginGroupInner>, AfdOriginGroupInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, originGroupName, originGroup);
        return this.client.<AfdOriginGroupInner, AfdOriginGroupInner>getLroResult(response, AfdOriginGroupInner.class,
            AfdOriginGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AfdOriginGroupInner>, AfdOriginGroupInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, originGroupName, originGroup, context);
        return this.client.<AfdOriginGroupInner, AfdOriginGroupInner>getLroResult(response, AfdOriginGroupInner.class,
            AfdOriginGroupInner.class, context);
    }
    ...
    public AfdOriginGroupInner create(String resourceGroupName, String profileName, String originGroupName,
        AfdOriginGroupInner originGroup) {
        return beginCreate(resourceGroupName, profileName, originGroupName, originGroup).getFinalResult();
    }
    ...
    public AfdOriginGroupInner create(String resourceGroupName, String profileName, String originGroupName,
        ...
        return beginCreate(resourceGroupName, profileName, originGroupName, originGroup, context).getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String profileName,
        ...
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, profileName, originGroupName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), originGroupUpdateProperties, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AfdOriginGroupInner>, AfdOriginGroupInner> beginUpdate(String resourceGroupName,
        String profileName, String originGroupName, AfdOriginGroupUpdateParameters originGroupUpdateProperties) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, profileName, originGroupName, originGroupUpdateProperties);
        return this.client.<AfdOriginGroupInner, AfdOriginGroupInner>getLroResult(response, AfdOriginGroupInner.class,
            AfdOriginGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AfdOriginGroupInner>, AfdOriginGroupInner> beginUpdate(String resourceGroupName,
        ...
        Context context) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, profileName, originGroupName, originGroupUpdateProperties, context);
        return this.client.<AfdOriginGroupInner, AfdOriginGroupInner>getLroResult(response, AfdOriginGroupInner.class,
            AfdOriginGroupInner.class, context);
    }
    ...
    public AfdOriginGroupInner update(String resourceGroupName, String profileName, String originGroupName,
        AfdOriginGroupUpdateParameters originGroupUpdateProperties) {
        return beginUpdate(resourceGroupName, profileName, originGroupName, originGroupUpdateProperties)
            .getFinalResult();
    }
    ...
    public AfdOriginGroupInner update(String resourceGroupName, String profileName, String originGroupName,
        ...
        return beginUpdate(resourceGroupName, profileName, originGroupName, originGroupUpdateProperties, context)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        String originGroupName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, profileName, originGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        String originGroupName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, profileName, originGroupName, context);
    ...
    public void delete(String resourceGroupName, String profileName, String originGroupName) {
        beginDelete(resourceGroupName, profileName, originGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String profileName, String originGroupName, Context context) {
        beginDelete(resourceGroupName, profileName, originGroupName, context).getFinalResult();
    }
    ...
    private PagedResponse<UsageInner> listResourceUsageSinglePage(String resourceGroupName, String profileName,
        ...
        Response<UsagesListResult> res
            = service.listResourceUsageSync(this.client.getEndpoint(), resourceGroupName, profileName, originGroupName,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<UsageInner> listResourceUsage(String resourceGroupName, String profileName,
        String originGroupName) {
        return new PagedIterable<>(() -> listResourceUsageSinglePage(resourceGroupName, profileName, originGroupName),
    ...
    public PagedIterable<UsageInner> listResourceUsage(String resourceGroupName, String profileName,
        ...
        return new PagedIterable<>(
            () -> listResourceUsageSinglePage(resourceGroupName, profileName, originGroupName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AfdOriginGroupInner> listByProfileNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AfdOriginGroupListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AfdOriginGroupInner> listByProfileNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AfdOriginGroupsClientImpl.class);
}
