...
public final class OriginsClientImpl implements OriginsClient {
    ...
    public interface OriginsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginListResult> listByEndpointSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("originName") String originName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginListResult> listByEndpointNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        String endpointName) {
        if (this.client.getEndpoint() == null) {
    ...
    private PagedResponse<OriginInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        Response<OriginListResult> res = service.listByEndpointSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public Response<OriginInner> getWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName, originName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return cDN origin is the source of the content being delivered via CDN along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName, originName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), origin, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginInner>, OriginInner> beginCreate(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, endpointName, originName, origin);
        return this.client.<OriginInner, OriginInner>getLroResult(response, OriginInner.class, OriginInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginInner>, OriginInner> beginCreate(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, endpointName, originName, origin, context);
        return this.client.<OriginInner, OriginInner>getLroResult(response, OriginInner.class, OriginInner.class,
            context);
    }
    ...
    public OriginInner create(String resourceGroupName, String profileName, String endpointName, String originName,
        OriginInner origin) {
        return beginCreate(resourceGroupName, profileName, endpointName, originName, origin).getFinalResult();
    }
    ...
    public OriginInner create(String resourceGroupName, String profileName, String endpointName, String originName,
        ...
        return beginCreate(resourceGroupName, profileName, endpointName, originName, origin, context).getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName, originName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), originUpdateProperties, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginInner>, OriginInner> beginUpdate(String resourceGroupName, String profileName,
        String endpointName, String originName, OriginUpdateParameters originUpdateProperties) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, profileName, endpointName, originName, originUpdateProperties);
        return this.client.<OriginInner, OriginInner>getLroResult(response, OriginInner.class, OriginInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginInner>, OriginInner> beginUpdate(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response = updateWithResponse(resourceGroupName, profileName, endpointName, originName,
    ...
    public OriginInner update(String resourceGroupName, String profileName, String endpointName, String originName,
        ...
        return beginUpdate(resourceGroupName, profileName, endpointName, originName, originUpdateProperties)
            .getFinalResult();
    }
    ...
    public OriginInner update(String resourceGroupName, String profileName, String endpointName, String originName,
        ...
        return beginUpdate(resourceGroupName, profileName, endpointName, originName, originUpdateProperties, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName, originName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        String endpointName, String originName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, profileName, endpointName, originName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, endpointName, originName, context);
    ...
    public void delete(String resourceGroupName, String profileName, String endpointName, String originName) {
        beginDelete(resourceGroupName, profileName, endpointName, originName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String profileName, String endpointName, String originName,
        Context context) {
        beginDelete(resourceGroupName, profileName, endpointName, originName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginInner> listByEndpointNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginInner> listByEndpointNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OriginsClientImpl.class);
}
