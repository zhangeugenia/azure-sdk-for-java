...
public final class SecurityPolicyImpl implements SecurityPolicy, SecurityPolicy.Definition, SecurityPolicy.Update {
    ...
    public SecurityPolicy apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSecurityPolicies()
            .patch(resourceGroupName, profileName, securityPolicyName, updateSecurityPolicyUpdateProperties,
                Context.NONE);
        return this;
    }
    ...
    public SecurityPolicy apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSecurityPolicies()
            .patch(resourceGroupName, profileName, securityPolicyName, updateSecurityPolicyUpdateProperties, context);
        return this;
    }
