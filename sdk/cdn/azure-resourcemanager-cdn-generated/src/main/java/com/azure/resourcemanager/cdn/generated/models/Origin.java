...
public interface Origin {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithHostname, DefinitionStages.WithHttpPort,
            DefinitionStages.WithHttpsPort, DefinitionStages.WithOriginHostHeader, DefinitionStages.WithPriority,
            DefinitionStages.WithWeight, DefinitionStages.WithEnabled, DefinitionStages.WithPrivateLinkAlias,
            DefinitionStages.WithPrivateLinkResourceId, DefinitionStages.WithPrivateLinkLocation,
        ...
        interface WithOriginHostHeader {
             ...
             * blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and
             * Cloud Services require this host header value to match the origin hostname by default. This overrides the
     ...
     */
    interface Update extends UpdateStages.WithHostname, UpdateStages.WithHttpPort, UpdateStages.WithHttpsPort,
        UpdateStages.WithOriginHostHeader, UpdateStages.WithPriority, UpdateStages.WithWeight, UpdateStages.WithEnabled,
        UpdateStages.WithPrivateLinkAlias, UpdateStages.WithPrivateLinkResourceId, UpdateStages.WithPrivateLinkLocation,
