...
public final class OriginGroupsClientImpl implements OriginGroupsClient {
    ...
    public interface OriginGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginGroupListResult> listByEndpointSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName, @PathParam("originGroupName") String originGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OriginGroupListResult> listByEndpointNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list origin groups along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginGroupInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        String endpointName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<OriginGroupListResult> res
    ...
    private PagedResponse<OriginGroupInner> listByEndpointSinglePage(String resourceGroupName, String profileName,
        ...
        final String accept = "application/json";
        Response<OriginGroupListResult> res = service.listByEndpointSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public Response<OriginGroupInner> getWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName, originGroupName,
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return origin group comprising of origins is used for load balancing to origins when the content cannot be
     * served from CDN along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        if (originGroup == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter originGroup is required and cannot be null."));
        } else {
            originGroup.validate();
        }
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            originGroupName, this.client.getSubscriptionId(), this.client.getApiVersion(), originGroup, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginGroupInner>, OriginGroupInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, endpointName, originGroupName, originGroup);
        return this.client.<OriginGroupInner, OriginGroupInner>getLroResult(response, OriginGroupInner.class,
            OriginGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginGroupInner>, OriginGroupInner> beginCreate(String resourceGroupName,
        ...
        Context context) {
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, profileName, endpointName, originGroupName, originGroup, context);
        return this.client.<OriginGroupInner, OriginGroupInner>getLroResult(response, OriginGroupInner.class,
            OriginGroupInner.class, context);
    }
    ...
    public OriginGroupInner create(String resourceGroupName, String profileName, String endpointName,
        String originGroupName, OriginGroupInner originGroup) {
        return beginCreate(resourceGroupName, profileName, endpointName, originGroupName, originGroup).getFinalResult();
    }
    ...
    public OriginGroupInner create(String resourceGroupName, String profileName, String endpointName,
        String originGroupName, OriginGroupInner originGroup, Context context) {
        return beginCreate(resourceGroupName, profileName, endpointName, originGroupName, originGroup, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            originGroupName, this.client.getSubscriptionId(), this.client.getApiVersion(), originGroupUpdateProperties,
            accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OriginGroupInner>, OriginGroupInner> beginUpdate(String resourceGroupName,
        String profileName, String endpointName, String originGroupName,
        OriginGroupUpdateParameters originGroupUpdateProperties) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, profileName, endpointName,
            originGroupName, originGroupUpdateProperties);
        return this.client.<OriginGroupInner, OriginGroupInner>getLroResult(response, OriginGroupInner.class,
            OriginGroupInner.class, Context.NONE);
    }
    ...
    public OriginGroupInner update(String resourceGroupName, String profileName, String endpointName,
        String originGroupName, OriginGroupUpdateParameters originGroupUpdateProperties) {
        return beginUpdate(resourceGroupName, profileName, endpointName, originGroupName, originGroupUpdateProperties)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String profileName, String endpointName,
        ...
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, profileName, endpointName,
            originGroupName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        String endpointName, String originGroupName) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, endpointName, originGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String profileName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, profileName, endpointName, originGroupName, context);
    ...
    public void delete(String resourceGroupName, String profileName, String endpointName, String originGroupName) {
        beginDelete(resourceGroupName, profileName, endpointName, originGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String profileName, String endpointName, String originGroupName,
        Context context) {
        beginDelete(resourceGroupName, profileName, endpointName, originGroupName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginGroupInner> listByEndpointNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OriginGroupInner> listByEndpointNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OriginGroupsClientImpl.class);
}
