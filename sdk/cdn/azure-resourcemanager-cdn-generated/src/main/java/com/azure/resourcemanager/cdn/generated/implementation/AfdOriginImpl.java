...
public final class AfdOriginImpl implements AfdOrigin, AfdOrigin.Definition, AfdOrigin.Update {
    ...
    public AfdOrigin apply() {
        this.innerObject = serviceManager.serviceClient()
            .getAfdOrigins()
            .update(resourceGroupName, profileName, originGroupName, originName, updateOriginUpdateProperties,
                Context.NONE);
        return this;
    }
    ...
    public AfdOrigin apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getAfdOrigins()
            .update(resourceGroupName, profileName, originGroupName, originName, updateOriginUpdateProperties, context);
        return this;
    }
