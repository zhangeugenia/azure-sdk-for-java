...
public final class ManagedPrivateEndpointsClientImpl implements ManagedPrivateEndpointsClient {
    ...
    public interface ManagedPrivateEndpointsService {
        ...
        Mono<Response<ManagedPrivateEndpointModelListResponse>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedPrivateEndpointModelInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
    ...
    private Mono<PagedResponse<ManagedPrivateEndpointModelInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ManagedPrivateEndpointModelInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedPrivateEndpointModelInner> listAsync(
        String resourceGroupName, String workspaceName, Context context) {
        return new PagedFlux<>(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of managed private endpoints of a grafana resource as paginated response with {@link
     *     PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedPrivateEndpointModelInner> list(
        String resourceGroupName, String workspaceName, Context context) {
    ...
    private Mono<Void> refreshAsync(String resourceGroupName, String workspaceName) {
        return beginRefreshAsync(resourceGroupName, workspaceName)
            .last()
    ...
    private Mono<Void> refreshAsync(String resourceGroupName, String workspaceName, Context context) {
        return beginRefreshAsync(resourceGroupName, workspaceName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedPrivateEndpointModelInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedPrivateEndpointModelInner> getAsync(
        String resourceGroupName, String workspaceName, String managedPrivateEndpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedPrivateEndpointModelInner> getWithResponse(
        String resourceGroupName, String workspaceName, String managedPrivateEndpointName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedPrivateEndpointModelInner get(
        String resourceGroupName, String workspaceName, String managedPrivateEndpointName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the managed private endpoint resource type along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private PollerFlux<PollResult<ManagedPrivateEndpointModelInner>, ManagedPrivateEndpointModelInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(
                resourceGroupName, workspaceName, managedPrivateEndpointName, requestBodyParameters);
        return this
            .client
            .<ManagedPrivateEndpointModelInner, ManagedPrivateEndpointModelInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<ManagedPrivateEndpointModelInner>, ManagedPrivateEndpointModelInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(
                resourceGroupName, workspaceName, managedPrivateEndpointName, requestBodyParameters, context);
        return this
            .client
            .<ManagedPrivateEndpointModelInner, ManagedPrivateEndpointModelInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedPrivateEndpointModelInner> createAsync(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointModelInner requestBodyParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedPrivateEndpointModelInner create(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointModelInner requestBodyParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedPrivateEndpointModelInner> updateAsync(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointUpdateParameters requestBodyParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedPrivateEndpointModelInner update(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointUpdateParameters requestBodyParameters) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String workspaceName, String managedPrivateEndpointName, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, workspaceName, managedPrivateEndpointName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String managedPrivateEndpointName) {
        return beginDeleteAsync(resourceGroupName, workspaceName, managedPrivateEndpointName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedPrivateEndpointModelInner>> listNextSinglePageAsync(
