    ...
    public ManagedPrivateEndpointModel apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getManagedPrivateEndpoints()
                .update(
                    resourceGroupName, workspaceName, managedPrivateEndpointName, updateRequestBodyParameters, context);
        return this;
    }

    ManagedPrivateEndpointModelImpl(
        ManagedPrivateEndpointModelInner innerObject,
