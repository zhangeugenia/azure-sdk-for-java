...
public interface ManagedPrivateEndpointsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ManagedPrivateEndpointModelInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedPrivateEndpointModelInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedPrivateEndpointModelInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedPrivateEndpointModelInner create(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointModelInner requestBodyParameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedPrivateEndpointModelInner update(
        String resourceGroupName,
        String workspaceName,
        String managedPrivateEndpointName,
        ManagedPrivateEndpointUpdateParameters requestBodyParameters);
