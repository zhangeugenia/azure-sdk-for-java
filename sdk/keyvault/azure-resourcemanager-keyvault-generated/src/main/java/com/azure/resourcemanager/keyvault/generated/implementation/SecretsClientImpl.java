...
public final class SecretsClientImpl implements SecretsClient {
     ...
     */
    SecretsClientImpl(AzureStorageResourceManagementApiImpl client) {
        this.service = RestProxy.create(SecretsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureStorageResourceManagementApiSecrets to be used by the proxy
    ...
    public interface SecretsService {
        ...
        Mono<Response<SecretInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @PathParam("secretName") String secretName, @HeaderParam("Accept") String accept, Context context);
        ...
        Mono<Response<SecretInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @PathParam("secretName") String secretName, @BodyParam("application/json") SecretInner resource,
        ...
        Mono<Response<SecretInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @PathParam("secretName") String secretName, @BodyParam("application/json") SecretPatchParameters properties,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @return the response of a Secret list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<SecretInner>> listSinglePageAsync(String resourceGroupName, String vaultName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, top, accept, context))
    ...
    private Mono<PagedResponse<SecretInner>> listSinglePageAsync(String resourceGroupName, String vaultName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, vaultName, top, accept, context)
    ...
    private Mono<Response<SecretInner>> getWithResponseAsync(String resourceGroupName, String vaultName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, secretName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SecretInner>> getWithResponseAsync(String resourceGroupName, String vaultName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, secretName, accept, context);
    }
    ...
    private Mono<Response<SecretInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String vaultName,
        String secretName, SecretInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, secretName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SecretInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String vaultName,
        String secretName, SecretInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<SecretInner> createOrUpdateAsync(String resourceGroupName, String vaultName, String secretName,
        SecretInner resource) {
        return createOrUpdateWithResponseAsync(resourceGroupName, vaultName, secretName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<SecretInner> createOrUpdateWithResponse(String resourceGroupName, String vaultName,
        String secretName, SecretInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, vaultName, secretName, resource, context).block();
    }
    ...
    public SecretInner createOrUpdate(String resourceGroupName, String vaultName, String secretName,
        SecretInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, vaultName, secretName, resource, Context.NONE).getValue();
    }
    ...
    private Mono<Response<SecretInner>> updateWithResponseAsync(String resourceGroupName, String vaultName,
        String secretName, SecretPatchParameters properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, secretName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SecretInner>> updateWithResponseAsync(String resourceGroupName, String vaultName,
        String secretName, SecretPatchParameters properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, secretName, properties, accept, context);
    }
    ...
    private Mono<SecretInner> updateAsync(String resourceGroupName, String vaultName, String secretName,
        SecretPatchParameters properties) {
        return updateWithResponseAsync(resourceGroupName, vaultName, secretName, properties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<SecretInner> updateWithResponse(String resourceGroupName, String vaultName, String secretName,
        ...
        return updateWithResponseAsync(resourceGroupName, vaultName, secretName, properties, context).block();
    }
    ...
    public SecretInner update(String resourceGroupName, String vaultName, String secretName,
        SecretPatchParameters properties) {
        return updateWithResponse(resourceGroupName, vaultName, secretName, properties, Context.NONE).getValue();
    }
