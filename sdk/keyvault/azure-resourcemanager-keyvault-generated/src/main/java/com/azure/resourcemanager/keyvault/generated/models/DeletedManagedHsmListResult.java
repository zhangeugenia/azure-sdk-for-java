...
public final class DeletedManagedHsmListResult implements JsonSerializable<DeletedManagedHsmListResult> {
    ...
    /**
     * Get the value property: The DeletedManagedHsm items on this page.
     * 
    ...
    /**
     * Set the value property: The DeletedManagedHsm items on this page.
     * 
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model DeletedManagedHsmListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DeletedManagedHsmListResult.class);
