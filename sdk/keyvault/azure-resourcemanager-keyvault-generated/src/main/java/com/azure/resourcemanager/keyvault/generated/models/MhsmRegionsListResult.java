...
public final class MhsmRegionsListResult implements JsonSerializable<MhsmRegionsListResult> {
    ...
    /**
     * Get the value property: The MhsmGeoReplicatedRegion items on this page.
     * 
    ...
    /**
     * Set the value property: The MhsmGeoReplicatedRegion items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model MhsmRegionsListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(MhsmRegionsListResult.class);
