...
public final class VaultImpl implements Vault, Vault.Definition, Vault.Update {
    ...
    private VaultPatchParameters updateProperties;
    ...
    public VaultImpl update() {
        this.updateProperties = new VaultPatchParameters();
        return this;
    }
    ...
    public Vault apply() {
        this.innerObject = serviceManager.serviceClient()
            .getVaults()
            .updateWithResponse(resourceGroupName, vaultName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Vault apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getVaults()
            .updateWithResponse(resourceGroupName, vaultName, updateProperties, context)
            .getValue();
        return this;
    }
    ...
    public VaultImpl withCreateMode(KeyVaultCreateMode createMode) {
    ...
    public VaultImpl withProvisioningState(KeyVaultProvisioningState provisioningState) {
