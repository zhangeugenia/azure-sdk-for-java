...
import com.azure.resourcemanager.keyvault.generated.models.MhsmPrivateEndpointConnectionListResult;
...
public final class MhsmPrivateEndpointConnectionsClientImpl implements MhsmPrivateEndpointConnectionsClient {
     ...
     */
    MhsmPrivateEndpointConnectionsClientImpl(AzureStorageResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureStorageResourceManagementApiMhsmPrivateEndpointConnections to be
    ...
    public interface MhsmPrivateEndpointConnectionsService {
        ...
        Mono<Response<MhsmPrivateEndpointConnectionListResult>> listByResource(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MhsmPrivateEndpointConnectionInner>> put(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("privateEndpointConnectionName") String privateEndpointConnectionName,
            @BodyParam("application/json") MhsmPrivateEndpointConnectionInner resource,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MhsmPrivateEndpointConnectionListResult>> listByResourceNext(
     ...
     * @return the response of a MhsmPrivateEndpointConnection list operation along with {@link PagedResponse} on
    ...
    private Mono<Response<MhsmPrivateEndpointConnectionInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, name, privateEndpointConnectionName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MhsmPrivateEndpointConnectionInner>> putWithResponseAsync(String resourceGroupName,
        String name, String privateEndpointConnectionName, MhsmPrivateEndpointConnectionInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.put(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, name, privateEndpointConnectionName, resource,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<MhsmPrivateEndpointConnectionInner>> putWithResponseAsync(String resourceGroupName,
        ...
        return service.put(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, name, privateEndpointConnectionName, resource, accept, context);
    }
    ...
    private Mono<MhsmPrivateEndpointConnectionInner> putAsync(String resourceGroupName, String name,
        String privateEndpointConnectionName, MhsmPrivateEndpointConnectionInner resource) {
        return putWithResponseAsync(resourceGroupName, name, privateEndpointConnectionName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MhsmPrivateEndpointConnectionInner> putWithResponse(String resourceGroupName, String name,
        String privateEndpointConnectionName, MhsmPrivateEndpointConnectionInner resource, Context context) {
        return putWithResponseAsync(resourceGroupName, name, privateEndpointConnectionName, resource, context).block();
    }
    ...
    public MhsmPrivateEndpointConnectionInner put(String resourceGroupName, String name,
        String privateEndpointConnectionName, MhsmPrivateEndpointConnectionInner resource) {
        return putWithResponse(resourceGroupName, name, privateEndpointConnectionName, resource, Context.NONE)
            .getValue();
    }
