...
public final class MhsmPrivateLinkServiceConnectionState
     ...
     */
    private ManagedHsmPrivateEndpointServiceConnectionStatus status;
     ...
     */
    public ManagedHsmPrivateEndpointServiceConnectionStatus status() {
        return this.status;
    }
     ...
     */
    public MhsmPrivateLinkServiceConnectionState withStatus(ManagedHsmPrivateEndpointServiceConnectionStatus status) {
        this.status = status;
        return this;
    }
     ...
     * @return An instance of MhsmPrivateLinkServiceConnectionState if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the MhsmPrivateLinkServiceConnectionState.
     */
    public static MhsmPrivateLinkServiceConnectionState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MhsmPrivateLinkServiceConnectionState deserializedMhsmPrivateLinkServiceConnectionState
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("status".equals(fieldName)) {
                    deserializedMhsmPrivateLinkServiceConnectionState.status
                        = ManagedHsmPrivateEndpointServiceConnectionStatus.fromString(reader.getString());
                } else if ("description".equals(fieldName)) {
                    deserializedMhsmPrivateLinkServiceConnectionState.description = reader.getString();
                } else if ("actionsRequired".equals(fieldName)) {
                    deserializedMhsmPrivateLinkServiceConnectionState.actionsRequired
            ...
            return deserializedMhsmPrivateLinkServiceConnectionState;
        });
    }
}
