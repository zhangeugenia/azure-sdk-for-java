...
public final class ResourceListResult implements JsonSerializable<ResourceListResult> {
     ...
     */
    private List<ResourceAutoGeneratedInner> value;
     ...
     */
    public List<ResourceAutoGeneratedInner> value() {
        return this.value;
    }

    /**
     * Set the value property: The Resource items on this page.
     * 
     * @param value the value value to set.
     * @return the ResourceListResult object itself.
     */
    public ResourceListResult withValue(List<ResourceAutoGeneratedInner> value) {
        this.value = value;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<ResourceAutoGeneratedInner> value
                        = reader.readArray(reader1 -> ResourceAutoGeneratedInner.fromJson(reader1));
