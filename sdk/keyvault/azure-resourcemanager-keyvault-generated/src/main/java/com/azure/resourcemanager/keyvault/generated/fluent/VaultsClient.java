...
public interface VaultsClient {
    ...
    PagedIterable<DeletedVaultInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeletedVaultInner> list(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VaultInner> updateWithResponse(String resourceGroupName, String vaultName, VaultPatchParameters properties,
        Context context);
