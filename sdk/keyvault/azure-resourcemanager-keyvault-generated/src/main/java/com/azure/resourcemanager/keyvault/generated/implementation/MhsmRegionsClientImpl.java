...
public final class MhsmRegionsClientImpl implements MhsmRegionsClient {
     ...
     */
    MhsmRegionsClientImpl(AzureStorageResourceManagementApiImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureStorageResourceManagementApiMhsmRegions to be used by the proxy
