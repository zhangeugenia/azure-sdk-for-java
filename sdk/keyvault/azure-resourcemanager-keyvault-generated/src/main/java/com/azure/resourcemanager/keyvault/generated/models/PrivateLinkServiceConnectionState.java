...
public final class PrivateLinkServiceConnectionState implements JsonSerializable<PrivateLinkServiceConnectionState> {
     ...
     */
    private KeyVaultActionsRequiredMessage actionsRequired;
     ...
     */
    public KeyVaultActionsRequiredMessage actionsRequired() {
     ...
     * @return the PrivateLinkServiceConnectionState object itself.
     */
    public PrivateLinkServiceConnectionState withActionsRequired(KeyVaultActionsRequiredMessage actionsRequired) {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("status".equals(fieldName)) {
                    ...
                    deserializedPrivateLinkServiceConnectionState.actionsRequired
                        = KeyVaultActionsRequiredMessage.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
