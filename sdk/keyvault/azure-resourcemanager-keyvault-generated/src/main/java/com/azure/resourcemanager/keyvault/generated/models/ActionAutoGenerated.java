...
public final class ActionAutoGenerated implements JsonSerializable<ActionAutoGenerated> {
     ...
     */
    public ActionAutoGenerated withType(KeyRotationPolicyActionType type) {
        this.type = type;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    deserializedActionAutoGenerated.type = KeyRotationPolicyActionType.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
