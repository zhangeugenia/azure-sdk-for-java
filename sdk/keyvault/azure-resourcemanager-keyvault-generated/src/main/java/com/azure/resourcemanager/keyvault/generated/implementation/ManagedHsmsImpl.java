...
public final class ManagedHsmsImpl implements ManagedHsms {
    ...
    public Response<CheckMhsmNameAvailabilityResult>
        ...
        Response<CheckMhsmNameAvailabilityResultInner> inner
            = this.serviceClient().checkMhsmNameAvailabilityWithResponse(body, context);
        if (inner != null) {
    ...
    public CheckMhsmNameAvailabilityResult checkMhsmNameAvailability(CheckMhsmNameAvailabilityParameters body) {
        CheckMhsmNameAvailabilityResultInner inner = this.serviceClient().checkMhsmNameAvailability(body);
        if (inner != null) {
