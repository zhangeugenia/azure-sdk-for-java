...
public final class NetworkRuleSet implements JsonSerializable<NetworkRuleSet> {
     ...
     * is 'AzureServices'.
     */
    private KeyVaultNetworkRuleBypassOption bypass;
     ...
     */
    private KeyVaultNetworkRuleAction defaultAction;
     ...
     */
    public KeyVaultNetworkRuleBypassOption bypass() {
        return this.bypass;
    }
     ...
     */
    public NetworkRuleSet withBypass(KeyVaultNetworkRuleBypassOption bypass) {
        this.bypass = bypass;
        return this;
    }
     ...
     */
    public KeyVaultNetworkRuleAction defaultAction() {
     ...
     * @return the NetworkRuleSet object itself.
     */
    public NetworkRuleSet withDefaultAction(KeyVaultNetworkRuleAction defaultAction) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("bypass".equals(fieldName)) {
                    deserializedNetworkRuleSet.bypass = KeyVaultNetworkRuleBypassOption.fromString(reader.getString());
                } else if ("defaultAction".equals(fieldName)) {
                    deserializedNetworkRuleSet.defaultAction = KeyVaultNetworkRuleAction.fromString(reader.getString());
