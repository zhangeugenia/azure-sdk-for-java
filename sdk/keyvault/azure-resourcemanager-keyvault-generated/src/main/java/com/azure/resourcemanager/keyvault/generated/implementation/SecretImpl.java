...
public final class SecretImpl implements Secret, Secret.Definition, Secret.Update {
    ...
    private SecretPatchParameters updateProperties;
    ...
    public SecretImpl update() {
        this.updateProperties = new SecretPatchParameters();
        return this;
    }
    ...
    public Secret apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSecrets()
            .updateWithResponse(resourceGroupName, vaultName, secretName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Secret apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSecrets()
            .updateWithResponse(resourceGroupName, vaultName, secretName, updateProperties, context)
            .getValue();
        return this;
    }
