...
public interface Vaults {
     ...
     */
    Response<CheckNameAvailabilityResult> checkNameAvailabilityWithResponse(VaultCheckNameAvailabilityParameters body,
        Context context);
     ...
     */
    CheckNameAvailabilityResult checkNameAvailability(VaultCheckNameAvailabilityParameters body);
     ...
     */
    PagedIterable<DeletedVault> list();
     ...
     * @return information about the deleted vaults in a subscription as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DeletedVault> list(Context context);
     ...
     */
    Response<DeletedVault> getDeletedWithResponse(String location, String vaultName, Context context);
     ...
     */
    DeletedVault getDeleted(String location, String vaultName);
