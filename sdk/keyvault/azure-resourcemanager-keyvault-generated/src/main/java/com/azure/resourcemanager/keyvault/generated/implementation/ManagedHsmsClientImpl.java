...
public final class ManagedHsmsClientImpl implements ManagedHsmsClient {
    ...
    public interface ManagedHsmsService {
        ...
        Mono<Response<CheckMhsmNameAvailabilityResultInner>> checkMhsmNameAvailability(
            ...
            @BodyParam("application/json") CheckMhsmNameAvailabilityParameters mhsName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DeletedManagedHsmListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedHsmListResult>> listBySubscription(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<Response<CheckMhsmNameAvailabilityResultInner>>
        checkMhsmNameAvailabilityWithResponseAsync(CheckMhsmNameAvailabilityParameters mhsName) {
        ...
        if (mhsName == null) {
            return Mono.error(new IllegalArgumentException("Parameter mhsName is required and cannot be null."));
        } else {
            mhsName.validate();
        }
        ...
        return FluxUtil
            .withContext(context -> service.checkMhsmNameAvailability(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), mhsName, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CheckMhsmNameAvailabilityResultInner>>
        checkMhsmNameAvailabilityWithResponseAsync(CheckMhsmNameAvailabilityParameters mhsName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.checkMhsmNameAvailability(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), mhsName, accept, context);
    }
    ...
    private Mono<CheckMhsmNameAvailabilityResultInner>
        checkMhsmNameAvailabilityAsync(CheckMhsmNameAvailabilityParameters mhsName) {
        return checkMhsmNameAvailabilityWithResponseAsync(mhsName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<CheckMhsmNameAvailabilityResultInner>
        ...
        return checkMhsmNameAvailabilityWithResponseAsync(mhsName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CheckMhsmNameAvailabilityResultInner checkMhsmNameAvailability(CheckMhsmNameAvailabilityParameters mhsName) {
        return checkMhsmNameAvailabilityWithResponse(mhsName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DeletedManagedHsmInner>> listSinglePageAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DeletedManagedHsmInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<DeletedManagedHsmInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DeletedManagedHsmInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeletedManagedHsmInner> list() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeletedManagedHsmInner> list(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeletedManagedHsmInner> getDeletedAsync(String location, String name) {
    ...
    private PollerFlux<PollResult<Void>, Void> beginPurgeDeletedAsync(String location, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> purgeDeletedAsync(String location, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedHsmInner>> listBySubscriptionSinglePageAsync(Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedHsmInner>> listBySubscriptionSinglePageAsync(Integer top, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedHsmInner> listBySubscriptionAsync(Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedHsmInner> listBySubscriptionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedHsmInner> listBySubscriptionAsync(Integer top, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedHsmInner> listBySubscription() {
        final Integer top = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedHsmInner> listBySubscription(Integer top, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String name,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, name, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String name,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, name, parameters, accept, context);
    }
