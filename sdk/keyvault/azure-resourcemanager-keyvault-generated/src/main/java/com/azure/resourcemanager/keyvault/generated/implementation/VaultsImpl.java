...
public final class VaultsImpl implements Vaults {
    ...
    public CheckNameAvailabilityResult checkNameAvailability(VaultCheckNameAvailabilityParameters body) {
    ...
    public PagedIterable<DeletedVault> list() {
        PagedIterable<DeletedVaultInner> inner = this.serviceClient().list();
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeletedVaultImpl(inner1, this.manager()));
    }

    public PagedIterable<DeletedVault> list(Context context) {
        PagedIterable<DeletedVaultInner> inner = this.serviceClient().list(context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeletedVaultImpl(inner1, this.manager()));
    }
    ...
    public Response<VaultAccessPolicyParameters> updateAccessPolicyWithResponse(String resourceGroupName,
        ...
        VaultsUpdateAccessPolicyResponse inner = this.serviceClient()
            .updateAccessPolicyWithResponse(resourceGroupName, vaultName, operationKind, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public VaultAccessPolicyParameters updateAccessPolicy(String resourceGroupName, String vaultName,
        ...
        VaultAccessPolicyParametersInner inner
            = this.serviceClient().updateAccessPolicy(resourceGroupName, vaultName, operationKind, body);
        if (inner != null) {
