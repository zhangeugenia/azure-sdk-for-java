...
public final class ManagedHsmListResult implements JsonSerializable<ManagedHsmListResult> {
    ...
    /**
     * Get the value property: The ManagedHsm items on this page.
     * 
    ...
    /**
     * Set the value property: The ManagedHsm items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ManagedHsmListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ManagedHsmListResult.class);
