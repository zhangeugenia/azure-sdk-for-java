...
public interface VaultAccessPolicyParameters {
    /**
     * Gets the id property: The resource id of the access policy.
     * 
     * @return the id value.
     */
    String id();
    ...
    /**
     * Gets the name property: The resource name of the access policy.
     * 
    ...
    /**
     * Gets the type property: The resource name of the access policy.
     * 
