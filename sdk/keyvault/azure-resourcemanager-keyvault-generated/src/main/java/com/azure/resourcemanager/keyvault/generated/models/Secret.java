...
public interface Secret {
    ...
    /**
     * Gets the value property: The value of the secret. NOTE: 'value' will never be returned from the service, as APIs
    ...
    /**
     * Gets the contentType property: The content type of the secret.
     * 
    ...
    /**
     * Gets the attributes property: The attributes of the secret.
     * 
    ...
    /**
     * Gets the secretUri property: The URI to retrieve the current version of the secret.
     * 
    ...
    /**
     * Gets the secretUriWithVersion property: The URI to retrieve the specific version of the secret.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithValue,
            DefinitionStages.WithContentType, DefinitionStages.WithAttributes {
            /**
        ...
        interface WithValue {
            /**
             * Specifies the value property: The value of the secret. NOTE: 'value' will never be returned from the
             * service, as APIs using this model are is intended for internal use in ARM deployments. Users should use
             * the data-plane REST service for interaction with vault secrets..
             * 
             * @param value The value of the secret. NOTE: 'value' will never be returned from the service, as APIs
             * using this model are is intended for internal use in ARM deployments. Users should use the data-plane
        ...
        /**
         * The stage of the Secret definition allowing to specify contentType.
         */
        interface WithContentType {
            /**
             * Specifies the contentType property: The content type of the secret..
             * 
        ...
        /**
         * The stage of the Secret definition allowing to specify attributes.
         */
        interface WithAttributes {
            /**
             * Specifies the attributes property: The attributes of the secret..
             * 
             * @param attributes The attributes of the secret.
             * @return the next definition stage.
             */
            WithCreate withAttributes(SecretAttributes attributes);
        }
    }
