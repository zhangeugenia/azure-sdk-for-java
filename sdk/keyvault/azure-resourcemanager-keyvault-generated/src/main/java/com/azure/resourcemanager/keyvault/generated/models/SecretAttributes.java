...
public final class SecretAttributes extends Attributes {
     ...
     */
    @Override
    public SecretAttributes withNbf(OffsetDateTime nbf) {
        super.withNbf(nbf);
        return this;
    }
     ...
     */
    @Override
    public SecretAttributes withExp(OffsetDateTime exp) {
        super.withExp(exp);
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        if (nbf() != null) {
            jsonWriter.writeNumberField("nbf", nbf().toEpochSecond());
        }
        if (exp() != null) {
            jsonWriter.writeNumberField("exp", exp().toEpochSecond());
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("enabled".equals(fieldName)) {
                    ...
                    Long nbfHolder = reader.getNullable(JsonReader::getLong);
                    if (nbfHolder != null) {
                        deserializedSecretAttributes
                            .withNbf(OffsetDateTime.ofInstant(Instant.ofEpochSecond(nbfHolder), ZoneOffset.UTC));
                    }
                } else if ("exp".equals(fieldName)) {
                    Long expHolder = reader.getNullable(JsonReader::getLong);
                    if (expHolder != null) {
                        deserializedSecretAttributes
                            .withExp(OffsetDateTime.ofInstant(Instant.ofEpochSecond(expHolder), ZoneOffset.UTC));
                    }
