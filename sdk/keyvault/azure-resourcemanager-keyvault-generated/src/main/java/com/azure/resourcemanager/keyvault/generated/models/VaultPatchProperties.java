...
public final class VaultPatchProperties implements JsonSerializable<VaultPatchProperties> {
     ...
     */
    private KeyVaultPatchMode createMode;
     ...
     */
    public KeyVaultPatchMode createMode() {
     ...
     * @return the VaultPatchProperties object itself.
     */
    public VaultPatchProperties withCreateMode(KeyVaultPatchMode createMode) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("tenantId".equals(fieldName)) {
                    ...
                    deserializedVaultPatchProperties.createMode = KeyVaultPatchMode.fromString(reader.getString());
