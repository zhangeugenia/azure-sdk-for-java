...
public final class VaultPatchProperties implements JsonSerializable<VaultPatchProperties> {
     ...
     * If set to 'SecuredByPerimeter' then only network security perimeter rules will apply; trusted services will not
     * be allowed through.
     */
     ...
     * present we will not honor the rules. If set to 'SecuredByPerimeter' then only network security perimeter rules
     * will apply; trusted services will not be allowed through.
     * 
