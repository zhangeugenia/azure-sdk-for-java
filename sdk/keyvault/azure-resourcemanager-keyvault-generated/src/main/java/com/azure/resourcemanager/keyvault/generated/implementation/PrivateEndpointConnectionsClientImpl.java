...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(AzureStorageResourceManagementApiImpl client) {
    ...
    /**
     * The interface defining all the services for AzureStorageResourceManagementApiPrivateEndpointConnections to be
    ...
    private Mono<Response<PrivateEndpointConnectionInner>> putWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.put(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, privateEndpointConnectionName, resource,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PrivateEndpointConnectionInner>> putWithResponseAsync(String resourceGroupName,
        ...
        return service.put(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, privateEndpointConnectionName, resource, accept, context);
    }
    ...
    private Mono<PrivateEndpointConnectionInner> putAsync(String resourceGroupName, String vaultName,
        ...
        return putWithResponseAsync(resourceGroupName, vaultName, privateEndpointConnectionName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionInner> putWithResponse(String resourceGroupName, String vaultName,
        String privateEndpointConnectionName, PrivateEndpointConnectionInner resource, Context context) {
        return putWithResponseAsync(resourceGroupName, vaultName, privateEndpointConnectionName, resource, context)
            .block();
    }
    ...
    public PrivateEndpointConnectionInner put(String resourceGroupName, String vaultName,
        String privateEndpointConnectionName, PrivateEndpointConnectionInner resource) {
        return putWithResponse(resourceGroupName, vaultName, privateEndpointConnectionName, resource, Context.NONE)
            .getValue();
    }
