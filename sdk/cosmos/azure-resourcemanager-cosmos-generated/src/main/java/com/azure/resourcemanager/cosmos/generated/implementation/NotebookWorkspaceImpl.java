...
public final class NotebookWorkspaceImpl
    ...
    public NotebookWorkspace create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdate(resourceGroupName, accountName, notebookWorkspaceName, createNotebookCreateUpdateParameters,
                Context.NONE);
        return this;
    }
    ...
    public NotebookWorkspace apply() {
        this.innerObject = serviceManager.serviceClient()
            .getNotebookWorkspaces()
            .createOrUpdate(resourceGroupName, accountName, notebookWorkspaceName, updateNotebookCreateUpdateParameters,
                Context.NONE);
        return this;
    }
    ...
    public Response<NotebookWorkspaceConnectionInfoResult> listConnectionInfoWithResponse(Context context) {
        return serviceManager.notebookWorkspaces()
    ...
    public void regenerateAuthToken(Context context) {
        serviceManager.notebookWorkspaces()
