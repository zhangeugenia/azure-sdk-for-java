...
public final class CassandraViewGetResultsImpl
    ...
    public CassandraViewGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createUpdateCassandraView(resourceGroupName, accountName, keyspaceName, viewName,
                createCreateUpdateCassandraViewParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraViewGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraView(resourceGroupName, accountName, keyspaceName, viewName,
                createCreateUpdateCassandraViewParameters, context);
        return this;
    }
    ...
    public CassandraViewGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraView(resourceGroupName, accountName, keyspaceName, viewName,
                updateCreateUpdateCassandraViewParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraViewGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraView(resourceGroupName, accountName, keyspaceName, viewName,
                updateCreateUpdateCassandraViewParameters, context);
        return this;
    }
