...
public final class DataTransferJobsImpl implements DataTransferJobs {
    ...
    public Response<DataTransferJobGetResults> completeWithResponse(String resourceGroupName, String accountName,
        String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner
    ...
    public DataTransferJobGetResults complete(String resourceGroupName, String accountName, String jobName) {
        DataTransferJobGetResultsInner inner = this.serviceClient().complete(resourceGroupName, accountName, jobName);
        if (inner != null) {
            return new DataTransferJobGetResultsImpl(inner, this.manager());
        } else {
            return null;
