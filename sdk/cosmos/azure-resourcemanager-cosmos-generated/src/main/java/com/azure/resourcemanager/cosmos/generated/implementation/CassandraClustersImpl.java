...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public Response<CommandPublicResource> getCommandAsyncResourceWithResponse(String resourceGroupName,
        String clusterName, String commandId, Context context) {
        Response<CommandPublicResourceInner> inner = this.serviceClient()
            .getCommandAsyncResourceWithResponse(resourceGroupName, clusterName, commandId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new CommandPublicResourceImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CommandPublicResource getCommandAsyncResource(String resourceGroupName, String clusterName,
        String commandId) {
        CommandPublicResourceInner inner
