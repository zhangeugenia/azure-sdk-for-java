...
public final class RestorableGremlinResourcesClientImpl implements RestorableGremlinResourcesClient {
    ...
    RestorableGremlinResourcesClientImpl(CosmosDBManagementClientImpl client) {
        this.service = RestProxy.create(RestorableGremlinResourcesService.class, client.getHttpPipeline(),
    ...
    public interface RestorableGremlinResourcesService {
        ...
        Mono<Response<RestorableGremlinResourcesListResult>> list(@HostParam("$host") String endpoint,
     ...
     * @return the List operation response, that contains the restorable Gremlin resources along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RestorableGremlinResourcesGetResultInner>> listSinglePageAsync(String location,
