 ...
 */
public final class ThroughputPoolOperationsClientImpl implements ThroughputPoolOperationsClient {
    /**
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputPoolResourceInner> getByResourceGroupAsync(String resourceGroupName,
        String throughputPoolName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String throughputPoolName, ThroughputPoolUpdate body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ThroughputPoolResourceInner>, ThroughputPoolResourceInner>
