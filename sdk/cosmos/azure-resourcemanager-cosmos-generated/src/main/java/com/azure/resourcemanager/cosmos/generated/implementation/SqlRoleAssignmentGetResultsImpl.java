...
public final class SqlRoleAssignmentGetResultsImpl
    ...
    public SqlRoleAssignmentGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleAssignment(roleAssignmentId, resourceGroupName, accountName,
                createCreateUpdateSqlRoleAssignmentParameters, Context.NONE);
        return this;
    }
    ...
    public SqlRoleAssignmentGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleAssignment(roleAssignmentId, resourceGroupName, accountName,
                createCreateUpdateSqlRoleAssignmentParameters, context);
        return this;
    }
    ...
    public SqlRoleAssignmentGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleAssignment(roleAssignmentId, resourceGroupName, accountName,
                updateCreateUpdateSqlRoleAssignmentParameters, Context.NONE);
        return this;
    }
    ...
    public SqlRoleAssignmentGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleAssignment(roleAssignmentId, resourceGroupName, accountName,
                updateCreateUpdateSqlRoleAssignmentParameters, context);
        return this;
    }
