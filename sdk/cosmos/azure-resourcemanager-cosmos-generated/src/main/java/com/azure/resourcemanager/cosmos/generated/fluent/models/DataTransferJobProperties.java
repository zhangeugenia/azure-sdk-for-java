...
import com.azure.resourcemanager.cosmos.generated.models.DataTransferContainerDetails;
...
public final class DataTransferJobProperties implements JsonSerializable<DataTransferJobProperties> {
    ...
    /*
     * The sourceAndDestinationContainers property.
     */
    private List<DataTransferContainerDetails> sourceAndDestinationContainers;
    ...
    /**
     * Get the sourceAndDestinationContainers property: The sourceAndDestinationContainers property.
     * 
     * @return the sourceAndDestinationContainers value.
     */
    public List<DataTransferContainerDetails> sourceAndDestinationContainers() {
        return this.sourceAndDestinationContainers;
    }

    /**
     * Set the sourceAndDestinationContainers property: The sourceAndDestinationContainers property.
     * 
     * @param sourceAndDestinationContainers the sourceAndDestinationContainers value to set.
     * @return the DataTransferJobProperties object itself.
     */
    public DataTransferJobProperties
        withSourceAndDestinationContainers(List<DataTransferContainerDetails> sourceAndDestinationContainers) {
        this.sourceAndDestinationContainers = sourceAndDestinationContainers;
        return this;
    }
    ...
    public void validate() {
        ...
        if (sourceAndDestinationContainers() != null) {
            sourceAndDestinationContainers().forEach(e -> e.validate());
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("sourceAndDestinationContainers", this.sourceAndDestinationContainers,
    ...
    public static DataTransferJobProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("sourceAndDestinationContainers".equals(fieldName)) {
                    List<DataTransferContainerDetails> sourceAndDestinationContainers
                        = reader.readArray(reader1 -> DataTransferContainerDetails.fromJson(reader1));
                    deserializedDataTransferJobProperties.sourceAndDestinationContainers
