...
public final class RestorableDatabaseAccountsClientImpl implements RestorableDatabaseAccountsClient {
    ...
    RestorableDatabaseAccountsClientImpl(CosmosDBManagementClientImpl client) {
        this.service = RestProxy.create(RestorableDatabaseAccountsService.class, client.getHttpPipeline(),
    ...
    public interface RestorableDatabaseAccountsService {
        ...
        Mono<Response<RestorableDatabaseAccountsListResult>> listByLocation(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RestorableDatabaseAccountsListResult>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RestorableDatabaseAccountGetResultInner>> getByLocation(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<PagedResponse<RestorableDatabaseAccountGetResultInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RestorableDatabaseAccountGetResultInner>> getByLocationWithResponseAsync(String location,
        String instanceId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getByLocation(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<RestorableDatabaseAccountGetResultInner>> getByLocationWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getByLocation(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), location, instanceId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RestorableDatabaseAccountGetResultInner> getByLocationWithResponse(String location,
        String instanceId, Context context) {
