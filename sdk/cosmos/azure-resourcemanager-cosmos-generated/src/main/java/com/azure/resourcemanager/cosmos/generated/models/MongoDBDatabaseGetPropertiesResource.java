...
public final class MongoDBDatabaseGetPropertiesResource extends MongoDBDatabaseResource {
        ...
        if (id() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property id in model MongoDBDatabaseGetPropertiesResource"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MongoDBDatabaseGetPropertiesResource.class);
