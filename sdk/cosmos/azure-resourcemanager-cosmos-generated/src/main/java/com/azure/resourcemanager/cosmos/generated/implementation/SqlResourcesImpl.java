...
public final class SqlResourcesImpl implements SqlResources {
    ...
    public PhysicalPartitionStorageInfoCollection listSqlContainerPartitionMerge(String resourceGroupName,
        ...
        PhysicalPartitionStorageInfoCollectionInner inner = this.serviceClient()
            .listSqlContainerPartitionMerge(resourceGroupName, accountName, databaseName, containerName,
                mergeParameters);
        if (inner != null) {
            return new PhysicalPartitionStorageInfoCollectionImpl(inner, this.manager());
        } else {
    ...
    public PhysicalPartitionThroughputInfoResult sqlDatabaseRetrieveThroughputDistribution(String resourceGroupName,
        ...
        PhysicalPartitionThroughputInfoResultInner inner = this.serviceClient()
            .sqlDatabaseRetrieveThroughputDistribution(resourceGroupName, accountName, databaseName,
    ...
    public PhysicalPartitionThroughputInfoResult sqlDatabaseRedistributeThroughput(String resourceGroupName,
        ...
        PhysicalPartitionThroughputInfoResultInner inner = this.serviceClient()
            .sqlDatabaseRedistributeThroughput(resourceGroupName, accountName, databaseName,
    ...
    public PhysicalPartitionThroughputInfoResult sqlContainerRetrieveThroughputDistribution(String resourceGroupName,
        ...
        PhysicalPartitionThroughputInfoResultInner inner = this.serviceClient()
            .sqlContainerRetrieveThroughputDistribution(resourceGroupName, accountName, databaseName, containerName,
                retrieveThroughputParameters);
        if (inner != null) {
            return new PhysicalPartitionThroughputInfoResultImpl(inner, this.manager());
        } else {
    ...
    public PhysicalPartitionThroughputInfoResult sqlContainerRedistributeThroughput(String resourceGroupName,
        ...
        PhysicalPartitionThroughputInfoResultInner inner = this.serviceClient()
            .sqlContainerRedistributeThroughput(resourceGroupName, accountName, databaseName, containerName,
                redistributeThroughputParameters);
        if (inner != null) {
            return new PhysicalPartitionThroughputInfoResultImpl(inner, this.manager());
        } else {
