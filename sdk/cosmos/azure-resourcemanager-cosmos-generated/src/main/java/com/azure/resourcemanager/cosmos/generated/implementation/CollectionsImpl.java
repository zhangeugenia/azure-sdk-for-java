...
public final class CollectionsImpl implements Collections {
    ...
    public PagedIterable<Metric> listMetrics(String resourceGroupName, String accountName, String databaseRid,
        ...
        PagedIterable<MetricInner> inner = this.serviceClient()
    ...
    public PagedIterable<Usage> listUsages(String resourceGroupName, String accountName, String databaseRid,
        String collectionRid, String filter, Context context) {
        PagedIterable<UsageInner> inner = this.serviceClient()
    ...
    public PagedIterable<MetricDefinition> listMetricDefinitions(String resourceGroupName, String accountName,
        ...
        PagedIterable<MetricDefinitionInner> inner = this.serviceClient()
