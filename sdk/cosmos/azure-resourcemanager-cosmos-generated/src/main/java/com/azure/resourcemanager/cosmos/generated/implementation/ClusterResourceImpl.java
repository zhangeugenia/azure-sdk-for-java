...
public final class ClusterResourceImpl implements ClusterResource, ClusterResource.Definition, ClusterResource.Update {
    ...
    public CommandPublicResource invokeCommandAsyncResource(CommandAsyncPostBody body) {
        return serviceManager.cassandraClusters().invokeCommandAsyncResource(resourceGroupName, clusterName, body);
    }

    public CommandPublicResource invokeCommandAsyncResource(CommandAsyncPostBody body, Context context) {
