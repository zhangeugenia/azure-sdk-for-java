...
public final class SqlRoleDefinitionGetResultsImpl
    ...
    public SqlRoleDefinitionGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleDefinition(roleDefinitionId, resourceGroupName, accountName,
                createCreateUpdateSqlRoleDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public SqlRoleDefinitionGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleDefinition(roleDefinitionId, resourceGroupName, accountName,
                createCreateUpdateSqlRoleDefinitionParameters, context);
        return this;
    }
    ...
    public SqlRoleDefinitionGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleDefinition(roleDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateSqlRoleDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public SqlRoleDefinitionGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlRoleDefinition(roleDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateSqlRoleDefinitionParameters, context);
        return this;
    }
