...
public class GremlinDatabaseResource implements JsonSerializable<GremlinDatabaseResource> {
     ...
     * @return An instance of GremlinDatabaseResource if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the GremlinDatabaseResource.
     */
