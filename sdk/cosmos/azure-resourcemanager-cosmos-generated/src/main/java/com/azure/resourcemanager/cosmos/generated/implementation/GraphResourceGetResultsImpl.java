...
public final class GraphResourceGetResultsImpl
    ...
    public GraphResourceGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getGraphResources()
            .createUpdateGraph(resourceGroupName, accountName, graphName, createCreateUpdateGraphParameters,
                Context.NONE);
        return this;
    }
    ...
    public GraphResourceGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGraphResources()
            .createUpdateGraph(resourceGroupName, accountName, graphName, createCreateUpdateGraphParameters, context);
        return this;
    }
    ...
    public GraphResourceGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getGraphResources()
            .createUpdateGraph(resourceGroupName, accountName, graphName, updateCreateUpdateGraphParameters,
                Context.NONE);
        return this;
    }
    ...
    public GraphResourceGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGraphResources()
            .createUpdateGraph(resourceGroupName, accountName, graphName, updateCreateUpdateGraphParameters, context);
        return this;
    }
