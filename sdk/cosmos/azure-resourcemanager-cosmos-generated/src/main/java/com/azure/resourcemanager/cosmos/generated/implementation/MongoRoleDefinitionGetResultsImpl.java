...
public final class MongoRoleDefinitionGetResultsImpl implements MongoRoleDefinitionGetResults,
    ...
    public MongoRoleDefinitionGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoRoleDefinition(mongoRoleDefinitionId, resourceGroupName, accountName,
                createCreateUpdateMongoRoleDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoRoleDefinitionGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoRoleDefinition(mongoRoleDefinitionId, resourceGroupName, accountName,
                createCreateUpdateMongoRoleDefinitionParameters, context);
        return this;
    }
    ...
    public MongoRoleDefinitionGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoRoleDefinition(mongoRoleDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateMongoRoleDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoRoleDefinitionGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoRoleDefinition(mongoRoleDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateMongoRoleDefinitionParameters, context);
        return this;
    }
