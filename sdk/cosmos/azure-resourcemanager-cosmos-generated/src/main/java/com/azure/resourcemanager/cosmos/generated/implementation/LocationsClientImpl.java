...
public final class LocationsClientImpl implements LocationsClient {
    ...
    public interface LocationsService {
        ...
        Mono<Response<LocationListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LocationGetResultInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
     ...
     * @return the List operation response, that contains Cosmos DB locations and their properties along with
    ...
    private Mono<PagedResponse<LocationGetResultInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<LocationGetResultInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
