...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CommandPublicResourceInner>>
        getCommandAsyncResourceWithResponseAsync(String resourceGroupName, String clusterName, String commandId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommandPublicResourceInner> getCommandAsyncResourceAsync(String resourceGroupName, String clusterName,
        String commandId) {
