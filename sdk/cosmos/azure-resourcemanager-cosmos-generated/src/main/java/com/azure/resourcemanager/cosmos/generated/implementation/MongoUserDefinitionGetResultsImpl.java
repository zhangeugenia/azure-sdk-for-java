...
public final class MongoUserDefinitionGetResultsImpl implements MongoUserDefinitionGetResults,
    ...
    public MongoUserDefinitionGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoUserDefinition(mongoUserDefinitionId, resourceGroupName, accountName,
                createCreateUpdateMongoUserDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoUserDefinitionGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoUserDefinition(mongoUserDefinitionId, resourceGroupName, accountName,
                createCreateUpdateMongoUserDefinitionParameters, context);
        return this;
    }
    ...
    public MongoUserDefinitionGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoUserDefinition(mongoUserDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateMongoUserDefinitionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoUserDefinitionGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoUserDefinition(mongoUserDefinitionId, resourceGroupName, accountName,
                updateCreateUpdateMongoUserDefinitionParameters, context);
        return this;
    }
