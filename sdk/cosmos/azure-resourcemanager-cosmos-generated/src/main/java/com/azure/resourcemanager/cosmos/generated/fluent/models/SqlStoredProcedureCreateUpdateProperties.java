...
public final class SqlStoredProcedureCreateUpdateProperties
     ...
     * @return An instance of SqlStoredProcedureCreateUpdateProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the SqlStoredProcedureCreateUpdateProperties.
     */
    public static SqlStoredProcedureCreateUpdateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SqlStoredProcedureCreateUpdateProperties deserializedSqlStoredProcedureCreateUpdateProperties
                = new SqlStoredProcedureCreateUpdateProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("resource".equals(fieldName)) {
                    deserializedSqlStoredProcedureCreateUpdateProperties.resource
                        = SqlStoredProcedureResource.fromJson(reader);
