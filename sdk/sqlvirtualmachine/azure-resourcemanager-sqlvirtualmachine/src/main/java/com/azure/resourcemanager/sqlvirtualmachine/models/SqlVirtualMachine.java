...
public interface SqlVirtualMachine {
     ...
     * @return the response.
     */
    SqlVmTroubleshooting troubleshoot(SqlVmTroubleshootingInner parameters);
     ...
     * @return the response.
     */
    SqlVmTroubleshooting troubleshoot(SqlVmTroubleshootingInner parameters, Context context);
}
