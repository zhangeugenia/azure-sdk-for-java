...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(SqlVirtualMachineClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for SqlVirtualMachineClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
