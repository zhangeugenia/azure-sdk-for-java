...
public final class SqlVirtualMachineGroupsClientImpl implements SqlVirtualMachineGroupsClient {
     ...
     */
    SqlVirtualMachineGroupsClientImpl(SqlVirtualMachineClientImpl client) {
    ...
    /**
     * The interface defining all the services for SqlVirtualMachineClientSqlVirtualMachineGroups to be used by the
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a SqlVirtualMachineGroup list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a SqlVirtualMachineGroup list operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SqlVirtualMachineGroupsClientImpl.class);
}
