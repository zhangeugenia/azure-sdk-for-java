...
public final class SqlVirtualMachineImpl
    ...
    public SqlVmTroubleshooting troubleshoot(SqlVmTroubleshootingInner parameters) {
        return serviceManager.sqlVirtualMachines().troubleshoot(resourceGroupName, sqlVirtualMachineName, parameters);
    }

    public SqlVmTroubleshooting troubleshoot(SqlVmTroubleshootingInner parameters, Context context) {
        return serviceManager.sqlVirtualMachines()
            .troubleshoot(resourceGroupName, sqlVirtualMachineName, parameters, context);
    }
