...
/**
 * Initializes a new instance of the SqlVirtualMachineClientImpl type.
 */
@ServiceClient(builder = SqlVirtualMachineClientBuilder.class)
public final class SqlVirtualMachineClientImpl implements SqlVirtualMachineClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of SqlVirtualMachineClient client.
     * 
     ...
     */
    SqlVirtualMachineClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SqlVirtualMachineClientImpl.class);
}
