...
public final class CacheRulesClientImpl implements CacheRulesClient {
    ...
    public interface CacheRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CacheRulesListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CacheRuleInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("cacheRuleName") String cacheRuleName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CacheRulesListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to list cache rules for a container registry along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CacheRuleInner> listSinglePage(String resourceGroupName, String registryName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<CacheRulesListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    public Response<CacheRuleInner> getWithResponse(String resourceGroupName, String registryName, String cacheRuleName,
        ...
        if (cacheRuleName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter cacheRuleName is required and cannot be null."));
        }
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an object that represents a cache rule for a container registry along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName, String cacheRuleName,
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, cacheRuleName, cacheRuleCreateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CacheRuleInner>, CacheRuleInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, cacheRuleName, cacheRuleCreateParameters);
        return this.client.<CacheRuleInner, CacheRuleInner>getLroResult(response, CacheRuleInner.class,
            CacheRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CacheRuleInner>, CacheRuleInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, cacheRuleName, cacheRuleCreateParameters, context);
        return this.client.<CacheRuleInner, CacheRuleInner>getLroResult(response, CacheRuleInner.class,
            CacheRuleInner.class, context);
    }
    ...
    public CacheRuleInner create(String resourceGroupName, String registryName, String cacheRuleName,
        CacheRuleInner cacheRuleCreateParameters) {
        return beginCreate(resourceGroupName, registryName, cacheRuleName, cacheRuleCreateParameters).getFinalResult();
    }
    ...
    public CacheRuleInner create(String resourceGroupName, String registryName, String cacheRuleName,
        CacheRuleInner cacheRuleCreateParameters, Context context) {
        return beginCreate(resourceGroupName, registryName, cacheRuleName, cacheRuleCreateParameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, cacheRuleName, accept, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName, String cacheRuleName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String cacheRuleName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, cacheRuleName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, cacheRuleName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String cacheRuleName) {
        beginDelete(resourceGroupName, registryName, cacheRuleName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String cacheRuleName, Context context) {
        beginDelete(resourceGroupName, registryName, cacheRuleName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName, String cacheRuleName,
        ...
        return service.updateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, cacheRuleName, cacheRuleUpdateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CacheRuleInner>, CacheRuleInner> beginUpdate(String resourceGroupName,
        String registryName, String cacheRuleName, CacheRuleUpdateParameters cacheRuleUpdateParameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, registryName, cacheRuleName, cacheRuleUpdateParameters);
        return this.client.<CacheRuleInner, CacheRuleInner>getLroResult(response, CacheRuleInner.class,
            CacheRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<CacheRuleInner>, CacheRuleInner> beginUpdate(String resourceGroupName,
        ...
        Context context) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, registryName, cacheRuleName, cacheRuleUpdateParameters, context);
        return this.client.<CacheRuleInner, CacheRuleInner>getLroResult(response, CacheRuleInner.class,
            CacheRuleInner.class, context);
    }
    ...
    public CacheRuleInner update(String resourceGroupName, String registryName, String cacheRuleName,
        CacheRuleUpdateParameters cacheRuleUpdateParameters) {
        return beginUpdate(resourceGroupName, registryName, cacheRuleName, cacheRuleUpdateParameters).getFinalResult();
    }
    ...
    public CacheRuleInner update(String resourceGroupName, String registryName, String cacheRuleName,
        CacheRuleUpdateParameters cacheRuleUpdateParameters, Context context) {
        return beginUpdate(resourceGroupName, registryName, cacheRuleName, cacheRuleUpdateParameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CacheRuleInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<CacheRulesListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CacheRuleInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<CacheRulesListResult> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(CacheRulesClientImpl.class);
}
