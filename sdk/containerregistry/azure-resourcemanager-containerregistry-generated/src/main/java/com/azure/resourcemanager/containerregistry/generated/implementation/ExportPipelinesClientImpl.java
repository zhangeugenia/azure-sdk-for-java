...
public final class ExportPipelinesClientImpl implements ExportPipelinesClient {
    ...
    private PagedResponse<ExportPipelineInner> listSinglePage(String resourceGroupName, String registryName) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<ExportPipelineListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName,
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, exportPipelineName, exportPipelineCreateParameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, exportPipelineName, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String exportPipelineName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, exportPipelineName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String exportPipelineName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, registryName, exportPipelineName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String exportPipelineName) {
        beginDelete(resourceGroupName, registryName, exportPipelineName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String exportPipelineName, Context context) {
        beginDelete(resourceGroupName, registryName, exportPipelineName, context).getFinalResult();
    }
