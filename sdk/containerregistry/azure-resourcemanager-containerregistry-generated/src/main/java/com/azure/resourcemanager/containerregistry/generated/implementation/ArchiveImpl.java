...
public final class ArchiveImpl implements Archive, Archive.Definition, Archive.Update {
    ...
    public Archive apply() {
        this.innerObject = serviceManager.serviceClient()
            .getArchives()
            .updateWithResponse(resourceGroupName, registryName, packageType, archiveName,
                updateArchiveUpdateParameters, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Archive apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getArchives()
            .updateWithResponse(resourceGroupName, registryName, packageType, archiveName,
                updateArchiveUpdateParameters, context)
            .getValue();
        return this;
    }
