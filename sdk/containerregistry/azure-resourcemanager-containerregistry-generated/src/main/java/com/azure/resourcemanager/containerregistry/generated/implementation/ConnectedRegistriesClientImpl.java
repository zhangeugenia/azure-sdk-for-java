...
public final class ConnectedRegistriesClientImpl implements ConnectedRegistriesClient {
    ...
    public interface ConnectedRegistriesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectedRegistryInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("connectedRegistryName") String connectedRegistryName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectedRegistryListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> deactivateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("connectedRegistryName") String connectedRegistryName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectedRegistryListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ConnectedRegistryInner> getWithResponse(String resourceGroupName, String registryName,
        ...
        if (connectedRegistryName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter connectedRegistryName is required and cannot be null."));
        }
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName,
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, connectedRegistryName, connectedRegistryCreateParameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectedRegistryInner>, ConnectedRegistryInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response = createWithResponse(resourceGroupName, registryName, connectedRegistryName,
            connectedRegistryCreateParameters);
        return this.client.<ConnectedRegistryInner, ConnectedRegistryInner>getLroResult(response,
            ConnectedRegistryInner.class, ConnectedRegistryInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectedRegistryInner>, ConnectedRegistryInner> beginCreate(String resourceGroupName,
        ...
        return this.client.<ConnectedRegistryInner, ConnectedRegistryInner>getLroResult(response,
            ConnectedRegistryInner.class, ConnectedRegistryInner.class, context);
    }
    ...
    public ConnectedRegistryInner create(String resourceGroupName, String registryName, String connectedRegistryName,
        ConnectedRegistryInner connectedRegistryCreateParameters) {
        return beginCreate(resourceGroupName, registryName, connectedRegistryName, connectedRegistryCreateParameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName,
        ...
        return service.updateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, connectedRegistryName, connectedRegistryUpdateParameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectedRegistryInner>, ConnectedRegistryInner> beginUpdate(String resourceGroupName,
        ...
        ConnectedRegistryUpdateParameters connectedRegistryUpdateParameters) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, registryName, connectedRegistryName,
    ...
    public ConnectedRegistryInner update(String resourceGroupName, String registryName, String connectedRegistryName,
        ConnectedRegistryUpdateParameters connectedRegistryUpdateParameters) {
        return beginUpdate(resourceGroupName, registryName, connectedRegistryName, connectedRegistryUpdateParameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, connectedRegistryName, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String connectedRegistryName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, connectedRegistryName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, registryName, connectedRegistryName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String connectedRegistryName) {
        beginDelete(resourceGroupName, registryName, connectedRegistryName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String connectedRegistryName, Context context) {
        beginDelete(resourceGroupName, registryName, connectedRegistryName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectedRegistryInner> listSinglePage(String resourceGroupName, String registryName,
        String filter) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<ConnectedRegistryListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, registryName, filter, accept, Context.NONE);
    ...
    public PagedIterable<ConnectedRegistryInner> list(String resourceGroupName, String registryName) {
        final String filter = null;
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, registryName, filter),
    ...
    public PagedIterable<ConnectedRegistryInner> list(String resourceGroupName, String registryName, String filter,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, registryName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deactivateWithResponse(String resourceGroupName, String registryName,
        String connectedRegistryName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        return service.deactivateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, connectedRegistryName, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeactivate(String resourceGroupName, String registryName,
        String connectedRegistryName) {
        Response<BinaryData> response = deactivateWithResponse(resourceGroupName, registryName, connectedRegistryName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeactivate(String resourceGroupName, String registryName,
        String connectedRegistryName, Context context) {
        Response<BinaryData> response
            = deactivateWithResponse(resourceGroupName, registryName, connectedRegistryName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void deactivate(String resourceGroupName, String registryName, String connectedRegistryName) {
        beginDeactivate(resourceGroupName, registryName, connectedRegistryName).getFinalResult();
    }
    ...
    public void deactivate(String resourceGroupName, String registryName, String connectedRegistryName,
        Context context) {
        beginDeactivate(resourceGroupName, registryName, connectedRegistryName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectedRegistryInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ConnectedRegistryListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectedRegistryInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ConnectedRegistriesClientImpl.class);
}
