...
public final class ConnectedRegistriesClientImpl implements ConnectedRegistriesClient {
    ...
    private PagedResponse<ConnectedRegistryInner> listSinglePage(String resourceGroupName, String registryName,
        ...
        Response<ConnectedRegistryListResult> res
            = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, registryName, filter, accept, Context.NONE);
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, registryName, connectedRegistryName,
            connectedRegistryCreateParameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName,
        ...
        return service.updateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, registryName, connectedRegistryName,
            connectedRegistryUpdateParameters, accept, Context.NONE);
    }
