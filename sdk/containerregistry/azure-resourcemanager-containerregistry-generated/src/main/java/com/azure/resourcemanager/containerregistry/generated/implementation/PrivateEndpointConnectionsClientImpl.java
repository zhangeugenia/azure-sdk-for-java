...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    private PagedResponse<PrivateEndpointConnectionInner> listSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<PrivateEndpointConnectionListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PrivateEndpointConnectionInner> listSinglePage(String resourceGroupName, String registryName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String registryName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, privateEndpointConnectionName, privateEndpointConnection, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PrivateEndpointConnectionInner>, PrivateEndpointConnectionInner> beginCreateOrUpdate(
        ...
        PrivateEndpointConnectionInner privateEndpointConnection) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, registryName,
            privateEndpointConnectionName, privateEndpointConnection);
    ...
    public PrivateEndpointConnectionInner createOrUpdate(String resourceGroupName, String registryName,
        String privateEndpointConnectionName, PrivateEndpointConnectionInner privateEndpointConnection) {
        return beginCreateOrUpdate(resourceGroupName, registryName, privateEndpointConnectionName,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, privateEndpointConnectionName, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, registryName, privateEndpointConnectionName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String privateEndpointConnectionName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, registryName, privateEndpointConnectionName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String privateEndpointConnectionName) {
        beginDelete(resourceGroupName, registryName, privateEndpointConnectionName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String privateEndpointConnectionName,
        Context context) {
        beginDelete(resourceGroupName, registryName, privateEndpointConnectionName, context).getFinalResult();
    }
