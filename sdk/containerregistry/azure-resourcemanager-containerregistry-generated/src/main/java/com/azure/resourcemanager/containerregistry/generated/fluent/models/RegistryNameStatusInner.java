...
public final class RegistryNameStatusInner implements JsonSerializable<RegistryNameStatusInner> {
    ...
    /**
     * Set the availableLoginServerName property: The complete login server name with domain name label (DNL) hash, if
     * available.
     * 
     * @param availableLoginServerName the availableLoginServerName value to set.
     * @return the RegistryNameStatusInner object itself.
     */
    public RegistryNameStatusInner withAvailableLoginServerName(String availableLoginServerName) {
        this.availableLoginServerName = availableLoginServerName;
        return this;
    }
