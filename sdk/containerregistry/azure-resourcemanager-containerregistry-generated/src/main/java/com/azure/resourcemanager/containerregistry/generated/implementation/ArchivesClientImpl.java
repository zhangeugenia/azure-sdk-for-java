...
public final class ArchivesClientImpl implements ArchivesClient {
    ...
    public interface ArchivesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ArchiveListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("packageType") String packageType, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ArchiveInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("packageType") String packageType, @PathParam("archiveName") String archiveName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ArchiveInner> updateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("packageType") String packageType, @PathParam("archiveName") String archiveName,
            @BodyParam("application/json") ArchiveUpdateParameters archiveUpdateParameters,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ArchiveListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to list archives for a container registry along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ArchiveInner> listSinglePage(String resourceGroupName, String registryName,
        String packageType) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<ArchiveListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, registryName, packageType, accept, Context.NONE);
    ...
    public PagedIterable<ArchiveInner> list(String resourceGroupName, String registryName, String packageType) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, registryName, packageType),
    ...
    public PagedIterable<ArchiveInner> list(String resourceGroupName, String registryName, String packageType,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, registryName, packageType, context),
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName, String packageType,
        ...
        if (archiveCreateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter archiveCreateParameters is required and cannot be null."));
        } else {
            archiveCreateParameters.validate();
        }
        final String apiVersion = "2025-05-01-preview";
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ArchiveInner>, ArchiveInner> beginCreate(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters);
        return this.client.<ArchiveInner, ArchiveInner>getLroResult(response, ArchiveInner.class, ArchiveInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ArchiveInner>, ArchiveInner> beginCreate(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response = createWithResponse(resourceGroupName, registryName, packageType, archiveName,
            archiveCreateParameters, context);
        return this.client.<ArchiveInner, ArchiveInner>getLroResult(response, ArchiveInner.class, ArchiveInner.class,
            context);
    }
    ...
    public ArchiveInner create(String resourceGroupName, String registryName, String packageType, String archiveName,
        ...
        return beginCreate(resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters)
            .getFinalResult();
    }
    ...
    public ArchiveInner create(String resourceGroupName, String registryName, String packageType, String archiveName,
        ...
        return beginCreate(resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters, context)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, registryName, packageType, archiveName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String packageType, String archiveName) {
        beginDelete(resourceGroupName, registryName, packageType, archiveName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String packageType, String archiveName,
        Context context) {
        beginDelete(resourceGroupName, registryName, packageType, archiveName, context).getFinalResult();
    }
    ...
    public Response<ArchiveInner> updateWithResponse(String resourceGroupName, String registryName, String packageType,
        ...
        if (archiveUpdateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter archiveUpdateParameters is required and cannot be null."));
        } else {
            archiveUpdateParameters.validate();
        }
        final String apiVersion = "2025-05-01-preview";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ArchiveInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ArchiveListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ArchiveInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ArchiveListResult> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(ArchivesClientImpl.class);
}
