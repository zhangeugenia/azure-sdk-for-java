...
public final class RunsClientImpl implements RunsClient {
    ...
    public interface RunsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RunListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @QueryParam("$filter") String filter,
            @QueryParam("$top") Integer top, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RunInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @PathParam("runId") String runId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RunInner> updateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @PathParam("runId") String runId,
            @BodyParam("application/json") RunUpdateParameters runUpdateParameters,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RunGetLogResultInner> getLogSasUrlSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @PathParam("runId") String runId,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<RunInner> listSinglePage(String resourceGroupName, String registryName, String filter,
        ...
        final String accept = "application/json";
        Response<RunListResult> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, registryName, this.client.getApiVersion(), filter, top, accept, Context.NONE);
    ...
    public Response<RunInner> updateWithResponse(String resourceGroupName, String registryName, String runId,
        ...
        if (runUpdateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter runUpdateParameters is required and cannot be null."));
        } else {
            runUpdateParameters.validate();
        }
        final String accept = "application/json";
    ...
    public Response<RunGetLogResultInner> getLogSasUrlWithResponse(String resourceGroupName, String registryName,
        ...
        final String accept = "application/json";
        return service.getLogSasUrlSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            registryName, this.client.getApiVersion(), runId, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of runs along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RunsClientImpl.class);
}
