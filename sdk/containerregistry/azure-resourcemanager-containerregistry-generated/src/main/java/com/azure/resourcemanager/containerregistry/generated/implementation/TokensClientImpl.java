...
public final class TokensClientImpl implements TokensClient {
    ...
    private PagedResponse<TokenInner> listSinglePage(String resourceGroupName, String registryName) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<TokenListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName, String tokenName,
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, tokenName, tokenCreateParameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName, String tokenName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, tokenName, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName, String tokenName,
        ...
        return service.updateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, tokenName, tokenUpdateParameters, accept, Context.NONE);
    }
