...
public final class ReplicationsClientImpl implements ReplicationsClient {
    ...
    public interface ReplicationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("replicationName") String replicationName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to list replications for a container registry along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationInner> listSinglePage(String resourceGroupName, String registryName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<ReplicationListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    public Response<ReplicationInner> getWithResponse(String resourceGroupName, String registryName,
        ...
        if (replicationName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter replicationName is required and cannot be null."));
        }
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an object that represents a replication for a container registry along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName,
        ...
        if (replication == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter replication is required and cannot be null."));
        } else {
            replication.validate();
        }
        final String apiVersion = "2025-05-01-preview";
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, replicationName, replication, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationInner>, ReplicationInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, replicationName, replication);
        return this.client.<ReplicationInner, ReplicationInner>getLroResult(response, ReplicationInner.class,
            ReplicationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationInner>, ReplicationInner> beginCreate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, replicationName, replication, context);
        return this.client.<ReplicationInner, ReplicationInner>getLroResult(response, ReplicationInner.class,
            ReplicationInner.class, context);
    }
    ...
    public ReplicationInner create(String resourceGroupName, String registryName, String replicationName,
        ReplicationInner replication) {
        return beginCreate(resourceGroupName, registryName, replicationName, replication).getFinalResult();
    }
    ...
    public ReplicationInner create(String resourceGroupName, String registryName, String replicationName,
        ...
        return beginCreate(resourceGroupName, registryName, replicationName, replication, context).getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, replicationName, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String replicationName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, replicationName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String replicationName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, replicationName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String replicationName) {
        beginDelete(resourceGroupName, registryName, replicationName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String replicationName, Context context) {
        beginDelete(resourceGroupName, registryName, replicationName, context).getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName,
        ...
        return service.updateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, replicationName, replicationUpdateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationInner>, ReplicationInner> beginUpdate(String resourceGroupName,
        String registryName, String replicationName, ReplicationUpdateParameters replicationUpdateParameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, registryName, replicationName, replicationUpdateParameters);
        return this.client.<ReplicationInner, ReplicationInner>getLroResult(response, ReplicationInner.class,
            ReplicationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationInner>, ReplicationInner> beginUpdate(String resourceGroupName,
        String registryName, String replicationName, ReplicationUpdateParameters replicationUpdateParameters,
        Context context) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, registryName, replicationName,
    ...
    public ReplicationInner update(String resourceGroupName, String registryName, String replicationName,
        ReplicationUpdateParameters replicationUpdateParameters) {
        return beginUpdate(resourceGroupName, registryName, replicationName, replicationUpdateParameters)
            .getFinalResult();
    }
    ...
    public ReplicationInner update(String resourceGroupName, String registryName, String replicationName,
        ...
        return beginUpdate(resourceGroupName, registryName, replicationName, replicationUpdateParameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ReplicationListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ReplicationsClientImpl.class);
}
