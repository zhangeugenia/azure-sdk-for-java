...
public final class WebhooksClientImpl implements WebhooksClient {
    ...
    public interface WebhooksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebhookListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebhookInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("webhookName") String webhookName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EventInfoInner> pingSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("webhookName") String webhookName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EventListResult> listEventsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("webhookName") String webhookName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CallbackConfigInner> getCallbackConfigSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("webhookName") String webhookName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebhookListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EventListResult> listEventsNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to list webhooks for a container registry along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebhookInner> listSinglePage(String resourceGroupName, String registryName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<WebhookListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebhookInner> listSinglePage(String resourceGroupName, String registryName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public Response<WebhookInner> getWithResponse(String resourceGroupName, String registryName, String webhookName,
        ...
        if (webhookName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter webhookName is required and cannot be null."));
        }
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an object that represents a webhook for a container registry along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName, String webhookName,
        ...
        if (webhookCreateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter webhookCreateParameters is required and cannot be null."));
        } else {
            webhookCreateParameters.validate();
        }
        final String apiVersion = "2025-05-01-preview";
        ...
        return service.createSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, webhookCreateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<WebhookInner>, WebhookInner> beginCreate(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, webhookName, webhookCreateParameters);
        return this.client.<WebhookInner, WebhookInner>getLroResult(response, WebhookInner.class, WebhookInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<WebhookInner>, WebhookInner> beginCreate(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, webhookName, webhookCreateParameters, context);
        return this.client.<WebhookInner, WebhookInner>getLroResult(response, WebhookInner.class, WebhookInner.class,
            context);
    }
    ...
    public WebhookInner create(String resourceGroupName, String registryName, String webhookName,
        WebhookCreateParameters webhookCreateParameters) {
        return beginCreate(resourceGroupName, registryName, webhookName, webhookCreateParameters).getFinalResult();
    }
    ...
    public WebhookInner create(String resourceGroupName, String registryName, String webhookName,
        WebhookCreateParameters webhookCreateParameters, Context context) {
        return beginCreate(resourceGroupName, registryName, webhookName, webhookCreateParameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName, String webhookName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        String webhookName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, webhookName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, registryName, webhookName, context);
    ...
    public void delete(String resourceGroupName, String registryName, String webhookName) {
        beginDelete(resourceGroupName, registryName, webhookName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String webhookName, Context context) {
        beginDelete(resourceGroupName, registryName, webhookName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName, String webhookName,
        ...
        if (webhookUpdateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter webhookUpdateParameters is required and cannot be null."));
        } else {
            webhookUpdateParameters.validate();
        }
        final String apiVersion = "2025-05-01-preview";
        ...
        return service.updateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, webhookUpdateParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<WebhookInner>, WebhookInner> beginUpdate(String resourceGroupName, String registryName,
        String webhookName, WebhookUpdateParameters webhookUpdateParameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, registryName, webhookName, webhookUpdateParameters);
        return this.client.<WebhookInner, WebhookInner>getLroResult(response, WebhookInner.class, WebhookInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<WebhookInner>, WebhookInner> beginUpdate(String resourceGroupName, String registryName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, registryName, webhookName, webhookUpdateParameters, context);
        return this.client.<WebhookInner, WebhookInner>getLroResult(response, WebhookInner.class, WebhookInner.class,
            context);
    }
    ...
    public WebhookInner update(String resourceGroupName, String registryName, String webhookName,
        WebhookUpdateParameters webhookUpdateParameters) {
        return beginUpdate(resourceGroupName, registryName, webhookName, webhookUpdateParameters).getFinalResult();
    }
    ...
    public WebhookInner update(String resourceGroupName, String registryName, String webhookName,
        WebhookUpdateParameters webhookUpdateParameters, Context context) {
        return beginUpdate(resourceGroupName, registryName, webhookName, webhookUpdateParameters, context)
            .getFinalResult();
    }
    ...
    public Response<EventInfoInner> pingWithResponse(String resourceGroupName, String registryName, String webhookName,
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        return service.pingSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to list events for a webhook along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EventInner> listEventsSinglePage(String resourceGroupName, String registryName,
        String webhookName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        Response<EventListResult> res = service.listEventsSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, registryName, webhookName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<EventInner> listEvents(String resourceGroupName, String registryName, String webhookName) {
        return new PagedIterable<>(() -> listEventsSinglePage(resourceGroupName, registryName, webhookName),
            nextLink -> listEventsNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<EventInner> listEvents(String resourceGroupName, String registryName, String webhookName,
        Context context) {
        return new PagedIterable<>(() -> listEventsSinglePage(resourceGroupName, registryName, webhookName, context),
            nextLink -> listEventsNextSinglePage(nextLink, context));
    }
    ...
    public Response<CallbackConfigInner> getCallbackConfigWithResponse(String resourceGroupName, String registryName,
        ...
        final String apiVersion = "2025-05-01-preview";
        final String accept = "application/json";
        return service.getCallbackConfigSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebhookInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebhookInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<WebhookListResult> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EventInner> listEventsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<EventListResult> res
            = service.listEventsNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<EventInner> listEventsNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<EventListResult> res
            = service.listEventsNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(WebhooksClientImpl.class);
}
