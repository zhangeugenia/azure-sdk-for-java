...
public final class WebhooksClientImpl implements WebhooksClient {
    ...
    private PagedResponse<WebhookInner> listSinglePage(String resourceGroupName, String registryName) {
        ...
        final String accept = "application/json";
        Response<WebhookListResult> res = service.listSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String registryName, String webhookName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, registryName, webhookName, Context.NONE);
    }
    ...
    public Response<EventInfoInner> pingWithResponse(String resourceGroupName, String registryName, String webhookName,
        ...
        final String accept = "application/json";
        return service.pingSync(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, registryName, webhookName, accept, context);
    }
    ...
    private PagedResponse<EventInner> listEventsSinglePage(String resourceGroupName, String registryName,
        ...
        final String accept = "application/json";
        Response<EventListResult> res = service.listEventsSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public Response<CallbackConfigInner> getCallbackConfigWithResponse(String resourceGroupName, String registryName,
        ...
        final String accept = "application/json";
        return service.getCallbackConfigSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, registryName, webhookName, accept, context);
    }
