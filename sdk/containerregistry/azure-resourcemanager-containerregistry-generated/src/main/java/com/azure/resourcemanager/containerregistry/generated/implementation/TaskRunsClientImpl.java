...
public final class TaskRunsClientImpl implements TaskRunsClient {
    ...
    public interface TaskRunsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TaskRunInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @PathParam("taskRunName") String taskRunName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TaskRunInner> getDetailsSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @PathParam("taskRunName") String taskRunName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TaskRunListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<TaskRunInner> getWithResponse(String resourceGroupName, String registryName, String taskRunName,
        ...
        if (taskRunName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter taskRunName is required and cannot be null."));
        }
        final String accept = "application/json";
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the task run that has the ARM resource and properties along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName, String taskRunName,
        ...
        if (taskRun == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter taskRun is required and cannot be null."));
        } else {
            taskRun.validate();
        }
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            registryName, this.client.getApiVersion(), taskRunName, taskRun, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String registryName, String taskRunName,
        ...
        if (updateParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter updateParameters is required and cannot be null."));
        } else {
            updateParameters.validate();
        }
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            registryName, this.client.getApiVersion(), taskRunName, updateParameters, accept, Context.NONE);
    }
    ...
    private PagedResponse<TaskRunInner> listSinglePage(String resourceGroupName, String registryName) {
        ...
        final String accept = "application/json";
        Response<TaskRunListResult> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, registryName, this.client.getApiVersion(), accept, Context.NONE);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(TaskRunsClientImpl.class);
}
