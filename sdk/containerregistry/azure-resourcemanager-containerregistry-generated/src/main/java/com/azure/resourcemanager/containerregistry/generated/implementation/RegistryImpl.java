...
public final class RegistryImpl implements Registry, Registry.Definition, Registry.Update {
    ...
    public Boolean networkRuleBypassAllowedForTasks() {
        return this.innerModel().networkRuleBypassAllowedForTasks();
    }
    ...
    public Response<Run> scheduleRunWithResponse(RunRequest runRequest, Context context) {
        return serviceManager.registries()
            .scheduleRunWithResponse(resourceGroupName, registryName, runRequest, context);
    }
    ...
    public RegistryImpl withNetworkRuleBypassAllowedForTasks(Boolean networkRuleBypassAllowedForTasks) {
        if (isInCreateMode()) {
            this.innerModel().withNetworkRuleBypassAllowedForTasks(networkRuleBypassAllowedForTasks);
            return this;
        } else {
