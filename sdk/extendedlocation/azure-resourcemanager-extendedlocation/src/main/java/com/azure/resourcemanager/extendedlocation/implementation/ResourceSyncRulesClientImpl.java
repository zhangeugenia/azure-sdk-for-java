...
public final class ResourceSyncRulesClientImpl implements ResourceSyncRulesClient {
    ...
    public interface ResourceSyncRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceSyncRuleInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("childResourceName") String childResourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceSyncRuleInner>> updateWithResponseAsync(String resourceGroupName, String resourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResourceSyncRuleInner> updateWithResponse(String resourceGroupName, String resourceName,
        String childResourceName, PatchableResourceSyncRule parameters, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a ResourceSyncRule list operation along with {@link PagedResponse} on successful
