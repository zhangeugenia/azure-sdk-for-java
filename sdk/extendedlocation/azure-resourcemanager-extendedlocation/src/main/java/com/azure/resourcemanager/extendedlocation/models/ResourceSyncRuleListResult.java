...
public final class ResourceSyncRuleListResult implements JsonSerializable<ResourceSyncRuleListResult> {
    ...
    /**
     * Get the value property: The ResourceSyncRule items on this page.
     * 
    ...
    /**
     * Set the value property: The ResourceSyncRule items on this page.
     * 
     * @param value the value value to set.
     * @return the ResourceSyncRuleListResult object itself.
     */
    public ResourceSyncRuleListResult withValue(List<ResourceSyncRuleInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ResourceSyncRuleListResult object itself.
     */
    public ResourceSyncRuleListResult withNextLink(String nextLink) {
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model ResourceSyncRuleListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ResourceSyncRuleListResult.class);
