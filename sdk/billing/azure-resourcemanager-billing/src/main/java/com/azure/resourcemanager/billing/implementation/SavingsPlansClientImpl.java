...
public final class SavingsPlansClientImpl implements SavingsPlansClient {
    ...
    public interface SavingsPlansService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SavingsPlanModelList> listBySavingsPlanOrderSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("savingsPlanOrderId") String savingsPlanOrderId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SavingsPlanModelListResult> listByBillingAccountSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName, @QueryParam("api-version") String apiVersion,
            @QueryParam("filter") String filter, @QueryParam("orderBy") String orderBy,
            @QueryParam("skiptoken") Float skiptoken, @QueryParam("take") Float take,
            @QueryParam("selectedState") String selectedState, @QueryParam("refreshSummary") String refreshSummary,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SavingsPlanModelInner> getByBillingAccountSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("savingsPlanOrderId") String savingsPlanOrderId,
            @PathParam("savingsPlanId") String savingsPlanId, @QueryParam("api-version") String apiVersion,
            @QueryParam("expand") String expand, @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<SavingsPlanModelInner> listBySavingsPlanOrderSinglePage(String billingAccountName,
        ...
        Response<SavingsPlanModelList> res = service.listBySavingsPlanOrderSync(this.client.getEndpoint(),
            billingAccountName, savingsPlanOrderId, this.client.getApiVersion(), accept, Context.NONE);
    ...
    private PagedResponse<SavingsPlanModelInner> listBySavingsPlanOrderSinglePage(String billingAccountName,
        ...
        final String accept = "application/json";
        Response<SavingsPlanModelList> res = service.listBySavingsPlanOrderSync(this.client.getEndpoint(),
            billingAccountName, savingsPlanOrderId, this.client.getApiVersion(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<SavingsPlanModelInner> listByBillingAccountSinglePage(String billingAccountName,
        ...
        Response<SavingsPlanModelListResult> res = service.listByBillingAccountSync(this.client.getEndpoint(),
            billingAccountName, this.client.getApiVersion(), filter, orderBy, skiptoken, take, selectedState,
    ...
    private Response<BinaryData> updateByBillingAccountWithResponse(String billingAccountName,
        ...
        final String accept = "application/json";
        return service.updateByBillingAccountSync(this.client.getEndpoint(), billingAccountName, savingsPlanOrderId,
            savingsPlanId, this.client.getApiVersion(), body, accept, Context.NONE);
    }
    ...
    public Response<SavingsPlanValidateResponseInner> validateUpdateByBillingAccountWithResponse(
        ...
        final String accept = "application/json";
        return service.validateUpdateByBillingAccountSync(this.client.getEndpoint(), billingAccountName,
            savingsPlanOrderId, savingsPlanId, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SavingsPlansClientImpl.class);
}
