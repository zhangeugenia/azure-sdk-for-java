...
public interface AccessClient {
    ...
    Response<AccessListUsersSuccessResponseInner> listUsersWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListUsersSuccessResponseInner listUsers(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessListServiceAccountsSuccessResponseInner> listServiceAccountsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListServiceAccountsSuccessResponseInner listServiceAccounts(
        String resourceGroupName, String organizationName, ListAccessRequestModel body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessListInvitationsSuccessResponseInner> listInvitationsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListInvitationsSuccessResponseInner listInvitations(
        String resourceGroupName, String organizationName, ListAccessRequestModel body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<InvitationRecordInner> inviteUserWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InvitationRecordInner inviteUser(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessListEnvironmentsSuccessResponseInner> listEnvironmentsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListEnvironmentsSuccessResponseInner listEnvironments(
        String resourceGroupName, String organizationName, ListAccessRequestModel body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessListClusterSuccessResponseInner> listClustersWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListClusterSuccessResponseInner listClusters(
        String resourceGroupName, String organizationName, ListAccessRequestModel body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessListRoleBindingsSuccessResponseInner> listRoleBindingsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccessListRoleBindingsSuccessResponseInner listRoleBindings(
        String resourceGroupName, String organizationName, ListAccessRequestModel body);
}
