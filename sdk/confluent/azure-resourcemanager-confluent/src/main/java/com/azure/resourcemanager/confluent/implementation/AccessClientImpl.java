...
public final class AccessClientImpl implements AccessClient {
    ...
    public interface AccessService {
        ...
        Mono<Response<AccessListUsersSuccessResponseInner>> listUsers(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("organizationName") String organizationName,
            @BodyParam("application/json") ListAccessRequestModel body,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessListInvitationsSuccessResponseInner>> listInvitations(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InvitationRecordInner>> inviteUser(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("organizationName") String organizationName,
            @BodyParam("application/json") AccessInviteUserAccountModel body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessListEnvironmentsSuccessResponseInner>> listEnvironments(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessListClusterSuccessResponseInner>> listClusters(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessListRoleBindingsSuccessResponseInner>> listRoleBindings(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<AccessListUsersSuccessResponseInner>> listUsersWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListUsersSuccessResponseInner> listUsersAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessListUsersSuccessResponseInner> listUsersWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListUsersSuccessResponseInner listUsers(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list service accounts success response along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListServiceAccountsSuccessResponseInner> listServiceAccountsAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListServiceAccountsSuccessResponseInner listServiceAccounts(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListInvitationsSuccessResponseInner> listInvitationsAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessListInvitationsSuccessResponseInner> listInvitationsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListInvitationsSuccessResponseInner listInvitations(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<InvitationRecordInner>> inviteUserWithResponseAsync(
        String resourceGroupName, String organizationName, AccessInviteUserAccountModel body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<InvitationRecordInner>> inviteUserWithResponseAsync(
        String resourceGroupName, String organizationName, AccessInviteUserAccountModel body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<InvitationRecordInner> inviteUserAsync(
        String resourceGroupName, String organizationName, AccessInviteUserAccountModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<InvitationRecordInner> inviteUserWithResponse(
        String resourceGroupName, String organizationName, AccessInviteUserAccountModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public InvitationRecordInner inviteUser(
        String resourceGroupName, String organizationName, AccessInviteUserAccountModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListEnvironmentsSuccessResponseInner> listEnvironmentsAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessListEnvironmentsSuccessResponseInner> listEnvironmentsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListEnvironmentsSuccessResponseInner listEnvironments(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListClusterSuccessResponseInner> listClustersAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessListClusterSuccessResponseInner> listClustersWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListClusterSuccessResponseInner listClusters(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessListRoleBindingsSuccessResponseInner> listRoleBindingsAsync(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessListRoleBindingsSuccessResponseInner> listRoleBindingsWithResponse(
        String resourceGroupName, String organizationName, ListAccessRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessListRoleBindingsSuccessResponseInner listRoleBindings(
        String resourceGroupName, String organizationName, ListAccessRequestModel body) {
