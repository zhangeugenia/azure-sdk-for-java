...
public final class EnterpriseMccCacheNodesOperationsClientImpl implements EnterpriseMccCacheNodesOperationsClient {
    ...
    private Mono<Response<MccCacheNodeAutoUpdateHistoryInner>> getCacheNodeAutoUpdateHistoryWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getCacheNodeAutoUpdateHistory(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, customerResourceName, cacheNodeResourceName, accept,
            context);
    }
    ...
    private Mono<Response<MccCacheNodeIssueHistoryInner>> getCacheNodeMccIssueDetailsHistoryWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getCacheNodeMccIssueDetailsHistory(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, customerResourceName, cacheNodeResourceName, accept,
            context);
    }
    ...
    private Mono<Response<MccCacheNodeTlsCertificateHistoryInner>> getCacheNodeTlsCertificateHistoryWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getCacheNodeTlsCertificateHistory(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, customerResourceName, cacheNodeResourceName, accept,
            context);
    }
