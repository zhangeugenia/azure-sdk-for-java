...
public final class ManagedResourceGroupConfiguration implements JsonSerializable<ManagedResourceGroupConfiguration> {
    ...
    /**
     * Get the name property: The resource group name.
     * 
    ...
    /**
     * Set the name property: The resource group name.
     * 
    ...
    /**
     * Get the location property: The resource group location.
     * 
    ...
    /**
     * Set the location property: The resource group location.
     * 
