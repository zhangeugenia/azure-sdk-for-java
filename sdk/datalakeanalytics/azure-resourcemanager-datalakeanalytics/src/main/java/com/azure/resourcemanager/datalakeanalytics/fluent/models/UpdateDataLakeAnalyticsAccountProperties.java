...
public final class UpdateDataLakeAnalyticsAccountProperties
     ...
     * @return the UpdateDataLakeAnalyticsAccountProperties object itself.
     */
    public UpdateDataLakeAnalyticsAccountProperties withMixedTokensMode(MixedTokensMode mixedTokensMode) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("dataLakeStoreAccounts".equals(fieldName)) {
                    ...
                    deserializedUpdateDataLakeAnalyticsAccountProperties.mixedTokensMode
