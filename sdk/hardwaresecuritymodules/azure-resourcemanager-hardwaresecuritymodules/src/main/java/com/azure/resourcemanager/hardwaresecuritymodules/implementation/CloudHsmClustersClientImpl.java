...
import com.azure.resourcemanager.hardwaresecuritymodules.models.CloudHsmClustersCloudHsmClusterBackupStatusGetResponse;
import com.azure.resourcemanager.hardwaresecuritymodules.models.CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse;
...
public final class CloudHsmClustersClientImpl implements CloudHsmClustersClient {
     ...
     */
    CloudHsmClustersClientImpl(HardwareSecurityModulesClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HardwareSecurityModulesClientCloudHsmClusters to be used by the proxy
    ...
    public interface CloudHsmClustersService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<CloudHsmClustersCloudHsmClusterBackupStatusGetResponse> cloudHsmClusterBackupStatusGet(
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        CloudHsmClustersCloudHsmClusterBackupStatusGetResponse cloudHsmClusterBackupStatusGetSync(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName, @PathParam("jobId") String jobId,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse> cloudHsmClusterRestoreStatusGet(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName, @PathParam("jobId") String jobId,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse cloudHsmClusterRestoreStatusGetSync(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName, @PathParam("jobId") String jobId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudHsmClustersCloudHsmClusterBackupStatusGetResponse>
        cloudHsmClusterBackupStatusGetWithResponseAsync(String resourceGroupName, String cloudHsmClusterName,
            String jobId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.cloudHsmClusterBackupStatusGet(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, cloudHsmClusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BackupResultInner> cloudHsmClusterBackupStatusGetAsync(String resourceGroupName,
        String cloudHsmClusterName, String jobId) {
        return cloudHsmClusterBackupStatusGetWithResponseAsync(resourceGroupName, cloudHsmClusterName, jobId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClustersCloudHsmClusterBackupStatusGetResponse cloudHsmClusterBackupStatusGetWithResponse(
        String resourceGroupName, String cloudHsmClusterName, String jobId, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return service.cloudHsmClusterBackupStatusGetSync(this.client.getEndpoint(), this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BackupResultInner cloudHsmClusterBackupStatusGet(String resourceGroupName, String cloudHsmClusterName,
        String jobId) {
        return cloudHsmClusterBackupStatusGetWithResponse(resourceGroupName, cloudHsmClusterName, jobId, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse>
        cloudHsmClusterRestoreStatusGetWithResponseAsync(String resourceGroupName, String cloudHsmClusterName,
            String jobId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.cloudHsmClusterRestoreStatusGet(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, cloudHsmClusterName,
                jobId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RestoreResultInner> cloudHsmClusterRestoreStatusGetAsync(String resourceGroupName,
        String cloudHsmClusterName, String jobId) {
        return cloudHsmClusterRestoreStatusGetWithResponseAsync(resourceGroupName, cloudHsmClusterName, jobId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse cloudHsmClusterRestoreStatusGetWithResponse(
        String resourceGroupName, String cloudHsmClusterName, String jobId, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.cloudHsmClusterRestoreStatusGetSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, cloudHsmClusterName, jobId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RestoreResultInner cloudHsmClusterRestoreStatusGet(String resourceGroupName, String cloudHsmClusterName,
        String jobId) {
        return cloudHsmClusterRestoreStatusGetWithResponse(resourceGroupName, cloudHsmClusterName, jobId, Context.NONE)
            .getValue();
    }
