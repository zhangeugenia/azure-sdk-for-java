...
public final class DedicatedHsmsClientImpl implements DedicatedHsmsClient {
     ...
     */
    DedicatedHsmsClientImpl(HardwareSecurityModulesClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HardwareSecurityModulesClientDedicatedHsms to be used by the proxy
