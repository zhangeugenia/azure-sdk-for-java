...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(HardwareSecurityModulesClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HardwareSecurityModulesClientOperations to be used by the proxy
