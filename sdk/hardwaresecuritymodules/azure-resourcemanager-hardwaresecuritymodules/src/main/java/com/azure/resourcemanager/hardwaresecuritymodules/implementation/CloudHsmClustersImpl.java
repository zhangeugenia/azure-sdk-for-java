...
public final class CloudHsmClustersImpl implements CloudHsmClusters {
    ...
    public Response<BackupResult> cloudHsmClusterBackupStatusGetWithResponse(String resourceGroupName,
        String cloudHsmClusterName, String jobId, Context context) {
        CloudHsmClustersCloudHsmClusterBackupStatusGetResponse inner = this.serviceClient()
            .cloudHsmClusterBackupStatusGetWithResponse(resourceGroupName, cloudHsmClusterName, jobId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public BackupResult cloudHsmClusterBackupStatusGet(String resourceGroupName, String cloudHsmClusterName,
        String jobId) {
        BackupResultInner inner
            = this.serviceClient().cloudHsmClusterBackupStatusGet(resourceGroupName, cloudHsmClusterName, jobId);
        if (inner != null) {
            return new BackupResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<RestoreResult> cloudHsmClusterRestoreStatusGetWithResponse(String resourceGroupName,
        String cloudHsmClusterName, String jobId, Context context) {
        CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse inner = this.serviceClient()
            .cloudHsmClusterRestoreStatusGetWithResponse(resourceGroupName, cloudHsmClusterName, jobId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public RestoreResult cloudHsmClusterRestoreStatusGet(String resourceGroupName, String cloudHsmClusterName,
        String jobId) {
        RestoreResultInner inner
            = this.serviceClient().cloudHsmClusterRestoreStatusGet(resourceGroupName, cloudHsmClusterName, jobId);
        if (inner != null) {
            return new RestoreResultImpl(inner, this.manager());
        } else {
            return null;
