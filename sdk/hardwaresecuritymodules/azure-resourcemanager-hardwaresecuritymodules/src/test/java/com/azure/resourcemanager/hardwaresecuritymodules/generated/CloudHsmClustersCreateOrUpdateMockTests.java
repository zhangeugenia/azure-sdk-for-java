...
public final class CloudHsmClustersCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"activationState\":\"NotActivated\",\"autoGeneratedDomainNameLabelScope\":\"TenantReuse\",\"hsms\":[{\"fqdn\":\"szfjvfbgofelja\",\"state\":\"qmqhldvriii\",\"stateMessage\":\"nalghfkvtvsexso\"},{\"fqdn\":\"el\",\"state\":\"hhahhxvrhmzkwpjg\",\"stateMessage\":\"spughftqsxhq\"}],\"privateEndpointConnections\":[{\"properties\":{\"privateEndpoint\":{},\"privateLinkServiceConnectionState\":{},\"provisioningState\":\"Updating\",\"groupIds\":[\"digrjguufzdmsyqt\",\"ihwhbotzingamvpp\"]},\"etag\":\"szqzudphqamv\",\"id\":\"fwynwcvtbvkay\",\"name\":\"mtnvyq\",\"type\":\"atkzwpcnpw\"}],\"provisioningState\":\"Succeeded\",\"publicNetworkAccess\":\"Disabled\",\"statusMessage\":\"gvvs\"},\"identity\":{\"principalId\":\"ajguqf\",\"tenantId\":\"ygz\",\"type\":\"UserAssigned\",\"userAssignedIdentities\":{\"vpsvuoymgcce\":{\"principalId\":\"fxusemdwzr\",\"clientId\":\"hapfcqdpsqx\"}}},\"sku\":{\"family\":\"B\",\"name\":\"Standard B10\",\"capacity\":808786975},\"location\":\"qlmfeoker\",\"tags\":{\"opgxedkowepb\":\"yhko\",\"fkbw\":\"pc\",\"khtj\":\"csnjvcdwxlpqekft\"},\"id\":\"y\",\"name\":\"ngwfqatm\",\"type\":\"dhtmdvypgikd\"}";
        ...
        CloudHsmCluster response = manager.cloudHsmClusters()
            .define("byqunyow")
            .withRegion("onok")
            .withExistingResourceGroup("ugcxnavvwxq")
            .withTags(mapOf("irgzp", "jq"))
            .withIdentity(new ManagedServiceIdentity().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED)
                .withUserAssignedIdentities(mapOf("zimejzanlfzx", new UserAssignedIdentity())))
            .withSku(new CloudHsmClusterSku().withFamily(CloudHsmClusterSkuFamily.B)
                .withName(CloudHsmClusterSkuName.STANDARD_B1)
                .withCapacity(1513194356))
            .withAutoGeneratedDomainNameLabelScope(AutoGeneratedDomainNameLabelScope.NO_REUSE)
            .withPublicNetworkAccess(PublicNetworkAccess.DISABLED)
            .create();

        Assertions.assertEquals("qlmfeoker", response.location());
        Assertions.assertEquals("yhko", response.tags().get("opgxedkowepb"));
        ...
        Assertions.assertEquals(808786975, response.sku().capacity());
