...
public final class PrivateEndpointConnectionsListByCloudHsmClusterMockTests {
    ...
    public void testListByCloudHsmCluster() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"privateEndpoint\":{\"id\":\"ahqkg\"},\"privateLinkServiceConnectionState\":{\"status\":\"Approved\",\"description\":\"ijnhyjsvfycxzbf\",\"actionsRequired\":\"owvrvmtgjqppyos\"},\"provisioningState\":\"Canceled\",\"groupIds\":[\"myhgfipnsxkmc\"]},\"etag\":\"ekrrjr\",\"id\":\"fxtsgum\",\"name\":\"jglikkxwslolb\",\"type\":\"pvuzlmv\"}]}";
        ...
        PagedIterable<PrivateEndpointConnection> response = manager.privateEndpointConnections()
            .listByCloudHsmCluster("pna", "xexccbdreaxhcexd", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("ekrrjr", response.iterator().next().etag());
        Assertions.assertEquals(PrivateEndpointServiceConnectionStatus.APPROVED,
            response.iterator().next().privateLinkServiceConnectionState().status());
        Assertions.assertEquals("ijnhyjsvfycxzbf",
