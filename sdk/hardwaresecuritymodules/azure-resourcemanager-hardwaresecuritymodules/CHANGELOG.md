...
#### `HardwareSecurityModulesManager$Configurable` was removed

#### `models.DedicatedHsmProperties` was removed

#### `HardwareSecurityModulesManager` was removed
...
* `HardwaresecuritymodulesManager$Configurable` was added

* `HardwaresecuritymodulesManager` was added
...
* `models.CloudHsmClustersCloudHsmClusterBackupStatusGetHeaders` was added
...
* `models.CloudHsmClustersCloudHsmClusterBackupStatusGetResponse` was added
...
* `models.CloudHsmClustersCloudHsmClusterRestoreStatusGetHeaders` was added
...
* `models.CloudHsmClustersCloudHsmClusterRestoreStatusGetResponse` was added
