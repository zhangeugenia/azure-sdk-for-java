...
public final class ActionGroupPatchBody implements JsonSerializable<ActionGroupPatchBody> {
     ...
     * @return the ActionGroupPatchBody object itself.
     */
    public ActionGroupPatchBody withIdentity(ManagedServiceIdentity identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("tags".equals(fieldName)) {
                    ...
                    deserializedActionGroupPatchBody.identity = ManagedServiceIdentity.fromJson(reader);
