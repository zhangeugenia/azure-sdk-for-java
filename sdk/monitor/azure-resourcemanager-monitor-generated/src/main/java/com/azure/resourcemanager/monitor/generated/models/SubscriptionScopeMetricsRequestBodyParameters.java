...
public final class SubscriptionScopeMetricsRequestBodyParameters {
    ...
    /**
     * Get the top property: The maximum number of records to retrieve. Valid only if $filter is specified. Defaults to
     * 10.
     *
    ...
    /**
     * Set the top property: The maximum number of records to retrieve. Valid only if $filter is specified. Defaults to
     * 10.
     *
    ...
    /**
     * Get the orderBy property: The aggregation to use for sorting results and the direction of the sort. Only one
     * order can be specified. Examples: sum asc.
     *
    ...
    /**
     * Set the orderBy property: The aggregation to use for sorting results and the direction of the sort. Only one
     * order can be specified. Examples: sum asc.
     *
