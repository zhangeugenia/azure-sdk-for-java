...
public final class WebAppsImpl implements WebApps {
    ...
    public Response<Map<String, String>> listFunctionKeysWithResponse(String resourceGroupName, String name,
        String functionName, Context context) {
        return this.serviceClient().listFunctionKeysWithResponse(resourceGroupName, name, functionName, context);
    }

    public Map<String, String> listFunctionKeys(String resourceGroupName, String name, String functionName) {
        Map<String, String> inner = this.serviceClient().listFunctionKeys(resourceGroupName, name, functionName);
        if (inner != null) {
