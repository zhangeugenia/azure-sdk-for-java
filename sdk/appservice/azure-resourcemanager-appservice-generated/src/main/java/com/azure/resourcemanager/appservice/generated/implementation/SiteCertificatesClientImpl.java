...
public final class SiteCertificatesClientImpl implements SiteCertificatesClient {
    ...
    public interface SiteCertificatesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Response<CertificateCollection> listSlotSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("slot") String slot, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Response<CertificateInner> getSlotSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("slot") String slot, @PathParam("certificateName") String certificateName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Response<CertificateInner> createOrUpdateSlotSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("name") String name,
            @PathParam("slot") String slot, @PathParam("certificateName") String certificateName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 204 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Response<Void> deleteSlotSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("slot") String slot, @PathParam("certificateName") String certificateName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Response<CertificateInner> updateSlotSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("slot") String slot, @PathParam("certificateName") String certificateName,
            @QueryParam("api-version") String apiVersion,
    ...
    private PagedResponse<CertificateInner> listSinglePage(String resourceGroupName, String name) {
        ...
        final String accept = "application/json";
        Response<CertificateCollection> res = service.listSync(this.client.getEndpoint(), resourceGroupName, name,
    ...
    public Response<CertificateInner> getWithResponse(String resourceGroupName, String name, String certificateName,
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, name, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<CertificateInner> createOrUpdateWithResponse(String resourceGroupName, String name,
        ...
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, name, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), certificateEnvelope, accept, context);
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String name, String certificateName,
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, name, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<CertificateInner> updateWithResponse(String resourceGroupName, String name, String certificateName,
        ...
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, name, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), certificateEnvelope, accept, context);
    }
    ...
    private PagedResponse<CertificateInner> listSlotSinglePage(String resourceGroupName, String name, String slot) {
        ...
        final String accept = "application/json";
        Response<CertificateCollection> res = service.listSlotSync(this.client.getEndpoint(), resourceGroupName, name,
            slot, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public Response<CertificateInner> getSlotWithResponse(String resourceGroupName, String name, String slot,
        ...
        final String accept = "application/json";
        return service.getSlotSync(this.client.getEndpoint(), resourceGroupName, name, slot, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<CertificateInner> createOrUpdateSlotWithResponse(String resourceGroupName, String name, String slot,
        ...
        final String accept = "application/json";
        return service.createOrUpdateSlotSync(this.client.getEndpoint(), resourceGroupName,
            this.client.getSubscriptionId(), name, slot, certificateName, this.client.getApiVersion(),
            certificateEnvelope, accept, context);
    }
    ...
    public Response<Void> deleteSlotWithResponse(String resourceGroupName, String name, String slot,
        ...
        final String accept = "application/json";
        return service.deleteSlotSync(this.client.getEndpoint(), resourceGroupName, name, slot, certificateName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<CertificateInner> updateSlotWithResponse(String resourceGroupName, String name, String slot,
        ...
        final String accept = "application/json";
        return service.updateSlotSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SiteCertificatesClientImpl.class);
}
