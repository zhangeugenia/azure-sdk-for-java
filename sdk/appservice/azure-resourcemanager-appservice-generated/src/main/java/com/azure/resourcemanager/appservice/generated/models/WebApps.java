...
public interface WebApps {
     ...
     * request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return host level function keys along with {@link Response}.
     */
    Response<Map<String, String>> listFunctionKeysWithResponse(String resourceGroupName, String name,
     ...
     */
    Map<String, String> listFunctionKeys(String resourceGroupName, String name, String functionName);
