...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AseRegionCollection>> listAseRegions(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
     ...
     *
     * <p>Description for get a list of available ASE regions and its supported Skus.
     *
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
                ...
                context ->
                    service
                        .listAseRegions(
                            ...
                            accept,
                            context))
            .<PagedResponse<AseRegionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
    ...
    private PagedFlux<AseRegionInner> listAseRegionsAsync() {
        return new PagedFlux<>(
            () -> listAseRegionsSinglePageAsync(), nextLink -> listAseRegionsNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<AseRegionInner> listAseRegionsAsync(Context context) {
        return new PagedFlux<>(
            () -> listAseRegionsSinglePageAsync(context),
    ...
    private Mono<PagedResponse<AseRegionInner>> listAseRegionsNextSinglePageAsync(String nextLink, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listAseRegionsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
