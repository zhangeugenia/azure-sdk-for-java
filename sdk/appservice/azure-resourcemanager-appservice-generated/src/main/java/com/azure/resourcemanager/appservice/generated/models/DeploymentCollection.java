 ...
 */
@Fluent
public final class DeploymentCollection implements JsonSerializable<DeploymentCollection> {
    /*
    ...
    /**
     * Reads an instance of DeploymentCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DeploymentCollection if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DeploymentCollection.
     */
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    ...
                    deserializedDeploymentCollection.value = value;
