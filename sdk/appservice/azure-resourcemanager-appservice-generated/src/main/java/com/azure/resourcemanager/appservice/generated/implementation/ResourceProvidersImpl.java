...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<DnlResourceNameAvailability> regionalCheckNameAvailabilityWithResponse(String location,
        DnlResourceNameAvailabilityRequest request, Context context) {
        Response<DnlResourceNameAvailabilityInner> inner
            = this.serviceClient().regionalCheckNameAvailabilityWithResponse(location, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public DnlResourceNameAvailability regionalCheckNameAvailability(String location,
        DnlResourceNameAvailabilityRequest request) {
        DnlResourceNameAvailabilityInner inner = this.serviceClient().regionalCheckNameAvailability(location, request);
        if (inner != null) {
