...
public final class MaintenanceConfigurationOperationGroupsImpl implements MaintenanceConfigurationOperationGroups {
    private static final ClientLogger LOGGER = new ClientLogger(MaintenanceConfigurationOperationGroupsImpl.class);

    private final MaintenanceConfigurationOperationGroupsClient innerClient;

    private final com.azure.resourcemanager.maintenance.MaintenanceManager serviceManager;

    public MaintenanceConfigurationOperationGroupsImpl(MaintenanceConfigurationOperationGroupsClient innerClient,
    ...
    private MaintenanceConfigurationOperationGroupsClient serviceClient() {
