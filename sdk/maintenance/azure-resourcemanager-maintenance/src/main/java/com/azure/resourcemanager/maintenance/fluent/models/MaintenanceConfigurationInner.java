 ...
 */
@Fluent
public final class MaintenanceConfigurationInner extends Resource {
    /*
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedMaintenanceConfigurationInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedMaintenanceConfigurationInner.withTags(tags);
