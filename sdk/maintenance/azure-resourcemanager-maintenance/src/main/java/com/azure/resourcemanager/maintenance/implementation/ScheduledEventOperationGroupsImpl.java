...
public final class ScheduledEventOperationGroupsImpl implements ScheduledEventOperationGroups {
    private static final ClientLogger LOGGER = new ClientLogger(ScheduledEventOperationGroupsImpl.class);

    private final ScheduledEventOperationGroupsClient innerClient;

    private final com.azure.resourcemanager.maintenance.MaintenanceManager serviceManager;

    public ScheduledEventOperationGroupsImpl(ScheduledEventOperationGroupsClient innerClient,
    ...
    private ScheduledEventOperationGroupsClient serviceClient() {
