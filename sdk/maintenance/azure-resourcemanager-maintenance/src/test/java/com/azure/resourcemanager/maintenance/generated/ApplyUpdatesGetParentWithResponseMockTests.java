...
public final class ApplyUpdatesGetParentWithResponseMockTests {
    ...
    public void testGetParentWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"status\":\"NoUpdatesPending\",\"resourceId\":\"ytdw\",\"lastUpdateTime\":\"2021-10-18T23:06:28Z\"},\"id\":\"qu\",\"name\":\"paxh\",\"type\":\"xiilivpdtiirqt\"}";
        ...
        ApplyUpdate response = manager.applyUpdates()
            .getParentWithResponse("sofwqmzqalkrmnji", "pxacqqudfn", "yxbaaabjyvayf", "imrzrtuzqog", "exn",
                "vfdnwnwmewzsyyce", "zsoibjudpfrxtr", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(UpdateStatus.NO_UPDATES_PENDING, response.status());
        Assertions.assertEquals("ytdw", response.resourceId());
        Assertions.assertEquals(OffsetDateTime.parse("2021-10-18T23:06:28Z"), response.lastUpdateTime());
    }
}
