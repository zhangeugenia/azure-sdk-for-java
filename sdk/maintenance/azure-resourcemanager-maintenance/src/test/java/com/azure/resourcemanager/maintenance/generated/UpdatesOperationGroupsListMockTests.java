...
public final class UpdatesOperationGroupsListMockTests {
    @Test
    public void testList() throws Exception {
        ...
        PagedIterable<Update> response = manager.updatesOperationGroups()
            .list("qgleohibetnluank", "rfxeeebtij", "acvbmqz", "qqxlajr", com.azure.core.util.Context.NONE);
        ...
        Assertions.assertEquals("xoafgaoqltfae", response.iterator().next().properties().resourceId());
    }
}
