...
public final class ScheduledEventOperationGroupsAcknowledgeWithResponseMockTests {
    ...
    public void testAcknowledgeWithResponse() throws Exception {
        String responseStr = "{\"value\":\"wmqtibx\"}";
        ...
        ScheduledEventApproveResponse response = manager.scheduledEventOperationGroups()
            .acknowledgeWithResponse("thwtzol", "a", "mwmdxmebwjscjpa", "lxveabfqx", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("wmqtibx", response.value());
    }
}
