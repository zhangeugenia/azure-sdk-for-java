...
public final class OpenShiftManagedClustersClientImpl implements OpenShiftManagedClustersClient {
    ...
    public interface OpenShiftManagedClustersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OpenShiftManagedClusterListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OpenShiftManagedClusterListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OpenShiftManagedClusterInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OpenShiftManagedClusterListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OpenShiftManagedClusterListResult> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of OpenShift managed clusters in the specified subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2019-04-30";
        final String accept = "application/json";
        Response<OpenShiftManagedClusterListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2019-04-30";
        final String accept = "application/json";
        Response<OpenShiftManagedClusterListResult> res
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response from the List OpenShift Managed Clusters operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2019-04-30";
        final String accept = "application/json";
        Response<OpenShiftManagedClusterListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return openShift Managed cluster along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<OpenShiftManagedClusterInner>, OpenShiftManagedClusterInner>
        ...
        return this.client.<OpenShiftManagedClusterInner, OpenShiftManagedClusterInner>getLroResult(response,
            OpenShiftManagedClusterInner.class, OpenShiftManagedClusterInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OpenShiftManagedClusterInner>, OpenShiftManagedClusterInner> beginCreateOrUpdate(
        ...
        return this.client.<OpenShiftManagedClusterInner, OpenShiftManagedClusterInner>getLroResult(response,
            OpenShiftManagedClusterInner.class, OpenShiftManagedClusterInner.class, context);
    }
    ...
    public SyncPoller<PollResult<OpenShiftManagedClusterInner>, OpenShiftManagedClusterInner>
        ...
        Response<BinaryData> response = updateTagsWithResponse(resourceGroupName, resourceName, parameters);
        return this.client.<OpenShiftManagedClusterInner, OpenShiftManagedClusterInner>getLroResult(response,
            OpenShiftManagedClusterInner.class, OpenShiftManagedClusterInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OpenShiftManagedClusterInner>, OpenShiftManagedClusterInner>
        ...
        Response<BinaryData> response = updateTagsWithResponse(resourceGroupName, resourceName, parameters, context);
        return this.client.<OpenShiftManagedClusterInner, OpenShiftManagedClusterInner>getLroResult(response,
            OpenShiftManagedClusterInner.class, OpenShiftManagedClusterInner.class, context);
    }
    ...
    public OpenShiftManagedClusterInner updateTags(String resourceGroupName, String resourceName,
        TagsObject parameters) {
        return beginUpdateTags(resourceGroupName, resourceName, parameters).getFinalResult();
    }
    ...
    public OpenShiftManagedClusterInner updateTags(String resourceGroupName, String resourceName, TagsObject parameters,
        Context context) {
        return beginUpdateTags(resourceGroupName, resourceName, parameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OpenShiftManagedClusterInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
