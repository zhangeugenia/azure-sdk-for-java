...
public final class MachinesClientImpl implements MachinesClient {
    ...
    public interface MachinesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MachineInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("agentPoolName") String agentPoolName, @PathParam("machineName") String machineName,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<MachineInner> listSinglePage(String resourceGroupName, String resourceName,
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<MachineListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response from the List Machines operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
