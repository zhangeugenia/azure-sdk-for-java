...
public final class TrustedAccessRoleBindingsClientImpl implements TrustedAccessRoleBindingsClient {
    ...
    public interface TrustedAccessRoleBindingsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TrustedAccessRoleBindingListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TrustedAccessRoleBindingInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("trustedAccessRoleBindingName") String trustedAccessRoleBindingName,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of trusted access role bindings along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<TrustedAccessRoleBindingInner> listSinglePage(String resourceGroupName, String resourceName) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<TrustedAccessRoleBindingListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String resourceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, trustedAccessRoleBindingName, trustedAccessRoleBinding, accept,
            Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String resourceName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, trustedAccessRoleBindingName, accept, Context.NONE);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(TrustedAccessRoleBindingsClientImpl.class);
}
