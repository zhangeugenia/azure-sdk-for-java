...
public interface AgentPool {
    ...
    /**
     * Gets the orchestratorVersion property: Both patch version &lt;major.minor.patch&gt; (e.g. 1.20.13) and
    ...
    /**
     * Gets the currentOrchestratorVersion property: If orchestratorVersion is a fully specified version
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithCount, DefinitionStages.WithVmSize,
            ...
            DefinitionStages.WithSecurityProfile, DefinitionStages.WithGpuProfile, DefinitionStages.WithIfMatch,
        ...
        interface WithOrchestratorVersion {
            /**
             * Specifies the orchestratorVersion property: Both patch version &lt;major.minor.patch&gt; (e.g. 1.20.13)
             * and &lt;major.minor&gt; (e.g. 1.20) are supported. When &lt;major.minor&gt; is specified, the latest
             * supported GA patch version is chosen automatically. Updating the cluster with the same
             * &lt;major.minor&gt; once it has been created (e.g. 1.14.x -&gt; 1.14) will not trigger an upgrade, even
             * if a newer patch version is available. As a best practice, you should upgrade all node pools in an AKS
             * cluster to the same Kubernetes version. The node pool version must have the same major version as the
             ...
             * pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#upgrade-a-node-pool)..
             * 
             * @param orchestratorVersion Both patch version &lt;major.minor.patch&gt; (e.g. 1.20.13) and
             * &lt;major.minor&gt; (e.g. 1.20) are supported. When &lt;major.minor&gt; is specified, the latest
             * supported GA patch version is chosen automatically. Updating the cluster with the same
             * &lt;major.minor&gt; once it has been created (e.g. 1.14.x -&gt; 1.14) will not trigger an upgrade, even
             * if a newer patch version is available. As a best practice, you should upgrade all node pools in an AKS
             * cluster to the same Kubernetes version. The node pool version must have the same major version as the
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithCount, UpdateStages.WithVmSize,
        ...
        UpdateStages.WithGpuProfile, UpdateStages.WithIfMatch, UpdateStages.WithIfNoneMatch {
        /**
