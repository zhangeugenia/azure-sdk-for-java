...
public final class TrustedAccessRolesClientImpl implements TrustedAccessRolesClient {
    ...
    public interface TrustedAccessRolesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<TrustedAccessRoleListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<TrustedAccessRoleInner> listSinglePage(String location) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<TrustedAccessRoleListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(TrustedAccessRolesClientImpl.class);
}
