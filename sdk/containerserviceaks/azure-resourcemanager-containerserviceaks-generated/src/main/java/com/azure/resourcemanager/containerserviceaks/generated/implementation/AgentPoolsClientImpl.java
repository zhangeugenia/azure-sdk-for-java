...
public final class AgentPoolsClientImpl implements AgentPoolsClient {
    ...
    public interface AgentPoolsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AgentPoolListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AgentPoolUpgradeProfileInner> getUpgradeProfileSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("agentPoolName") String agentPoolName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> deleteMachinesSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("agentPoolName") String agentPoolName,
            @BodyParam("application/json") AgentPoolDeleteMachinesParameter machines,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AgentPoolAvailableVersionsInner> getAvailableAgentPoolVersionsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> upgradeNodeImageVersionSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("resourceName") String resourceName,
            @PathParam("agentPoolName") String agentPoolName, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> abortLatestOperationWithResponse(String resourceGroupName, String resourceName,
        ...
        return service.abortLatestOperationSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, agentPoolName, accept, Context.NONE);
    }
    ...
    private PagedResponse<AgentPoolInner> listSinglePage(String resourceGroupName, String resourceName) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<AgentPoolListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String resourceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, agentPoolName, ifMatch, ifNoneMatch, parameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String resourceName, String agentPoolName,
        ...
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, agentPoolName, ignorePodDisruptionBudget, ifMatch, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteMachinesWithResponse(String resourceGroupName, String resourceName,
        ...
        if (machines == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter machines is required and cannot be null."));
        } else {
            machines.validate();
        }
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        return service.deleteMachinesSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, resourceName, agentPoolName, machines, accept, Context.NONE);
    }
    ...
    public Response<AgentPoolAvailableVersionsInner> getAvailableAgentPoolVersionsWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        return service.getAvailableAgentPoolVersionsSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, resourceName, accept, context);
    }
    ...
    private Response<BinaryData> upgradeNodeImageVersionWithResponse(String resourceGroupName, String resourceName,
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        return service.upgradeNodeImageVersionSync(this.client.getEndpoint(), apiVersion,
    ...
    public AgentPoolInner upgradeNodeImageVersion(String resourceGroupName, String resourceName, String agentPoolName) {
        return beginUpgradeNodeImageVersion(resourceGroupName, resourceName, agentPoolName).getFinalResult();
    }
    ...
    public AgentPoolInner upgradeNodeImageVersion(String resourceGroupName, String resourceName, String agentPoolName,
        Context context) {
        return beginUpgradeNodeImageVersion(resourceGroupName, resourceName, agentPoolName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response from the List Agent Pools operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
