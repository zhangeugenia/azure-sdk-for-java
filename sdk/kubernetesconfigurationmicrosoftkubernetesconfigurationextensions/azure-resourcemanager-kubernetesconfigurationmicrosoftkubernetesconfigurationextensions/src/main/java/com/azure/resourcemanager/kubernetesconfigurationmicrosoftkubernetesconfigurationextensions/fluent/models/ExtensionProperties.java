...
public final class ExtensionProperties implements JsonSerializable<ExtensionProperties> {
    ...
    /**
     * Get the extensionState property: State of the extension on the cluster.
     * 
    ...
    public static ExtensionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("extensionState".equals(fieldName)) {
                    deserializedExtensionProperties.extensionState = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
