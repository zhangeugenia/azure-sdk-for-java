...
import com.azure.resourcemanager.healthdataaiservices.models.PrivateEndpointConnectionResourceListResult;
...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(MicrosoftHealthDataAIServicesImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftHealthDataAIServicesPrivateEndpointConnections to be used by
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String deidServiceName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, deidServiceName, privateEndpointConnectionName, resource, accept, context);
    }
