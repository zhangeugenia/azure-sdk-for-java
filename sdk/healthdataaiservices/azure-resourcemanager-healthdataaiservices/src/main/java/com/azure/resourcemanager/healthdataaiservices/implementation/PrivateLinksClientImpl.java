...
import com.azure.resourcemanager.healthdataaiservices.models.PrivateLinkResourceListResult;
...
public final class PrivateLinksClientImpl implements PrivateLinksClient {
     ...
     */
    PrivateLinksClientImpl(MicrosoftHealthDataAIServicesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftHealthDataAIServicesPrivateLinks to be used by the proxy
    ...
    public interface PrivateLinksService {
        ...
        Mono<Response<PrivateLinkResourceListResult>> listByDeidService(@HostParam("$host") String endpoint,
