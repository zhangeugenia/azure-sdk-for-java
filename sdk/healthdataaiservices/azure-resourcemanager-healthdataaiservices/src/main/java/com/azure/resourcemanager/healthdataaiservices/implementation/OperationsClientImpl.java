...
import com.azure.resourcemanager.healthdataaiservices.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftHealthDataAIServicesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftHealthDataAIServicesOperations to be used by the proxy
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.HealthDataAIServices/operations")
