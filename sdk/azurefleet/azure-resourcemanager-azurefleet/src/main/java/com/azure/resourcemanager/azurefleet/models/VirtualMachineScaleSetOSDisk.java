...
public final class VirtualMachineScaleSetOSDisk implements JsonSerializable<VirtualMachineScaleSetOSDisk> {
    ...
    /**
     * Get the osType property: This property allows you to specify the type of the OS that is included in the
     * disk if creating a VM from user-image or a specialized VHD. Possible values
     * are: **Windows,** **Linux.**.
     * 
    ...
    /**
     * Set the osType property: This property allows you to specify the type of the OS that is included in the
     * disk if creating a VM from user-image or a specialized VHD. Possible values
     * are: **Windows,** **Linux.**.
     * 
