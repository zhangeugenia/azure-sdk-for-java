...
package com.azure.resourcemanager.resourcesmicrosoftresourcesbicep.fluent.models;
...
public final class DecompileOperationSuccessResponseInner
     ...
     */
    public DecompileOperationSuccessResponseInner() {
    }
    ...
    /**
     * Set the files property: An array of key-value pairs containing the entryPoint string as the key for the Bicep
     * file decompiled from the ARM json template.
     * 
     * @param files the files value to set.
     * @return the DecompileOperationSuccessResponseInner object itself.
     */
    public DecompileOperationSuccessResponseInner withFiles(List<FileDefinition> files) {
        this.files = files;
        return this;
    }
    ...
    /**
     * Set the entryPoint property: The file path to the main Bicep file generated from the decompiled ARM json
     * template.
     * 
     * @param entryPoint the entryPoint value to set.
     * @return the DecompileOperationSuccessResponseInner object itself.
     */
    public DecompileOperationSuccessResponseInner withEntryPoint(String entryPoint) {
