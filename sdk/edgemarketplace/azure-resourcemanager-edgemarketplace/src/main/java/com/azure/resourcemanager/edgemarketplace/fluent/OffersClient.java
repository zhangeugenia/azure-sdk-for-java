...
public interface OffersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<OfferInner> list(String resourceUri, Integer top, Integer skip, Integer maxPageSize, String filter,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<OfferInner> listBySubscription(Integer top, Integer skip, Integer maxPageSize, String filter,
        String skipToken, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DiskAccessTokenInner> getAccessTokenWithResponse(String resourceUri, String offerId,
