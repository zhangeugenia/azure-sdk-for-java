...
public interface DashboardsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DashboardInner createOrUpdate(String resourceGroupName, String dashboardName, DashboardInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DashboardInner update(String resourceGroupName, String dashboardName, PatchableDashboard properties);
