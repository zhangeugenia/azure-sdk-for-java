...
public final class GatesUpdateMockTests {
    ...
    public void testUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"displayName\":\"vtpuqujmqlgk\",\"gateType\":\"Approval\",\"target\":{\"updateRunProperties\":{\"name\":\"ndo\",\"stage\":\"n\",\"group\":\"jcntuj\",\"timing\":\"Before\"}},\"state\":\"Completed\"},\"eTag\":\"ed\",\"location\":\"wwa\",\"tags\":{\"i\":\"ojvdcpzfoqo\",\"oxciqopidoamcio\":\"ybxarzgszu\"},\"id\":\"hkh\",\"name\":\"zxkhnzbonlwnto\",\"type\":\"gokdwbwhks\"}";
        ...
        Gate response = manager.gates()
            .update("xqtvcofu", "f", "vkg",
                new GatePatch().withTags(mapOf("aznqntoru", "gdknnqv", "uwjuetaeburuvdmo", "sgsahmkycgr"))
                    .withProperties(new GatePatchProperties().withState(GateState.SKIPPED)),
                "mz", "xwabmqoe", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("wwa", response.location());
        Assertions.assertEquals("ojvdcpzfoqo", response.tags().get("i"));
        Assertions.assertEquals("vtpuqujmqlgk", response.displayName());
