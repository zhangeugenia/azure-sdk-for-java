...
public final class FleetUpdateStrategiesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Succeeded\",\"strategy\":{\"stages\":[{\"name\":\"ojlpijnkrxf\",\"groups\":[{\"name\":\"hcrat\"},{\"name\":\"zzronasx\"}],\"afterStageWaitInSeconds\":1438708374,\"beforeGates\":[{\"type\":\"Approval\"}],\"afterGates\":[{\"type\":\"Approval\"}]}]}},\"eTag\":\"tw\",\"id\":\"gogczhonnxkrlgny\",\"name\":\"mossxkkgthrrghxj\",\"type\":\"dhqxvcx\"}]}";
        ...
        PagedIterable<FleetUpdateStrategy> response
            = manager.fleetUpdateStrategies().listByFleet("qknp", "rgnepttwqmsniffc", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("ojlpijnkrxf", response.iterator().next().strategy().stages().get(0).name());
        Assertions.assertEquals("hcrat", response.iterator().next().strategy().stages().get(0).groups().get(0).name());
        Assertions.assertEquals(1438708374,
