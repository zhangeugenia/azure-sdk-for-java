...
public final class ConnectionListResult implements JsonSerializable<ConnectionListResult> {
    ...
    /**
     * Set the value property: The Connection items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ConnectionListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ConnectionListResult.class);
