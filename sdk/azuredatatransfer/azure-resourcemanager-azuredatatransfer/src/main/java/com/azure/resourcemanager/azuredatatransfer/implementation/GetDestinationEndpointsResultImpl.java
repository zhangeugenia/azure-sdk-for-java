...
public final class GetDestinationEndpointsResultImpl implements GetDestinationEndpointsResult {
    private GetDestinationEndpointsResultInner innerObject;

    private final com.azure.resourcemanager.azuredatatransfer.AzuredatatransferManager serviceManager;

    GetDestinationEndpointsResultImpl(GetDestinationEndpointsResultInner innerObject,
    ...
    public GetDestinationEndpointsResultInner innerModel() {
