...
public final class ActionType extends ExpandableStringEnum<ActionType> {
    ...
    /**
     * Static value AllowUpdates for ActionType.
     */
    public static final ActionType ALLOW_UPDATES = fromString("AllowUpdates");

    /**
     * Static value ForceDisable for ActionType.
     */
    public static final ActionType FORCE_DISABLE = fromString("ForceDisable");
