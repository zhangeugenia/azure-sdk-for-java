...
public interface PipelinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner executeAction(String resourceGroupName, String pipelineName, Action action);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner executeAction(String resourceGroupName, String pipelineName, Action action, Context context);
