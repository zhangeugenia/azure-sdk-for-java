...
public final class PipelineImpl implements Pipeline, Pipeline.Definition, Pipeline.Update {
    ...
    public Pipeline executeAction(Action action) {
        return serviceManager.pipelines().executeAction(resourceGroupName, pipelineName, action);
    }

    public Pipeline executeAction(Action action, Context context) {
        return serviceManager.pipelines().executeAction(resourceGroupName, pipelineName, action, context);
    }
