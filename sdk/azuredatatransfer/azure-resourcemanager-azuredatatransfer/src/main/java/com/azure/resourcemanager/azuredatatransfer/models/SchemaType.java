...
public final class SchemaType extends ExpandableStringEnum<SchemaType> {
    /**
     * Static value Xsd for SchemaType.
     */
    public static final SchemaType XSD = fromString("Xsd");

    /**
     * Static value Zip for SchemaType.
     */
    public static final SchemaType ZIP = fromString("Zip");
