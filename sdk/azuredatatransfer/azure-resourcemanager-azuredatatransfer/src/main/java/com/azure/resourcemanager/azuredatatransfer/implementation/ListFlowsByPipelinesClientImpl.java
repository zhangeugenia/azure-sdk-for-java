...
public final class ListFlowsByPipelinesClientImpl implements ListFlowsByPipelinesClient {
    ...
    public Response<ListFlowsByPipelineResultInner> listWithResponse(String resourceGroupName, String pipelineName,
        ...
        return service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            pipelineName, this.client.getApiVersion(), connections, accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ListFlowsByPipelinesClientImpl.class);
}
