...
public interface Pipelines {
     ...
     */
    Pipeline executeAction(String resourceGroupName, String pipelineName, Action action);
     ...
     * @return the pipeline resource definition.
     */
    Pipeline executeAction(String resourceGroupName, String pipelineName, Action action, Context context);
