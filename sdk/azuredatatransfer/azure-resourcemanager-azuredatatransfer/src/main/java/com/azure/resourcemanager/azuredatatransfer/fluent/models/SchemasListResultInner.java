 ...
 */
@Fluent
public final class SchemasListResultInner implements JsonSerializable<SchemasListResultInner> {
    /*
     * Schemas array.
     */
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<Schema> value = reader.readArray(reader1 -> Schema.fromJson(reader1));
