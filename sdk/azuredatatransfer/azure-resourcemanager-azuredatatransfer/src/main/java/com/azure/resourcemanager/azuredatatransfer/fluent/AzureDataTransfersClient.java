...
public interface AzureDataTransfersClient {
    ...
    Response<SchemasListResultInner> listApprovedSchemasWithResponse(ListApprovedSchemasRequest body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ValidateSchemaResultInner> validateSchemaWithResponse(Schema body, Context context);
