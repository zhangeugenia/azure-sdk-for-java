...
public class FlowPropertiesInner implements JsonSerializable<FlowPropertiesInner> {
    ...
    /**
     * Set the forceDisabledStatus property: Force disablement status of the current flow.
     * 
     * @param forceDisabledStatus the forceDisabledStatus value to set.
     * @return the FlowPropertiesInner object itself.
     */
    FlowPropertiesInner withForceDisabledStatus(List<ForceDisabledStatus> forceDisabledStatus) {
