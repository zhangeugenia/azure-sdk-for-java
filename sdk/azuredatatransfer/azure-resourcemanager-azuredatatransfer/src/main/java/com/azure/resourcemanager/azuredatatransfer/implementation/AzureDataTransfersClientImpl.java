...
public final class AzureDataTransfersClientImpl implements AzureDataTransfersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SchemasListResultInner> listApprovedSchemasAsync(ListApprovedSchemasRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SchemasListResultInner> listApprovedSchemasWithResponse(ListApprovedSchemasRequest body,
        Context context) {
        if (this.client.getEndpoint() == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ValidateSchemaResultInner>> validateSchemaWithResponseAsync(Schema body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidateSchemaResultInner> validateSchemaAsync(Schema body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ValidateSchemaResultInner> validateSchemaWithResponse(Schema body, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
