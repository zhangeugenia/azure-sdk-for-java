...
public final class ResourceProvisionPayload implements JsonSerializable<ResourceProvisionPayload> {
     ...
     */
    private List<byte[]> resourceOverrides;
     ...
     */
    public List<byte[]> resourceOverrides() {
     ...
     * @return the ResourceProvisionPayload object itself.
     */
    public ResourceProvisionPayload withResourceOverrides(List<byte[]> resourceOverrides) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceCount".equals(fieldName)) {
                    ...
                    List<byte[]> resourceOverrides = reader.readArray(reader1 -> reader1.getBinary());
