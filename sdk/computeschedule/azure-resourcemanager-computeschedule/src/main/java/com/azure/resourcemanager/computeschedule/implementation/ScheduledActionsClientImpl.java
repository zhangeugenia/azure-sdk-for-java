...
public final class ScheduledActionsClientImpl implements ScheduledActionsClient {
    ...
    public interface ScheduledActionsService {
        ...
        Mono<Response<CreateResourceOperationResponseInner>> virtualMachinesExecuteCreate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("locationparameter") String locationparameter,
            @BodyParam("application/json") ExecuteCreateRequest requestBody, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<DeleteResourceOperationResponseInner>> virtualMachinesExecuteDelete(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("locationparameter") String locationparameter,
            @BodyParam("application/json") ExecuteDeleteRequest requestBody, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<CreateResourceOperationResponseInner>> virtualMachinesSubmitCreate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("locationparameter") String locationparameter,
            @BodyParam("application/json") SubmitCreateRequest requestBody, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<DeleteResourceOperationResponseInner>> virtualMachinesSubmitDelete(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("locationparameter") String locationparameter,
            @BodyParam("application/json") SubmitDeleteRequest requestBody, @HeaderParam("Accept") String accept,
            Context context);
