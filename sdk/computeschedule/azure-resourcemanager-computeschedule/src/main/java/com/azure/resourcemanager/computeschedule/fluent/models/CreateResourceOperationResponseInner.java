...
public final class CreateResourceOperationResponseInner
     ...
     */
    public CreateResourceOperationResponseInner() {
    }
     ...
     * @return the CreateResourceOperationResponseInner object itself.
     */
    public CreateResourceOperationResponseInner withDescription(String description) {
    ...
    /**
     * Set the type property: The type of resources used in the create request eg virtual machines.
     * 
     * @param type the type value to set.
     * @return the CreateResourceOperationResponseInner object itself.
     */
    public CreateResourceOperationResponseInner withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the CreateResourceOperationResponseInner object itself.
     */
    public CreateResourceOperationResponseInner withLocation(String location) {
     ...
     * @return the CreateResourceOperationResponseInner object itself.
     */
    public CreateResourceOperationResponseInner withResults(List<ResourceOperation> results) {
