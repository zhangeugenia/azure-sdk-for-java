...
public final class ScheduledActionsImpl implements ScheduledActions {
    ...
    public Response<CreateResourceOperationResponse> virtualMachinesSubmitCreateWithResponse(String locationparameter,
        SubmitCreateRequest requestBody, Context context) {
        Response<CreateResourceOperationResponseInner> inner
            = this.serviceClient().virtualMachinesSubmitCreateWithResponse(locationparameter, requestBody, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new CreateResourceOperationResponseImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public CreateResourceOperationResponse virtualMachinesSubmitCreate(String locationparameter,
        SubmitCreateRequest requestBody) {
        CreateResourceOperationResponseInner inner
            = this.serviceClient().virtualMachinesSubmitCreate(locationparameter, requestBody);
        if (inner != null) {
            return new CreateResourceOperationResponseImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<DeleteResourceOperationResponse> virtualMachinesSubmitDeleteWithResponse(String locationparameter,
        SubmitDeleteRequest requestBody, Context context) {
        Response<DeleteResourceOperationResponseInner> inner
            = this.serviceClient().virtualMachinesSubmitDeleteWithResponse(locationparameter, requestBody, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new DeleteResourceOperationResponseImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public DeleteResourceOperationResponse virtualMachinesSubmitDelete(String locationparameter,
        SubmitDeleteRequest requestBody) {
        DeleteResourceOperationResponseInner inner
            = this.serviceClient().virtualMachinesSubmitDelete(locationparameter, requestBody);
        if (inner != null) {
            return new DeleteResourceOperationResponseImpl(inner, this.manager());
        } else {
            return null;
