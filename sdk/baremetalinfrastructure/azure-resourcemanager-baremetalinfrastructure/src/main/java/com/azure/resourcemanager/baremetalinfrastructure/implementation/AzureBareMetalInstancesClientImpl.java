...
import com.azure.resourcemanager.baremetalinfrastructure.models.AzureBareMetalInstanceListResult;
...
public final class AzureBareMetalInstancesClientImpl implements AzureBareMetalInstancesClient {
    ...
    public interface AzureBareMetalInstancesService {
        ...
        Mono<Response<AzureBareMetalInstanceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureBareMetalInstanceListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureBareMetalInstanceListResult>> listBySubscriptionNext(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureBareMetalInstanceListResult>> listByResourceGroupNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @return the response of a AzureBareMetalInstance list operation along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a AzureBareMetalInstance list operation as paginated response with {@link PagedFlux}.
     */
