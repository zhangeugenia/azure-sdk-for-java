...
public final class LotsOperationsClientImpl implements LotsOperationsClient {
    ...
    public interface LotsOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Lots> listByBillingProfileSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountId") String billingAccountId,
            @PathParam("billingProfileId") String billingProfileId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Lots> listByBillingAccountSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountId") String billingAccountId, @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Lots> listByCustomerSync(@HostParam("$host") String endpoint,
            @PathParam("billingAccountId") String billingAccountId, @PathParam("customerId") String customerId,
            @QueryParam("api-version") String apiVersion, @QueryParam("$filter") String filter,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<LotSummaryInner> listByBillingProfileSinglePage(String billingAccountId,
        ...
        final String accept = "application/json";
        Response<Lots> res = service.listByBillingProfileSync(this.client.getEndpoint(), billingAccountId,
            billingProfileId, this.client.getApiVersion(), accept, Context.NONE);
    ...
    private PagedResponse<LotSummaryInner> listByBillingAccountSinglePage(String billingAccountId, String filter) {
        ...
        final String accept = "application/json";
        Response<Lots> res = service.listByBillingAccountSync(this.client.getEndpoint(), billingAccountId,
    ...
    private PagedResponse<LotSummaryInner> listByCustomerSinglePage(String billingAccountId, String customerId,
        ...
        if (customerId == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter customerId is required and cannot be null."));
        }
        final String accept = "application/json";
        Response<Lots> res = service.listByCustomerSync(this.client.getEndpoint(), billingAccountId, customerId,
            this.client.getApiVersion(), filter, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LotsOperationsClientImpl.class);
}
