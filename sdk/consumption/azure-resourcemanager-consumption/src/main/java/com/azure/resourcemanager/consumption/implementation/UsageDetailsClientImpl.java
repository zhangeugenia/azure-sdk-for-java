...
public final class UsageDetailsClientImpl implements UsageDetailsClient {
    ...
    public interface UsageDetailsService {
        ...
        @ExpectedResponses({ 200, 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<UsageDetailsListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope, @QueryParam("$expand") String expand,
            @QueryParam("$filter") String filter, @QueryParam("$skiptoken") String skiptoken,
            @QueryParam("$top") Integer top, @QueryParam("api-version") String apiVersion,
            @QueryParam("metric") Metrictype metric, @HeaderParam("Accept") String accept, Context context);
    ...
    private PagedResponse<UsageDetailInner> listSinglePage(String scope, String expand, String filter, String skiptoken,
        ...
        final String accept = "application/json";
        Response<UsageDetailsListResult> res = service.listSync(this.client.getEndpoint(), scope, expand, filter,
            skiptoken, top, this.client.getApiVersion(), metric, accept, Context.NONE);
    ...
    private PagedResponse<UsageDetailInner> listSinglePage(String scope, String expand, String filter, String skiptoken,
        ...
        final String accept = "application/json";
        Response<UsageDetailsListResult> res = service.listSync(this.client.getEndpoint(), scope, expand, filter,
            skiptoken, top, this.client.getApiVersion(), metric, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(UsageDetailsClientImpl.class);
}
