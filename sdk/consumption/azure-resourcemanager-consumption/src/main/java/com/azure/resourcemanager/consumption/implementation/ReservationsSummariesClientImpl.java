...
public final class ReservationsSummariesClientImpl implements ReservationsSummariesClient {
    ...
    public interface ReservationsSummariesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReservationSummariesListResult> listByReservationOrderSync(@HostParam("$host") String endpoint,
            @PathParam("reservationOrderId") String reservationOrderId, @QueryParam("grain") Datagrain grain,
            @QueryParam("$filter") String filter, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReservationSummariesListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam(value = "resourceScope", encoded = true) String resourceScope,
            @QueryParam("grain") Datagrain grain, @QueryParam("startDate") String startDate,
            @QueryParam("endDate") String endDate, @QueryParam("$filter") String filter,
            @QueryParam("reservationId") String reservationId,
    ...
    private PagedResponse<ReservationSummaryInner> listByReservationOrderSinglePage(String reservationOrderId,
        ...
        if (grain == null) {
            throw LOGGER.atError().log(new IllegalArgumentException("Parameter grain is required and cannot be null."));
        }
        final String accept = "application/json";
        Response<ReservationSummariesListResult> res = service.listByReservationOrderSync(this.client.getEndpoint(),
            reservationOrderId, grain, filter, this.client.getApiVersion(), accept, Context.NONE);
    ...
    private PagedResponse<ReservationSummaryInner> listByReservationOrderSinglePage(String reservationOrderId,
        ...
        final String accept = "application/json";
        Response<ReservationSummariesListResult> res = service.listByReservationOrderSync(this.client.getEndpoint(),
            reservationOrderId, grain, filter, this.client.getApiVersion(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<ReservationSummaryInner> listByReservationOrderAndReservationSinglePage(
        ...
        Response<ReservationSummariesListResult> res
            = service.listByReservationOrderAndReservationSync(this.client.getEndpoint(), reservationOrderId,
                reservationId, grain, filter, this.client.getApiVersion(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<ReservationSummaryInner> listByReservationOrderAndReservationSinglePage(
        ...
        Response<ReservationSummariesListResult> res
            = service.listByReservationOrderAndReservationSync(this.client.getEndpoint(), reservationOrderId,
                reservationId, grain, filter, this.client.getApiVersion(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<ReservationSummaryInner> listSinglePage(String resourceScope, Datagrain grain,
        ...
        final String accept = "application/json";
        Response<ReservationSummariesListResult> res
            = service.listSync(this.client.getEndpoint(), resourceScope, grain, startDate, endDate, filter,
                reservationId, reservationOrderId, this.client.getApiVersion(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ReservationsSummariesClientImpl.class);
}
