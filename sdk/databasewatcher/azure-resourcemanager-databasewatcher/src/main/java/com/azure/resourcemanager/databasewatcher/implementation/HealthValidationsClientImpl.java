...
import com.azure.resourcemanager.databasewatcher.models.HealthValidationListResult;
...
public final class HealthValidationsClientImpl implements HealthValidationsClient {
     ...
     */
    HealthValidationsClientImpl(MicrosoftDatabaseWatcherImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftDatabaseWatcherHealthValidations to be used by the proxy
    ...
    public interface HealthValidationsService {
        ...
        Mono<Response<HealthValidationListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HealthValidationInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("watcherName") String watcherName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> startValidation(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("watcherName") String watcherName,
            @PathParam("healthValidationName") String healthValidationName, @HeaderParam("Accept") String accept,
            Context context);
