...
public final class AlertRuleResourcesClientImpl implements AlertRuleResourcesClient {
     ...
     */
    AlertRuleResourcesClientImpl(MicrosoftDatabaseWatcherImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftDatabaseWatcherAlertRuleResources to be used by the proxy
