...
public interface IotDpsResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<PrivateEndpointConnectionInner> listPrivateEndpointConnections(String resourceGroupName,
        String provisioningServiceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateEndpointConnectionInner getPrivateEndpointConnection(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateEndpointConnectionInner deletePrivateEndpointConnection(String resourceGroupName,
        String provisioningServiceName, String privateEndpointConnectionName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateLinkResourcesInner listPrivateLinkResources(String resourceGroupName, String provisioningServiceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<GroupIdInformationInner> getPrivateLinkResourcesWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    GroupIdInformationInner getPrivateLinkResources(String resourceGroupName, String provisioningServiceName,
        String groupId);
