...
public final class NamespaceResourceImpl
    ...
    public Response<CheckAvailabilityResult>
        checkNotificationHubAvailabilityWithResponse(CheckAvailabilityParameters parameters, Context context) {
        return serviceManager.namespaceResources()
            .checkNotificationHubAvailabilityWithResponse(resourceGroupName, namespaceName, parameters, context);
    }

    public CheckAvailabilityResult checkNotificationHubAvailability(CheckAvailabilityParameters parameters) {
        return serviceManager.namespaceResources()
    ...
    public Response<PnsCredentialsResource> getPnsCredentialsWithResponse(Context context) {
        return serviceManager.namespaceResources()
            .getPnsCredentialsWithResponse(resourceGroupName, namespaceName, context);
    }

    public PnsCredentialsResource getPnsCredentials() {
        return serviceManager.namespaceResources().getPnsCredentials(resourceGroupName, namespaceName);
    }
