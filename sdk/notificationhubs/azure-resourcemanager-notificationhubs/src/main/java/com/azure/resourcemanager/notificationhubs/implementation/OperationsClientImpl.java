...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(NotificationHubsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for NotificationHubsClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
