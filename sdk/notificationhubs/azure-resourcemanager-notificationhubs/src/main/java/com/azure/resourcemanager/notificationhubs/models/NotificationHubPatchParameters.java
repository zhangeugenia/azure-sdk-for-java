 ...
 */
@Fluent
public final class NotificationHubPatchParameters implements JsonSerializable<NotificationHubPatchParameters> {
    /*
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    ...
                    deserializedNotificationHubPatchParameters.tags = tags;
                } else {
                    reader.skipChildren();
                }
            }
