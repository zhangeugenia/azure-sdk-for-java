...
public final class OperationStatusClientImpl implements OperationStatusClient {
     ...
     */
    OperationStatusClientImpl(DeviceRegistryMgmtClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DeviceRegistryMgmtClientOperationStatus to be used by the proxy
