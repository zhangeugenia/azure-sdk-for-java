...
public class EventBase implements JsonSerializable<EventBase> {
    ...
    public void validate() {
        if (name() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property name in model EventBase"));
        }
        if (eventNotifier() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property eventNotifier in model EventBase"));
        }
        if (topic() != null) {
            topic().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(EventBase.class);
