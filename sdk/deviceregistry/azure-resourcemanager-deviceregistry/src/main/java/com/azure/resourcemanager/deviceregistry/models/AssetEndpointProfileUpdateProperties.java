...
public final class AssetEndpointProfileUpdateProperties
     ...
     */
    private AuthenticationUpdate authentication;
     ...
     */
    public AuthenticationUpdate authentication() {
     ...
     * @return the AssetEndpointProfileUpdateProperties object itself.
     */
    public AssetEndpointProfileUpdateProperties withAuthentication(AuthenticationUpdate authentication) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("targetAddress".equals(fieldName)) {
                    ...
                    deserializedAssetEndpointProfileUpdateProperties.authentication
                        = AuthenticationUpdate.fromJson(reader);
