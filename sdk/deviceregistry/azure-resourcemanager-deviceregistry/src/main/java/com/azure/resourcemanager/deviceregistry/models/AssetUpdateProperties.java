...
public final class AssetUpdateProperties implements JsonSerializable<AssetUpdateProperties> {
     ...
     */
    private TopicUpdate defaultTopic;
     ...
     */
    public TopicUpdate defaultTopic() {
     ...
     * @return the AssetUpdateProperties object itself.
     */
    public AssetUpdateProperties withDefaultTopic(TopicUpdate defaultTopic) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("enabled".equals(fieldName)) {
                    ...
                    deserializedAssetUpdateProperties.defaultTopic = TopicUpdate.fromJson(reader);
