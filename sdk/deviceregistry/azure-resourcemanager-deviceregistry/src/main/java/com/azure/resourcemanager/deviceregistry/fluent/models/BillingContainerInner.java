...
public final class BillingContainerInner extends ProxyResource {
     ...
     * @return the BillingContainerInner object itself.
     */
    public BillingContainerInner withProperties(BillingContainerProperties properties) {
