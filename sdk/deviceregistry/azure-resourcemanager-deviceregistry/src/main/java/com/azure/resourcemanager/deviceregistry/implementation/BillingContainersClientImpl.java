...
import com.azure.resourcemanager.deviceregistry.models.BillingContainerListResult;
...
public final class BillingContainersClientImpl implements BillingContainersClient {
     ...
     */
    BillingContainersClientImpl(DeviceRegistryMgmtClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DeviceRegistryMgmtClientBillingContainers to be used by the proxy
    ...
    public interface BillingContainersService {
        ...
        Mono<Response<BillingContainerListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingContainerInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
