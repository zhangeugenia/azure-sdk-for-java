...
public final class MachineRunCommandsImpl implements MachineRunCommands {
    ...
    public MachineRunCommandsImpl(
        MachineRunCommandsClient innerClient,
    ...
    public Response<MachineRunCommand> getWithResponse(
    ...
    public PagedIterable<MachineRunCommand> list(
