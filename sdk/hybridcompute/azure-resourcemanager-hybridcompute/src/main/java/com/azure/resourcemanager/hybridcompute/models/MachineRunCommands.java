...
public interface MachineRunCommands {
     ...
     */
    Response<MachineRunCommand> getWithResponse(
     ...
     */
    PagedIterable<MachineRunCommand> list(String resourceGroupName, String machineName);
     ...
     * @return describes the Run Commands List Result as paginated response with {@link PagedIterable}.
     */
    PagedIterable<MachineRunCommand> list(String resourceGroupName, String machineName, String expand, Context context);
     ...
     * @return describes a Run Command along with {@link Response}.
     */
    MachineRunCommand getById(String id);
     ...
     * @return describes a Run Command along with {@link Response}.
     */
    Response<MachineRunCommand> getByIdWithResponse(String id, Context context);
     ...
     * @return the first stage of the new MachineRunCommand definition.
     */
    MachineRunCommand.DefinitionStages.Blank define(String name);
}
