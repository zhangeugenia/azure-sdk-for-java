...
public interface MachineRunCommandsClient {
    ...
    SyncPoller<PollResult<MachineRunCommandInner>, MachineRunCommandInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MachineRunCommandInner>, MachineRunCommandInner> beginUpdate(
        String resourceGroupName,
        String machineName,
        String runCommandName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MachineRunCommandInner> getWithResponse(
        String resourceGroupName, String machineName, String runCommandName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MachineRunCommandInner> list(
