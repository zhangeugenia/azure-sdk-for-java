...
public final class NetworkSecurityPerimeterConfigurationsClientImpl
    ...
    public interface NetworkSecurityPerimeterConfigurationsService {
        ...
        Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getByPrivateLinkScope(
            ...
            @PathParam("perimeterName") String perimeterName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> reconcileForPrivateLinkScope(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getByPrivateLinkScopeWithResponseAsync(
        String resourceGroupName, String scopeName, String perimeterName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the network security perimeter configuration for a private link scope on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkSecurityPerimeterConfigurationInner> getByPrivateLinkScopeAsync(
        String resourceGroupName, String scopeName, String perimeterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkSecurityPerimeterConfigurationInner getByPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>> listByPrivateLinkScopeSinglePageAsync(
    ...
    private PagedFlux<NetworkSecurityPerimeterConfigurationInner> listByPrivateLinkScopeAsync(
        String resourceGroupName, String scopeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkSecurityPerimeterConfigurationInner> listByPrivateLinkScope(
        String resourceGroupName, String scopeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> reconcileForPrivateLinkScopeWithResponseAsync(
        String resourceGroupName, String scopeName, String perimeterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private PollerFlux<PollResult<Void>, Void> beginReconcileForPrivateLinkScopeAsync(
        String resourceGroupName, String scopeName, String perimeterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginReconcileForPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginReconcileForPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName, Context context) {
        return this
            .beginReconcileForPrivateLinkScopeAsync(resourceGroupName, scopeName, perimeterName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> reconcileForPrivateLinkScopeAsync(
        String resourceGroupName, String scopeName, String perimeterName) {
        return beginReconcileForPrivateLinkScopeAsync(resourceGroupName, scopeName, perimeterName)
            .last()
    ...
    private Mono<Void> reconcileForPrivateLinkScopeAsync(
        String resourceGroupName, String scopeName, String perimeterName, Context context) {
        return beginReconcileForPrivateLinkScopeAsync(resourceGroupName, scopeName, perimeterName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void reconcileForPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>> listByPrivateLinkScopeNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
