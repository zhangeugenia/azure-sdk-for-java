...
public interface NetworkSecurityPerimeterConfigurationsClient {
    ...
    Response<NetworkSecurityPerimeterConfigurationInner> getByPrivateLinkScopeWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkSecurityPerimeterConfigurationInner getByPrivateLinkScope(
    ...
    PagedIterable<NetworkSecurityPerimeterConfigurationInner> listByPrivateLinkScope(
    ...
    SyncPoller<PollResult<Void>, Void> beginReconcileForPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void reconcileForPrivateLinkScope(
        String resourceGroupName, String scopeName, String perimeterName, Context context);
}
