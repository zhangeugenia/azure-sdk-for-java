...
public final class LookingGlassClientImpl implements LookingGlassClient {
    ...
    public interface LookingGlassService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LookingGlassOutputInner> invokeSync(@HostParam("$host") String endpoint,
            @QueryParam("command") LookingGlassCommand command,
            @QueryParam("sourceType") LookingGlassSourceType sourceType,
            @QueryParam("sourceLocation") String sourceLocation, @QueryParam("destinationIP") String destinationIp,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
    ...
    public Response<LookingGlassOutputInner> invokeWithResponse(LookingGlassCommand command,
        ...
        if (command == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter command is required and cannot be null."));
        }
        if (sourceType == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter sourceType is required and cannot be null."));
        }
        if (sourceLocation == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter sourceLocation is required and cannot be null."));
        }
        if (destinationIp == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter destinationIp is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.invokeSync(this.client.getEndpoint(), command, sourceType, sourceLocation, destinationIp,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LookingGlassClientImpl.class);
}
