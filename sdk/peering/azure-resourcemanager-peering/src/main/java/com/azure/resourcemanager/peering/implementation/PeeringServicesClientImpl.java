...
public final class PeeringServicesClientImpl implements PeeringServicesClient {
    ...
    public interface PeeringServicesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringServiceInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("peeringServiceName") String peeringServiceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringServiceInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("peeringServiceName") String peeringServiceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") PeeringServiceInner peeringService, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringServiceInner> updateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("peeringServiceName") String peeringServiceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ResourceTags tags, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringServiceListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringServiceListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> initializeConnectionMonitorSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<PeeringServiceInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
    ...
    public Response<PeeringServiceInner> createOrUpdateWithResponse(String resourceGroupName, String peeringServiceName,
        ...
        if (peeringService == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter peeringService is required and cannot be null."));
        } else {
            peeringService.validate();
        }
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), peeringService, accept, context);
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String peeringServiceName, Context context) {
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<PeeringServiceInner> updateWithResponse(String resourceGroupName, String peeringServiceName,
        ...
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), tags, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of peering services along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public Response<Void> initializeConnectionMonitorWithResponse(Context context) {
        ...
        final String accept = "application/json";
        return service.initializeConnectionMonitorSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(PeeringServicesClientImpl.class);
}
