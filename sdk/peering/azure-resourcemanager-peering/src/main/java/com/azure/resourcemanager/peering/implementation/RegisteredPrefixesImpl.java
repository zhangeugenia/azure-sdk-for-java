...
public final class RegisteredPrefixesImpl implements RegisteredPrefixes {
    ...
    public RegisteredPrefixesImpl(RegisteredPrefixesClient innerClient,
        com.azure.resourcemanager.peering.PeeringManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<PeeringRegisteredPrefix> getWithResponse(String resourceGroupName, String peeringName,
    ...
    public PeeringRegisteredPrefix getById(String id) {
        ...
        String registeredPrefixName = ResourceManagerUtils.getValueFromIdByName(id, "registeredPrefixes");
        if (registeredPrefixName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'registeredPrefixes'.", id)));
        }
