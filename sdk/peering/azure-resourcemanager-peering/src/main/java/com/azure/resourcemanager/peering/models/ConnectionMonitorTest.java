...
public interface ConnectionMonitorTest {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithSourceAgent, DefinitionStages.WithDestination,
            DefinitionStages.WithDestinationPort, DefinitionStages.WithTestFrequencyInSec {
            /**
     ...
     */
    interface Update extends UpdateStages.WithSourceAgent, UpdateStages.WithDestination,
        UpdateStages.WithDestinationPort, UpdateStages.WithTestFrequencyInSec {
        /**
