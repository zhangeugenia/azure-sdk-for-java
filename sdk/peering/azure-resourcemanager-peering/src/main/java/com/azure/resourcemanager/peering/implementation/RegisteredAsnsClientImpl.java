...
public final class RegisteredAsnsClientImpl implements RegisteredAsnsClient {
    ...
    public interface RegisteredAsnsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringRegisteredAsnInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("peeringName") String peeringName,
            @PathParam("registeredAsnName") String registeredAsnName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringRegisteredAsnInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("peeringName") String peeringName,
            @PathParam("registeredAsnName") String registeredAsnName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") PeeringRegisteredAsnInner registeredAsn,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PeeringRegisteredAsnListResult> listByPeeringSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("peeringName") String peeringName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<PeeringRegisteredAsnInner> getWithResponse(String resourceGroupName, String peeringName,
        ...
        if (registeredAsnName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter registeredAsnName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, peeringName, registeredAsnName,
    ...
    public Response<PeeringRegisteredAsnInner> createOrUpdateWithResponse(String resourceGroupName, String peeringName,
        ...
        if (registeredAsn == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter registeredAsn is required and cannot be null."));
        } else {
            registeredAsn.validate();
        }
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, peeringName, registeredAsnName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String peeringName, String registeredAsnName,
        ...
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, peeringName, registeredAsnName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of peering registered ASNs along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RegisteredAsnsClientImpl.class);
}
