...
public interface LookingGlassClient {
    ...
    Response<LookingGlassOutputInner> invokeWithResponse(LookingGlassCommand command, LookingGlassSourceType sourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    LookingGlassOutputInner invoke(LookingGlassCommand command, LookingGlassSourceType sourceType,
