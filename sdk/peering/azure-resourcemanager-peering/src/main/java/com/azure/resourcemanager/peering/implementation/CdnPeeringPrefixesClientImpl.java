...
public final class CdnPeeringPrefixesClientImpl implements CdnPeeringPrefixesClient {
    ...
    public interface CdnPeeringPrefixesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<CdnPeeringPrefixListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("peeringLocation") String peeringLocation, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of CDN peering prefixes along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CdnPeeringPrefixInner> listSinglePage(String peeringLocation) {
        ...
        final String accept = "application/json";
        Response<CdnPeeringPrefixListResult> res = service.listSync(this.client.getEndpoint(), peeringLocation,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CdnPeeringPrefixesClientImpl.class);
}
