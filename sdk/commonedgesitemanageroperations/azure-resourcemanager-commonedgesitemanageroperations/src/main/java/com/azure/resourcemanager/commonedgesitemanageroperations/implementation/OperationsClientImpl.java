...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(EdgeClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for EdgeClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "EdgeClientOperations")
