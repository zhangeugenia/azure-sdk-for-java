...
public final class PreValidateEnableBackupRequest implements JsonSerializable<PreValidateEnableBackupRequest> {
     ...
     */
    private DataSourceTypeAutoGenerated resourceType;
     ...
     */
    public DataSourceTypeAutoGenerated resourceType() {
     ...
     */
    public PreValidateEnableBackupRequest withResourceType(DataSourceTypeAutoGenerated resourceType) {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceType".equals(fieldName)) {
                    deserializedPreValidateEnableBackupRequest.resourceType
                        = DataSourceTypeAutoGenerated.fromString(reader.getString());
