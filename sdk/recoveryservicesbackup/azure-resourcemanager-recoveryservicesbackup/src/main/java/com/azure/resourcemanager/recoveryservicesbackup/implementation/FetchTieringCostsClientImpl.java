...
public final class FetchTieringCostsClientImpl implements FetchTieringCostsClient {
    ...
    private PollerFlux<PollResult<TieringCostInfoInner>, TieringCostInfoInner> beginPostAsync(
        String resourceGroupName, String vaultName, FetchTieringCostInfoRequest parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = postWithResponseAsync(resourceGroupName, vaultName, parameters);
        return this
            .client
            .<TieringCostInfoInner, TieringCostInfoInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<TieringCostInfoInner>, TieringCostInfoInner> beginPost(
        String resourceGroupName, String vaultName, FetchTieringCostInfoRequest parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TieringCostInfoInner> postAsync(
        String resourceGroupName, String vaultName, FetchTieringCostInfoRequest parameters) {
