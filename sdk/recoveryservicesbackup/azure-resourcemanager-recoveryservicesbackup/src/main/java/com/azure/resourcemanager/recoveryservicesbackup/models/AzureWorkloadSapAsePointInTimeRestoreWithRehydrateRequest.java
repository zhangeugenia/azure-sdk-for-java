 ...
 */
@Fluent
public final class AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest
    extends AzureWorkloadSapAsePointInTimeRestoreRequest {
    /*
     * This property will be used as the discriminator for deciding the specific types in the polymorphic chain of
     * types.
     */
    private String objectType = "AzureWorkloadSAPAsePointInTimeRestoreWithRehydrateRequest";
    ...
    /**
     * Creates an instance of AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest class.
     */
     ...
     * @return the AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest object itself.
     */
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withPointInTime(OffsetDateTime pointInTime) {
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withRecoveryType(RecoveryType recoveryType) {
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withSourceResourceId(String sourceResourceId) {
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withPropertyBag(Map<String, String> propertyBag) {
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withTargetInfo(TargetRestoreInfo targetInfo) {
     ...
     */
    @Override
    public AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest withRecoveryMode(RecoveryMode recoveryMode) {
    ...
    /**
     * Reads an instance of AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest if the JsonReader was pointing
     * to an instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the
     * AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest.
     */
    public static AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest
                = new AzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceGuardOperationRequests".equals(fieldName)) {
                    ...
                    deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest
                    ...
                    deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest.withPropertyBag(propertyBag);
                    ...
                    deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest.withPointInTime(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("objectType".equals(fieldName)) {
                    deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest.objectType
                        = reader.getString();
                } else if ("recoveryPointRehydrationInfo".equals(fieldName)) {
                    deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest.recoveryPointRehydrationInfo
            ...
            return deserializedAzureWorkloadSapAsePointInTimeRestoreWithRehydrateRequest;
        });
    }
}
