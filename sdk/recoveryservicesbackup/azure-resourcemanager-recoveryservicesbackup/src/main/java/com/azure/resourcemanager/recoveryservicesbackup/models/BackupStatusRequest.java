...
public final class BackupStatusRequest implements JsonSerializable<BackupStatusRequest> {
     ...
     */
    private DataSourceTypeAutoGenerated2 resourceType;
     ...
     */
    public DataSourceTypeAutoGenerated2 resourceType() {
     ...
     */
    public BackupStatusRequest withResourceType(DataSourceTypeAutoGenerated2 resourceType) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceType".equals(fieldName)) {
                    deserializedBackupStatusRequest.resourceType
                        = DataSourceTypeAutoGenerated2.fromString(reader.getString());
