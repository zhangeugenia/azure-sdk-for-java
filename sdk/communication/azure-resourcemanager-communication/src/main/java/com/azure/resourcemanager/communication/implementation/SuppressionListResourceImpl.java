...
public final class SuppressionListResourceImpl
    ...
    public SuppressionListResourceImpl withExistingDomain(
    ...
    public SuppressionListResource create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getSuppressionLists()
                .createOrUpdateWithResponse(
                    resourceGroupName, emailServiceName, domainName, suppressionListName, this.innerModel(), context)
                .getValue();
        return this;
    }

    SuppressionListResourceImpl(
    ...
    SuppressionListResourceImpl(
        SuppressionListResourceInner innerObject,
