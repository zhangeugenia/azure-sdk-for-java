...
public final class SuppressionListsImpl implements SuppressionLists {
    ...
    public SuppressionListsImpl(
        SuppressionListsClient innerClient,
        com.azure.resourcemanager.communication.CommunicationManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<SuppressionListResource> listByDomain(
    ...
    public Response<SuppressionListResource> getWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        Context context) {
        Response<SuppressionListResourceInner> inner =
            this
                .serviceClient()
    ...
    public SuppressionListResource get(
