...
public interface SuppressionListsClient {
    ...
    PagedIterable<SuppressionListResourceInner> listByDomain(
    ...
    Response<SuppressionListResourceInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SuppressionListResourceInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SuppressionListResourceInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SuppressionListResourceInner createOrUpdate(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
