...
public final class SuppressionListAddressesClientImpl implements SuppressionListAddressesClient {
    ...
    SuppressionListAddressesClientImpl(CommunicationServiceManagementClientImpl client) {
        this.service =
            RestProxy
                .create(SuppressionListAddressesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface SuppressionListAddressesService {
        ...
        Mono<Response<SuppressionListAddressResourceCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SuppressionListAddressResourceInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SuppressionListAddressResourceInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     * Get
     *
     * <p>Get all the addresses in a suppression list.
     *
    ...
    private Mono<PagedResponse<SuppressionListAddressResourceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<SuppressionListAddressResourceInner>>map(
                res ->
    ...
    private PagedFlux<SuppressionListAddressResourceInner> listAsync(
        String resourceGroupName, String emailServiceName, String domainName, String suppressionListName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SuppressionListAddressResourceInner> list(
        String resourceGroupName, String emailServiceName, String domainName, String suppressionListName) {
     ...
     * Get
     *
     * <p>Get a SuppressionListAddress.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param emailServiceName The name of the EmailService resource.
     * @param domainName The name of the Domains resource.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SuppressionListAddressResourceInner>> getWithResponseAsync(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SuppressionListAddressResourceInner> getAsync(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SuppressionListAddressResourceInner> getWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        return getWithResponseAsync(
                resourceGroupName, emailServiceName, domainName, suppressionListName, addressId, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SuppressionListAddressResourceInner get(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        return getWithResponse(
                resourceGroupName, emailServiceName, domainName, suppressionListName, addressId, Context.NONE)
            .getValue();
    }
     ...
     * Create Or Update
     *
     * <p>Create or update a SuppressionListAddress.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param emailServiceName The name of the EmailService resource.
     * @param domainName The name of the Domains resource.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SuppressionListAddressResourceInner> createOrUpdateAsync(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, emailServiceName, domainName, suppressionListName, addressId, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SuppressionListAddressResourceInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, emailServiceName, domainName, suppressionListName, addressId, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SuppressionListAddressResourceInner createOrUpdate(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     * Delete
     *
     * <p>Operation to delete a single address from a suppression list.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param emailServiceName The name of the EmailService resource.
     * @param domainName The name of the Domains resource.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SuppressionListAddressResourceInner>> listNextSinglePageAsync(
