...
public final class SuppressionListAddressesImpl implements SuppressionListAddresses {
    ...
    public SuppressionListAddressesImpl(
        SuppressionListAddressesClient innerClient,
        com.azure.resourcemanager.communication.CommunicationManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<SuppressionListAddressResource> list(
    ...
    public Response<SuppressionListAddressResource> getWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        String addressId,
        Context context) {
        Response<SuppressionListAddressResourceInner> inner =
            this
                .serviceClient()
                .getWithResponse(
    ...
    public SuppressionListAddressResource get(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'suppressionLists'.", id)));
        }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'suppressionListAddresses'.",
                                id)));
        }
        return this
            .getWithResponse(
