...
public final class SuppressionListsClientImpl implements SuppressionListsClient {
    ...
    public interface SuppressionListsService {
        ...
        Mono<Response<SuppressionListResourceCollection>> listByDomain(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SuppressionListResourceInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SuppressionListResourceInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     * List
     *
     * <p>List all suppression lists for a domains resource.
     *
    ...
    private Mono<PagedResponse<SuppressionListResourceInner>> listByDomainSinglePageAsync(
                ...
                context ->
                    service
                        .listByDomain(
                            ...
                            accept,
                            context))
            .<PagedResponse<SuppressionListResourceInner>>map(
                res ->
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a class representing a Domains SuppressionListResource collection as paginated response with {@link
     *     PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SuppressionListResourceInner> listByDomainAsync(
        String resourceGroupName, String emailServiceName, String domainName) {
        return new PagedFlux<>(
            () -> listByDomainSinglePageAsync(resourceGroupName, emailServiceName, domainName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SuppressionListResourceInner> listByDomain(
        String resourceGroupName, String emailServiceName, String domainName) {
     ...
     * Get
     *
     * <p>Get a SuppressionList resource.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param emailServiceName The name of the EmailService resource.
     * @param domainName The name of the Domains resource.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SuppressionListResourceInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SuppressionListResourceInner> getAsync(
        String resourceGroupName, String emailServiceName, String domainName, String suppressionListName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SuppressionListResourceInner> getWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SuppressionListResourceInner get(
        String resourceGroupName, String emailServiceName, String domainName, String suppressionListName) {
     ...
     * Create Or Update
     *
     * <p>Add a new SuppressionList resource under the parent Domains resource or update an existing SuppressionList
     * resource.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param emailServiceName The name of the EmailService resource.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SuppressionListResourceInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SuppressionListResourceInner> createOrUpdateAsync(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, emailServiceName, domainName, suppressionListName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SuppressionListResourceInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, emailServiceName, domainName, suppressionListName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SuppressionListResourceInner createOrUpdate(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, emailServiceName, domainName, suppressionListName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SuppressionListResourceInner>> listByDomainNextSinglePageAsync(
