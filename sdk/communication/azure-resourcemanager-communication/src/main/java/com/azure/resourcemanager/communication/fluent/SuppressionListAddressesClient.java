...
public interface SuppressionListAddressesClient {
    ...
    PagedIterable<SuppressionListAddressResourceInner> list(
    ...
    Response<SuppressionListAddressResourceInner> getWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SuppressionListAddressResourceInner get(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SuppressionListAddressResourceInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SuppressionListAddressResourceInner createOrUpdate(
        String resourceGroupName,
        String emailServiceName,
        String domainName,
        String suppressionListName,
