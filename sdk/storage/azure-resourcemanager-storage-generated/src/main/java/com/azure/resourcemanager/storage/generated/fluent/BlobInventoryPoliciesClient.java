...
public interface BlobInventoryPoliciesClient {
    ...
    Response<ListBlobInventoryPolicyInner> listWithResponse(String resourceGroupName, String accountName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ListBlobInventoryPolicyInner list(String resourceGroupName, String accountName);
