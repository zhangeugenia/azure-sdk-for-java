...
public final class UsagesClientImpl implements UsagesClient {
    ...
    public interface UsagesService {
        ...
        Mono<Response<UsageListResultInner>> listByLocation(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<UsageListResultInner>> listByLocationWithResponseAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<UsageListResultInner>> listByLocationWithResponseAsync(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the current usage count and the limit for the resources of the location under the subscription on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<UsageListResultInner> listByLocationAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<UsageListResultInner> listByLocationWithResponse(String location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UsageListResultInner listByLocation(String location) {
