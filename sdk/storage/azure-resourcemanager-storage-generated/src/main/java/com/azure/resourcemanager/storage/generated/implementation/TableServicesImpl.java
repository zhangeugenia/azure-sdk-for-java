...
public final class TableServicesImpl implements TableServices {
    ...
    public Response<TableServiceProperties> setServicePropertiesWithResponse(String resourceGroupName,
        String accountName, TableServicePropertiesInner parameters, Context context) {
        Response<TableServicePropertiesInner> inner = this.serviceClient()
    ...
    public TableServiceProperties setServiceProperties(String resourceGroupName, String accountName,
        TableServicePropertiesInner parameters) {
        TableServicePropertiesInner inner
