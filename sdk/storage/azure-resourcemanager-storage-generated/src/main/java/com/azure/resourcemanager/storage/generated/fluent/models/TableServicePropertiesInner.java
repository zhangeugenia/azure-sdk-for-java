...
public final class TableServicePropertiesInner extends ProxyResource {
     ...
     * The properties of a storage account’s Table service.
     */
    private TableServicePropertiesProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: The properties of a storage account’s Table service.
     * 
    ...
    public TableServicePropertiesInner withCors(CorsRules cors) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TableServicePropertiesProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedTableServicePropertiesInner.innerProperties
