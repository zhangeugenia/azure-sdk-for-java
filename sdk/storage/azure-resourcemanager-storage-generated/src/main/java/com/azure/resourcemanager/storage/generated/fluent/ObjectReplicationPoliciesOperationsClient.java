...
public interface ObjectReplicationPoliciesOperationsClient {
    ...
    Response<ObjectReplicationPoliciesInner> listWithResponse(String resourceGroupName, String accountName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ObjectReplicationPoliciesInner list(String resourceGroupName, String accountName);
