...
public final class StorageAccountsImpl implements StorageAccounts {
    ...
    public Response<CheckNameAvailabilityResult> checkStorageAccountNameAvailabilityWithResponse(
        StorageAccountCheckNameAvailabilityParameters accountName, Context context) {
        Response<CheckNameAvailabilityResultInner> inner
            = this.serviceClient().checkStorageAccountNameAvailabilityWithResponse(accountName, context);
        if (inner != null) {
    ...
    public CheckNameAvailabilityResult
        ...
        CheckNameAvailabilityResultInner inner = this.serviceClient().checkStorageAccountNameAvailability(accountName);
        if (inner != null) {
