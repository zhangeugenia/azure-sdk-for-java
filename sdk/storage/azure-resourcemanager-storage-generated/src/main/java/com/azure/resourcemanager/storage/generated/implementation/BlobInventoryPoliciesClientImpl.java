...
public final class BlobInventoryPoliciesClientImpl implements BlobInventoryPoliciesClient {
    ...
    public interface BlobInventoryPoliciesService {
        ...
        Mono<Response<ListBlobInventoryPolicyInner>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<ListBlobInventoryPolicyInner>> listWithResponseAsync(String resourceGroupName,
        String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListBlobInventoryPolicyInner> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ListBlobInventoryPolicyInner> listWithResponse(String resourceGroupName, String accountName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListBlobInventoryPolicyInner list(String resourceGroupName, String accountName) {
