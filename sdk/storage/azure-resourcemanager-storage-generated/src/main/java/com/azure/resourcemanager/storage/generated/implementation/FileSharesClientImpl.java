...
public final class FileSharesClientImpl implements FileSharesClient {
    ...
    private Mono<PagedResponse<FileShareItemInner>> listSinglePageAsync(String resourceGroupName, String accountName,
        Integer maxpagesize, String filter, String expand) {
    ...
    private PagedFlux<FileShareItemInner> listAsync(String resourceGroupName, String accountName, Integer maxpagesize,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FileShareItemInner> list(String resourceGroupName, String accountName, Integer maxpagesize,
        String filter, String expand, Context context) {
