...
public final class BlobContainersImpl implements BlobContainers {
    ...
    public Response<ImmutabilityPolicy> createOrUpdateImmutabilityPolicyWithResponse(String resourceGroupName,
        String accountName, String containerName, ImmutabilityPolicyInner parameters, String ifMatch, Context context) {
        BlobContainersCreateOrUpdateImmutabilityPolicyResponse inner = this.serviceClient()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, parameters,
                ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
    ...
    public ImmutabilityPolicy createOrUpdateImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, ImmutabilityPolicyInner parameters) {
        ImmutabilityPolicyInner inner = this.serviceClient()
            .createOrUpdateImmutabilityPolicy(resourceGroupName, accountName, containerName, parameters);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
            return null;
