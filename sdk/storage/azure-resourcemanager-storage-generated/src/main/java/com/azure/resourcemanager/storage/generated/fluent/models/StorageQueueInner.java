...
public final class StorageQueueInner extends ProxyResource {
     ...
     */
    private QueueProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: Queue resource properties.
     * 
    ...
    public StorageQueueInner withMetadata(Map<String, String> metadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new QueueProperties();
        }
    ...
    public Integer approximateMessageCount() {
        return this.innerProperties() == null ? null : this.innerProperties().approximateMessageCount();
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedStorageQueueInner.innerProperties = QueueProperties.fromJson(reader);
