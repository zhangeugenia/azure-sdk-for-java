...
public final class QueuesClientImpl implements QueuesClient {
    ...
    private PagedFlux<ListQueueInner> listAsync(String resourceGroupName, String accountName, Integer maxpagesize,
        String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ListQueueInner> list(String resourceGroupName, String accountName, Integer maxpagesize,
        String filter, Context context) {
