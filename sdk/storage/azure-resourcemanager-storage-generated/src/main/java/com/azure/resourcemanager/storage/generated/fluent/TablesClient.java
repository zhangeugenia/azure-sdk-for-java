...
public interface TablesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TableInner create(String resourceGroupName, String accountName, String tableName, TableInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TableInner update(String resourceGroupName, String accountName, String tableName, TableInner parameters);
