...
public final class FileServicePropertiesInner extends ProxyResource {
     ...
     * The properties of File services in storage account.
     */
    private FileServicePropertiesProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: The properties of File services in storage account.
     * 
    ...
    public FileServicePropertiesInner withCors(CorsRules cors) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FileServicePropertiesProperties();
        }
    ...
    public DeleteRetentionPolicy shareDeleteRetentionPolicy() {
        return this.innerProperties() == null ? null : this.innerProperties().shareDeleteRetentionPolicy();
    }
    ...
    public FileServicePropertiesInner withShareDeleteRetentionPolicy(DeleteRetentionPolicy shareDeleteRetentionPolicy) {
        ...
        this.innerProperties().withShareDeleteRetentionPolicy(shareDeleteRetentionPolicy);
        return this;
    }
    ...
    public ProtocolSettings protocolSettings() {
        return this.innerProperties() == null ? null : this.innerProperties().protocolSettings();
    }
    ...
    public FileServicePropertiesInner withProtocolSettings(ProtocolSettings protocolSettings) {
        ...
        this.innerProperties().withProtocolSettings(protocolSettings);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedFileServicePropertiesInner.innerProperties
                    ...
                    deserializedFileServicePropertiesInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
