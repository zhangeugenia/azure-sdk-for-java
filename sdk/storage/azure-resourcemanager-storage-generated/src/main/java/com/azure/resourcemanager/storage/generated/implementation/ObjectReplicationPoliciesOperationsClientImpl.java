...
public final class ObjectReplicationPoliciesOperationsClientImpl implements ObjectReplicationPoliciesOperationsClient {
    ...
    public interface ObjectReplicationPoliciesOperationsService {
        ...
        Mono<Response<ObjectReplicationPoliciesInner>> list(@HostParam("$host") String endpoint,
     ...
     * @return list storage account object replication policies along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ObjectReplicationPoliciesInner>> listWithResponseAsync(String resourceGroupName,
        String accountName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list storage account object replication policies on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ObjectReplicationPoliciesInner> listAsync(String resourceGroupName, String accountName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list storage account object replication policies along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ObjectReplicationPoliciesInner> listWithResponse(String resourceGroupName, String accountName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ObjectReplicationPoliciesInner list(String resourceGroupName, String accountName) {
    ...
    private Mono<Response<ObjectReplicationPolicyInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, objectReplicationPolicyId, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ObjectReplicationPolicyInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, objectReplicationPolicyId, accept, context);
    }
    ...
    private Mono<Response<ObjectReplicationPolicyInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, objectReplicationPolicyId, properties,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
