...
public final class BlobContainersClientImpl implements BlobContainersClient {
    ...
    public interface BlobContainersService {
        ...
        Mono<BlobContainersGetImmutabilityPolicyResponse> getImmutabilityPolicy(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("containerName") String containerName, @HeaderParam("if-match") String ifMatch,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<BlobContainersGetImmutabilityPolicyResponse> getImmutabilityPolicyWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.getImmutabilityPolicy(this.client.getEndpoint(),
                ...
                containerName, ifMatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<BlobContainersGetImmutabilityPolicyResponse> getImmutabilityPolicyWithResponseAsync(
        ...
        return service.getImmutabilityPolicy(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, ifMatch, accept, context);
    }
    ...
    private Mono<BlobContainersCreateOrUpdateImmutabilityPolicyResponse>
        createOrUpdateImmutabilityPolicyWithResponseAsync(String resourceGroupName, String accountName,
            String containerName, ImmutabilityPolicyInner parameters, String ifMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdateImmutabilityPolicy(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, accountName,
                containerName, ifMatch, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<BlobContainersCreateOrUpdateImmutabilityPolicyResponse>
        createOrUpdateImmutabilityPolicyWithResponseAsync(String resourceGroupName, String accountName,
            String containerName, ImmutabilityPolicyInner parameters, String ifMatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdateImmutabilityPolicy(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, ifMatch, parameters, accept,
            context);
    }
    ...
    private Mono<ImmutabilityPolicyInner> createOrUpdateImmutabilityPolicyAsync(String resourceGroupName,
        String accountName, String containerName, ImmutabilityPolicyInner parameters) {
        final String ifMatch = null;
    ...
    public BlobContainersCreateOrUpdateImmutabilityPolicyResponse createOrUpdateImmutabilityPolicyWithResponse(
        String resourceGroupName, String accountName, String containerName, ImmutabilityPolicyInner parameters,
    ...
    public ImmutabilityPolicyInner createOrUpdateImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, ImmutabilityPolicyInner parameters) {
        final String ifMatch = null;
        return createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, parameters,
