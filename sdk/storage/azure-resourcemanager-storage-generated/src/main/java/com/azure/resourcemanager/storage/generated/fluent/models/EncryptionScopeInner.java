...
public final class EncryptionScopeInner extends ProxyResource {
     ...
     */
    private EncryptionScopeProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: Properties of the encryption scope.
     * 
    ...
    public EncryptionScopeInner withSource(EncryptionScopeSource source) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EncryptionScopeProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedEncryptionScopeInner.innerProperties = EncryptionScopeProperties.fromJson(reader);
