...
public final class QueueServicePropertiesInner extends ProxyResource {
     ...
     * The properties of a storage account’s Queue service.
     */
    private QueueServicePropertiesProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: The properties of a storage account’s Queue service.
     * 
    ...
    public QueueServicePropertiesInner withCors(CorsRules cors) {
        if (this.innerProperties() == null) {
            this.innerProperties = new QueueServicePropertiesProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedQueueServicePropertiesInner.innerProperties
