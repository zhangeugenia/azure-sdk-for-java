...
public interface BlobServicesClient {
    ...
    Response<BlobServiceItemsInner> listWithResponse(String resourceGroupName, String accountName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BlobServiceItemsInner list(String resourceGroupName, String accountName);
