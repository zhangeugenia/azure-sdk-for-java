...
public final class TriageRecommendationsClientImpl implements TriageRecommendationsClient {
    ...
    private Mono<PagedResponse<TriageRecommendationInner>> listSinglePageAsync(String reviewId, Integer top,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                this.client.getApiVersion(), reviewId, top, skip, accept, context))
    ...
    private Mono<Response<Void>> approveTriageRecommendationWithResponseAsync(String reviewId,
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.approveTriageRecommendation(this.client.getEndpoint(),
            this.client.getSubscriptionId(), this.client.getApiVersion(), reviewId, recommendationId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> approveTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.approveTriageRecommendation(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), reviewId, recommendationId, accept, context);
    }
    ...
    private Mono<Response<Void>> rejectTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        return FluxUtil
            .withContext(context -> service.rejectTriageRecommendation(this.client.getEndpoint(),
                this.client.getSubscriptionId(), this.client.getApiVersion(), reviewId, recommendationId,
    ...
    private Mono<Response<Void>> rejectTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.rejectTriageRecommendation(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), reviewId, recommendationId, recommendationRejectBody, accept, context);
    }
    ...
    private Mono<Response<Void>> resetTriageRecommendationWithResponseAsync(String reviewId, String recommendationId) {
        ...
        return FluxUtil
            .withContext(
                context -> service.resetTriageRecommendation(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    this.client.getApiVersion(), reviewId, recommendationId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> resetTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.resetTriageRecommendation(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), reviewId, recommendationId, accept, context);
    }
