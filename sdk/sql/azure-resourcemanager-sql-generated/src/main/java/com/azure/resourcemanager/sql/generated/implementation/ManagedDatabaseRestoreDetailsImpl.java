...
public final class ManagedDatabaseRestoreDetailsImpl implements ManagedDatabaseRestoreDetails {
    ...
    public ManagedDatabaseRestoreDetailsImpl(ManagedDatabaseRestoreDetailsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ManagedDatabaseRestoreDetailsResult> getWithResponse(String resourceGroupName,
        String managedInstanceName, String databaseName, RestoreDetailsName restoreDetailsName, Context context) {
        Response<ManagedDatabaseRestoreDetailsResultInner> inner = this.serviceClient()
    ...
    public ManagedDatabaseRestoreDetailsResult get(String resourceGroupName, String managedInstanceName,
