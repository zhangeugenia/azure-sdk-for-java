...
public final class FailoverGroupsClientImpl implements FailoverGroupsClient {
    ...
    public interface FailoverGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FailoverGroupListResult> listByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FailoverGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("failoverGroupName") String failoverGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> forceFailoverAllowDataLossSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("failoverGroupName") String failoverGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> tryPlannedBeforeForcedFailoverSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("failoverGroupName") String failoverGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FailoverGroupListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FailoverGroupInner> listByServerSinglePage(String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<FailoverGroupListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public Response<FailoverGroupInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, failoverGroupName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, failoverGroupName,
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, failoverGroupName, parameters);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, failoverGroupName, parameters, context);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, context);
    }
    ...
    public FailoverGroupInner createOrUpdate(String resourceGroupName, String serverName, String failoverGroupName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, failoverGroupName, parameters).getFinalResult();
    }
    ...
    public FailoverGroupInner createOrUpdate(String resourceGroupName, String serverName, String failoverGroupName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, failoverGroupName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, serverName, failoverGroupName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String failoverGroupName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, failoverGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String failoverGroupName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, failoverGroupName, context);
    ...
    public void delete(String resourceGroupName, String serverName, String failoverGroupName) {
        beginDelete(resourceGroupName, serverName, failoverGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String serverName, String failoverGroupName, Context context) {
        beginDelete(resourceGroupName, serverName, failoverGroupName, context).getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, serverName, failoverGroupName,
            this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginUpdate(String resourceGroupName,
        String serverName, String failoverGroupName, FailoverGroupUpdate parameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, failoverGroupName, parameters);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, failoverGroupName, parameters, context);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, context);
    }
    ...
    public FailoverGroupInner update(String resourceGroupName, String serverName, String failoverGroupName,
        FailoverGroupUpdate parameters) {
        return beginUpdate(resourceGroupName, serverName, failoverGroupName, parameters).getFinalResult();
    }
    ...
    public FailoverGroupInner update(String resourceGroupName, String serverName, String failoverGroupName,
        ...
        return beginUpdate(resourceGroupName, serverName, failoverGroupName, parameters, context).getFinalResult();
    }
    ...
    private Response<BinaryData> failoverWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.failoverSync(this.client.getEndpoint(), resourceGroupName, serverName, failoverGroupName,
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginFailover(String resourceGroupName,
        String serverName, String failoverGroupName) {
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, serverName, failoverGroupName);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginFailover(String resourceGroupName,
        ...
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, serverName, failoverGroupName, context);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, context);
    }
    ...
    public FailoverGroupInner failover(String resourceGroupName, String serverName, String failoverGroupName) {
        return beginFailover(resourceGroupName, serverName, failoverGroupName).getFinalResult();
    }
    ...
    public FailoverGroupInner failover(String resourceGroupName, String serverName, String failoverGroupName,
        Context context) {
        return beginFailover(resourceGroupName, serverName, failoverGroupName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> forceFailoverAllowDataLossWithResponse(String resourceGroupName, String serverName,
        String failoverGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.forceFailoverAllowDataLossSync(this.client.getEndpoint(), resourceGroupName, serverName,
            failoverGroupName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner>
        ...
        Response<BinaryData> response
            = forceFailoverAllowDataLossWithResponse(resourceGroupName, serverName, failoverGroupName);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginForceFailoverAllowDataLoss(
        ...
        Response<BinaryData> response
            = forceFailoverAllowDataLossWithResponse(resourceGroupName, serverName, failoverGroupName, context);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, context);
    }
    ...
    public FailoverGroupInner forceFailoverAllowDataLoss(String resourceGroupName, String serverName,
        String failoverGroupName) {
        return beginForceFailoverAllowDataLoss(resourceGroupName, serverName, failoverGroupName).getFinalResult();
    }
    ...
    public FailoverGroupInner forceFailoverAllowDataLoss(String resourceGroupName, String serverName,
        String failoverGroupName, Context context) {
        return beginForceFailoverAllowDataLoss(resourceGroupName, serverName, failoverGroupName, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> tryPlannedBeforeForcedFailoverWithResponse(String resourceGroupName, String serverName,
        String failoverGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.tryPlannedBeforeForcedFailoverSync(this.client.getEndpoint(), resourceGroupName, serverName,
            failoverGroupName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner>
        ...
        Response<BinaryData> response
            = tryPlannedBeforeForcedFailoverWithResponse(resourceGroupName, serverName, failoverGroupName);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FailoverGroupInner>, FailoverGroupInner> beginTryPlannedBeforeForcedFailover(
        String resourceGroupName, String serverName, String failoverGroupName, Context context) {
        Response<BinaryData> response
            = tryPlannedBeforeForcedFailoverWithResponse(resourceGroupName, serverName, failoverGroupName, context);
        return this.client.<FailoverGroupInner, FailoverGroupInner>getLroResult(response, FailoverGroupInner.class,
            FailoverGroupInner.class, context);
    }
    ...
    public FailoverGroupInner tryPlannedBeforeForcedFailover(String resourceGroupName, String serverName,
        String failoverGroupName) {
        return beginTryPlannedBeforeForcedFailover(resourceGroupName, serverName, failoverGroupName).getFinalResult();
    }
    ...
    public FailoverGroupInner tryPlannedBeforeForcedFailover(String resourceGroupName, String serverName,
        String failoverGroupName, Context context) {
        return beginTryPlannedBeforeForcedFailover(resourceGroupName, serverName, failoverGroupName, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FailoverGroupInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FailoverGroupInner> listByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
