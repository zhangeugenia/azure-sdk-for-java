...
public final class InstancePoolsImpl implements InstancePools {
    ...
    public PagedIterable<InstancePool> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new InstancePoolImpl(inner1, this.manager()));
    }
    ...
    public InstancePool getById(String id) {
        ...
        String instancePoolName = ResourceManagerUtils.getValueFromIdByName(id, "instancePools");
