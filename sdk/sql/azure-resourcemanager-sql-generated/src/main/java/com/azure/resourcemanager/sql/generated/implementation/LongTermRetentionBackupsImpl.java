...
public final class LongTermRetentionBackupsImpl implements LongTermRetentionBackups {
    ...
    public Response<LongTermRetentionBackup> getWithResponse(String locationName, String longTermRetentionServerName,
        ...
        Response<LongTermRetentionBackupInner> inner = this.serviceClient()
            .getWithResponse(locationName, longTermRetentionServerName, longTermRetentionDatabaseName, backupName,
                context);
        if (inner != null) {
    ...
    public LongTermRetentionBackup get(String locationName, String longTermRetentionServerName,
        ...
        LongTermRetentionBackupInner inner = this.serviceClient()
    ...
    public LongTermRetentionBackup changeAccessTier(String locationName, String longTermRetentionServerName,
        ...
        LongTermRetentionBackupInner inner = this.serviceClient()
            .changeAccessTier(locationName, longTermRetentionServerName, longTermRetentionDatabaseName, backupName,
                parameters);
        if (inner != null) {
            return new LongTermRetentionBackupImpl(inner, this.manager());
        } else {
    ...
    public LongTermRetentionBackupOperationResult copy(String locationName, String longTermRetentionServerName,
        ...
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient()
    ...
    public LongTermRetentionBackupOperationResult update(String locationName, String longTermRetentionServerName,
        ...
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient()
            .update(locationName, longTermRetentionServerName, longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
            return new LongTermRetentionBackupOperationResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<LongTermRetentionBackup> listByResourceGroupDatabase(String resourceGroupName,
        ...
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient()
            .listByResourceGroupDatabase(resourceGroupName, locationName, longTermRetentionServerName,
    ...
    public Response<LongTermRetentionBackup> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        String backupName, Context context) {
        Response<LongTermRetentionBackupInner> inner = this.serviceClient()
            .getByResourceGroupWithResponse(resourceGroupName, locationName, longTermRetentionServerName,
    ...
    public LongTermRetentionBackup getByResourceGroup(String resourceGroupName, String locationName,
        ...
        LongTermRetentionBackupInner inner = this.serviceClient()
            .getByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
    ...
    public void deleteByResourceGroup(String resourceGroupName, String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName) {
        this.serviceClient()
            .deleteByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
                longTermRetentionDatabaseName, backupName);
    }
    ...
    public LongTermRetentionBackup changeAccessTierByResourceGroup(String resourceGroupName, String locationName,
        ...
        ChangeLongTermRetentionBackupAccessTierParameters parameters) {
        LongTermRetentionBackupInner inner = this.serviceClient()
            .changeAccessTierByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
    ...
    public LongTermRetentionBackupOperationResult copyByResourceGroup(String resourceGroupName, String locationName,
        ...
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient()
            .copyByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
                longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
            return new LongTermRetentionBackupOperationResultImpl(inner, this.manager());
        } else {
    ...
    public LongTermRetentionBackupOperationResult updateByResourceGroup(String resourceGroupName, String locationName,
        ...
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient()
            .updateByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
                longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
            return new LongTermRetentionBackupOperationResultImpl(inner, this.manager());
        } else {
