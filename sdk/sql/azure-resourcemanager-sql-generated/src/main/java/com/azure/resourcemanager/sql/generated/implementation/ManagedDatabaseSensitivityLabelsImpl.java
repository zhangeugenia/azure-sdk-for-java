...
public final class ManagedDatabaseSensitivityLabelsImpl implements ManagedDatabaseSensitivityLabels {
    ...
    public PagedIterable<SensitivityLabel> listCurrentByDatabase(String resourceGroupName, String managedInstanceName,
        ...
        PagedIterable<SensitivityLabelInner> inner = this.serviceClient()
            .listCurrentByDatabase(resourceGroupName, managedInstanceName, databaseName, skipToken, count, filter,
                context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SensitivityLabelImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SensitivityLabel> listRecommendedByDatabase(String resourceGroupName,
        ...
        PagedIterable<SensitivityLabelInner> inner = this.serviceClient()
            .listRecommendedByDatabase(resourceGroupName, managedInstanceName, databaseName, skipToken,
