...
public final class TransparentDataEncryptionsClientImpl implements TransparentDataEncryptionsClient {
    ...
    public interface TransparentDataEncryptionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LogicalDatabaseTransparentDataEncryptionListResult> listByDatabaseSync(
            @HostParam("$host") String endpoint, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName, @PathParam("databaseName") String databaseName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LogicalDatabaseTransparentDataEncryptionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("tdeName") TransparentDataEncryptionName tdeName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LogicalDatabaseTransparentDataEncryptionListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of the logical database's transparent data encryption along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LogicalDatabaseTransparentDataEncryptionInner>
        listByDatabaseSinglePage(String resourceGroupName, String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        Response<LogicalDatabaseTransparentDataEncryptionListResult> res
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LogicalDatabaseTransparentDataEncryptionInner>
        listByDatabaseSinglePage(String resourceGroupName, String serverName, String databaseName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public Response<LogicalDatabaseTransparentDataEncryptionInner> getWithResponse(String resourceGroupName,
        ...
        if (tdeName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter tdeName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, tdeName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            tdeName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, tdeName, parameters);
        return this.client
            .<LogicalDatabaseTransparentDataEncryptionInner, LogicalDatabaseTransparentDataEncryptionInner>getLroResult(
                response, LogicalDatabaseTransparentDataEncryptionInner.class,
                LogicalDatabaseTransparentDataEncryptionInner.class, Context.NONE);
    }
    ...
    public
        ...
        beginCreateOrUpdate(String resourceGroupName, String serverName, String databaseName,
            ...
            Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, tdeName, parameters, context);
        return this.client
            .<LogicalDatabaseTransparentDataEncryptionInner, LogicalDatabaseTransparentDataEncryptionInner>getLroResult(
                response, LogicalDatabaseTransparentDataEncryptionInner.class,
    ...
    public LogicalDatabaseTransparentDataEncryptionInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, TransparentDataEncryptionName tdeName,
        LogicalDatabaseTransparentDataEncryptionInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, tdeName, parameters).getFinalResult();
    }
    ...
    public LogicalDatabaseTransparentDataEncryptionInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, TransparentDataEncryptionName tdeName,
        LogicalDatabaseTransparentDataEncryptionInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, tdeName, parameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of transparent data encryptions along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LogicalDatabaseTransparentDataEncryptionInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(TransparentDataEncryptionsClientImpl.class);
}
