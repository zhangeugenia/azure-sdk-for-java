...
public final class InstanceFailoverGroupsClientImpl implements InstanceFailoverGroupsClient {
    ...
    public interface InstanceFailoverGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InstanceFailoverGroupListResult> listByLocationSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("locationName") String locationName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InstanceFailoverGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("locationName") String locationName,
            @PathParam("failoverGroupName") String failoverGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InstanceFailoverGroupListResult> listByLocationNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of instance failover groups along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<InstanceFailoverGroupInner> listByLocationSinglePage(String resourceGroupName,
        String locationName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        Response<InstanceFailoverGroupListResult> res = service.listByLocationSync(this.client.getEndpoint(),
            resourceGroupName, locationName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    ...
    private PagedResponse<InstanceFailoverGroupInner> listByLocationSinglePage(String resourceGroupName,
        ...
        final String accept = "application/json";
        Response<InstanceFailoverGroupListResult> res = service.listByLocationSync(this.client.getEndpoint(),
            resourceGroupName, locationName, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<InstanceFailoverGroupInner> listByLocation(String resourceGroupName, String locationName) {
        return new PagedIterable<>(() -> listByLocationSinglePage(resourceGroupName, locationName),
    ...
    public PagedIterable<InstanceFailoverGroupInner> listByLocation(String resourceGroupName, String locationName,
        Context context) {
        return new PagedIterable<>(() -> listByLocationSinglePage(resourceGroupName, locationName, context),
    ...
    public Response<InstanceFailoverGroupInner> getWithResponse(String resourceGroupName, String locationName,
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, locationName, failoverGroupName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an instance failover group along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String locationName,
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, locationName, failoverGroupName,
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, locationName, failoverGroupName, parameters);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, locationName, failoverGroupName, parameters, context);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, context);
    }
    ...
    public InstanceFailoverGroupInner createOrUpdate(String resourceGroupName, String locationName,
        String failoverGroupName, InstanceFailoverGroupInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, locationName, failoverGroupName, parameters).getFinalResult();
    }
    ...
    public InstanceFailoverGroupInner createOrUpdate(String resourceGroupName, String locationName,
        String failoverGroupName, InstanceFailoverGroupInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, locationName, failoverGroupName, parameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String locationName,
        String failoverGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-05-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, locationName, failoverGroupName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String locationName,
        String failoverGroupName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, locationName, failoverGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String locationName,
        String failoverGroupName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, locationName, failoverGroupName, context);
    ...
    public void delete(String resourceGroupName, String locationName, String failoverGroupName) {
        beginDelete(resourceGroupName, locationName, failoverGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String locationName, String failoverGroupName, Context context) {
        beginDelete(resourceGroupName, locationName, failoverGroupName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> failoverWithResponse(String resourceGroupName, String locationName,
        String failoverGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        return service.failoverSync(this.client.getEndpoint(), resourceGroupName, locationName, failoverGroupName,
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner>
        ...
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, locationName, failoverGroupName);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner>
        ...
        Response<BinaryData> response
            = failoverWithResponse(resourceGroupName, locationName, failoverGroupName, context);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, context);
    }
    ...
    public InstanceFailoverGroupInner failover(String resourceGroupName, String locationName,
        String failoverGroupName) {
        return beginFailover(resourceGroupName, locationName, failoverGroupName).getFinalResult();
    }
    ...
    public InstanceFailoverGroupInner failover(String resourceGroupName, String locationName, String failoverGroupName,
        Context context) {
        return beginFailover(resourceGroupName, locationName, failoverGroupName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> forceFailoverAllowDataLossWithResponse(String resourceGroupName, String locationName,
        String failoverGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        return service.forceFailoverAllowDataLossSync(this.client.getEndpoint(), resourceGroupName, locationName,
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner>
        ...
        Response<BinaryData> response
            = forceFailoverAllowDataLossWithResponse(resourceGroupName, locationName, failoverGroupName);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<InstanceFailoverGroupInner>, InstanceFailoverGroupInner>
        beginForceFailoverAllowDataLoss(String resourceGroupName, String locationName, String failoverGroupName,
            Context context) {
        Response<BinaryData> response
            = forceFailoverAllowDataLossWithResponse(resourceGroupName, locationName, failoverGroupName, context);
        return this.client.<InstanceFailoverGroupInner, InstanceFailoverGroupInner>getLroResult(response,
            InstanceFailoverGroupInner.class, InstanceFailoverGroupInner.class, context);
    }
    ...
    public InstanceFailoverGroupInner forceFailoverAllowDataLoss(String resourceGroupName, String locationName,
        String failoverGroupName) {
        return beginForceFailoverAllowDataLoss(resourceGroupName, locationName, failoverGroupName).getFinalResult();
    }
    ...
    public InstanceFailoverGroupInner forceFailoverAllowDataLoss(String resourceGroupName, String locationName,
        String failoverGroupName, Context context) {
        return beginForceFailoverAllowDataLoss(resourceGroupName, locationName, failoverGroupName, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<InstanceFailoverGroupInner> listByLocationNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<InstanceFailoverGroupListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<InstanceFailoverGroupInner> listByLocationNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(InstanceFailoverGroupsClientImpl.class);
}
