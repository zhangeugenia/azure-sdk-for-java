...
public final class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesImpl
    ...
    public ManagedBackupShortTermRetentionPolicy createOrUpdate(String resourceGroupName, String managedInstanceName,
        ...
        ManagedBackupShortTermRetentionPolicyInner inner = this.serviceClient()
            .createOrUpdate(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, policyName,
                parameters);
        if (inner != null) {
            return new ManagedBackupShortTermRetentionPolicyImpl(inner, this.manager());
        } else {
    ...
    public ManagedBackupShortTermRetentionPolicy createOrUpdate(String resourceGroupName, String managedInstanceName,
        ...
        ManagedBackupShortTermRetentionPolicyInner inner = this.serviceClient()
            .createOrUpdate(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, policyName, parameters,
                context);
        if (inner != null) {
            return new ManagedBackupShortTermRetentionPolicyImpl(inner, this.manager());
        } else {
