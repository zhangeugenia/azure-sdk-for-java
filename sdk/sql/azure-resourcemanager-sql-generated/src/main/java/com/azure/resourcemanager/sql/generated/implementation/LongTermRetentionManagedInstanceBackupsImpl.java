...
public final class LongTermRetentionManagedInstanceBackupsImpl implements LongTermRetentionManagedInstanceBackups {
    ...
    public Response<ManagedInstanceLongTermRetentionBackup> getWithResponse(String locationName,
        ...
        Response<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient()
            .getWithResponse(locationName, managedInstanceName, databaseName, backupName, context);
        if (inner != null) {
    ...
    public Response<ManagedInstanceLongTermRetentionBackup> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        Response<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient()
            .getByResourceGroupWithResponse(resourceGroupName, locationName, managedInstanceName, databaseName,
                backupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ManagedInstanceLongTermRetentionBackupImpl(inner.getValue(), this.manager()));
    ...
    public ManagedInstanceLongTermRetentionBackup getByResourceGroup(String resourceGroupName, String locationName,
        ...
        ManagedInstanceLongTermRetentionBackupInner inner = this.serviceClient()
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupInstance(String resourceGroupName,
        ...
        Context context) {
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient()
            .listByResourceGroupInstance(resourceGroupName, locationName, managedInstanceName, onlyLatestPerDatabase,
