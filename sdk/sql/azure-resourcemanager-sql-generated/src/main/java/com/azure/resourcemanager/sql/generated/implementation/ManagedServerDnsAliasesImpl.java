...
public final class ManagedServerDnsAliasesImpl implements ManagedServerDnsAliases {
    ...
    public PagedIterable<ManagedServerDnsAlias> listByManagedInstance(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ManagedServerDnsAliasImpl(inner1, this.manager()));
    }
    ...
    public ManagedServerDnsAlias getById(String id) {
        ...
        String dnsAliasName = ResourceManagerUtils.getValueFromIdByName(id, "dnsAliases");
