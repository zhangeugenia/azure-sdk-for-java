...
public final class DatabaseExtensionsOperationsClientImpl implements DatabaseExtensionsOperationsClient {
    ...
    public interface DatabaseExtensionsOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("extensionName") String extensionName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ImportExportExtensionsOperationListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ImportExportExtensionsOperationListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<Void> getWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2021-02-01-preview";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, extensionName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an Extension operation result resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            extensionName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, extensionName, parameters);
        return this.client
            .<ImportExportExtensionsOperationResultInner, ImportExportExtensionsOperationResultInner>getLroResult(
                response, ImportExportExtensionsOperationResultInner.class,
                ImportExportExtensionsOperationResultInner.class, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName,
            extensionName, parameters, context);
        return this.client
            .<ImportExportExtensionsOperationResultInner, ImportExportExtensionsOperationResultInner>getLroResult(
                response, ImportExportExtensionsOperationResultInner.class,
    ...
    public ImportExportExtensionsOperationResultInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, String extensionName, DatabaseExtensions parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, extensionName, parameters)
            .getFinalResult();
    }
    ...
    public ImportExportExtensionsOperationResultInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, String extensionName, DatabaseExtensions parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, extensionName, parameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return import export operation extensions list along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ImportExportExtensionsOperationResultInner> listByDatabaseSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<ImportExportExtensionsOperationListResult> res
    ...
    private PagedResponse<ImportExportExtensionsOperationResultInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<ImportExportExtensionsOperationListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ImportExportExtensionsOperationResultInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DatabaseExtensionsOperationsClientImpl.class);
}
