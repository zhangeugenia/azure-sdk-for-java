...
public final class ElasticPoolActivitiesClientImpl implements ElasticPoolActivitiesClient {
    ...
    public interface ElasticPoolActivitiesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ElasticPoolActivityListResult> listByElasticPoolSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("elasticPoolName") String elasticPoolName, @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents the response to a list elastic pool activity request along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ElasticPoolActivityInner> listByElasticPoolSinglePage(String resourceGroupName,
        String serverName, String elasticPoolName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2014-04-01";
        final String accept = "application/json";
        Response<ElasticPoolActivityListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ElasticPoolActivitiesClientImpl.class);
}
