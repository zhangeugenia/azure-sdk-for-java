...
public final class BackupShortTermRetentionPoliciesClientImpl implements BackupShortTermRetentionPoliciesClient {
    ...
    public interface BackupShortTermRetentionPoliciesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BackupShortTermRetentionPolicyInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
            @PathParam("policyName") ShortTermRetentionPolicyName policyName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BackupShortTermRetentionPolicyListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BackupShortTermRetentionPolicyListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<BackupShortTermRetentionPolicyInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, policyName,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            policyName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<BackupShortTermRetentionPolicyInner>, BackupShortTermRetentionPolicyInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, policyName, parameters);
        return this.client.<BackupShortTermRetentionPolicyInner, BackupShortTermRetentionPolicyInner>getLroResult(
            response, BackupShortTermRetentionPolicyInner.class, BackupShortTermRetentionPolicyInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<BackupShortTermRetentionPolicyInner>, BackupShortTermRetentionPolicyInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, policyName, parameters, context);
        return this.client.<BackupShortTermRetentionPolicyInner, BackupShortTermRetentionPolicyInner>getLroResult(
            response, BackupShortTermRetentionPolicyInner.class, BackupShortTermRetentionPolicyInner.class, context);
    }
    ...
    public BackupShortTermRetentionPolicyInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, ShortTermRetentionPolicyName policyName, BackupShortTermRetentionPolicyInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, policyName, parameters)
            .getFinalResult();
    }
    ...
    public BackupShortTermRetentionPolicyInner createOrUpdate(String resourceGroupName, String serverName,
        String databaseName, ShortTermRetentionPolicyName policyName, BackupShortTermRetentionPolicyInner parameters,
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, policyName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, policyName,
    ...
    public SyncPoller<PollResult<BackupShortTermRetentionPolicyInner>, BackupShortTermRetentionPolicyInner> beginUpdate(
        ...
        BackupShortTermRetentionPolicyInner parameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, databaseName, policyName, parameters);
        return this.client.<BackupShortTermRetentionPolicyInner, BackupShortTermRetentionPolicyInner>getLroResult(
            response, BackupShortTermRetentionPolicyInner.class, BackupShortTermRetentionPolicyInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<BackupShortTermRetentionPolicyInner>, BackupShortTermRetentionPolicyInner> beginUpdate(
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, databaseName, policyName, parameters, context);
        return this.client.<BackupShortTermRetentionPolicyInner, BackupShortTermRetentionPolicyInner>getLroResult(
            response, BackupShortTermRetentionPolicyInner.class, BackupShortTermRetentionPolicyInner.class, context);
    }
    ...
    public BackupShortTermRetentionPolicyInner update(String resourceGroupName, String serverName, String databaseName,
        ShortTermRetentionPolicyName policyName, BackupShortTermRetentionPolicyInner parameters) {
        return beginUpdate(resourceGroupName, serverName, databaseName, policyName, parameters).getFinalResult();
    }
    ...
    public BackupShortTermRetentionPolicyInner update(String resourceGroupName, String serverName, String databaseName,
        ShortTermRetentionPolicyName policyName, BackupShortTermRetentionPolicyInner parameters, Context context) {
        return beginUpdate(resourceGroupName, serverName, databaseName, policyName, parameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a database's short term retention policy along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BackupShortTermRetentionPolicyInner> listByDatabaseSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<BackupShortTermRetentionPolicyListResult> res
    ...
    private PagedResponse<BackupShortTermRetentionPolicyInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<BackupShortTermRetentionPolicyListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BackupShortTermRetentionPolicyInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(BackupShortTermRetentionPoliciesClientImpl.class);
}
