...
public final class ServerConfigurationOptionsClientImpl implements ServerConfigurationOptionsClient {
    ...
    public interface ServerConfigurationOptionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerConfigurationOptionListResult> listByManagedInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerConfigurationOptionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("serverConfigurationOptionName") ServerConfigurationOptionName serverConfigurationOptionName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerConfigurationOptionListResult> listByManagedInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed instance server configuration options along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerConfigurationOptionInner> listByManagedInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        Response<ServerConfigurationOptionListResult> res = service.listByManagedInstanceSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a server configuration option along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            serverConfigurationOptionName, this.client.getSubscriptionId(), apiVersion, parameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServerConfigurationOptionInner>, ServerConfigurationOptionInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, managedInstanceName,
            serverConfigurationOptionName, parameters);
        return this.client.<ServerConfigurationOptionInner, ServerConfigurationOptionInner>getLroResult(response,
            ServerConfigurationOptionInner.class, ServerConfigurationOptionInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServerConfigurationOptionInner>, ServerConfigurationOptionInner> beginCreateOrUpdate(
        ...
        return this.client.<ServerConfigurationOptionInner, ServerConfigurationOptionInner>getLroResult(response,
            ServerConfigurationOptionInner.class, ServerConfigurationOptionInner.class, context);
    }
    ...
    public ServerConfigurationOptionInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName, ServerConfigurationOptionInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, serverConfigurationOptionName, parameters)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of server configuration options along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerConfigurationOptionInner> listByManagedInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ServerConfigurationOptionListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServerConfigurationOptionsClientImpl.class);
}
