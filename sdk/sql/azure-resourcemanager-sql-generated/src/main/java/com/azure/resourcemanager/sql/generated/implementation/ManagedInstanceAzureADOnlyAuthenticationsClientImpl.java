...
public final class ManagedInstanceAzureADOnlyAuthenticationsClientImpl
    ...
    public interface ManagedInstanceAzureADOnlyAuthenticationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAzureADOnlyAuthenticationInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("authenticationName") AuthenticationName authenticationName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAzureADOnlyAuthListResult> listByInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAzureADOnlyAuthListResult> listByInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ManagedInstanceAzureADOnlyAuthenticationInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, authenticationName,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            authenticationName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, managedInstanceName, authenticationName, parameters);
        return this.client
            .<ManagedInstanceAzureADOnlyAuthenticationInner, ManagedInstanceAzureADOnlyAuthenticationInner>getLroResult(
                response, ManagedInstanceAzureADOnlyAuthenticationInner.class,
                ManagedInstanceAzureADOnlyAuthenticationInner.class, Context.NONE);
    }
    ...
    public ManagedInstanceAzureADOnlyAuthenticationInner createOrUpdate(String resourceGroupName,
        String managedInstanceName, AuthenticationName authenticationName,
        ManagedInstanceAzureADOnlyAuthenticationInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, authenticationName, parameters)
            .getFinalResult();
    }
    ...
    public ManagedInstanceAzureADOnlyAuthenticationInner createOrUpdate(String resourceGroupName,
        String managedInstanceName, AuthenticationName authenticationName,
        ManagedInstanceAzureADOnlyAuthenticationInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, authenticationName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, authenticationName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        AuthenticationName authenticationName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, managedInstanceName, authenticationName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        AuthenticationName authenticationName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, authenticationName, context);
    ...
    public void delete(String resourceGroupName, String managedInstanceName, AuthenticationName authenticationName) {
        beginDelete(resourceGroupName, managedInstanceName, authenticationName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, AuthenticationName authenticationName,
        Context context) {
        beginDelete(resourceGroupName, managedInstanceName, authenticationName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceAzureADOnlyAuthenticationInner>
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstanceAzureADOnlyAuthListResult> res = service.listByInstanceSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceAzureADOnlyAuthenticationInner> listByInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ManagedInstanceAzureADOnlyAuthListResult> res
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(ManagedInstanceAzureADOnlyAuthenticationsClientImpl.class);
}
