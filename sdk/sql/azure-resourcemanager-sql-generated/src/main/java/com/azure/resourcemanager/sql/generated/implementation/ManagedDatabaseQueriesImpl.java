...
public final class ManagedDatabaseQueriesImpl implements ManagedDatabaseQueries {
    ...
    public Response<ManagedInstanceQuery> getWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        Response<ManagedInstanceQueryInner> inner = this.serviceClient()
    ...
    public PagedIterable<QueryStatistics> listByQuery(String resourceGroupName, String managedInstanceName,
        ...
        Context context) {
        PagedIterable<QueryStatisticsInner> inner = this.serviceClient()
            .listByQuery(resourceGroupName, managedInstanceName, databaseName, queryId, startTime, endTime, interval,
                context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new QueryStatisticsImpl(inner1, this.manager()));
    }
