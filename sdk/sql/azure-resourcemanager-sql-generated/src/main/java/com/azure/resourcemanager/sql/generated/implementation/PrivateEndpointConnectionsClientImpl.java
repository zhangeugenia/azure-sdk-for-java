...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    private PagedResponse<PrivateEndpointConnectionInner> listByServerSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        Response<PrivateEndpointConnectionListResult> res = service.listByServerSync(this.client.getEndpoint(),
    ...
    public Response<PrivateEndpointConnectionInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, privateEndpointConnectionName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
