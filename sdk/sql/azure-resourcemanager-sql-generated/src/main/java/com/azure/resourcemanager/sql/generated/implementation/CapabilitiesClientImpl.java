...
public final class CapabilitiesClientImpl implements CapabilitiesClient {
    ...
    public interface CapabilitiesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LocationCapabilitiesInner> listByLocationSync(@HostParam("$host") String endpoint,
            @PathParam("locationName") String locationName, @QueryParam("include") CapabilityGroup include,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<LocationCapabilitiesInner> listByLocationWithResponse(String locationName, CapabilityGroup include,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.listByLocationSync(this.client.getEndpoint(), locationName, include,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
