...
public final class ReplicationLinksClientImpl implements ReplicationLinksClient {
    ...
    public interface ReplicationLinksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationLinkListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationLinkInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("linkId") String linkId,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> failoverAllowDataLossSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("linkId") String linkId,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationLinkListResult> listByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationLinkListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ReplicationLinkListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of replication links on database along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByDatabaseSinglePage(String resourceGroupName, String serverName,
        String databaseName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<ReplicationLinkListResult> res
            = service.listByDatabaseSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
    ...
    private PagedResponse<ReplicationLinkInner> listByDatabaseSinglePage(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<ReplicationLinkListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
            resourceGroupName, serverName, databaseName, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public Response<ReplicationLinkInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        if (linkId == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter linkId is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, linkId,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            linkId, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            linkId, this.client.getSubscriptionId(), apiVersion, parameters, accept, context);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, linkId, parameters);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, linkId, parameters, context);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
    ...
    public ReplicationLinkInner createOrUpdate(String resourceGroupName, String serverName, String databaseName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, linkId, parameters).getFinalResult();
    }
    ...
    public ReplicationLinkInner createOrUpdate(String resourceGroupName, String serverName, String databaseName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, linkId, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-05-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, linkId,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String databaseName, String linkId) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, databaseName, linkId);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String databaseName, String linkId, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, serverName, databaseName, linkId, context);
    ...
    public void delete(String resourceGroupName, String serverName, String databaseName, String linkId) {
        beginDelete(resourceGroupName, serverName, databaseName, linkId).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String serverName, String databaseName, String linkId,
        Context context) {
        beginDelete(resourceGroupName, serverName, databaseName, linkId, context).getFinalResult();
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, linkId,
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, databaseName, linkId, parameters);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, databaseName, linkId, parameters, context);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, context);
    }
    ...
    public ReplicationLinkInner update(String resourceGroupName, String serverName, String databaseName, String linkId,
        ReplicationLinkUpdate parameters) {
        return beginUpdate(resourceGroupName, serverName, databaseName, linkId, parameters).getFinalResult();
    }
    ...
    public ReplicationLinkInner update(String resourceGroupName, String serverName, String databaseName, String linkId,
        ...
        return beginUpdate(resourceGroupName, serverName, databaseName, linkId, parameters, context).getFinalResult();
    }
    ...
    private Response<BinaryData> failoverWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.failoverSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, linkId,
            this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginFailover(String resourceGroupName,
        ...
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, serverName, databaseName, linkId);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginFailover(String resourceGroupName,
        ...
        Response<BinaryData> response
            = failoverWithResponse(resourceGroupName, serverName, databaseName, linkId, context);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, context);
    }
    ...
    public ReplicationLinkInner failover(String resourceGroupName, String serverName, String databaseName,
        String linkId) {
        return beginFailover(resourceGroupName, serverName, databaseName, linkId).getFinalResult();
    }
    ...
    public ReplicationLinkInner failover(String resourceGroupName, String serverName, String databaseName,
        String linkId, Context context) {
        return beginFailover(resourceGroupName, serverName, databaseName, linkId, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> failoverAllowDataLossWithResponse(String resourceGroupName, String serverName,
        String databaseName, String linkId) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        return service.failoverAllowDataLossSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            linkId, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner>
        ...
        Response<BinaryData> response
            = failoverAllowDataLossWithResponse(resourceGroupName, serverName, databaseName, linkId);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginFailoverAllowDataLoss(
        ...
        Response<BinaryData> response
            = failoverAllowDataLossWithResponse(resourceGroupName, serverName, databaseName, linkId, context);
        return this.client.<ReplicationLinkInner, ReplicationLinkInner>getLroResult(response,
            ReplicationLinkInner.class, ReplicationLinkInner.class, context);
    }
    ...
    public ReplicationLinkInner failoverAllowDataLoss(String resourceGroupName, String serverName, String databaseName,
        String linkId) {
        return beginFailoverAllowDataLoss(resourceGroupName, serverName, databaseName, linkId).getFinalResult();
    }
    ...
    public ReplicationLinkInner failoverAllowDataLoss(String resourceGroupName, String serverName, String databaseName,
        String linkId, Context context) {
        return beginFailoverAllowDataLoss(resourceGroupName, serverName, databaseName, linkId, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of replication links along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByServerSinglePage(String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<ReplicationLinkListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
            serverName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ReplicationLinkInner> listByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ReplicationLinksClientImpl.class);
}
