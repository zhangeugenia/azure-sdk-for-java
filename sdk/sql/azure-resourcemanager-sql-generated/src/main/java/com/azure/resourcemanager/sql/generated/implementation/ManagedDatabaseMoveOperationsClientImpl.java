...
public final class ManagedDatabaseMoveOperationsClientImpl implements ManagedDatabaseMoveOperationsClient {
    ...
    public interface ManagedDatabaseMoveOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedDatabaseMoveOperationListResult> listByLocationSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("locationName") String locationName,
            @QueryParam("onlyLatestPerDatabase") Boolean onlyLatestPerDatabase, @QueryParam("$filter") String filter,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedDatabaseMoveOperationResultInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("locationName") String locationName,
            @PathParam("operationId") UUID operationId, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedDatabaseMoveOperationListResult> listByLocationNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of managed database move operations along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedDatabaseMoveOperationResultInner> listByLocationSinglePage(String resourceGroupName,
        String locationName, Boolean onlyLatestPerDatabase, String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        Response<ManagedDatabaseMoveOperationListResult> res
            = service.listByLocationSync(this.client.getEndpoint(), resourceGroupName, locationName,
                onlyLatestPerDatabase, filter, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<ManagedDatabaseMoveOperationResultInner> listByLocation(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByLocationSinglePage(resourceGroupName, locationName, onlyLatestPerDatabase, filter),
    ...
    public PagedIterable<ManagedDatabaseMoveOperationResultInner> listByLocation(String resourceGroupName,
        String locationName, Boolean onlyLatestPerDatabase, String filter, Context context) {
        return new PagedIterable<>(
            () -> listByLocationSinglePage(resourceGroupName, locationName, onlyLatestPerDatabase, filter, context),
    ...
    public Response<ManagedDatabaseMoveOperationResultInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, locationName, operationId,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedDatabaseMoveOperationResultInner> listByLocationNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedDatabaseMoveOperationsClientImpl.class);
}
