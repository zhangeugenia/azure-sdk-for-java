...
public final class DistributedAvailabilityGroupsClientImpl implements DistributedAvailabilityGroupsClient {
    ...
    public interface DistributedAvailabilityGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DistributedAvailabilityGroupsListResult> listByInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DistributedAvailabilityGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("distributedAvailabilityGroupName") String distributedAvailabilityGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> setRoleSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("distributedAvailabilityGroupName") String distributedAvailabilityGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DistributedAvailabilityGroupsListResult> listByInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of a distributed availability groups in instance along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DistributedAvailabilityGroupInner> listByInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2023-08-01-preview";
        final String accept = "application/json";
        Response<DistributedAvailabilityGroupsListResult> res = service.listByInstanceSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return distributed availability group between box and Sql Managed Instance along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, parameters);
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner>
        ...
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, context);
    }
    ...
    public DistributedAvailabilityGroupInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, context);
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String distributedAvailabilityGroupName) {
        beginDelete(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String distributedAvailabilityGroupName,
        Context context) {
        beginDelete(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner> beginUpdate(
        ...
        DistributedAvailabilityGroupInner parameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters);
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, Context.NONE);
    }
    ...
    public DistributedAvailabilityGroupInner update(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupInner parameters) {
        return beginUpdate(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> failoverWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2023-08-01-preview";
        final String accept = "application/json";
        return service.failoverSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, this.client.getSubscriptionId(), apiVersion, parameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner> beginFailover(
        String resourceGroupName, String managedInstanceName, String distributedAvailabilityGroupName,
        DistributedAvailabilityGroupsFailoverRequest parameters) {
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, parameters);
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, Context.NONE);
    }
    ...
    public DistributedAvailabilityGroupInner failover(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupsFailoverRequest parameters) {
        return beginFailover(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> setRoleWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2023-08-01-preview";
        final String accept = "application/json";
        return service.setRoleSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, this.client.getSubscriptionId(), apiVersion, parameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner> beginSetRole(
        ...
        DistributedAvailabilityGroupSetRole parameters) {
        Response<BinaryData> response
            = setRoleWithResponse(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters);
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DistributedAvailabilityGroupInner>, DistributedAvailabilityGroupInner> beginSetRole(
        ...
        Response<BinaryData> response = setRoleWithResponse(resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, parameters, context);
        return this.client.<DistributedAvailabilityGroupInner, DistributedAvailabilityGroupInner>getLroResult(response,
            DistributedAvailabilityGroupInner.class, DistributedAvailabilityGroupInner.class, context);
    }
    ...
    public DistributedAvailabilityGroupInner setRole(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupSetRole parameters) {
        return beginSetRole(resourceGroupName, managedInstanceName, distributedAvailabilityGroupName, parameters)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of distributed availability groups in instance along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DistributedAvailabilityGroupInner> listByInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<DistributedAvailabilityGroupsListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DistributedAvailabilityGroupsClientImpl.class);
}
