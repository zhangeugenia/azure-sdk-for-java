...
public final class SynapseLinkWorkspacesClientImpl implements SynapseLinkWorkspacesClient {
    ...
    public interface SynapseLinkWorkspacesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SynapseLinkWorkspaceListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SynapseLinkWorkspaceListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all synapselink workspaces for a database along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SynapseLinkWorkspaceInner> listByDatabaseSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        Response<SynapseLinkWorkspaceListResult> res
    ...
    private PagedResponse<SynapseLinkWorkspaceInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2022-05-01-preview";
        final String accept = "application/json";
        Response<SynapseLinkWorkspaceListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of synapselink workspaces along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SynapseLinkWorkspaceInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SynapseLinkWorkspaceInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SynapseLinkWorkspacesClientImpl.class);
}
