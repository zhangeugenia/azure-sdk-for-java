...
public final class DatabaseOperationsClientImpl implements DatabaseOperationsClient {
    ...
    public interface DatabaseOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseOperationListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseOperationListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of operations performed on the database along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseOperationInner> listByDatabaseSinglePage(String resourceGroupName, String serverName,
        String databaseName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-11-01-preview";
        final String accept = "application/json";
        Response<DatabaseOperationListResult> res
    ...
    private PagedResponse<DatabaseOperationInner> listByDatabaseSinglePage(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2022-11-01-preview";
        final String accept = "application/json";
        Response<DatabaseOperationListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
    ...
    public Response<Void> cancelWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2022-11-01-preview";
        return service.cancelSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, operationId,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response to a list database operations request along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseOperationInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseOperationInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DatabaseOperationsClientImpl.class);
}
