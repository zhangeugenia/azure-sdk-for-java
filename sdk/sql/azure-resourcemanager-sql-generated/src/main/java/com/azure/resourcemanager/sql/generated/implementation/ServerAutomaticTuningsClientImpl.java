...
public final class ServerAutomaticTuningsClientImpl implements ServerAutomaticTuningsClient {
    ...
    public interface ServerAutomaticTuningsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerAutomaticTuningInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerAutomaticTuningInner> updateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ServerAutomaticTuningInner parameters, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Response<ServerAutomaticTuningInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServerAutomaticTuningsClientImpl.class);
}
