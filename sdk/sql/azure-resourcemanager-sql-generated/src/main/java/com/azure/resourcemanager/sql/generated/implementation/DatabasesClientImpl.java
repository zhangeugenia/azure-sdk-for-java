...
public final class DatabasesClientImpl implements DatabasesClient {
    ...
    public interface DatabasesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MetricListResult> listMetricsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @QueryParam("$filter") String filter,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MetricDefinitionListResult> listMetricDefinitionsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> renameSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ResourceMoveDefinition parameters, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> pauseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> upgradeDataWarehouseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseListResult> listByElasticPoolSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("elasticPoolName") String elasticPoolName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseListResult> listInaccessibleByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseListResult> listByElasticPoolNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DatabaseListResult> listInaccessibleByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response to a list database metrics request along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<MetricInner> listMetricsSinglePage(String resourceGroupName, String serverName,
        String databaseName, String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2014-04-01";
        final String accept = "application/json";
        Response<MetricListResult> res = service.listMetricsSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, serverName, databaseName, filter, accept, Context.NONE);
    ...
    public PagedIterable<MetricInner> listMetrics(String resourceGroupName, String serverName, String databaseName,
        String filter) {
        return new PagedIterable<>(() -> listMetricsSinglePage(resourceGroupName, serverName, databaseName, filter));
    }
    ...
    public PagedIterable<MetricInner> listMetrics(String resourceGroupName, String serverName, String databaseName,
        ...
        return new PagedIterable<>(
            () -> listMetricsSinglePage(resourceGroupName, serverName, databaseName, filter, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response to a list database metric definitions request along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<MetricDefinitionInner> listMetricDefinitionsSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2014-04-01";
        final String accept = "application/json";
        Response<MetricDefinitionListResult> res
            = service.listMetricDefinitionsSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                resourceGroupName, serverName, databaseName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            null, null);
    }
    ...
    private PagedResponse<MetricDefinitionInner> listMetricDefinitionsSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2014-04-01";
        final String accept = "application/json";
        Response<MetricDefinitionListResult> res = service.listMetricDefinitionsSync(this.client.getEndpoint(),
            apiVersion, this.client.getSubscriptionId(), resourceGroupName, serverName, databaseName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            null, null);
    }
    ...
    public PagedIterable<MetricDefinitionInner> listMetricDefinitions(String resourceGroupName, String serverName,
        String databaseName) {
        return new PagedIterable<>(() -> listMetricDefinitionsSinglePage(resourceGroupName, serverName, databaseName));
    }
    ...
    public PagedIterable<MetricDefinitionInner> listMetricDefinitions(String resourceGroupName, String serverName,
        ...
        return new PagedIterable<>(
            () -> listMetricDefinitionsSinglePage(resourceGroupName, serverName, databaseName, context));
    }
    ...
    private PagedResponse<DatabaseInner> listByServerSinglePage(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        Response<DatabaseListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
            serverName, skipToken, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
    ...
    private PagedResponse<DatabaseInner> listByServerSinglePage(String resourceGroupName, String serverName,
        ...
        final String accept = "application/json";
        Response<DatabaseListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
            serverName, skipToken, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<DatabaseInner> listByServer(String resourceGroupName, String serverName) {
        final String skipToken = null;
        return new PagedIterable<>(() -> listByServerSinglePage(resourceGroupName, serverName, skipToken),
    ...
    public PagedIterable<DatabaseInner> listByServer(String resourceGroupName, String serverName, String skipToken,
        Context context) {
        return new PagedIterable<>(() -> listByServerSinglePage(resourceGroupName, serverName, skipToken, context),
    ...
    public Response<DatabaseInner> getWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, expand, filter,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a database resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginUpdate(String resourceGroupName, String serverName,
        String databaseName, DatabaseUpdate parameters) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, serverName, databaseName, parameters);
        return this.client.<DatabaseInner, DatabaseInner>getLroResult(response, DatabaseInner.class,
            DatabaseInner.class, Context.NONE);
    }
    ...
    public DatabaseInner update(String resourceGroupName, String serverName, String databaseName,
        DatabaseUpdate parameters) {
        return beginUpdate(resourceGroupName, serverName, databaseName, parameters).getFinalResult();
    }
    ...
    public DatabaseInner update(String resourceGroupName, String serverName, String databaseName,
        DatabaseUpdate parameters, Context context) {
        return beginUpdate(resourceGroupName, serverName, databaseName, parameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> exportWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.exportSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ImportExportOperationResultInner>, ImportExportOperationResultInner> beginExport(
        String resourceGroupName, String serverName, String databaseName, ExportDatabaseDefinition parameters) {
        Response<BinaryData> response = exportWithResponse(resourceGroupName, serverName, databaseName, parameters);
    ...
    public SyncPoller<PollResult<ImportExportOperationResultInner>, ImportExportOperationResultInner> beginExport(
        ...
        Context context) {
        Response<BinaryData> response
            = exportWithResponse(resourceGroupName, serverName, databaseName, parameters, context);
        return this.client.<ImportExportOperationResultInner, ImportExportOperationResultInner>getLroResult(response,
    ...
    public ImportExportOperationResultInner export(String resourceGroupName, String serverName, String databaseName,
        ExportDatabaseDefinition parameters) {
        return beginExport(resourceGroupName, serverName, databaseName, parameters).getFinalResult();
    }
    ...
    public ImportExportOperationResultInner export(String resourceGroupName, String serverName, String databaseName,
        ExportDatabaseDefinition parameters, Context context) {
        return beginExport(resourceGroupName, serverName, databaseName, parameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> failoverWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-02-01-preview";
        return service.failoverSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, replicaType,
            this.client.getSubscriptionId(), apiVersion, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginFailover(String resourceGroupName, String serverName,
        String databaseName, ReplicaType replicaType) {
        Response<BinaryData> response = failoverWithResponse(resourceGroupName, serverName, databaseName, replicaType);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginFailover(String resourceGroupName, String serverName,
        ...
        Response<BinaryData> response
            = failoverWithResponse(resourceGroupName, serverName, databaseName, replicaType, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void failover(String resourceGroupName, String serverName, String databaseName) {
        final ReplicaType replicaType = null;
        beginFailover(resourceGroupName, serverName, databaseName, replicaType).getFinalResult();
    }
    ...
    public void failover(String resourceGroupName, String serverName, String databaseName, ReplicaType replicaType,
        Context context) {
        beginFailover(resourceGroupName, serverName, databaseName, replicaType, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> importMethodWithResponse(String resourceGroupName, String serverName,
        String databaseName, ImportExistingDatabaseDefinition parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.importMethodSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ImportExportOperationResultInner>, ImportExportOperationResultInner> beginImportMethod(
        ...
        Response<BinaryData> response
            = importMethodWithResponse(resourceGroupName, serverName, databaseName, parameters);
        return this.client.<ImportExportOperationResultInner, ImportExportOperationResultInner>getLroResult(response,
            ImportExportOperationResultInner.class, ImportExportOperationResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ImportExportOperationResultInner>, ImportExportOperationResultInner> beginImportMethod(
        ...
        Context context) {
        Response<BinaryData> response
            = importMethodWithResponse(resourceGroupName, serverName, databaseName, parameters, context);
        return this.client.<ImportExportOperationResultInner, ImportExportOperationResultInner>getLroResult(response,
            ImportExportOperationResultInner.class, ImportExportOperationResultInner.class, context);
    }
    ...
    public ImportExportOperationResultInner importMethod(String resourceGroupName, String serverName,
        String databaseName, ImportExistingDatabaseDefinition parameters) {
        return beginImportMethod(resourceGroupName, serverName, databaseName, parameters).getFinalResult();
    }
    ...
    public ImportExportOperationResultInner importMethod(String resourceGroupName, String serverName,
        String databaseName, ImportExistingDatabaseDefinition parameters, Context context) {
        return beginImportMethod(resourceGroupName, serverName, databaseName, parameters, context).getFinalResult();
    }
    ...
    public Response<Void> renameWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        final String apiVersion = "2023-02-01-preview";
        return service.renameSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> pauseWithResponse(String resourceGroupName, String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.pauseSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginPause(String resourceGroupName, String serverName,
        String databaseName) {
        Response<BinaryData> response = pauseWithResponse(resourceGroupName, serverName, databaseName);
        return this.client.<DatabaseInner, DatabaseInner>getLroResult(response, DatabaseInner.class,
            DatabaseInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginPause(String resourceGroupName, String serverName,
        String databaseName, Context context) {
        Response<BinaryData> response = pauseWithResponse(resourceGroupName, serverName, databaseName, context);
        return this.client.<DatabaseInner, DatabaseInner>getLroResult(response, DatabaseInner.class,
            DatabaseInner.class, context);
    }
    ...
    public DatabaseInner pause(String resourceGroupName, String serverName, String databaseName) {
        return beginPause(resourceGroupName, serverName, databaseName).getFinalResult();
    }
    ...
    public DatabaseInner pause(String resourceGroupName, String serverName, String databaseName, Context context) {
        return beginPause(resourceGroupName, serverName, databaseName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> resumeWithResponse(String resourceGroupName, String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        return service.resumeSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginResume(String resourceGroupName, String serverName,
        String databaseName) {
        Response<BinaryData> response = resumeWithResponse(resourceGroupName, serverName, databaseName);
        return this.client.<DatabaseInner, DatabaseInner>getLroResult(response, DatabaseInner.class,
            DatabaseInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginResume(String resourceGroupName, String serverName,
        String databaseName, Context context) {
        Response<BinaryData> response = resumeWithResponse(resourceGroupName, serverName, databaseName, context);
        return this.client.<DatabaseInner, DatabaseInner>getLroResult(response, DatabaseInner.class,
            DatabaseInner.class, context);
    }
    ...
    public DatabaseInner resume(String resourceGroupName, String serverName, String databaseName) {
        return beginResume(resourceGroupName, serverName, databaseName).getFinalResult();
    }
    ...
    public DatabaseInner resume(String resourceGroupName, String serverName, String databaseName, Context context) {
        return beginResume(resourceGroupName, serverName, databaseName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> upgradeDataWarehouseWithResponse(String resourceGroupName, String serverName,
        String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-02-01-preview";
        return service.upgradeDataWarehouseSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            this.client.getSubscriptionId(), apiVersion, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpgradeDataWarehouse(String resourceGroupName, String serverName,
        String databaseName) {
        Response<BinaryData> response = upgradeDataWarehouseWithResponse(resourceGroupName, serverName, databaseName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpgradeDataWarehouse(String resourceGroupName, String serverName,
        String databaseName, Context context) {
        Response<BinaryData> response
            = upgradeDataWarehouseWithResponse(resourceGroupName, serverName, databaseName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void upgradeDataWarehouse(String resourceGroupName, String serverName, String databaseName) {
        beginUpgradeDataWarehouse(resourceGroupName, serverName, databaseName).getFinalResult();
    }
    ...
    public void upgradeDataWarehouse(String resourceGroupName, String serverName, String databaseName,
        Context context) {
        beginUpgradeDataWarehouse(resourceGroupName, serverName, databaseName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of databases in an elastic pool along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listByElasticPoolSinglePage(String resourceGroupName, String serverName,
        String elasticPoolName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        if (elasticPoolName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter elasticPoolName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        Response<DatabaseListResult> res = service.listByElasticPoolSync(this.client.getEndpoint(), resourceGroupName,
            serverName, elasticPoolName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<DatabaseInner> listByElasticPoolSinglePage(String resourceGroupName, String serverName,
        ...
        final String accept = "application/json";
        Response<DatabaseListResult> res = service.listByElasticPoolSync(this.client.getEndpoint(), resourceGroupName,
            serverName, elasticPoolName, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<DatabaseInner> listByElasticPool(String resourceGroupName, String serverName,
        String elasticPoolName) {
        return new PagedIterable<>(() -> listByElasticPoolSinglePage(resourceGroupName, serverName, elasticPoolName),
    ...
    public PagedIterable<DatabaseInner> listByElasticPool(String resourceGroupName, String serverName,
        String elasticPoolName, Context context) {
        return new PagedIterable<>(
            () -> listByElasticPoolSinglePage(resourceGroupName, serverName, elasticPoolName, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of inaccessible databases in a logical server along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listInaccessibleByServerSinglePage(String resourceGroupName,
        String serverName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2023-02-01-preview";
        final String accept = "application/json";
        Response<DatabaseListResult> res = service.listInaccessibleByServerSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listInaccessibleByServerSinglePage(String resourceGroupName, String serverName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public PagedIterable<DatabaseInner> listInaccessibleByServer(String resourceGroupName, String serverName) {
        return new PagedIterable<>(() -> listInaccessibleByServerSinglePage(resourceGroupName, serverName),
            nextLink -> listInaccessibleByServerNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<DatabaseInner> listInaccessibleByServer(String resourceGroupName, String serverName,
        Context context) {
        return new PagedIterable<>(() -> listInaccessibleByServerSinglePage(resourceGroupName, serverName, context),
            nextLink -> listInaccessibleByServerNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listByElasticPoolNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listByElasticPoolNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listInaccessibleByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<DatabaseListResult> res
            = service.listInaccessibleByServerNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseInner> listInaccessibleByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<DatabaseListResult> res
            = service.listInaccessibleByServerNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
