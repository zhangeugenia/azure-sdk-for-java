...
public final class ManagedDatabaseSecurityEventsClientImpl implements ManagedDatabaseSecurityEventsClient {
    ...
    public interface ManagedDatabaseSecurityEventsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityEventCollection> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("databaseName") String databaseName, @QueryParam("$filter") String filter,
            @QueryParam("$skip") Integer skip, @QueryParam("$top") Integer top,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityEventCollection> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of security events along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityEventInner> listByDatabaseSinglePage(String resourceGroupName,
        String managedInstanceName, String databaseName, String filter, Integer skip, Integer top, String skiptoken) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<SecurityEventCollection> res = service.listByDatabaseSync(this.client.getEndpoint(), resourceGroupName,
            managedInstanceName, databaseName, filter, skip, top, skiptoken, this.client.getSubscriptionId(),
    ...
    public PagedIterable<SecurityEventInner> listByDatabase(String resourceGroupName, String managedInstanceName,
        ...
        return new PagedIterable<>(() -> listByDatabaseSinglePage(resourceGroupName, managedInstanceName, databaseName,
            filter, skip, top, skiptoken), nextLink -> listByDatabaseNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<SecurityEventInner> listByDatabase(String resourceGroupName, String managedInstanceName,
        ...
        return new PagedIterable<>(() -> listByDatabaseSinglePage(resourceGroupName, managedInstanceName, databaseName,
            filter, skip, top, skiptoken, context), nextLink -> listByDatabaseNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityEventInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<SecurityEventCollection> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityEventInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedDatabaseSecurityEventsClientImpl.class);
}
