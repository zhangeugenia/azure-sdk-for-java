...
public interface JobPrivateEndpointsClient {
    ...
    PagedIterable<JobPrivateEndpointInner> listByAgent(
    ...
    Response<JobPrivateEndpointInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobPrivateEndpointInner createOrUpdate(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String privateEndpointName,
