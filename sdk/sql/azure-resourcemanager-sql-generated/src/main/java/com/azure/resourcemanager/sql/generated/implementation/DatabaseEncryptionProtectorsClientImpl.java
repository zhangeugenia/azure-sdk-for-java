...
public final class DatabaseEncryptionProtectorsClientImpl implements DatabaseEncryptionProtectorsClient {
    ...
    private Response<BinaryData> revalidateWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2022-08-01-preview";
        return service.revalidateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(String resourceGroupName, String serverName,
        ...
        Response<BinaryData> response
            = revalidateWithResponse(resourceGroupName, serverName, databaseName, encryptionProtectorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(String resourceGroupName, String serverName,
        String databaseName, EncryptionProtectorName encryptionProtectorName, Context context) {
        Response<BinaryData> response
            = revalidateWithResponse(resourceGroupName, serverName, databaseName, encryptionProtectorName, context);
    ...
    public void revalidate(String resourceGroupName, String serverName, String databaseName,
        EncryptionProtectorName encryptionProtectorName) {
        beginRevalidate(resourceGroupName, serverName, databaseName, encryptionProtectorName).getFinalResult();
    }
    ...
    public void revalidate(String resourceGroupName, String serverName, String databaseName,
        ...
        beginRevalidate(resourceGroupName, serverName, databaseName, encryptionProtectorName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> revertWithResponse(String resourceGroupName, String serverName, String databaseName,
        EncryptionProtectorName encryptionProtectorName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-08-01-preview";
        return service.revertSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            encryptionProtectorName, this.client.getSubscriptionId(), apiVersion, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevert(String resourceGroupName, String serverName,
        String databaseName, EncryptionProtectorName encryptionProtectorName) {
        Response<BinaryData> response
            = revertWithResponse(resourceGroupName, serverName, databaseName, encryptionProtectorName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevert(String resourceGroupName, String serverName,
        String databaseName, EncryptionProtectorName encryptionProtectorName, Context context) {
        Response<BinaryData> response
            = revertWithResponse(resourceGroupName, serverName, databaseName, encryptionProtectorName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void revert(String resourceGroupName, String serverName, String databaseName,
        EncryptionProtectorName encryptionProtectorName) {
        beginRevert(resourceGroupName, serverName, databaseName, encryptionProtectorName).getFinalResult();
    }
    ...
    public void revert(String resourceGroupName, String serverName, String databaseName,
        EncryptionProtectorName encryptionProtectorName, Context context) {
        beginRevert(resourceGroupName, serverName, databaseName, encryptionProtectorName, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(DatabaseEncryptionProtectorsClientImpl.class);
}
