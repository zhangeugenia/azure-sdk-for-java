...
public final class ServerDnsAliasesClientImpl implements ServerDnsAliasesClient {
    ...
    public interface ServerDnsAliasesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerDnsAliasInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("dnsAliasName") String dnsAliasName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerDnsAliasListResult> listByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerDnsAliasListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ServerDnsAliasInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, dnsAliasName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, dnsAliasName,
    ...
    public SyncPoller<PollResult<ServerDnsAliasInner>, ServerDnsAliasInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, serverName, dnsAliasName);
        return this.client.<ServerDnsAliasInner, ServerDnsAliasInner>getLroResult(response, ServerDnsAliasInner.class,
            ServerDnsAliasInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServerDnsAliasInner>, ServerDnsAliasInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, dnsAliasName, context);
        return this.client.<ServerDnsAliasInner, ServerDnsAliasInner>getLroResult(response, ServerDnsAliasInner.class,
            ServerDnsAliasInner.class, context);
    }
    ...
    public ServerDnsAliasInner createOrUpdate(String resourceGroupName, String serverName, String dnsAliasName) {
        return beginCreateOrUpdate(resourceGroupName, serverName, dnsAliasName).getFinalResult();
    }
    ...
    public ServerDnsAliasInner createOrUpdate(String resourceGroupName, String serverName, String dnsAliasName,
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, dnsAliasName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String serverName, String dnsAliasName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, serverName, dnsAliasName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String dnsAliasName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, dnsAliasName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String dnsAliasName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, dnsAliasName, context);
    ...
    public void delete(String resourceGroupName, String serverName, String dnsAliasName) {
        beginDelete(resourceGroupName, serverName, dnsAliasName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String serverName, String dnsAliasName, Context context) {
        beginDelete(resourceGroupName, serverName, dnsAliasName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of server DNS aliases for a server along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerDnsAliasInner> listByServerSinglePage(String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ServerDnsAliasListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> acquireWithResponse(String resourceGroupName, String serverName, String dnsAliasName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.acquireSync(this.client.getEndpoint(), resourceGroupName, serverName, dnsAliasName,
    ...
    public SyncPoller<PollResult<ServerDnsAliasInner>, ServerDnsAliasInner> beginAcquire(String resourceGroupName,
        String serverName, String dnsAliasName, ServerDnsAliasAcquisition parameters) {
        Response<BinaryData> response = acquireWithResponse(resourceGroupName, serverName, dnsAliasName, parameters);
        return this.client.<ServerDnsAliasInner, ServerDnsAliasInner>getLroResult(response, ServerDnsAliasInner.class,
            ServerDnsAliasInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServerDnsAliasInner>, ServerDnsAliasInner> beginAcquire(String resourceGroupName,
        ...
        Response<BinaryData> response
            = acquireWithResponse(resourceGroupName, serverName, dnsAliasName, parameters, context);
        return this.client.<ServerDnsAliasInner, ServerDnsAliasInner>getLroResult(response, ServerDnsAliasInner.class,
            ServerDnsAliasInner.class, context);
    }
    ...
    public ServerDnsAliasInner acquire(String resourceGroupName, String serverName, String dnsAliasName,
        ServerDnsAliasAcquisition parameters) {
        return beginAcquire(resourceGroupName, serverName, dnsAliasName, parameters).getFinalResult();
    }
    ...
    public ServerDnsAliasInner acquire(String resourceGroupName, String serverName, String dnsAliasName,
        ServerDnsAliasAcquisition parameters, Context context) {
        return beginAcquire(resourceGroupName, serverName, dnsAliasName, parameters, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of server DNS aliases along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerDnsAliasInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ServerDnsAliasListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerDnsAliasInner> listByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServerDnsAliasesClientImpl.class);
}
