...
public final class WorkloadGroupImpl implements WorkloadGroup, WorkloadGroup.Definition, WorkloadGroup.Update {
    ...
    public WorkloadGroup create() {
        this.innerObject = serviceManager.serviceClient()
            .getWorkloadGroups()
            .createOrUpdate(resourceGroupName, serverName, databaseName, workloadGroupName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    public WorkloadGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getWorkloadGroups()
            .createOrUpdate(resourceGroupName, serverName, databaseName, workloadGroupName, this.innerModel(), context);
        return this;
    }
