...
public final class ManagedInstanceAdministratorsClientImpl implements ManagedInstanceAdministratorsClient {
    ...
    public interface ManagedInstanceAdministratorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAdministratorListResult> listByInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAdministratorInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("administratorName") AdministratorName administratorName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceAdministratorListResult> listByInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed instance administrators along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceAdministratorInner> listByInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstanceAdministratorListResult> res = service.listByInstanceSync(this.client.getEndpoint(),
    ...
    public Response<ManagedInstanceAdministratorInner> getWithResponse(String resourceGroupName,
        ...
        if (administratorName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter administratorName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, administratorName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an Azure SQL managed instance administrator along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            administratorName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedInstanceAdministratorInner>, ManagedInstanceAdministratorInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, managedInstanceName, administratorName, parameters);
        return this.client.<ManagedInstanceAdministratorInner, ManagedInstanceAdministratorInner>getLroResult(response,
            ManagedInstanceAdministratorInner.class, ManagedInstanceAdministratorInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedInstanceAdministratorInner>, ManagedInstanceAdministratorInner>
        ...
        return this.client.<ManagedInstanceAdministratorInner, ManagedInstanceAdministratorInner>getLroResult(response,
            ManagedInstanceAdministratorInner.class, ManagedInstanceAdministratorInner.class, context);
    }
    ...
    public ManagedInstanceAdministratorInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        AdministratorName administratorName, ManagedInstanceAdministratorInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, administratorName, parameters)
            .getFinalResult();
    }
    ...
    public ManagedInstanceAdministratorInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        AdministratorName administratorName, ManagedInstanceAdministratorInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, administratorName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, administratorName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        AdministratorName administratorName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, managedInstanceName, administratorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        AdministratorName administratorName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, administratorName, context);
    ...
    public void delete(String resourceGroupName, String managedInstanceName, AdministratorName administratorName) {
        beginDelete(resourceGroupName, managedInstanceName, administratorName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, AdministratorName administratorName,
        Context context) {
        beginDelete(resourceGroupName, managedInstanceName, administratorName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceAdministratorInner> listByInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ManagedInstanceAdministratorListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedInstanceAdministratorsClientImpl.class);
}
