...
public final class LedgerDigestUploadsOperationsClientImpl implements LedgerDigestUploadsOperationsClient {
    ...
    public interface LedgerDigestUploadsOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LedgerDigestUploadsInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
            @PathParam("ledgerDigestUploads") LedgerDigestUploadsName ledgerDigestUploads,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LedgerDigestUploadsListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LedgerDigestUploadsListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
            ledgerDigestUploads, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LedgerDigestUploadsInner>, LedgerDigestUploadsInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, ledgerDigestUploads, parameters);
        return this.client.<LedgerDigestUploadsInner, LedgerDigestUploadsInner>getLroResult(response,
            LedgerDigestUploadsInner.class, LedgerDigestUploadsInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LedgerDigestUploadsInner>, LedgerDigestUploadsInner> beginCreateOrUpdate(
        ...
        return this.client.<LedgerDigestUploadsInner, LedgerDigestUploadsInner>getLroResult(response,
            LedgerDigestUploadsInner.class, LedgerDigestUploadsInner.class, context);
    }
    ...
    public LedgerDigestUploadsInner createOrUpdate(String resourceGroupName, String serverName, String databaseName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, databaseName, ledgerDigestUploads, parameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LedgerDigestUploadsInner> listByDatabaseSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<LedgerDigestUploadsListResult> res
    ...
    private PagedResponse<LedgerDigestUploadsInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<LedgerDigestUploadsListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> disableWithResponse(String resourceGroupName, String serverName, String databaseName,
        LedgerDigestUploadsName ledgerDigestUploads) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        return service.disableSync(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
    ...
    public SyncPoller<PollResult<LedgerDigestUploadsInner>, LedgerDigestUploadsInner> beginDisable(
        String resourceGroupName, String serverName, String databaseName, LedgerDigestUploadsName ledgerDigestUploads) {
        Response<BinaryData> response
            = disableWithResponse(resourceGroupName, serverName, databaseName, ledgerDigestUploads);
        return this.client.<LedgerDigestUploadsInner, LedgerDigestUploadsInner>getLroResult(response,
            LedgerDigestUploadsInner.class, LedgerDigestUploadsInner.class, Context.NONE);
    }
    ...
    public LedgerDigestUploadsInner disable(String resourceGroupName, String serverName, String databaseName,
        LedgerDigestUploadsName ledgerDigestUploads) {
        return beginDisable(resourceGroupName, serverName, databaseName, ledgerDigestUploads).getFinalResult();
    }
    ...
    public LedgerDigestUploadsInner disable(String resourceGroupName, String serverName, String databaseName,
        LedgerDigestUploadsName ledgerDigestUploads, Context context) {
        return beginDisable(resourceGroupName, serverName, databaseName, ledgerDigestUploads, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LedgerDigestUploadsInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LedgerDigestUploadsInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LedgerDigestUploadsOperationsClientImpl.class);
}
