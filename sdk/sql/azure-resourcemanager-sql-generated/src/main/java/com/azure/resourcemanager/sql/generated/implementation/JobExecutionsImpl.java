...
public final class JobExecutionsImpl implements JobExecutions {
    ...
    public PagedIterable<JobExecution> listByAgent(String resourceGroupName, String serverName, String jobAgentName,
        ...
        PagedIterable<JobExecutionInner> inner = this.serviceClient()
            .listByAgent(resourceGroupName, serverName, jobAgentName, createTimeMin, createTimeMax, endTimeMin,
                endTimeMax, isActive, skip, top, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobExecutionImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<JobExecution> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        ...
        OffsetDateTime endTimeMax, Boolean isActive, Integer skip, Integer top, Context context) {
        PagedIterable<JobExecutionInner> inner = this.serviceClient()
            .listByJob(resourceGroupName, serverName, jobAgentName, jobName, createTimeMin, createTimeMax, endTimeMin,
                endTimeMax, isActive, skip, top, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobExecutionImpl(inner1, this.manager()));
    }
