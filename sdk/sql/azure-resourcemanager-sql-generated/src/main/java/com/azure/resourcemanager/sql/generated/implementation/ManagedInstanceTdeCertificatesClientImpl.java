...
public final class ManagedInstanceTdeCertificatesClientImpl implements ManagedInstanceTdeCertificatesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginCreate(String resourceGroupName, String managedInstanceName,
        TdeCertificate parameters) {
        Response<BinaryData> response = createWithResponse(resourceGroupName, managedInstanceName, parameters);
    ...
    public SyncPoller<PollResult<Void>, Void> beginCreate(String resourceGroupName, String managedInstanceName,
        TdeCertificate parameters, Context context) {
        Response<BinaryData> response = createWithResponse(resourceGroupName, managedInstanceName, parameters, context);
    ...
    public void create(String resourceGroupName, String managedInstanceName, TdeCertificate parameters) {
        beginCreate(resourceGroupName, managedInstanceName, parameters).getFinalResult();
    }
    ...
    public void create(String resourceGroupName, String managedInstanceName, TdeCertificate parameters,
        Context context) {
        beginCreate(resourceGroupName, managedInstanceName, parameters, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(ManagedInstanceTdeCertificatesClientImpl.class);
}
