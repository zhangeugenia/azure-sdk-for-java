...
public final class JobAgentsClientImpl implements JobAgentsClient {
    ...
    public interface JobAgentsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<JobAgentListResult> listByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<JobAgentInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("jobAgentName") String jobAgentName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<JobAgentListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of job agents in a server along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<JobAgentInner> listByServerSinglePage(String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<JobAgentListResult> res = service.listByServerSync(this.client.getEndpoint(), resourceGroupName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an Azure SQL job agent along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        String jobAgentName, JobAgentInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<JobAgentInner>, JobAgentInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, jobAgentName, parameters);
        return this.client.<JobAgentInner, JobAgentInner>getLroResult(response, JobAgentInner.class,
            JobAgentInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<JobAgentInner>, JobAgentInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, jobAgentName, parameters, context);
        return this.client.<JobAgentInner, JobAgentInner>getLroResult(response, JobAgentInner.class,
            JobAgentInner.class, context);
    }
    ...
    public JobAgentInner createOrUpdate(String resourceGroupName, String serverName, String jobAgentName,
        JobAgentInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, jobAgentName, parameters).getFinalResult();
    }
    ...
    public JobAgentInner createOrUpdate(String resourceGroupName, String serverName, String jobAgentName,
        ...
        return beginCreateOrUpdate(resourceGroupName, serverName, jobAgentName, parameters, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String jobAgentName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, jobAgentName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, jobAgentName, context);
    ...
    public void delete(String resourceGroupName, String serverName, String jobAgentName) {
        beginDelete(resourceGroupName, serverName, jobAgentName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String serverName, String jobAgentName, Context context) {
        beginDelete(resourceGroupName, serverName, jobAgentName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, serverName, jobAgentName,
            this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<JobAgentInner>, JobAgentInner> beginUpdate(String resourceGroupName, String serverName,
        String jobAgentName, JobAgentUpdate parameters) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, serverName, jobAgentName, parameters);
        return this.client.<JobAgentInner, JobAgentInner>getLroResult(response, JobAgentInner.class,
            JobAgentInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<JobAgentInner>, JobAgentInner> beginUpdate(String resourceGroupName, String serverName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, serverName, jobAgentName, parameters, context);
        return this.client.<JobAgentInner, JobAgentInner>getLroResult(response, JobAgentInner.class,
            JobAgentInner.class, context);
    }
    ...
    public JobAgentInner update(String resourceGroupName, String serverName, String jobAgentName,
        JobAgentUpdate parameters) {
        return beginUpdate(resourceGroupName, serverName, jobAgentName, parameters).getFinalResult();
    }
    ...
    public JobAgentInner update(String resourceGroupName, String serverName, String jobAgentName,
        JobAgentUpdate parameters, Context context) {
        return beginUpdate(resourceGroupName, serverName, jobAgentName, parameters, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Azure SQL job agents along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<JobAgentInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<JobAgentListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<JobAgentInner> listByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(JobAgentsClientImpl.class);
}
