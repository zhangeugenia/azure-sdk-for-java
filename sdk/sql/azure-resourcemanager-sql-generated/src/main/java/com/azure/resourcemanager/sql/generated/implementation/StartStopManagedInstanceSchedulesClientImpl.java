...
public final class StartStopManagedInstanceSchedulesClientImpl implements StartStopManagedInstanceSchedulesClient {
    ...
    public interface StartStopManagedInstanceSchedulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StartStopManagedInstanceScheduleListResult> listByInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StartStopManagedInstanceScheduleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("startStopScheduleName") StartStopScheduleName startStopScheduleName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StartStopManagedInstanceScheduleInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("startStopScheduleName") StartStopScheduleName startStopScheduleName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StartStopManagedInstanceScheduleListResult> listByInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return managed instance's Start/Stop schedule list result along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StartStopManagedInstanceScheduleInner> listByInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        Response<StartStopManagedInstanceScheduleListResult> res = service.listByInstanceSync(this.client.getEndpoint(),
    ...
    public Response<StartStopManagedInstanceScheduleInner> getWithResponse(String resourceGroupName,
        ...
        if (startStopScheduleName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter startStopScheduleName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-08-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, startStopScheduleName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StartStopManagedInstanceScheduleInner> listByInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<StartStopManagedInstanceScheduleListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(StartStopManagedInstanceSchedulesClientImpl.class);
}
