...
public final class ManagedInstanceEncryptionProtectorsClientImpl implements ManagedInstanceEncryptionProtectorsClient {
    ...
    public interface ManagedInstanceEncryptionProtectorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceEncryptionProtectorListResult> listByInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceEncryptionProtectorInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("encryptionProtectorName") EncryptionProtectorName encryptionProtectorName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceEncryptionProtectorListResult> listByInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> revalidateWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.revalidateSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            encryptionProtectorName, this.client.getSubscriptionId(), apiVersion, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(String resourceGroupName, String managedInstanceName,
        ...
        Response<BinaryData> response
            = revalidateWithResponse(resourceGroupName, managedInstanceName, encryptionProtectorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName, Context context) {
        Response<BinaryData> response
            = revalidateWithResponse(resourceGroupName, managedInstanceName, encryptionProtectorName, context);
    ...
    public void revalidate(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName) {
        beginRevalidate(resourceGroupName, managedInstanceName, encryptionProtectorName).getFinalResult();
    }
    ...
    public void revalidate(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName, Context context) {
        beginRevalidate(resourceGroupName, managedInstanceName, encryptionProtectorName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed instance encryption protectors along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceEncryptionProtectorInner> listByInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstanceEncryptionProtectorListResult> res
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the managed instance encryption protector along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<ManagedInstanceEncryptionProtectorInner>, ManagedInstanceEncryptionProtectorInner>
        beginCreateOrUpdate(String resourceGroupName, String managedInstanceName,
            EncryptionProtectorName encryptionProtectorName, ManagedInstanceEncryptionProtectorInner parameters) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, managedInstanceName, encryptionProtectorName, parameters);
        return this.client
            .<ManagedInstanceEncryptionProtectorInner, ManagedInstanceEncryptionProtectorInner>getLroResult(response,
                ManagedInstanceEncryptionProtectorInner.class, ManagedInstanceEncryptionProtectorInner.class,
                Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedInstanceEncryptionProtectorInner>, ManagedInstanceEncryptionProtectorInner>
        ...
        return this.client
            .<ManagedInstanceEncryptionProtectorInner, ManagedInstanceEncryptionProtectorInner>getLroResult(response,
                ManagedInstanceEncryptionProtectorInner.class, ManagedInstanceEncryptionProtectorInner.class, context);
    }
    ...
    public ManagedInstanceEncryptionProtectorInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName, ManagedInstanceEncryptionProtectorInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, encryptionProtectorName, parameters)
            .getFinalResult();
    }
    ...
    public ManagedInstanceEncryptionProtectorInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName, ManagedInstanceEncryptionProtectorInner parameters,
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, encryptionProtectorName, parameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstanceEncryptionProtectorInner> listByInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedInstanceEncryptionProtectorsClientImpl.class);
}
