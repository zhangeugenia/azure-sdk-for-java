...
public final class SensitivityLabelImpl
    ...
    public SensitivityLabel create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdateWithResponse(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName,
    ...
    public Response<Void> disableRecommendationWithResponse(Context context) {
        return serviceManager.managedDatabaseSensitivityLabels()
            .disableRecommendationWithResponse(resourceGroupName, managedInstanceName, databaseName, schemaName,
                tableName, columnName, context);
    }

    public void disableRecommendation() {
        serviceManager.managedDatabaseSensitivityLabels()
            .disableRecommendation(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName,
                columnName);
    }

    public Response<Void> enableRecommendationWithResponse(Context context) {
        return serviceManager.managedDatabaseSensitivityLabels()
            .enableRecommendationWithResponse(resourceGroupName, managedInstanceName, databaseName, schemaName,
                tableName, columnName, context);
    }

    public void enableRecommendation() {
        serviceManager.managedDatabaseSensitivityLabels()
            .enableRecommendation(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName,
                columnName);
    }
