...
public final class OutboundFirewallRulesClientImpl implements OutboundFirewallRulesClient {
    ...
    public interface OutboundFirewallRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OutboundFirewallRuleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("outboundRuleFqdn") String outboundRuleFqdn, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OutboundFirewallRuleListResult> listByServerSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OutboundFirewallRuleListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<OutboundFirewallRuleInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        if (outboundRuleFqdn == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter outboundRuleFqdn is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, outboundRuleFqdn,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an Azure SQL DB Server Outbound Firewall Rule along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serverName, outboundRuleFqdn,
    ...
    public SyncPoller<PollResult<OutboundFirewallRuleInner>, OutboundFirewallRuleInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, outboundRuleFqdn, parameters);
        return this.client.<OutboundFirewallRuleInner, OutboundFirewallRuleInner>getLroResult(response,
            OutboundFirewallRuleInner.class, OutboundFirewallRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<OutboundFirewallRuleInner>, OutboundFirewallRuleInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, outboundRuleFqdn, parameters, context);
        return this.client.<OutboundFirewallRuleInner, OutboundFirewallRuleInner>getLroResult(response,
            OutboundFirewallRuleInner.class, OutboundFirewallRuleInner.class, context);
    }
    ...
    public OutboundFirewallRuleInner createOrUpdate(String resourceGroupName, String serverName,
        String outboundRuleFqdn, OutboundFirewallRuleInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, outboundRuleFqdn, parameters).getFinalResult();
    }
    ...
    public OutboundFirewallRuleInner createOrUpdate(String resourceGroupName, String serverName,
        String outboundRuleFqdn, OutboundFirewallRuleInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, outboundRuleFqdn, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2021-02-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, serverName, outboundRuleFqdn,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String outboundRuleFqdn) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, outboundRuleFqdn);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serverName,
        String outboundRuleFqdn, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, serverName, outboundRuleFqdn, context);
    ...
    public void delete(String resourceGroupName, String serverName, String outboundRuleFqdn) {
        beginDelete(resourceGroupName, serverName, outboundRuleFqdn).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String serverName, String outboundRuleFqdn, Context context) {
        beginDelete(resourceGroupName, serverName, outboundRuleFqdn, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all outbound firewall rules on a server along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OutboundFirewallRuleInner> listByServerSinglePage(String resourceGroupName,
        String serverName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-02-01-preview";
        final String accept = "application/json";
        Response<OutboundFirewallRuleListResult> res = service.listByServerSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OutboundFirewallRuleInner> listByServerSinglePage(String resourceGroupName, String serverName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of outbound rules along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OutboundFirewallRuleInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<OutboundFirewallRuleListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OutboundFirewallRuleInner> listByServerNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OutboundFirewallRulesClientImpl.class);
}
