...
public final class LongTermRetentionPoliciesClientImpl implements LongTermRetentionPoliciesClient {
    ...
    public interface LongTermRetentionPoliciesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LongTermRetentionPolicyListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LongTermRetentionPolicyInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
            @PathParam("policyName") LongTermRetentionPolicyName policyName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LongTermRetentionPolicyListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a database's long term retention policy along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LongTermRetentionPolicyInner> listByDatabaseSinglePage(String resourceGroupName,
        String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<LongTermRetentionPolicyListResult> res
    ...
    private PagedResponse<LongTermRetentionPolicyInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2023-05-01-preview";
        final String accept = "application/json";
        Response<LongTermRetentionPolicyListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a long term retention policy along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<LongTermRetentionPolicyInner>, LongTermRetentionPolicyInner> beginCreateOrUpdate(
        ...
        return this.client.<LongTermRetentionPolicyInner, LongTermRetentionPolicyInner>getLroResult(response,
            LongTermRetentionPolicyInner.class, LongTermRetentionPolicyInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LongTermRetentionPolicyInner>, LongTermRetentionPolicyInner> beginCreateOrUpdate(
        ...
        return this.client.<LongTermRetentionPolicyInner, LongTermRetentionPolicyInner>getLroResult(response,
            LongTermRetentionPolicyInner.class, LongTermRetentionPolicyInner.class, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of long term retention policies along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LongTermRetentionPolicyInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LongTermRetentionPolicyInner> listByDatabaseNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LongTermRetentionPoliciesClientImpl.class);
}
