...
public final class TdeCertificatesClientImpl implements TdeCertificatesClient {
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, serverName,
    ...
    public void create(String resourceGroupName, String serverName, TdeCertificate parameters) {
        beginCreate(resourceGroupName, serverName, parameters).getFinalResult();
    }
    ...
    public void create(String resourceGroupName, String serverName, TdeCertificate parameters, Context context) {
        beginCreate(resourceGroupName, serverName, parameters, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(TdeCertificatesClientImpl.class);
}
