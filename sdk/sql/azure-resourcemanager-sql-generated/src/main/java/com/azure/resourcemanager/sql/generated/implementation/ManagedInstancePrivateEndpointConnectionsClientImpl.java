...
public final class ManagedInstancePrivateEndpointConnectionsClientImpl
    ...
    public interface ManagedInstancePrivateEndpointConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstancePrivateEndpointConnectionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("privateEndpointConnectionName") String privateEndpointConnectionName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstancePrivateEndpointConnectionListResult> listByManagedInstanceSync(
            @HostParam("$host") String endpoint, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstancePrivateEndpointConnectionListResult> listByManagedInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public
        ...
        return this.client
            .<ManagedInstancePrivateEndpointConnectionInner, ManagedInstancePrivateEndpointConnectionInner>getLroResult(
                response, ManagedInstancePrivateEndpointConnectionInner.class,
                ManagedInstancePrivateEndpointConnectionInner.class, Context.NONE);
    }
    ...
    public ManagedInstancePrivateEndpointConnectionInner createOrUpdate(String resourceGroupName,
        String managedInstanceName, String privateEndpointConnectionName,
        ManagedInstancePrivateEndpointConnectionInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, privateEndpointConnectionName, parameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            privateEndpointConnectionName, this.client.getSubscriptionId(), apiVersion, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, privateEndpointConnectionName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        String privateEndpointConnectionName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, privateEndpointConnectionName, context);
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String privateEndpointConnectionName) {
        beginDelete(resourceGroupName, managedInstanceName, privateEndpointConnectionName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String privateEndpointConnectionName,
        Context context) {
        beginDelete(resourceGroupName, managedInstanceName, privateEndpointConnectionName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstancePrivateEndpointConnectionInner>
        listByManagedInstanceSinglePage(String resourceGroupName, String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstancePrivateEndpointConnectionListResult> res
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstancePrivateEndpointConnectionInner>
        listByManagedInstanceSinglePage(String resourceGroupName, String managedInstanceName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstancePrivateEndpointConnectionInner>
        listByManagedInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedInstancePrivateEndpointConnectionInner>
        listByManagedInstanceNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(ManagedInstancePrivateEndpointConnectionsClientImpl.class);
}
