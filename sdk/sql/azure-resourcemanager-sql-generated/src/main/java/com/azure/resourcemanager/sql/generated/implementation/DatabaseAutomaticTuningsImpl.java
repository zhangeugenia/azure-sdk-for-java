...
public final class DatabaseAutomaticTuningsImpl implements DatabaseAutomaticTunings {
    ...
    public DatabaseAutomaticTuningsImpl(DatabaseAutomaticTuningsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<DatabaseAutomaticTuning> getWithResponse(String resourceGroupName, String serverName,
    ...
    public Response<DatabaseAutomaticTuning> updateWithResponse(String resourceGroupName, String serverName,
    ...
    public DatabaseAutomaticTuning update(String resourceGroupName, String serverName, String databaseName,
