...
public final class ServerUsagesClientImpl implements ServerUsagesClient {
    ...
    public interface ServerUsagesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerUsageListResult> listByServerSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents the response to a list server metrics request along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerUsageInner> listByServerSinglePage(String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2014-04-01";
        final String accept = "application/json";
        Response<ServerUsageListResult> res = service.listByServerSync(this.client.getEndpoint(), apiVersion,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServerUsagesClientImpl.class);
}
