...
public final class ManagedServerDnsAliasesClientImpl implements ManagedServerDnsAliasesClient {
    ...
    public interface ManagedServerDnsAliasesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedServerDnsAliasListResult> listByManagedInstanceSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedServerDnsAliasInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("dnsAliasName") String dnsAliasName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> acquireSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("dnsAliasName") String dnsAliasName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedServerDnsAliasListResult> listByManagedInstanceNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed server DNS aliases for a managed server along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedServerDnsAliasInner> listByManagedInstanceSinglePage(String resourceGroupName,
        String managedInstanceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2021-11-01-preview";
        final String accept = "application/json";
        Response<ManagedServerDnsAliasListResult> res = service.listByManagedInstanceSync(this.client.getEndpoint(),
    ...
    public Response<ManagedServerDnsAliasInner> getWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        if (dnsAliasName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter dnsAliasName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2021-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, dnsAliasName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a managed server DNS alias along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            dnsAliasName, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, managedInstanceName, dnsAliasName, parameters);
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(response,
            ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context);
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(response,
            ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class, context);
    }
    ...
    public ManagedServerDnsAliasInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasCreation parameters) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, dnsAliasName, parameters).getFinalResult();
    }
    ...
    public ManagedServerDnsAliasInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasCreation parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2021-11-01-preview";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, dnsAliasName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        String dnsAliasName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, managedInstanceName, dnsAliasName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, managedInstanceName, dnsAliasName, context);
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String dnsAliasName) {
        beginDelete(resourceGroupName, managedInstanceName, dnsAliasName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String dnsAliasName, Context context) {
        beginDelete(resourceGroupName, managedInstanceName, dnsAliasName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> acquireWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String apiVersion = "2021-11-01-preview";
        final String accept = "application/json";
        return service.acquireSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, dnsAliasName,
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginAcquire(
        ...
        ManagedServerDnsAliasAcquisition parameters) {
        Response<BinaryData> response
            = acquireWithResponse(resourceGroupName, managedInstanceName, dnsAliasName, parameters);
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(response,
            ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginAcquire(
        ...
        Response<BinaryData> response
            = acquireWithResponse(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context);
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(response,
            ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class, context);
    }
    ...
    public ManagedServerDnsAliasInner acquire(String resourceGroupName, String managedInstanceName, String dnsAliasName,
        ManagedServerDnsAliasAcquisition parameters) {
        return beginAcquire(resourceGroupName, managedInstanceName, dnsAliasName, parameters).getFinalResult();
    }
    ...
    public ManagedServerDnsAliasInner acquire(String resourceGroupName, String managedInstanceName, String dnsAliasName,
        ManagedServerDnsAliasAcquisition parameters, Context context) {
        return beginAcquire(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed server DNS aliases along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ManagedServerDnsAliasInner> listByManagedInstanceNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ManagedServerDnsAliasListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedServerDnsAliasesClientImpl.class);
}
