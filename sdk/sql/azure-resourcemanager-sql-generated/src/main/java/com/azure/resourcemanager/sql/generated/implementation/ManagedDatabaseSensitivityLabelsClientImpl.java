...
public final class ManagedDatabaseSensitivityLabelsClientImpl implements ManagedDatabaseSensitivityLabelsClient {
    ...
    public Response<Void> disableRecommendationWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String sensitivityLabelSource = "recommended";
        final String apiVersion = "2020-11-01-preview";
        return service.disableRecommendationSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            databaseName, schemaName, tableName, columnName, sensitivityLabelSource, this.client.getSubscriptionId(),
            apiVersion, context);
    }
    ...
    public Response<Void> enableRecommendationWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        final String sensitivityLabelSource = "recommended";
        final String apiVersion = "2020-11-01-preview";
        return service.enableRecommendationSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            databaseName, schemaName, tableName, columnName, sensitivityLabelSource, this.client.getSubscriptionId(),
            apiVersion, context);
    }
    ...
    private PagedResponse<SensitivityLabelInner> listCurrentByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<SensitivityLabelListResult> res = service.listCurrentByDatabaseSync(this.client.getEndpoint(),
    ...
    private PagedResponse<SensitivityLabelInner> listCurrentByDatabaseSinglePage(String resourceGroupName,
        ...
        Response<SensitivityLabelListResult> res
            = service.listCurrentByDatabaseSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
                databaseName, skipToken, count, filter, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SensitivityLabelInner> listCurrentByDatabase(String resourceGroupName,
        ...
        final Boolean count = null;
        final String filter = null;
        return new PagedIterable<>(() -> listCurrentByDatabaseSinglePage(resourceGroupName, managedInstanceName,
            databaseName, skipToken, count, filter), nextLink -> listCurrentByDatabaseNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<SensitivityLabelInner> listCurrentByDatabase(String resourceGroupName,
        ...
        return new PagedIterable<>(() -> listCurrentByDatabaseSinglePage(resourceGroupName, managedInstanceName,
            ...
            nextLink -> listCurrentByDatabaseNextSinglePage(nextLink, context));
    }
    ...
    private PagedResponse<SensitivityLabelInner> listRecommendedByDatabaseSinglePage(String resourceGroupName,
        ...
        Response<SensitivityLabelListResult> res = service.listRecommendedByDatabaseSync(this.client.getEndpoint(),
            resourceGroupName, managedInstanceName, databaseName, skipToken, includeDisabledRecommendations, filter,
            this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SensitivityLabelInner> listRecommendedByDatabase(String resourceGroupName,
        ...
        final Boolean includeDisabledRecommendations = null;
        final String filter = null;
        return new PagedIterable<>(() -> listRecommendedByDatabaseSinglePage(resourceGroupName, managedInstanceName,
    ...
    public PagedIterable<SensitivityLabelInner> listRecommendedByDatabase(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listRecommendedByDatabaseSinglePage(resourceGroupName, managedInstanceName, databaseName, skipToken,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedDatabaseSensitivityLabelsClientImpl.class);
}
