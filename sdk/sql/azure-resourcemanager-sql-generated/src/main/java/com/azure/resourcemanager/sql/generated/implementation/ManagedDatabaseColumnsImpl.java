...
public final class ManagedDatabaseColumnsImpl implements ManagedDatabaseColumns {
    ...
    public PagedIterable<DatabaseColumn> listByDatabase(String resourceGroupName, String managedInstanceName,
        ...
        PagedIterable<DatabaseColumnInner> inner = this.serviceClient()
            .listByDatabase(resourceGroupName, managedInstanceName, databaseName, schema, table, column, orderBy,
                skiptoken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DatabaseColumnImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<DatabaseColumn> listByTable(String resourceGroupName, String managedInstanceName,
        ...
        PagedIterable<DatabaseColumnInner> inner = this.serviceClient()
            .listByTable(resourceGroupName, managedInstanceName, databaseName, schemaName, tableName, filter, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DatabaseColumnImpl(inner1, this.manager()));
    }
    ...
    public Response<DatabaseColumn> getWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        Response<DatabaseColumnInner> inner = this.serviceClient()
    ...
    public DatabaseColumn get(String resourceGroupName, String managedInstanceName, String databaseName,
        ...
        DatabaseColumnInner inner = this.serviceClient()
