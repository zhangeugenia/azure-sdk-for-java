...
public final class ManagedDatabaseTablesClientImpl implements ManagedDatabaseTablesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DatabaseTableInner> listBySchemaSinglePage(String resourceGroupName,
        String managedInstanceName, String databaseName, String schemaName, String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        Response<DatabaseTableListResult> res
            = service.listBySchemaSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
    ...
    private PagedResponse<DatabaseTableInner> listBySchemaSinglePage(String resourceGroupName,
        ...
        Response<DatabaseTableListResult> res
            = service.listBySchemaSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
                schemaName, filter, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<DatabaseTableInner> listBySchema(String resourceGroupName, String managedInstanceName,
        ...
        return new PagedIterable<>(
            () -> listBySchemaSinglePage(resourceGroupName, managedInstanceName, databaseName, schemaName, filter),
    ...
    public PagedIterable<DatabaseTableInner> listBySchema(String resourceGroupName, String managedInstanceName,
        ...
        return new PagedIterable<>(() -> listBySchemaSinglePage(resourceGroupName, managedInstanceName, databaseName,
            schemaName, filter, context), nextLink -> listBySchemaNextSinglePage(nextLink, context));
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedDatabaseTablesClientImpl.class);
}
