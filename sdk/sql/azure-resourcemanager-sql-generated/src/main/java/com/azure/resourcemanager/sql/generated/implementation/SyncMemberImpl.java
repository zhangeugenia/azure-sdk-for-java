...
public final class SyncMemberImpl implements SyncMember, SyncMember.Definition, SyncMember.Update {
    ...
    public SyncMember create() {
        this.innerObject = serviceManager.serviceClient()
            .getSyncMembers()
            .createOrUpdate(resourceGroupName, serverName, databaseName, syncGroupName, syncMemberName,
    ...
    public SyncMember apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSyncMembers()
            .update(resourceGroupName, serverName, databaseName, syncGroupName, syncMemberName, this.innerModel(),
                Context.NONE);
        return this;
    }
