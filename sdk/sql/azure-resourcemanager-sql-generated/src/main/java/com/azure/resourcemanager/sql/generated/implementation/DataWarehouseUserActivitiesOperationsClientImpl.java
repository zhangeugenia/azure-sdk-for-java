...
public final class DataWarehouseUserActivitiesOperationsClientImpl
    ...
    public interface DataWarehouseUserActivitiesOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DataWarehouseUserActivitiesInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
            @PathParam("dataWarehouseUserActivityName") DataWarehouseUserActivityName dataWarehouseUserActivityName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DataWarehouseUserActivitiesListResult> listByDatabaseSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DataWarehouseUserActivitiesListResult> listByDatabaseNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return user activities of a data warehouse along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DataWarehouseUserActivitiesInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<DataWarehouseUserActivitiesListResult> res
    ...
    private PagedResponse<DataWarehouseUserActivitiesInner> listByDatabaseSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<DataWarehouseUserActivitiesListResult> res = service.listByDatabaseSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DataWarehouseUserActivitiesInner> listByDatabaseNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DataWarehouseUserActivitiesOperationsClientImpl.class);
}
