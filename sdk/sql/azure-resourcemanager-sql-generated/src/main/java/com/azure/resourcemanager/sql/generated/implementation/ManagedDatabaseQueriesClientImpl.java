...
public final class ManagedDatabaseQueriesClientImpl implements ManagedDatabaseQueriesClient {
    ...
    public interface ManagedDatabaseQueriesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceQueryInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("databaseName") String databaseName, @PathParam("queryId") String queryId,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceQueryStatistics> listByQuerySync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("databaseName") String databaseName, @PathParam("queryId") String queryId,
            @QueryParam("startTime") String startTime, @QueryParam("endTime") String endTime,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedInstanceQueryStatistics> listByQueryNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ManagedInstanceQueryInner> getWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        if (queryId == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter queryId is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName, queryId,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return query execution statistics by query id along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<QueryStatisticsInner> listByQuerySinglePage(String resourceGroupName,
        String managedInstanceName, String databaseName, String queryId, String startTime, String endTime,
        QueryTimeGrainType interval) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstanceQueryStatistics> res = service.listByQuerySync(this.client.getEndpoint(),
    ...
    private PagedResponse<QueryStatisticsInner> listByQuerySinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2020-11-01-preview";
        final String accept = "application/json";
        Response<ManagedInstanceQueryStatistics> res
            = service.listByQuerySync(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
                queryId, startTime, endTime, interval, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<QueryStatisticsInner> listByQuery(String resourceGroupName, String managedInstanceName,
        ...
        final String endTime = null;
        final QueryTimeGrainType interval = null;
        return new PagedIterable<>(() -> listByQuerySinglePage(resourceGroupName, managedInstanceName, databaseName,
            queryId, startTime, endTime, interval), nextLink -> listByQueryNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<QueryStatisticsInner> listByQuery(String resourceGroupName, String managedInstanceName,
        ...
        Context context) {
        return new PagedIterable<>(() -> listByQuerySinglePage(resourceGroupName, managedInstanceName, databaseName,
            queryId, startTime, endTime, interval, context), nextLink -> listByQueryNextSinglePage(nextLink, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return execution statistics for one particular query along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<QueryStatisticsInner> listByQueryNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ManagedInstanceQueryStatistics> res
            = service.listByQueryNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<QueryStatisticsInner> listByQueryNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ManagedInstanceQueryStatistics> res
            = service.listByQueryNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(ManagedDatabaseQueriesClientImpl.class);
}
