...
public final class ServerAdvancedThreatProtectionSettingsClientImpl
    ...
    public interface ServerAdvancedThreatProtectionSettingsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LogicalServerAdvancedThreatProtectionListResult> listByServerSync(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServerAdvancedThreatProtectionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serverName") String serverName,
            @PathParam("advancedThreatProtectionName") AdvancedThreatProtectionName advancedThreatProtectionName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LogicalServerAdvancedThreatProtectionListResult> listByServerNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of the server's Advanced Threat Protection states along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerAdvancedThreatProtectionInner> listByServerSinglePage(String resourceGroupName,
        String serverName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2021-11-01-preview";
        final String accept = "application/json";
        Response<LogicalServerAdvancedThreatProtectionListResult> res
            = service.listByServerSync(this.client.getEndpoint(), resourceGroupName, serverName,
    ...
    public Response<ServerAdvancedThreatProtectionInner> getWithResponse(String resourceGroupName, String serverName,
        ...
        final String apiVersion = "2021-11-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serverName, advancedThreatProtectionName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a server Advanced Threat Protection along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<ServerAdvancedThreatProtectionInner>, ServerAdvancedThreatProtectionInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, serverName, advancedThreatProtectionName, parameters);
        return this.client.<ServerAdvancedThreatProtectionInner, ServerAdvancedThreatProtectionInner>getLroResult(
            response, ServerAdvancedThreatProtectionInner.class, ServerAdvancedThreatProtectionInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServerAdvancedThreatProtectionInner>, ServerAdvancedThreatProtectionInner>
        ...
        return this.client.<ServerAdvancedThreatProtectionInner, ServerAdvancedThreatProtectionInner>getLroResult(
            response, ServerAdvancedThreatProtectionInner.class, ServerAdvancedThreatProtectionInner.class, context);
    }
    ...
    public ServerAdvancedThreatProtectionInner createOrUpdate(String resourceGroupName, String serverName,
        AdvancedThreatProtectionName advancedThreatProtectionName, ServerAdvancedThreatProtectionInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, serverName, advancedThreatProtectionName, parameters)
            .getFinalResult();
    }
    ...
    public ServerAdvancedThreatProtectionInner createOrUpdate(String resourceGroupName, String serverName,
        AdvancedThreatProtectionName advancedThreatProtectionName, ServerAdvancedThreatProtectionInner parameters,
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, serverName, advancedThreatProtectionName, parameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of the server's Advanced Threat Protection configurations along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServerAdvancedThreatProtectionInner> listByServerNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServerAdvancedThreatProtectionSettingsClientImpl.class);
}
