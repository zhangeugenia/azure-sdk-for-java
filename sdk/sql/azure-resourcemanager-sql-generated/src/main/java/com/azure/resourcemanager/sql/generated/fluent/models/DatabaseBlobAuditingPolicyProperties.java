...
public final class DatabaseBlobAuditingPolicyProperties
    implements JsonSerializable<DatabaseBlobAuditingPolicyProperties> {
    /*
    ...
    /**
     * Reads an instance of DatabaseBlobAuditingPolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DatabaseBlobAuditingPolicyProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DatabaseBlobAuditingPolicyProperties.
     */
    public static DatabaseBlobAuditingPolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DatabaseBlobAuditingPolicyProperties deserializedDatabaseBlobAuditingPolicyProperties
                = new DatabaseBlobAuditingPolicyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("state".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.state
                        = BlobAuditingPolicyState.fromString(reader.getString());
                } else if ("retentionDays".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.retentionDays
                    ...
                    deserializedDatabaseBlobAuditingPolicyProperties.auditActionsAndGroups = auditActionsAndGroups;
                } else if ("isStorageSecondaryKeyInUse".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.isStorageSecondaryKeyInUse
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("isAzureMonitorTargetEnabled".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.isAzureMonitorTargetEnabled
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("queueDelayMs".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.queueDelayMs
                        = reader.getNullable(JsonReader::getInt);
                } else if ("isManagedIdentityInUse".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.isManagedIdentityInUse
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("storageEndpoint".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.storageEndpoint = reader.getString();
                } else if ("storageAccountAccessKey".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.storageAccountAccessKey = reader.getString();
                } else if ("storageAccountSubscriptionId".equals(fieldName)) {
                    deserializedDatabaseBlobAuditingPolicyProperties.storageAccountSubscriptionId
            ...
            return deserializedDatabaseBlobAuditingPolicyProperties;
        });
    }
}
