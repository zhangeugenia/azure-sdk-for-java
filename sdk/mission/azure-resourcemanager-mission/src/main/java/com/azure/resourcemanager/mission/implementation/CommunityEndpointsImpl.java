...
public final class CommunityEndpointsImpl implements CommunityEndpoints {
    ...
    public ApprovalCallbackResponse approvalCallback(String resourceGroupName, String communityName,
        String communityEndpointName, ApprovalCallbackRequest body) {
        ApprovalCallbackResponseInner inner
            = this.serviceClient().approvalCallback(resourceGroupName, communityName, communityEndpointName, body);
        if (inner != null) {
    ...
    public ApprovalCallbackResponse approvalCallback(String resourceGroupName, String communityName,
        ...
        ApprovalCallbackResponseInner inner = this.serviceClient()
    ...
    public ApprovalDeletionCallbackResponse approvalDeletionCallback(String resourceGroupName, String communityName,
        String communityEndpointName, ApprovalDeletionCallbackRequest body) {
        ApprovalDeletionCallbackResponseInner inner = this.serviceClient()
