...
public final class InitiatorCallbackResponseImpl implements InitiatorCallbackResponse {
    private InitiatorCallbackResponseInner innerObject;

    private final com.azure.resourcemanager.mission.MissionManager serviceManager;

    InitiatorCallbackResponseImpl(InitiatorCallbackResponseInner innerObject,
    ...
    public InitiatorCallbackResponseInner innerModel() {
