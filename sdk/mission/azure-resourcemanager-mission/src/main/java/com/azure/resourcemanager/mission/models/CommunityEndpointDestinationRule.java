...
public final class CommunityEndpointDestinationRule implements JsonSerializable<CommunityEndpointDestinationRule> {
     ...
     */
    public CommunityEndpointDestinationRule withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the CommunityEndpointDestinationRule object itself.
     */
    public CommunityEndpointDestinationRule withPort(String port) {
        this.port = port;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    deserializedCommunityEndpointDestinationRule.name = reader.getString();
                } else if ("destination".equals(fieldName)) {
                    deserializedCommunityEndpointDestinationRule.destination = reader.getString();
                } else if ("port".equals(fieldName)) {
                    deserializedCommunityEndpointDestinationRule.port = reader.getString();
