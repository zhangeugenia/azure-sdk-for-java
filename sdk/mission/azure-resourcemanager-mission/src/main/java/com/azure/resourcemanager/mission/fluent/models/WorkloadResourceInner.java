...
public final class WorkloadResourceInner extends Resource {
     ...
     */
    public WorkloadResourceInner withResourceGroupCollection(List<String> resourceGroupCollection) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedWorkloadResourceInner.innerProperties = WorkloadProperties.fromJson(reader);
