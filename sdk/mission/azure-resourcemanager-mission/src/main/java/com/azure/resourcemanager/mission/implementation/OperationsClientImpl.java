...
import com.azure.resourcemanager.mission.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MissionClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MissionClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MissionClientOperati")
