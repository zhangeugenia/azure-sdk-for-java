...
This package contains Microsoft Azure SDK for edgeorder Management SDK. Edge Order API's. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
