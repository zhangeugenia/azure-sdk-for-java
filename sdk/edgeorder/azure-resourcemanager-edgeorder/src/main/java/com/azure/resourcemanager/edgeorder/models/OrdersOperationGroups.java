...
/**
 * Resource collection API of OrdersOperationGroups.
 */
public interface OrdersOperationGroups {
     ...
     */
    PagedIterable<OrderResource> list();
     ...
     * @return list of orders as paginated response with {@link PagedIterable}.
     */
    PagedIterable<OrderResource> list(String skipToken, Integer top, Context context);
     ...
     * @return list of orders as paginated response with {@link PagedIterable}.
     */
    PagedIterable<OrderResource> listByResourceGroup(String resourceGroupName);
     ...
     * @return list of orders as paginated response with {@link PagedIterable}.
     */
    PagedIterable<OrderResource> listByResourceGroup(String resourceGroupName, String skipToken, Integer top,
        Context context);
}
