...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(EdgeOrderClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for EdgeOrderClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "EdgeOrderClientOpera")
