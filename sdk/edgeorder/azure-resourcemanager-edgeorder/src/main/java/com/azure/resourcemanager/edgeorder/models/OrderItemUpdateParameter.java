...
public final class OrderItemUpdateParameter implements JsonSerializable<OrderItemUpdateParameter> {
     ...
     * @return the OrderItemUpdateParameter object itself.
     */
    public OrderItemUpdateParameter withIdentity(ResourceIdentity identity) {
     ...
     * @return the OrderItemUpdateParameter object itself.
     */
    public OrderItemUpdateParameter withOrderItemDetails(OrderItemDetailsUpdateParameter orderItemDetails) {
        if (this.innerProperties() == null) {
            this.innerProperties = new OrderItemUpdateProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    ...
                    deserializedOrderItemUpdateParameter.identity = ResourceIdentity.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
