...
public final class OrderItemResourceImpl
    ...
    public OrderItemResource create() {
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .create(resourceGroupName, orderItemName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public OrderItemResource create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .create(resourceGroupName, orderItemName, this.innerModel(), context);
        return this;
    }
    ...
    public OrderItemResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .update(resourceGroupName, orderItemName, updateOrderItemUpdateParameter, updateIfMatch, Context.NONE);
        return this;
    }
    ...
    public OrderItemResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .update(resourceGroupName, orderItemName, updateOrderItemUpdateParameter, updateIfMatch, context);
        return this;
    }
    ...
    public OrderItemResource refresh() {
        ...
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .getByResourceGroupWithResponse(resourceGroupName, orderItemName, localExpand, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public OrderItemResource refresh(Context context) {
        ...
        this.innerObject = serviceManager.serviceClient()
            .getOrderItemResources()
            .getByResourceGroupWithResponse(resourceGroupName, orderItemName, localExpand, context)
            .getValue();
        return this;
    }

    public Response<Void> cancelWithResponse(CancellationReason cancellationReason, Context context) {
        return serviceManager.orderItemResources()
            .cancelWithResponse(resourceGroupName, orderItemName, cancellationReason, context);
    }

    public void cancel(CancellationReason cancellationReason) {
        serviceManager.orderItemResources().cancel(resourceGroupName, orderItemName, cancellationReason);
    }

    public void returnOrderItem(ReturnOrderItemDetails returnOrderItemDetails) {
        serviceManager.orderItemResources().returnOrderItem(resourceGroupName, orderItemName, returnOrderItemDetails);
    }

    public void returnOrderItem(ReturnOrderItemDetails returnOrderItemDetails, Context context) {
        serviceManager.orderItemResources()
            .returnOrderItem(resourceGroupName, orderItemName, returnOrderItemDetails, context);
    }
    ...
    public OrderItemResourceImpl withIdentity(ResourceIdentity identity) {
        if (isInCreateMode()) {
            this.innerModel().withIdentity(identity);
            return this;
        } else {
            this.updateOrderItemUpdateParameter.withIdentity(identity);
            return this;
        }
    }
    ...
    public OrderItemResourceImpl withOrderItemDetails(OrderItemDetailsUpdateParameter orderItemDetails) {
        this.updateOrderItemUpdateParameter.withOrderItemDetails(orderItemDetails);
        return this;
    }
