...
public final class OrderItemUpdateProperties implements JsonSerializable<OrderItemUpdateProperties> {
     ...
     */
    private OrderItemDetailsUpdateParameter orderItemDetails;
     ...
     */
    public OrderItemDetailsUpdateParameter orderItemDetails() {
     ...
     * @return the OrderItemUpdateProperties object itself.
     */
    public OrderItemUpdateProperties withOrderItemDetails(OrderItemDetailsUpdateParameter orderItemDetails) {
    ...
    public static OrderItemUpdateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("orderItemDetails".equals(fieldName)) {
                    deserializedOrderItemUpdateProperties.orderItemDetails
                        = OrderItemDetailsUpdateParameter.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
