 ...
 */
public interface OrderItemResourcesClient {
    /**
     * Get an order item.
     * 
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginReturnOrderItem(String resourceGroupName, String orderItemName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void returnOrderItem(String resourceGroupName, String orderItemName, ReturnOrderItemDetails returnOrderItemDetails);
