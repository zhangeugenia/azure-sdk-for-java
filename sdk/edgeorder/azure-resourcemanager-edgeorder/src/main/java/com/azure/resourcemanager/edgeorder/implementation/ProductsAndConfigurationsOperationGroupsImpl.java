...
public final class ProductsAndConfigurationsOperationGroupsImpl implements ProductsAndConfigurationsOperationGroups {
    private static final ClientLogger LOGGER = new ClientLogger(ProductsAndConfigurationsOperationGroupsImpl.class);

    private final ProductsAndConfigurationsOperationGroupsClient innerClient;

    private final com.azure.resourcemanager.edgeorder.EdgeorderManager serviceManager;

    public ProductsAndConfigurationsOperationGroupsImpl(ProductsAndConfigurationsOperationGroupsClient innerClient,
    ...
    private ProductsAndConfigurationsOperationGroupsClient serviceClient() {
