...
public final class OrderItemDetails implements JsonSerializable<OrderItemDetails> {
     ...
     */
    private OrderMode orderItemMode;
    ...
    /**
     * Get the orderItemMode property: Defines the mode of the Order item.
     * 
     * @return the orderItemMode value.
     */
    public OrderMode orderItemMode() {
        return this.orderItemMode;
    }

    /**
     * Set the orderItemMode property: Defines the mode of the Order item.
     * 
     * @param orderItemMode the orderItemMode value to set.
     * @return the OrderItemDetails object itself.
     */
    public OrderItemDetails withOrderItemMode(OrderMode orderItemMode) {
     ...
     * @return the OrderItemDetails object itself.
     */
    public OrderItemDetails withSiteDetails(SiteDetails siteDetails) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("orderItemMode", this.orderItemMode == null ? null : this.orderItemMode.toString());
    ...
    public static OrderItemDetails fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("orderItemMode".equals(fieldName)) {
                    deserializedOrderItemDetails.orderItemMode = OrderMode.fromString(reader.getString());
                } else if ("siteDetails".equals(fieldName)) {
                    deserializedOrderItemDetails.siteDetails = SiteDetails.fromJson(reader);
