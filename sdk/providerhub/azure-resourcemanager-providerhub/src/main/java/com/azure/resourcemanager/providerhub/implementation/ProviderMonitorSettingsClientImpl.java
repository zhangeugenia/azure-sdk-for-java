...
public final class ProviderMonitorSettingsClientImpl implements ProviderMonitorSettingsClient {
     ...
     */
    @Host("{$host}")
    @ServiceInterface(name = "ProviderHubProviderM")
    ...
    public Response<ProviderMonitorSettingInner> getByResourceGroupWithResponse(String resourceGroupName,
        String providerMonitorSettingName, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, providerMonitorSettingName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        String providerMonitorSettingName, ProviderMonitorSettingInner properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<ProviderMonitorSettingInner>, ProviderMonitorSettingInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, providerMonitorSettingName, properties, context);
        return this.client.<ProviderMonitorSettingInner, ProviderMonitorSettingInner>getLroResult(mono,
            this.client.getHttpPipeline(), ProviderMonitorSettingInner.class, ProviderMonitorSettingInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<ProviderMonitorSettingInner>, ProviderMonitorSettingInner> beginCreate(
        String resourceGroupName, String providerMonitorSettingName, ProviderMonitorSettingInner properties) {
        return this.beginCreateAsync(resourceGroupName, providerMonitorSettingName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ProviderMonitorSettingInner>, ProviderMonitorSettingInner> beginCreate(
        String resourceGroupName, String providerMonitorSettingName, ProviderMonitorSettingInner properties,
        Context context) {
        return this.beginCreateAsync(resourceGroupName, providerMonitorSettingName, properties, context)
            .getSyncPoller();
    }
    ...
    private Mono<ProviderMonitorSettingInner> createAsync(String resourceGroupName, String providerMonitorSettingName,
        ...
        return beginCreateAsync(resourceGroupName, providerMonitorSettingName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ProviderMonitorSettingInner create(String resourceGroupName, String providerMonitorSettingName,
        ProviderMonitorSettingInner properties) {
        return createAsync(resourceGroupName, providerMonitorSettingName, properties).block();
    }
    ...
    public ProviderMonitorSettingInner create(String resourceGroupName, String providerMonitorSettingName,
        ProviderMonitorSettingInner properties, Context context) {
        return createAsync(resourceGroupName, providerMonitorSettingName, properties, context).block();
    }
    ...
    public Response<ProviderMonitorSettingInner> updateWithResponse(String resourceGroupName,
        String providerMonitorSettingName, Context context) {
        return updateWithResponseAsync(resourceGroupName, providerMonitorSettingName, context).block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String providerMonitorSettingName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, providerMonitorSettingName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProviderMonitorSettingInner> listByResourceGroupAsync(String resourceGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProviderMonitorSettingInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProviderMonitorSettingInner> listAsync(Context context) {
