...
public final class NewRegionFrontloadReleasesClientImpl implements NewRegionFrontloadReleasesClient {
     ...
     */
    @Host("{$host}")
    @ServiceInterface(name = "ProviderHubNewRegion")
    ...
    public Response<ResourceProviderManifestInner> generateManifestWithResponse(String providerNamespace,
        FrontloadPayload properties, Context context) {
        return generateManifestWithResponseAsync(providerNamespace, properties, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DefaultRolloutInner>> createOrUpdateWithResponseAsync(String providerNamespace,
        String releaseName, FrontloadPayload properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Response<DefaultRolloutInner> createOrUpdateWithResponse(String providerNamespace, String releaseName,
        FrontloadPayload properties, Context context) {
        return createOrUpdateWithResponseAsync(providerNamespace, releaseName, properties, context).block();
    }
    ...
    private Mono<Response<DefaultRolloutInner>> getWithResponseAsync(String providerNamespace, String releaseName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), providerNamespace, releaseName,
    ...
    public Response<DefaultRolloutInner> getWithResponse(String providerNamespace, String releaseName,
        Context context) {
        return getWithResponseAsync(providerNamespace, releaseName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> stopWithResponseAsync(String providerNamespace, String releaseName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.stop(this.client.getEndpoint(), this.client.getSubscriptionId(), providerNamespace, releaseName,
            this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<Void> stopWithResponse(String providerNamespace, String releaseName, Context context) {
        return stopWithResponseAsync(providerNamespace, releaseName, context).block();
    }
