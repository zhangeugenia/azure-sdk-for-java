        ...
        if (registryEndpointRef() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property registryEndpointRef in model DataflowGraphNodeGraphSettings"));
        }
        if (artifact() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property artifact in model DataflowGraphNodeGraphSettings"));
        }
        if (configuration() != null) {
            configuration().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DataflowGraphNodeGraphSettings.class);
