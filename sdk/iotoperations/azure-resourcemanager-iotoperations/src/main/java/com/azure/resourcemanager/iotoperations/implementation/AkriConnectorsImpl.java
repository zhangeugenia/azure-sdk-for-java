...
public final class AkriConnectorsImpl implements AkriConnectors {
    ...
    public AkriConnectorResource get(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        ...
        AkriConnectorResourceInner inner
            = this.serviceClient().get(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName);
        if (inner != null) {
    ...
    public void delete(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        String akriConnectorName) {
        this.serviceClient().delete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName);
    }

    public void delete(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        String akriConnectorName, Context context) {
        this.serviceClient()
            .delete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName, context);
    }
    ...
    public AkriConnectorResource getById(String id) {
        ...
        String akriConnectorName = ResourceManagerUtils.getValueFromIdByName(id, "akriConnectors");
        if (akriConnectorName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'akriConnectors'.", id)));
        }
        return this
    ...
    public Response<AkriConnectorResource> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName,
            context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName, context);
    }
