...
public final class DataflowGraphsClientImpl implements DataflowGraphsClient {
    ...
    private Mono<Response<DataflowGraphResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        if (dataflowGraphName == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter dataflowGraphName is required and cannot be null."));
        }
    ...
    public Response<DataflowGraphResourceInner> getWithResponse(String resourceGroupName, String instanceName,
        ...
        if (dataflowGraphName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter dataflowGraphName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DataflowGraphsClientImpl.class);
}
