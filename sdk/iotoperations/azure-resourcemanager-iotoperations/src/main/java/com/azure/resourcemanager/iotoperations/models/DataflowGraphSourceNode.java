...
public final class DataflowGraphSourceNode extends DataflowGraphNode {
     ...
     * Type of the node.
     */
    private DataflowGraphNodeType type = DataflowGraphNodeType.SOURCE;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedDataflowGraphSourceNode.type = DataflowGraphNodeType.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
