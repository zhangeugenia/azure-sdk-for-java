...
public final class AkriConnectorTemplateHelmContainerRegistrySettings
    ...
    /**
     * Get the repository property: The repository to use for the Helm chart.
     * 
    ...
    /**
     * Set the repository property: The repository to use for the Helm chart.
     * 
     * @param repository the repository value to set.
     * @return the AkriConnectorTemplateHelmContainerRegistrySettings object itself.
     */
    public AkriConnectorTemplateHelmContainerRegistrySettings withRepository(String repository) {
    ...
    public void validate() {
        ...
        if (repository() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property repository in model AkriConnectorTemplateHelmContainerRegistrySettings"));
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("registry".equals(fieldName)) {
                    ...
                    deserializedAkriConnectorTemplateHelmContainerRegistrySettings.repository = reader.getString();
