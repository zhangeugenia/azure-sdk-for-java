...
public final class DataflowGraphGraphNode extends DataflowGraphNode {
     ...
     * Type of the node.
     */
    private DataflowGraphNodeType type = DataflowGraphNodeType.GRAPH;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedDataflowGraphGraphNode.type = DataflowGraphNodeType.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
