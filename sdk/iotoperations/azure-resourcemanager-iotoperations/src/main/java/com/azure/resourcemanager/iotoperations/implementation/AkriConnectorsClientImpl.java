...
public final class AkriConnectorsClientImpl implements AkriConnectorsClient {
    ...
    public interface AkriConnectorsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/akriConnectorTemplates/{akriConnectorTemplateName}/akriConnectors/{akriConnectorName}")
        ...
        Mono<Response<AkriConnectorResourceInner>> get(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("akriConnectorName") String akriConnectorName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("instanceName") String instanceName,
            @PathParam("akriConnectorTemplateName") String akriConnectorTemplateName,
            @PathParam("akriConnectorName") String akriConnectorName, @HeaderParam("Content-Type") String contentType,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTOperations/instances/{instanceName}/akriConnectorTemplates/{akriConnectorTemplateName}/akriConnectors")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     * @param akriConnectorName Name of AkriConnector resource.
    ...
    private Mono<Response<AkriConnectorResourceInner>> getWithResponseAsync(String resourceGroupName,
        String instanceName, String akriConnectorTemplateName, String akriConnectorName) {
        ...
        if (akriConnectorName == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter akriConnectorName is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, instanceName, akriConnectorTemplateName,
                akriConnectorName, accept, context))
    ...
    private Mono<AkriConnectorResourceInner> getAsync(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName) {
        return getWithResponseAsync(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName)
    ...
    public Response<AkriConnectorResourceInner> getWithResponse(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName, Context context) {
        if (this.client.getEndpoint() == null) {
        ...
        if (akriConnectorName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter akriConnectorName is required and cannot be null."));
        }
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName, accept, context);
    }
    ...
    public AkriConnectorResourceInner get(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName) {
        return getWithResponse(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, instanceName, akriConnectorTemplateName,
                akriConnectorName, contentType, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName, AkriConnectorResourceInner resource) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, instanceName, akriConnectorTemplateName,
            akriConnectorName, contentType, accept, resource, Context.NONE);
    }
    ...
    private PollerFlux<PollResult<AkriConnectorResourceInner>, AkriConnectorResourceInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String instanceName, String akriConnectorTemplateName, String akriConnectorName,
        AkriConnectorResourceInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, instanceName,
            akriConnectorTemplateName, akriConnectorName, resource);
    ...
    public SyncPoller<PollResult<AkriConnectorResourceInner>, AkriConnectorResourceInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, instanceName,
            akriConnectorTemplateName, akriConnectorName, resource, context);
        return this.client.<AkriConnectorResourceInner, AkriConnectorResourceInner>getLroResult(response,
    ...
    private Mono<AkriConnectorResourceInner> createOrUpdateAsync(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName, AkriConnectorResourceInner resource) {
        return beginCreateOrUpdateAsync(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName,
    ...
    public AkriConnectorResourceInner createOrUpdate(String resourceGroupName, String instanceName,
        String akriConnectorTemplateName, String akriConnectorName, AkriConnectorResourceInner resource) {
        return beginCreateOrUpdate(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String instanceName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, instanceName, akriConnectorTemplateName,
            akriConnectorName, accept, Context.NONE);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String instanceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String instanceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName);
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        String akriConnectorName) {
        return beginDeleteAsync(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName).last()
    ...
    public void delete(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        String akriConnectorName) {
        beginDelete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName).getFinalResult();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String instanceName, String akriConnectorTemplateName,
        String akriConnectorName, Context context) {
        beginDelete(resourceGroupName, instanceName, akriConnectorTemplateName, akriConnectorName, context)
            .getFinalResult();
    }
