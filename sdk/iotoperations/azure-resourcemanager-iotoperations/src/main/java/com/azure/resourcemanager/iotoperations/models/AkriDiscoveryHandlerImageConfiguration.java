 ...
 */
@Fluent
public final class AkriDiscoveryHandlerImageConfiguration
    implements JsonSerializable<AkriDiscoveryHandlerImageConfiguration> {
    /*
    ...
    /**
     * Creates an instance of AkriDiscoveryHandlerImageConfiguration class.
     */
    public AkriDiscoveryHandlerImageConfiguration() {
    }
     ...
     * @return the AkriDiscoveryHandlerImageConfiguration object itself.
     */
    public AkriDiscoveryHandlerImageConfiguration withImageName(String imageName) {
     ...
     * @return the AkriDiscoveryHandlerImageConfiguration object itself.
     */
    public AkriDiscoveryHandlerImageConfiguration withImagePullPolicy(AkriConnectorsImagePullPolicy imagePullPolicy) {
     ...
     * @return the AkriDiscoveryHandlerImageConfiguration object itself.
     */
    public AkriDiscoveryHandlerImageConfiguration withReplicas(Integer replicas) {
        ...
        if (imageName() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property imageName in model AkriDiscoveryHandlerImageConfiguration"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AkriDiscoveryHandlerImageConfiguration.class);
    ...
    /**
     * Reads an instance of AkriDiscoveryHandlerImageConfiguration from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AkriDiscoveryHandlerImageConfiguration if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AkriDiscoveryHandlerImageConfiguration.
     */
    public static AkriDiscoveryHandlerImageConfiguration fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AkriDiscoveryHandlerImageConfiguration deserializedAkriDiscoveryHandlerImageConfiguration
                = new AkriDiscoveryHandlerImageConfiguration();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("imageName".equals(fieldName)) {
                    deserializedAkriDiscoveryHandlerImageConfiguration.imageName = reader.getString();
                } else if ("imagePullPolicy".equals(fieldName)) {
                    deserializedAkriDiscoveryHandlerImageConfiguration.imagePullPolicy
                        = AkriConnectorsImagePullPolicy.fromString(reader.getString());
                } else if ("replicas".equals(fieldName)) {
                    deserializedAkriDiscoveryHandlerImageConfiguration.replicas
                        = reader.getNullable(JsonReader::getInt);
                } else if ("registrySettings".equals(fieldName)) {
                    deserializedAkriDiscoveryHandlerImageConfiguration.registrySettings
                        = AkriConnectorsRegistrySettings.fromJson(reader);
                } else if ("tagDigestSettings".equals(fieldName)) {
                    deserializedAkriDiscoveryHandlerImageConfiguration.tagDigestSettings
            ...
            return deserializedAkriDiscoveryHandlerImageConfiguration;
        });
    }
}
