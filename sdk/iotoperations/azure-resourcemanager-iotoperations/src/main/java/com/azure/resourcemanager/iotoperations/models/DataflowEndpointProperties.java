...
public final class DataflowEndpointProperties implements JsonSerializable<DataflowEndpointProperties> {
     ...
     */
    private DataflowEnpointHostType hostType;
     ...
     */
    public DataflowEnpointHostType hostType() {
     ...
     * @return the DataflowEndpointProperties object itself.
     */
    public DataflowEndpointProperties withHostType(DataflowEnpointHostType hostType) {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("endpointType".equals(fieldName)) {
                    ...
                    deserializedDataflowEndpointProperties.hostType
                        = DataflowEnpointHostType.fromString(reader.getString());
