...
public final class DataflowGraphDestinationNodeSettings
     ...
     */
    private DataflowGraphSchemaSettings outputSchemaSettings;
    ...
    /**
     * Get the endpointRef property: The endpoint reference for the destination.
     * 
    ...
    /**
     * Set the endpointRef property: The endpoint reference for the destination.
     * 
     ...
     */
    public DataflowGraphSchemaSettings outputSchemaSettings() {
     ...
     */
    public DataflowGraphDestinationNodeSettings
        withOutputSchemaSettings(DataflowGraphSchemaSettings outputSchemaSettings) {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("endpointRef".equals(fieldName)) {
                    ...
                    deserializedDataflowGraphDestinationNodeSettings.outputSchemaSettings
                        = DataflowGraphSchemaSettings.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
