...
public final class DiagnosticsLogsTests {
    ...
    public void testDeserialize() throws Exception {
        DiagnosticsLogs model = BinaryData.fromString("{\"level\":\"j\"}").toObject(DiagnosticsLogs.class);
        Assertions.assertEquals("j", model.level());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        DiagnosticsLogs model = new DiagnosticsLogs().withLevel("j");
