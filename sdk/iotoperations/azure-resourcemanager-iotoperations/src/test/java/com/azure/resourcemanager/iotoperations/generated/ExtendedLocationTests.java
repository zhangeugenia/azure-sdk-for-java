...
public final class ExtendedLocationTests {
    ...
    public void testDeserialize() throws Exception {
        ExtendedLocation model = BinaryData.fromString("{\"name\":\"zfsinzgvf\",\"type\":\"CustomLocation\"}")
            .toObject(ExtendedLocation.class);
        Assertions.assertEquals("zfsinzgvf", model.name());
    ...
    public void testSerialize() throws Exception {
        ExtendedLocation model
            = new ExtendedLocation().withName("zfsinzgvf").withType(ExtendedLocationType.CUSTOM_LOCATION);
