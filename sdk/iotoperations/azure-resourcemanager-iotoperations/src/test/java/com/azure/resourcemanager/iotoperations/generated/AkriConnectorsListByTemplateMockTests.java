...
public final class AkriConnectorsListByTemplateMockTests {
    ...
    public void testListByTemplate() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Deleting\"},\"extendedLocation\":{\"name\":\"mswziq\",\"type\":\"CustomLocation\"},\"id\":\"hokzrusw\",\"name\":\"vhczznvfby\",\"type\":\"jsxjwwix\"}]}";
        ...
        PagedIterable<AkriConnectorResource> response = manager.akriConnectors()
            .listByTemplate("luxlxqzvnersby", "ucrwnami", "ze", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("mswziq", response.iterator().next().extendedLocation().name());
