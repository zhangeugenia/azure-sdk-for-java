...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CloudHealthClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CloudHealthClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CloudHealthClientOpe")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.CloudHealth/operations")
