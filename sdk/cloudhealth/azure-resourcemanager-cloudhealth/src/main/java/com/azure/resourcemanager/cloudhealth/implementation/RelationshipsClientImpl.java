...
public final class RelationshipsClientImpl implements RelationshipsClient {
     ...
     */
    RelationshipsClientImpl(CloudHealthClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CloudHealthClientRelationships to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CloudHealthClientRel")
    ...
    public Response<RelationshipInner> getWithResponse(String resourceGroupName, String healthModelName,
        String relationshipName, Context context) {
        return getWithResponseAsync(resourceGroupName, healthModelName, relationshipName, context).block();
    }
    ...
    public Response<RelationshipInner> createOrUpdateWithResponse(String resourceGroupName, String healthModelName,
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, healthModelName, relationshipName, resource, context)
            .block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String healthModelName, String relationshipName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, healthModelName, relationshipName, context).block();
    }
