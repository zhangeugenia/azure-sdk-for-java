...
import com.azure.resourcemanager.cloudhealth.implementation.CloudHealthClientBuilder;
...
public final class CloudHealthManager {
    ...
    private final CloudHealthClient clientObject;
    ...
    private CloudHealthManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new CloudHealthClientBuilder().pipeline(httpPipeline)
