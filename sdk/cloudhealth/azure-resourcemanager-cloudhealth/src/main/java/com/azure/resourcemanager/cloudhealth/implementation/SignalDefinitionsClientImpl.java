...
public final class SignalDefinitionsClientImpl implements SignalDefinitionsClient {
     ...
     */
    SignalDefinitionsClientImpl(CloudHealthClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CloudHealthClientSignalDefinitions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CloudHealthClientSig")
    ...
    public Response<SignalDefinitionInner> getWithResponse(String resourceGroupName, String healthModelName,
        String signalDefinitionName, Context context) {
        return getWithResponseAsync(resourceGroupName, healthModelName, signalDefinitionName, context).block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String healthModelName,
        String signalDefinitionName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, healthModelName, signalDefinitionName, context).block();
    }
