...
import com.azure.resourcemanager.help.implementation.models.DiscoveryResponse;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in DiscoverySolutionOperationGroupsClient.
 */
public final class DiscoverySolutionOperationGroupsClientImpl implements DiscoverySolutionOperationGroupsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final DiscoverySolutionOperationGroupsService service;
    ...
    /**
     * Initializes an instance of DiscoverySolutionOperationGroupsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    DiscoverySolutionOperationGroupsClientImpl(HelpClientImpl client) {
        this.service = RestProxy.create(DiscoverySolutionOperationGroupsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for HelpClientDiscoverySolutionOperationGroups to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HelpClientDiscoveryS")
    public interface DiscoverySolutionOperationGroupsService {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DiscoverySolutionOperationGroupsClientImpl.class);
}
