...
/**
 * An instance of this class provides access to all the operations defined in SolutionResourceSelfHelpsClient.
 */
public final class SolutionResourceSelfHelpsClientImpl implements SolutionResourceSelfHelpsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SolutionResourceSelfHelpsService service;
    ...
    /**
     * Initializes an instance of SolutionResourceSelfHelpsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SolutionResourceSelfHelpsClientImpl(HelpClientImpl client) {
        this.service = RestProxy.create(SolutionResourceSelfHelpsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for HelpClientSolutionResourceSelfHelps to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HelpClientSolutionRe")
    public interface SolutionResourceSelfHelpsService {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SolutionResourceSelfHelpsClientImpl.class);
}
