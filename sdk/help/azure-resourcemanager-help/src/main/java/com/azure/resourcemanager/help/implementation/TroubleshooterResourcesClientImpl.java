...
/**
 * An instance of this class provides access to all the operations defined in TroubleshooterResourcesClient.
 */
public final class TroubleshooterResourcesClientImpl implements TroubleshooterResourcesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TroubleshooterResourcesService service;
    ...
    /**
     * Initializes an instance of TroubleshooterResourcesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TroubleshooterResourcesClientImpl(HelpClientImpl client) {
        this.service = RestProxy.create(TroubleshooterResourcesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for HelpClientTroubleshooterResources to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HelpClientTroublesho")
    public interface TroubleshooterResourcesService {
        ...
        Mono<Response<TroubleshooterResourceInner>> create(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Content-Type") String contentType,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> continueMethod(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> continueMethodSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") ContinueRequestBody continueRequestBody, Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> end(@HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> endSync(@HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RestartTroubleshooterResponseInner>> restart(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RestartTroubleshooterResponseInner> restartSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("troubleshooterName") String troubleshooterName, @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<TroubleshooterResourceInner>> createWithResponseAsync(String scope, String troubleshooterName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(), scope,
                troubleshooterName, contentType, accept, createTroubleshooterRequestBody, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<TroubleshooterResourceInner> createWithResponse(String scope, String troubleshooterName,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getApiVersion(), scope, troubleshooterName,
            contentType, accept, createTroubleshooterRequestBody, context);
    }
    ...
    private Mono<Response<Void>> continueMethodWithResponseAsync(String scope, String troubleshooterName,
        ...
        return FluxUtil
            .withContext(context -> service.continueMethod(this.client.getEndpoint(), this.client.getApiVersion(),
                scope, troubleshooterName, accept, continueRequestBody, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public Response<Void> continueMethodWithResponse(String scope, String troubleshooterName,
        ...
        return service.continueMethodSync(this.client.getEndpoint(), this.client.getApiVersion(), scope,
            troubleshooterName, accept, continueRequestBody, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(TroubleshooterResourcesClientImpl.class);
}
