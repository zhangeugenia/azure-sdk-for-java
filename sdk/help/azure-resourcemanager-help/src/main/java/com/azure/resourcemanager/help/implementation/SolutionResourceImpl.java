...
import com.azure.resourcemanager.help.models.ReplacementMaps;
import com.azure.resourcemanager.help.models.Section;
import com.azure.resourcemanager.help.models.SolutionPatchRequestBody;
import com.azure.resourcemanager.help.models.SolutionProvisioningState;
...
public final class SolutionResourceImpl
    ...
    SolutionResourceImpl(String name, com.azure.resourcemanager.help.HelpManager serviceManager) {
    ...
    SolutionResourceImpl(SolutionResourceInner innerObject, com.azure.resourcemanager.help.HelpManager serviceManager) {
    ...
    public Response<Void> warmUpWithResponse(SolutionWarmUpRequestBody solutionWarmUpRequestBody, Context context) {
        return serviceManager.solutionResources()
            .warmUpWithResponse(scope, solutionResourceName, solutionWarmUpRequestBody, context);
    }

    public void warmUp() {
        serviceManager.solutionResources().warmUp(scope, solutionResourceName);
    }
