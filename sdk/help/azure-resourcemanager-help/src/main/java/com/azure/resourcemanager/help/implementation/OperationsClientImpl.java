...
import com.azure.resourcemanager.help.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(HelpClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HelpClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HelpClientOperations")
