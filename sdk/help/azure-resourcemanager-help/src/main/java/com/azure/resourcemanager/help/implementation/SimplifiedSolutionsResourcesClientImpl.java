...
/**
 * An instance of this class provides access to all the operations defined in SimplifiedSolutionsResourcesClient.
 */
public final class SimplifiedSolutionsResourcesClientImpl implements SimplifiedSolutionsResourcesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SimplifiedSolutionsResourcesService service;
    ...
    /**
     * Initializes an instance of SimplifiedSolutionsResourcesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SimplifiedSolutionsResourcesClientImpl(HelpClientImpl client) {
        this.service = RestProxy.create(SimplifiedSolutionsResourcesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for HelpClientSimplifiedSolutionsResources to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "HelpClientSimplified")
    public interface SimplifiedSolutionsResourcesService {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(), scope,
                simplifiedSolutionsResourceName, contentType, accept, simplifiedSolutionsRequestBody, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> createWithResponse(String scope, String simplifiedSolutionsResourceName,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getApiVersion(), scope,
            simplifiedSolutionsResourceName, contentType, accept, simplifiedSolutionsRequestBody, Context.NONE);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SimplifiedSolutionsResourcesClientImpl.class);
}
