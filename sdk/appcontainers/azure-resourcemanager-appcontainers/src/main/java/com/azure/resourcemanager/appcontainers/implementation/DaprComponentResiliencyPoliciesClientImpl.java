...
public final class DaprComponentResiliencyPoliciesClientImpl implements DaprComponentResiliencyPoliciesClient {
    ...
    public interface DaprComponentResiliencyPoliciesService {
        ...
        Mono<Response<DaprComponentResiliencyPoliciesCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DaprComponentResiliencyPolicyInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("environmentName") String environmentName,
        ...
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DaprComponentResiliencyPolicyInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("environmentName") String environmentName,
    ...
    private Mono<PagedResponse<DaprComponentResiliencyPolicyInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<DaprComponentResiliencyPolicyInner>>map(
                res ->
    ...
    private PagedFlux<DaprComponentResiliencyPolicyInner> listAsync(
        String resourceGroupName, String environmentName, String componentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DaprComponentResiliencyPolicyInner> list(
        String resourceGroupName, String environmentName, String componentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DaprComponentResiliencyPolicyInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DaprComponentResiliencyPolicyInner> getAsync(
        String resourceGroupName, String environmentName, String componentName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DaprComponentResiliencyPolicyInner> getWithResponse(
        String resourceGroupName, String environmentName, String componentName, String name, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DaprComponentResiliencyPolicyInner get(
        String resourceGroupName, String environmentName, String componentName, String name) {
     ...
     *
     * <p>Creates or updates a resiliency policy for a Dapr component.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param environmentName Name of the Managed Environment.
     * @param componentName Name of the Dapr Component.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DaprComponentResiliencyPolicyInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DaprComponentResiliencyPolicyInner> createOrUpdateAsync(
        String resourceGroupName,
        String environmentName,
        String componentName,
        String name,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, environmentName, componentName, name, daprComponentResiliencyPolicyEnvelope)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DaprComponentResiliencyPolicyInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String environmentName,
        String componentName,
        String name,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, environmentName, componentName, name, daprComponentResiliencyPolicyEnvelope, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DaprComponentResiliencyPolicyInner createOrUpdate(
        String resourceGroupName,
        String environmentName,
        String componentName,
        String name,
     ...
     *
     * <p>Delete a resiliency policy for a Dapr component.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param environmentName Name of the Managed Environment.
     * @param componentName Name of the Dapr Component.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DaprComponentResiliencyPolicyInner>> listNextSinglePageAsync(
