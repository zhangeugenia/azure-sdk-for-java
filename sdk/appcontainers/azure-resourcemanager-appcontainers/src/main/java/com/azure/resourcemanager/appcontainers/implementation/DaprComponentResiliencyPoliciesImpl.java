...
public final class DaprComponentResiliencyPoliciesImpl implements DaprComponentResiliencyPolicies {
    ...
    public DaprComponentResiliencyPoliciesImpl(
        DaprComponentResiliencyPoliciesClient innerClient,
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<DaprComponentResiliencyPolicy> list(
    ...
    public Response<DaprComponentResiliencyPolicy> getWithResponse(
    ...
    public DaprComponentResiliencyPolicy get(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'resiliencyPolicies'.", id)));
        }
