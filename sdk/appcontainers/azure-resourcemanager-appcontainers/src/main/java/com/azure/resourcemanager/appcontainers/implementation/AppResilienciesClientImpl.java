...
public final class AppResilienciesClientImpl implements AppResilienciesClient {
    ...
    public interface AppResilienciesService {
        ...
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppResiliencyInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appName") String appName,
     ...
     *
     * <p>Create or update container app resiliency policy.
     *
     ...
     *
     * <p>Update container app resiliency policy.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param appName Name of the Container App.
     * @param name Name of the resiliency policy.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResiliencyInner>> updateWithResponseAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResiliencyInner> updateAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppResiliencyInner> updateWithResponse(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResiliencyInner update(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
     ...
     *
     * <p>Delete container app resiliency policy.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param appName Name of the Container App.
     * @param name Name of the resiliency policy.
     ...
     *
     * <p>Get container app resiliency policy.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param appName Name of the Container App.
     * @param name Name of the resiliency policy.
     ...
     *
     * <p>List container app resiliency policies.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param appName Name of the Container App.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
