...
public final class DaprComponentResiliencyPolicyConfiguration {
     ...
     */
    public DaprComponentResiliencyPolicyConfiguration withHttpRetryPolicy(
        DaprComponentResiliencyPolicyHttpRetryPolicyConfiguration httpRetryPolicy) {
     ...
     * @return the DaprComponentResiliencyPolicyConfiguration object itself.
     */
    public DaprComponentResiliencyPolicyConfiguration withTimeoutPolicy(
        DaprComponentResiliencyPolicyTimeoutPolicyConfiguration timeoutPolicy) {
