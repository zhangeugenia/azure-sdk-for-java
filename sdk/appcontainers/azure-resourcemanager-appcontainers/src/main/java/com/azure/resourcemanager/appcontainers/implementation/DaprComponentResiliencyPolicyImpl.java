...
public final class DaprComponentResiliencyPolicyImpl
    ...
    public DaprComponentResiliencyPolicyImpl withExistingDaprComponent(
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, environmentName, componentName, name, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DaprComponentResiliencyPolicy create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getDaprComponentResiliencyPolicies()
                .createOrUpdateWithResponse(
                    resourceGroupName, environmentName, componentName, name, this.innerModel(), context)
                .getValue();
        return this;
    }

    DaprComponentResiliencyPolicyImpl(
    ...
    DaprComponentResiliencyPolicyImpl(
        DaprComponentResiliencyPolicyInner innerObject,
    ...
    public DaprComponentResiliencyPolicyImpl withInboundPolicy(
        DaprComponentResiliencyPolicyConfiguration inboundPolicy) {
        this.innerModel().withInboundPolicy(inboundPolicy);
        return this;
    }

    public DaprComponentResiliencyPolicyImpl withOutboundPolicy(
