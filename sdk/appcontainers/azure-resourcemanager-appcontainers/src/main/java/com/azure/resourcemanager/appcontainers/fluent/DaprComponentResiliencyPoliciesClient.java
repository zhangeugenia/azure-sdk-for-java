...
public interface DaprComponentResiliencyPoliciesClient {
    ...
    PagedIterable<DaprComponentResiliencyPolicyInner> list(
    ...
    Response<DaprComponentResiliencyPolicyInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DaprComponentResiliencyPolicyInner> createOrUpdateWithResponse(
