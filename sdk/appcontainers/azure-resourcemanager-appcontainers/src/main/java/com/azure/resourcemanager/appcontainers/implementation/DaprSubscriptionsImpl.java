...
public final class DaprSubscriptionsImpl implements DaprSubscriptions {
    ...
    public DaprSubscriptionsImpl(
        DaprSubscriptionsClient innerClient,
    ...
    public Response<DaprSubscription> getWithResponse(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'daprSubscriptions'.", id)));
        }
