...
public interface DaprSubscriptionsClient {
    ...
    PagedIterable<DaprSubscriptionInner> list(String resourceGroupName, String environmentName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DaprSubscriptionInner> list(String resourceGroupName, String environmentName, Context context);
    ...
    Response<DaprSubscriptionInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DaprSubscriptionInner> createOrUpdateWithResponse(
