...
public interface BuildersClient {
    ...
    Response<BuilderResourceInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<BuilderResourceInner>, BuilderResourceInner> beginUpdate(
