...
import com.azure.resourcemanager.databasefleetmanager.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DatabaseFleetClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseFleetClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "DatabaseFleetClientO")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.DatabaseFleetManager/operations")
