...
import com.azure.resourcemanager.databasefleetmanager.models.FleetDatabaseListResult;
...
public final class FleetDatabasesClientImpl implements FleetDatabasesClient {
     ...
     */
    FleetDatabasesClientImpl(DatabaseFleetClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseFleetClientFleetDatabases to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface FleetDatabasesService {
        ...
        Mono<Response<FleetDatabaseListResult>> listByFleetspace(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FleetDatabaseInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") FleetDatabaseInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") FleetDatabaseInner properties, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> changeTier(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") DatabaseChangeTierProperties body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> rename(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") DatabaseRenameProperties body, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, databaseName, resource,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, databaseName, properties,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, fleetName, fleetspaceName, databaseName, properties, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> changeTierWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return FluxUtil
            .withContext(context -> service.changeTier(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, databaseName, body,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> changeTierWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return service.changeTier(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, databaseName, body, accept,
            context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> renameWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return service.rename(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, fleetName, fleetspaceName, databaseName, body, accept, context);
    }
