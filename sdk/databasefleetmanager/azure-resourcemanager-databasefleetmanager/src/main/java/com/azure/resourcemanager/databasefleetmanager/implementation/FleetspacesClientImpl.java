...
public final class FleetspacesClientImpl implements FleetspacesClient {
    ...
    public interface FleetspacesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FleetspaceInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FleetspaceListResult> listByFleetSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @QueryParam("$skip") Long skip, @QueryParam("$top") Long top, @QueryParam("$skiptoken") String skiptoken,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> registerServerSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") RegisterServerProperties body,
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> unregisterSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("fleetName") String fleetName,
            @PathParam("fleetspaceName") String fleetspaceName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FleetspaceListResult> listByFleetNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a fleetspace along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<FleetspaceInner>, FleetspaceInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, fleetName, fleetspaceName, resource);
        return this.client.<FleetspaceInner, FleetspaceInner>getLroResult(response, FleetspaceInner.class,
            FleetspaceInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FleetspaceInner>, FleetspaceInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, fleetName, fleetspaceName, resource, context);
        return this.client.<FleetspaceInner, FleetspaceInner>getLroResult(response, FleetspaceInner.class,
            FleetspaceInner.class, context);
    }
    ...
    public FleetspaceInner createOrUpdate(String resourceGroupName, String fleetName, String fleetspaceName,
        FleetspaceInner resource) {
        return beginCreateOrUpdate(resourceGroupName, fleetName, fleetspaceName, resource).getFinalResult();
    }
    ...
    public FleetspaceInner createOrUpdate(String resourceGroupName, String fleetName, String fleetspaceName,
        ...
        return beginCreateOrUpdate(resourceGroupName, fleetName, fleetspaceName, resource, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<FleetspaceInner>, FleetspaceInner> beginUpdate(String resourceGroupName,
        String fleetName, String fleetspaceName, FleetspaceInner properties) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, fleetName, fleetspaceName, properties);
        return this.client.<FleetspaceInner, FleetspaceInner>getLroResult(response, FleetspaceInner.class,
            FleetspaceInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FleetspaceInner>, FleetspaceInner> beginUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, fleetName, fleetspaceName, properties, context);
        return this.client.<FleetspaceInner, FleetspaceInner>getLroResult(response, FleetspaceInner.class,
            FleetspaceInner.class, context);
    }
    ...
    public FleetspaceInner update(String resourceGroupName, String fleetName, String fleetspaceName,
        FleetspaceInner properties) {
        return beginUpdate(resourceGroupName, fleetName, fleetspaceName, properties).getFinalResult();
    }
    ...
    public FleetspaceInner update(String resourceGroupName, String fleetName, String fleetspaceName,
        FleetspaceInner properties, Context context) {
        return beginUpdate(resourceGroupName, fleetName, fleetspaceName, properties, context).getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String fleetName, String fleetspaceName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String fleetName,
        String fleetspaceName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, fleetName, fleetspaceName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String fleetName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, fleetName, fleetspaceName, context);
    ...
    public void delete(String resourceGroupName, String fleetName, String fleetspaceName) {
        beginDelete(resourceGroupName, fleetName, fleetspaceName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String fleetName, String fleetspaceName, Context context) {
        beginDelete(resourceGroupName, fleetName, fleetspaceName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a Fleetspace list operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FleetspaceInner> listByFleetSinglePage(String resourceGroupName, String fleetName, Long skip,
        ...
        final String accept = "application/json";
        Response<FleetspaceListResult> res = service.listByFleetSync(this.client.getEndpoint(),
    ...
    private PagedResponse<FleetspaceInner> listByFleetSinglePage(String resourceGroupName, String fleetName, Long skip,
        ...
        final String accept = "application/json";
        Response<FleetspaceListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> registerServerWithResponse(String resourceGroupName, String fleetName,
        String fleetspaceName, RegisterServerProperties body) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.registerServerSync(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    public SyncPoller<PollResult<Void>, Void> beginRegisterServer(String resourceGroupName, String fleetName,
        String fleetspaceName, RegisterServerProperties body) {
        Response<BinaryData> response = registerServerWithResponse(resourceGroupName, fleetName, fleetspaceName, body);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRegisterServer(String resourceGroupName, String fleetName,
        String fleetspaceName, RegisterServerProperties body, Context context) {
        Response<BinaryData> response
            = registerServerWithResponse(resourceGroupName, fleetName, fleetspaceName, body, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void registerServer(String resourceGroupName, String fleetName, String fleetspaceName,
        RegisterServerProperties body) {
        beginRegisterServer(resourceGroupName, fleetName, fleetspaceName, body).getFinalResult();
    }
    ...
    public void registerServer(String resourceGroupName, String fleetName, String fleetspaceName,
        ...
        beginRegisterServer(resourceGroupName, fleetName, fleetspaceName, body, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> unregisterWithResponse(String resourceGroupName, String fleetName,
        String fleetspaceName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginUnregister(String resourceGroupName, String fleetName,
        String fleetspaceName) {
        Response<BinaryData> response = unregisterWithResponse(resourceGroupName, fleetName, fleetspaceName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUnregister(String resourceGroupName, String fleetName,
        String fleetspaceName, Context context) {
        Response<BinaryData> response = unregisterWithResponse(resourceGroupName, fleetName, fleetspaceName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void unregister(String resourceGroupName, String fleetName, String fleetspaceName) {
        beginUnregister(resourceGroupName, fleetName, fleetspaceName).getFinalResult();
    }
    ...
    public void unregister(String resourceGroupName, String fleetName, String fleetspaceName, Context context) {
        beginUnregister(resourceGroupName, fleetName, fleetspaceName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FleetspaceInner> listByFleetNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FleetspaceInner> listByFleetNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(FleetspacesClientImpl.class);
}
