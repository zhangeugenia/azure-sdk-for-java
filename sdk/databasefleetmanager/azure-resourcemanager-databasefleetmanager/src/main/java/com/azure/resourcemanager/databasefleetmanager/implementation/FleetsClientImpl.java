...
import com.azure.resourcemanager.databasefleetmanager.models.FleetListResult;
...
public final class FleetsClientImpl implements FleetsClient {
     ...
     */
    FleetsClientImpl(DatabaseFleetClientImpl client) {
        this.service = RestProxy.create(FleetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DatabaseFleetClientFleets to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
