...
import com.azure.resourcemanager.databasefleetmanager.models.FirewallRuleListResult;
...
public final class FirewallRulesClientImpl implements FirewallRulesClient {
     ...
     */
    FirewallRulesClientImpl(DatabaseFleetClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseFleetClientFirewallRules to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface FirewallRulesService {
        ...
        Mono<Response<FirewallRuleListResult>> listByFleetspace(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String fleetName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, fleetName, fleetspaceName, firewallRuleName, resource,
            accept, context);
    }
