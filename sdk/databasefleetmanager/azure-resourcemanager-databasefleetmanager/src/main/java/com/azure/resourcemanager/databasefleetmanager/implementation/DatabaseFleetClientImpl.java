...
/**
 * Initializes a new instance of the DatabaseFleetClientImpl type.
 */
@ServiceClient(builder = DatabaseFleetClientBuilder.class)
public final class DatabaseFleetClientImpl implements DatabaseFleetClient {
    /**
    ...
    /**
     * Initializes an instance of DatabaseFleetClient client.
     * 
     ...
     */
    DatabaseFleetClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DatabaseFleetClientImpl.class);
}
