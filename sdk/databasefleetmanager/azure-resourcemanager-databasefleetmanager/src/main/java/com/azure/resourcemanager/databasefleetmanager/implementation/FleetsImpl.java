...
public final class FleetsImpl implements Fleets {
    ...
    public PagedIterable<Fleet> listByResourceGroup(String resourceGroupName, Long skip, Long top, String skiptoken,
        Context context) {
        PagedIterable<FleetInner> inner
            = this.serviceClient().listByResourceGroup(resourceGroupName, skip, top, skiptoken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new FleetImpl(inner1, this.manager()));
    }
