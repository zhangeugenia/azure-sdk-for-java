...
public final class FirewallRulesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"startIpAddress\":\"k\",\"endIpAddress\":\"mpew\",\"provisioningState\":\"Provisioning\"},\"id\":\"krvrns\",\"name\":\"shqjohxcrsbf\",\"type\":\"vasrruvwb\"}";
        ...
        FirewallRule response = manager.firewallRules()
            .getWithResponse("ivetvtcq", "qtdo", "mcbxvwvxysl", "bhsfxob", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("k", response.properties().startIpAddress());
        Assertions.assertEquals("mpew", response.properties().endIpAddress());
    }
}
