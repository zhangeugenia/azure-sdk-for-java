 ...
 */
@Fluent
public final class IntegrationAccountPartnerInner extends ProxyResource {
    /*
    ...
    /**
     * Get the properties property: The integration account partner properties.
     * 
    ...
    /**
     * Set the properties property: The integration account partner properties.
     * 
     * @param properties the properties value to set.
     * @return the IntegrationAccountPartnerInner object itself.
     */
    public IntegrationAccountPartnerInner withProperties(IntegrationAccountPartnerProperties properties) {
        ...
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property properties in model IntegrationAccountPartnerInner"));
        } else {
            properties().validate();
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedIntegrationAccountPartnerInner.properties
                        = IntegrationAccountPartnerProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedIntegrationAccountPartnerInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
