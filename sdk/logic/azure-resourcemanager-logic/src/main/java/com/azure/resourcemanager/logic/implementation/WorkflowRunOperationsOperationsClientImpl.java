...
/**
 * An instance of this class provides access to all the operations defined in WorkflowRunOperationsOperationsClient.
 */
public final class WorkflowRunOperationsOperationsClientImpl implements WorkflowRunOperationsOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WorkflowRunOperationsOperationsService service;
    ...
    /**
     * Initializes an instance of WorkflowRunOperationsOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WorkflowRunOperationsOperationsClientImpl(LogicManagementClientImpl client) {
        this.service = RestProxy.create(WorkflowRunOperationsOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientWorkflowRunOperationsOperations to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface WorkflowRunOperationsOperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/runs/{runName}/operations/{operationId}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{workflowName}/{runName}/{operationId}")
    ...
    private Mono<Response<WorkflowRunInner>> getWithResponseAsync(String resourceGroupName, String workflowName,
        ...
        return FluxUtil.withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, workflowName, runName, operationId, accept, context))
    ...
    private Mono<Response<WorkflowRunInner>> getWithResponseAsync(String resourceGroupName, String workflowName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, workflowName, runName, operationId, accept, context);
    }
