...
/**
 * An instance of this class provides access to all the operations defined in RequestHistoriesClient.
 */
public final class RequestHistoriesClientImpl implements RequestHistoriesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final RequestHistoriesService service;
    ...
    /**
     * Initializes an instance of RequestHistoriesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    RequestHistoriesClientImpl(LogicManagementClientImpl client) {
        this.service
            = RestProxy.create(RequestHistoriesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientRequestHistories to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface RequestHistoriesService {
    ...
    private Mono<Response<RequestHistoryInner>> getWithResponseAsync(String resourceGroupName, String workflowName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, workflowName, runName, actionName, repetitionName, requestHistoryName, accept, context);
    }
    ...
    public RequestHistoryInner get(String resourceGroupName, String workflowName, String runName, String actionName,
        ...
        return getWithResponse(resourceGroupName, workflowName, runName, actionName, repetitionName, requestHistoryName,
