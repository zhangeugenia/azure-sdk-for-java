 ...
 */
public final class WorkflowRunsOperationsClientImpl implements WorkflowRunsOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WorkflowRunsOperationsService service;
    ...
    /**
     * Initializes an instance of WorkflowRunsOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WorkflowRunsOperationsClientImpl(LogicManagementClientImpl client) {
        this.service = RestProxy.create(WorkflowRunsOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientWorkflowRunsOperations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface WorkflowRunsOperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/runs/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{workflowName}")
    ...
    private Mono<PagedResponse<WorkflowRunInner>> listSinglePageAsync(String resourceGroupName, String workflowName,
    ...
    private PagedFlux<WorkflowRunInner> listAsync(String resourceGroupName, String workflowName, Integer top,
        String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<WorkflowRunInner> list(String resourceGroupName, String workflowName, Integer top,
        String filter, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a WorkflowRun list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
