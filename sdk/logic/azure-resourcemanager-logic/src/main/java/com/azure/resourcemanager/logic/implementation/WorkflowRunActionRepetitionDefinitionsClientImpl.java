 ...
 * WorkflowRunActionRepetitionDefinitionsClient.
 */
public final class WorkflowRunActionRepetitionDefinitionsClientImpl
    implements WorkflowRunActionRepetitionDefinitionsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WorkflowRunActionRepetitionDefinitionsService service;
    ...
    /**
     * Initializes an instance of WorkflowRunActionRepetitionDefinitionsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WorkflowRunActionRepetitionDefinitionsClientImpl(LogicManagementClientImpl client) {
        this.service = RestProxy.create(WorkflowRunActionRepetitionDefinitionsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientWorkflowRunActionRepetitionDefinitions to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface WorkflowRunActionRepetitionDefinitionsService {
