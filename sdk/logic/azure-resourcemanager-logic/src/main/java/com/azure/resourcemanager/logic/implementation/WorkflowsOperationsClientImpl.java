...
/**
 * An instance of this class provides access to all the operations defined in WorkflowsOperationsClient.
 */
public final class WorkflowsOperationsClientImpl implements WorkflowsOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WorkflowsOperationsService service;
    ...
    /**
     * Initializes an instance of WorkflowsOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WorkflowsOperationsClientImpl(LogicManagementClientImpl client) {
        this.service = RestProxy.create(WorkflowsOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientWorkflowsOperations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface WorkflowsOperationsService {
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/locations/{location}/workflows/{workflowName}/validate/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/locations/{location}/{workflowName}/validateByLocation")
