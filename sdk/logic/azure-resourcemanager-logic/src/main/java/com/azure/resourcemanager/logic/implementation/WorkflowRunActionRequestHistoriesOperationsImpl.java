...
public final class WorkflowRunActionRequestHistoriesOperationsImpl
    implements WorkflowRunActionRequestHistoriesOperations {
    private static final ClientLogger LOGGER = new ClientLogger(WorkflowRunActionRequestHistoriesOperationsImpl.class);

    private final WorkflowRunActionRequestHistoriesOperationsClient innerClient;

    private final com.azure.resourcemanager.logic.LogicManager serviceManager;

    public WorkflowRunActionRequestHistoriesOperationsImpl(
        WorkflowRunActionRequestHistoriesOperationsClient innerClient,
    ...
    private WorkflowRunActionRequestHistoriesOperationsClient serviceClient() {
