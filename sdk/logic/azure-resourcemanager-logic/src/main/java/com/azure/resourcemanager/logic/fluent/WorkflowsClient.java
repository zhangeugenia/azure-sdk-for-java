...
public interface WorkflowsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<WorkflowInner> updateWithResponse(String resourceGroupName, String workflowName, Object properties,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    WorkflowInner update(String resourceGroupName, String workflowName, Object properties);
