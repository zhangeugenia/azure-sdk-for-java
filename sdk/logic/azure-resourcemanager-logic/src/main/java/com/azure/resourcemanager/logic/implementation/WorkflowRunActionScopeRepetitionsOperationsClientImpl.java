 ...
 * WorkflowRunActionScopeRepetitionsOperationsClient.
 */
public final class WorkflowRunActionScopeRepetitionsOperationsClientImpl
    implements WorkflowRunActionScopeRepetitionsOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WorkflowRunActionScopeRepetitionsOperationsService service;
    ...
    /**
     * Initializes an instance of WorkflowRunActionScopeRepetitionsOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WorkflowRunActionScopeRepetitionsOperationsClientImpl(LogicManagementClientImpl client) {
        this.service = RestProxy.create(WorkflowRunActionScopeRepetitionsOperationsService.class,
            client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LogicManagementClientWorkflowRunActionScopeRepetitionsOperations to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "LogicManagementClien")
    public interface WorkflowRunActionScopeRepetitionsOperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/runs/{runName}/actions/{actionName}/scopeRepetitions/{repetitionName}/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{workflowName}/{runName}/{actionName}/{repetitionName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/workflows/{workflowName}/runs/{runName}/actions/{actionName}/scopeRepetitions/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{workflowName}/{runName}/{actionName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
