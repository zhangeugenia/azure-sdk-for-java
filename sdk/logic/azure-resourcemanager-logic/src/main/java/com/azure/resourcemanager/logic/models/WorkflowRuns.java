...
public interface WorkflowRuns {
     ...
     */
    PagedIterable<WorkflowRun> list(String resourceGroupName, String workflowName, String runName);
     ...
     * @return a list of workflow runs as paginated response with {@link PagedIterable}.
     */
    PagedIterable<WorkflowRun> list(String resourceGroupName, String workflowName, String runName, Integer top,
