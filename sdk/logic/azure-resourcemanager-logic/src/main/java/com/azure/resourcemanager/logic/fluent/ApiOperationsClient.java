...
public interface ApiOperationsClient {
    ...
    PagedIterable<ApiOperationInner> list(String integrationServiceEnvironmentName, String apiName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ApiOperationInner> list(String integrationServiceEnvironmentName, String apiName, Context context);
}
