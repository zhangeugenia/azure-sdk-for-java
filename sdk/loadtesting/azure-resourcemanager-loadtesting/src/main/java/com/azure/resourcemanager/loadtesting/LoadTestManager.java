...
import com.azure.resourcemanager.loadtesting.fluent.LoadTestMgmtClient;
import com.azure.resourcemanager.loadtesting.implementation.LoadTestMgmtClientBuilder;
import com.azure.resourcemanager.loadtesting.implementation.ResourceProvidersImpl;
...
public final class LoadTestManager {
    ...
    private final LoadTestMgmtClient clientObject;
    ...
    private LoadTestManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new LoadTestMgmtClientBuilder().pipeline(httpPipeline)
    ...
    /**
     * Creates an instance of Load Test service API entry point.
     * 
     * @param credential the credential to use.
     * @param profile the Azure profile for client.
     * @return the Load Test service API instance.
     */
    ...
    /**
     * Gets the resource collection API of ResourceProviders. It manages LoadTestResource.
     * 
    ...
    /**
     * Gets wrapped service client LoadTestMgmtClient providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client LoadTestMgmtClient.
     */
    public LoadTestMgmtClient serviceClient() {
