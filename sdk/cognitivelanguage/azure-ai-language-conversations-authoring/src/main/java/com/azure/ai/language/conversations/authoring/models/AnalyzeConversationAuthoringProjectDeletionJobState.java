 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringProjectDeletionJobState
    implements JsonSerializable<AnalyzeConversationAuthoringProjectDeletionJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringProjectDeletionJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringProjectDeletionJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringProjectDeletionJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringProjectDeletionJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringProjectDeletionJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringProjectDeletionJobState fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringProjectDeletionJobState deserializedAnalyzeConversationAuthoringProjectDeletionJobState
                = new AnalyzeConversationAuthoringProjectDeletionJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringProjectDeletionJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringProjectDeletionJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringProjectDeletionJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringProjectDeletionJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringProjectDeletionJobState;
        });
    }
}
