 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringExportedTrainedModel
    implements JsonSerializable<AnalyzeConversationAuthoringExportedTrainedModel> {
    /*
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringExportedTrainedModel class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringExportedTrainedModel(String modelId, OffsetDateTime lastTrainedDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringExportedTrainedModel from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringExportedTrainedModel if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringExportedTrainedModel.
     */
    @Generated
    public static AnalyzeConversationAuthoringExportedTrainedModel fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringExportedTrainedModel deserializedAnalyzeConversationAuthoringExportedTrainedModel
                = new AnalyzeConversationAuthoringExportedTrainedModel(modelId, lastTrainedDateTime,
                    lastExportedModelDateTime, modelExpirationDate, modelTrainingConfigVersion);
            deserializedAnalyzeConversationAuthoringExportedTrainedModel.exportedModelName = exportedModelName;

            return deserializedAnalyzeConversationAuthoringExportedTrainedModel;
        });
    }
}
