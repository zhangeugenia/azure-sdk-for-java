 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringDeploymentResourcesJobState
    implements JsonSerializable<AnalyzeConversationAuthoringDeploymentResourcesJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringDeploymentResourcesJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringDeploymentResourcesJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringDeploymentResourcesJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringDeploymentResourcesJobState if the JsonReader was pointing to
     * an instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringDeploymentResourcesJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringDeploymentResourcesJobState fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringDeploymentResourcesJobState deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState
                = new AnalyzeConversationAuthoringDeploymentResourcesJobState(createdDateTime, lastUpdatedDateTime,
                    status);
            deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringDeploymentResourcesJobState;
        });
    }
}
