 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState
    implements JsonSerializable<AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState if the JsonReader was
     ...
     */
    @Generated
    public static AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState
                = new AnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState(createdDateTime,
                    lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState.expirationDateTime
                = expirationDateTime;
            deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringDeploymentDeleteFromResourcesJobState;
        });
    }
}
