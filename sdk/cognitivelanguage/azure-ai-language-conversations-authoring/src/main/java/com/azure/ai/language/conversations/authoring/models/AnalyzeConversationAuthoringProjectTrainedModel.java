 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringProjectTrainedModel
    implements JsonSerializable<AnalyzeConversationAuthoringProjectTrainedModel> {
    /*
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringProjectTrainedModel class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringProjectTrainedModel(String modelId, OffsetDateTime lastTrainedDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringProjectTrainedModel from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringProjectTrainedModel if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringProjectTrainedModel.
     */
    @Generated
    public static AnalyzeConversationAuthoringProjectTrainedModel fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringProjectTrainedModel deserializedAnalyzeConversationAuthoringProjectTrainedModel
                = new AnalyzeConversationAuthoringProjectTrainedModel(modelId, lastTrainedDateTime,
                    lastTrainingDurationInSeconds, modelExpirationDate, modelTrainingConfigVersion, hasSnapshot);
            deserializedAnalyzeConversationAuthoringProjectTrainedModel.label = label;

            return deserializedAnalyzeConversationAuthoringProjectTrainedModel;
        });
    }
}
