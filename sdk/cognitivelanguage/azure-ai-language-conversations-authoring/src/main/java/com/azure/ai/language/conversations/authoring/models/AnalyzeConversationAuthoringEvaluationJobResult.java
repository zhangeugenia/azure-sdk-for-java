...
/**
 * The AnalyzeConversationAuthoringEvaluationJobResult model.
 */
@Immutable
public final class AnalyzeConversationAuthoringEvaluationJobResult
    implements JsonSerializable<AnalyzeConversationAuthoringEvaluationJobResult> {
    /*
     * Represents the options used running the evaluation.
     */
    @Generated
    private final AnalyzeConversationAuthoringEvaluationOptions evaluationOptions;
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringEvaluationJobResult class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringEvaluationJobResult(
        AnalyzeConversationAuthoringEvaluationOptions evaluationOptions, String modelLabel,
        String trainingConfigVersion, int percentComplete) {
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringEvaluationJobResult from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringEvaluationJobResult if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringEvaluationJobResult.
     */
    @Generated
    public static AnalyzeConversationAuthoringEvaluationJobResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new AnalyzeConversationAuthoringEvaluationJobResult(evaluationOptions, modelLabel,
                trainingConfigVersion, percentComplete);
        });
    }
}
