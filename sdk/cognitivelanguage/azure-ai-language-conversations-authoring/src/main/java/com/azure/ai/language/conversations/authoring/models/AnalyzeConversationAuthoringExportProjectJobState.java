 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringExportProjectJobState
    implements JsonSerializable<AnalyzeConversationAuthoringExportProjectJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringExportProjectJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringExportProjectJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringExportProjectJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringExportProjectJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringExportProjectJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringExportProjectJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringExportProjectJobState deserializedAnalyzeConversationAuthoringExportProjectJobState
                = new AnalyzeConversationAuthoringExportProjectJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringExportProjectJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringExportProjectJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringExportProjectJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringExportProjectJobState.errors = errors;
            deserializedAnalyzeConversationAuthoringExportProjectJobState.resultUrl = resultUrl;

            return deserializedAnalyzeConversationAuthoringExportProjectJobState;
        });
    }
}
