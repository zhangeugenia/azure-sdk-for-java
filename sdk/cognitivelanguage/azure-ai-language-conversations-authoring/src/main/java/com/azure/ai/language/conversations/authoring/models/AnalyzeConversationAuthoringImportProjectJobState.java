 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringImportProjectJobState
    implements JsonSerializable<AnalyzeConversationAuthoringImportProjectJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringImportProjectJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringImportProjectJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringImportProjectJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringImportProjectJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringImportProjectJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringImportProjectJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringImportProjectJobState deserializedAnalyzeConversationAuthoringImportProjectJobState
                = new AnalyzeConversationAuthoringImportProjectJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringImportProjectJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringImportProjectJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringImportProjectJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringImportProjectJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringImportProjectJobState;
        });
    }
}
