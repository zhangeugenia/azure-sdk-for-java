 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringDeploymentJobState
    implements JsonSerializable<AnalyzeConversationAuthoringDeploymentJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringDeploymentJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringDeploymentJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringDeploymentJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringDeploymentJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringDeploymentJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringDeploymentJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringDeploymentJobState deserializedAnalyzeConversationAuthoringDeploymentJobState
                = new AnalyzeConversationAuthoringDeploymentJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringDeploymentJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringDeploymentJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringDeploymentJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringDeploymentJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringDeploymentJobState;
        });
    }
}
