 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringExportedModelJobState
    implements JsonSerializable<AnalyzeConversationAuthoringExportedModelJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringExportedModelJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringExportedModelJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringExportedModelJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringExportedModelJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringExportedModelJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringExportedModelJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringExportedModelJobState deserializedAnalyzeConversationAuthoringExportedModelJobState
                = new AnalyzeConversationAuthoringExportedModelJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringExportedModelJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringExportedModelJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringExportedModelJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringExportedModelJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringExportedModelJobState;
        });
    }
}
