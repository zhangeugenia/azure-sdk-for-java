 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions
    implements JsonSerializable<AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions> {
    /*
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions class.
     * 
     * @param assignedResourceIds the assignedResourceIds value to set.
     */
    @Generated
    public AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions(List<String> assignedResourceIds) {
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions if the JsonReader was
     ...
     */
    @Generated
    public static AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new AnalyzeConversationAuthoringUnassignDeploymentResourcesOptions(assignedResourceIds);
        });
    }
}
