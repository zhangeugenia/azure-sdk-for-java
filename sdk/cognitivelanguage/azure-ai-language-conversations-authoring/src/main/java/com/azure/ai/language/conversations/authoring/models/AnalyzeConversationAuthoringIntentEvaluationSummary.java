 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringIntentEvaluationSummary
    implements JsonSerializable<AnalyzeConversationAuthoringIntentEvaluationSummary> {
    /*
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringIntentEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringIntentEvaluationSummary(double f1, double precision, double recall,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringIntentEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringIntentEvaluationSummary if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringIntentEvaluationSummary.
     */
    @Generated
    public static AnalyzeConversationAuthoringIntentEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new AnalyzeConversationAuthoringIntentEvaluationSummary(f1, precision, recall, truePositiveCount,
