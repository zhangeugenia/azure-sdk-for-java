 ...
 */
@Immutable
public final class ExportedModelOptions implements JsonSerializable<ExportedModelOptions> {
    /*
    ...
    /**
     * Creates an instance of ExportedModelOptions class.
     * 
     * @param trainedModelLabel the trainedModelLabel value to set.
     */
    @Generated
    public ExportedModelOptions(String trainedModelLabel) {
    ...
    /**
     * Reads an instance of ExportedModelOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ExportedModelOptions if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ExportedModelOptions.
     */
    @Generated
    public static ExportedModelOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new ExportedModelOptions(trainedModelLabel);
        });
    }
}
