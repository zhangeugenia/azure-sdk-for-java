 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringCopyProjectJobState
    implements JsonSerializable<AnalyzeConversationAuthoringCopyProjectJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringCopyProjectJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringCopyProjectJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringCopyProjectJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringCopyProjectJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringCopyProjectJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringCopyProjectJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringCopyProjectJobState deserializedAnalyzeConversationAuthoringCopyProjectJobState
                = new AnalyzeConversationAuthoringCopyProjectJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringCopyProjectJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringCopyProjectJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringCopyProjectJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringCopyProjectJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringCopyProjectJobState;
        });
    }
}
