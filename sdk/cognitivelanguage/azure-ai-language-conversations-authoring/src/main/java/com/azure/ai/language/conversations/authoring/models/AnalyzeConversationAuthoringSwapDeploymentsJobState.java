 ...
 */
@Immutable
public final class AnalyzeConversationAuthoringSwapDeploymentsJobState
    implements JsonSerializable<AnalyzeConversationAuthoringSwapDeploymentsJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of AnalyzeConversationAuthoringSwapDeploymentsJobState class.
     * 
     ...
     */
    @Generated
    private AnalyzeConversationAuthoringSwapDeploymentsJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Reads an instance of AnalyzeConversationAuthoringSwapDeploymentsJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AnalyzeConversationAuthoringSwapDeploymentsJobState if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AnalyzeConversationAuthoringSwapDeploymentsJobState.
     */
    @Generated
    public static AnalyzeConversationAuthoringSwapDeploymentsJobState fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AnalyzeConversationAuthoringSwapDeploymentsJobState deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState
                = new AnalyzeConversationAuthoringSwapDeploymentsJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState.jobId = jobId;
            deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState.expirationDateTime = expirationDateTime;
            deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState.warnings = warnings;
            deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState.errors = errors;

            return deserializedAnalyzeConversationAuthoringSwapDeploymentsJobState;
        });
    }
}
