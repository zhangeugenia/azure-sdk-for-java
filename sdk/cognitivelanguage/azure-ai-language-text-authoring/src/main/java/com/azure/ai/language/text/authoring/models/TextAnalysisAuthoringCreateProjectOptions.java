 ...
 */
@Fluent
public final class TextAnalysisAuthoringCreateProjectOptions
    implements JsonSerializable<TextAnalysisAuthoringCreateProjectOptions> {
    /*
     * The project kind.
     */
    @Generated
    ...
    static {
        JsonMergePatchHelper.setTextAnalysisAuthoringCreateProjectOptionsAccessor(
            new JsonMergePatchHelper.TextAnalysisAuthoringCreateProjectOptionsAccessor() {
                @Override
                public TextAnalysisAuthoringCreateProjectOptions prepareModelForJsonMergePatch(
                    TextAnalysisAuthoringCreateProjectOptions model, boolean jsonMergePatchEnabled) {
                    model.serializeAsJsonMergePatch(jsonMergePatchEnabled);
                    return model;
                }

                @Override
                public boolean isJsonMergePatch(TextAnalysisAuthoringCreateProjectOptions model) {
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringCreateProjectOptions class.
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions() {
    }
     ...
     * @return the TextAnalysisAuthoringCreateProjectOptions object itself.
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setProjectKind(ProjectKind projectKind) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setStorageInputContainerName(String storageInputContainerName) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setSettings(ProjectSettings settings) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setProjectName(String projectName) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setMultilingual(Boolean multilingual) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setDescription(String description) {
     ...
     */
    @Generated
    public TextAnalysisAuthoringCreateProjectOptions setLanguage(String language) {
    ...
    private JsonWriter toJsonMergePatch(JsonWriter jsonWriter) throws IOException {
        ...
        if (updatedProperties.contains("settings")) {
            if (this.settings == null) {
                ...
                JsonMergePatchHelper.getProjectSettingsAccessor().prepareModelForJsonMergePatch(this.settings, true);
                jsonWriter.writeJsonField("settings", this.settings);
                JsonMergePatchHelper.getProjectSettingsAccessor().prepareModelForJsonMergePatch(this.settings, false);
            }
        }
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringCreateProjectOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringCreateProjectOptions if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringCreateProjectOptions.
     */
    @Generated
    public static TextAnalysisAuthoringCreateProjectOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            TextAnalysisAuthoringCreateProjectOptions deserializedTextAnalysisAuthoringCreateProjectOptions
                = new TextAnalysisAuthoringCreateProjectOptions();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("projectKind".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.projectKind
                        = ProjectKind.fromString(reader.getString());
                } else if ("storageInputContainerName".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.storageInputContainerName
                        = reader.getString();
                } else if ("settings".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.settings = ProjectSettings.fromJson(reader);
                } else if ("projectName".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.projectName = reader.getString();
                } else if ("multilingual".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.multilingual
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("description".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.description = reader.getString();
                } else if ("language".equals(fieldName)) {
                    deserializedTextAnalysisAuthoringCreateProjectOptions.language = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedTextAnalysisAuthoringCreateProjectOptions;
        });
    }
}
