 ...
 */
@Immutable
public final class TextAnalysisAuthoringAssignedProjectDeploymentMetadata
    implements JsonSerializable<TextAnalysisAuthoringAssignedProjectDeploymentMetadata> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringAssignedProjectDeploymentMetadata class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringAssignedProjectDeploymentMetadata(String deploymentName,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringAssignedProjectDeploymentMetadata from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringAssignedProjectDeploymentMetadata if the JsonReader was pointing to
     * an instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringAssignedProjectDeploymentMetadata.
     */
    @Generated
    public static TextAnalysisAuthoringAssignedProjectDeploymentMetadata fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringAssignedProjectDeploymentMetadata(deploymentName, lastDeployedDateTime,
                deploymentExpirationDate);
        });
    }
}
