 ...
 */
@Immutable
public final class TextAnalysisAuthoringSwapDeploymentsOptions
    implements JsonSerializable<TextAnalysisAuthoringSwapDeploymentsOptions> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringSwapDeploymentsOptions class.
     * 
     ...
     */
    @Generated
    public TextAnalysisAuthoringSwapDeploymentsOptions(String firstDeploymentName, String secondDeploymentName) {
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringSwapDeploymentsOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringSwapDeploymentsOptions if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringSwapDeploymentsOptions.
     */
    @Generated
    public static TextAnalysisAuthoringSwapDeploymentsOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringSwapDeploymentsOptions(firstDeploymentName, secondDeploymentName);
        });
    }
}
