 ...
 */
@Immutable
public final class TextAnalysisAuthoringProjectDeployment
    implements JsonSerializable<TextAnalysisAuthoringProjectDeployment> {
    /*
     ...
     */
    @Generated
    private final List<TextAnalysisAuthoringDeploymentResource> assignedResources;

    /**
     * Creates an instance of TextAnalysisAuthoringProjectDeployment class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringProjectDeployment(String modelId, OffsetDateTime lastTrainedDateTime,
        OffsetDateTime lastDeployedDateTime, LocalDate deploymentExpirationDate, String modelTrainingConfigVersion,
        List<TextAnalysisAuthoringDeploymentResource> assignedResources) {
     ...
     */
    @Generated
    public List<TextAnalysisAuthoringDeploymentResource> getAssignedResources() {
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringProjectDeployment from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringProjectDeployment if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringProjectDeployment.
     */
    @Generated
    public static TextAnalysisAuthoringProjectDeployment fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            List<TextAnalysisAuthoringDeploymentResource> assignedResources = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("deploymentName".equals(fieldName)) {
                    ...
                    assignedResources
                        = reader.readArray(reader1 -> TextAnalysisAuthoringDeploymentResource.fromJson(reader1));
                } else {
                    reader.skipChildren();
                }
            }
            TextAnalysisAuthoringProjectDeployment deserializedTextAnalysisAuthoringProjectDeployment
                = new TextAnalysisAuthoringProjectDeployment(modelId, lastTrainedDateTime, lastDeployedDateTime,
                    deploymentExpirationDate, modelTrainingConfigVersion, assignedResources);
            deserializedTextAnalysisAuthoringProjectDeployment.deploymentName = deploymentName;

            return deserializedTextAnalysisAuthoringProjectDeployment;
        });
    }
}
