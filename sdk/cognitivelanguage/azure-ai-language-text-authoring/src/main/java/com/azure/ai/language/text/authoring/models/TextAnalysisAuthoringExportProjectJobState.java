 ...
 */
@Immutable
public final class TextAnalysisAuthoringExportProjectJobState
    implements JsonSerializable<TextAnalysisAuthoringExportProjectJobState> {
    /*
     * The job ID.
     */
    @Generated
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringExportProjectJobState class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringExportProjectJobState(OffsetDateTime createdDateTime,
    ...
    /**
     * Get the resultUrl property: The URL to use in order to download the exported project.
     * 
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringExportProjectJobState from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringExportProjectJobState if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringExportProjectJobState.
     */
    @Generated
    public static TextAnalysisAuthoringExportProjectJobState fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            TextAnalysisAuthoringExportProjectJobState deserializedTextAnalysisAuthoringExportProjectJobState
                = new TextAnalysisAuthoringExportProjectJobState(createdDateTime, lastUpdatedDateTime, status);
            deserializedTextAnalysisAuthoringExportProjectJobState.jobId = jobId;
            deserializedTextAnalysisAuthoringExportProjectJobState.expirationDateTime = expirationDateTime;
            deserializedTextAnalysisAuthoringExportProjectJobState.warnings = warnings;
            deserializedTextAnalysisAuthoringExportProjectJobState.errors = errors;
            deserializedTextAnalysisAuthoringExportProjectJobState.resultUrl = resultUrl;

            return deserializedTextAnalysisAuthoringExportProjectJobState;
        });
    }
}
