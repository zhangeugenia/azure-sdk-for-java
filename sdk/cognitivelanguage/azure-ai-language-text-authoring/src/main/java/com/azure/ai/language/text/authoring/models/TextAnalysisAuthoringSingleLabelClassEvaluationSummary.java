 ...
 */
@Immutable
public final class TextAnalysisAuthoringSingleLabelClassEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringSingleLabelClassEvaluationSummary> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringSingleLabelClassEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringSingleLabelClassEvaluationSummary(double f1, double precision, double recall,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringSingleLabelClassEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringSingleLabelClassEvaluationSummary if the JsonReader was pointing to
     * an instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringSingleLabelClassEvaluationSummary.
     */
    @Generated
    public static TextAnalysisAuthoringSingleLabelClassEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringSingleLabelClassEvaluationSummary(f1, precision, recall, truePositiveCount,
