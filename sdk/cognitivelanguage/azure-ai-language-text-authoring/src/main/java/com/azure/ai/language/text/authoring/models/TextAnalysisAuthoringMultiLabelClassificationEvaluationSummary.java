 ...
 */
@Immutable
public final class TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary> {
    /*
     * Represents the classes evaluation
     */
    @Generated
    private final Map<String, TextAnalysisAuthoringMultiLabelClassEvaluationSummary> classes;
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary(
        Map<String, TextAnalysisAuthoringMultiLabelClassEvaluationSummary> classes, double microF1,
     ...
     */
    @Generated
    public Map<String, TextAnalysisAuthoringMultiLabelClassEvaluationSummary> getClasses() {
        return this.classes;
    }
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary if the JsonReader was
     ...
     */
    @Generated
    public static TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            Map<String, TextAnalysisAuthoringMultiLabelClassEvaluationSummary> classes = null;
            double microF1 = 0.0;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("classes".equals(fieldName)) {
                    classes = reader
                        .readMap(reader1 -> TextAnalysisAuthoringMultiLabelClassEvaluationSummary.fromJson(reader1));
            ...
            return new TextAnalysisAuthoringMultiLabelClassificationEvaluationSummary(classes, microF1, microPrecision,
                microRecall, macroF1, macroPrecision, macroRecall);
        });
    }
}
