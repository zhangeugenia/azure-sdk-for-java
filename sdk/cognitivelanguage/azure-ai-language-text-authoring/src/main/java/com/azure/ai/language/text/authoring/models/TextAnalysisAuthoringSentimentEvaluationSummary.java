 ...
 */
@Immutable
public final class TextAnalysisAuthoringSentimentEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringSentimentEvaluationSummary> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringSentimentEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringSentimentEvaluationSummary(double f1, double precision, double recall,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringSentimentEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringSentimentEvaluationSummary if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringSentimentEvaluationSummary.
     */
    @Generated
    public static TextAnalysisAuthoringSentimentEvaluationSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringSentimentEvaluationSummary(f1, precision, recall, truePositiveCount,
