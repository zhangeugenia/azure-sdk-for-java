 ...
 */
@Fluent
public final class TextAnalysisAuthoringCreateDeploymentOptions
    implements JsonSerializable<TextAnalysisAuthoringCreateDeploymentOptions> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringCreateDeploymentOptions class.
     * 
     * @param trainedModelLabel the trainedModelLabel value to set.
     */
    @Generated
    public TextAnalysisAuthoringCreateDeploymentOptions(String trainedModelLabel) {
     ...
     * @return the TextAnalysisAuthoringCreateDeploymentOptions object itself.
     */
    @Generated
    public TextAnalysisAuthoringCreateDeploymentOptions setAssignedResourceIds(List<String> assignedResourceIds) {
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringCreateDeploymentOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringCreateDeploymentOptions if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringCreateDeploymentOptions.
     */
    @Generated
    public static TextAnalysisAuthoringCreateDeploymentOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            TextAnalysisAuthoringCreateDeploymentOptions deserializedTextAnalysisAuthoringCreateDeploymentOptions
                = new TextAnalysisAuthoringCreateDeploymentOptions(trainedModelLabel);
            deserializedTextAnalysisAuthoringCreateDeploymentOptions.assignedResourceIds = assignedResourceIds;

            return deserializedTextAnalysisAuthoringCreateDeploymentOptions;
        });
    }
}
