 ...
 */
@Immutable
public final class TextAnalysisAuthoringEntityRecognitionEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringEntityRecognitionEvaluationSummary> {
    /*
     ...
     */
    @Generated
    private final Map<String, TextAnalysisAuthoringEntityEvaluationSummary> entities;
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringEntityRecognitionEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringEntityRecognitionEvaluationSummary(
        TextAnalysisAuthoringConfusionMatrix confusionMatrix,
        Map<String, TextAnalysisAuthoringEntityEvaluationSummary> entities, double microF1, double microPrecision,
    ...
    /**
     * Get the entities property: Represents the entities evaluation.
     * 
     * @return the entities value.
     */
    @Generated
    public Map<String, TextAnalysisAuthoringEntityEvaluationSummary> getEntities() {
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringEntityRecognitionEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringEntityRecognitionEvaluationSummary if the JsonReader was pointing to
     * an instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringEntityRecognitionEvaluationSummary.
     */
    @Generated
    public static TextAnalysisAuthoringEntityRecognitionEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            TextAnalysisAuthoringConfusionMatrix confusionMatrix = null;
            Map<String, TextAnalysisAuthoringEntityEvaluationSummary> entities = null;
            double microF1 = 0.0;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("confusionMatrix".equals(fieldName)) {
                    ...
                    entities
                        = reader.readMap(reader1 -> TextAnalysisAuthoringEntityEvaluationSummary.fromJson(reader1));
            ...
            return new TextAnalysisAuthoringEntityRecognitionEvaluationSummary(confusionMatrix, entities, microF1,
