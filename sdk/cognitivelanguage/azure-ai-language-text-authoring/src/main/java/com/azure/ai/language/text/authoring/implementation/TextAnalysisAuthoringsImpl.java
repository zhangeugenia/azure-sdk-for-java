...
/**
 * An instance of this class provides access to all the operations defined in TextAnalysisAuthorings.
 */
public final class TextAnalysisAuthoringsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TextAnalysisAuthoringsService service;
    ...
    /**
     * Initializes an instance of TextAnalysisAuthoringsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TextAnalysisAuthoringsImpl(AuthoringClientImpl client) {
        this.service = RestProxy.create(TextAnalysisAuthoringsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for AuthoringClientTextAnalysisAuthorings to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{Endpoint}/language")
    @ServiceInterface(name = "AuthoringClientTextA")
    public interface TextAnalysisAuthoringsService {
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getExportedModelManifest(@HostParam("Endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("projectName") String projectName,
            @PathParam("exportedModelName") String exportedModelName, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getExportedModelManifestSync(@HostParam("Endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("projectName") String projectName,
            @PathParam("exportedModelName") String exportedModelName, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> listAssignedResourceDeploymentsNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> listAssignedResourceDeploymentsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getSupportedLanguagesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getSupportedPrebuiltEntitiesNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getSupportedPrebuiltEntitiesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> listTrainingConfigVersionsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("Endpoint") String endpoint,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    }
     ...
     * @return paged collection of TextAnalysisAuthoringProjectMetadata items along with {@link PagedResponse} on
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringProjectMetadata items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringProjectDeletionJobState, Void>
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringProjectDeletionJobState.class),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringProjectDeletionJobState, Void>
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringCopyProjectJobState, Void> beginCopyProjectWithModelAsync(String projectName,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringCopyProjectJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringCopyProjectJobState, Void> beginCopyProjectWithModel(String projectName,
        BinaryData body, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.copyProjectWithResponse(projectName, body, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringExportProjectJobState, Void> beginExportWithModelAsync(String projectName,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringExportProjectJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringExportProjectJobState, Void> beginExportWithModel(String projectName,
        String stringIndexType, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.exportWithResponse(projectName, stringIndexType, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringImportProjectJobState, Void>
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringImportProjectJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringImportProjectJobState, Void> beginImportMethodWithModel(String projectName,
        BinaryData body, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.importMethodWithResponse(projectName, body, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
    ...
    public PollerFlux<BinaryData, BinaryData> beginTrainAsync(String projectName, BinaryData body,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new com.azure.ai.language.text.authoring.implementation.OperationLocationPollingStrategy<>(
    ...
    public SyncPoller<BinaryData, BinaryData> beginTrain(String projectName, BinaryData body,
        ...
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            ...
            new com.azure.ai.language.text.authoring.implementation.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.client.getHttpPipeline())
                    .setEndpoint("{Endpoint}/language".replace("{Endpoint}", this.client.getEndpoint()))
                    .setContext(requestOptions != null && requestOptions.getContext() != null
                        ? requestOptions.getContext()
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new com.azure.ai.language.text.authoring.implementation.OperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.client.getHttpPipeline())
                    ...
                    .setServiceVersion(this.client.getServiceVersion().getVersion()),
                "result"),
            TypeReference.createInstance(TextAnalysisAuthoringTrainingJobState.class),
            TypeReference.createInstance(TextAnalysisAuthoringTrainingJobResult.class));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringProjectDeployment items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringProjectDeployment items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringDeploymentJobState, Void> beginDeployProjectWithModelAsync(
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringDeploymentJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringDeploymentJobState, Void> beginDeployProjectWithModel(String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringDeploymentJobState, Void>
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringDeploymentJobState, Void> beginDeleteDeploymentWithModel(String projectName,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringDeploymentDeleteFromResourcesJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringSwapDeploymentsJobState, Void>
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringSwapDeploymentsJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringSwapDeploymentsJobState, Void>
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringExportedTrainedModel items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringExportedTrainedModel items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringExportedModelJobState, Void> beginCreateOrUpdateExportedModelWithModelAsync(
        String projectName, String exportedModelName, BinaryData body, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.createOrUpdateExportedModelWithResponseAsync(projectName, exportedModelName, body,
                requestOptions),
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringExportedModelJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringExportedModelJobState, Void> beginCreateOrUpdateExportedModelWithModel(
        String projectName, String exportedModelName, BinaryData body, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.createOrUpdateExportedModelWithResponse(projectName, exportedModelName, body, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringExportedModelJobState, Void> beginDeleteExportedModelWithModelAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringExportedModelJobState, Void>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getExportedModelManifestWithResponseAsync(String projectName,
        String exportedModelName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getExportedModelManifest(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), projectName, exportedModelName, accept, requestOptions,
            context));
    }
    ...
    public Response<BinaryData> getExportedModelManifestWithResponse(String projectName, String exportedModelName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getExportedModelManifestSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), projectName, exportedModelName, accept, requestOptions,
            Context.NONE);
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringProjectTrainedModel items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringProjectTrainedModel items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new com.azure.ai.language.text.authoring.implementation.OperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.client.getHttpPipeline())
                    ...
                    .setServiceVersion(this.client.getServiceVersion().getVersion()),
                "result"),
            TypeReference.createInstance(TextAnalysisAuthoringEvaluationJobState.class),
            TypeReference.createInstance(TextAnalysisAuthoringEvaluationJobResult.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringLoadSnapshotJobState, Void>
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringLoadSnapshotJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringLoadSnapshotJobState, Void> beginLoadSnapshotWithModel(String projectName,
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringAssignedDeploymentResource items along with
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringAssignDeploymentResourcesJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<TextAnalysisAuthoringUnassignDeploymentResourcesJobState, Void>
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new DefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
                ...
                .setContext(requestOptions != null && requestOptions.getContext() != null
                    ...
                    : Context.NONE)
                .setServiceVersion(this.client.getServiceVersion().getVersion())),
            TypeReference.createInstance(TextAnalysisAuthoringUnassignDeploymentResourcesJobState.class),
            TypeReference.createInstance(Void.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TextAnalysisAuthoringUnassignDeploymentResourcesJobState, Void>
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringTrainingJobState items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringTrainingJobState items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringAssignedProjectDeploymentsMetadata items along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>>
        listAssignedResourceDeploymentsSinglePageAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listAssignedResourceDeployments(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> listAssignedResourceDeploymentsAsync(RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedFlux<>((pageSize) -> {
            ...
            return listAssignedResourceDeploymentsSinglePageAsync(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return listAssignedResourceDeploymentsNextSinglePageAsync(nextLink, requestOptionsLocal);
        });
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listAssignedResourceDeploymentsSinglePage(RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listAssignedResourceDeploymentsSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
    ...
    public PagedIterable<BinaryData> listAssignedResourceDeployments(RequestOptions requestOptions) {
        ...
        return new PagedIterable<>((pageSize) -> {
            ...
            return listAssignedResourceDeploymentsSinglePage(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return listAssignedResourceDeploymentsNextSinglePage(nextLink, requestOptionsLocal);
        });
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringSupportedLanguage items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> getSupportedLanguagesSinglePageAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getSupportedLanguages(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
    ...
    public PagedFlux<BinaryData> getSupportedLanguagesAsync(RequestOptions requestOptions) {
        ...
        return new PagedFlux<>((pageSize) -> {
            ...
            return getSupportedLanguagesSinglePageAsync(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return getSupportedLanguagesNextSinglePageAsync(nextLink, requestOptionsLocal);
        });
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringSupportedLanguage items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> getSupportedLanguagesSinglePage(RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getSupportedLanguagesSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
    ...
    public PagedIterable<BinaryData> getSupportedLanguages(RequestOptions requestOptions) {
        ...
        return new PagedIterable<>((pageSize) -> {
            ...
            return getSupportedLanguagesSinglePage(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return getSupportedLanguagesNextSinglePage(nextLink, requestOptionsLocal);
        });
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringPrebuiltEntity items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> getSupportedPrebuiltEntitiesSinglePageAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getSupportedPrebuiltEntities(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> getSupportedPrebuiltEntitiesAsync(RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedFlux<>(() -> getSupportedPrebuiltEntitiesSinglePageAsync(requestOptions),
            nextLink -> getSupportedPrebuiltEntitiesNextSinglePageAsync(nextLink, requestOptionsForNextPage));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringPrebuiltEntity items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> getSupportedPrebuiltEntitiesSinglePage(RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getSupportedPrebuiltEntitiesSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
    ...
    public PagedIterable<BinaryData> getSupportedPrebuiltEntities(RequestOptions requestOptions) {
        ...
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedIterable<>(() -> getSupportedPrebuiltEntitiesSinglePage(requestOptions),
            nextLink -> getSupportedPrebuiltEntitiesNextSinglePage(nextLink, requestOptionsForNextPage));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringTrainingConfigVersion items along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listTrainingConfigVersionsSinglePageAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listTrainingConfigVersions(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
    ...
    public PagedFlux<BinaryData> listTrainingConfigVersionsAsync(RequestOptions requestOptions) {
        ...
        return new PagedFlux<>((pageSize) -> {
            ...
            return listTrainingConfigVersionsSinglePageAsync(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return listTrainingConfigVersionsNextSinglePageAsync(nextLink, requestOptionsLocal);
        });
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringTrainingConfigVersion items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listTrainingConfigVersionsSinglePage(RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listTrainingConfigVersionsSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
    ...
    public PagedIterable<BinaryData> listTrainingConfigVersions(RequestOptions requestOptions) {
        ...
        return new PagedIterable<>((pageSize) -> {
            ...
            return listTrainingConfigVersionsSinglePage(requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
            ...
            return listTrainingConfigVersionsNextSinglePage(nextLink, requestOptionsLocal);
        });
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of TextAnalysisAuthoringDocumentEvaluationResult items along with {@link PagedResponse}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listAssignedResourceDeploymentsNextSinglePageAsync(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listAssignedResourceDeploymentsNext(nextLink, this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listAssignedResourceDeploymentsNextSinglePage(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listAssignedResourceDeploymentsNextSync(nextLink, this.client.getEndpoint(),
            accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> getSupportedLanguagesNextSinglePageAsync(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getSupportedLanguagesNext(nextLink, this.client.getEndpoint(), accept,
                requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> getSupportedLanguagesNextSinglePage(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getSupportedLanguagesNextSync(nextLink, this.client.getEndpoint(), accept,
            requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> getSupportedPrebuiltEntitiesNextSinglePageAsync(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getSupportedPrebuiltEntitiesNext(nextLink, this.client.getEndpoint(),
                accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> getSupportedPrebuiltEntitiesNextSinglePage(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getSupportedPrebuiltEntitiesNextSync(nextLink, this.client.getEndpoint(),
            accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listTrainingConfigVersionsNextSinglePageAsync(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listTrainingConfigVersionsNext(nextLink, this.client.getEndpoint(), accept,
                requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listTrainingConfigVersionsNextSinglePage(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listTrainingConfigVersionsNextSync(nextLink, this.client.getEndpoint(),
            accept, requestOptions, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null);
    }
