 ...
 */
@Immutable
public final class TextAnalysisAuthoringCopyProjectOptions
    implements JsonSerializable<TextAnalysisAuthoringCopyProjectOptions> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringCopyProjectOptions class.
     * 
     ...
     */
    @Generated
    public TextAnalysisAuthoringCopyProjectOptions(ProjectKind projectKind, String targetProjectName,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringCopyProjectOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringCopyProjectOptions if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringCopyProjectOptions.
     */
    @Generated
    public static TextAnalysisAuthoringCopyProjectOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringCopyProjectOptions(projectKind, targetProjectName, accessToken, expiresAt,
                targetResourceId, targetResourceRegion);
        });
    }
}
