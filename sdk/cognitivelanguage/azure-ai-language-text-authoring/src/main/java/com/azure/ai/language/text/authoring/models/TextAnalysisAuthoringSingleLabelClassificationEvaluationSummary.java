 ...
 */
@Immutable
public final class TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary> {
    /*
     * Represents the confusion matrix between two classes (the two classes can be the same). The matrix is between the
     * class that was labelled and the class that was predicted.
     */
    @Generated
     ...
     */
    @Generated
    private final Map<String, TextAnalysisAuthoringSingleLabelClassEvaluationSummary> classes;
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary(
        TextAnalysisAuthoringConfusionMatrix confusionMatrix,
        Map<String, TextAnalysisAuthoringSingleLabelClassEvaluationSummary> classes, double microF1,
    ...
    /**
     * Get the confusionMatrix property: Represents the confusion matrix between two classes (the two classes can be the
     * same). The matrix is between the class that was labelled and the class that was predicted.
     * 
    ...
    /**
     * Get the classes property: Represents the classes evaluation.
     * 
     * @return the classes value.
     */
    @Generated
    public Map<String, TextAnalysisAuthoringSingleLabelClassEvaluationSummary> getClasses() {
        return this.classes;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeMapField("classes", this.classes, (writer, element) -> writer.writeJson(element));
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary if the JsonReader was
     ...
     */
    @Generated
    public static TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            TextAnalysisAuthoringConfusionMatrix confusionMatrix = null;
            Map<String, TextAnalysisAuthoringSingleLabelClassEvaluationSummary> classes = null;
            double microF1 = 0.0;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("confusionMatrix".equals(fieldName)) {
                    ...
                    classes = reader
                        .readMap(reader1 -> TextAnalysisAuthoringSingleLabelClassEvaluationSummary.fromJson(reader1));
            ...
            return new TextAnalysisAuthoringSingleLabelClassificationEvaluationSummary(confusionMatrix, classes,
                microF1, microPrecision, microRecall, macroF1, macroPrecision, macroRecall);
        });
    }
}
