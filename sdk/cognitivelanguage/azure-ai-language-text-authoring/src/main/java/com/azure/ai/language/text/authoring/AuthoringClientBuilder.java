...
import com.azure.ai.language.text.authoring.implementation.AuthoringClientImpl;
...
public final class AuthoringClientBuilder implements HttpTrait<AuthoringClientBuilder>,
    ConfigurationTrait<AuthoringClientBuilder>, TokenCredentialTrait<AuthoringClientBuilder>,
    KeyCredentialTrait<AuthoringClientBuilder>, EndpointTrait<AuthoringClientBuilder> {
    @Generated
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("azure-ai-language-text-authoring.properties");
    ...
    public AuthoringAsyncClient buildAsyncClient() {
        return new AuthoringAsyncClient(buildInnerClient().getTextAnalysisAuthorings());
    }
    ...
    public AuthoringClient buildClient() {
        return new AuthoringClient(buildInnerClient().getTextAnalysisAuthorings());
    }
