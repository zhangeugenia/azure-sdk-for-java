 ...
 */
@Immutable
public final class TextAnalysisAuthoringEntityEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringEntityEvaluationSummary> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringEntityEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringEntityEvaluationSummary(double f1, double precision, double recall,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringEntityEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringEntityEvaluationSummary if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringEntityEvaluationSummary.
     */
    @Generated
    public static TextAnalysisAuthoringEntityEvaluationSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringEntityEvaluationSummary(f1, precision, recall, truePositiveCount,
