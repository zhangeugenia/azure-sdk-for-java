 ...
 */
@Immutable
public final class TextAnalysisAuthoringMultiLabelClassEvaluationSummary
    implements JsonSerializable<TextAnalysisAuthoringMultiLabelClassEvaluationSummary> {
    /*
    ...
    /**
     * Creates an instance of TextAnalysisAuthoringMultiLabelClassEvaluationSummary class.
     * 
     ...
     */
    @Generated
    private TextAnalysisAuthoringMultiLabelClassEvaluationSummary(double f1, double precision, double recall,
    ...
    /**
     * Reads an instance of TextAnalysisAuthoringMultiLabelClassEvaluationSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TextAnalysisAuthoringMultiLabelClassEvaluationSummary if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TextAnalysisAuthoringMultiLabelClassEvaluationSummary.
     */
    @Generated
    public static TextAnalysisAuthoringMultiLabelClassEvaluationSummary fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TextAnalysisAuthoringMultiLabelClassEvaluationSummary(f1, precision, recall, truePositiveCount,
