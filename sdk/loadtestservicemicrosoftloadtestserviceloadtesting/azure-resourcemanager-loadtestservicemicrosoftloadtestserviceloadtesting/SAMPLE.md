...
public final class LoadTestsListSamples {
    /*
     * x-ms-original-file:
     * specification/loadtestservice/resource-manager/Microsoft.LoadTestService/loadtesting/stable/2022-12-01/examples/
    ...
    public static void listLoadTestResourceResourcesBySubscriptionID(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
...
public final class LoadTestsDeleteSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void deleteALoadTestResource(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
...
public final class LoadTestsGetByResourceGroupSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void getALoadTestResource(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
...
public final class QuotasListSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void listQuotasForAGivenSubscriptionId(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
...
public final class LoadTestsUpdateSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void updateALoadTestResource(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
...
public final class LoadTestsCreateOrUpdateSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void createALoadTestResource(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
        manager.loadTests()
            .define("myLoadTest")
...
public final class LoadTestsListByResourceGroupSamples {
     ...
     * @param manager Entry point to LoadTestManager.
     */
    public static void listLoadTestResourceResourcesByResourceGroup(
        com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceloadtesting.LoadTestManager manager) {
