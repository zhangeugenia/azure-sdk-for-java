...
public final class SharedGalleryImageVersionsClientImpl implements SharedGalleryImageVersionsClient {
    ...
    public interface SharedGalleryImageVersionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageVersionList> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("galleryUniqueName") String galleryUniqueName,
            @PathParam("galleryImageName") String galleryImageName, @QueryParam("sharedTo") SharedToValues sharedTo,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageVersionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("galleryUniqueName") String galleryUniqueName,
            @PathParam("galleryImageName") String galleryImageName,
            @PathParam("galleryImageVersionName") String galleryImageVersionName, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageVersionList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Shared Gallery Image versions operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageVersionInner> listSinglePage(String location, String galleryUniqueName,
        String galleryImageName, SharedToValues sharedTo) {
        if (this.client.getEndpoint() == null) {
        ...
        if (galleryUniqueName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter galleryUniqueName is required and cannot be null."));
        }
        if (galleryImageName == null) {
            throw LOGGER.atError()
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<SharedGalleryImageVersionList> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, apiVersion,
                galleryUniqueName, galleryImageName, sharedTo, accept, Context.NONE);
    ...
    private PagedResponse<SharedGalleryImageVersionInner> listSinglePage(String location, String galleryUniqueName,
        ...
        Response<SharedGalleryImageVersionList> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, apiVersion,
                galleryUniqueName, galleryImageName, sharedTo, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SharedGalleryImageVersionInner> list(String location, String galleryUniqueName,
        String galleryImageName) {
        final SharedToValues sharedTo = null;
        return new PagedIterable<>(() -> listSinglePage(location, galleryUniqueName, galleryImageName, sharedTo),
    ...
    public PagedIterable<SharedGalleryImageVersionInner> list(String location, String galleryUniqueName,
        ...
        return new PagedIterable<>(
            () -> listSinglePage(location, galleryUniqueName, galleryImageName, sharedTo, context),
    ...
    public Response<SharedGalleryImageVersionInner> getWithResponse(String location, String galleryUniqueName,
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageVersionInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageVersionInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SharedGalleryImageVersionsClientImpl.class);
}
