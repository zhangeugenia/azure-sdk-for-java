...
public final class RestorePointCollectionsClientImpl implements RestorePointCollectionsClient {
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String restorePointCollectionName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            restorePointCollectionName, apiVersion, accept, Context.NONE);
    }
    ...
    private PagedResponse<RestorePointCollectionInner> listSinglePage() {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<RestorePointCollectionListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List restore point collection operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
