...
public final class GalleryScriptList implements JsonSerializable<GalleryScriptList> {
    ...
    /*
     * The uri to fetch the next page of Script Definitions in the Gallery. Call ListNext() with this to fetch the next
     * page of gallery Script Definitions.
     */
    ...
    /**
     * Get the value property: A list of Gallery Scripts.
     * 
    ...
    /**
     * Set the value property: A list of Gallery Scripts.
     * 
    ...
    /**
     * Get the nextLink property: The uri to fetch the next page of Script Definitions in the Gallery. Call ListNext()
     * with this to fetch the next page of gallery Script Definitions.
     * 
    ...
    /**
     * Set the nextLink property: The uri to fetch the next page of Script Definitions in the Gallery. Call ListNext()
     * with this to fetch the next page of gallery Script Definitions.
     * 
