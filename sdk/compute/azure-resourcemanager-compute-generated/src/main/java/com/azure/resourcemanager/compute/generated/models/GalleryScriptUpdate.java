...
public final class GalleryScriptUpdate extends UpdateResourceDefinition {
     ...
     */
    public GalleryScriptUpdate withProperties(GalleryScriptProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedGalleryScriptUpdate.properties = GalleryScriptProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
