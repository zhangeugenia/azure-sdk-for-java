...
public final class VirtualMachineScaleSetVMExtensionsClientImpl implements VirtualMachineScaleSetVMExtensionsClient {
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            vmExtensionName, apiVersion, this.client.getSubscriptionId(), extensionParameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            vmExtensionName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<VirtualMachineScaleSetVMExtensionInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            vmExtensionName, expand, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<VirtualMachineScaleSetVMExtensionsListResultInner> listWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, expand,
