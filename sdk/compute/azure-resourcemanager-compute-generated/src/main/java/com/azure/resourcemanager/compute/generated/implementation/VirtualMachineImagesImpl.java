...
public final class VirtualMachineImagesImpl implements VirtualMachineImages {
    ...
    public PagedIterable<VirtualMachineImage> listWithProperties(String location, String publisherName, String offer,
        String skus, Expand expand) {
        PagedIterable<VirtualMachineImageInner> inner
            = this.serviceClient().listWithProperties(location, publisherName, offer, skus, expand);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new VirtualMachineImageImpl(inner1, this.manager()));
    }

    public PagedIterable<VirtualMachineImage> listWithProperties(String location, String publisherName, String offer,
        String skus, Expand expand, Integer top, String orderby, Context context) {
        PagedIterable<VirtualMachineImageInner> inner = this.serviceClient()
            .listWithProperties(location, publisherName, offer, skus, expand, top, orderby, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new VirtualMachineImageImpl(inner1, this.manager()));
    }
