...
public final class CapacityReservationsClientImpl implements CapacityReservationsClient {
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, capacityReservationGroupName,
            capacityReservationName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String capacityReservationGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, capacityReservationGroupName,
            capacityReservationName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String capacityReservationGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, capacityReservationGroupName,
            capacityReservationName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<CapacityReservationInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, capacityReservationGroupName,
            capacityReservationName, expand, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private PagedResponse<CapacityReservationInner> listByCapacityReservationGroupSinglePage(String resourceGroupName,
        ...
        Response<CapacityReservationListResult> res
            = service.listByCapacityReservationGroupSync(this.client.getEndpoint(), resourceGroupName,
                capacityReservationGroupName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
