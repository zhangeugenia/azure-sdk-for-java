...
public final class GalleryImageImpl implements GalleryImage, GalleryImage.Definition, GalleryImage.Update {
    ...
    public Boolean allowUpdateImage() {
        return this.innerModel().allowUpdateImage();
    }
    ...
    public GalleryImageImpl withAllowUpdateImage(Boolean allowUpdateImage) {
        if (isInCreateMode()) {
            this.innerModel().withAllowUpdateImage(allowUpdateImage);
            return this;
        } else {
            this.updateGalleryImage.withAllowUpdateImage(allowUpdateImage);
            return this;
        }
    }
