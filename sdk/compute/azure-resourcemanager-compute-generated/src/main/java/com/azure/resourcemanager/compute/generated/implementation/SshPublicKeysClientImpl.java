...
public final class SshPublicKeysClientImpl implements SshPublicKeysClient {
    ...
    private PagedResponse<SshPublicKeyResourceInner> listSinglePage() {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<SshPublicKeysGroupListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    public Response<SshPublicKeyResourceInner> createWithResponse(String resourceGroupName, String sshPublicKeyName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, sshPublicKeyName, apiVersion,
    ...
    public Response<SshPublicKeyResourceInner> updateWithResponse(String resourceGroupName, String sshPublicKeyName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, sshPublicKeyName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String sshPublicKeyName, Context context) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, sshPublicKeyName, apiVersion,
    ...
    public Response<SshPublicKeyResourceInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, sshPublicKeyName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<SshPublicKeyGenerateKeyPairResultInner> generateKeyPairWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.generateKeyPairSync(this.client.getEndpoint(), resourceGroupName, sshPublicKeyName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
