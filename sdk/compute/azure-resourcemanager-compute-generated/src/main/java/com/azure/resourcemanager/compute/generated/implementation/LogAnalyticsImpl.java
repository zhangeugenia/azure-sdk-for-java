...
public final class LogAnalyticsImpl implements LogAnalytics {
    ...
    public LogAnalyticsOperationResult exportThrottledRequests(String location, ThrottledRequestsInput body) {
        LogAnalyticsOperationResultInner inner = this.serviceClient().exportThrottledRequests(location, body);
        if (inner != null) {
            return new LogAnalyticsOperationResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LogAnalyticsOperationResult exportThrottledRequests(String location, ThrottledRequestsInput body,
        Context context) {
        LogAnalyticsOperationResultInner inner = this.serviceClient().exportThrottledRequests(location, body, context);
        if (inner != null) {
            return new LogAnalyticsOperationResultImpl(inner, this.manager());
        } else {
            return null;
