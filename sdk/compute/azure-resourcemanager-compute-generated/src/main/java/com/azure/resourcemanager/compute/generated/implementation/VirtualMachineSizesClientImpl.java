...
public final class VirtualMachineSizesClientImpl implements VirtualMachineSizesClient {
    ...
    private PagedResponse<VirtualMachineSizeInner> listSinglePage(String location) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<VirtualMachineSizeListResult> res = service.listSync(this.client.getEndpoint(), location, apiVersion,
    ...
    public PagedIterable<VirtualMachineSizeInner> list(String location) {
        return new PagedIterable<>(() -> listSinglePage(location));
    }
