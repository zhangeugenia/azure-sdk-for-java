...
public final class AvailabilitySetsClientImpl implements AvailabilitySetsClient {
    ...
    public Response<AvailabilitySetInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, availabilitySetName, apiVersion,
    ...
    public Response<AvailabilitySetInner> updateWithResponse(String resourceGroupName, String availabilitySetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, availabilitySetName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String availabilitySetName, Context context) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, availabilitySetName, apiVersion,
    ...
    public Response<AvailabilitySetInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, availabilitySetName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private PagedResponse<AvailabilitySetInner> listSinglePage(String expand) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<AvailabilitySetListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
    ...
    private PagedResponse<VirtualMachineSizeInner> listAvailableSizesSinglePage(String resourceGroupName,
        ...
        Response<VirtualMachineSizeListResult> res = service.listAvailableSizesSync(this.client.getEndpoint(),
            resourceGroupName, availabilitySetName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            null, null);
    }
    ...
    public Response<Void> startMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.startMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(), resourceGroupName,
            availabilitySetName, apiVersion, this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    public Response<Void> cancelMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.cancelMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(), resourceGroupName,
            availabilitySetName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<Void> validateMigrationToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.validateMigrationToVirtualMachineScaleSetSync(this.client.getEndpoint(), resourceGroupName,
            availabilitySetName, apiVersion, this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    private Response<BinaryData> convertToVirtualMachineScaleSetWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.convertToVirtualMachineScaleSetSync(this.client.getEndpoint(), resourceGroupName,
            availabilitySetName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
