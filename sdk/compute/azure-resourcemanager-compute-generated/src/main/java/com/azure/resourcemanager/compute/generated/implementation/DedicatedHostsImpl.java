...
public final class DedicatedHostsImpl implements DedicatedHosts {
    ...
    public DedicatedHost restart(String resourceGroupName, String hostGroupName, String hostname) {
        DedicatedHostInner inner = this.serviceClient().restart(resourceGroupName, hostGroupName, hostname);
        if (inner != null) {
            return new DedicatedHostImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DedicatedHost restart(String resourceGroupName, String hostGroupName, String hostname, Context context) {
        DedicatedHostInner inner = this.serviceClient().restart(resourceGroupName, hostGroupName, hostname, context);
        if (inner != null) {
            return new DedicatedHostImpl(inner, this.manager());
        } else {
            return null;
