...
public final class GalleryInVMAccessControlProfilesClientImpl implements GalleryInVMAccessControlProfilesClient {
    ...
    public interface GalleryInVMAccessControlProfilesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryInVMAccessControlProfileInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @PathParam("inVMAccessControlProfileName") String inVMAccessControlProfileName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryInVMAccessControlProfileList> listByGallerySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryInVMAccessControlProfileList> listByGalleryNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String galleryName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, inVMAccessControlProfileName, apiVersion, galleryInVMAccessControlProfile, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryInVMAccessControlProfileInner>, GalleryInVMAccessControlProfileInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, galleryName,
            inVMAccessControlProfileName, galleryInVMAccessControlProfile);
        return this.client.<GalleryInVMAccessControlProfileInner, GalleryInVMAccessControlProfileInner>getLroResult(
            response, GalleryInVMAccessControlProfileInner.class, GalleryInVMAccessControlProfileInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryInVMAccessControlProfileInner>, GalleryInVMAccessControlProfileInner>
        ...
        return this.client.<GalleryInVMAccessControlProfileInner, GalleryInVMAccessControlProfileInner>getLroResult(
            response, GalleryInVMAccessControlProfileInner.class, GalleryInVMAccessControlProfileInner.class, context);
    }
    ...
    public GalleryInVMAccessControlProfileInner createOrUpdate(String resourceGroupName, String galleryName,
        ...
        return beginCreateOrUpdate(resourceGroupName, galleryName, inVMAccessControlProfileName,
            galleryInVMAccessControlProfile).getFinalResult();
    }
    ...
    public GalleryInVMAccessControlProfileInner createOrUpdate(String resourceGroupName, String galleryName,
        ...
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, inVMAccessControlProfileName,
            galleryInVMAccessControlProfile, context).getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String galleryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, inVMAccessControlProfileName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, galleryName, inVMAccessControlProfileName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        String inVMAccessControlProfileName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, galleryName, inVMAccessControlProfileName, context);
    ...
    public void delete(String resourceGroupName, String galleryName, String inVMAccessControlProfileName) {
        beginDelete(resourceGroupName, galleryName, inVMAccessControlProfileName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String galleryName, String inVMAccessControlProfileName,
        Context context) {
        beginDelete(resourceGroupName, galleryName, inVMAccessControlProfileName, context).getFinalResult();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Gallery InVMAccessControlProfiles operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInVMAccessControlProfileInner> listByGallerySinglePage(String resourceGroupName,
        String galleryName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GalleryInVMAccessControlProfileList> res = service.listByGallerySync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInVMAccessControlProfileInner> listByGalleryNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<GalleryInVMAccessControlProfileList> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(GalleryInVMAccessControlProfilesClientImpl.class);
}
