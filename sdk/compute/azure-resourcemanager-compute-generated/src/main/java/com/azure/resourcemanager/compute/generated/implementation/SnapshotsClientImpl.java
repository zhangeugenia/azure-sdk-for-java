...
public final class SnapshotsClientImpl implements SnapshotsClient {
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String snapshotName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            snapshotName, apiVersion, snapshot, accept, Context.NONE);
    }
    ...
    public Response<SnapshotInner> getByResourceGroupWithResponse(String resourceGroupName, String snapshotName,
        ...
        return service.getByResourceGroupSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, snapshotName, apiVersion, accept, context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String snapshotName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            snapshotName, apiVersion, Context.NONE);
    }
    ...
    private PagedResponse<SnapshotInner> listSinglePage() {
        ...
        final String apiVersion = "2024-03-02";
        final String accept = "application/json";
        Response<SnapshotList> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Response<BinaryData> grantAccessWithResponse(String resourceGroupName, String snapshotName,
        ...
        return service.grantAccessSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            snapshotName, apiVersion, grantAccessData, accept, Context.NONE);
    }
