...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
    ...
    private Response<BinaryData> reimageWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.reimageSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, apiVersion,
            this.client.getSubscriptionId(), vmScaleSetVMReimageInput, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> reimageAllWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.reimageAllSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
    ...
    private Response<BinaryData> approveRollingUpgradeWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        return service.approveRollingUpgradeSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName,
            instanceId, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deallocateWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.deallocateSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, apiVersion,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId,
        ...
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            forceDeletion, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<VirtualMachineScaleSetVMInner> getWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, expand,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<VirtualMachineScaleSetVMInstanceViewInner> getInstanceViewWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getInstanceViewSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private PagedResponse<VirtualMachineScaleSetVMInner> listSinglePage(String resourceGroupName,
        ...
        Response<VirtualMachineScaleSetVMListResult> res
            = service.listSync(this.client.getEndpoint(), resourceGroupName, virtualMachineScaleSetName, filter, select,
                expand, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    ...
    private Response<BinaryData> powerOffWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.powerOffSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            skipShutdown, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    private Response<BinaryData> powerOffWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String accept = "application/json";
        return service.powerOffSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            skipShutdown, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Response<BinaryData> restartWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.restartSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, apiVersion,
    ...
    private Response<BinaryData> startWithResponse(String resourceGroupName, String vmScaleSetName, String instanceId) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.startSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId, apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    private Response<BinaryData> redeployWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.redeploySync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<RetrieveBootDiagnosticsDataResultInner> retrieveBootDiagnosticsDataWithResponse(
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.retrieveBootDiagnosticsDataSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName,
    ...
    private Response<BinaryData> performMaintenanceWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.performMaintenanceSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<Void> simulateEvictionWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.simulateEvictionSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Response<BinaryData> attachDetachDataDisksWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.attachDetachDataDisksSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName,
            instanceId, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> attachDetachDataDisksWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String accept = "application/json";
        return service.attachDetachDataDisksSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName,
            instanceId, this.client.getSubscriptionId(), apiVersion, parameters, accept, context);
    }
    ...
    private Response<BinaryData> runCommandWithResponse(String resourceGroupName, String vmScaleSetName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.runCommandSync(this.client.getEndpoint(), resourceGroupName, vmScaleSetName, instanceId,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Virtual Machine Scale Set VMs operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
