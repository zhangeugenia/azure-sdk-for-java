...
public final class CloudServicesUpdateDomainsClientImpl implements CloudServicesUpdateDomainsClient {
    ...
    public interface CloudServicesUpdateDomainsService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<BinaryData> walkUpdateDomainSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName, @PathParam("updateDomain") int updateDomain,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateDomainInner parameters, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<UpdateDomainInner> getUpdateDomainSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName, @PathParam("updateDomain") int updateDomain,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<UpdateDomainListResult> listUpdateDomainsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<UpdateDomainListResult> listUpdateDomainsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> walkUpdateDomainWithResponse(String resourceGroupName, String cloudServiceName,
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        return service.walkUpdateDomainSync(this.client.getEndpoint(), resourceGroupName, cloudServiceName,
            updateDomain, this.client.getSubscriptionId(), apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginWalkUpdateDomain(String resourceGroupName, String cloudServiceName,
        ...
        Response<BinaryData> response
            = walkUpdateDomainWithResponse(resourceGroupName, cloudServiceName, updateDomain, parameters);
    ...
    public SyncPoller<PollResult<Void>, Void> beginWalkUpdateDomain(String resourceGroupName, String cloudServiceName,
        int updateDomain, UpdateDomainInner parameters, Context context) {
        Response<BinaryData> response
            = walkUpdateDomainWithResponse(resourceGroupName, cloudServiceName, updateDomain, parameters, context);
    ...
    public void walkUpdateDomain(String resourceGroupName, String cloudServiceName, int updateDomain) {
        final UpdateDomainInner parameters = null;
        beginWalkUpdateDomain(resourceGroupName, cloudServiceName, updateDomain, parameters).getFinalResult();
    }
    ...
    public void walkUpdateDomain(String resourceGroupName, String cloudServiceName, int updateDomain,
        ...
        beginWalkUpdateDomain(resourceGroupName, cloudServiceName, updateDomain, parameters, context).getFinalResult();
    }
    ...
    public Response<UpdateDomainInner> getUpdateDomainWithResponse(String resourceGroupName, String cloudServiceName,
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        return service.getUpdateDomainSync(this.client.getEndpoint(), resourceGroupName, cloudServiceName, updateDomain,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of all update domains in a cloud service along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<UpdateDomainInner> listUpdateDomainsSinglePage(String resourceGroupName,
        String cloudServiceName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        Response<UpdateDomainListResult> res = service.listUpdateDomainsSync(this.client.getEndpoint(),
            resourceGroupName, cloudServiceName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<UpdateDomainInner> listUpdateDomains(String resourceGroupName, String cloudServiceName) {
        return new PagedIterable<>(() -> listUpdateDomainsSinglePage(resourceGroupName, cloudServiceName),
            nextLink -> listUpdateDomainsNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<UpdateDomainInner> listUpdateDomains(String resourceGroupName, String cloudServiceName,
        Context context) {
        return new PagedIterable<>(() -> listUpdateDomainsSinglePage(resourceGroupName, cloudServiceName, context),
            nextLink -> listUpdateDomainsNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<UpdateDomainInner> listUpdateDomainsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<UpdateDomainListResult> res
            = service.listUpdateDomainsNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<UpdateDomainInner> listUpdateDomainsNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<UpdateDomainListResult> res
            = service.listUpdateDomainsNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(CloudServicesUpdateDomainsClientImpl.class);
}
