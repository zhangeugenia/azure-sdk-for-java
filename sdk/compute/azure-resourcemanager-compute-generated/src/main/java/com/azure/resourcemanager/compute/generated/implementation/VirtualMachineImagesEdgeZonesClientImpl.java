...
public final class VirtualMachineImagesEdgeZonesClientImpl implements VirtualMachineImagesEdgeZonesClient {
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listSkusWithResponseAsync(String location,
        ...
        return service.listSkus(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            location, edgeZone, publisherName, offer, accept, context);
    }
    ...
    private Mono<Response<VirtualMachineImageInner>> getWithResponseAsync(String location, String edgeZone,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), location, edgeZone, publisherName,
            offer, skus, version, this.client.getSubscriptionId(), accept, context);
    }
