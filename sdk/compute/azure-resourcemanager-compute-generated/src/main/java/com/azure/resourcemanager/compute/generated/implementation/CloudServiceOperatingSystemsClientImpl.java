...
public final class CloudServiceOperatingSystemsClientImpl implements CloudServiceOperatingSystemsClient {
    ...
    public interface CloudServiceOperatingSystemsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSVersionInner> getOSVersionSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("osVersionName") String osVersionName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSVersionListResult> listOSVersionsSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSFamilyInner> getOSFamilySync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("osFamilyName") String osFamilyName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSFamilyListResult> listOSFamiliesSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSVersionListResult> listOSVersionsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<OSFamilyListResult> listOSFamiliesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<OSVersionInner> getOSVersionWithResponse(String location, String osVersionName, Context context) {
        ...
        if (osVersionName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter osVersionName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        return service.getOSVersionSync(this.client.getEndpoint(), location, osVersionName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of all guest operating system versions available to be specified in the XML service configuration
     * (.cscfg) for a cloud service along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSVersionInner> listOSVersionsSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        Response<OSVersionListResult> res = service.listOSVersionsSync(this.client.getEndpoint(), location,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSVersionInner> listOSVersionsSinglePage(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public PagedIterable<OSVersionInner> listOSVersions(String location) {
        return new PagedIterable<>(() -> listOSVersionsSinglePage(location),
            nextLink -> listOSVersionsNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<OSVersionInner> listOSVersions(String location, Context context) {
        return new PagedIterable<>(() -> listOSVersionsSinglePage(location, context),
            nextLink -> listOSVersionsNextSinglePage(nextLink, context));
    }
    ...
    public Response<OSFamilyInner> getOSFamilyWithResponse(String location, String osFamilyName, Context context) {
        ...
        if (osFamilyName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter osFamilyName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        return service.getOSFamilySync(this.client.getEndpoint(), location, osFamilyName,
            this.client.getSubscriptionId(), apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSFamilyInner> listOSFamiliesSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-11-04";
        final String accept = "application/json";
        Response<OSFamilyListResult> res = service.listOSFamiliesSync(this.client.getEndpoint(), location,
            this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSFamilyInner> listOSFamiliesSinglePage(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public PagedIterable<OSFamilyInner> listOSFamilies(String location) {
        return new PagedIterable<>(() -> listOSFamiliesSinglePage(location),
            nextLink -> listOSFamiliesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<OSFamilyInner> listOSFamilies(String location, Context context) {
        return new PagedIterable<>(() -> listOSFamiliesSinglePage(location, context),
            nextLink -> listOSFamiliesNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSVersionInner> listOSVersionsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<OSVersionListResult> res
            = service.listOSVersionsNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSVersionInner> listOSVersionsNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<OSVersionListResult> res
            = service.listOSVersionsNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSFamilyInner> listOSFamiliesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<OSFamilyListResult> res
            = service.listOSFamiliesNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<OSFamilyInner> listOSFamiliesNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<OSFamilyListResult> res
            = service.listOSFamiliesNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(CloudServiceOperatingSystemsClientImpl.class);
}
