...
public interface LogAnalytics {
     ...
     * @return logAnalytics operation status response.
     */
    LogAnalyticsOperationResult exportThrottledRequests(String location, ThrottledRequestsInput body);
     ...
     * @return logAnalytics operation status response.
     */
    LogAnalyticsOperationResult exportThrottledRequests(String location, ThrottledRequestsInput body, Context context);
}
