...
public final class LogAnalyticsClientImpl implements LogAnalyticsClient {
    ...
    private Response<BinaryData> exportRequestRateByIntervalWithResponse(String location,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.exportRequestRateByIntervalSync(this.client.getEndpoint(), location, apiVersion,
    ...
    private Response<BinaryData> exportThrottledRequestsWithResponse(String location,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.exportThrottledRequestsSync(this.client.getEndpoint(), location, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
