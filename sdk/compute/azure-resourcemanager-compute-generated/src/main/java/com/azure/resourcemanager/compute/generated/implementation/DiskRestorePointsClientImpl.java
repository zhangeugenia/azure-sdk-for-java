...
public final class DiskRestorePointsClientImpl implements DiskRestorePointsClient {
    ...
    private PagedResponse<DiskRestorePointInner> listByRestorePointSinglePage(String resourceGroupName,
        ...
        Response<DiskRestorePointList> res
            = service.listByRestorePointSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, restorePointCollectionName, vmRestorePointName, apiVersion, accept, Context.NONE);
    ...
    private Response<BinaryData> revokeAccessWithResponse(String resourceGroupName, String restorePointCollectionName,
        ...
        return service.revokeAccessSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            restorePointCollectionName, vmRestorePointName, diskRestorePointName, apiVersion, accept, Context.NONE);
    }
