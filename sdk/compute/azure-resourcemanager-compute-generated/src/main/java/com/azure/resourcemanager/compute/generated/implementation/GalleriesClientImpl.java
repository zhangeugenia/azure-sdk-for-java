...
public final class GalleriesClientImpl implements GalleriesClient {
    ...
    public interface GalleriesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @QueryParam("api-version") String apiVersion, @QueryParam("$select") SelectPermissions select,
            @QueryParam("$expand") GalleryExpandParams expand, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryList> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryList> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryList> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String galleryName,
        ...
        if (gallery == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter gallery is required and cannot be null."));
        } else {
            gallery.validate();
        }
        final String apiVersion = "2024-03-03";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, apiVersion, gallery, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryInner>, GalleryInner> beginCreateOrUpdate(String resourceGroupName,
        String galleryName, GalleryInner gallery) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, galleryName, gallery);
    ...
    public SyncPoller<PollResult<GalleryInner>, GalleryInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, galleryName, gallery, context);
        return this.client.<GalleryInner, GalleryInner>getLroResult(response, GalleryInner.class, GalleryInner.class,
            context);
    }
    ...
    public GalleryInner createOrUpdate(String resourceGroupName, String galleryName, GalleryInner gallery) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, gallery).getFinalResult();
    }
    ...
    public GalleryInner createOrUpdate(String resourceGroupName, String galleryName, GalleryInner gallery,
        Context context) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, gallery, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String galleryName, GalleryUpdate gallery,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<GalleryInner>, GalleryInner> beginUpdate(String resourceGroupName, String galleryName,
        GalleryUpdate gallery) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, galleryName, gallery);
        return this.client.<GalleryInner, GalleryInner>getLroResult(response, GalleryInner.class, GalleryInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryInner>, GalleryInner> beginUpdate(String resourceGroupName, String galleryName,
        ...
        Response<BinaryData> response = updateWithResponse(resourceGroupName, galleryName, gallery, context);
        return this.client.<GalleryInner, GalleryInner>getLroResult(response, GalleryInner.class, GalleryInner.class,
            context);
    }
    ...
    public GalleryInner update(String resourceGroupName, String galleryName, GalleryUpdate gallery) {
        return beginUpdate(resourceGroupName, galleryName, gallery).getFinalResult();
    }
    ...
    public GalleryInner update(String resourceGroupName, String galleryName, GalleryUpdate gallery, Context context) {
        return beginUpdate(resourceGroupName, galleryName, gallery, context).getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String galleryName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, apiVersion, accept, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String galleryName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, galleryName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, galleryName, context);
    ...
    public void delete(String resourceGroupName, String galleryName) {
        beginDelete(resourceGroupName, galleryName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String galleryName, Context context) {
        beginDelete(resourceGroupName, galleryName, context).getFinalResult();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Galleries operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GalleryList> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listByResourceGroupSinglePage(String resourceGroupName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GalleryList> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listByResourceGroupNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<GalleryList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<GalleryList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(GalleriesClientImpl.class);
}
