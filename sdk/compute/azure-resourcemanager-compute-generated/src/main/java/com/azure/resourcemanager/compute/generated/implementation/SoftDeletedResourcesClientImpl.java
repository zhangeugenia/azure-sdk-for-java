...
public final class SoftDeletedResourcesClientImpl implements SoftDeletedResourcesClient {
    ...
    public interface SoftDeletedResourcesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GallerySoftDeletedResourceList> listByArtifactNameSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @PathParam("artifactType") String artifactType, @PathParam("artifactName") String artifactName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GallerySoftDeletedResourceList> listByArtifactNameNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Soft-deleted Resources operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GallerySoftDeletedResourceInner> listByArtifactNameSinglePage(String resourceGroupName,
        String galleryName, String artifactType, String artifactName) {
        if (this.client.getEndpoint() == null) {
        ...
        if (artifactType == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter artifactType is required and cannot be null."));
        }
        if (artifactName == null) {
            throw LOGGER.atError()
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GallerySoftDeletedResourceList> res
            = service.listByArtifactNameSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, galleryName, artifactType, artifactName, apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<GallerySoftDeletedResourceInner> listByArtifactName(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByArtifactNameSinglePage(resourceGroupName, galleryName, artifactType, artifactName),
            nextLink -> listByArtifactNameNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<GallerySoftDeletedResourceInner> listByArtifactName(String resourceGroupName,
        String galleryName, String artifactType, String artifactName, Context context) {
        return new PagedIterable<>(
            () -> listByArtifactNameSinglePage(resourceGroupName, galleryName, artifactType, artifactName, context),
            nextLink -> listByArtifactNameNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GallerySoftDeletedResourceInner> listByArtifactNameNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<GallerySoftDeletedResourceList> res
            = service.listByArtifactNameNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<GallerySoftDeletedResourceInner> listByArtifactNameNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<GallerySoftDeletedResourceList> res
            = service.listByArtifactNameNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(SoftDeletedResourcesClientImpl.class);
}
