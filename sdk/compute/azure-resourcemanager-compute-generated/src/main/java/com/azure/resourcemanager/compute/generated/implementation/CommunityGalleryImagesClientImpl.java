...
public final class CommunityGalleryImagesClientImpl implements CommunityGalleryImagesClient {
    ...
    public interface CommunityGalleryImagesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CommunityGalleryImageInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("publicGalleryName") String publicGalleryName,
            @PathParam("galleryImageName") String galleryImageName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CommunityGalleryImageList> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("publicGalleryName") String publicGalleryName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CommunityGalleryImageList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Community Gallery Images operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CommunityGalleryImageInner> listSinglePage(String location, String publicGalleryName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<CommunityGalleryImageList> res = service.listSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), location, apiVersion, publicGalleryName, accept, Context.NONE);
    ...
    private PagedResponse<CommunityGalleryImageInner> listSinglePage(String location, String publicGalleryName,
        ...
        final String accept = "application/json";
        Response<CommunityGalleryImageList> res = service.listSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), location, apiVersion, publicGalleryName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<CommunityGalleryImageInner> list(String location, String publicGalleryName) {
        return new PagedIterable<>(() -> listSinglePage(location, publicGalleryName),
    ...
    public PagedIterable<CommunityGalleryImageInner> list(String location, String publicGalleryName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(location, publicGalleryName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CommunityGalleryImageInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<CommunityGalleryImageList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<CommunityGalleryImageInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CommunityGalleryImagesClientImpl.class);
}
