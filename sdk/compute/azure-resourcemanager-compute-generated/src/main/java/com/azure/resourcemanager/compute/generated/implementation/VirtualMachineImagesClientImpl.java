...
public final class VirtualMachineImagesClientImpl implements VirtualMachineImagesClient {
    ...
    public interface VirtualMachineImagesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineImagesWithPropertiesListResult> listWithPropertiesSync(
            @HostParam("$host") String endpoint, @PathParam("location") String location,
            @PathParam("publisherName") String publisherName, @PathParam("offer") String offer,
            @PathParam("skus") String skus, @QueryParam("$expand") Expand expand, @QueryParam("$top") Integer top,
            @QueryParam("$orderby") String orderby, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<VirtualMachineImagesWithPropertiesListResult> listWithPropertiesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<VirtualMachineImageInner> getWithResponse(String location, String publisherName, String offer,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), location, publisherName, offer, skus, version, apiVersion,
    ...
    public Response<List<VirtualMachineImageResourceInner>> listWithResponse(String location, String publisherName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listSync(this.client.getEndpoint(), location, publisherName, offer, skus, expand, top, orderby,
    ...
    public Response<List<VirtualMachineImageResourceInner>> listOffersWithResponse(String location,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listOffersSync(this.client.getEndpoint(), location, publisherName, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<List<VirtualMachineImageResourceInner>> listPublishersWithResponse(String location,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listPublishersSync(this.client.getEndpoint(), location, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<List<VirtualMachineImageResourceInner>> listSkusWithResponse(String location, String publisherName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listSkusSync(this.client.getEndpoint(), location, publisherName, offer, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<VmImagesInEdgeZoneListResultInner> listByEdgeZoneWithResponse(String location, String edgeZone,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        return service.listByEdgeZoneSync(this.client.getEndpoint(), location, edgeZone, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Virtual Machine Images operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineImageInner> listWithPropertiesSinglePage(String location, String publisherName,
        String offer, String skus, Expand expand, Integer top, String orderby) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<VirtualMachineImagesWithPropertiesListResult> res
            = service.listWithPropertiesSync(this.client.getEndpoint(), location, publisherName, offer, skus, expand,
                top, orderby, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    ...
    private PagedResponse<VirtualMachineImageInner> listWithPropertiesSinglePage(String location, String publisherName,
        ...
        Response<VirtualMachineImagesWithPropertiesListResult> res
            = service.listWithPropertiesSync(this.client.getEndpoint(), location, publisherName, offer, skus, expand,
                top, orderby, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<VirtualMachineImageInner> listWithProperties(String location, String publisherName,
        ...
        return new PagedIterable<>(
            () -> listWithPropertiesSinglePage(location, publisherName, offer, skus, expand, top, orderby),
            nextLink -> listWithPropertiesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<VirtualMachineImageInner> listWithProperties(String location, String publisherName,
        String offer, String skus, Expand expand, Integer top, String orderby, Context context) {
        return new PagedIterable<>(
            () -> listWithPropertiesSinglePage(location, publisherName, offer, skus, expand, top, orderby, context),
            nextLink -> listWithPropertiesNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineImageInner> listWithPropertiesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<VirtualMachineImagesWithPropertiesListResult> res
            = service.listWithPropertiesNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualMachineImageInner> listWithPropertiesNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<VirtualMachineImagesWithPropertiesListResult> res
            = service.listWithPropertiesNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
