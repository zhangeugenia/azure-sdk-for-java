...
public final class SharedGalleriesClientImpl implements SharedGalleriesClient {
    ...
    public interface SharedGalleriesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryList> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @QueryParam("sharedTo") SharedToValues sharedTo,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @PathParam("galleryUniqueName") String galleryUniqueName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Shared Galleries operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryInner> listSinglePage(String location, SharedToValues sharedTo) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<SharedGalleryList> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            location, apiVersion, sharedTo, accept, Context.NONE);
    ...
    private PagedResponse<SharedGalleryInner> listSinglePage(String location, SharedToValues sharedTo,
        ...
        final String accept = "application/json";
        Response<SharedGalleryList> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            location, apiVersion, sharedTo, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SharedGalleryInner> list(String location) {
        final SharedToValues sharedTo = null;
        return new PagedIterable<>(() -> listSinglePage(location, sharedTo), nextLink -> listNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<SharedGalleryInner> list(String location, SharedToValues sharedTo, Context context) {
        return new PagedIterable<>(() -> listSinglePage(location, sharedTo, context),
    ...
    public Response<SharedGalleryInner> getWithResponse(String location, String galleryUniqueName, Context context) {
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, galleryUniqueName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<SharedGalleryList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<SharedGalleryList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(SharedGalleriesClientImpl.class);
}
