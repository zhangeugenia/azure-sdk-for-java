...
public final class ResourceSkusClientImpl implements ResourceSkusClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of Microsoft.Compute SKUs available for your Subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ResourceSkuInner> listSinglePage(String filter, String includeExtendedLocations) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2021-07-01";
        final String accept = "application/json";
        Response<ResourceSkusResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), filter, includeExtendedLocations, accept, Context.NONE);
    ...
    private PagedResponse<ResourceSkuInner> listSinglePage(String filter, String includeExtendedLocations,
        ...
        final String accept = "application/json";
        Response<ResourceSkusResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), filter, includeExtendedLocations, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<ResourceSkuInner> list() {
        final String filter = null;
        final String includeExtendedLocations = null;
        return new PagedIterable<>(() -> listSinglePage(filter, includeExtendedLocations),
    ...
    public PagedIterable<ResourceSkuInner> list(String filter, String includeExtendedLocations, Context context) {
        return new PagedIterable<>(() -> listSinglePage(filter, includeExtendedLocations, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Resource Skus operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
