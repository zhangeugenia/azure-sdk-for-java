...
public final class CommunityGalleriesClientImpl implements CommunityGalleriesClient {
    ...
    public interface CommunityGalleriesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<CommunityGalleryInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @PathParam("publicGalleryName") String publicGalleryName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<CommunityGalleryInner> getWithResponse(String location, String publicGalleryName, Context context) {
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, publicGalleryName,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CommunityGalleriesClientImpl.class);
}
