...
public final class VirtualMachineRunCommandsClientImpl implements VirtualMachineRunCommandsClient {
    ...
    private PagedResponse<RunCommandDocumentBaseInner> listSinglePage(String location) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        Response<RunCommandListResult> res = service.listSync(this.client.getEndpoint(), location, apiVersion,
    ...
    public Response<RunCommandDocumentInner> getWithResponse(String location, String commandId, Context context) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.getSync(this.client.getEndpoint(), location, commandId, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vmName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, vmName, runCommandName,
            apiVersion, this.client.getSubscriptionId(), runCommand, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String vmName, String runCommandName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, vmName, runCommandName, apiVersion,
            this.client.getSubscriptionId(), runCommand, accept, Context.NONE);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vmName, String runCommandName) {
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, vmName, runCommandName, apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public Response<VirtualMachineRunCommandInner> getByVirtualMachineWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        return service.getByVirtualMachineSync(this.client.getEndpoint(), resourceGroupName, vmName, runCommandName,
    ...
    private PagedResponse<VirtualMachineRunCommandInner> listByVirtualMachineSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json, text/json";
        Response<VirtualMachineRunCommandsListResult> res = service.listByVirtualMachineSync(this.client.getEndpoint(),
            resourceGroupName, vmName, expand, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<VirtualMachineRunCommandInner> listByVirtualMachineSinglePage(String resourceGroupName,
        ...
        final String accept = "application/json, text/json";
        Response<VirtualMachineRunCommandsListResult> res = service.listByVirtualMachineSync(this.client.getEndpoint(),
            resourceGroupName, vmName, expand, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
