...
public final class VirtualMachineRunCommandsClientImpl implements VirtualMachineRunCommandsClient {
    ...
    private Mono<PagedResponse<RunCommandDocumentBaseInner>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), location, accept, acceptParam, context))
    ...
    private Mono<Response<RunCommandDocumentInner>> getWithResponseAsync(String location, String commandId) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(), location,
                commandId, this.client.getSubscriptionId(), accept, acceptParam, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RunCommandDocumentInner>> getWithResponseAsync(String location, String commandId,
        ...
        final String acceptParam = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), location, commandId,
    ...
    private Mono<Response<VirtualMachineRunCommandInner>> getByVirtualMachineWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getByVirtualMachine(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, vmName, runCommandName, expand, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String vmName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vmName, runCommandName, accept, context);
    }
