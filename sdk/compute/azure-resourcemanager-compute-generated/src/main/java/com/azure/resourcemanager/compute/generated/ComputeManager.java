...
import com.azure.resourcemanager.compute.generated.implementation.GalleryScriptVersionsImpl;
import com.azure.resourcemanager.compute.generated.implementation.GalleryScriptsImpl;
...
public final class ComputeManager {
    ...
    private GalleryScripts galleryScripts;

    private GalleryScriptVersions galleryScriptVersions;
    ...
    /**
     * Gets the resource collection API of GalleryScripts. It manages GalleryScript.
     * 
     * @return Resource collection API of GalleryScripts.
     */
    public GalleryScripts galleryScripts() {
        if (this.galleryScripts == null) {
            this.galleryScripts = new GalleryScriptsImpl(clientObject.getGalleryScripts(), this);
        }
        return galleryScripts;
    }

    /**
     * Gets the resource collection API of GalleryScriptVersions. It manages GalleryScriptVersion.
     * 
     * @return Resource collection API of GalleryScriptVersions.
     */
    public GalleryScriptVersions galleryScriptVersions() {
        if (this.galleryScriptVersions == null) {
            this.galleryScriptVersions = new GalleryScriptVersionsImpl(clientObject.getGalleryScriptVersions(), this);
        }
        return galleryScriptVersions;
    }
