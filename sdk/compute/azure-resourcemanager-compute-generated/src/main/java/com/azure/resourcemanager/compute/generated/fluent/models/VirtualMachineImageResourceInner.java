...
public class VirtualMachineImageResourceInner extends SubResource {
     ...
     */
    public VirtualMachineImageProperties properties() {
        return this.properties;
    }

    /**
     * Set the properties property: Describes the properties of a Virtual Machine Image.
     * 
     * @param properties the properties value to set.
     * @return the VirtualMachineImageResourceInner object itself.
     */
    public VirtualMachineImageResourceInner withProperties(VirtualMachineImageProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineImageResourceInner.properties
