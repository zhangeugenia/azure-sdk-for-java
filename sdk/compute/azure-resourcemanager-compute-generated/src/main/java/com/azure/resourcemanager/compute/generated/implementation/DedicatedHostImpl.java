...
public final class DedicatedHostImpl implements DedicatedHost, DedicatedHost.Definition, DedicatedHost.Update {
    ...
    public DedicatedHost restart() {
        return serviceManager.dedicatedHosts().restart(resourceGroupName, hostGroupName, hostname);
    }

    public DedicatedHost restart(Context context) {
        return serviceManager.dedicatedHosts().restart(resourceGroupName, hostGroupName, hostname, context);
    }
