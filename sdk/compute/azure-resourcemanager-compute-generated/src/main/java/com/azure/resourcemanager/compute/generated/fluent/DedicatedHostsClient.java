...
public interface DedicatedHostsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DedicatedHostInner>, DedicatedHostInner> beginRestart(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DedicatedHostInner restart(String resourceGroupName, String hostGroupName, String hostname);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DedicatedHostInner restart(String resourceGroupName, String hostGroupName, String hostname, Context context);
}
