...
public final class GalleryApplicationsClientImpl implements GalleryApplicationsClient {
    ...
    public interface GalleryApplicationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @PathParam("galleryApplicationName") String galleryApplicationName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationList> listByGallerySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationList> listByGalleryNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String galleryName,
        ...
        if (galleryApplication == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter galleryApplication is required and cannot be null."));
        } else {
            galleryApplication.validate();
        }
        final String apiVersion = "2024-03-03";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, galleryApplicationName, apiVersion, galleryApplication, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationInner>, GalleryApplicationInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, galleryName, galleryApplicationName, galleryApplication);
        return this.client.<GalleryApplicationInner, GalleryApplicationInner>getLroResult(response,
            GalleryApplicationInner.class, GalleryApplicationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationInner>, GalleryApplicationInner> beginCreateOrUpdate(
        ...
        return this.client.<GalleryApplicationInner, GalleryApplicationInner>getLroResult(response,
            GalleryApplicationInner.class, GalleryApplicationInner.class, context);
    }
    ...
    public GalleryApplicationInner createOrUpdate(String resourceGroupName, String galleryName,
        String galleryApplicationName, GalleryApplicationInner galleryApplication) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplication)
            .getFinalResult();
    }
    ...
    public GalleryApplicationInner createOrUpdate(String resourceGroupName, String galleryName,
        String galleryApplicationName, GalleryApplicationInner galleryApplication, Context context) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplication, context)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationInner>, GalleryApplicationInner> beginUpdate(
        ...
        GalleryApplicationUpdate galleryApplication) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, galleryName, galleryApplicationName, galleryApplication);
        return this.client.<GalleryApplicationInner, GalleryApplicationInner>getLroResult(response,
            GalleryApplicationInner.class, GalleryApplicationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationInner>, GalleryApplicationInner> beginUpdate(
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, galleryName, galleryApplicationName, galleryApplication, context);
        return this.client.<GalleryApplicationInner, GalleryApplicationInner>getLroResult(response,
            GalleryApplicationInner.class, GalleryApplicationInner.class, context);
    }
    ...
    public GalleryApplicationInner update(String resourceGroupName, String galleryName, String galleryApplicationName,
        GalleryApplicationUpdate galleryApplication) {
        return beginUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplication).getFinalResult();
    }
    ...
    public GalleryApplicationInner update(String resourceGroupName, String galleryName, String galleryApplicationName,
        GalleryApplicationUpdate galleryApplication, Context context) {
        return beginUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplication, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String galleryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, galleryApplicationName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        String galleryApplicationName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, galleryName, galleryApplicationName, context);
    ...
    public void delete(String resourceGroupName, String galleryName, String galleryApplicationName) {
        beginDelete(resourceGroupName, galleryName, galleryApplicationName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String galleryName, String galleryApplicationName, Context context) {
        beginDelete(resourceGroupName, galleryName, galleryApplicationName, context).getFinalResult();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Gallery Applications operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationInner> listByGallerySinglePage(String resourceGroupName,
        String galleryName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GalleryApplicationList> res = service.listByGallerySync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationInner> listByGallerySinglePage(String resourceGroupName, String galleryName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationInner> listByGalleryNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<GalleryApplicationList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationInner> listByGalleryNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(GalleryApplicationsClientImpl.class);
}
