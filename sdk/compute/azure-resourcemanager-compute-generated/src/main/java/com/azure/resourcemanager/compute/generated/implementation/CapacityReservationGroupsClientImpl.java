...
public final class CapacityReservationGroupsClientImpl implements CapacityReservationGroupsClient {
    ...
    private PagedResponse<CapacityReservationGroupInner> listByResourceGroupSinglePage(String resourceGroupName,
        ...
        Response<CapacityReservationGroupListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
            resourceGroupName, apiVersion, this.client.getSubscriptionId(), expand, accept, Context.NONE);
    ...
    private PagedResponse<CapacityReservationGroupInner> listByResourceGroupSinglePage(String resourceGroupName,
        ...
        final String accept = "application/json";
        Response<CapacityReservationGroupListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
            resourceGroupName, apiVersion, this.client.getSubscriptionId(), expand, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<CapacityReservationGroupInner> listSinglePage(
        ...
        final String apiVersion = "2024-11-01";
        final String accept = "application/json";
        Response<CapacityReservationGroupListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), expand, resourceIdsOnly, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
