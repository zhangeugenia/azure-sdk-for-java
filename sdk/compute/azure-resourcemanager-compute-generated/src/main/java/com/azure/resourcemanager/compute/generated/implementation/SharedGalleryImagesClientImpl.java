...
public final class SharedGalleryImagesClientImpl implements SharedGalleryImagesClient {
    ...
    public interface SharedGalleryImagesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageList> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("galleryUniqueName") String galleryUniqueName,
            @QueryParam("sharedTo") SharedToValues sharedTo, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @PathParam("galleryUniqueName") String galleryUniqueName,
            @PathParam("galleryImageName") String galleryImageName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<SharedGalleryImageList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Shared Gallery Images operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageInner> listSinglePage(String location, String galleryUniqueName,
        SharedToValues sharedTo) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<SharedGalleryImageList> res = service.listSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), location, apiVersion, galleryUniqueName, sharedTo, accept, Context.NONE);
    ...
    private PagedResponse<SharedGalleryImageInner> listSinglePage(String location, String galleryUniqueName,
        ...
        final String accept = "application/json";
        Response<SharedGalleryImageList> res = service.listSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), location, apiVersion, galleryUniqueName, sharedTo, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SharedGalleryImageInner> list(String location, String galleryUniqueName) {
        final SharedToValues sharedTo = null;
        return new PagedIterable<>(() -> listSinglePage(location, galleryUniqueName, sharedTo),
    ...
    public PagedIterable<SharedGalleryImageInner> list(String location, String galleryUniqueName,
        SharedToValues sharedTo, Context context) {
        return new PagedIterable<>(() -> listSinglePage(location, galleryUniqueName, sharedTo, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<SharedGalleryImageList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SharedGalleryImageInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SharedGalleryImagesClientImpl.class);
}
