...
public final class GalleryApplicationVersionsClientImpl implements GalleryApplicationVersionsClient {
    ...
    public interface GalleryApplicationVersionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationVersionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @PathParam("galleryApplicationName") String galleryApplicationName,
            @PathParam("galleryApplicationVersionName") String galleryApplicationVersionName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationVersionList> listByGalleryApplicationSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("galleryName") String galleryName,
            @PathParam("galleryApplicationName") String galleryApplicationName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Response<GalleryApplicationVersionList> listByGalleryApplicationNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String galleryName,
        ...
        if (galleryApplicationName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter galleryApplicationName is required and cannot be null."));
        }
        if (galleryApplicationVersionName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<GalleryApplicationVersionInner>, GalleryApplicationVersionInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, galleryName,
            galleryApplicationName, galleryApplicationVersionName, galleryApplicationVersion);
        return this.client.<GalleryApplicationVersionInner, GalleryApplicationVersionInner>getLroResult(response,
            GalleryApplicationVersionInner.class, GalleryApplicationVersionInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationVersionInner>, GalleryApplicationVersionInner> beginCreateOrUpdate(
        ...
        return this.client.<GalleryApplicationVersionInner, GalleryApplicationVersionInner>getLroResult(response,
            GalleryApplicationVersionInner.class, GalleryApplicationVersionInner.class, context);
    }
    ...
    public GalleryApplicationVersionInner createOrUpdate(String resourceGroupName, String galleryName,
        String galleryApplicationName, String galleryApplicationVersionName,
        GalleryApplicationVersionInner galleryApplicationVersion) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, galleryApplicationName,
            galleryApplicationVersionName, galleryApplicationVersion).getFinalResult();
    }
    ...
    public GalleryApplicationVersionInner createOrUpdate(String resourceGroupName, String galleryName,
        ...
        GalleryApplicationVersionInner galleryApplicationVersion, Context context) {
        return beginCreateOrUpdate(resourceGroupName, galleryName, galleryApplicationName,
            galleryApplicationVersionName, galleryApplicationVersion, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<GalleryApplicationVersionInner>, GalleryApplicationVersionInner> beginUpdate(
        String resourceGroupName, String galleryName, String galleryApplicationName,
        String galleryApplicationVersionName, GalleryApplicationVersionUpdate galleryApplicationVersion) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, galleryName, galleryApplicationName,
    ...
    public GalleryApplicationVersionInner update(String resourceGroupName, String galleryName,
        String galleryApplicationName, String galleryApplicationVersionName,
        GalleryApplicationVersionUpdate galleryApplicationVersion) {
        return beginUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName,
            galleryApplicationVersion).getFinalResult();
    }
    ...
    public GalleryApplicationVersionInner update(String resourceGroupName, String galleryName,
        ...
        GalleryApplicationVersionUpdate galleryApplicationVersion, Context context) {
        return beginUpdate(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName,
            galleryApplicationVersion, context).getFinalResult();
    }
    ...
    public Response<GalleryApplicationVersionInner> getWithResponse(String resourceGroupName, String galleryName,
        ...
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, galleryApplicationName, galleryApplicationVersionName, expand, apiVersion, accept, context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String galleryName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, galleryApplicationName, galleryApplicationVersionName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String galleryName,
        String galleryApplicationName, String galleryApplicationVersionName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, galleryName, galleryApplicationName,
    ...
    public void delete(String resourceGroupName, String galleryName, String galleryApplicationName,
        ...
        beginDelete(resourceGroupName, galleryName, galleryApplicationName, galleryApplicationVersionName, context)
            .getFinalResult();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List Gallery Application version operation response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationVersionInner> listByGalleryApplicationSinglePage(String resourceGroupName,
        String galleryName, String galleryApplicationName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-03-03";
        final String accept = "application/json";
        Response<GalleryApplicationVersionList> res
            = service.listByGalleryApplicationSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, galleryName, galleryApplicationName, apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<GalleryApplicationVersionInner> listByGalleryApplication(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByGalleryApplicationSinglePage(resourceGroupName, galleryName, galleryApplicationName),
            nextLink -> listByGalleryApplicationNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<GalleryApplicationVersionInner> listByGalleryApplication(String resourceGroupName,
        String galleryName, String galleryApplicationName, Context context) {
        return new PagedIterable<>(
            () -> listByGalleryApplicationSinglePage(resourceGroupName, galleryName, galleryApplicationName, context),
            nextLink -> listByGalleryApplicationNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GalleryApplicationVersionInner> listByGalleryApplicationNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<GalleryApplicationVersionList> res
            = service.listByGalleryApplicationNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<GalleryApplicationVersionInner> listByGalleryApplicationNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<GalleryApplicationVersionList> res
            = service.listByGalleryApplicationNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(GalleryApplicationVersionsClientImpl.class);
}
