...
public final class GallerySharingProfilesClientImpl implements GallerySharingProfilesClient {
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return specifies information about the gallery sharing profile update along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String galleryName,
        ...
        if (sharingUpdate == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter sharingUpdate is required and cannot be null."));
        } else {
            sharingUpdate.validate();
        }
        final String apiVersion = "2024-03-03";
        ...
        return service.updateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            galleryName, apiVersion, sharingUpdate, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<SharingUpdateInner>, SharingUpdateInner> beginUpdate(String resourceGroupName,
        String galleryName, SharingUpdateInner sharingUpdate) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, galleryName, sharingUpdate);
        return this.client.<SharingUpdateInner, SharingUpdateInner>getLroResult(response, SharingUpdateInner.class,
            SharingUpdateInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<SharingUpdateInner>, SharingUpdateInner> beginUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response = updateWithResponse(resourceGroupName, galleryName, sharingUpdate, context);
        return this.client.<SharingUpdateInner, SharingUpdateInner>getLroResult(response, SharingUpdateInner.class,
            SharingUpdateInner.class, context);
    }
    ...
    public SharingUpdateInner update(String resourceGroupName, String galleryName, SharingUpdateInner sharingUpdate) {
        return beginUpdate(resourceGroupName, galleryName, sharingUpdate).getFinalResult();
    }
    ...
    public SharingUpdateInner update(String resourceGroupName, String galleryName, SharingUpdateInner sharingUpdate,
        Context context) {
        return beginUpdate(resourceGroupName, galleryName, sharingUpdate, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(GallerySharingProfilesClientImpl.class);
}
