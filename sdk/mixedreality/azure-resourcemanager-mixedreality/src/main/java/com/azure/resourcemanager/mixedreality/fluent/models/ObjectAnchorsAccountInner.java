...
public final class ObjectAnchorsAccountInner extends Resource {
    ...
    /**
     * Reads an instance of ObjectAnchorsAccountInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ObjectAnchorsAccountInner if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ObjectAnchorsAccountInner.
     */
    public static ObjectAnchorsAccountInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ObjectAnchorsAccountInner deserializedObjectAnchorsAccountInner = new ObjectAnchorsAccountInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedObjectAnchorsAccountInner.withTags(tags);
                } else if ("identity".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.identity = ObjectAnchorsAccountIdentity.fromJson(reader);
                } else if ("properties".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.innerProperties
                        = MixedRealityAccountProperties.fromJson(reader);
                } else if ("plan".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.plan = Identity.fromJson(reader);
                } else if ("sku".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.sku = Sku.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.kind = Sku.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedObjectAnchorsAccountInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedObjectAnchorsAccountInner;
        });
    }
}
