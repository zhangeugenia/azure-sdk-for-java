...
public final class ObjectAnchorsAccountsImpl implements ObjectAnchorsAccounts {
    ...
    public ObjectAnchorsAccountsImpl(ObjectAnchorsAccountsClient innerClient,
    ...
    public PagedIterable<ObjectAnchorsAccount> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ObjectAnchorsAccountImpl(inner1, this.manager()));
    }
    ...
    public Response<ObjectAnchorsAccount> getByResourceGroupWithResponse(String resourceGroupName, String accountName,
        Context context) {
    ...
    public ObjectAnchorsAccount getById(String id) {
        ...
        String accountName = ResourceManagerUtils.getValueFromIdByName(id, "objectAnchorsAccounts");
        if (accountName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'objectAnchorsAccounts'.", id)));
        }
