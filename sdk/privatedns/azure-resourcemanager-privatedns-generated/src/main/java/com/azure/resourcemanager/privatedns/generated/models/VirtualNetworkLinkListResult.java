...
public final class VirtualNetworkLinkListResult implements JsonSerializable<VirtualNetworkLinkListResult> {
    ...
    /**
     * Set the value property: The VirtualNetworkLink items on this page.
     * 
     ...
     * @return the VirtualNetworkLinkListResult object itself.
     */
    public VirtualNetworkLinkListResult withNextLink(String nextLink) {
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model VirtualNetworkLinkListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(VirtualNetworkLinkListResult.class);
