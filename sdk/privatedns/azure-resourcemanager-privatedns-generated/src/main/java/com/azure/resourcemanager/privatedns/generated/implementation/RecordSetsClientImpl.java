...
public final class RecordSetsClientImpl implements RecordSetsClient {
    ...
    public interface RecordSetsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{recordType}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}/{recordType}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}/{recordType}")
        ...
        Mono<Response<RecordSetInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @HeaderParam("if-none-match") String ifNoneMatch, @BodyParam("application/json") RecordSetInner parameters,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}/{recordType}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/{recordType}/{relativeRecordSetName}/{recordType}")
    ...
    private Mono<Response<RecordSetInner>> getWithResponseAsync(String resourceGroupName, String privateZoneName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateZoneName, relativeRecordSetName, recordType,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RecordSetInner>> getWithResponseAsync(String resourceGroupName, String privateZoneName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateZoneName, relativeRecordSetName, recordType, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecordSetInner> getAsync(String resourceGroupName, String privateZoneName,
        String relativeRecordSetName, RecordType recordType) {
        return getWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType)
    ...
    public Response<RecordSetInner> getWithResponse(String resourceGroupName, String privateZoneName,
        String relativeRecordSetName, RecordType recordType, Context context) {
        return getWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RecordSetInner get(String resourceGroupName, String privateZoneName, String relativeRecordSetName,
        RecordType recordType) {
        return getWithResponse(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<RecordSetInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateZoneName, String relativeRecordSetName, RecordType recordType, RecordSetInner parameters,
    ...
    private Mono<RecordSetInner> createOrUpdateAsync(String resourceGroupName, String privateZoneName,
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RecordSetInner createOrUpdate(String resourceGroupName, String privateZoneName, String relativeRecordSetName,
        RecordType recordType, RecordSetInner parameters) {
        final String ifMatch = null;
        final String ifNoneMatch = null;
        return createOrUpdateWithResponse(resourceGroupName, privateZoneName, relativeRecordSetName, recordType,
    ...
    private Mono<Response<RecordSetInner>> updateWithResponseAsync(String resourceGroupName, String privateZoneName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateZoneName, relativeRecordSetName, recordType, ifMatch, parameters, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecordSetInner> updateAsync(String resourceGroupName, String privateZoneName,
        String relativeRecordSetName, RecordType recordType, RecordSetInner parameters) {
        final String ifMatch = null;
        return updateWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RecordSetInner update(String resourceGroupName, String privateZoneName, String relativeRecordSetName,
        RecordType recordType, RecordSetInner parameters) {
        final String ifMatch = null;
        return updateWithResponse(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, parameters,
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String privateZoneName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateZoneName, relativeRecordSetName, recordType, ifMatch, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String privateZoneName, String relativeRecordSetName,
        RecordType recordType) {
        final String ifMatch = null;
        return deleteWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, ifMatch)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String privateZoneName,
        String relativeRecordSetName, RecordType recordType, String ifMatch, Context context) {
        return deleteWithResponseAsync(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, ifMatch,
            context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String privateZoneName, String relativeRecordSetName,
        RecordType recordType) {
        final String ifMatch = null;
        deleteWithResponse(resourceGroupName, privateZoneName, relativeRecordSetName, recordType, ifMatch,
            Context.NONE);
    }
