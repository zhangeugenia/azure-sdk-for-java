...
public final class StorageTasksClientImpl implements StorageTasksClient {
    ...
    public interface StorageTasksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTasksListResult>> listBySubscription(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StorageTasksListResult> listBySubscriptionSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTaskAssignmentsListResult>> storageTaskAssignmentList(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StorageTaskAssignmentsListResult> storageTaskAssignmentListSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("storageTaskName") String storageTaskName, @QueryParam("$maxpagesize") Integer maxpagesize,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTaskAssignmentsListResult>> storageTaskAssignmentListNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<StorageTaskAssignmentsListResult> storageTaskAssignmentListNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskInner>> listBySubscriptionSinglePageAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StorageTaskInner> listBySubscriptionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StorageTaskInner> listBySubscriptionSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<StorageTasksListResult> res = service.listBySubscriptionSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StorageTaskInner> listBySubscriptionSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StorageTaskInner> listBySubscription() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StorageTaskInner> listBySubscription(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskAssignmentInner>> storageTaskAssignmentListSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StorageTaskAssignmentInner> storageTaskAssignmentListAsync(String resourceGroupName,
        String storageTaskName, Integer maxpagesize) {
        return new PagedFlux<>(
            () -> storageTaskAssignmentListSinglePageAsync(resourceGroupName, storageTaskName, maxpagesize),
            nextLink -> storageTaskAssignmentListNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StorageTaskAssignmentInner> storageTaskAssignmentListSinglePage(String resourceGroupName,
        String storageTaskName, Integer maxpagesize) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        Response<StorageTaskAssignmentsListResult> res
            = service.storageTaskAssignmentListSync(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, storageTaskName, maxpagesize, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StorageTaskAssignmentInner> storageTaskAssignmentList(String resourceGroupName,
        String storageTaskName) {
        final Integer maxpagesize = null;
        return new PagedIterable<>(
            () -> storageTaskAssignmentListSinglePage(resourceGroupName, storageTaskName, maxpagesize),
            nextLink -> storageTaskAssignmentListNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<StorageTaskAssignmentInner> storageTaskAssignmentList(String resourceGroupName,
        String storageTaskName, Integer maxpagesize, Context context) {
        return new PagedIterable<>(
            () -> storageTaskAssignmentListSinglePage(resourceGroupName, storageTaskName, maxpagesize, context),
            nextLink -> storageTaskAssignmentListNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskAssignmentInner>>
        storageTaskAssignmentListNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        return FluxUtil
            .withContext(
                context -> service.storageTaskAssignmentListNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<StorageTaskAssignmentInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<StorageTaskAssignmentInner> storageTaskAssignmentListNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<StorageTaskAssignmentsListResult> res
            = service.storageTaskAssignmentListNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<StorageTaskAssignmentInner> storageTaskAssignmentListNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<StorageTaskAssignmentsListResult> res
            = service.storageTaskAssignmentListNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
