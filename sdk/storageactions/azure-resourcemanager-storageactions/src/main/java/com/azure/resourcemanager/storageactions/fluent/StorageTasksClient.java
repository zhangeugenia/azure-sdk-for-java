...
public interface StorageTasksClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<StorageTaskInner> listBySubscription();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<StorageTaskInner> listBySubscription(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<StorageTaskAssignmentInner> storageTaskAssignmentList(String resourceGroupName,
