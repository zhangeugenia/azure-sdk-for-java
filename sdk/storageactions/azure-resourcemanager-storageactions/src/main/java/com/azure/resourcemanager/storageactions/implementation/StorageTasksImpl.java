...
public final class StorageTasksImpl implements StorageTasks {
    ...
    public PagedIterable<StorageTask> listBySubscription() {
        PagedIterable<StorageTaskInner> inner = this.serviceClient().listBySubscription();
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageTaskImpl(inner1, this.manager()));
    }

    public PagedIterable<StorageTask> listBySubscription(Context context) {
        PagedIterable<StorageTaskInner> inner = this.serviceClient().listBySubscription(context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageTaskImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<StorageTaskAssignment> storageTaskAssignmentList(String resourceGroupName,
        String storageTaskName) {
        PagedIterable<StorageTaskAssignmentInner> inner
            = this.serviceClient().storageTaskAssignmentList(resourceGroupName, storageTaskName);
    ...
    public PagedIterable<StorageTaskAssignment> storageTaskAssignmentList(String resourceGroupName,
        ...
        PagedIterable<StorageTaskAssignmentInner> inner
            = this.serviceClient().storageTaskAssignmentList(resourceGroupName, storageTaskName, maxpagesize, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageTaskAssignmentImpl(inner1, this.manager()));
    }
