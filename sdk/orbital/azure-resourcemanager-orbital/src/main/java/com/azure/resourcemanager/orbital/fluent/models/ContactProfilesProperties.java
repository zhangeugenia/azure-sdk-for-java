 ...
 */
@Fluent
public final class ContactProfilesProperties implements JsonSerializable<ContactProfilesProperties> {
    /*
     ...
     */
    public ContactProfilesProperties withProvisioningState(ProvisioningState provisioningState) {
