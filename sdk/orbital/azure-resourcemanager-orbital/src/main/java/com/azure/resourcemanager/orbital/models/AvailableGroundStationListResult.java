...
public final class AvailableGroundStationListResult implements JsonSerializable<AvailableGroundStationListResult> {
    ...
    /**
     * Get the value property: The AvailableGroundStation items on this page.
     * 
    ...
    /**
     * Set the value property: The AvailableGroundStation items on this page.
     * 
     ...
     * @return the AvailableGroundStationListResult object itself.
     */
    public AvailableGroundStationListResult withNextLink(String nextLink) {
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model AvailableGroundStationListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AvailableGroundStationListResult.class);
