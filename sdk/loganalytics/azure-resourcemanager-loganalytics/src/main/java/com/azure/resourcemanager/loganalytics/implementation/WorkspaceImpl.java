...
public final class WorkspaceImpl implements Workspace, Workspace.Definition, Workspace.Update {
    ...
    public WorkspaceFailoverProperties failover() {
        return this.innerModel().failover();
    }
    ...
    public WorkspaceImpl withReplication(WorkspaceReplicationProperties replication) {
        if (isInCreateMode()) {
            this.innerModel().withReplication(replication);
            return this;
        } else {
            this.updateParameters.withReplication(replication);
            return this;
        }
    }

    public WorkspaceImpl withFailover(WorkspaceFailoverProperties failover) {
        if (isInCreateMode()) {
            this.innerModel().withFailover(failover);
            return this;
        } else {
            this.updateParameters.withFailover(failover);
            return this;
        }
    }
