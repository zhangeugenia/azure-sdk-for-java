...
public final class MonitoredResourcesClientImpl implements MonitoredResourcesClient {
    ...
    public interface MonitoredResourcesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MonitoredResourceListResponse> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MonitoredResourcesClientImpl.class);
}
