...
public final class PublicCloudConnectorImpl
    ...
    public AwsCloudProfile awsCloudProfile() {
        return this.innerModel().awsCloudProfile();
    }
    ...
    public String connectorPrimaryIdentifier() {
        return this.innerModel().connectorPrimaryIdentifier();
    }
    ...
    public PublicCloudConnectorImpl withAwsCloudProfile(AwsCloudProfile awsCloudProfile) {
        this.innerModel().withAwsCloudProfile(awsCloudProfile);
        return this;
    }

    public PublicCloudConnectorImpl withHostType(HostType hostType) {
