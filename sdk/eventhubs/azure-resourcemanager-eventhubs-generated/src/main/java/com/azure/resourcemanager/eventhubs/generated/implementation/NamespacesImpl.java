...
public final class NamespacesImpl implements Namespaces {
    ...
    public FailOver failover(String resourceGroupName, String namespaceName, FailOverInner parameters) {
        FailOverInner inner = this.serviceClient().failover(resourceGroupName, namespaceName, parameters);
        if (inner != null) {
            return new FailOverImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public FailOver failover(String resourceGroupName, String namespaceName, FailOverInner parameters,
        Context context) {
        FailOverInner inner = this.serviceClient().failover(resourceGroupName, namespaceName, parameters, context);
        if (inner != null) {
            return new FailOverImpl(inner, this.manager());
        } else {
            return null;
