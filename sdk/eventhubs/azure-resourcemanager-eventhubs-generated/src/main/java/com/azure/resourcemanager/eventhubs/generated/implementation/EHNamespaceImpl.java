...
public final class EHNamespaceImpl implements EHNamespace, EHNamespace.Definition, EHNamespace.Update {
    ...
    public FailOver failover(FailOverInner parameters) {
        return serviceManager.namespaces().failover(resourceGroupName, namespaceName, parameters);
    }

    public FailOver failover(FailOverInner parameters, Context context) {
        return serviceManager.namespaces().failover(resourceGroupName, namespaceName, parameters, context);
    }
