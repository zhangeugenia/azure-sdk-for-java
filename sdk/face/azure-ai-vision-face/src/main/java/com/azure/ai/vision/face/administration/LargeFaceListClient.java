...
public final class LargeFaceListClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> addFaceFromUrlImplWithResponse(BinaryData addFaceFromUrlRequest2,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponse(addFaceFromUrlRequest2, requestOptions);
    }
    ...
    AddFaceResult addFaceFromUrlImpl(String url, List<Integer> targetFace, FaceDetectionModel detectionModel,
        ...
        return addFaceFromUrlImplWithResponse(addFaceFromUrlRequest2, requestOptions).getValue()
