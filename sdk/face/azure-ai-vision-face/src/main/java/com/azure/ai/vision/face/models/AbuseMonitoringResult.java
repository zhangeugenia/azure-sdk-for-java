...
public final class AbuseMonitoringResult implements JsonSerializable<AbuseMonitoringResult> {
     ...
     */
    @Generated
    private final boolean isAbuseDetected;
     ...
     */
    @Generated
    private AbuseMonitoringResult(boolean isAbuseDetected, List<OtherFlaggedSessions> otherFlaggedSessions) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("isAbuseDetected", this.isAbuseDetected);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isAbuseDetected".equals(fieldName)) {
                    isAbuseDetected = reader.getBoolean();
