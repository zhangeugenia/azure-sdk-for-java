...
public final class LargePersonGroupClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> addFaceFromUrlImplWithResponse(String personId, BinaryData addFaceFromUrlRequest1,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponse(personId, addFaceFromUrlRequest1, requestOptions);
    }
    ...
    public Response<Void> updateFaceWithResponse(String personId, String persistedFaceId, BinaryData updateFaceRequest1,
        RequestOptions requestOptions) {
        return this.serviceClient.updateFaceWithResponse(personId, persistedFaceId, updateFaceRequest1, requestOptions);
    }
    ...
    AddFaceResult addFaceFromUrlImpl(String personId, String url, List<Integer> targetFace,
        ...
        return addFaceFromUrlImplWithResponse(personId, addFaceFromUrlRequest1, requestOptions).getValue()
    ...
    public void updateFace(String personId, String persistedFaceId, String userData) {
        ...
        updateFaceWithResponse(personId, persistedFaceId, updateFaceRequest1, requestOptions).getValue();
    }
