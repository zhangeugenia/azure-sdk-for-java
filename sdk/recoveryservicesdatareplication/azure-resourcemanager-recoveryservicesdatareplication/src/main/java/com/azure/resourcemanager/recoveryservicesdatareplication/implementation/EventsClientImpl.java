...
import com.azure.resourcemanager.recoveryservicesdatareplication.models.EventModelListResult;
...
public final class EventsClientImpl implements EventsClient {
    ...
    public interface EventsService {
        ...
        Mono<Response<EventModelListResult>> list(@HostParam("$host") String endpoint,
