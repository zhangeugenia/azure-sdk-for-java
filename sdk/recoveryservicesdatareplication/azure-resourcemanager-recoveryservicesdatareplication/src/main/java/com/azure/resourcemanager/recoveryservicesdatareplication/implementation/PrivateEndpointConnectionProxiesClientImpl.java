...
import com.azure.resourcemanager.recoveryservicesdatareplication.models.PrivateEndpointConnectionProxyListResult;
...
public final class PrivateEndpointConnectionProxiesClientImpl implements PrivateEndpointConnectionProxiesClient {
    ...
    public interface PrivateEndpointConnectionProxiesService {
        ...
        Mono<Response<PrivateEndpointConnectionProxyListResult>> list(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateEndpointConnectionProxyInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @PathParam("privateEndpointConnectionProxyName") String privateEndpointConnectionProxyName,
            @BodyParam("application/json") PrivateEndpointConnectionProxyInner body,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateEndpointConnectionProxyInner>> validate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @PathParam("privateEndpointConnectionProxyName") String privateEndpointConnectionProxyName,
            @BodyParam("application/json") PrivateEndpointConnectionProxyInner body,
    ...
    private Mono<Response<PrivateEndpointConnectionProxyInner>> createWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vaultName, privateEndpointConnectionProxyName, body,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PrivateEndpointConnectionProxyInner>> createWithResponseAsync(String resourceGroupName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, privateEndpointConnectionProxyName, body, accept, context);
    }
    ...
    private Mono<PrivateEndpointConnectionProxyInner> createAsync(String resourceGroupName, String vaultName,
        ...
        return createWithResponseAsync(resourceGroupName, vaultName, privateEndpointConnectionProxyName, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<PrivateEndpointConnectionProxyInner> createWithResponse(String resourceGroupName, String vaultName,
        ...
        return createWithResponseAsync(resourceGroupName, vaultName, privateEndpointConnectionProxyName, body, context)
            .block();
    }
    ...
    public PrivateEndpointConnectionProxyInner create(String resourceGroupName, String vaultName,
        String privateEndpointConnectionProxyName, PrivateEndpointConnectionProxyInner body) {
        return createWithResponse(resourceGroupName, vaultName, privateEndpointConnectionProxyName, body, Context.NONE)
            .getValue();
    }
