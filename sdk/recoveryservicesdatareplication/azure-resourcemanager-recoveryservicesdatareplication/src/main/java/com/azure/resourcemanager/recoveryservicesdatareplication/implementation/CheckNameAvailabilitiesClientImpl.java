...
public final class CheckNameAvailabilitiesClientImpl implements CheckNameAvailabilitiesClient {
    ...
    public interface CheckNameAvailabilitiesService {
        ...
        Mono<Response<CheckNameAvailabilityResponseModelInner>> post(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @BodyParam("application/json") CheckNameAvailabilityModel body,
