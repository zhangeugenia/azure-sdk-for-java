...
import com.azure.resourcemanager.recoveryservicesdatareplication.models.JobModelListResult;
...
public final class JobsClientImpl implements JobsClient {
    ...
    public interface JobsService {
        ...
        Mono<Response<JobModelListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobModelInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
