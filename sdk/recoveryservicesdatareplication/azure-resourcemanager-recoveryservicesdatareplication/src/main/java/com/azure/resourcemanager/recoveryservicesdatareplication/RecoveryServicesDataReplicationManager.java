...
import com.azure.resourcemanager.recoveryservicesdatareplication.implementation.LocationBasedOperationResultsImpl;
...
public final class RecoveryServicesDataReplicationManager {
    ...
    private LocationBasedOperationResults locationBasedOperationResults;
    ...
    /**
     * Gets the resource collection API of LocationBasedOperationResults.
     * 
     * @return Resource collection API of LocationBasedOperationResults.
     */
    public LocationBasedOperationResults locationBasedOperationResults() {
        if (this.locationBasedOperationResults == null) {
            this.locationBasedOperationResults
                = new LocationBasedOperationResultsImpl(clientObject.getLocationBasedOperationResults(), this);
        }
        return locationBasedOperationResults;
    }
