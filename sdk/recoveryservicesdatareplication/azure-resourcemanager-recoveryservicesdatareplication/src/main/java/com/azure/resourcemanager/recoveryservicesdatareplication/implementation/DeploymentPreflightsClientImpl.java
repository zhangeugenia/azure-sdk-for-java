...
public final class DeploymentPreflightsClientImpl implements DeploymentPreflightsClient {
    ...
    public interface DeploymentPreflightsService {
        ...
        Mono<Response<DeploymentPreflightModelInner>> post(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<DeploymentPreflightModelInner>> postWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.post(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, deploymentId, body, accept, context))
    ...
    private Mono<Response<DeploymentPreflightModelInner>> postWithResponseAsync(String resourceGroupName,
        ...
        return service.post(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, deploymentId, body, accept, context);
    }
