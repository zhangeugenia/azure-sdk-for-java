...
public final class OperationResultsImpl implements OperationResults {
    ...
    public Response<OperationStatus> getWithResponse(String resourceGroupName, String operationId, Context context) {
        Response<OperationStatusInner> inner
            = this.serviceClient().getWithResponse(resourceGroupName, operationId, context);
        if (inner != null) {
    ...
    public OperationStatus get(String resourceGroupName, String operationId) {
        OperationStatusInner inner = this.serviceClient().get(resourceGroupName, operationId);
        if (inner != null) {
