        ...
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                if ("HyperVToAzStackHCI".equals(discriminatorValue)) {
                    return HyperVToAzStackHCIPlannedFailoverModelCustomProperties.fromJson(readerToUse.reset());
                } else if ("VMwareToAzStackHCI".equals(discriminatorValue)) {
                    return VMwareToAzStackHCIPlannedFailoverModelCustomProperties.fromJson(readerToUse.reset());
                } else {
