...
public final class PrivateLinkResourceProperties implements JsonSerializable<PrivateLinkResourceProperties> {
    ...
    /**
     * Set the groupId property: Gets or sets the group id.
     * 
    ...
    /**
     * Set the requiredMembers property: Gets or sets the required member. This translates to how many Private IPs
     * should be created for each privately linkable resource.
     * 
    ...
    /**
     * Set the requiredZoneNames property: Gets or sets the private DNS zone names.
     * 
