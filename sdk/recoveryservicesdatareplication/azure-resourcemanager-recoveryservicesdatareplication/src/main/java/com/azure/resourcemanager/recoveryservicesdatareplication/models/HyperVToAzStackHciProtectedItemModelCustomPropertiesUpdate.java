 ...
 */
@Fluent
public final class HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate
    ...
    /**
     * Creates an instance of HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate class.
     */
     ...
     * @return the HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate object itself.
     */
    public HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate
     ...
     * @return the HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate object itself.
     */
    public HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate withTargetCpuCores(Integer targetCpuCores) {
     ...
     * @return the HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate object itself.
     */
    public HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate withIsDynamicRam(Boolean isDynamicRam) {
     ...
     * @return the HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate object itself.
     */
    public HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate withOsType(String osType) {
        this.osType = osType;
        return this;
    }
    ...
    /**
     * Reads an instance of HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate if the JsonReader was pointing
     * to an instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the
     * HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.
     */
    public static HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            HyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("instanceType".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.instanceType
                        = reader.getString();
                    ...
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.nicsToInclude
                        = nicsToInclude;
                } else if ("targetCpuCores".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.targetCpuCores
                        = reader.getNullable(JsonReader::getInt);
                } else if ("isDynamicRam".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.isDynamicRam
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("dynamicMemoryConfig".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.dynamicMemoryConfig
                        = ProtectedItemDynamicMemoryConfig.fromJson(reader);
                } else if ("targetMemoryInMegaBytes".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.targetMemoryInMegaBytes
                        = reader.getNullable(JsonReader::getInt);
                } else if ("osType".equals(fieldName)) {
                    deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate.osType = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedHyperVToAzStackHciProtectedItemModelCustomPropertiesUpdate;
        });
    }
}
