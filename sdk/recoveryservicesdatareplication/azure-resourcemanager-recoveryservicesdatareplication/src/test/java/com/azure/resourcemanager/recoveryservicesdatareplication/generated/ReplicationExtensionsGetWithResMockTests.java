...
public final class ReplicationExtensionsGetWithResMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Deleting\",\"customProperties\":{\"instanceType\":\"ReplicationExtensionModelCustomProperties\"}},\"id\":\"ds\",\"name\":\"xmxeatkdb\",\"type\":\"wnrdjyibqbnaom\"}";
        ...
        ReplicationExtensionModel response = manager.replicationExtensions()
            .getWithResponse("owog", "gitsqh", "vbrzcdb", com.azure.core.util.Context.NONE)
            .getValue();
