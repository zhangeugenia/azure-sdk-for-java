...
public final class PoliciesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Failed\",\"customProperties\":{\"instanceType\":\"PolicyModelCustomProperties\"}},\"id\":\"zz\",\"name\":\"yjaf\",\"type\":\"tlhguynuchl\"}]}";
        ...
        PagedIterable<PolicyModel> response
            = manager.policies().list("pcrrk", "lawjmjsmwrok", com.azure.core.util.Context.NONE);
