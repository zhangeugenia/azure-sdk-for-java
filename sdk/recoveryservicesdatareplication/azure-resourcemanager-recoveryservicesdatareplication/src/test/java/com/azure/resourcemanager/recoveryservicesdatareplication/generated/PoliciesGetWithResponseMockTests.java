...
public final class PoliciesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Failed\",\"customProperties\":{\"instanceType\":\"PolicyModelCustomProperties\"}},\"id\":\"k\",\"name\":\"bqzolxr\",\"type\":\"vhqjwtrhtgvg\"}";
        ...
        PolicyModel response = manager.policies()
            .getWithResponse("jpu", "yjucejikzoeo", "vtzejetjklnti", com.azure.core.util.Context.NONE)
            .getValue();
