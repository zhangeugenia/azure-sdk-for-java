...
public final class PrivateEndpointConnectionsListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Updating\",\"privateEndpoint\":{\"id\":\"bhdyir\"},\"privateLinkServiceConnectionState\":{\"status\":\"Pending\",\"description\":\"ddei\",\"actionsRequired\":\"wzovgk\"}},\"id\":\"muikjcjcaztbws\",\"name\":\"sqowxwc\",\"type\":\"mlikytw\"}]}";
        ...
        PagedIterable<PrivateEndpointConnection> response
            = manager.privateEndpointConnections().list("ggsvoujkxibdaf", "rkmdyom", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("bhdyir", response.iterator().next().properties().privateEndpoint().id());
