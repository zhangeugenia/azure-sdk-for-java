...
public final class InitiateSessionHostUpdatesClientImpl implements InitiateSessionHostUpdatesClient {
    ...
    public interface InitiateSessionHostUpdatesService {
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> postSync(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("hostPoolName") String hostPoolName,
            @BodyParam("application/json") UpdateSessionHostsRequestBody updateSessionHostsRequestBody,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(InitiateSessionHostUpdatesClientImpl.class);
}
