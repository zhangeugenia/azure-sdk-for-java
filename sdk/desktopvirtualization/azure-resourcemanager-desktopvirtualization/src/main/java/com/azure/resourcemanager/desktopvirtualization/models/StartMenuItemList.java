...
public final class StartMenuItemList implements JsonSerializable<StartMenuItemList> {
    ...
    /**
     * Set the value property: The StartMenuItem items on this page.
     * 
     ...
     * @return the StartMenuItemList object itself.
     */
    public StartMenuItemList withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model StartMenuItemList"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(StartMenuItemList.class);
