...
public final class ControlSessionHostUpdatesClientImpl implements ControlSessionHostUpdatesClient {
    ...
    private Response<BinaryData> postWithResponse(String resourceGroupName, String hostPoolName,
        ...
        return service.postSync(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, hostPoolName, hostPoolUpdateControlParameter, accept, Context.NONE);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ControlSessionHostUpdatesClientImpl.class);
}
