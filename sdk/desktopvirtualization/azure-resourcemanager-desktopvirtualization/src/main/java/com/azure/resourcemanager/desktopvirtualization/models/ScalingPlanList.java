...
public final class ScalingPlanList implements JsonSerializable<ScalingPlanList> {
    ...
    /**
     * Set the value property: The ScalingPlan items on this page.
     * 
     ...
     * @return the ScalingPlanList object itself.
     */
    public ScalingPlanList withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ScalingPlanList"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ScalingPlanList.class);
