...
public final class AppAttachPackagesClientImpl implements AppAttachPackagesClient {
    ...
    public interface AppAttachPackagesService {
        ...
        Mono<Response<AppAttachPackageInner>> getByResourceGroup(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppAttachPackageInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appAttachPackageName") String appAttachPackageName,
            @BodyParam("application/json") AppAttachPackageInner appAttachPackage,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppAttachPackageInner>> update(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppAttachPackageList>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppAttachPackageList>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$filter") String filter,
    ...
    public Mono<Response<AppAttachPackageInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String appAttachPackageName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppAttachPackageInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppAttachPackageInner> getByResourceGroupWithResponse(
        String resourceGroupName, String appAttachPackageName, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return schema for App Attach Package properties along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<AppAttachPackageInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appAttachPackageName, AppAttachPackageInner appAttachPackage) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppAttachPackageInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppAttachPackageInner> createOrUpdateAsync(
        String resourceGroupName, String appAttachPackageName, AppAttachPackageInner appAttachPackage) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppAttachPackageInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String appAttachPackageName,
        AppAttachPackageInner appAttachPackage,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppAttachPackageInner createOrUpdate(
        String resourceGroupName, String appAttachPackageName, AppAttachPackageInner appAttachPackage) {
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(
        String resourceGroupName, String appAttachPackageName, Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<AppAttachPackageInner>> updateWithResponseAsync(
        String resourceGroupName, String appAttachPackageName, AppAttachPackagePatch appAttachPackagePatch) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppAttachPackageInner>> updateWithResponseAsync(
        String resourceGroupName,
        String appAttachPackageName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppAttachPackageInner> updateWithResponse(
        String resourceGroupName,
        String appAttachPackageName,
        AppAttachPackagePatch appAttachPackagePatch,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppAttachPackageInner>> listByResourceGroupSinglePageAsync(
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<AppAttachPackageInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AppAttachPackageInner> listByResourceGroupAsync(
        String resourceGroupName, String filter, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AppAttachPackageInner> listByResourceGroup(
        String resourceGroupName, String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppAttachPackageInner>> listByResourceGroupNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppAttachPackageInner>> listBySubscriptionNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
