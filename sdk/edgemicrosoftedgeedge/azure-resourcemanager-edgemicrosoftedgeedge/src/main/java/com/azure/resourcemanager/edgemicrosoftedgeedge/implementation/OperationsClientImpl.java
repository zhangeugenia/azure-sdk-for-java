...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    private final MicrosoftEdgeTestImpl client;
     ...
     */
    OperationsClientImpl(MicrosoftEdgeTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftEdgeTestOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftEdgeTestOpe")
