...
package com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationprivatelinkscopes.fluent;
...
public interface PrivateLinkScopesClient {
    ...
    PagedIterable<KubernetesConfigurationPrivateLinkScopeInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<KubernetesConfigurationPrivateLinkScopeInner> list(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<KubernetesConfigurationPrivateLinkScopeInner> listByResourceGroup(String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<KubernetesConfigurationPrivateLinkScopeInner> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<KubernetesConfigurationPrivateLinkScopeInner> createOrUpdateWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<KubernetesConfigurationPrivateLinkScopeInner> updateTagsWithResponse(String resourceGroupName,
