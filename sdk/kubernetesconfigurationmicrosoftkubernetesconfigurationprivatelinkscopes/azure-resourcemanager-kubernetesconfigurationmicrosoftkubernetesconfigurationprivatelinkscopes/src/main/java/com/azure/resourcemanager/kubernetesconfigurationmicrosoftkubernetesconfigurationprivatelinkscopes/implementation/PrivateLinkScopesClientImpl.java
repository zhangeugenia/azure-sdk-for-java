...
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationprivatelinkscopes.fluent.PrivateLinkScopesClient;
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationprivatelinkscopes.fluent.models.KubernetesConfigurationPrivateLinkScopeInner;
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationprivatelinkscopes.models.KubernetesConfigurationPrivateLinkScopeListResult;
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationprivatelinkscopes.models.TagsResource;
...
public final class PrivateLinkScopesClientImpl implements PrivateLinkScopesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<KubernetesConfigurationPrivateLinkScopeInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<KubernetesConfigurationPrivateLinkScopeInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String scopeName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String scopeName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, scopeName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<KubernetesConfigurationPrivateLinkScopeInner>> updateTagsWithResponseAsync(
