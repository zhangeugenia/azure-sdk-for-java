...
public final class CompoundAssessmentOperationsDeleteWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.compoundAssessmentOperations()
            .deleteWithResponse("vfyexfw", "ybcibvyvdcsit", "nnaamdectehfiqsc", com.azure.core.util.Context.NONE);
