...
public final class MachineAssessmentsV2OperationsDeleteWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.machineAssessmentsV2Operations()
            .deleteWithResponse("kbebxmubyyntwlrb", "tkoievseotgq", "l", com.azure.core.util.Context.NONE);
