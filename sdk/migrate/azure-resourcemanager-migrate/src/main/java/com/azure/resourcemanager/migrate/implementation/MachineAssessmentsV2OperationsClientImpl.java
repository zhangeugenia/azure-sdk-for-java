...
import com.azure.resourcemanager.migrate.implementation.models.MachineAssessmentV2ListResult;
...
public final class MachineAssessmentsV2OperationsClientImpl implements MachineAssessmentsV2OperationsClient {
     ...
     */
    MachineAssessmentsV2OperationsClientImpl(MigrateClientImpl client) {
    ...
    /**
     * The interface defining all the services for MigrateClientMachineAssessmentsV2Operations to be used by the proxy
    ...
    public interface MachineAssessmentsV2OperationsService {
        ...
        Mono<Response<MachineAssessmentV2Inner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineAssessmentV2ListResult>> listByParent(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("endpoint") String endpoint,
            ...
            @HeaderParam("Accept") String accept, @BodyParam("application/json") MachineAssessmentV2Inner resource,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> downloadUrl(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
            @PathParam("assessmentName") String assessmentName, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") DownloadUrlRequest body,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, projectName, assessmentName, contentType, accept,
                resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, projectName, assessmentName, contentType, accept, resource, context);
    }
     ...
     * 
     * Get the URL for downloading the assessment in a report format along with {@link Response} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> downloadUrlWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, DownloadUrlRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> downloadUrlWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, DownloadUrlRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.downloadUrl(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, projectName, assessmentName, contentType, accept, body,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of download URL for the assessment report.
     * 
     * Get the URL for downloading the assessment in a report format.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @return download URL for the assessment report.
     * 
     * Get the URL for downloading the assessment in a report format on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
