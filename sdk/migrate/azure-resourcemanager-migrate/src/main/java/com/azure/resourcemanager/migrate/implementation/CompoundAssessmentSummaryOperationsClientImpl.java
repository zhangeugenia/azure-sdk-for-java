...
public final class CompoundAssessmentSummaryOperationsClientImpl implements CompoundAssessmentSummaryOperationsClient {
    ...
    public interface CompoundAssessmentSummaryOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebAppCompoundAssessmentSummaryInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
            @PathParam("compoundAssessmentName") String compoundAssessmentName,
            @PathParam("summaryName") String summaryName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebAppCompoundAssessmentSummaryListResult> listByParentSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
            @PathParam("compoundAssessmentName") String compoundAssessmentName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WebAppCompoundAssessmentSummaryListResult> listByParentNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("endpoint") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<WebAppCompoundAssessmentSummaryInner> getWithResponse(String resourceGroupName, String projectName,
        ...
        if (summaryName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter summaryName is required and cannot be null."));
        }
        final String accept = "application/json";
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a WebAppCompoundAssessmentSummary list operation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebAppCompoundAssessmentSummaryInner> listByParentSinglePage(String resourceGroupName,
        String projectName, String compoundAssessmentName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<WebAppCompoundAssessmentSummaryListResult> res = service.listByParentSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, projectName,
            compoundAssessmentName, accept, Context.NONE);
    ...
    private PagedResponse<WebAppCompoundAssessmentSummaryInner> listByParentSinglePage(String resourceGroupName,
        ...
        Response<WebAppCompoundAssessmentSummaryListResult> res = service.listByParentSync(this.client.getEndpoint(),
            this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, projectName,
            compoundAssessmentName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<WebAppCompoundAssessmentSummaryInner> listByParent(String resourceGroupName,
        String projectName, String compoundAssessmentName) {
        return new PagedIterable<>(() -> listByParentSinglePage(resourceGroupName, projectName, compoundAssessmentName),
    ...
    public PagedIterable<WebAppCompoundAssessmentSummaryInner> listByParent(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByParentSinglePage(resourceGroupName, projectName, compoundAssessmentName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WebAppCompoundAssessmentSummaryInner> listByParentNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<WebAppCompoundAssessmentSummaryListResult> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CompoundAssessmentSummaryOperationsClientImpl.class);
}
