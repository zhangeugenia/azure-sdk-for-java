...
public final class Error implements JsonSerializable<Error> {
     ...
     */
    private List<NameValuePair> messageParameters;
     ...
     */
    public List<NameValuePair> messageParameters() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    List<NameValuePair> messageParameters
                        = reader.readArray(reader1 -> NameValuePair.fromJson(reader1));
