...
public final class GatewayImpl implements Gateway, Gateway.Definition, Gateway.Update {
    ...
    public ApplicationOwnerProperties configuredApplicationOwner() {
        return this.innerModel().configuredApplicationOwner();
    }
    ...
    public GatewayImpl withConfiguredApplication(ApplicationProperties configuredApplication) {
        this.innerModel().withConfiguredApplication(configuredApplication);
        return this;
    }

    public GatewayImpl withConfiguredApplicationOwner(ApplicationOwnerProperties configuredApplicationOwner) {
        this.innerModel().withConfiguredApplicationOwner(configuredApplicationOwner);
        return this;
    }
