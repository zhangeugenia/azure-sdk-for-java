    ...
    public void validate() {
        if (countryCode() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property countryCode in model DataRegions"));
        }
        if (dataPrivacyFrameworkUrl() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property dataPrivacyFrameworkUrl in model DataRegions"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DataRegions.class);
