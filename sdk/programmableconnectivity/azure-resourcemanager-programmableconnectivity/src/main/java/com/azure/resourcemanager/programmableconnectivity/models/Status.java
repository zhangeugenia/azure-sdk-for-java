...
public final class Status implements JsonSerializable<Status> {
    ...
    /**
     * Set the state property: Current state of the OperatorApiConnection resource.
     * 
    ...
    /**
     * Set the reason property: Explanation of the current state of the OperatorApiConnection resource.
     * 
