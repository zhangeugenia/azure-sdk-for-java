...
public final class LocalRepresentative implements JsonSerializable<LocalRepresentative> {
     ...
     */
    private Person localRepresentativePerson;
    ...
    /**
     * Get the localRepresentativePerson property: Local representative for this country/region.
     * 
     * @return the localRepresentativePerson value.
     */
    public Person localRepresentativePerson() {
        return this.localRepresentativePerson;
    }

    /**
     * Set the localRepresentativePerson property: Local representative for this country/region.
     * 
     * @param localRepresentativePerson the localRepresentativePerson value to set.
     * @return the LocalRepresentative object itself.
     */
    public LocalRepresentative withLocalRepresentativePerson(Person localRepresentativePerson) {
        this.localRepresentativePerson = localRepresentativePerson;
        return this;
    }
    ...
    public void validate() {
        ...
        if (localRepresentativePerson() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property localRepresentativePerson in model LocalRepresentative"));
        } else {
            localRepresentativePerson().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("localRepresentativePerson", this.localRepresentativePerson);
    ...
    public static LocalRepresentative fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("localRepresentativePerson".equals(fieldName)) {
                    deserializedLocalRepresentative.localRepresentativePerson = Person.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
