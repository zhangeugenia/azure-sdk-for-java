        ...
        if (configuredApplication() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property configuredApplication in model GatewayProperties"));
        } else {
            configuredApplication().validate();
        }
        if (configuredApplicationOwner() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property configuredApplicationOwner in model GatewayProperties"));
        } else {
            configuredApplicationOwner().validate();
        }
    }
