...
import com.azure.resourcemanager.programmableconnectivity.models.OperatorApiPlanListResult;
...
public final class OperatorApiPlansClientImpl implements OperatorApiPlansClient {
     ...
     */
    OperatorApiPlansClientImpl(ProgrammableConnectivityImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ProgrammableConnectivityOperatorApiPlans to be used by the proxy
    ...
    public interface OperatorApiPlansService {
        ...
        Mono<Response<OperatorApiPlanListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OperatorApiPlanInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<OperatorApiPlanInner> listAsync(String filter, Integer top, Integer skip, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperatorApiPlanInner>> getWithResponseAsync(String operatorApiPlanName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
