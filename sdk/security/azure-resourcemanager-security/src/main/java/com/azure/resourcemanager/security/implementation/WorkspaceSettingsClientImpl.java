...
public final class WorkspaceSettingsClientImpl implements WorkspaceSettingsClient {
    ...
    public interface WorkspaceSettingsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WorkspaceSettingList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WorkspaceSettingInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("workspaceSettingName") String workspaceSettingName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WorkspaceSettingInner> createSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("workspaceSettingName") String workspaceSettingName,
            @BodyParam("application/json") WorkspaceSettingInner workspaceSetting, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WorkspaceSettingInner> updateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("workspaceSettingName") String workspaceSettingName,
            @BodyParam("application/json") WorkspaceSettingInner workspaceSetting, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<WorkspaceSettingList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of workspace settings response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WorkspaceSettingInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2017-08-01-preview";
        final String accept = "application/json";
        Response<WorkspaceSettingList> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WorkspaceSettingInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2017-08-01-preview";
        final String accept = "application/json";
        Response<WorkspaceSettingList> res
    ...
    public Response<WorkspaceSettingInner> getWithResponse(String workspaceSettingName, Context context) {
        ...
        if (workspaceSettingName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter workspaceSettingName is required and cannot be null."));
        }
        final String apiVersion = "2017-08-01-preview";
        final String accept = "application/json";
    ...
    public Response<WorkspaceSettingInner> createWithResponse(String workspaceSettingName,
        ...
        if (workspaceSetting == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter workspaceSetting is required and cannot be null."));
        } else {
            workspaceSetting.validate();
        }
        final String apiVersion = "2017-08-01-preview";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WorkspaceSettingInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<WorkspaceSettingInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<WorkspaceSettingList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(WorkspaceSettingsClientImpl.class);
}
