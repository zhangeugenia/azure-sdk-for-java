...
public final class TasksClientImpl implements TasksClient {
    ...
    public interface TasksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listByHomeRegionSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("ascLocation") String ascLocation, @QueryParam("$filter") String filter,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskInner> getSubscriptionLevelTaskSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("ascLocation") String ascLocation, @PathParam("taskName") String taskName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> updateSubscriptionLevelTaskStateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("ascLocation") String ascLocation, @PathParam("taskName") String taskName,
            @PathParam("taskUpdateActionType") TaskUpdateActionType taskUpdateActionType,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ascLocation") String ascLocation,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskInner> getResourceGroupLevelTaskSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ascLocation") String ascLocation,
            @PathParam("taskName") String taskName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<Void> updateResourceGroupLevelTaskStateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ascLocation") String ascLocation,
            @PathParam("taskName") String taskName,
            @PathParam("taskUpdateActionType") TaskUpdateActionType taskUpdateActionType,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listByHomeRegionNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityTaskList> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of security task recommendations along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listSinglePage(String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        Response<SecurityTaskList> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listSinglePage(String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByHomeRegionSinglePage(String ascLocation, String filter) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        Response<SecurityTaskList> res = service.listByHomeRegionSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), ascLocation, filter, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SecurityTaskInner> listByHomeRegion(String ascLocation) {
        final String filter = null;
        return new PagedIterable<>(() -> listByHomeRegionSinglePage(ascLocation, filter),
            nextLink -> listByHomeRegionNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<SecurityTaskInner> listByHomeRegion(String ascLocation, String filter, Context context) {
        return new PagedIterable<>(() -> listByHomeRegionSinglePage(ascLocation, filter, context),
            nextLink -> listByHomeRegionNextSinglePage(nextLink, context));
    }
    ...
    public Response<SecurityTaskInner> getSubscriptionLevelTaskWithResponse(String ascLocation, String taskName,
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        return service.getSubscriptionLevelTaskSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), ascLocation, taskName, accept, context);
    }
    ...
    public Response<Void> updateSubscriptionLevelTaskStateWithResponse(String ascLocation, String taskName,
        ...
        if (taskUpdateActionType == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter taskUpdateActionType is required and cannot be null."));
        }
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        return service.updateSubscriptionLevelTaskStateSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), ascLocation, taskName, taskUpdateActionType, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByResourceGroupSinglePage(String resourceGroupName, String ascLocation,
        String filter) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        Response<SecurityTaskList> res = service.listByResourceGroupSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, ascLocation, filter, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SecurityTaskInner> listByResourceGroup(String resourceGroupName, String ascLocation) {
        final String filter = null;
        return new PagedIterable<>(() -> listByResourceGroupSinglePage(resourceGroupName, ascLocation, filter),
    ...
    public PagedIterable<SecurityTaskInner> listByResourceGroup(String resourceGroupName, String ascLocation,
        String filter, Context context) {
        return new PagedIterable<>(() -> listByResourceGroupSinglePage(resourceGroupName, ascLocation, filter, context),
    ...
    public Response<SecurityTaskInner> getResourceGroupLevelTaskWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        return service.getResourceGroupLevelTaskSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, ascLocation, taskName, accept, context);
    }
    ...
    public Response<Void> updateResourceGroupLevelTaskStateWithResponse(String resourceGroupName, String ascLocation,
        ...
        final String apiVersion = "2015-06-01-preview";
        final String accept = "application/json";
        return service.updateResourceGroupLevelTaskStateSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, ascLocation, taskName, taskUpdateActionType, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<SecurityTaskList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByHomeRegionNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<SecurityTaskList> res
            = service.listByHomeRegionNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByHomeRegionNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<SecurityTaskList> res
            = service.listByHomeRegionNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecurityTaskInner> listByResourceGroupNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
