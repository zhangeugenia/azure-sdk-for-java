...
public final class BlobsScanSummary implements JsonSerializable<BlobsScanSummary> {
    ...
    /**
     * Set the failedBlobsCount property: The number of failed blob scans.
     * 
     * @param failedBlobsCount the failedBlobsCount value to set.
     * @return the BlobsScanSummary object itself.
     */
    public BlobsScanSummary withFailedBlobsCount(Long failedBlobsCount) {
        this.failedBlobsCount = failedBlobsCount;
        return this;
    }
