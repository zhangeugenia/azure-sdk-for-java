...
public interface DefenderForStorages {
     ...
     */
    Response<DefenderForStorageSetting> getWithResponse(String resourceId, SettingNameAutoGenerated settingName,
        Context context);
     ...
     */
    Response<MalwareScan> startMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
        Context context);
     ...
     */
    MalwareScan startMalwareScan(String resourceId, SettingNameAutoGenerated settingName);
     ...
     * @return describes the state of a malware scan operation along with {@link Response}.
     */
    Response<MalwareScan> cancelMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
     ...
     * @return describes the state of a malware scan operation.
     */
    MalwareScan cancelMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId);
     ...
     */
    Response<MalwareScan> getMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
        String scanId, Context context);
     ...
     */
    MalwareScan getMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId);
