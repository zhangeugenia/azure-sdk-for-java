...
public final class GovernanceRulesClientImpl implements GovernanceRulesClient {
    ...
    public interface GovernanceRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceRuleList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceRuleInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("ruleId") String ruleId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceRuleInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("ruleId") String ruleId, @BodyParam("application/json") GovernanceRuleInner governanceRule,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> executeSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("ruleId") String ruleId,
            @BodyParam("application/json") ExecuteGovernanceRuleParams executeGovernanceRuleParams,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        GovernanceRulesOperationResultsResponse operationResultsSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("ruleId") String ruleId, @PathParam("operationId") String operationId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceRuleList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of all relevant governance rules over a scope along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceRuleInner> listSinglePage(String scope) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        Response<GovernanceRuleList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceRuleInner> listSinglePage(String scope, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public Response<GovernanceRuleInner> getWithResponse(String scope, String ruleId, Context context) {
        ...
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, scope, ruleId, accept, context);
    }
    ...
    public Response<GovernanceRuleInner> createOrUpdateWithResponse(String scope, String ruleId,
        ...
        if (governanceRule == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter governanceRule is required and cannot be null."));
        } else {
            governanceRule.validate();
        }
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, scope, ruleId, governanceRule, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String scope, String ruleId) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2022-01-01-preview";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, scope, ruleId, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String scope, String ruleId, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2022-01-01-preview";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, scope, ruleId, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String ruleId) {
        Response<BinaryData> response = deleteWithResponse(scope, ruleId);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String ruleId, Context context) {
        Response<BinaryData> response = deleteWithResponse(scope, ruleId, context);
    ...
    public void delete(String scope, String ruleId) {
        beginDelete(scope, ruleId).getFinalResult();
    }
    ...
    public void delete(String scope, String ruleId, Context context) {
        beginDelete(scope, ruleId, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> executeWithResponse(String scope, String ruleId,
        ExecuteGovernanceRuleParams executeGovernanceRuleParams) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.executeSync(this.client.getEndpoint(), apiVersion, scope, ruleId, executeGovernanceRuleParams,
            accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExecute(String scope, String ruleId,
        ExecuteGovernanceRuleParams executeGovernanceRuleParams) {
        Response<BinaryData> response = executeWithResponse(scope, ruleId, executeGovernanceRuleParams);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExecute(String scope, String ruleId,
        ExecuteGovernanceRuleParams executeGovernanceRuleParams, Context context) {
        Response<BinaryData> response = executeWithResponse(scope, ruleId, executeGovernanceRuleParams, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void execute(String scope, String ruleId) {
        final ExecuteGovernanceRuleParams executeGovernanceRuleParams = null;
        beginExecute(scope, ruleId, executeGovernanceRuleParams).getFinalResult();
    }
    ...
    public void execute(String scope, String ruleId, ExecuteGovernanceRuleParams executeGovernanceRuleParams,
        Context context) {
        beginExecute(scope, ruleId, executeGovernanceRuleParams, context).getFinalResult();
    }
    ...
    public GovernanceRulesOperationResultsResponse operationResultsWithResponse(String scope, String ruleId,
        ...
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.operationResultsSync(this.client.getEndpoint(), apiVersion, scope, ruleId, operationId, accept,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return page of a governance rules list along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceRuleInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceRuleInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<GovernanceRuleList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(GovernanceRulesClientImpl.class);
}
