...
public final class ConnectorsClientImpl implements ConnectorsClient {
    ...
    public interface ConnectorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectorSettingList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectorSettingInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("connectorName") String connectorName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectorSettingInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("connectorName") String connectorName,
            @BodyParam("application/json") ConnectorSettingInner connectorSetting, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectorSettingList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectorSettingInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2020-01-01-preview";
        final String accept = "application/json";
        Response<ConnectorSettingList> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectorSettingInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2020-01-01-preview";
        final String accept = "application/json";
        Response<ConnectorSettingList> res
    ...
    public Response<ConnectorSettingInner> getWithResponse(String connectorName, Context context) {
        ...
        final String apiVersion = "2020-01-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), connectorName,
            accept, context);
    }
    ...
    public Response<ConnectorSettingInner> createOrUpdateWithResponse(String connectorName,
        ...
        if (connectorSetting == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter connectorSetting is required and cannot be null."));
        } else {
            connectorSetting.validate();
        }
        final String apiVersion = "2020-01-01-preview";
    ...
    public Response<Void> deleteWithResponse(String connectorName, Context context) {
        ...
        final String apiVersion = "2020-01-01-preview";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), connectorName,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectorSettingInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectorSettingInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ConnectorSettingList> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(ConnectorsClientImpl.class);
}
