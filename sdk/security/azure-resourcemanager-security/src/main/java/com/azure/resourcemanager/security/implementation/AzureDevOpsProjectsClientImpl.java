...
public final class AzureDevOpsProjectsClientImpl implements AzureDevOpsProjectsClient {
    ...
    public interface AzureDevOpsProjectsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AzureDevOpsProjectListResponse> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName, @PathParam("orgName") String orgName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AzureDevOpsProjectInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName, @PathParam("orgName") String orgName,
            @PathParam("projectName") String projectName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AzureDevOpsProjectListResponse> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AzureDevOpsProjectInner> listSinglePage(String resourceGroupName,
        String securityConnectorName, String orgName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<AzureDevOpsProjectListResponse> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                securityConnectorName, orgName, apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<AzureDevOpsProjectInner> list(String resourceGroupName, String securityConnectorName,
        String orgName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, securityConnectorName, orgName),
    ...
    public PagedIterable<AzureDevOpsProjectInner> list(String resourceGroupName, String securityConnectorName,
        ...
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, securityConnectorName, orgName, context),
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String securityConnectorName,
        ...
        if (azureDevOpsProject == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter azureDevOpsProject is required and cannot be null."));
        } else {
            azureDevOpsProject.validate();
        }
        final String apiVersion = "2025-03-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            securityConnectorName, orgName, projectName, apiVersion, azureDevOpsProject, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginCreateOrUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName,
        AzureDevOpsProjectInner azureDevOpsProject) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, securityConnectorName, orgName,
            projectName, azureDevOpsProject);
        return this.client.<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(response,
            AzureDevOpsProjectInner.class, AzureDevOpsProjectInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, securityConnectorName, orgName,
            projectName, azureDevOpsProject, context);
        return this.client.<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(response,
            AzureDevOpsProjectInner.class, AzureDevOpsProjectInner.class, context);
    }
    ...
    public AzureDevOpsProjectInner createOrUpdate(String resourceGroupName, String securityConnectorName,
        String orgName, String projectName, AzureDevOpsProjectInner azureDevOpsProject) {
        return beginCreateOrUpdate(resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginUpdate(
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject);
        return this.client.<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(response,
            AzureDevOpsProjectInner.class, AzureDevOpsProjectInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName,
        AzureDevOpsProjectInner azureDevOpsProject, Context context) {
        Response<BinaryData> response = updateWithResponse(resourceGroupName, securityConnectorName, orgName,
            projectName, azureDevOpsProject, context);
        return this.client.<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(response,
            AzureDevOpsProjectInner.class, AzureDevOpsProjectInner.class, context);
    }
    ...
    public AzureDevOpsProjectInner update(String resourceGroupName, String securityConnectorName, String orgName,
        ...
        return beginUpdate(resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject)
            .getFinalResult();
    }
    ...
    public AzureDevOpsProjectInner update(String resourceGroupName, String securityConnectorName, String orgName,
        ...
        return beginUpdate(resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AzureDevOpsProjectInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AzureDevOpsProjectInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureDevOpsProjectsClientImpl.class);
}
