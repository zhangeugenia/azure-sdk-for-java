...
public final class SecurityOperatorsClientImpl implements SecurityOperatorsClient {
    ...
    public interface SecurityOperatorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityOperatorListInner> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("pricingName") String pricingName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityOperatorInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("pricingName") String pricingName,
            @PathParam("securityOperatorName") String securityOperatorName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecurityOperatorInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("pricingName") String pricingName,
            @PathParam("securityOperatorName") String securityOperatorName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Response<SecurityOperatorListInner> listWithResponse(String pricingName, Context context) {
        ...
        final String apiVersion = "2023-01-01-preview";
        final String accept = "application/json";
        return service.listSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), pricingName,
            accept, context);
    }
    ...
    public Response<SecurityOperatorInner> getWithResponse(String pricingName, String securityOperatorName,
        ...
        if (securityOperatorName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter securityOperatorName is required and cannot be null."));
        }
        final String apiVersion = "2023-01-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), pricingName,
    ...
    public Response<Void> deleteWithResponse(String pricingName, String securityOperatorName, Context context) {
        ...
        final String apiVersion = "2023-01-01-preview";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), pricingName,
            securityOperatorName, accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SecurityOperatorsClientImpl.class);
}
