...
public final class GovernanceAssignmentsClientImpl implements GovernanceAssignmentsClient {
    ...
    public interface GovernanceAssignmentsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceAssignmentsList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("assessmentName") String assessmentName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceAssignmentInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("assessmentName") String assessmentName, @PathParam("assignmentKey") String assignmentKey,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceAssignmentInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scope") String scope,
            @PathParam("assessmentName") String assessmentName, @PathParam("assignmentKey") String assignmentKey,
            @BodyParam("application/json") GovernanceAssignmentInner governanceAssignment,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GovernanceAssignmentsList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return governance assignments on all of your resources inside a scope along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceAssignmentInner> listSinglePage(String scope, String assessmentName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        Response<GovernanceAssignmentsList> res
    ...
    public Response<GovernanceAssignmentInner> getWithResponse(String scope, String assessmentName,
        ...
        if (assignmentKey == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter assignmentKey is required and cannot be null."));
        }
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, assignmentKey, accept,
            context);
    }
    ...
    public Response<GovernanceAssignmentInner> createOrUpdateWithResponse(String scope, String assessmentName,
        ...
        if (governanceAssignment == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter governanceAssignment is required and cannot be null."));
        } else {
            governanceAssignment.validate();
        }
        final String apiVersion = "2022-01-01-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, assignmentKey,
    ...
    public Response<Void> deleteWithResponse(String scope, String assessmentName, String assignmentKey,
        ...
        final String apiVersion = "2022-01-01-preview";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, assignmentKey, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return page of a governance assignments list along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceAssignmentInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GovernanceAssignmentInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(GovernanceAssignmentsClientImpl.class);
}
