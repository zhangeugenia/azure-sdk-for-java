...
public final class OnUploadProperties implements JsonSerializable<OnUploadProperties> {
    ...
    /*
     * Defines the max GB to be scanned per Month. Set to -1 if no capping is needed. If not specified, the default
     * value is -1.
     */
    ...
    /**
     * Get the capGBPerMonth property: Defines the max GB to be scanned per Month. Set to -1 if no capping is needed. If
    ...
    /**
     * Set the capGBPerMonth property: Defines the max GB to be scanned per Month. Set to -1 if no capping is needed. If
     * not specified, the default value is -1.
     * 
