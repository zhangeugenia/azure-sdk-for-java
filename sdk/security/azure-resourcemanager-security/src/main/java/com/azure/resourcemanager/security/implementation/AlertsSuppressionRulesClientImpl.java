...
public final class AlertsSuppressionRulesClientImpl implements AlertsSuppressionRulesClient {
    ...
    public interface AlertsSuppressionRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AlertsSuppressionRulesList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("AlertType") String alertType, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AlertsSuppressionRuleInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("alertsSuppressionRuleName") String alertsSuppressionRuleName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AlertsSuppressionRuleInner> updateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("alertsSuppressionRuleName") String alertsSuppressionRuleName,
            @BodyParam("application/json") AlertsSuppressionRuleInner alertsSuppressionRule,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AlertsSuppressionRulesList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return suppression rules list for subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AlertsSuppressionRuleInner> listSinglePage(String alertType) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2019-01-01-preview";
        final String accept = "application/json";
        Response<AlertsSuppressionRulesList> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), alertType, accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AlertsSuppressionRuleInner> listSinglePage(String alertType, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public PagedIterable<AlertsSuppressionRuleInner> list() {
        final String alertType = null;
        return new PagedIterable<>(() -> listSinglePage(alertType), nextLink -> listNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<AlertsSuppressionRuleInner> list(String alertType, Context context) {
        return new PagedIterable<>(() -> listSinglePage(alertType, context),
    ...
    public Response<AlertsSuppressionRuleInner> updateWithResponse(String alertsSuppressionRuleName,
        ...
        if (alertsSuppressionRule == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter alertsSuppressionRule is required and cannot be null."));
        } else {
            alertsSuppressionRule.validate();
        }
        final String apiVersion = "2019-01-01-preview";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AlertsSuppressionRuleInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AlertsSuppressionRulesList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AlertsSuppressionRuleInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AlertsSuppressionRulesClientImpl.class);
}
