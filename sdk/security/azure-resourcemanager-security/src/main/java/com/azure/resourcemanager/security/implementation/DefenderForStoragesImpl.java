...
public final class DefenderForStoragesImpl implements DefenderForStorages {
    ...
    public Response<MalwareScan> startMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
        Context context) {
    ...
    public MalwareScan startMalwareScan(String resourceId, SettingNameAutoGenerated settingName) {
    ...
    public Response<MalwareScan> cancelMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
    ...
    public MalwareScan cancelMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId) {
    ...
    public Response<MalwareScan> getMalwareScanWithResponse(String resourceId, SettingNameAutoGenerated settingName,
        String scanId, Context context) {
        Response<MalwareScanInner> inner
    ...
    public MalwareScan getMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId) {
