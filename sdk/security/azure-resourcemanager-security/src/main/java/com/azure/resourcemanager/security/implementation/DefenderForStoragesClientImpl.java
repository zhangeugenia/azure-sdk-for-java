...
public final class DefenderForStoragesClientImpl implements DefenderForStoragesClient {
    ...
    public interface DefenderForStoragesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DefenderForStorageSettingInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DefenderForStorageSettingInner> createSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName,
            @BodyParam("application/json") DefenderForStorageSettingInner defenderForStorageSetting,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MalwareScanInner> startMalwareScanSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<MalwareScanInner>> cancelMalwareScan(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName, @PathParam("scanId") String scanId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MalwareScanInner> cancelMalwareScanSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName, @PathParam("scanId") String scanId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MalwareScanInner> getMalwareScanSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName, @PathParam("scanId") String scanId,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<DefenderForStorageSettingInner> getWithResponse(String resourceId,
        ...
        final String apiVersion = "2025-01-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, resourceId, settingName, accept, context);
    }
    ...
    public Response<DefenderForStorageSettingInner> createWithResponse(String resourceId,
        ...
        final String apiVersion = "2025-01-01";
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), apiVersion, resourceId, settingName,
            defenderForStorageSetting, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MalwareScanInner> startMalwareScanAsync(String resourceId, SettingNameAutoGenerated settingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MalwareScanInner> startMalwareScanWithResponse(String resourceId,
        SettingNameAutoGenerated settingName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2025-01-01";
        final String accept = "application/json";
        return service.startMalwareScanSync(this.client.getEndpoint(), apiVersion, resourceId, settingName, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MalwareScanInner startMalwareScan(String resourceId, SettingNameAutoGenerated settingName) {
    ...
    private Mono<Response<MalwareScanInner>> cancelMalwareScanWithResponseAsync(String resourceId,
        SettingNameAutoGenerated settingName, String scanId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MalwareScanInner> cancelMalwareScanAsync(String resourceId, SettingNameAutoGenerated settingName,
        String scanId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MalwareScanInner> cancelMalwareScanWithResponse(String resourceId,
        SettingNameAutoGenerated settingName, String scanId, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2025-01-01";
        final String accept = "application/json";
        return service.cancelMalwareScanSync(this.client.getEndpoint(), apiVersion, resourceId, settingName, scanId,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MalwareScanInner cancelMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MalwareScanInner>> getMalwareScanWithResponseAsync(String resourceId,
        SettingNameAutoGenerated settingName, String scanId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MalwareScanInner> getMalwareScanAsync(String resourceId, SettingNameAutoGenerated settingName,
        String scanId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MalwareScanInner> getMalwareScanWithResponse(String resourceId,
        SettingNameAutoGenerated settingName, String scanId, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2025-01-01";
        final String accept = "application/json";
        return service.getMalwareScanSync(this.client.getEndpoint(), apiVersion, resourceId, settingName, scanId,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MalwareScanInner getMalwareScan(String resourceId, SettingNameAutoGenerated settingName, String scanId) {
        return getMalwareScanWithResponse(resourceId, settingName, scanId, Context.NONE).getValue();
    }

    private static final ClientLogger LOGGER = new ClientLogger(DefenderForStoragesClientImpl.class);
}
