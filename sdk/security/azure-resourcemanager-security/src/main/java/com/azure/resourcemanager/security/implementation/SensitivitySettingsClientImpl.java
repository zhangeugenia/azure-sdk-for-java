...
public final class SensitivitySettingsClientImpl implements SensitivitySettingsClient {
    ...
    public interface SensitivitySettingsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GetSensitivitySettingsResponseInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateSensitivitySettingsRequest sensitivitySettings,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GetSensitivitySettingsResponseInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GetSensitivitySettingsListResponseInner> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<GetSensitivitySettingsResponseInner>
        ...
        if (sensitivitySettings == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter sensitivitySettings is required and cannot be null."));
        } else {
            sensitivitySettings.validate();
        }
        final String apiVersion = "2023-02-15-preview";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), apiVersion, sensitivitySettings, accept, context);
    }
    ...
    public Response<GetSensitivitySettingsResponseInner> getWithResponse(Context context) {
        ...
        final String apiVersion = "2023-02-15-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SensitivitySettingsClientImpl.class);
}
