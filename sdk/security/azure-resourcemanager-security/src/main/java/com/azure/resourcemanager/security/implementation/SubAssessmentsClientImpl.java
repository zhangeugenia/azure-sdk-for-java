...
public final class SubAssessmentsClientImpl implements SubAssessmentsClient {
    ...
    public interface SubAssessmentsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecuritySubAssessmentList> listAllSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecuritySubAssessmentList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("assessmentName") String assessmentName, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecuritySubAssessmentInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("assessmentName") String assessmentName,
            @PathParam("subAssessmentName") String subAssessmentName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecuritySubAssessmentList> listAllNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SecuritySubAssessmentList> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listAllSinglePage(String scope) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2019-01-01-preview";
        final String accept = "application/json";
        Response<SecuritySubAssessmentList> res
            = service.listAllSync(this.client.getEndpoint(), apiVersion, scope, accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listAllSinglePage(String scope, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<SecuritySubAssessmentList> res
            = service.listAllSync(this.client.getEndpoint(), apiVersion, scope, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SecuritySubAssessmentInner> listAll(String scope) {
        return new PagedIterable<>(() -> listAllSinglePage(scope), nextLink -> listAllNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<SecuritySubAssessmentInner> listAll(String scope, Context context) {
        return new PagedIterable<>(() -> listAllSinglePage(scope, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return security sub-assessments on all your scanned resources inside a scope along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listSinglePage(String scope, String assessmentName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<SecuritySubAssessmentList> res
            = service.listSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<SecuritySubAssessmentInner> listSinglePage(String scope, String assessmentName,
        ...
        final String accept = "application/json";
        Response<SecuritySubAssessmentList> res
            = service.listSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<SecuritySubAssessmentInner> list(String scope, String assessmentName) {
        return new PagedIterable<>(() -> listSinglePage(scope, assessmentName),
    ...
    public PagedIterable<SecuritySubAssessmentInner> list(String scope, String assessmentName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(scope, assessmentName, context),
    ...
    public Response<SecuritySubAssessmentInner> getWithResponse(String scope, String assessmentName,
        ...
        if (subAssessmentName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter subAssessmentName is required and cannot be null."));
        }
        final String apiVersion = "2019-01-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, scope, assessmentName, subAssessmentName, accept,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of security sub-assessments along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listAllNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listAllNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<SecuritySubAssessmentInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SubAssessmentsClientImpl.class);
}
