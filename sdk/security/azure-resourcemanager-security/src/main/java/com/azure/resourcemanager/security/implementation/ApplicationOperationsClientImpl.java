...
public final class ApplicationOperationsClientImpl implements ApplicationOperationsClient {
    ...
    public interface ApplicationOperationsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("applicationId") String applicationId,
            @BodyParam("application/json") ApplicationInner application, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Response<ApplicationInner> getWithResponse(String applicationId, Context context) {
        ...
        final String apiVersion = "2022-07-01-preview";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), applicationId,
            accept, context);
    }
    ...
    public Response<ApplicationInner> createOrUpdateWithResponse(String applicationId, ApplicationInner application,
        ...
        if (application == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter application is required and cannot be null."));
        } else {
            application.validate();
        }
        final String apiVersion = "2022-07-01-preview";
    ...
    public Response<Void> deleteWithResponse(String applicationId, Context context) {
        ...
        final String apiVersion = "2022-07-01-preview";
        return service.deleteSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), applicationId,
            context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ApplicationOperationsClientImpl.class);
}
