...
public final class RegulatoryComplianceAssessmentsClientImpl implements RegulatoryComplianceAssessmentsClient {
    ...
    public interface RegulatoryComplianceAssessmentsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceAssessmentList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("regulatoryComplianceStandardName") String regulatoryComplianceStandardName,
            @PathParam("regulatoryComplianceControlName") String regulatoryComplianceControlName,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceAssessmentInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("regulatoryComplianceStandardName") String regulatoryComplianceStandardName,
            @PathParam("regulatoryComplianceControlName") String regulatoryComplianceControlName,
            @PathParam("regulatoryComplianceAssessmentName") String regulatoryComplianceAssessmentName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceAssessmentList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of regulatory compliance assessment response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceAssessmentInner> listSinglePage(String regulatoryComplianceStandardName,
        String regulatoryComplianceControlName, String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2019-01-01-preview";
        final String accept = "application/json";
        Response<RegulatoryComplianceAssessmentList> res
            = service.listSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                regulatoryComplianceStandardName, regulatoryComplianceControlName, filter, accept, Context.NONE);
    ...
    public PagedIterable<RegulatoryComplianceAssessmentInner> list(String regulatoryComplianceStandardName,
        ...
        return new PagedIterable<>(
            () -> listSinglePage(regulatoryComplianceStandardName, regulatoryComplianceControlName, filter),
    ...
    public PagedIterable<RegulatoryComplianceAssessmentInner> list(String regulatoryComplianceStandardName,
        String regulatoryComplianceControlName, String filter, Context context) {
        return new PagedIterable<>(
            () -> listSinglePage(regulatoryComplianceStandardName, regulatoryComplianceControlName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceAssessmentInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceAssessmentInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RegulatoryComplianceAssessmentsClientImpl.class);
}
