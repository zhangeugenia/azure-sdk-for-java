...
public final class DevOpsConfigurationsClientImpl implements DevOpsConfigurationsClient {
    ...
    public interface DevOpsConfigurationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DevOpsConfigurationListResponse> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DevOpsConfigurationInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DevOpsConfigurationListResponse> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DevOpsConfigurationInner> listSinglePage(String resourceGroupName,
        String securityConnectorName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<DevOpsConfigurationListResponse> res
    ...
    private PagedResponse<DevOpsConfigurationInner> listSinglePage(String resourceGroupName,
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<DevOpsConfigurationListResponse> res = service.listSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return devOps Configuration resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String securityConnectorName,
        ...
        if (devOpsConfiguration == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter devOpsConfiguration is required and cannot be null."));
        } else {
            devOpsConfiguration.validate();
        }
        final String apiVersion = "2025-03-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            securityConnectorName, apiVersion, devOpsConfiguration, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, securityConnectorName, devOpsConfiguration);
        return this.client.<DevOpsConfigurationInner, DevOpsConfigurationInner>getLroResult(response,
            DevOpsConfigurationInner.class, DevOpsConfigurationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, securityConnectorName, devOpsConfiguration, context);
        return this.client.<DevOpsConfigurationInner, DevOpsConfigurationInner>getLroResult(response,
            DevOpsConfigurationInner.class, DevOpsConfigurationInner.class, context);
    }
    ...
    public DevOpsConfigurationInner createOrUpdate(String resourceGroupName, String securityConnectorName,
        DevOpsConfigurationInner devOpsConfiguration) {
        return beginCreateOrUpdate(resourceGroupName, securityConnectorName, devOpsConfiguration).getFinalResult();
    }
    ...
    public DevOpsConfigurationInner createOrUpdate(String resourceGroupName, String securityConnectorName,
        DevOpsConfigurationInner devOpsConfiguration, Context context) {
        return beginCreateOrUpdate(resourceGroupName, securityConnectorName, devOpsConfiguration, context)
            .getFinalResult();
    }
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginUpdate(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, securityConnectorName, devOpsConfiguration);
        return this.client.<DevOpsConfigurationInner, DevOpsConfigurationInner>getLroResult(response,
            DevOpsConfigurationInner.class, DevOpsConfigurationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, securityConnectorName, devOpsConfiguration, context);
        return this.client.<DevOpsConfigurationInner, DevOpsConfigurationInner>getLroResult(response,
            DevOpsConfigurationInner.class, DevOpsConfigurationInner.class, context);
    }
    ...
    public DevOpsConfigurationInner update(String resourceGroupName, String securityConnectorName,
        DevOpsConfigurationInner devOpsConfiguration) {
        return beginUpdate(resourceGroupName, securityConnectorName, devOpsConfiguration).getFinalResult();
    }
    ...
    public DevOpsConfigurationInner update(String resourceGroupName, String securityConnectorName,
        DevOpsConfigurationInner devOpsConfiguration, Context context) {
        return beginUpdate(resourceGroupName, securityConnectorName, devOpsConfiguration, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String securityConnectorName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String securityConnectorName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, securityConnectorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String securityConnectorName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, securityConnectorName, context);
    ...
    public void delete(String resourceGroupName, String securityConnectorName) {
        beginDelete(resourceGroupName, securityConnectorName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String securityConnectorName, Context context) {
        beginDelete(resourceGroupName, securityConnectorName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DevOpsConfigurationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DevOpsConfigurationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DevOpsConfigurationsClientImpl.class);
}
