...
public final class DefenderForServersAwsOfferingMdeAutoProvisioning
    implements JsonSerializable<DefenderForServersAwsOfferingMdeAutoProvisioning> {
    /*
    ...
    /**
     * Reads an instance of DefenderForServersAwsOfferingMdeAutoProvisioning from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DefenderForServersAwsOfferingMdeAutoProvisioning if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DefenderForServersAwsOfferingMdeAutoProvisioning.
     */
    public static DefenderForServersAwsOfferingMdeAutoProvisioning fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DefenderForServersAwsOfferingMdeAutoProvisioning deserializedDefenderForServersAwsOfferingMdeAutoProvisioning
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("enabled".equals(fieldName)) {
                    deserializedDefenderForServersAwsOfferingMdeAutoProvisioning.enabled
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("configuration".equals(fieldName)) {
                    deserializedDefenderForServersAwsOfferingMdeAutoProvisioning.configuration = reader.readUntyped();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedDefenderForServersAwsOfferingMdeAutoProvisioning;
        });
    }
}
