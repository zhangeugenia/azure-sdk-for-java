...
public final class GitHubReposClientImpl implements GitHubReposClient {
    ...
    public interface GitHubReposService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GitHubRepositoryListResponse> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName, @PathParam("ownerName") String ownerName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GitHubRepositoryInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName, @PathParam("ownerName") String ownerName,
            @PathParam("repoName") String repoName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<GitHubRepositoryListResponse> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GitHubRepositoryInner> listSinglePage(String resourceGroupName, String securityConnectorName,
        String ownerName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2025-03-01";
        final String accept = "application/json";
        Response<GitHubRepositoryListResponse> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                securityConnectorName, ownerName, apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<GitHubRepositoryInner> list(String resourceGroupName, String securityConnectorName,
        String ownerName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, securityConnectorName, ownerName),
    ...
    public PagedIterable<GitHubRepositoryInner> list(String resourceGroupName, String securityConnectorName,
        String ownerName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, securityConnectorName, ownerName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GitHubRepositoryInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<GitHubRepositoryInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(GitHubReposClientImpl.class);
}
