...
public final class RegulatoryComplianceControlsClientImpl implements RegulatoryComplianceControlsClient {
    ...
    public interface RegulatoryComplianceControlsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceControlList> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("regulatoryComplianceStandardName") String regulatoryComplianceStandardName,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceControlInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("regulatoryComplianceStandardName") String regulatoryComplianceStandardName,
            @PathParam("regulatoryComplianceControlName") String regulatoryComplianceControlName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RegulatoryComplianceControlList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of regulatory compliance controls response along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceControlInner> listSinglePage(String regulatoryComplianceStandardName,
        String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2019-01-01-preview";
        final String accept = "application/json";
        Response<RegulatoryComplianceControlList> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), regulatoryComplianceStandardName, filter, accept, Context.NONE);
    ...
    public PagedIterable<RegulatoryComplianceControlInner> list(String regulatoryComplianceStandardName) {
        final String filter = null;
        return new PagedIterable<>(() -> listSinglePage(regulatoryComplianceStandardName, filter),
    ...
    public PagedIterable<RegulatoryComplianceControlInner> list(String regulatoryComplianceStandardName, String filter,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(regulatoryComplianceStandardName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceControlInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<RegulatoryComplianceControlList> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RegulatoryComplianceControlInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RegulatoryComplianceControlsClientImpl.class);
}
