...
public final class InsightsClientImpl implements InsightsClient {
    ...
    public interface InsightsService {
        ...
        Mono<Response<InsightListResult>> listBySubscription(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InsightInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InsightInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("workloadImpactName") String workloadImpactName, @PathParam("insightName") String insightName,
