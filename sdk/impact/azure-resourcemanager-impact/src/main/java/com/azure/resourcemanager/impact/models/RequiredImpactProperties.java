...
public final class RequiredImpactProperties implements JsonSerializable<RequiredImpactProperties> {
     ...
     */
    public RequiredImpactProperties() {
    }
     ...
     * @return the RequiredImpactProperties object itself.
     */
    public RequiredImpactProperties withName(String name) {
        this.name = name;
        return this;
    }
    ...
    /**
     * Set the allowedValues property: Allowed values values for the property.
     * 
     * @param allowedValues the allowedValues value to set.
     * @return the RequiredImpactProperties object itself.
     */
    public RequiredImpactProperties withAllowedValues(List<String> allowedValues) {
