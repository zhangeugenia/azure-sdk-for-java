...
import com.azure.resourcemanager.agricultureplatform.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftAgriculturePlatformImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftAgriculturePlatformOperations to be used by the proxy
