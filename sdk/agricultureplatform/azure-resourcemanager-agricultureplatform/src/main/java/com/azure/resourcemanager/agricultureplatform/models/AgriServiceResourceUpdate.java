...
public final class AgriServiceResourceUpdate implements JsonSerializable<AgriServiceResourceUpdate> {
     ...
     * @return the AgriServiceResourceUpdate object itself.
     */
    public AgriServiceResourceUpdate withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
        this.sku = sku;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identity".equals(fieldName)) {
                    deserializedAgriServiceResourceUpdate.identity
                        = AzureResourceManagerCommonTypesManagedServiceIdentityUpdate.fromJson(reader);
                } else if ("sku".equals(fieldName)) {
                    deserializedAgriServiceResourceUpdate.sku
                        = AzureResourceManagerCommonTypesSkuUpdate.fromJson(reader);
