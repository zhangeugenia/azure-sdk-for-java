...
public final class AgriServicesClientImpl implements AgriServicesClient {
    ...
    public Response<AgriServiceResourceInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        if (agriServiceResourceName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter agriServiceResourceName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String agriServiceResourceName) {
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, agriServiceResourceName, accept, Context.NONE);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AgriServicesClientImpl.class);
}
