 ...
 */
@Fluent
public final class AgriServiceResourceListResult implements JsonSerializable<AgriServiceResourceListResult> {
    /*
     * The AgriServiceResource items on this page
     */
    private List<AgriServiceResourceInner> value;
     ...
     */
    public List<AgriServiceResourceInner> value() {
        return this.value;
    }

    /**
     * Set the value property: The AgriServiceResource items on this page.
     * 
     * @param value the value value to set.
     * @return the AgriServiceResourceListResult object itself.
     */
    public AgriServiceResourceListResult withValue(List<AgriServiceResourceInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the AgriServiceResourceListResult object itself.
     */
    public AgriServiceResourceListResult withNextLink(String nextLink) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<AgriServiceResourceInner> value
