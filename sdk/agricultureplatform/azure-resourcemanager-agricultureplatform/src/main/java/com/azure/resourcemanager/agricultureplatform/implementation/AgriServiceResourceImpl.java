...
public final class AgriServiceResourceImpl
    ...
    public AgriServiceResourceImpl withIdentity(AzureResourceManagerCommonTypesManagedServiceIdentityUpdate identity) {
        this.updateProperties.withIdentity(identity);
        return this;
    }

    public AgriServiceResourceImpl withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
