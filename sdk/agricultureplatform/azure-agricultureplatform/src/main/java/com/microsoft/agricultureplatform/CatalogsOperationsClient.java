...
public final class CatalogsOperationsClient {
    @Generated
    private final CatalogsOperationsImpl serviceClient;

    /**
     * Initializes an instance of CatalogsOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    CatalogsOperationsClient(CatalogsOperationsImpl serviceClient) {
    ...
    public Response<BinaryData> getWithResponse(String catalogId, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponse(catalogId, requestOptions);
    }
    ...
    public Response<BinaryData> createOrUpdateWithResponse(String catalogId, BinaryData body,
        ...
        return this.serviceClient.createOrUpdateWithResponse(catalogId, body, requestOptions);
    }
    ...
    public Response<Void> deleteWithResponse(String catalogId, RequestOptions requestOptions) {
        return this.serviceClient.deleteWithResponse(catalogId, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Catalog> list(List<String> names, List<String> propertyFilters, List<String> statuses,
        ...
        return serviceClient.list(requestOptions).mapPage(bodyItemValue -> bodyItemValue.toObject(Catalog.class));
    }
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a specified Catalog resource.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Catalog get(String catalogId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(catalogId, requestOptions).getValue().toObject(Catalog.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Catalog createOrUpdate(String catalogId, Catalog body) {
        ...
        return createOrUpdateWithResponse(catalogId, bodyInBinaryData, requestOptions).getValue()
            .toObject(Catalog.class);
    }
    ...
    public void delete(String catalogId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        deleteWithResponse(catalogId, requestOptions).getValue();
    }
}
