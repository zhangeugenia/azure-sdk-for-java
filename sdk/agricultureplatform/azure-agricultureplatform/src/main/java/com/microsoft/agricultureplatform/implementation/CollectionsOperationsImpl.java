...
/**
 * An instance of this class provides access to all the operations defined in CollectionsOperations.
 */
public final class CollectionsOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CollectionsOperationsService service;
    ...
    /**
     * Initializes an instance of CollectionsOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CollectionsOperationsImpl(AgriculturePlatformClientImpl client) {
        this.service = RestProxy.create(CollectionsOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for AgriculturePlatformClientCollectionsOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AgriculturePlatformC")
    public interface CollectionsOperationsService {
        @Get("/catalogs/{catalogId}/collections")
        ...
        @Get("/catalogs/{catalogId}/collections/{collectionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Patch("/catalogs/{catalogId}/collections/{collectionId}")
        ...
        @Delete("/catalogs/{catalogId}/collections/{collectionId}")
     ...
     * @return paged collection of Collection items along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listSinglePageAsync(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), catalogId, accept, requestOptions, context))
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of Collection items as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> listAsync(String catalogId, RequestOptions requestOptions) {
        ...
        return new PagedFlux<>((pageSize) -> {
            ...
            return listSinglePageAsync(catalogId, requestOptionsLocal);
        }, (nextLink, pageSize) -> {
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of Collection items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listSinglePage(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), catalogId, accept, requestOptions, Context.NONE);
    ...
    public PagedIterable<BinaryData> list(String catalogId, RequestOptions requestOptions) {
        ...
        return new PagedIterable<>((pageSize) -> {
            ...
            return listSinglePage(catalogId, requestOptionsLocal);
        }, (nextLink, pageSize) -> {
            RequestOptions requestOptionsLocal = new RequestOptions();
            requestOptionsLocal.setContext(requestOptionsForNextPage.getContext());
            if (pageSize != null) {
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return a specified Collection resource along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getWithResponseAsync(String catalogId, String collectionId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.get(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), catalogId, collectionId, accept, requestOptions, context));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return collection along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createOrUpdateWithResponseAsync(String catalogId, String collectionId,
        ...
        return FluxUtil.withContext(
            context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                catalogId, collectionId, contentType, accept, body, requestOptions, context));
    }
    ...
    public Response<BinaryData> createOrUpdateWithResponse(String catalogId, String collectionId, BinaryData body,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            catalogId, collectionId, contentType, accept, body, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String catalogId, String collectionId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
