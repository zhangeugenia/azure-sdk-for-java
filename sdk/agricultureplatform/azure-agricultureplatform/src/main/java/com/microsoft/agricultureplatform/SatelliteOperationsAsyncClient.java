...
public final class SatelliteOperationsAsyncClient {
    @Generated
    private final SatelliteOperationsImpl serviceClient;

    /**
     * Initializes an instance of SatelliteOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SatelliteOperationsAsyncClient(SatelliteOperationsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> fetchItemsWithResponse(BinaryData fetchItemsRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.fetchItemsWithResponseAsync(fetchItemsRequest, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> searchItemsWithResponse(BinaryData searchItemsRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.searchItemsWithResponseAsync(searchItemsRequest, requestOptions);
    }
     ...
     * @return satellite Fetch Response on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SatelliteFetchResponse> fetchItems(FetchItemsOptions options) {
        ...
        return fetchItemsWithResponse(fetchItemsRequest, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SatelliteFetchResponse.class));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return paged response contains list of items and next property to get the next set of
     * results on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SearchFeaturesResponse> searchItems(SearchItemsOptions options) {
        ...
        return searchItemsWithResponse(searchItemsRequest, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SearchFeaturesResponse.class));
    }
}
