...
public final class WeatherOperationsAsyncClient {
    @Generated
    private final WeatherOperationsImpl serviceClient;

    /**
     * Initializes an instance of WeatherOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    WeatherOperationsAsyncClient(WeatherOperationsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getWithResponse(BinaryData getRequest, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(getRequest, requestOptions);
    }
     ...
     * @return schema of Weather Data Provider Response on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<WeatherResponse> get(String providerName, String providerApiName, String units, String language,
        ...
        return getWithResponse(getRequest, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(WeatherResponse.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<WeatherResponse> get(String providerName, String providerApiName, String units) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
