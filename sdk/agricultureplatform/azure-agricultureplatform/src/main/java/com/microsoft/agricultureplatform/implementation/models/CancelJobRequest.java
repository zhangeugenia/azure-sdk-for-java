...
/**
 * The CancelJobRequest model.
 */
@Immutable
public final class CancelJobRequest implements JsonSerializable<CancelJobRequest> {
    /*
     * SolutionId.
     */
    @Generated
     ...
     */
    @Generated
    public CancelJobRequest(String solutionId, String requestPath, Map<String, BinaryData> partnerRequestBody,
    ...
    /**
     * Reads an instance of CancelJobRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CancelJobRequest if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CancelJobRequest.
     */
    @Generated
    public static CancelJobRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new CancelJobRequest(solutionId, requestPath, partnerRequestBody, partnerRequestHeaders);
        });
    }
}
