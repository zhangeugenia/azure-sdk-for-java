...
public final class CreateJobRequest implements JsonSerializable<CreateJobRequest> {
     ...
     */
    @Generated
    public CreateJobRequest(String solutionId, String requestPath, Map<String, BinaryData> partnerRequestBody,
    ...
    public static CreateJobRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new CreateJobRequest(solutionId, requestPath, partnerRequestBody, partnerRequestHeaders, inputData);
        });
    }
}
