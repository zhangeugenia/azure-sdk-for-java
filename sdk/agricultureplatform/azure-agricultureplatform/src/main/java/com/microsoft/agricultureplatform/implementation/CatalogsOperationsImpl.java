...
/**
 * An instance of this class provides access to all the operations defined in CatalogsOperations.
 */
public final class CatalogsOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CatalogsOperationsService service;
    ...
    /**
     * Initializes an instance of CatalogsOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CatalogsOperationsImpl(AgriculturePlatformClientImpl client) {
        this.service = RestProxy.create(CatalogsOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for AgriculturePlatformClientCatalogsOperations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AgriculturePlatformC")
    public interface CatalogsOperationsService {
        @Get("/catalogs")
        ...
        Response<Void> deleteSync(@HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("catalogId") String catalogId, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getWithResponseAsync(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return a specified Catalog resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getWithResponse(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createOrUpdateWithResponseAsync(String catalogId, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/merge-patch+json";
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                catalogId, contentType, accept, body, requestOptions, context));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return catalog along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createOrUpdateWithResponse(String catalogId, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/merge-patch+json";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            catalogId, contentType, accept, body, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String catalogId, RequestOptions requestOptions) {
        final String accept = "application/json";
