...
/**
 * Options for searchAcrossCollection API.
 */
@Fluent
public final class SearchAcrossCollectionOptions {
    /*
     * Id of the Catalog.
     */
    @Generated
    ...
    /**
     * Creates an instance of SearchAcrossCollectionOptions class.
     * 
     * @param catalogId the catalogId value to set.
     */
    @Generated
    public SearchAcrossCollectionOptions(String catalogId) {
     ...
     * @return the SearchAcrossCollectionOptions object itself.
     */
    @Generated
    public SearchAcrossCollectionOptions setMaximumPageSize(Integer maximumPageSize) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setOwnerItemIds(List<String> ownerItemIds) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setDataFilters(List<String> dataFilters) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setIntersectsWithGeometry(GeoJsonObject intersectsWithGeometry) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setIds(List<String> ids) {
        this.ids = ids;
        return this;
    }
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setMinCreatedDateTime(OffsetDateTime minCreatedDateTime) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setMaxCreatedDateTime(OffsetDateTime maxCreatedDateTime) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setMinLastModifiedDateTime(OffsetDateTime minLastModifiedDateTime) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setMaxLastModifiedDateTime(OffsetDateTime maxLastModifiedDateTime) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setMaxPageSize(Integer maxPageSize) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setSkipToken(String skipToken) {
     ...
     */
    @Generated
    public SearchAcrossCollectionOptions setCollectionIds(List<String> collectionIds) {
