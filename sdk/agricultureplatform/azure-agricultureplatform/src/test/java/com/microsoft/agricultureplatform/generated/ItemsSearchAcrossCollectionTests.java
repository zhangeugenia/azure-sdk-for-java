...
@Disabled
public final class ItemsSearchAcrossCollectionTests extends AgriculturePlatformClientTestBase {
    @Test
    @Disabled
    public void testItemsSearchAcrossCollectionTests() {
        // method invocation
        ...
        Assertions.assertEquals("0000a432-0000-0100-0000-66bf15b80000", responseValueFirstItem.getETag());
        ...
        Assertions.assertEquals("TempValue", responseValueFirstItem.getOwnerItemId());
        Assertions.assertEquals("Owner", responseValueFirstItem.getCatalogId());
        Assertions.assertEquals("Owner", responseValueFirstItem.getCollectionId());
        ...
        Assertions.assertEquals("Owner", responseValueFirstItem.getId());
    }
}
