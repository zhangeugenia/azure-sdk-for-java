...
public class CollectionsCreateOrUpdate {
    public static void main(String[] args) {
        ...
        // BEGIN:com.microsoft.agricultureplatform.generated.collectionsoperationscreateorupdate.collectionscreateorupdate
        Collection response = collectionsOperationsClient.createOrUpdate("CATALOG123", "COLLECTION123",
            new Collection().setLinks(Arrays.asList(
                ...
                .setSchemaId("SCHEMA123"));
        // END:com.microsoft.agricultureplatform.generated.collectionsoperationscreateorupdate.collectionscreateorupdate
    }
