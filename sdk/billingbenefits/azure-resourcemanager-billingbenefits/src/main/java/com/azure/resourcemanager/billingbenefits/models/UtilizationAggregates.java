        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("grain".equals(fieldName)) {
                    deserializedUtilizationAggregates.grain = reader.getNullable(JsonReader::getDouble);
                } else if ("grainUnit".equals(fieldName)) {
                    deserializedUtilizationAggregates.grainUnit = reader.getString();
                } else if ("value".equals(fieldName)) {
                    deserializedUtilizationAggregates.value = reader.getNullable(JsonReader::getDouble);
