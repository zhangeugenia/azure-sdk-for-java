...
/**
 * Resource collection API of SavingsPlanOperationGroups.
 */
public interface SavingsPlanOperationGroups {
    /**
     * List savings plans.
     * 
     ...
     * @return represents the result of listing savings plan models as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SavingsPlanModel> listAll(String filter, String orderby, String refreshSummary, Double skiptoken,
     ...
     */
    Response<SavingsPlanValidateResponse> validatePurchaseWithResponse(SavingsPlanPurchaseValidateRequest body,
        Context context);
     ...
     * @return the response.
     */
    SavingsPlanValidateResponse validatePurchase(SavingsPlanPurchaseValidateRequest body);
}
