...
public final class DiscountsImpl implements Discounts {
    ...
    public Discount getById(String id) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, discountName, Context.NONE).getValue();
    }

    public Response<Discount> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, discountName, context);
    }
