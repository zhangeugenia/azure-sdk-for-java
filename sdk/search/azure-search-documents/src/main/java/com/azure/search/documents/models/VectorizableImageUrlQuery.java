...
public final class VectorizableImageUrlQuery extends VectorQuery {
    ...
    @Generated
    @Override
    public VectorizableImageUrlQuery setKNearestNeighbors(Integer kNearestNeighbors) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("k".equals(fieldName)) {
                    deserializedVectorizableImageUrlQuery.setKNearestNeighbors(reader.getNullable(JsonReader::getInt));
