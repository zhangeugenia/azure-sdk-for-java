...
public class SearchIndexerKnowledgeStoreProjectionSelector
    ...
    public static SearchIndexerKnowledgeStoreProjectionSelector fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SearchIndexerKnowledgeStoreProjectionSelector deserializedSearchIndexerKnowledgeStoreProjectionSelector
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("referenceKeyName".equals(fieldName)) {
                    deserializedSearchIndexerKnowledgeStoreProjectionSelector.referenceKeyName = reader.getString();
                } else if ("generatedKeyName".equals(fieldName)) {
                    deserializedSearchIndexerKnowledgeStoreProjectionSelector.generatedKeyName = reader.getString();
                } else if ("source".equals(fieldName)) {
                    deserializedSearchIndexerKnowledgeStoreProjectionSelector.source = reader.getString();
                } else if ("sourceContext".equals(fieldName)) {
                    deserializedSearchIndexerKnowledgeStoreProjectionSelector.sourceContext = reader.getString();
                } else if ("inputs".equals(fieldName)) {
                    List<InputFieldMappingEntry> inputs
                        = reader.readArray(reader1 -> InputFieldMappingEntry.fromJson(reader1));
                    deserializedSearchIndexerKnowledgeStoreProjectionSelector.inputs = inputs;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSearchIndexerKnowledgeStoreProjectionSelector;
        });
    }
}
