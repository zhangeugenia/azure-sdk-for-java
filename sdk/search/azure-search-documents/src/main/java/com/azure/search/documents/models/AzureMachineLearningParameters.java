...
public final class AzureMachineLearningParameters implements JsonSerializable<AzureMachineLearningParameters> {
    ...
    /**
     * Get the scoringUri property: (Required for no authentication or key authentication) The scoring URI of the
     * AML service to which the JSON payload will be sent. Only the https URI scheme
     * is allowed.
     * 
    ...
    /**
     * Get the modelName property: The name of the embedding model from the Azure AI Studio Catalog that is
     * deployed at the provided endpoint.
     * 
    ...
    /**
     * Set the modelName property: The name of the embedding model from the Azure AI Studio Catalog that is
     * deployed at the provided endpoint.
     * 
