...
public final class ManagedIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedIdentity model = BinaryData.fromString(
            "{\"principalId\":\"qrolfpf\",\"tenantId\":\"algbquxigjyjg\",\"type\":\"SystemAssigned, UserAssigned\",\"userAssignedIdentities\":{\"qawrlyxwj\":{\"principalId\":\"hr\",\"clientId\":\"ilnerkujysvlejuv\"},\"qguhmuo\":{\"principalId\":\"prbnwbxgjvtbv\",\"clientId\":\"sszdnru\"},\"uizga\":{\"principalId\":\"f\",\"clientId\":\"wzwbnguitn\"},\"htymw\":{\"principalId\":\"ufizuckyf\",\"clientId\":\"rfidfvzwdz\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedIdentity model = new ManagedIdentity().withType(ManagedIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
            .withUserAssignedIdentities(mapOf("qawrlyxwj", new UserAssignedIdentity(), "qguhmuo",
                new UserAssignedIdentity(), "uizga", new UserAssignedIdentity(), "htymw", new UserAssignedIdentity()));
