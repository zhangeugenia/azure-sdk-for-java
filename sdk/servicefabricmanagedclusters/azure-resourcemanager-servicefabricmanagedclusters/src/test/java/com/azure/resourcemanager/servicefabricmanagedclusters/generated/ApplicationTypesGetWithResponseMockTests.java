...
public final class ApplicationTypesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"snfepgfewetwlyx\"},\"tags\":{\"limmbcxf\":\"xykxhdj\"},\"location\":\"cporxvxcjz\",\"id\":\"izxfpxt\",\"name\":\"qscjavftjuh\",\"type\":\"qaz\"}";
        ...
        ApplicationTypeResource response = manager.applicationTypes()
            .getWithResponse("eazulcs", "thwwn", "jhlfzswpchwahf", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("xykxhdj", response.tags().get("limmbcxf"));
        Assertions.assertEquals("cporxvxcjz", response.location());
    }
}
