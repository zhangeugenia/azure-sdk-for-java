...
public final class ManagedClusterProperties implements JsonSerializable<ManagedClusterProperties> {
    ...
    /*
     * The VM image the node types are configured with. This property controls the Service Fabric component packages to
     * be used for the cluster. Allowed values are: 'Windows'. The default value is 'Windows'.
     */
     ...
     * @return the ManagedClusterProperties object itself.
     */
    public ManagedClusterProperties withVMImage(String vMImage) {
