...
public final class ManagedApplyMaintenanceWindowsClientImpl implements ManagedApplyMaintenanceWindowsClient {
     ...
     */
    ManagedApplyMaintenanceWindowsClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientManagedApplyMaintenanceWindows to be used by the
