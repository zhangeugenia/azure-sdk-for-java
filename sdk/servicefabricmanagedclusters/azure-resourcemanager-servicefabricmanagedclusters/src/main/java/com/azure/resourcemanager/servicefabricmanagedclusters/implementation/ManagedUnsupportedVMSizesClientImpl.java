...
public final class ManagedUnsupportedVMSizesClientImpl implements ManagedUnsupportedVMSizesClient {
     ...
     */
    ManagedUnsupportedVMSizesClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientManagedUnsupportedVMSizes to be used by the proxy
