...
public final class ManagedAzResiliencyStatusesClientImpl implements ManagedAzResiliencyStatusesClient {
     ...
     */
    ManagedAzResiliencyStatusesClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientManagedAzResiliencyStatuses to be used by the
