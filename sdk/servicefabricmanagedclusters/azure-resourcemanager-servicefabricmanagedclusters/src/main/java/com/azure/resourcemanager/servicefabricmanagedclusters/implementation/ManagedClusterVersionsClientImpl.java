...
public final class ManagedClusterVersionsClientImpl implements ManagedClusterVersionsClient {
     ...
     */
    ManagedClusterVersionsClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientManagedClusterVersions to be used by the proxy
