...
public final class NodeTypeImpl implements NodeType, NodeType.Definition, NodeType.Update {
    ...
    public SecurityEncryptionType securityEncryptionType() {
        return this.innerModel().securityEncryptionType();
    }
    ...
    public NodeTypeImpl withSecurityEncryptionType(SecurityEncryptionType securityEncryptionType) {
        this.innerModel().withSecurityEncryptionType(securityEncryptionType);
        return this;
    }
