...
public final class ApplicationTypesClientImpl implements ApplicationTypesClient {
     ...
     */
    ApplicationTypesClientImpl(ServiceFabricClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ServiceFabricClientApplicationTypes to be used by the proxy service
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ApplicationTypesClientImpl.class);
}
