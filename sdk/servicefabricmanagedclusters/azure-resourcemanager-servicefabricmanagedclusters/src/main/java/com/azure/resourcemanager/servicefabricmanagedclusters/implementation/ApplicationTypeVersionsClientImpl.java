...
public final class ApplicationTypeVersionsClientImpl implements ApplicationTypeVersionsClient {
     ...
     */
    ApplicationTypeVersionsClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientApplicationTypeVersions to be used by the proxy
    ...
    private Mono<Response<ApplicationTypeVersionResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, clusterName, applicationTypeName, version, contentType, accept, parameters, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ApplicationTypeVersionResourceInner>>
        listByApplicationTypesNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByApplicationTypesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
