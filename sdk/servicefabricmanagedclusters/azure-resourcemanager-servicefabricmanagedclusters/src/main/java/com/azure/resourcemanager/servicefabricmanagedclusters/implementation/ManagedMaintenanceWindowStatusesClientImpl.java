...
public final class ManagedMaintenanceWindowStatusesClientImpl implements ManagedMaintenanceWindowStatusesClient {
     ...
     */
    ManagedMaintenanceWindowStatusesClientImpl(ServiceFabricClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceFabricClientManagedMaintenanceWindowStatuses to be used by the
    ...
    public interface ManagedMaintenanceWindowStatusesService {
        ...
        Mono<Response<ManagedMaintenanceWindowStatusInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ManagedMaintenanceWindowStatusInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @HeaderParam("Accept") String accept, Context context);
    }
