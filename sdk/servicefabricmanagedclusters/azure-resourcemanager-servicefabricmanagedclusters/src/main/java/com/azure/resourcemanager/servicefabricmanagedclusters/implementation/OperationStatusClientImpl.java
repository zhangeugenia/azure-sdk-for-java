...
public final class OperationStatusClientImpl implements OperationStatusClient {
     ...
     */
    OperationStatusClientImpl(ServiceFabricClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ServiceFabricClientOperationStatus to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface OperationStatusService {
        ...
        Mono<Response<LongRunningOperationResultInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LongRunningOperationResultInner> getSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("operationId") String operationId,
            @HeaderParam("Accept") String accept, Context context);
    }
