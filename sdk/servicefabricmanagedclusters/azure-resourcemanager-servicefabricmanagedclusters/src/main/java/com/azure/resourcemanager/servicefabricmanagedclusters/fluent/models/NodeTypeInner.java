...
public final class NodeTypeInner extends ProxyResource {
    ...
    public SecurityEncryptionType securityEncryptionType() {
        return this.innerProperties() == null ? null : this.innerProperties().securityEncryptionType();
    }
     ...
     * @return the NodeTypeInner object itself.
     */
    public NodeTypeInner withSecurityEncryptionType(SecurityEncryptionType securityEncryptionType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new NodeTypeProperties();
        }
        this.innerProperties().withSecurityEncryptionType(securityEncryptionType);
        return this;
    }
     ...
     * @return the NodeTypeInner object itself.
     */
    public NodeTypeInner withZoneBalance(Boolean zoneBalance) {
        if (this.innerProperties() == null) {
            this.innerProperties = new NodeTypeProperties();
        }
