...
public final class VMSSExtension implements JsonSerializable<VMSSExtension> {
     ...
     * @return the VMSSExtension object itself.
     */
    public VMSSExtension withSettings(VMSSExtensionPropertiesSettings settings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VMSSExtensionProperties();
        }
     ...
     * @return the VMSSExtension object itself.
     */
    public VMSSExtension withProtectedSettings(VMSSExtensionPropertiesProtectedSettings protectedSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VMSSExtensionProperties();
        }
