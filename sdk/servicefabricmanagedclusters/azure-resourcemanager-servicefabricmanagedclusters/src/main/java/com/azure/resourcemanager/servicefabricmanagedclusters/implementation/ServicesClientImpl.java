...
public final class ServicesClientImpl implements ServicesClient {
     ...
     */
    ServicesClientImpl(ServiceFabricClientImpl client) {
        this.service = RestProxy.create(ServicesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ServiceFabricClientServices to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ServiceFabricClientS")
    ...
    private Mono<Response<ServiceResourceInner>> updateWithResponseAsync(String resourceGroupName, String clusterName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, clusterName, applicationName, serviceName, contentType, accept, parameters, context);
    }
    ...
    private Mono<PagedResponse<ServiceResourceInner>> listByApplicationsSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByApplications(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
