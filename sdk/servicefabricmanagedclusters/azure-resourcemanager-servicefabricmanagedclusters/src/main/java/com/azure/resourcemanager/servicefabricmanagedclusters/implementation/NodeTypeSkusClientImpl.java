...
public final class NodeTypeSkusClientImpl implements NodeTypeSkusClient {
     ...
     */
    NodeTypeSkusClientImpl(ServiceFabricClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ServiceFabricClientNodeTypeSkus to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
