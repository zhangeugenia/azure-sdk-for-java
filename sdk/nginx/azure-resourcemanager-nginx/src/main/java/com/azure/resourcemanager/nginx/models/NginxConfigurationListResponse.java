...
public final class NginxConfigurationListResponse implements JsonSerializable<NginxConfigurationListResponse> {
    ...
    /**
     * Set the value property: The NginxConfigurationResponse items on this page.
     * 
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model NginxConfigurationListResponse"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(NginxConfigurationListResponse.class);
