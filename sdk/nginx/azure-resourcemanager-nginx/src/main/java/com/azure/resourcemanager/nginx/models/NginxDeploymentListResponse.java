...
public final class NginxDeploymentListResponse implements JsonSerializable<NginxDeploymentListResponse> {
    ...
    /**
     * Set the value property: The NginxDeployment items on this page.
     * 
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model NginxDeploymentListResponse"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(NginxDeploymentListResponse.class);
