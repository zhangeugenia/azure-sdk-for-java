...
public final class FileSharesCheckNameAvailabilityWithResponseMockTests {
    ...
    public void testCheckNameAvailabilityWithResponse() throws Exception {
        String responseStr = "{\"nameAvailable\":true,\"reason\":\"AlreadyExists\",\"message\":\"c\"}";
        ...
        CheckNameAvailabilityResponse response = manager.fileShares()
            .checkNameAvailabilityWithResponse("jf",
                new CheckNameAvailabilityRequest().withName("brjcxe").withType("uwutttxfvjrbi"),
        ...
        Assertions.assertEquals("c", response.message());
    }
}
