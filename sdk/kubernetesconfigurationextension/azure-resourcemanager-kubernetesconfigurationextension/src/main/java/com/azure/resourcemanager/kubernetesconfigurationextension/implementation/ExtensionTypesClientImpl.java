...
package com.azure.resourcemanager.kubernetesconfigurationextension.implementation;
...
import com.azure.resourcemanager.kubernetesconfigurationextension.fluent.ExtensionTypesClient;
...
import com.azure.resourcemanager.kubernetesconfigurationextension.models.ExtensionTypeVersionsList;
import com.azure.resourcemanager.kubernetesconfigurationextension.models.ExtensionTypesList;
...
public final class ExtensionTypesClientImpl implements ExtensionTypesClient {
    ...
    public interface ExtensionTypesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExtensionTypeVersionForReleaseTrainInner> getVersionSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @PathParam("extensionTypeName") String extensionTypeName, @PathParam("versionNumber") String versionNumber,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExtensionTypeVersionForReleaseTrainInner> clusterGetVersionSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterRp") String clusterRp,
            @PathParam("clusterResourceName") String clusterResourceName, @PathParam("clusterName") String clusterName,
            @PathParam("extensionTypeName") String extensionTypeName, @PathParam("versionNumber") String versionNumber,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExtensionTypeVersionForReleaseTrainInner> listVersionsSinglePage(String location,
        String extensionTypeName, String releaseTrain, String clusterType, String majorVersion, Boolean showLatest) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExtensionTypeVersionForReleaseTrainInner> clusterListVersionsSinglePage(
        String resourceGroupName, String clusterRp, String clusterResourceName, String clusterName,
        String extensionTypeName, String releaseTrain, String majorVersion, Boolean showLatest) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExtensionTypeVersionForReleaseTrainInner> listVersionsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExtensionTypeVersionForReleaseTrainInner> clusterListVersionsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
