...
public interface IncidentTasksClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<IncidentTaskInner> list(
    ...
    Response<IncidentTaskInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<IncidentTaskInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    IncidentTaskInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String incidentId,
        String incidentTaskId,
