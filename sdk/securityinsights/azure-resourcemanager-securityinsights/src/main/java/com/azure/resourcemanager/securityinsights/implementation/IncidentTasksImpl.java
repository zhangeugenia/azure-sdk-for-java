...
public final class IncidentTasksImpl implements IncidentTasks {
    ...
    public IncidentTasksImpl(
        IncidentTasksClient innerClient,
    ...
    public PagedIterable<IncidentTask> list(
    ...
    public Response<IncidentTask> getWithResponse(
        String resourceGroupName, String workspaceName, String incidentId, String incidentTaskId, Context context) {
        Response<IncidentTaskInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, workspaceName, incidentId, incidentTaskId, context);
        if (inner != null) {
