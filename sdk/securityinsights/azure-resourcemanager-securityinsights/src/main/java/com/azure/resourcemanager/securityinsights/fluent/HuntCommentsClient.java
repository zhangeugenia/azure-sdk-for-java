...
public interface HuntCommentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<HuntCommentInner> list(
    ...
    Response<HuntCommentInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HuntCommentInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String workspaceName,
        String huntId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    HuntCommentInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String huntId,
        String huntCommentId,
