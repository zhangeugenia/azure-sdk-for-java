...
public final class WorkspaceManagerAssignmentsImpl implements WorkspaceManagerAssignments {
    ...
    public WorkspaceManagerAssignmentsImpl(
        WorkspaceManagerAssignmentsClient innerClient,
    ...
    public PagedIterable<WorkspaceManagerAssignment> list(
    ...
    public Response<WorkspaceManagerAssignment> getWithResponse(
        String resourceGroupName, String workspaceName, String workspaceManagerAssignmentName, Context context) {
        Response<WorkspaceManagerAssignmentInner> inner =
            this
                .serviceClient()
    ...
    public WorkspaceManagerAssignment get(
