...
public interface HuntRelationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<HuntRelationInner> list(
    ...
    Response<HuntRelationInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HuntRelationInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String workspaceName,
        String huntId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    HuntRelationInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String huntId,
        String huntRelationId,
