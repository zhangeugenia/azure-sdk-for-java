...
public final class HuntCommentsImpl implements HuntComments {
    ...
    public HuntCommentsImpl(
        HuntCommentsClient innerClient,
    ...
    public PagedIterable<HuntComment> list(
        ...
        String skipToken,
        Context context) {
        PagedIterable<HuntCommentInner> inner =
            this
                .serviceClient()
    ...
    public Response<HuntComment> getWithResponse(
