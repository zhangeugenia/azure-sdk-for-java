...
public final class HuntRelationsImpl implements HuntRelations {
    ...
    public HuntRelationsImpl(
        HuntRelationsClient innerClient,
    ...
    public PagedIterable<HuntRelation> list(
        ...
        String skipToken,
        Context context) {
        PagedIterable<HuntRelationInner> inner =
            this
                .serviceClient()
    ...
    public Response<HuntRelation> getWithResponse(
