...
public final class ContentTemplatesClientImpl implements ContentTemplatesClient {
     ...
     * @return all installed templates. Expandable properties: - properties/mainTemplate - properties/dependantTemplates
    ...
    private PagedFlux<TemplateModelInner> listAsync(
        ...
        return new PagedFlux<>(
            () ->
                listSinglePageAsync(
                    resourceGroupName, workspaceName, filter, orderby, expand, search, count, top, skip, skipToken),
