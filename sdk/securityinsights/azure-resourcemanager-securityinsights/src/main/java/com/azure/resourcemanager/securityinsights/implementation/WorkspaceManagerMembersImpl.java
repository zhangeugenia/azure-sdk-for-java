...
public final class WorkspaceManagerMembersImpl implements WorkspaceManagerMembers {
    ...
    public PagedIterable<WorkspaceManagerMember> list(
    ...
    public Response<WorkspaceManagerMember> getWithResponse(
        String resourceGroupName, String workspaceName, String workspaceManagerMemberName, Context context) {
        Response<WorkspaceManagerMemberInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, workspaceName, workspaceManagerMemberName, context);
        if (inner != null) {
    ...
    public WorkspaceManagerMember get(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'workspaceManagerMembers'.",
                                id)));
        }
        return this
