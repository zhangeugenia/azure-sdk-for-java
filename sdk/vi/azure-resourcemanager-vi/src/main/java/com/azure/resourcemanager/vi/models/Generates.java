...
public interface Generates {
     ...
     * @return azure Video Indexer access token along with {@link Response}.
     */
    Response<AccessToken> extensionAccessTokenWithResponse(String resourceGroupName, String accountName,
     ...
     * @return azure Video Indexer access token.
     */
    AccessToken extensionAccessToken(String resourceGroupName, String accountName);
     ...
     * @return azure Video Indexer access token along with {@link Response}.
     */
    Response<AccessToken> extensionRestrictedViewerAccessTokenWithResponse(String resourceGroupName, String accountName,
        GenerateExtensionRestrictedViewerAccessTokenParameters parameters, Context context);
     ...
     * @return azure Video Indexer access token.
     */
    AccessToken extensionRestrictedViewerAccessToken(String resourceGroupName, String accountName);
}
