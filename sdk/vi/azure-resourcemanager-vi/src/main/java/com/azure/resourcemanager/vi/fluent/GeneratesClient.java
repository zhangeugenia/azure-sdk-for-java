...
public interface GeneratesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessTokenInner> extensionAccessTokenWithResponse(String resourceGroupName, String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessTokenInner> extensionRestrictedViewerAccessTokenWithResponse(String resourceGroupName,
