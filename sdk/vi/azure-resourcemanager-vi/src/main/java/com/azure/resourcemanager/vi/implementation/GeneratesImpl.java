...
public final class GeneratesImpl implements Generates {
    ...
    public Response<AccessToken> extensionAccessTokenWithResponse(String resourceGroupName, String accountName,
    ...
    public Response<AccessToken> extensionRestrictedViewerAccessTokenWithResponse(String resourceGroupName,
