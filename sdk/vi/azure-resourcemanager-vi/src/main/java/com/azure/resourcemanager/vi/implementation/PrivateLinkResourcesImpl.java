...
import com.azure.resourcemanager.vi.models.PrivateLinkResources;
...
public final class PrivateLinkResourcesImpl implements PrivateLinkResources {
    ...
    public Response<PrivateLinkResource> getWithResponse(String resourceGroupName, String accountName, String groupId,
        Context context) {
    ...
    public PrivateLinkResource get(String resourceGroupName, String accountName, String groupId) {
        PrivateLinkResourceInner inner = this.serviceClient().get(resourceGroupName, accountName, groupId);
        if (inner != null) {
