...
@Disabled
public final class InstructionServiceClientCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleTests
    extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void testInstructionServiceClientCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleTests() {
        // method invocation
        SyncPoller<OperationResponse, Instruction> response = setPlaybackSyncPollerPollInterval(
