...
public final class GetResponse implements JsonSerializable<GetResponse> {
     ...
     */
    @Generated
    private GetResponse(InstructionLanguageEnum language, RetrievalProperties retrieval, ContentProperties content,
        Relationships relationships, AdministrativeDetails administrativeDetails) {
    ...
    public static GetResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            GetResponse deserializedGetResponse
                = new GetResponse(language, retrieval, content, relationships, administrativeDetails);
