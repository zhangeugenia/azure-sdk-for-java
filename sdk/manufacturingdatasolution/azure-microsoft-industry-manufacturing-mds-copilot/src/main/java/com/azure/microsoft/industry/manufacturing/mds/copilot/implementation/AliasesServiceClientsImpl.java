...
/**
 * An instance of this class provides access to all the operations defined in AliasesServiceClients.
 */
public final class AliasesServiceClientsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AliasesServiceClientsService service;
    ...
    /**
     * Initializes an instance of AliasesServiceClientsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AliasesServiceClientsImpl(CopilotServiceClientImpl client) {
        this.service = RestProxy.create(AliasesServiceClientsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for CopilotServiceClientAliasesServiceClients to be used by the proxy
     * service to perform REST calls.
     */
    @Host("https://mds-{mdsUniqueId}.{location}.cloudapp.azure.com/")
    @ServiceInterface(name = "CopilotServiceClient")
    public interface AliasesServiceClientsService {
