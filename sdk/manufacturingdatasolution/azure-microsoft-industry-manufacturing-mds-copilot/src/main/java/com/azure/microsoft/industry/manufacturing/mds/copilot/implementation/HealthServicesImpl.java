...
/**
 * An instance of this class provides access to all the operations defined in HealthServices.
 */
public final class HealthServicesImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final HealthServicesService service;
    ...
    /**
     * Initializes an instance of HealthServicesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    HealthServicesImpl(CopilotServiceClientImpl client) {
        this.service
            = RestProxy.create(HealthServicesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for CopilotServiceClientHealthServices to be used by the proxy service to
     * perform REST calls.
     */
    @Host("https://mds-{mdsUniqueId}.{location}.cloudapp.azure.com/")
    @ServiceInterface(name = "CopilotServiceClient")
    public interface HealthServicesService {
        @Get("/copilot/health")
        ...
        Mono<Response<BinaryData>> getHealthStatus(@HostParam("mdsUniqueId") String mdsUniqueId,
            @HostParam("location") String location, @HeaderParam("Accept") String accept, RequestOptions requestOptions,
            Context context);
    ...
    public Response<BinaryData> getHealthStatusWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getHealthStatusSync(this.client.getMdsUniqueId(), this.client.getLocation(), accept,
