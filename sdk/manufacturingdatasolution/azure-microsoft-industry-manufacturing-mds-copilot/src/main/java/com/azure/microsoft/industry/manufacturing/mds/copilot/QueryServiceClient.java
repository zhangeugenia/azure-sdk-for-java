...
public final class QueryServiceClient {
     ...
     */
    @Generated
    QueryServiceClient(QueryServiceClientsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public QueryResponse queryExecute(UserQueryRequest request, String conversationId, String acceptLanguage,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public QueryResponse queryExecute(UserQueryRequest request) {
        // Generated convenience method for queryExecuteWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return queryExecuteWithResponse(BinaryData.fromObject(request), requestOptions).getValue()
            .toObject(QueryResponse.class);
