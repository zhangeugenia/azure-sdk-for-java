...
public final class Instruction implements JsonSerializable<Instruction> {
     ...
     */
    @Generated
    public Instruction(String instructionId, String instructionVersion, InstrustionDomainEnum domain,
        InstructionSubDomainEnum subDomain, InstructionCategoryEnum category, InstructionLanguageEnum language,
        RetrievalProperties retrieval, ContentProperties content, Relationships relationships,
        AdministrativeDetails administrativeDetails, ResourceState state) {
    ...
    /**
     * Get the state property: state for the instruction.
     * 
    ...
    public static Instruction fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Instruction deserializedInstruction = new Instruction(instructionId, instructionVersion, domain, subDomain,
                category, language, retrieval, content, relationships, administrativeDetails, state);
