...
public final class CopilotHealth implements JsonSerializable<CopilotHealth> {
     ...
     */
    @Generated
    private CopilotHealth(String message, OperationStatusValue operationStatus, List<String> errorMessage) {
    ...
    public static CopilotHealth fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new CopilotHealth(message, operationStatus, errorMessage);
        });
    }
}
