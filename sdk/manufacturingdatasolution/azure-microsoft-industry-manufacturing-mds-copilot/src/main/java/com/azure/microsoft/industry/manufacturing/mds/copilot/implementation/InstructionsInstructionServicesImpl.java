...
/**
 * An instance of this class provides access to all the operations defined in InstructionsInstructionServices.
 */
public final class InstructionsInstructionServicesImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final InstructionsInstructionServicesService service;
    ...
    /**
     * Initializes an instance of InstructionsInstructionServicesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    InstructionsInstructionServicesImpl(CopilotServiceClientImpl client) {
        this.service = RestProxy.create(InstructionsInstructionServicesService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for CopilotServiceClientInstructionsInstructionServices to be used by the
     * proxy service to perform REST calls.
     */
    @Host("https://mds-{mdsUniqueId}.{location}.cloudapp.azure.com/")
    @ServiceInterface(name = "CopilotServiceClient")
    public interface InstructionsInstructionServicesService {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listSinglePageAsync(String state, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.list(this.client.getMdsUniqueId(), this.client.getLocation(),
                this.client.getServiceVersion().getVersion(), state, accept, requestOptions, context))
    ...
    public PagedFlux<BinaryData> listAsync(String state, RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedFlux<>(() -> listSinglePageAsync(state, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listSinglePage(String state, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listSync(this.client.getMdsUniqueId(), this.client.getLocation(),
            this.client.getServiceVersion().getVersion(), state, accept, requestOptions, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BinaryData> list(String state, RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedIterable<>(() -> listSinglePage(state, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<OperationResponse, Instruction> beginCreateWithModelAsync(BinaryData resource,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<OperationResponse, Instruction> beginCreateWithModel(BinaryData resource,
        RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1), () -> this.createWithResponse(resource, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.client.getHttpPipeline())
