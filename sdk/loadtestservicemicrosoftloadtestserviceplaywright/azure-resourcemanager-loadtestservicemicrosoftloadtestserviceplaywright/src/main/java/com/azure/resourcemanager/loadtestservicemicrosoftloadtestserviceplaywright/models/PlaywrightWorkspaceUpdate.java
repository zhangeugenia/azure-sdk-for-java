...
import com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceplaywright.fluent.models.PlaywrightWorkspaceUpdateProperties;
...
public final class PlaywrightWorkspaceUpdate implements JsonSerializable<PlaywrightWorkspaceUpdate> {
     ...
     */
    private PlaywrightWorkspaceUpdateProperties innerProperties;
     ...
     * @return the PlaywrightWorkspaceUpdate object itself.
     */
    public PlaywrightWorkspaceUpdate withRegionalAffinity(EnablementStatus regionalAffinity) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PlaywrightWorkspaceUpdateProperties();
        }
     ...
     * @return the PlaywrightWorkspaceUpdate object itself.
     */
    public PlaywrightWorkspaceUpdate withLocalAuth(EnablementStatus localAuth) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PlaywrightWorkspaceUpdateProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("tags".equals(fieldName)) {
                    ...
                    deserializedPlaywrightWorkspaceUpdate.innerProperties
