...
package com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceplaywright.fluent.models;
...
public final class PlaywrightWorkspaceInner extends Resource {
     ...
     */
    private PlaywrightWorkspaceProperties innerProperties;
     ...
     */
    public PlaywrightWorkspaceInner withRegionalAffinity(EnablementStatus regionalAffinity) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PlaywrightWorkspaceProperties();
        }
    ...
    public EnablementStatus localAuth() {
        return this.innerProperties() == null ? null : this.innerProperties().localAuth();
    }
     ...
     * @return the PlaywrightWorkspaceInner object itself.
     */
    public PlaywrightWorkspaceInner withLocalAuth(EnablementStatus localAuth) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PlaywrightWorkspaceProperties();
        }
        this.innerProperties().withLocalAuth(localAuth);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedPlaywrightWorkspaceInner.innerProperties
                        = PlaywrightWorkspaceProperties.fromJson(reader);
