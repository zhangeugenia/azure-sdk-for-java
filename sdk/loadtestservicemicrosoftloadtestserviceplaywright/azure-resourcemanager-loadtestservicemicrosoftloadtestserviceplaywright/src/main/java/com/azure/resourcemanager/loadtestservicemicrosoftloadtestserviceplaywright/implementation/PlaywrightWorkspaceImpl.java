...
import com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceplaywright.models.ProvisioningState;
...
public final class PlaywrightWorkspaceImpl
    ...
    public EnablementStatus localAuth() {
        return this.innerModel().localAuth();
    }
    ...
    public PlaywrightWorkspaceImpl withRegionalAffinity(EnablementStatus regionalAffinity) {
        if (isInCreateMode()) {
    ...
    public PlaywrightWorkspaceImpl withLocalAuth(EnablementStatus localAuth) {
        if (isInCreateMode()) {
            this.innerModel().withLocalAuth(localAuth);
            return this;
        } else {
            this.updateProperties.withLocalAuth(localAuth);
            return this;
        }
    }
