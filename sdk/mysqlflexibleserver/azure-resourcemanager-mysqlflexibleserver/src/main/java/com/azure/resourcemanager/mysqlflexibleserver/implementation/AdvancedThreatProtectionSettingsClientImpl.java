...
public final class AdvancedThreatProtectionSettingsClientImpl implements AdvancedThreatProtectionSettingsClient {
    ...
    public interface AdvancedThreatProtectionSettingsService {
        ...
        Mono<Response<AdvancedThreatProtectionInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AdvancedThreatProtectionListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<Response<AdvancedThreatProtectionInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvancedThreatProtectionInner> getAsync(
        String resourceGroupName, String serverName, AdvancedThreatProtectionName advancedThreatProtectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AdvancedThreatProtectionInner> getWithResponse(
        String resourceGroupName,
        String serverName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
        Context context) {
    ...
    private PollerFlux<PollResult<AdvancedThreatProtectionInner>, AdvancedThreatProtectionInner> beginUpdateAsync(
        ...
        return this
            .client
            .<AdvancedThreatProtectionInner, AdvancedThreatProtectionInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvancedThreatProtectionInner> updateAsync(
        String resourceGroupName,
        String serverName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
        AdvancedThreatProtectionForUpdate parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AdvancedThreatProtectionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AdvancedThreatProtectionInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AdvancedThreatProtectionInner> listAsync(
        String resourceGroupName, String serverName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AdvancedThreatProtectionInner> list(
        String resourceGroupName, String serverName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AdvancedThreatProtectionInner>> listNextSinglePageAsync(
