...
public final class ImpactedResourcesClientImpl implements ImpactedResourcesClient {
    ...
    public interface ImpactedResourcesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EventImpactedResourceInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("eventTrackingId") String eventTrackingId,
            @PathParam("impactedResourceName") String impactedResourceName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EventImpactedResourceInner> getByTenantIdSync(@HostParam("$host") String endpoint,
            @PathParam("eventTrackingId") String eventTrackingId,
            @PathParam("impactedResourceName") String impactedResourceName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<EventImpactedResourceInner> getWithResponse(String eventTrackingId, String impactedResourceName,
        ...
        if (impactedResourceName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter impactedResourceName is required and cannot be null."));
        }
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), eventTrackingId,
    ...
    public Response<EventImpactedResourceInner> getByTenantIdWithResponse(String eventTrackingId,
        ...
        final String accept = "application/json";
        return service.getByTenantIdSync(this.client.getEndpoint(), eventTrackingId, impactedResourceName,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ImpactedResourcesClientImpl.class);
}
