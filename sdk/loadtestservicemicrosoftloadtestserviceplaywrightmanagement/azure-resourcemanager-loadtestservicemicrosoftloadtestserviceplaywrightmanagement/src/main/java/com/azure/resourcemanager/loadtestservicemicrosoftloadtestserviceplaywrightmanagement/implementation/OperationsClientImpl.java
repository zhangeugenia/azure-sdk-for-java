...
import com.azure.resourcemanager.loadtestservicemicrosoftloadtestserviceplaywrightmanagement.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(PlaywrightServiceClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PlaywrightServiceClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
