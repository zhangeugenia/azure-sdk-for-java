...
public final class RaiPolicyOperationsClientImpl implements RaiPolicyOperationsClient {
    ...
    public interface RaiPolicyOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RaiPolicyPropertiesBasicResourceInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("endpointName") String endpointName, @PathParam("raiPolicyName") String raiPolicyName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String workspaceName, String endpointName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, endpointName, raiPolicyName, this.client.getApiVersion(), proxyApiVersion, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, workspaceName, endpointName, raiPolicyName, proxyApiVersion);
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName) {
        final String proxyApiVersion = null;
        beginDelete(resourceGroupName, workspaceName, endpointName, raiPolicyName, proxyApiVersion).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName,
        ...
        beginDelete(resourceGroupName, workspaceName, endpointName, raiPolicyName, proxyApiVersion, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String workspaceName, String endpointName,
        String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body, String proxyApiVersion) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        beginCreate(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName,
            RaiPolicyPropertiesBasicResourceInner body, String proxyApiVersion) {
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, proxyApiVersion);
        return this.client.<RaiPolicyPropertiesBasicResourceInner, RaiPolicyPropertiesBasicResourceInner>getLroResult(
    ...
    public SyncPoller<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        ...
        Response<BinaryData> response = createWithResponse(resourceGroupName, workspaceName, endpointName,
    ...
    public RaiPolicyPropertiesBasicResourceInner create(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body) {
        final String proxyApiVersion = null;
        return beginCreate(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, proxyApiVersion)
            .getFinalResult();
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RaiPolicyOperationsClientImpl.class);
}
