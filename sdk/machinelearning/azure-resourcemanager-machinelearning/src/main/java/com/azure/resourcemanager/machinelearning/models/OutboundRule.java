...
public class OutboundRule implements JsonSerializable<OutboundRule> {
    ...
    /**
     * Get the errorInformation property: Error information about an outbound rule of a machine learning workspace if
    ...
    /**
     * Set the errorInformation property: Error information about an outbound rule of a machine learning workspace if
     * RuleStatus is failed.
     * 
