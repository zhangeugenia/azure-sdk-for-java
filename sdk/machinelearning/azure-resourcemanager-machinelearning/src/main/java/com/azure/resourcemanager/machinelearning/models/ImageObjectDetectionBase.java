...
public class ImageObjectDetectionBase extends ImageVertical {
        ...
        if (limitSettings() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property limitSettings in model ImageObjectDetectionBase"));
        } else {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ImageObjectDetectionBase.class);
