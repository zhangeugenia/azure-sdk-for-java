...
public final class SweepJob extends JobBaseProperties {
     ...
     */
    @Override
    public SweepJob withParentJobName(String parentJobName) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("description".equals(fieldName)) {
                    ...
                    deserializedSweepJob.withParentJobName(reader.getString());
                    ...
                    deserializedSweepJob.withStatus(JobStatus.fromString(reader.getString()));
