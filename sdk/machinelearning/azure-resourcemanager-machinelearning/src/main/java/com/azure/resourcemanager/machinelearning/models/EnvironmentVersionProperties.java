...
public final class EnvironmentVersionProperties extends AssetBase {
    ...
    /**
     * Get the imageDetails property: Environment image details.
     * 
     * @return the imageDetails value.
     */
    ...
    /**
     * Set the imageDetails property: Environment image details.
     * 
     * @param imageDetails the imageDetails value to set.
     * @return the EnvironmentVersionProperties object itself.
     */
    public EnvironmentVersionProperties withImageDetails(ImageDetails imageDetails) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("imageDetails", this.imageDetails);
    ...
    public static EnvironmentVersionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("imageDetails".equals(fieldName)) {
                    deserializedEnvironmentVersionProperties.imageDetails = ImageDetails.fromJson(reader);
