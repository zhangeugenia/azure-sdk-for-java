...
public final class ModelVersionsClientImpl implements ModelVersionsClient {
    ...
    public interface ModelVersionsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ModelVersionInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") ModelVersionInner body,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ModelVersionsClientImpl.class);
}
