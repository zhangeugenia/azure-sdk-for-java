...
public final class ComponentVersionsClientImpl implements ComponentVersionsClient {
    ...
    public interface ComponentVersionsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ComponentVersionInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") ComponentVersionInner body,
    ...
    private PagedResponse<ComponentVersionInner> listSinglePage(String resourceGroupName, String workspaceName,
        ...
        final String accept = "application/json";
        Response<ComponentVersionResourceArmPaginatedResult> res = service.listSync(this.client.getEndpoint(),
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ComponentVersionsClientImpl.class);
}
