...
public final class PtuQuotasClientImpl implements PtuQuotasClient {
    ...
    private Mono<PagedResponse<AvailableQuotaInner>> listAvailableSinglePageAsync(String location, String skip,
        ...
        return service
            .listAvailable(this.client.getEndpoint(), this.client.getSubscriptionId(), location,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailableQuotaInner> listAvailableAsync(String location, String skip, Context context) {
        return new PagedFlux<>(() -> listAvailableSinglePageAsync(location, skip, context),
            nextLink -> listAvailableNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<AvailableQuotaInner> listAvailable(String location) {
        final String skip = null;
        return new PagedIterable<>(listAvailableAsync(location, skip));
    }
    ...
    public PagedIterable<AvailableQuotaInner> listAvailable(String location, String skip, Context context) {
        return new PagedIterable<>(listAvailableAsync(location, skip, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AvailableQuotaInner>> getAvailableWithResponseAsync(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getAvailable(this.client.getEndpoint(), this.client.getSubscriptionId(), location,
    ...
    public Response<AvailableQuotaInner> getAvailableWithResponse(String location, Context context) {
        return getAvailableWithResponseAsync(location, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<UsageAndQuotaDetailsInner> listAsync(String location, String skip, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(location, skip, context),
    ...
    public PagedIterable<UsageAndQuotaDetailsInner> list(String location) {
        final String skip = null;
        return new PagedIterable<>(listAsync(location, skip));
    }
    ...
    public PagedIterable<UsageAndQuotaDetailsInner> list(String location, String skip, Context context) {
        return new PagedIterable<>(listAsync(location, skip, context));
    }
    ...
    private Mono<PagedResponse<AvailableQuotaInner>> listAvailableNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listAvailableNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UsageAndQuotaDetailsInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
