...
public final class RaiPolicyContentFilter implements JsonSerializable<RaiPolicyContentFilter> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("allowedContentLevel",
            this.allowedContentLevel == null ? null : this.allowedContentLevel.toString());
    ...
    public static RaiPolicyContentFilter fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("allowedContentLevel".equals(fieldName)) {
                    deserializedRaiPolicyContentFilter.allowedContentLevel
                        = AllowedContentLevel.fromString(reader.getString());
