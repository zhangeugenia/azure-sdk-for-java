...
public final class InferenceEndpointImpl
    ...
    public InferenceEndpointImpl withExistingInferencePool(
    ...
    public InferenceEndpoint create() {
        this.innerObject =
            serviceManager
                ...
                .createOrUpdate(
                    resourceGroupName, workspaceName, poolName, endpointName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    InferenceEndpointImpl(
        InferenceEndpointInner innerObject,
