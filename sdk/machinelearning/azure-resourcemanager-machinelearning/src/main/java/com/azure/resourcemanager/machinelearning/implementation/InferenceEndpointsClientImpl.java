...
public final class InferenceEndpointsClientImpl implements InferenceEndpointsClient {
     ...
     */
    InferenceEndpointsClientImpl(AzureMachineLearningWorkspacesImpl client) {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningWorkspacesInferenceEndpoints to be used by the
    ...
    public interface InferenceEndpointsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InferenceEndpointTrackedResourceArmPaginatedResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("poolName") String poolName, @QueryParam("api-version") String apiVersion,
            @QueryParam("count") Integer count, @QueryParam("$skip") String skip, @QueryParam("tags") String tags,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InferenceEndpointInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("poolName") String poolName, @PathParam("endpointName") String endpointName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String workspaceName, String poolName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, poolName, endpointName, this.client.getApiVersion(), accept, Context.NONE);
    }
    ...
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String workspaceName, String poolName,
        ...
        return service.updateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, poolName, endpointName, this.client.getApiVersion(), body, accept, Context.NONE);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(InferenceEndpointsClientImpl.class);
}
