...
public final class InferenceGroupsImpl implements InferenceGroups {
    ...
    public PagedIterable<InferenceGroup> list(
    ...
    public Response<InferenceGroup> getWithResponse(
        String resourceGroupName, String workspaceName, String poolName, String groupName, Context context) {
    ...
    public Response<GroupStatus> getStatusWithResponse(
        ...
        Response<GroupStatusInner> inner =
            this.serviceClient().getStatusWithResponse(resourceGroupName, workspaceName, poolName, groupName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PagedIterable<SkuResource> listSkus(
        ...
        Context context) {
        PagedIterable<SkuResourceInner> inner =
            this.serviceClient().listSkus(resourceGroupName, workspaceName, poolName, groupName, count, skip, context);
        return Utils.mapPage(inner, inner1 -> new SkuResourceImpl(inner1, this.manager()));
    }
