...
public final class FeaturestoreEntityVersionsClientImpl implements FeaturestoreEntityVersionsClient {
    ...
    public interface FeaturestoreEntityVersionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FeaturestoreEntityVersionResourceArmPaginatedResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @QueryParam("$skip") String skip, @QueryParam("tags") String tags,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FeaturestoreEntityVersionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FeaturestoreEntityVersionResourceArmPaginatedResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a paginated list of FeaturestoreEntityVersion entities along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FeaturestoreEntityVersionInner> listSinglePage(String resourceGroupName, String workspaceName,
        String name, String skip, String tags, ListViewType listViewType, Integer pageSize, String versionName,
        String version, String description, String createdBy, String stage) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<FeaturestoreEntityVersionResourceArmPaginatedResult> res = service.listSync(this.client.getEndpoint(),
    ...
    public SyncPoller<PollResult<FeaturestoreEntityVersionInner>, FeaturestoreEntityVersionInner> beginCreateOrUpdate(
        ...
        return this.client.<FeaturestoreEntityVersionInner, FeaturestoreEntityVersionInner>getLroResult(response,
            FeaturestoreEntityVersionInner.class, FeaturestoreEntityVersionInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FeaturestoreEntityVersionInner>, FeaturestoreEntityVersionInner> beginCreateOrUpdate(
        ...
        return this.client.<FeaturestoreEntityVersionInner, FeaturestoreEntityVersionInner>getLroResult(response,
            FeaturestoreEntityVersionInner.class, FeaturestoreEntityVersionInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FeaturestoreEntityVersionInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<FeaturestoreEntityVersionResourceArmPaginatedResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FeaturestoreEntityVersionInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(FeaturestoreEntityVersionsClientImpl.class);
}
