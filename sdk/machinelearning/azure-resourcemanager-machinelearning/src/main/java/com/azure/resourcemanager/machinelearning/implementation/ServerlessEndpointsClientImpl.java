...
public final class ServerlessEndpointsClientImpl implements ServerlessEndpointsClient {
    ...
    public interface ServerlessEndpointsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerlessEndpointStatusInner>> getStatus(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerlessEndpointStatusInner>> getStatusWithResponseAsync(
        String resourceGroupName, String workspaceName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerlessEndpointStatusInner> getStatusAsync(
        String resourceGroupName, String workspaceName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServerlessEndpointStatusInner> getStatusWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context) {
