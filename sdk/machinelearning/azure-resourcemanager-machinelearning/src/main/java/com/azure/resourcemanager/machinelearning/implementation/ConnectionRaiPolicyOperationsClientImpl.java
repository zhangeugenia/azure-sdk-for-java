...
public final class ConnectionRaiPolicyOperationsClientImpl implements ConnectionRaiPolicyOperationsClient {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion);
    ...
    public void delete(String resourceGroupName, String workspaceName, String connectionName, String raiPolicyName) {
        final String proxyApiVersion = null;
        beginDelete(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String connectionName, String raiPolicyName,
        ...
        beginDelete(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion, context)
            .getFinalResult();
    }
    ...
    public RaiPolicyPropertiesBasicResourceInner create(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body) {
        final String proxyApiVersion = null;
        return beginCreate(resourceGroupName, workspaceName, connectionName, raiPolicyName, body, proxyApiVersion)
            .getFinalResult();
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ConnectionRaiPolicyOperationsClientImpl.class);
}
