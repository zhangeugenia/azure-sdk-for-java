...
public final class RaiPoliciesClientImpl implements RaiPoliciesClient {
    ...
    private PagedResponse<RaiPolicyPropertiesBasicResourceInner> listSinglePage(String resourceGroupName,
        ...
        Response<RaiPolicyPropertiesBasicResourceArmPaginatedResult> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, endpointName, this.client.getApiVersion(), proxyApiVersion, accept, Context.NONE);
    ...
    public PagedIterable<RaiPolicyPropertiesBasicResourceInner> list(String resourceGroupName, String workspaceName,
        ...
        return new PagedIterable<>(
            () -> listSinglePage(resourceGroupName, workspaceName, endpointName, proxyApiVersion),
    ...
    public PagedIterable<RaiPolicyPropertiesBasicResourceInner> list(String resourceGroupName, String workspaceName,
        ...
        return new PagedIterable<>(
            () -> listSinglePage(resourceGroupName, workspaceName, endpointName, proxyApiVersion, context),
