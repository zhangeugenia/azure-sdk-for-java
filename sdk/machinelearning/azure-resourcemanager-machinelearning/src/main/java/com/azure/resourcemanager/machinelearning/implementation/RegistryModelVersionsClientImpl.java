...
public final class RegistryModelVersionsClientImpl implements RegistryModelVersionsClient {
    ...
    public SyncPoller<PollResult<PackageResponseInner>, PackageResponseInner> beginPackageMethod(
        ...
        Context context) {
        return this
            .beginPackageMethodAsync(resourceGroupName, registryName, modelName, version, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<PackageResponseInner> packageMethodAsync(
        String resourceGroupName, String registryName, String modelName, String version, PackageRequest body) {
        return beginPackageMethodAsync(resourceGroupName, registryName, modelName, version, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PackageResponseInner> packageMethodAsync(
        ...
        PackageRequest body,
        Context context) {
        return beginPackageMethodAsync(resourceGroupName, registryName, modelName, version, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
