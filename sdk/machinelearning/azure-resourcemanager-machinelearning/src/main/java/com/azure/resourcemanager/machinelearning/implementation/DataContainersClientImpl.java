...
public final class DataContainersClientImpl implements DataContainersClient {
    ...
    public interface DataContainersService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DataContainerInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataContainerInner body, @HeaderParam("Accept") String accept,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DataContainersClientImpl.class);
}
