        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("computeLocation".equals(fieldName)) {
                    ...
                    deserializedDataLakeAnalytics.withCreatedOn(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("modifiedOn".equals(fieldName)) {
                    deserializedDataLakeAnalytics.withModifiedOn(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                    ...
                    deserializedDataLakeAnalytics.withProvisioningErrors(provisioningErrors);
                } else if ("isAttachedCompute".equals(fieldName)) {
                    deserializedDataLakeAnalytics.withIsAttachedCompute(reader.getNullable(JsonReader::getBoolean));
