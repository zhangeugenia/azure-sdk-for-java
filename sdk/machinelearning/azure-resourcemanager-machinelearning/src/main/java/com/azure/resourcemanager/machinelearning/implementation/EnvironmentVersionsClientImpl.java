...
public final class EnvironmentVersionsClientImpl implements EnvironmentVersionsClient {
    ...
    public interface EnvironmentVersionsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<EnvironmentVersionInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") EnvironmentVersionInner body,
    ...
    private PagedResponse<EnvironmentVersionInner> listSinglePage(String resourceGroupName, String workspaceName,
        ...
        Response<EnvironmentVersionResourceArmPaginatedResult> res = service.listSync(this.client.getEndpoint(),
            ...
            orderBy, top, skip, listViewType, accept, Context.NONE);
    ...
    private PagedResponse<EnvironmentVersionInner> listSinglePage(String resourceGroupName, String workspaceName,
        ...
        Response<EnvironmentVersionResourceArmPaginatedResult> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, name, this.client.getApiVersion(), orderBy, top, skip, listViewType, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(EnvironmentVersionsClientImpl.class);
}
