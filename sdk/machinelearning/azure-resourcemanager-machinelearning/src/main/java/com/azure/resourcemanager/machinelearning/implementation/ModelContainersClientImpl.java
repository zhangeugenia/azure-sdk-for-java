...
public final class ModelContainersClientImpl implements ModelContainersClient {
    ...
    public interface ModelContainersService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ModelContainerInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ModelContainerInner body, @HeaderParam("Accept") String accept,
    ...
    private PagedResponse<ModelContainerInner> listSinglePage(String resourceGroupName, String workspaceName,
        ...
        Response<ModelContainerResourceArmPaginatedResult> res
            = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, this.client.getApiVersion(), skip, count, listViewType, accept, Context.NONE);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ModelContainersClientImpl.class);
}
