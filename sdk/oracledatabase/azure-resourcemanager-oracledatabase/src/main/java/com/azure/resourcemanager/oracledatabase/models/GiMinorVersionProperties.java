...
public final class GiMinorVersionProperties implements JsonSerializable<GiMinorVersionProperties> {
    ...
    /**
     * Set the version property: A valid Oracle Grid Infrastructure (GI) software version.
     * 
     * @param version the version value to set.
     * @return the GiMinorVersionProperties object itself.
     */
    public GiMinorVersionProperties withVersion(String version) {
    ...
    /**
     * Set the gridImageOcid property: Grid Infrastructure Image Id.
     * 
     * @param gridImageOcid the gridImageOcid value to set.
     * @return the GiMinorVersionProperties object itself.
     */
    public GiMinorVersionProperties withGridImageOcid(String gridImageOcid) {
