...
public final class ExascaleDbNodesClientImpl implements ExascaleDbNodesClient {
    ...
    public interface ExascaleDbNodesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExascaleDbNodeListResult> listByParentSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("exadbVmClusterName") String exadbVmClusterName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExascaleDbNodeInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("exadbVmClusterName") String exadbVmClusterName,
            @PathParam("exascaleDbNodeName") String exascaleDbNodeName, @HeaderParam("Accept") String accept,
    ...
    private Response<BinaryData> actionWithResponse(String resourceGroupName, String exadbVmClusterName,
        ...
        return service.actionSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, exadbVmClusterName, exascaleDbNodeName, body, accept,
            Context.NONE);
    }
