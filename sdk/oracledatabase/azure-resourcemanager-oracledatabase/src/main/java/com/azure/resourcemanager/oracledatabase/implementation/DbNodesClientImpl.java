...
public final class DbNodesClientImpl implements DbNodesClient {
    ...
    public interface DbNodesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DbNodeListResult> listByParentSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudvmclustername") String cloudvmclustername, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DbNodeInner> getSync(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> actionSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudvmclustername") String cloudvmclustername, @PathParam("dbnodeocid") String dbnodeocid,
            @BodyParam("application/json") DbNodeAction body, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DbNodeListResult> listByParentNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DbNodeInner> listByParentSinglePage(String resourceGroupName, String cloudvmclustername) {
        if (this.client.getEndpoint() == null) {
    ...
    public PagedIterable<DbNodeInner> listByParent(String resourceGroupName, String cloudvmclustername) {
        return new PagedIterable<>(() -> listByParentSinglePage(resourceGroupName, cloudvmclustername),
    ...
    public PagedIterable<DbNodeInner> listByParent(String resourceGroupName, String cloudvmclustername,
        Context context) {
        return new PagedIterable<>(() -> listByParentSinglePage(resourceGroupName, cloudvmclustername, context),
    ...
    private Response<BinaryData> actionWithResponse(String resourceGroupName, String cloudvmclustername,
        ...
        return service.actionSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, cloudvmclustername, dbnodeocid, body, accept,
            Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DbNodeInner> listByParentNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<DbNodeInner> listByParentNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
