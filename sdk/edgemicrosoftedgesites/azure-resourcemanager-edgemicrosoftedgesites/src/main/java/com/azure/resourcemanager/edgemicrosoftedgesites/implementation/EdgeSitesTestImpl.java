...
/**
 * Initializes a new instance of the EdgeSitesTestImpl type.
 */
@ServiceClient(builder = EdgeSitesTestBuilder.class)
public final class EdgeSitesTestImpl implements EdgeSitesTest {
    /**
    ...
    /**
     * Initializes an instance of EdgeSitesTest client.
     * 
     ...
     */
    EdgeSitesTestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(EdgeSitesTestImpl.class);
}
