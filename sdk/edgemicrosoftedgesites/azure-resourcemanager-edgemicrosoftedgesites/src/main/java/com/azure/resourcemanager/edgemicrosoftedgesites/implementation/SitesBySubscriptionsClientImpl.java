...
public final class SitesBySubscriptionsClientImpl implements SitesBySubscriptionsClient {
     ...
     */
    private final EdgeSitesTestImpl client;
     ...
     */
    SitesBySubscriptionsClientImpl(EdgeSitesTestImpl client) {
    ...
    /**
     * The interface defining all the services for EdgeSitesTestSitesBySubscriptions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EdgeSitesTestSitesBy")
    public interface SitesBySubscriptionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("siteName") String siteName, @BodyParam("application/json") SiteInner resource,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SiteInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("siteName") String siteName, @BodyParam("application/json") SiteUpdate properties,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String siteName, SiteInner resource) {
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), siteName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SiteInner>> updateWithResponseAsync(String siteName, SiteUpdate properties) {
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), siteName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SiteInner>> updateWithResponseAsync(String siteName, SiteUpdate properties, Context context) {
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            siteName, properties, accept, context);
    }
