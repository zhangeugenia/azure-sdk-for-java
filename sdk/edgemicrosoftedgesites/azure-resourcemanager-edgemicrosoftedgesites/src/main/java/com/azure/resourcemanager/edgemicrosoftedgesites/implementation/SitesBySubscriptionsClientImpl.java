...
public final class SitesBySubscriptionsClientImpl implements SitesBySubscriptionsClient {
     ...
     */
    SitesBySubscriptionsClientImpl(EdgeSitesImpl client) {
    ...
    /**
     * The interface defining all the services for EdgeSitesSitesBySubscriptions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EdgeSitesSitesBySubs")
