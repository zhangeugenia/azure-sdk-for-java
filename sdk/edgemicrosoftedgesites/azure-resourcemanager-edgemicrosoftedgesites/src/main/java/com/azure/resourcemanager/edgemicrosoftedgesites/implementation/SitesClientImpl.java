...
public final class SitesClientImpl implements SitesClient {
     ...
     */
    SitesClientImpl(EdgeSitesImpl client) {
        this.service = RestProxy.create(SitesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for EdgeSitesSites to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EdgeSitesSites")
