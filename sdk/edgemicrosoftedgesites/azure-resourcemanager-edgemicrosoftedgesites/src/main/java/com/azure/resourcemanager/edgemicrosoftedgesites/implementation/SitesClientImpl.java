...
public final class SitesClientImpl implements SitesClient {
     ...
     */
    SitesClientImpl(EdgeSitesTestImpl client) {
        this.service = RestProxy.create(SitesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for EdgeSitesTestSites to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EdgeSitesTestSites")
    public interface SitesService {
        ...
        Mono<Response<SiteInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("siteName") String siteName,
            @BodyParam("application/json") SiteUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
