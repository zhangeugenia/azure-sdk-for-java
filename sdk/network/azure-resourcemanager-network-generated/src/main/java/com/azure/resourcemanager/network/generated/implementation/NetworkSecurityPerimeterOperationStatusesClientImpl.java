...
public final class NetworkSecurityPerimeterOperationStatusesClientImpl
    ...
    public interface NetworkSecurityPerimeterOperationStatusesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<OperationStatusResultInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @PathParam("operationId") String operationId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<OperationStatusResultInner> getWithResponse(String location, String operationId, Context context) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), location, operationId,
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(NetworkSecurityPerimeterOperationStatusesClientImpl.class);
}
