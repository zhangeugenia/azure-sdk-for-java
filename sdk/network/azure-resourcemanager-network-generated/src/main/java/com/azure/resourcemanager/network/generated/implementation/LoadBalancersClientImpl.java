...
public final class LoadBalancersClientImpl implements LoadBalancersClient {
    ...
    public interface LoadBalancersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("$expand") String expand,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") TagsObject parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> swapPublicIpAddressesSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") LoadBalancerVipSwapRequest parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> listInboundNatRulePortMappingsSync(@HostParam("$host") String endpoint,
            @PathParam("groupName") String groupName, @PathParam("loadBalancerName") String loadBalancerName,
            @PathParam("backendPoolName") String backendPoolName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") QueryInboundNatRulePortMappingRequest parameters,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<MigratedPoolsInner> migrateToIpBasedSync(@HostParam("$host") String endpoint,
            @PathParam("groupName") String groupName, @PathParam("loadBalancerName") String loadBalancerName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") MigrateLoadBalancerToIpBasedRequest parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerListResult> listAllNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String loadBalancerName) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, loadBalancerName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String loadBalancerName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, loadBalancerName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String loadBalancerName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, loadBalancerName, context);
    ...
    public void delete(String resourceGroupName, String loadBalancerName) {
        beginDelete(resourceGroupName, loadBalancerName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String loadBalancerName, Context context) {
        beginDelete(resourceGroupName, loadBalancerName, context).getFinalResult();
    }
    ...
    public Response<LoadBalancerInner> getByResourceGroupWithResponse(String resourceGroupName, String loadBalancerName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, loadBalancerName,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String loadBalancerName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, loadBalancerName, apiVersion,
    ...
    public SyncPoller<PollResult<LoadBalancerInner>, LoadBalancerInner> beginCreateOrUpdate(String resourceGroupName,
        String loadBalancerName, LoadBalancerInner parameters) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, loadBalancerName, parameters);
    ...
    public SyncPoller<PollResult<LoadBalancerInner>, LoadBalancerInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, loadBalancerName, parameters, context);
        return this.client.<LoadBalancerInner, LoadBalancerInner>getLroResult(response, LoadBalancerInner.class,
    ...
    public LoadBalancerInner createOrUpdate(String resourceGroupName, String loadBalancerName,
        LoadBalancerInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, loadBalancerName, parameters).getFinalResult();
    }
    ...
    public LoadBalancerInner createOrUpdate(String resourceGroupName, String loadBalancerName,
        LoadBalancerInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, loadBalancerName, parameters, context).getFinalResult();
    }
    ...
    public Response<LoadBalancerInner> updateTagsWithResponse(String resourceGroupName, String loadBalancerName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, loadBalancerName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the load balancers in a subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<LoadBalancerListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the load balancers in a resource group along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<LoadBalancerListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listByResourceGroupSinglePage(String resourceGroupName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> swapPublicIpAddressesWithResponse(String location,
        LoadBalancerVipSwapRequest parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.swapPublicIpAddressesSync(this.client.getEndpoint(), location, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginSwapPublicIpAddresses(String location,
        LoadBalancerVipSwapRequest parameters) {
        Response<BinaryData> response = swapPublicIpAddressesWithResponse(location, parameters);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginSwapPublicIpAddresses(String location,
        LoadBalancerVipSwapRequest parameters, Context context) {
        Response<BinaryData> response = swapPublicIpAddressesWithResponse(location, parameters, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void swapPublicIpAddresses(String location, LoadBalancerVipSwapRequest parameters) {
        beginSwapPublicIpAddresses(location, parameters).getFinalResult();
    }
    ...
    public void swapPublicIpAddresses(String location, LoadBalancerVipSwapRequest parameters, Context context) {
        beginSwapPublicIpAddresses(location, parameters, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response for a QueryInboundNatRulePortMapping API along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> listInboundNatRulePortMappingsWithResponse(String groupName, String loadBalancerName,
        ...
        if (backendPoolName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter backendPoolName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listInboundNatRulePortMappingsSync(this.client.getEndpoint(), groupName, loadBalancerName,
            backendPoolName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    public
        ...
        beginListInboundNatRulePortMappings(String groupName, String loadBalancerName, String backendPoolName,
            QueryInboundNatRulePortMappingRequest parameters) {
        Response<BinaryData> response
            = listInboundNatRulePortMappingsWithResponse(groupName, loadBalancerName, backendPoolName, parameters);
        return this.client
            .<BackendAddressInboundNatRulePortMappingsInner, BackendAddressInboundNatRulePortMappingsInner>getLroResult(
                response, BackendAddressInboundNatRulePortMappingsInner.class,
                BackendAddressInboundNatRulePortMappingsInner.class, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response = listInboundNatRulePortMappingsWithResponse(groupName, loadBalancerName,
            backendPoolName, parameters, context);
        return this.client
            .<BackendAddressInboundNatRulePortMappingsInner, BackendAddressInboundNatRulePortMappingsInner>getLroResult(
                response, BackendAddressInboundNatRulePortMappingsInner.class,
    ...
    public BackendAddressInboundNatRulePortMappingsInner listInboundNatRulePortMappings(String groupName,
        String loadBalancerName, String backendPoolName, QueryInboundNatRulePortMappingRequest parameters) {
        return beginListInboundNatRulePortMappings(groupName, loadBalancerName, backendPoolName, parameters)
            .getFinalResult();
    }
    ...
    public BackendAddressInboundNatRulePortMappingsInner listInboundNatRulePortMappings(String groupName,
        String loadBalancerName, String backendPoolName, QueryInboundNatRulePortMappingRequest parameters,
        Context context) {
        return beginListInboundNatRulePortMappings(groupName, loadBalancerName, backendPoolName, parameters, context)
            .getFinalResult();
    }
    ...
    public Response<MigratedPoolsInner> migrateToIpBasedWithResponse(String groupName, String loadBalancerName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.migrateToIpBasedSync(this.client.getEndpoint(), groupName, loadBalancerName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListLoadBalancers API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listAllNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listAllNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
