...
public final class RoutingIntentsClientImpl implements RoutingIntentsClient {
    ...
    public interface RoutingIntentsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RoutingIntentInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName,
            @PathParam("routingIntentName") String routingIntentName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListRoutingIntentResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListRoutingIntentResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualHubName,
        ...
        if (routingIntentName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter routingIntentName is required and cannot be null."));
        }
        if (routingIntentParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter routingIntentParameters is required and cannot be null."));
        } else {
            routingIntentParameters.validate();
        }
        final String apiVersion = "2024-07-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routingIntentName, apiVersion, routingIntentParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RoutingIntentInner>, RoutingIntentInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routingIntentName, routingIntentParameters);
        return this.client.<RoutingIntentInner, RoutingIntentInner>getLroResult(response, RoutingIntentInner.class,
            RoutingIntentInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RoutingIntentInner>, RoutingIntentInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routingIntentName,
            routingIntentParameters, context);
        return this.client.<RoutingIntentInner, RoutingIntentInner>getLroResult(response, RoutingIntentInner.class,
            RoutingIntentInner.class, context);
    }
    ...
    public RoutingIntentInner createOrUpdate(String resourceGroupName, String virtualHubName, String routingIntentName,
        RoutingIntentInner routingIntentParameters) {
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routingIntentName, routingIntentParameters)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routingIntentName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routingIntentName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, routingIntentName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routingIntentName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, virtualHubName, routingIntentName, context);
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routingIntentName) {
        beginDelete(resourceGroupName, virtualHubName, routingIntentName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routingIntentName, Context context) {
        beginDelete(resourceGroupName, virtualHubName, routingIntentName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RoutingIntentInner> listSinglePage(String resourceGroupName, String virtualHubName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListRoutingIntentResult> res = service.listSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RoutingIntentInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListRoutingIntentResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RoutingIntentInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
