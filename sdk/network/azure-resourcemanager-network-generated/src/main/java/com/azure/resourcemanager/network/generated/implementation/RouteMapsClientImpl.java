...
public final class RouteMapsClientImpl implements RouteMapsClient {
    ...
    public interface RouteMapsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<RouteMapInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @PathParam("routeMapName") String routeMapName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListRouteMapsResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListRouteMapsResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<RouteMapInner> getWithResponse(String resourceGroupName, String virtualHubName, String routeMapName,
        ...
        if (routeMapName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter routeMapName is required and cannot be null."));
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualHubName,
        ...
        if (routeMapParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter routeMapParameters is required and cannot be null."));
        } else {
            routeMapParameters.validate();
        }
        final String apiVersion = "2024-07-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routeMapName, apiVersion, routeMapParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RouteMapInner>, RouteMapInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routeMapName, routeMapParameters);
        return this.client.<RouteMapInner, RouteMapInner>getLroResult(response, RouteMapInner.class,
            RouteMapInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<RouteMapInner>, RouteMapInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routeMapName, routeMapParameters, context);
        return this.client.<RouteMapInner, RouteMapInner>getLroResult(response, RouteMapInner.class,
            RouteMapInner.class, context);
    }
    ...
    public RouteMapInner createOrUpdate(String resourceGroupName, String virtualHubName, String routeMapName,
        ...
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routeMapName, routeMapParameters)
            .getFinalResult();
    }
    ...
    public RouteMapInner createOrUpdate(String resourceGroupName, String virtualHubName, String routeMapName,
        ...
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routeMapName, routeMapParameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routeMapName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routeMapName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, routeMapName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routeMapName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, routeMapName, context);
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routeMapName) {
        beginDelete(resourceGroupName, virtualHubName, routeMapName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routeMapName, Context context) {
        beginDelete(resourceGroupName, virtualHubName, routeMapName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of RouteMaps and a URL nextLink to get the next set of results along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RouteMapInner> listSinglePage(String resourceGroupName, String virtualHubName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListRouteMapsResult> res = service.listSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, virtualHubName, apiVersion, accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RouteMapInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListRouteMapsResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<RouteMapInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ListRouteMapsResult> res = service.listNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(RouteMapsClientImpl.class);
}
