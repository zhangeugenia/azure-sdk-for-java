...
public final class VipSwapsClientImpl implements VipSwapsClient {
    ...
    public interface VipSwapsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SwapResourceInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("groupName") String groupName, @PathParam("resourceName") String resourceName,
            @PathParam("singletonResource") String singletonResource, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> createSync(@HostParam("$host") String endpoint, @PathParam("groupName") String groupName,
            @PathParam("resourceName") String resourceName, @PathParam("singletonResource") String singletonResource,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<SwapResourceListResultInner> listSync(@HostParam("$host") String endpoint,
            @PathParam("groupName") String groupName, @PathParam("resourceName") String resourceName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<SwapResourceInner> getWithResponse(String groupName, String resourceName, Context context) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), groupName, resourceName, singletonResource, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String groupName, String resourceName,
        SwapResourceInner parameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), groupName, resourceName, singletonResource, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String groupName, String resourceName, SwapResourceInner parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginCreate(String groupName, String resourceName,
        SwapResourceInner parameters) {
        Response<BinaryData> response = createWithResponse(groupName, resourceName, parameters);
    ...
    public SyncPoller<PollResult<Void>, Void> beginCreate(String groupName, String resourceName,
        ...
        Response<BinaryData> response = createWithResponse(groupName, resourceName, parameters, context);
    ...
    public void create(String groupName, String resourceName, SwapResourceInner parameters) {
        beginCreate(groupName, resourceName, parameters).getFinalResult();
    }
    ...
    public void create(String groupName, String resourceName, SwapResourceInner parameters, Context context) {
        beginCreate(groupName, resourceName, parameters, context).getFinalResult();
    }
    ...
    public Response<SwapResourceListResultInner> listWithResponse(String groupName, String resourceName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listSync(this.client.getEndpoint(), groupName, resourceName, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VipSwapsClientImpl.class);
}
