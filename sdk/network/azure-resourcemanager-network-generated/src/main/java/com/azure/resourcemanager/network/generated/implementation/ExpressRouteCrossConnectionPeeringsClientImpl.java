...
public final class ExpressRouteCrossConnectionPeeringsClientImpl implements ExpressRouteCrossConnectionPeeringsClient {
    ...
    public interface ExpressRouteCrossConnectionPeeringsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionPeeringList> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("crossConnectionName") String crossConnectionName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionPeeringInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("crossConnectionName") String crossConnectionName, @PathParam("peeringName") String peeringName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionPeeringList> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all peerings in a specified ExpressRouteCrossConnection along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionPeeringInner> listSinglePage(String resourceGroupName,
        String crossConnectionName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionPeeringList> res = service.listSync(this.client.getEndpoint(),
            resourceGroupName, crossConnectionName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    ...
    private PagedResponse<ExpressRouteCrossConnectionPeeringInner> listSinglePage(String resourceGroupName,
        ...
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionPeeringList> res = service.listSync(this.client.getEndpoint(),
            resourceGroupName, crossConnectionName, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<ExpressRouteCrossConnectionPeeringInner> list(String resourceGroupName,
        String crossConnectionName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, crossConnectionName),
    ...
    public PagedIterable<ExpressRouteCrossConnectionPeeringInner> list(String resourceGroupName,
        String crossConnectionName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, crossConnectionName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String crossConnectionName,
        String peeringName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName, peeringName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String crossConnectionName,
        String peeringName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, crossConnectionName, peeringName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String crossConnectionName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, crossConnectionName, peeringName, context);
    ...
    public void delete(String resourceGroupName, String crossConnectionName, String peeringName) {
        beginDelete(resourceGroupName, crossConnectionName, peeringName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String crossConnectionName, String peeringName, Context context) {
        beginDelete(resourceGroupName, crossConnectionName, peeringName, context).getFinalResult();
    }
    ...
    public Response<ExpressRouteCrossConnectionPeeringInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName, peeringName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return peering in an ExpressRoute Cross Connection resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String crossConnectionName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName,
            peeringName, apiVersion, this.client.getSubscriptionId(), peeringParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCrossConnectionPeeringInner>, ExpressRouteCrossConnectionPeeringInner>
        beginCreateOrUpdate(String resourceGroupName, String crossConnectionName, String peeringName,
            ExpressRouteCrossConnectionPeeringInner peeringParameters) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, crossConnectionName, peeringName, peeringParameters);
        return this.client
            .<ExpressRouteCrossConnectionPeeringInner, ExpressRouteCrossConnectionPeeringInner>getLroResult(response,
                ExpressRouteCrossConnectionPeeringInner.class, ExpressRouteCrossConnectionPeeringInner.class,
                Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCrossConnectionPeeringInner>, ExpressRouteCrossConnectionPeeringInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, crossConnectionName, peeringName,
            peeringParameters, context);
        return this.client
            .<ExpressRouteCrossConnectionPeeringInner, ExpressRouteCrossConnectionPeeringInner>getLroResult(response,
                ExpressRouteCrossConnectionPeeringInner.class, ExpressRouteCrossConnectionPeeringInner.class, context);
    }
    ...
    public ExpressRouteCrossConnectionPeeringInner createOrUpdate(String resourceGroupName, String crossConnectionName,
        String peeringName, ExpressRouteCrossConnectionPeeringInner peeringParameters) {
        return beginCreateOrUpdate(resourceGroupName, crossConnectionName, peeringName, peeringParameters)
            .getFinalResult();
    }
    ...
    public ExpressRouteCrossConnectionPeeringInner createOrUpdate(String resourceGroupName, String crossConnectionName,
        String peeringName, ExpressRouteCrossConnectionPeeringInner peeringParameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, crossConnectionName, peeringName, peeringParameters, context)
            .getFinalResult();
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListPeering API service call retrieves all peerings that belong to an
     * ExpressRouteCrossConnection along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionPeeringInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionPeeringList> res
