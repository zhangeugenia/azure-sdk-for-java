...
public final class LoadBalancerLoadBalancingRulesImpl implements LoadBalancerLoadBalancingRules {
    ...
    public LoadBalancerHealthPerRule health(String groupName, String loadBalancerName, String loadBalancingRuleName) {
        LoadBalancerHealthPerRuleInner inner
            = this.serviceClient().health(groupName, loadBalancerName, loadBalancingRuleName);
        if (inner != null) {
            return new LoadBalancerHealthPerRuleImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public LoadBalancerHealthPerRule health(String groupName, String loadBalancerName, String loadBalancingRuleName,
        Context context) {
        LoadBalancerHealthPerRuleInner inner
            = this.serviceClient().health(groupName, loadBalancerName, loadBalancingRuleName, context);
        if (inner != null) {
            return new LoadBalancerHealthPerRuleImpl(inner, this.manager());
        } else {
            return null;
