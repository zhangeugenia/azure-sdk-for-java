...
public final class ApplicationGatewayWafDynamicManifestsClientImpl
    ...
    public interface ApplicationGatewayWafDynamicManifestsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayWafDynamicManifestResultList> getSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayWafDynamicManifestResultList> getNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the regional application gateway waf manifest along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ApplicationGatewayWafDynamicManifestResultInner> getSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ApplicationGatewayWafDynamicManifestResultList> res = service.getSync(this.client.getEndpoint(),
            location, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    ...
    private PagedResponse<ApplicationGatewayWafDynamicManifestResultInner> getSinglePage(String location,
        ...
        final String accept = "application/json";
        Response<ApplicationGatewayWafDynamicManifestResultList> res = service.getSync(this.client.getEndpoint(),
            location, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ApplicationGatewayWafDynamicManifests API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ApplicationGatewayWafDynamicManifestResultInner> getNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ApplicationGatewayWafDynamicManifestResultList> res
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ApplicationGatewayWafDynamicManifestsClientImpl.class);
}
