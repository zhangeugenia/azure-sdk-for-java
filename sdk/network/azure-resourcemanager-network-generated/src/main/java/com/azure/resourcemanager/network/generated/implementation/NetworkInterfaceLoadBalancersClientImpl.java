...
public final class NetworkInterfaceLoadBalancersClientImpl implements NetworkInterfaceLoadBalancersClient {
    ...
    public interface NetworkInterfaceLoadBalancersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkInterfaceLoadBalancerListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkInterfaceLoadBalancerListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancerInner> listSinglePage(String resourceGroupName, String networkInterfaceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<NetworkInterfaceLoadBalancerListResult> res = service.listSync(this.client.getEndpoint(),
    ...
    private PagedResponse<LoadBalancerInner> listNextSinglePage(String nextLink) {
        ...
        final String accept = "application/json";
        Response<NetworkInterfaceLoadBalancerListResult> res
