...
public final class VirtualNetworkImpl implements VirtualNetwork, VirtualNetwork.Definition, VirtualNetwork.Update {
    ...
    public PrivateEndpointVNetPolicies privateEndpointVNetPolicies() {
        return this.innerModel().privateEndpointVNetPolicies();
    }

    public SubResource defaultPublicNatGateway() {
        return this.innerModel().defaultPublicNatGateway();
    }
    ...
    public VirtualNetworkImpl withPrivateEndpointVNetPolicies(PrivateEndpointVNetPolicies privateEndpointVNetPolicies) {
        this.innerModel().withPrivateEndpointVNetPolicies(privateEndpointVNetPolicies);
        return this;
    }
