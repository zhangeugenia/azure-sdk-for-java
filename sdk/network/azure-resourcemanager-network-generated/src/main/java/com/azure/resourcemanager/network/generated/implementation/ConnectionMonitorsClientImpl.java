...
public final class ConnectionMonitorsClientImpl implements ConnectionMonitorsClient {
    ...
    public interface ConnectionMonitorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionMonitorResultInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName,
            @PathParam("connectionMonitorName") String connectionMonitorName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionMonitorResultInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName,
            @PathParam("connectionMonitorName") String connectionMonitorName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionMonitorListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        if (connectionMonitorName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter connectionMonitorName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName,
            connectionMonitorName, apiVersion, this.client.getSubscriptionId(), migrate, parameters, accept,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectionMonitorResultInner>, ConnectionMonitorResultInner> beginCreateOrUpdate(
        String resourceGroupName, String networkWatcherName, String connectionMonitorName, ConnectionMonitor parameters,
        String migrate) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, networkWatcherName,
            connectionMonitorName, parameters, migrate);
        return this.client.<ConnectionMonitorResultInner, ConnectionMonitorResultInner>getLroResult(response,
            ConnectionMonitorResultInner.class, ConnectionMonitorResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectionMonitorResultInner>, ConnectionMonitorResultInner> beginCreateOrUpdate(
        ...
        return this.client.<ConnectionMonitorResultInner, ConnectionMonitorResultInner>getLroResult(response,
            ConnectionMonitorResultInner.class, ConnectionMonitorResultInner.class, context);
    }
    ...
    public ConnectionMonitorResultInner createOrUpdate(String resourceGroupName, String networkWatcherName,
        String connectionMonitorName, ConnectionMonitor parameters) {
        final String migrate = null;
        return beginCreateOrUpdate(resourceGroupName, networkWatcherName, connectionMonitorName, parameters, migrate)
            .getFinalResult();
    }
    ...
    public Response<ConnectionMonitorResultInner> getWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, connectionMonitorName,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName,
            connectionMonitorName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkWatcherName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, networkWatcherName, connectionMonitorName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkWatcherName,
        String connectionMonitorName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, networkWatcherName, connectionMonitorName, context);
    ...
    public void delete(String resourceGroupName, String networkWatcherName, String connectionMonitorName) {
        beginDelete(resourceGroupName, networkWatcherName, connectionMonitorName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String networkWatcherName, String connectionMonitorName,
        Context context) {
        beginDelete(resourceGroupName, networkWatcherName, connectionMonitorName, context).getFinalResult();
    }
    ...
    public Response<ConnectionMonitorResultInner> updateTagsWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName,
            connectionMonitorName, apiVersion, this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    private Response<BinaryData> stopWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.stopSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, connectionMonitorName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginStop(String resourceGroupName, String networkWatcherName,
        String connectionMonitorName) {
        Response<BinaryData> response = stopWithResponse(resourceGroupName, networkWatcherName, connectionMonitorName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginStop(String resourceGroupName, String networkWatcherName,
        String connectionMonitorName, Context context) {
        Response<BinaryData> response
            = stopWithResponse(resourceGroupName, networkWatcherName, connectionMonitorName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void stop(String resourceGroupName, String networkWatcherName, String connectionMonitorName) {
        beginStop(resourceGroupName, networkWatcherName, connectionMonitorName).getFinalResult();
    }
    ...
    public void stop(String resourceGroupName, String networkWatcherName, String connectionMonitorName,
        Context context) {
        beginStop(resourceGroupName, networkWatcherName, connectionMonitorName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of connection monitors along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectionMonitorResultInner> listSinglePage(String resourceGroupName,
        String networkWatcherName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ConnectionMonitorListResult> res = service.listSync(this.client.getEndpoint(), resourceGroupName,
