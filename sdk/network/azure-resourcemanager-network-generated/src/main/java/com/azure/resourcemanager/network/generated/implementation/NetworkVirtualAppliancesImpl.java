...
public final class NetworkVirtualAppliancesImpl implements NetworkVirtualAppliances {
    ...
    public NetworkVirtualApplianceInstanceIds reimage(String resourceGroupName, String networkVirtualApplianceName) {
        NetworkVirtualApplianceInstanceIdsInner inner
            = this.serviceClient().reimage(resourceGroupName, networkVirtualApplianceName);
        if (inner != null) {
            return new NetworkVirtualApplianceInstanceIdsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public NetworkVirtualApplianceInstanceIds reimage(String resourceGroupName, String networkVirtualApplianceName,
        NetworkVirtualApplianceInstanceIdsInner networkVirtualApplianceInstanceIds, Context context) {
        NetworkVirtualApplianceInstanceIdsInner inner = this.serviceClient()
            .reimage(resourceGroupName, networkVirtualApplianceName, networkVirtualApplianceInstanceIds, context);
        if (inner != null) {
            return new NetworkVirtualApplianceInstanceIdsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public NetworkVirtualApplianceInstanceId getBootDiagnosticLogs(String resourceGroupName,
        String networkVirtualApplianceName, NetworkVirtualApplianceBootDiagnosticParameters request) {
        NetworkVirtualApplianceInstanceIdInner inner
            = this.serviceClient().getBootDiagnosticLogs(resourceGroupName, networkVirtualApplianceName, request);
        if (inner != null) {
            return new NetworkVirtualApplianceInstanceIdImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public NetworkVirtualApplianceInstanceId getBootDiagnosticLogs(String resourceGroupName,
        ...
        NetworkVirtualApplianceInstanceIdInner inner = this.serviceClient()
            .getBootDiagnosticLogs(resourceGroupName, networkVirtualApplianceName, request, context);
        if (inner != null) {
            return new NetworkVirtualApplianceInstanceIdImpl(inner, this.manager());
        } else {
            return null;
