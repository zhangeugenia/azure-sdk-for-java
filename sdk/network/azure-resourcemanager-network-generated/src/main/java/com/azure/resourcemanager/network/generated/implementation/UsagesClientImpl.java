...
public final class UsagesClientImpl implements UsagesClient {
    ...
    public interface UsagesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<UsagesListResult> listSync(@HostParam("$host") String endpoint, @PathParam("location") String location,
    ...
    private PagedResponse<UsageInner> listSinglePage(String location) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<UsagesListResult> res = service.listSync(this.client.getEndpoint(), location, apiVersion,
