...
public final class FlowLogImpl implements FlowLog, FlowLog.Definition, FlowLog.Update {
    ...
    public String enabledFilteringCriteria() {
        return this.innerModel().enabledFilteringCriteria();
    }
    ...
    public FlowLogImpl withEnabledFilteringCriteria(String enabledFilteringCriteria) {
        this.innerModel().withEnabledFilteringCriteria(enabledFilteringCriteria);
        return this;
    }
