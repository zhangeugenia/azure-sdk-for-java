...
public final class NspAssociationsImpl implements NspAssociations {
    private static final ClientLogger LOGGER = new ClientLogger(NspAssociationsImpl.class);

    private final NspAssociationsClient innerClient;

    private final com.azure.resourcemanager.network.generated.NetworkManager serviceManager;

    public NspAssociationsImpl(NspAssociationsClient innerClient,
    ...
    private NspAssociationsClient serviceClient() {
