...
public final class NetworkVirtualApplianceImpl
    ...
    public NetworkVirtualApplianceInstanceIds reimage() {
        return serviceManager.networkVirtualAppliances().reimage(resourceGroupName, networkVirtualApplianceName);
    }

    public NetworkVirtualApplianceInstanceIds
        reimage(NetworkVirtualApplianceInstanceIdsInner networkVirtualApplianceInstanceIds, Context context) {
        return serviceManager.networkVirtualAppliances()
    ...
    public NetworkVirtualApplianceInstanceId
        getBootDiagnosticLogs(NetworkVirtualApplianceBootDiagnosticParameters request) {
        return serviceManager.networkVirtualAppliances()
            .getBootDiagnosticLogs(resourceGroupName, networkVirtualApplianceName, request);
    }

    public NetworkVirtualApplianceInstanceId
        getBootDiagnosticLogs(NetworkVirtualApplianceBootDiagnosticParameters request, Context context) {
        return serviceManager.networkVirtualAppliances()
