...
public final class PublicIpAddressesClientImpl implements PublicIpAddressesClient {
    ...
    public interface PublicIpAddressesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listCloudServicePublicIpAddressesSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listCloudServiceRoleInstancePublicIpAddressesSync(
            @HostParam("$host") String endpoint, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressInner> getCloudServicePublicIpAddressSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publicIpAddressName") String publicIpAddressName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("$expand") String expand,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publicIpAddressName") String publicIpAddressName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") TagsObject parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> ddosProtectionStatusSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publicIpAddressName") String publicIpAddressName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listVirtualMachineScaleSetPublicIpAddressesSync(
            @HostParam("$host") String endpoint, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualMachineScaleSetName") String virtualMachineScaleSetName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listVirtualMachineScaleSetVMPublicIpAddressesSync(
            @HostParam("$host") String endpoint, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualMachineScaleSetName") String virtualMachineScaleSetName,
            @PathParam("virtualmachineIndex") String virtualmachineIndex,
            @PathParam("networkInterfaceName") String networkInterfaceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressInner> getVirtualMachineScaleSetPublicIpAddressSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualMachineScaleSetName") String virtualMachineScaleSetName,
            @PathParam("virtualmachineIndex") String virtualmachineIndex,
            @PathParam("networkInterfaceName") String networkInterfaceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listCloudServicePublicIpAddressesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listCloudServiceRoleInstancePublicIpAddressesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listAllNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listVirtualMachineScaleSetPublicIpAddressesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PublicIpAddressListResult> listVirtualMachineScaleSetVMPublicIpAddressesNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about all public IP addresses on a cloud service level along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listCloudServicePublicIpAddressesSinglePage(String resourceGroupName,
        String cloudServiceName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res
            = service.listCloudServicePublicIpAddressesSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public PagedIterable<PublicIpAddressInner> listCloudServicePublicIpAddresses(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listCloudServicePublicIpAddressesSinglePage(resourceGroupName, cloudServiceName),
            nextLink -> listCloudServicePublicIpAddressesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<PublicIpAddressInner> listCloudServicePublicIpAddresses(String resourceGroupName,
        String cloudServiceName, Context context) {
        return new PagedIterable<>(
            () -> listCloudServicePublicIpAddressesSinglePage(resourceGroupName, cloudServiceName, context),
            nextLink -> listCloudServicePublicIpAddressesNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listCloudServiceRoleInstancePublicIpAddressesSinglePage(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName,
        String ipConfigurationName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listCloudServiceRoleInstancePublicIpAddressesSync(
            this.client.getEndpoint(), resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName,
            ipConfigurationName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<PublicIpAddressInner> listCloudServiceRoleInstancePublicIpAddresses(String resourceGroupName,
        String cloudServiceName, String roleInstanceName, String networkInterfaceName, String ipConfigurationName) {
        return new PagedIterable<>(
            () -> listCloudServiceRoleInstancePublicIpAddressesSinglePage(resourceGroupName, cloudServiceName,
                roleInstanceName, networkInterfaceName, ipConfigurationName),
            nextLink -> listCloudServiceRoleInstancePublicIpAddressesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<PublicIpAddressInner> listCloudServiceRoleInstancePublicIpAddresses(String resourceGroupName,
        ...
        return new PagedIterable<>(
            ...
            nextLink -> listCloudServiceRoleInstancePublicIpAddressesNextSinglePage(nextLink, context));
    }
    ...
    public Response<PublicIpAddressInner> getCloudServicePublicIpAddressWithResponse(String resourceGroupName,
        ...
        if (publicIpAddressName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter publicIpAddressName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getCloudServicePublicIpAddressSync(this.client.getEndpoint(), resourceGroupName,
            cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName, publicIpAddressName,
            apiVersion, this.client.getSubscriptionId(), expand, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String publicIpAddressName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, publicIpAddressName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String publicIpAddressName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, publicIpAddressName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String publicIpAddressName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, publicIpAddressName, context);
    ...
    public void delete(String resourceGroupName, String publicIpAddressName) {
        beginDelete(resourceGroupName, publicIpAddressName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String publicIpAddressName, Context context) {
        beginDelete(resourceGroupName, publicIpAddressName, context).getFinalResult();
    }
    ...
    public Response<PublicIpAddressInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, publicIpAddressName,
            apiVersion, this.client.getSubscriptionId(), expand, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String publicIpAddressName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, publicIpAddressName, apiVersion,
    ...
    public SyncPoller<PollResult<PublicIpAddressInner>, PublicIpAddressInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, publicIpAddressName, parameters);
        return this.client.<PublicIpAddressInner, PublicIpAddressInner>getLroResult(response,
            PublicIpAddressInner.class, PublicIpAddressInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PublicIpAddressInner>, PublicIpAddressInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, publicIpAddressName, parameters, context);
        return this.client.<PublicIpAddressInner, PublicIpAddressInner>getLroResult(response,
    ...
    public PublicIpAddressInner createOrUpdate(String resourceGroupName, String publicIpAddressName,
        PublicIpAddressInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, publicIpAddressName, parameters).getFinalResult();
    }
    ...
    public PublicIpAddressInner createOrUpdate(String resourceGroupName, String publicIpAddressName,
        PublicIpAddressInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, publicIpAddressName, parameters, context).getFinalResult();
    }
    ...
    public Response<PublicIpAddressInner> updateTagsWithResponse(String resourceGroupName, String publicIpAddressName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, publicIpAddressName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the public IP addresses in a subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all public IP addresses in a resource group along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Ddos Protection Status of a Public IP Address along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> ddosProtectionStatusWithResponse(String resourceGroupName,
        String publicIpAddressName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.ddosProtectionStatusSync(this.client.getEndpoint(), resourceGroupName, publicIpAddressName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> ddosProtectionStatusWithResponse(String resourceGroupName, String publicIpAddressName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<PublicIpDdosProtectionStatusResultInner>, PublicIpDdosProtectionStatusResultInner>
        ...
        Response<BinaryData> response = ddosProtectionStatusWithResponse(resourceGroupName, publicIpAddressName);
        return this.client
            .<PublicIpDdosProtectionStatusResultInner, PublicIpDdosProtectionStatusResultInner>getLroResult(response,
                PublicIpDdosProtectionStatusResultInner.class, PublicIpDdosProtectionStatusResultInner.class,
                Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PublicIpDdosProtectionStatusResultInner>, PublicIpDdosProtectionStatusResultInner>
        ...
        Response<BinaryData> response
            = ddosProtectionStatusWithResponse(resourceGroupName, publicIpAddressName, context);
        return this.client
            .<PublicIpDdosProtectionStatusResultInner, PublicIpDdosProtectionStatusResultInner>getLroResult(response,
                PublicIpDdosProtectionStatusResultInner.class, PublicIpDdosProtectionStatusResultInner.class, context);
    }
    ...
    public PublicIpDdosProtectionStatusResultInner ddosProtectionStatus(String resourceGroupName,
        String publicIpAddressName) {
        return beginDdosProtectionStatus(resourceGroupName, publicIpAddressName).getFinalResult();
    }
    ...
    public PublicIpDdosProtectionStatusResultInner ddosProtectionStatus(String resourceGroupName,
        ...
        return beginDdosProtectionStatus(resourceGroupName, publicIpAddressName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listVirtualMachineScaleSetPublicIpAddressesSinglePage(
        String resourceGroupName, String virtualMachineScaleSetName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res
            = service.listVirtualMachineScaleSetPublicIpAddressesSync(this.client.getEndpoint(), resourceGroupName,
    ...
    public PagedIterable<PublicIpAddressInner> listVirtualMachineScaleSetPublicIpAddresses(String resourceGroupName,
        String virtualMachineScaleSetName) {
        return new PagedIterable<>(
            () -> listVirtualMachineScaleSetPublicIpAddressesSinglePage(resourceGroupName, virtualMachineScaleSetName),
            nextLink -> listVirtualMachineScaleSetPublicIpAddressesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<PublicIpAddressInner> listVirtualMachineScaleSetPublicIpAddresses(String resourceGroupName,
        ...
        return new PagedIterable<>(() -> listVirtualMachineScaleSetPublicIpAddressesSinglePage(resourceGroupName,
            virtualMachineScaleSetName, context),
            nextLink -> listVirtualMachineScaleSetPublicIpAddressesNextSinglePage(nextLink, context));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about all public IP addresses in a virtual machine IP configuration in a virtual machine
     * scale set along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listVirtualMachineScaleSetVMPublicIpAddressesSinglePage(
        String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex,
        String networkInterfaceName, String ipConfigurationName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res
            = service.listVirtualMachineScaleSetVMPublicIpAddressesSync(this.client.getEndpoint(), resourceGroupName,
    ...
    private PagedResponse<PublicIpAddressInner> listVirtualMachineScaleSetVMPublicIpAddressesSinglePage(
        ...
        final String apiVersion = "2018-10-01";
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listVirtualMachineScaleSetVMPublicIpAddressesSync(
            this.client.getEndpoint(), resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex,
            networkInterfaceName, ipConfigurationName, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<PublicIpAddressInner> listVirtualMachineScaleSetVMPublicIpAddresses(String resourceGroupName,
        ...
        String ipConfigurationName) {
        return new PagedIterable<>(
            () -> listVirtualMachineScaleSetVMPublicIpAddressesSinglePage(resourceGroupName, virtualMachineScaleSetName,
                virtualmachineIndex, networkInterfaceName, ipConfigurationName),
            nextLink -> listVirtualMachineScaleSetVMPublicIpAddressesNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<PublicIpAddressInner> listVirtualMachineScaleSetVMPublicIpAddresses(String resourceGroupName,
        ...
        return new PagedIterable<>(
            ...
            nextLink -> listVirtualMachineScaleSetVMPublicIpAddressesNextSinglePage(nextLink, context));
    }
    ...
    public Response<PublicIpAddressInner> getVirtualMachineScaleSetPublicIpAddressWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2018-10-01";
        final String accept = "application/json";
        return service.getVirtualMachineScaleSetPublicIpAddressSync(this.client.getEndpoint(), resourceGroupName,
            virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, ipConfigurationName,
            publicIpAddressName, apiVersion, this.client.getSubscriptionId(), expand, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListPublicIpAddresses API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listCloudServicePublicIpAddressesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listCloudServicePublicIpAddressesNextSync(nextLink,
    ...
    private PagedResponse<PublicIpAddressInner> listCloudServicePublicIpAddressesNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res
            = service.listCloudServicePublicIpAddressesNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listCloudServiceRoleInstancePublicIpAddressesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listCloudServiceRoleInstancePublicIpAddressesNextSync(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listCloudServiceRoleInstancePublicIpAddressesNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listAllNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listAllNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listVirtualMachineScaleSetPublicIpAddressesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listVirtualMachineScaleSetPublicIpAddressesNextSync(nextLink,
            this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listVirtualMachineScaleSetPublicIpAddressesNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listVirtualMachineScaleSetVMPublicIpAddressesNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<PublicIpAddressListResult> res = service.listVirtualMachineScaleSetVMPublicIpAddressesNextSync(
            nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpAddressInner>
        listVirtualMachineScaleSetVMPublicIpAddressesNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
