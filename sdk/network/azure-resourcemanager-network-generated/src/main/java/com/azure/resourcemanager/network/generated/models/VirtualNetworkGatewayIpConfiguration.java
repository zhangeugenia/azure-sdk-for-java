...
public final class VirtualNetworkGatewayIpConfiguration extends SubResource {
    ...
    /**
     * Reads an instance of VirtualNetworkGatewayIpConfiguration from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of VirtualNetworkGatewayIpConfiguration if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the VirtualNetworkGatewayIpConfiguration.
     */
    public static VirtualNetworkGatewayIpConfiguration fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            VirtualNetworkGatewayIpConfiguration deserializedVirtualNetworkGatewayIpConfiguration
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVirtualNetworkGatewayIpConfiguration.withId(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedVirtualNetworkGatewayIpConfiguration.innerProperties
                        = VirtualNetworkGatewayIpConfigurationPropertiesFormat.fromJson(reader);
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualNetworkGatewayIpConfiguration.name = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedVirtualNetworkGatewayIpConfiguration.etag = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedVirtualNetworkGatewayIpConfiguration;
        });
    }
}
