...
public final class ExpressRouteCircuitPeeringsClientImpl implements ExpressRouteCircuitPeeringsClient {
    ...
    public interface ExpressRouteCircuitPeeringsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCircuitPeeringInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName,
            @PathParam("peeringName") String peeringName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCircuitPeeringListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCircuitPeeringListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String circuitName, String peeringName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, circuitName, peeringName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String circuitName,
        String peeringName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, circuitName, peeringName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String circuitName,
        ...
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, circuitName, peeringName, context);
    ...
    public void delete(String resourceGroupName, String circuitName, String peeringName) {
        beginDelete(resourceGroupName, circuitName, peeringName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String circuitName, String peeringName, Context context) {
        beginDelete(resourceGroupName, circuitName, peeringName, context).getFinalResult();
    }
    ...
    public Response<ExpressRouteCircuitPeeringInner> getWithResponse(String resourceGroupName, String circuitName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, circuitName, peeringName, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return peering in an ExpressRouteCircuit resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String circuitName,
        ...
        if (peeringParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter peeringParameters is required and cannot be null."));
        } else {
            peeringParameters.validate();
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, circuitName, peeringName,
            apiVersion, this.client.getSubscriptionId(), peeringParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCircuitPeeringInner>, ExpressRouteCircuitPeeringInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, circuitName, peeringName, peeringParameters);
        return this.client.<ExpressRouteCircuitPeeringInner, ExpressRouteCircuitPeeringInner>getLroResult(response,
            ExpressRouteCircuitPeeringInner.class, ExpressRouteCircuitPeeringInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCircuitPeeringInner>, ExpressRouteCircuitPeeringInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, circuitName, peeringName, peeringParameters, context);
        return this.client.<ExpressRouteCircuitPeeringInner, ExpressRouteCircuitPeeringInner>getLroResult(response,
            ExpressRouteCircuitPeeringInner.class, ExpressRouteCircuitPeeringInner.class, context);
    }
    ...
    public ExpressRouteCircuitPeeringInner createOrUpdate(String resourceGroupName, String circuitName,
        String peeringName, ExpressRouteCircuitPeeringInner peeringParameters) {
        return beginCreateOrUpdate(resourceGroupName, circuitName, peeringName, peeringParameters).getFinalResult();
    }
    ...
    public ExpressRouteCircuitPeeringInner createOrUpdate(String resourceGroupName, String circuitName,
        String peeringName, ExpressRouteCircuitPeeringInner peeringParameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, circuitName, peeringName, peeringParameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all peerings in a specified express route circuit along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitPeeringInner> listSinglePage(String resourceGroupName,
        String circuitName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ExpressRouteCircuitPeeringListResult> res = service.listSync(this.client.getEndpoint(),
            resourceGroupName, circuitName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitPeeringInner> listSinglePage(String resourceGroupName, String circuitName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String accept = "application/json";
        Response<ExpressRouteCircuitPeeringListResult> res = service.listSync(this.client.getEndpoint(),
            resourceGroupName, circuitName, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<ExpressRouteCircuitPeeringInner> list(String resourceGroupName, String circuitName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, circuitName),
    ...
    public PagedIterable<ExpressRouteCircuitPeeringInner> list(String resourceGroupName, String circuitName,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, circuitName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitPeeringInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ExpressRouteCircuitPeeringListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitPeeringInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
