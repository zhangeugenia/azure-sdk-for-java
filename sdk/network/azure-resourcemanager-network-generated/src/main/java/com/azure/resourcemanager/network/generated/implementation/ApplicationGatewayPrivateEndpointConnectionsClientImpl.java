...
public final class ApplicationGatewayPrivateEndpointConnectionsClientImpl
    ...
    public interface ApplicationGatewayPrivateEndpointConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayPrivateEndpointConnectionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @PathParam("connectionName") String connectionName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayPrivateEndpointConnectionListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayPrivateEndpointConnectionListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String applicationGatewayName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, applicationGatewayName, connectionName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String applicationGatewayName,
        String connectionName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, applicationGatewayName, connectionName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String applicationGatewayName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, applicationGatewayName, connectionName, context);
    ...
    public void delete(String resourceGroupName, String applicationGatewayName, String connectionName) {
        beginDelete(resourceGroupName, applicationGatewayName, connectionName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String applicationGatewayName, String connectionName,
        Context context) {
        beginDelete(resourceGroupName, applicationGatewayName, connectionName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return private Endpoint connection on an application gateway along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateWithResponse(String resourceGroupName, String applicationGatewayName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), resourceGroupName, applicationGatewayName, connectionName,
    ...
    public
        ...
        beginUpdate(String resourceGroupName, String applicationGatewayName, String connectionName,
            ApplicationGatewayPrivateEndpointConnectionInner parameters) {
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, applicationGatewayName, connectionName, parameters);
        return this.client
            .<ApplicationGatewayPrivateEndpointConnectionInner, ApplicationGatewayPrivateEndpointConnectionInner>getLroResult(
                response, ApplicationGatewayPrivateEndpointConnectionInner.class,
                ApplicationGatewayPrivateEndpointConnectionInner.class, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response
            = updateWithResponse(resourceGroupName, applicationGatewayName, connectionName, parameters, context);
        return this.client
            .<ApplicationGatewayPrivateEndpointConnectionInner, ApplicationGatewayPrivateEndpointConnectionInner>getLroResult(
                response, ApplicationGatewayPrivateEndpointConnectionInner.class,
    ...
    public ApplicationGatewayPrivateEndpointConnectionInner update(String resourceGroupName,
        String applicationGatewayName, String connectionName,
        ApplicationGatewayPrivateEndpointConnectionInner parameters) {
        return beginUpdate(resourceGroupName, applicationGatewayName, connectionName, parameters).getFinalResult();
    }
    ...
    public ApplicationGatewayPrivateEndpointConnectionInner update(String resourceGroupName,
        String applicationGatewayName, String connectionName,
        ApplicationGatewayPrivateEndpointConnectionInner parameters, Context context) {
        return beginUpdate(resourceGroupName, applicationGatewayName, connectionName, parameters, context)
            .getFinalResult();
    }
    ...
    public Response<ApplicationGatewayPrivateEndpointConnectionInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, applicationGatewayName, connectionName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ApplicationGatewayPrivateEndpointConnectionInner> listSinglePage(String resourceGroupName,
        String applicationGatewayName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ApplicationGatewayPrivateEndpointConnectionListResult> res
            = service.listSync(this.client.getEndpoint(), resourceGroupName, applicationGatewayName, apiVersion,
    ...
    public PagedIterable<ApplicationGatewayPrivateEndpointConnectionInner> list(String resourceGroupName,
        String applicationGatewayName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, applicationGatewayName),
    ...
    public PagedIterable<ApplicationGatewayPrivateEndpointConnectionInner> list(String resourceGroupName,
        String applicationGatewayName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, applicationGatewayName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ApplicationGatewayPrivateEndpointConnectionInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
