...
public final class FirewallPoliciesClientImpl implements FirewallPoliciesClient {
    ...
    public interface FirewallPoliciesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("$expand") String expand,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") TagsObject parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyListResult> listAllNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String firewallPolicyName) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, firewallPolicyName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String firewallPolicyName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, firewallPolicyName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String firewallPolicyName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, firewallPolicyName, context);
    ...
    public void delete(String resourceGroupName, String firewallPolicyName) {
        beginDelete(resourceGroupName, firewallPolicyName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String firewallPolicyName, Context context) {
        beginDelete(resourceGroupName, firewallPolicyName, context).getFinalResult();
    }
    ...
    public Response<FirewallPolicyInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, firewallPolicyName,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String firewallPolicyName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, firewallPolicyName, apiVersion,
    ...
    public SyncPoller<PollResult<FirewallPolicyInner>, FirewallPolicyInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, firewallPolicyName, parameters);
        return this.client.<FirewallPolicyInner, FirewallPolicyInner>getLroResult(response, FirewallPolicyInner.class,
            FirewallPolicyInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<FirewallPolicyInner>, FirewallPolicyInner> beginCreateOrUpdate(
        ...
        return this.client.<FirewallPolicyInner, FirewallPolicyInner>getLroResult(response, FirewallPolicyInner.class,
            FirewallPolicyInner.class, context);
    }
    ...
    public FirewallPolicyInner createOrUpdate(String resourceGroupName, String firewallPolicyName,
        FirewallPolicyInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, firewallPolicyName, parameters).getFinalResult();
    }
    ...
    public FirewallPolicyInner createOrUpdate(String resourceGroupName, String firewallPolicyName,
        FirewallPolicyInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, firewallPolicyName, parameters, context).getFinalResult();
    }
    ...
    public Response<FirewallPolicyInner> updateTagsWithResponse(String resourceGroupName, String firewallPolicyName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, firewallPolicyName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListFirewallPolicies API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<FirewallPolicyListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the Firewall Policies in a subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<FirewallPolicyListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<FirewallPolicyListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listAllNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<FirewallPolicyInner> listAllNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
