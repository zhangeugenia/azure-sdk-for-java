...
public final class AvailableResourceGroupDelegationsClientImpl implements AvailableResourceGroupDelegationsClient {
    ...
    public interface AvailableResourceGroupDelegationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailableDelegationsResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailableDelegationsResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailableDelegationInner> listSinglePage(String location, String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<AvailableDelegationsResult> res = service.listSync(this.client.getEndpoint(), location,
    ...
    public PagedIterable<AvailableDelegationInner> list(String location, String resourceGroupName) {
        return new PagedIterable<>(() -> listSinglePage(location, resourceGroupName),
    ...
    public PagedIterable<AvailableDelegationInner> list(String location, String resourceGroupName, Context context) {
        return new PagedIterable<>(() -> listSinglePage(location, resourceGroupName, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an array of available delegations along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailableDelegationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AvailableDelegationsResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailableDelegationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
