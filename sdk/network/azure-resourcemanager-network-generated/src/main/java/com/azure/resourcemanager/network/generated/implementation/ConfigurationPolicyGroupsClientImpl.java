...
public final class ConfigurationPolicyGroupsClientImpl implements ConfigurationPolicyGroupsClient {
    ...
    public interface ConfigurationPolicyGroupsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VpnServerConfigurationPolicyGroupInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vpnServerConfigurationName") String vpnServerConfigurationName,
            @PathParam("configurationPolicyGroupName") String configurationPolicyGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnServerConfigurationPolicyGroupsResult> listByVpnServerConfigurationSync(
            @HostParam("$host") String endpoint, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vpnServerConfigurationName") String vpnServerConfigurationName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnServerConfigurationPolicyGroupsResult> listByVpnServerConfigurationNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String vpnServerConfigurationName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            ...
            vpnServerConfigurationPolicyGroupParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VpnServerConfigurationPolicyGroupInner>, VpnServerConfigurationPolicyGroupInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, vpnServerConfigurationName,
            configurationPolicyGroupName, vpnServerConfigurationPolicyGroupParameters);
        return this.client.<VpnServerConfigurationPolicyGroupInner, VpnServerConfigurationPolicyGroupInner>getLroResult(
            response, VpnServerConfigurationPolicyGroupInner.class, VpnServerConfigurationPolicyGroupInner.class,
            Context.NONE);
    }
    ...
    public VpnServerConfigurationPolicyGroupInner createOrUpdate(String resourceGroupName,
        String vpnServerConfigurationName, String configurationPolicyGroupName,
        VpnServerConfigurationPolicyGroupInner vpnServerConfigurationPolicyGroupParameters) {
        return beginCreateOrUpdate(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName,
            vpnServerConfigurationPolicyGroupParameters).getFinalResult();
    }
    ...
    public VpnServerConfigurationPolicyGroupInner createOrUpdate(String resourceGroupName,
        ...
        VpnServerConfigurationPolicyGroupInner vpnServerConfigurationPolicyGroupParameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName,
            vpnServerConfigurationPolicyGroupParameters, context).getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String vpnServerConfigurationName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            vpnServerConfigurationName, configurationPolicyGroupName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vpnServerConfigurationName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vpnServerConfigurationName,
        String configurationPolicyGroupName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName, context);
    ...
    public void delete(String resourceGroupName, String vpnServerConfigurationName,
        String configurationPolicyGroupName) {
        beginDelete(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String vpnServerConfigurationName, String configurationPolicyGroupName,
        Context context) {
        beginDelete(resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list VpnServerConfigurationPolicyGroups along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnServerConfigurationPolicyGroupInner>
        listByVpnServerConfigurationSinglePage(String resourceGroupName, String vpnServerConfigurationName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListVpnServerConfigurationPolicyGroupsResult> res
            = service.listByVpnServerConfigurationSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, vpnServerConfigurationName, apiVersion, accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnServerConfigurationPolicyGroupInner> listByVpnServerConfigurationSinglePage(
    ...
    public PagedIterable<VpnServerConfigurationPolicyGroupInner> listByVpnServerConfiguration(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByVpnServerConfigurationSinglePage(resourceGroupName, vpnServerConfigurationName),
            nextLink -> listByVpnServerConfigurationNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<VpnServerConfigurationPolicyGroupInner> listByVpnServerConfiguration(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByVpnServerConfigurationSinglePage(resourceGroupName, vpnServerConfigurationName, context),
            nextLink -> listByVpnServerConfigurationNextSinglePage(nextLink, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnServerConfigurationPolicyGroupInner>
        listByVpnServerConfigurationNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListVpnServerConfigurationPolicyGroupsResult> res
            = service.listByVpnServerConfigurationNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnServerConfigurationPolicyGroupInner>
        listByVpnServerConfigurationNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ListVpnServerConfigurationPolicyGroupsResult> res
            = service.listByVpnServerConfigurationNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }

    private static final ClientLogger LOGGER = new ClientLogger(ConfigurationPolicyGroupsClientImpl.class);
}
