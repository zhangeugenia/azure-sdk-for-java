...
public final class P2SVpnGatewaysClientImpl implements P2SVpnGatewaysClient {
    ...
    public interface P2SVpnGatewaysService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<P2SVpnGatewayInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListP2SVpnGatewaysResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListP2SVpnGatewaysResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> getP2SVpnConnectionHealthSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> getP2SVpnConnectionHealthDetailedSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") P2SVpnConnectionHealthRequest request, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> disconnectP2SVpnConnectionsSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("p2sVpnGatewayName") String p2SVpnGatewayName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") P2SVpnConnectionRequest request, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListP2SVpnGatewaysResult> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListP2SVpnGatewaysResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String gatewayName,
        ...
        if (p2SVpnGatewayParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter p2SVpnGatewayParameters is required and cannot be null."));
        } else {
            p2SVpnGatewayParameters.validate();
        }
        final String apiVersion = "2024-07-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, apiVersion, p2SVpnGatewayParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, gatewayName, p2SVpnGatewayParameters);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, gatewayName, p2SVpnGatewayParameters, context);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, context);
    }
    ...
    public P2SVpnGatewayInner createOrUpdate(String resourceGroupName, String gatewayName,
        P2SVpnGatewayInner p2SVpnGatewayParameters) {
        return beginCreateOrUpdate(resourceGroupName, gatewayName, p2SVpnGatewayParameters).getFinalResult();
    }
    ...
    public P2SVpnGatewayInner createOrUpdate(String resourceGroupName, String gatewayName,
        P2SVpnGatewayInner p2SVpnGatewayParameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, gatewayName, p2SVpnGatewayParameters, context).getFinalResult();
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginUpdateTags(String resourceGroupName,
        ...
        Response<BinaryData> response = updateTagsWithResponse(resourceGroupName, gatewayName, p2SVpnGatewayParameters);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginUpdateTags(String resourceGroupName,
        ...
        Response<BinaryData> response
            = updateTagsWithResponse(resourceGroupName, gatewayName, p2SVpnGatewayParameters, context);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, context);
    }
    ...
    public P2SVpnGatewayInner updateTags(String resourceGroupName, String gatewayName,
        TagsObject p2SVpnGatewayParameters) {
        return beginUpdateTags(resourceGroupName, gatewayName, p2SVpnGatewayParameters).getFinalResult();
    }
    ...
    public P2SVpnGatewayInner updateTags(String resourceGroupName, String gatewayName,
        TagsObject p2SVpnGatewayParameters, Context context) {
        return beginUpdateTags(resourceGroupName, gatewayName, p2SVpnGatewayParameters, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list P2SVpnGateways along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListP2SVpnGatewaysResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listByResourceGroupSinglePage(String resourceGroupName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListP2SVpnGatewaysResult> res = service.listSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListP2SVpnGatewaysResult> res
    ...
    private Response<BinaryData> resetWithResponse(String resourceGroupName, String gatewayName) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.resetSync(this.client.getEndpoint(), resourceGroupName, gatewayName, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> resetWithResponse(String resourceGroupName, String gatewayName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginReset(String resourceGroupName,
        String gatewayName) {
        Response<BinaryData> response = resetWithResponse(resourceGroupName, gatewayName);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner> beginReset(String resourceGroupName,
        ...
        Response<BinaryData> response = resetWithResponse(resourceGroupName, gatewayName, context);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, context);
    }
    ...
    public P2SVpnGatewayInner reset(String resourceGroupName, String gatewayName) {
        return beginReset(resourceGroupName, gatewayName).getFinalResult();
    }
    ...
    public P2SVpnGatewayInner reset(String resourceGroupName, String gatewayName, Context context) {
        return beginReset(resourceGroupName, gatewayName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> generateVpnProfileWithResponse(String resourceGroupName, String gatewayName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.generateVpnProfileSync(this.client.getEndpoint(), resourceGroupName, gatewayName, apiVersion,
    ...
    public SyncPoller<PollResult<VpnProfileResponseInner>, VpnProfileResponseInner>
        ...
        Response<BinaryData> response = generateVpnProfileWithResponse(resourceGroupName, gatewayName, parameters);
    ...
    public SyncPoller<PollResult<VpnProfileResponseInner>, VpnProfileResponseInner> beginGenerateVpnProfile(
        ...
        Response<BinaryData> response
            = generateVpnProfileWithResponse(resourceGroupName, gatewayName, parameters, context);
        return this.client.<VpnProfileResponseInner, VpnProfileResponseInner>getLroResult(response,
    ...
    public VpnProfileResponseInner generateVpnProfile(String resourceGroupName, String gatewayName,
        P2SVpnProfileParameters parameters) {
        return beginGenerateVpnProfile(resourceGroupName, gatewayName, parameters).getFinalResult();
    }
    ...
    public VpnProfileResponseInner generateVpnProfile(String resourceGroupName, String gatewayName,
        P2SVpnProfileParameters parameters, Context context) {
        return beginGenerateVpnProfile(resourceGroupName, gatewayName, parameters, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> getP2SVpnConnectionHealthWithResponse(String resourceGroupName, String gatewayName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getP2SVpnConnectionHealthSync(this.client.getEndpoint(), resourceGroupName, gatewayName,
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner>
        ...
        Response<BinaryData> response = getP2SVpnConnectionHealthWithResponse(resourceGroupName, gatewayName);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnGatewayInner>, P2SVpnGatewayInner>
        ...
        Response<BinaryData> response = getP2SVpnConnectionHealthWithResponse(resourceGroupName, gatewayName, context);
        return this.client.<P2SVpnGatewayInner, P2SVpnGatewayInner>getLroResult(response, P2SVpnGatewayInner.class,
            P2SVpnGatewayInner.class, context);
    }
    ...
    public P2SVpnGatewayInner getP2SVpnConnectionHealth(String resourceGroupName, String gatewayName) {
        return beginGetP2SVpnConnectionHealth(resourceGroupName, gatewayName).getFinalResult();
    }
    ...
    public P2SVpnGatewayInner getP2SVpnConnectionHealth(String resourceGroupName, String gatewayName, Context context) {
        return beginGetP2SVpnConnectionHealth(resourceGroupName, gatewayName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> getP2SVpnConnectionHealthDetailedWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getP2SVpnConnectionHealthDetailedSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, gatewayName, apiVersion, request, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnConnectionHealthInner>, P2SVpnConnectionHealthInner>
        beginGetP2SVpnConnectionHealthDetailed(String resourceGroupName, String gatewayName,
            P2SVpnConnectionHealthRequest request) {
        Response<BinaryData> response
            = getP2SVpnConnectionHealthDetailedWithResponse(resourceGroupName, gatewayName, request);
        return this.client.<P2SVpnConnectionHealthInner, P2SVpnConnectionHealthInner>getLroResult(response,
            P2SVpnConnectionHealthInner.class, P2SVpnConnectionHealthInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<P2SVpnConnectionHealthInner>, P2SVpnConnectionHealthInner>
        ...
        Response<BinaryData> response
            = getP2SVpnConnectionHealthDetailedWithResponse(resourceGroupName, gatewayName, request, context);
        return this.client.<P2SVpnConnectionHealthInner, P2SVpnConnectionHealthInner>getLroResult(response,
            P2SVpnConnectionHealthInner.class, P2SVpnConnectionHealthInner.class, context);
    }
    ...
    public P2SVpnConnectionHealthInner getP2SVpnConnectionHealthDetailed(String resourceGroupName, String gatewayName,
        P2SVpnConnectionHealthRequest request) {
        return beginGetP2SVpnConnectionHealthDetailed(resourceGroupName, gatewayName, request).getFinalResult();
    }
    ...
    public P2SVpnConnectionHealthInner getP2SVpnConnectionHealthDetailed(String resourceGroupName, String gatewayName,
        P2SVpnConnectionHealthRequest request, Context context) {
        return beginGetP2SVpnConnectionHealthDetailed(resourceGroupName, gatewayName, request, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> disconnectP2SVpnConnectionsWithResponse(String resourceGroupName,
        String p2SVpnGatewayName, P2SVpnConnectionRequest request) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        if (p2SVpnGatewayName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter p2SVpnGatewayName is required and cannot be null."));
        }
        if (request == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter request is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.disconnectP2SVpnConnectionsSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, p2SVpnGatewayName, apiVersion, request, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDisconnectP2SVpnConnections(String resourceGroupName,
        String p2SVpnGatewayName, P2SVpnConnectionRequest request) {
        Response<BinaryData> response
            = disconnectP2SVpnConnectionsWithResponse(resourceGroupName, p2SVpnGatewayName, request);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDisconnectP2SVpnConnections(String resourceGroupName,
        String p2SVpnGatewayName, P2SVpnConnectionRequest request, Context context) {
        Response<BinaryData> response
            = disconnectP2SVpnConnectionsWithResponse(resourceGroupName, p2SVpnGatewayName, request, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void disconnectP2SVpnConnections(String resourceGroupName, String p2SVpnGatewayName,
        P2SVpnConnectionRequest request) {
        beginDisconnectP2SVpnConnections(resourceGroupName, p2SVpnGatewayName, request).getFinalResult();
    }
    ...
    public void disconnectP2SVpnConnections(String resourceGroupName, String p2SVpnGatewayName,
        ...
        beginDisconnectP2SVpnConnections(resourceGroupName, p2SVpnGatewayName, request, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listByResourceGroupNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<P2SVpnGatewayInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
