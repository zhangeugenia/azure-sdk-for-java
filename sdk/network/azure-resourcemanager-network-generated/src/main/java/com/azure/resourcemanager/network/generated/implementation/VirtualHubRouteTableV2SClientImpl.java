...
public final class VirtualHubRouteTableV2SClientImpl implements VirtualHubRouteTableV2SClient {
    ...
    public interface VirtualHubRouteTableV2SService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ErrorException.class)
        Response<VirtualHubRouteTableV2Inner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @PathParam("routeTableName") String routeTableName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVirtualHubRouteTableV2SResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVirtualHubRouteTableV2SResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routeTableName, apiVersion, virtualHubRouteTableV2Parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualHubRouteTableV2Inner>, VirtualHubRouteTableV2Inner> beginCreateOrUpdate(
        ...
        return this.client.<VirtualHubRouteTableV2Inner, VirtualHubRouteTableV2Inner>getLroResult(response,
            VirtualHubRouteTableV2Inner.class, VirtualHubRouteTableV2Inner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualHubRouteTableV2Inner>, VirtualHubRouteTableV2Inner> beginCreateOrUpdate(
        ...
        return this.client.<VirtualHubRouteTableV2Inner, VirtualHubRouteTableV2Inner>getLroResult(response,
            VirtualHubRouteTableV2Inner.class, VirtualHubRouteTableV2Inner.class, context);
    }
    ...
    public VirtualHubRouteTableV2Inner createOrUpdate(String resourceGroupName, String virtualHubName,
        String routeTableName, VirtualHubRouteTableV2Inner virtualHubRouteTableV2Parameters) {
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routeTableName, virtualHubRouteTableV2Parameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualHubRouteTableV2Inner> listSinglePage(String resourceGroupName, String virtualHubName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListVirtualHubRouteTableV2SResult> res = service.listSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualHubRouteTableV2Inner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListVirtualHubRouteTableV2SResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualHubRouteTableV2Inner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
