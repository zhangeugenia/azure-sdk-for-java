...
public final class ExpressRoutePortAuthorizationImpl implements ExpressRoutePortAuthorization,
    ...
    public Response<ExpressRoutePortAuthorization> getWithResponse(Context context) {
        return serviceManager.expressRoutePortAuthorizations()
            .getWithResponse(resourceGroupName, expressRoutePortName, authorizationName, context);
    }

    public ExpressRoutePortAuthorization get() {
        return serviceManager.expressRoutePortAuthorizations()
            .get(resourceGroupName, expressRoutePortName, authorizationName);
    }

    public ExpressRoutePortAuthorization createOrUpdate(ExpressRoutePortAuthorizationInner authorizationParameters) {
        return serviceManager.expressRoutePortAuthorizations()
            .createOrUpdate(resourceGroupName, expressRoutePortName, authorizationName, authorizationParameters);
    }
