...
public final class NetworkManagementClientImpl implements NetworkManagementClient {
    ...
    /**
     * The NspLoggingConfigurationsOperationsClient object to access its operations.
     */
    private final NspLoggingConfigurationsOperationsClient nspLoggingConfigurationsOperations;

    /**
     * Gets the NspLoggingConfigurationsOperationsClient object to access its operations.
     * 
     * @return the NspLoggingConfigurationsOperationsClient object.
     */
    public NspLoggingConfigurationsOperationsClient getNspLoggingConfigurationsOperations() {
        return this.nspLoggingConfigurationsOperations;
    }

    /**
     * The NspOperationStatusClient object to access its operations.
     */
    private final NspOperationStatusClient nspOperationStatus;

    /**
     * Gets the NspOperationStatusClient object to access its operations.
     * 
     * @return the NspOperationStatusClient object.
     */
    public NspOperationStatusClient getNspOperationStatus() {
        return this.nspOperationStatus;
    }
    ...
    NetworkManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.nspLoggingConfigurationsOperations = new NspLoggingConfigurationsOperationsClientImpl(this);
        this.nspOperationStatus = new NspOperationStatusClientImpl(this);
