...
public final class NatRulesClientImpl implements NatRulesClient {
    ...
    public interface NatRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VpnGatewayNatRuleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("natRuleName") String natRuleName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnGatewayNatRulesResult> listByVpnGatewaySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnGatewayNatRulesResult> listByVpnGatewayNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String gatewayName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, natRuleName, apiVersion, natRuleParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VpnGatewayNatRuleInner>, VpnGatewayNatRuleInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, gatewayName, natRuleName, natRuleParameters);
        return this.client.<VpnGatewayNatRuleInner, VpnGatewayNatRuleInner>getLroResult(response,
            VpnGatewayNatRuleInner.class, VpnGatewayNatRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VpnGatewayNatRuleInner>, VpnGatewayNatRuleInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, gatewayName, natRuleName, natRuleParameters, context);
        return this.client.<VpnGatewayNatRuleInner, VpnGatewayNatRuleInner>getLroResult(response,
            VpnGatewayNatRuleInner.class, VpnGatewayNatRuleInner.class, context);
    }
    ...
    public VpnGatewayNatRuleInner createOrUpdate(String resourceGroupName, String gatewayName, String natRuleName,
        ...
        return beginCreateOrUpdate(resourceGroupName, gatewayName, natRuleName, natRuleParameters).getFinalResult();
    }
    ...
    public VpnGatewayNatRuleInner createOrUpdate(String resourceGroupName, String gatewayName, String natRuleName,
        ...
        return beginCreateOrUpdate(resourceGroupName, gatewayName, natRuleName, natRuleParameters, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String gatewayName, String natRuleName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, natRuleName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String gatewayName,
        String natRuleName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, gatewayName, natRuleName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String gatewayName,
        String natRuleName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, gatewayName, natRuleName, context);
    ...
    public void delete(String resourceGroupName, String gatewayName, String natRuleName) {
        beginDelete(resourceGroupName, gatewayName, natRuleName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String gatewayName, String natRuleName, Context context) {
        beginDelete(resourceGroupName, gatewayName, natRuleName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list all nat rules to a virtual wan vpn gateway along with
     * {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnGatewayNatRuleInner> listByVpnGatewaySinglePage(String resourceGroupName,
        String gatewayName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListVpnGatewayNatRulesResult> res = service.listByVpnGatewaySync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnGatewayNatRuleInner> listByVpnGatewayNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListVpnGatewayNatRulesResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnGatewayNatRuleInner> listByVpnGatewayNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NatRulesClientImpl.class);
}
