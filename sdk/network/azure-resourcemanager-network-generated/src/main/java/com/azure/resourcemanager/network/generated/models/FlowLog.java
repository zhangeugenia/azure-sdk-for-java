...
public interface FlowLog {
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithStorageId, DefinitionStages.WithEnabledFilteringCriteria, DefinitionStages.WithEnabled,
            DefinitionStages.WithRetentionPolicy, DefinitionStages.WithFormat,
        ...
        /**
         * The stage of the FlowLog definition allowing to specify enabledFilteringCriteria.
         */
        interface WithEnabledFilteringCriteria {
            /**
             * Specifies the enabledFilteringCriteria property: Optional field to filter network traffic logs based on
             * SrcIP, SrcPort, DstIP, DstPort, Protocol, Encryption, Direction and Action. If not specified, all network
             * traffic will be logged..
             * 
             * @param enabledFilteringCriteria Optional field to filter network traffic logs based on SrcIP, SrcPort,
             * DstIP, DstPort, Protocol, Encryption, Direction and Action. If not specified, all network traffic will be
             * logged.
             * @return the next definition stage.
             */
            WithCreate withEnabledFilteringCriteria(String enabledFilteringCriteria);
        }
