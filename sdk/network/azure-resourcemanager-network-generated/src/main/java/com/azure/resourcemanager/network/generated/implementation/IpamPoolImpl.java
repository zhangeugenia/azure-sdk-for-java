...
public final class IpamPoolImpl implements IpamPool, IpamPool.Definition, IpamPool.Update {
    ...
    public IpamPool create() {
        this.innerObject = serviceManager.serviceClient()
            .getIpamPools()
            .create(resourceGroupName, networkManagerName, poolName, this.innerModel(), createIfMatch, Context.NONE);
        return this;
    }
    ...
    public IpamPool create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getIpamPools()
            .create(resourceGroupName, networkManagerName, poolName, this.innerModel(), createIfMatch, context);
        return this;
    }
    ...
    public IpamPool apply() {
        this.innerObject = serviceManager.serviceClient()
            .getIpamPools()
            .updateWithResponse(resourceGroupName, networkManagerName, poolName, updateIfMatch, updateBody,
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    public IpamPool apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getIpamPools()
            .updateWithResponse(resourceGroupName, networkManagerName, poolName, updateIfMatch, updateBody, context)
            .getValue();
        return this;
    }
    ...
    public IpamPoolImpl withIfMatch(String ifMatch) {
        if (isInCreateMode()) {
