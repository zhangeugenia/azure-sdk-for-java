...
public final class AvailableDelegationsClientImpl implements AvailableDelegationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailableDelegationInner> listSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<AvailableDelegationsResult> res = service.listSync(this.client.getEndpoint(), location, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailableDelegationInner> listSinglePage(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
