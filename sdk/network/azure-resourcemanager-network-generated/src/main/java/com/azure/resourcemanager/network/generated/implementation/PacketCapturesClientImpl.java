...
public final class PacketCapturesClientImpl implements PacketCapturesClient {
    ...
    public interface PacketCapturesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PacketCaptureResultInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName,
            @PathParam("packetCaptureName") String packetCaptureName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> getStatusSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName,
            @PathParam("packetCaptureName") String packetCaptureName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<PacketCaptureListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkWatcherName") String networkWatcherName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about packet capture session along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        if (packetCaptureName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter packetCaptureName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, packetCaptureName,
    ...
    public SyncPoller<PollResult<PacketCaptureResultInner>, PacketCaptureResultInner> beginCreate(
        ...
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, networkWatcherName, packetCaptureName, parameters);
        return this.client.<PacketCaptureResultInner, PacketCaptureResultInner>getLroResult(response,
            PacketCaptureResultInner.class, PacketCaptureResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PacketCaptureResultInner>, PacketCaptureResultInner> beginCreate(
        ...
        Context context) {
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, networkWatcherName, packetCaptureName, parameters, context);
        return this.client.<PacketCaptureResultInner, PacketCaptureResultInner>getLroResult(response,
            PacketCaptureResultInner.class, PacketCaptureResultInner.class, context);
    }
    ...
    public PacketCaptureResultInner create(String resourceGroupName, String networkWatcherName,
        String packetCaptureName, PacketCapture parameters) {
        return beginCreate(resourceGroupName, networkWatcherName, packetCaptureName, parameters).getFinalResult();
    }
    ...
    public PacketCaptureResultInner create(String resourceGroupName, String networkWatcherName,
        String packetCaptureName, PacketCapture parameters, Context context) {
        return beginCreate(resourceGroupName, networkWatcherName, packetCaptureName, parameters, context)
            .getFinalResult();
    }
    ...
    public Response<PacketCaptureResultInner> getWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, packetCaptureName,
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String networkWatcherName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, packetCaptureName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkWatcherName,
        String packetCaptureName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, networkWatcherName, packetCaptureName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkWatcherName,
        String packetCaptureName, Context context) {
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, networkWatcherName, packetCaptureName, context);
    ...
    public void delete(String resourceGroupName, String networkWatcherName, String packetCaptureName) {
        beginDelete(resourceGroupName, networkWatcherName, packetCaptureName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String networkWatcherName, String packetCaptureName, Context context) {
        beginDelete(resourceGroupName, networkWatcherName, packetCaptureName, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> stopWithResponse(String resourceGroupName, String networkWatcherName,
        String packetCaptureName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.stopSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName, packetCaptureName,
            apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginStop(String resourceGroupName, String networkWatcherName,
        String packetCaptureName) {
        Response<BinaryData> response = stopWithResponse(resourceGroupName, networkWatcherName, packetCaptureName);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginStop(String resourceGroupName, String networkWatcherName,
        String packetCaptureName, Context context) {
        Response<BinaryData> response
            = stopWithResponse(resourceGroupName, networkWatcherName, packetCaptureName, context);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, context);
    }
    ...
    public void stop(String resourceGroupName, String networkWatcherName, String packetCaptureName) {
        beginStop(resourceGroupName, networkWatcherName, packetCaptureName).getFinalResult();
    }
    ...
    public void stop(String resourceGroupName, String networkWatcherName, String packetCaptureName, Context context) {
        beginStop(resourceGroupName, networkWatcherName, packetCaptureName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return status of packet capture session along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> getStatusWithResponse(String resourceGroupName, String networkWatcherName,
        String packetCaptureName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getStatusSync(this.client.getEndpoint(), resourceGroupName, networkWatcherName,
            packetCaptureName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PacketCaptureQueryStatusResultInner>, PacketCaptureQueryStatusResultInner>
        ...
        Response<BinaryData> response = getStatusWithResponse(resourceGroupName, networkWatcherName, packetCaptureName);
        return this.client.<PacketCaptureQueryStatusResultInner, PacketCaptureQueryStatusResultInner>getLroResult(
            response, PacketCaptureQueryStatusResultInner.class, PacketCaptureQueryStatusResultInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<PacketCaptureQueryStatusResultInner>, PacketCaptureQueryStatusResultInner>
        ...
        Response<BinaryData> response
            = getStatusWithResponse(resourceGroupName, networkWatcherName, packetCaptureName, context);
        return this.client.<PacketCaptureQueryStatusResultInner, PacketCaptureQueryStatusResultInner>getLroResult(
            response, PacketCaptureQueryStatusResultInner.class, PacketCaptureQueryStatusResultInner.class, context);
    }
    ...
    public PacketCaptureQueryStatusResultInner getStatus(String resourceGroupName, String networkWatcherName,
        String packetCaptureName) {
        return beginGetStatus(resourceGroupName, networkWatcherName, packetCaptureName).getFinalResult();
    }
    ...
    public PacketCaptureQueryStatusResultInner getStatus(String resourceGroupName, String networkWatcherName,
        String packetCaptureName, Context context) {
        return beginGetStatus(resourceGroupName, networkWatcherName, packetCaptureName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of packet capture sessions along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PacketCaptureResultInner> listSinglePage(String resourceGroupName,
        String networkWatcherName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<PacketCaptureListResult> res = service.listSync(this.client.getEndpoint(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PacketCaptureResultInner> listSinglePage(String resourceGroupName, String networkWatcherName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
