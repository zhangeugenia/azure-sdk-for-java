...
public final class ExpressRouteGatewaysClientImpl implements ExpressRouteGatewaysClient {
    ...
    public interface ExpressRouteGatewaysService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteGatewayListInner> listBySubscriptionSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteGatewayListInner> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteGatewayInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("expressRouteGatewayName") String expressRouteGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public Response<ExpressRouteGatewayListInner> listBySubscriptionWithResponse(Context context) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listBySubscriptionSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            accept, context);
    }
    ...
    public Response<ExpressRouteGatewayListInner> listByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String expressRouteGatewayName,
        ...
        if (expressRouteGatewayName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter expressRouteGatewayName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, expressRouteGatewayName,
            apiVersion, this.client.getSubscriptionId(), putExpressRouteGatewayParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteGatewayInner>, ExpressRouteGatewayInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, expressRouteGatewayName, putExpressRouteGatewayParameters);
        return this.client.<ExpressRouteGatewayInner, ExpressRouteGatewayInner>getLroResult(response,
            ExpressRouteGatewayInner.class, ExpressRouteGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteGatewayInner>, ExpressRouteGatewayInner> beginCreateOrUpdate(
        String resourceGroupName, String expressRouteGatewayName,
        ExpressRouteGatewayInner putExpressRouteGatewayParameters, Context context) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, expressRouteGatewayName,
            putExpressRouteGatewayParameters, context);
        return this.client.<ExpressRouteGatewayInner, ExpressRouteGatewayInner>getLroResult(response,
            ExpressRouteGatewayInner.class, ExpressRouteGatewayInner.class, context);
    }
    ...
    public ExpressRouteGatewayInner createOrUpdate(String resourceGroupName, String expressRouteGatewayName,
        ExpressRouteGatewayInner putExpressRouteGatewayParameters) {
        return beginCreateOrUpdate(resourceGroupName, expressRouteGatewayName, putExpressRouteGatewayParameters)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> updateTagsWithResponse(String resourceGroupName, String expressRouteGatewayName,
        ...
        return service.updateTagsSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            expressRouteGatewayName, apiVersion, expressRouteGatewayParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteGatewayInner>, ExpressRouteGatewayInner> beginUpdateTags(
        String resourceGroupName, String expressRouteGatewayName, TagsObject expressRouteGatewayParameters) {
        Response<BinaryData> response
            = updateTagsWithResponse(resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters);
        return this.client.<ExpressRouteGatewayInner, ExpressRouteGatewayInner>getLroResult(response,
            ExpressRouteGatewayInner.class, ExpressRouteGatewayInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteGatewayInner>, ExpressRouteGatewayInner> beginUpdateTags(
        String resourceGroupName, String expressRouteGatewayName, TagsObject expressRouteGatewayParameters,
        Context context) {
        Response<BinaryData> response = updateTagsWithResponse(resourceGroupName, expressRouteGatewayName,
    ...
    public ExpressRouteGatewayInner updateTags(String resourceGroupName, String expressRouteGatewayName,
        TagsObject expressRouteGatewayParameters) {
        return beginUpdateTags(resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters)
            .getFinalResult();
    }
    ...
    public ExpressRouteGatewayInner updateTags(String resourceGroupName, String expressRouteGatewayName,
        TagsObject expressRouteGatewayParameters, Context context) {
        return beginUpdateTags(resourceGroupName, expressRouteGatewayName, expressRouteGatewayParameters, context)
            .getFinalResult();
    }
    ...
    public Response<ExpressRouteGatewayInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, expressRouteGatewayName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String expressRouteGatewayName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, expressRouteGatewayName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String expressRouteGatewayName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, expressRouteGatewayName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String expressRouteGatewayName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, expressRouteGatewayName, context);
    ...
    public void delete(String resourceGroupName, String expressRouteGatewayName) {
        beginDelete(resourceGroupName, expressRouteGatewayName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String expressRouteGatewayName, Context context) {
        beginDelete(resourceGroupName, expressRouteGatewayName, context).getFinalResult();
    }

    private static final ClientLogger LOGGER = new ClientLogger(ExpressRouteGatewaysClientImpl.class);
}
