...
public final class AvailablePrivateEndpointTypesClientImpl implements AvailablePrivateEndpointTypesClient {
    ...
    public interface AvailablePrivateEndpointTypesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailablePrivateEndpointTypesResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailablePrivateEndpointTypesResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailablePrivateEndpointTypesResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AvailablePrivateEndpointTypesResult> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an array of available PrivateEndpoint types along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listSinglePage(String location) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<AvailablePrivateEndpointTypesResult> res = service.listSync(this.client.getEndpoint(), location,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listSinglePage(String location, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listByResourceGroupSinglePage(String location,
        String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<AvailablePrivateEndpointTypesResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
            location, resourceGroupName, this.client.getSubscriptionId(), apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<AvailablePrivateEndpointTypeInner> listByResourceGroupSinglePage(String location,
        ...
        final String accept = "application/json";
        Response<AvailablePrivateEndpointTypesResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
            location, resourceGroupName, this.client.getSubscriptionId(), apiVersion, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<AvailablePrivateEndpointTypeInner> listByResourceGroup(String location,
        String resourceGroupName) {
        return new PagedIterable<>(() -> listByResourceGroupSinglePage(location, resourceGroupName),
    ...
    public PagedIterable<AvailablePrivateEndpointTypeInner> listByResourceGroup(String location,
        String resourceGroupName, Context context) {
        return new PagedIterable<>(() -> listByResourceGroupSinglePage(location, resourceGroupName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AvailablePrivateEndpointTypesResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<AvailablePrivateEndpointTypeInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
