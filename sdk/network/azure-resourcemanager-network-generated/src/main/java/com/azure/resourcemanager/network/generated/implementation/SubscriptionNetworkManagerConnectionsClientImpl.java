...
public final class SubscriptionNetworkManagerConnectionsClientImpl
    ...
    public Response<NetworkManagerConnectionInner> getWithResponse(String networkManagerConnectionName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), this.client.getSubscriptionId(), networkManagerConnectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<NetworkManagerConnectionInner> listSinglePage(Integer top, String skipToken) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SubscriptionNetworkManagerConnectionsClientImpl.class);
}
