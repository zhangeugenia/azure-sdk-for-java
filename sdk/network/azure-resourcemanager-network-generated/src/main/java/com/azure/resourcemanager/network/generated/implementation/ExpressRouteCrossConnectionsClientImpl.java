...
public final class ExpressRouteCrossConnectionsClientImpl implements ExpressRouteCrossConnectionsClient {
    ...
    public interface ExpressRouteCrossConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("crossConnectionName") String crossConnectionName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("crossConnectionName") String crossConnectionName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") TagsObject crossConnectionParameters, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCrossConnectionListResult> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListExpressRouteCrossConnection API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listSinglePage(String filter) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listSinglePage(String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
    ...
    public Response<ExpressRouteCrossConnectionInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        if (crossConnectionName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter crossConnectionName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String crossConnectionName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName, apiVersion,
    ...
    public SyncPoller<PollResult<ExpressRouteCrossConnectionInner>, ExpressRouteCrossConnectionInner>
        beginCreateOrUpdate(String resourceGroupName, String crossConnectionName,
            ExpressRouteCrossConnectionInner parameters) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, crossConnectionName, parameters);
        return this.client.<ExpressRouteCrossConnectionInner, ExpressRouteCrossConnectionInner>getLroResult(response,
            ExpressRouteCrossConnectionInner.class, ExpressRouteCrossConnectionInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCrossConnectionInner>, ExpressRouteCrossConnectionInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, crossConnectionName, parameters, context);
        return this.client.<ExpressRouteCrossConnectionInner, ExpressRouteCrossConnectionInner>getLroResult(response,
            ExpressRouteCrossConnectionInner.class, ExpressRouteCrossConnectionInner.class, context);
    }
    ...
    public ExpressRouteCrossConnectionInner createOrUpdate(String resourceGroupName, String crossConnectionName,
        ExpressRouteCrossConnectionInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, crossConnectionName, parameters).getFinalResult();
    }
    ...
    public ExpressRouteCrossConnectionInner createOrUpdate(String resourceGroupName, String crossConnectionName,
        ExpressRouteCrossConnectionInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, crossConnectionName, parameters, context).getFinalResult();
    }
    ...
    public Response<ExpressRouteCrossConnectionInner> updateTagsWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> listArpTableWithResponse(String resourceGroupName, String crossConnectionName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listArpTableSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName, peeringName,
    ...
    public
        ...
        Response<BinaryData> response
            = listArpTableWithResponse(resourceGroupName, crossConnectionName, peeringName, devicePath);
        return this.client
            .<ExpressRouteCircuitsArpTableListResultInner, ExpressRouteCircuitsArpTableListResultInner>getLroResult(
    ...
    public
        ...
        beginListArpTable(String resourceGroupName, String crossConnectionName, String peeringName, String devicePath,
            Context context) {
        Response<BinaryData> response
            = listArpTableWithResponse(resourceGroupName, crossConnectionName, peeringName, devicePath, context);
        return this.client
            .<ExpressRouteCircuitsArpTableListResultInner, ExpressRouteCircuitsArpTableListResultInner>getLroResult(
                response, ExpressRouteCircuitsArpTableListResultInner.class,
    ...
    public ExpressRouteCircuitsArpTableListResultInner listArpTable(String resourceGroupName,
        String crossConnectionName, String peeringName, String devicePath) {
        return beginListArpTable(resourceGroupName, crossConnectionName, peeringName, devicePath).getFinalResult();
    }
    ...
    public ExpressRouteCircuitsArpTableListResultInner listArpTable(String resourceGroupName,
        ...
        return beginListArpTable(resourceGroupName, crossConnectionName, peeringName, devicePath, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> listRoutesTableSummaryWithResponse(String resourceGroupName,
        String crossConnectionName, String peeringName, String devicePath) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listRoutesTableSummarySync(this.client.getEndpoint(), resourceGroupName, crossConnectionName,
    ...
    public
        ...
        beginListRoutesTableSummary(String resourceGroupName, String crossConnectionName, String peeringName,
            String devicePath) {
        Response<BinaryData> response
            = listRoutesTableSummaryWithResponse(resourceGroupName, crossConnectionName, peeringName, devicePath);
        return this.client
            .<ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner, ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner>getLroResult(
                response, ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner.class,
                ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner.class, Context.NONE);
    }
    ...
    public
        ...
        Response<BinaryData> response = listRoutesTableSummaryWithResponse(resourceGroupName, crossConnectionName,
    ...
    public ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner listRoutesTableSummary(
        String resourceGroupName, String crossConnectionName, String peeringName, String devicePath) {
        return beginListRoutesTableSummary(resourceGroupName, crossConnectionName, peeringName, devicePath)
            .getFinalResult();
    }
    ...
    public ExpressRouteCrossConnectionsRoutesTableSummaryListResultInner listRoutesTableSummary(
        ...
        return beginListRoutesTableSummary(resourceGroupName, crossConnectionName, peeringName, devicePath, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> listRoutesTableWithResponse(String resourceGroupName, String crossConnectionName,
        String peeringName, String devicePath) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listRoutesTableSync(this.client.getEndpoint(), resourceGroupName, crossConnectionName,
            peeringName, devicePath, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public
        ...
        beginListRoutesTable(String resourceGroupName, String crossConnectionName, String peeringName,
            String devicePath) {
        Response<BinaryData> response
            = listRoutesTableWithResponse(resourceGroupName, crossConnectionName, peeringName, devicePath);
        return this.client
            .<ExpressRouteCircuitsRoutesTableListResultInner, ExpressRouteCircuitsRoutesTableListResultInner>getLroResult(
    ...
    public
        ...
        beginListRoutesTable(String resourceGroupName, String crossConnectionName, String peeringName,
            String devicePath, Context context) {
        Response<BinaryData> response
            = listRoutesTableWithResponse(resourceGroupName, crossConnectionName, peeringName, devicePath, context);
        return this.client
            .<ExpressRouteCircuitsRoutesTableListResultInner, ExpressRouteCircuitsRoutesTableListResultInner>getLroResult(
                response, ExpressRouteCircuitsRoutesTableListResultInner.class,
    ...
    public ExpressRouteCircuitsRoutesTableListResultInner listRoutesTable(String resourceGroupName,
        String crossConnectionName, String peeringName, String devicePath) {
        return beginListRoutesTable(resourceGroupName, crossConnectionName, peeringName, devicePath).getFinalResult();
    }
    ...
    public ExpressRouteCircuitsRoutesTableListResultInner listRoutesTable(String resourceGroupName,
        String crossConnectionName, String peeringName, String devicePath, Context context) {
        return beginListRoutesTable(resourceGroupName, crossConnectionName, peeringName, devicePath, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ExpressRouteCrossConnectionListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCrossConnectionInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
