...
public final class FirewallPolicyRuleCollectionGroupDraftsClientImpl
    ...
    public interface FirewallPolicyRuleCollectionGroupDraftsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyRuleCollectionGroupDraftInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleCollectionGroupName") String ruleCollectionGroupName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<FirewallPolicyRuleCollectionGroupDraftInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleCollectionGroupName") String ruleCollectionGroupName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(FirewallPolicyRuleCollectionGroupDraftsClientImpl.class);
}
