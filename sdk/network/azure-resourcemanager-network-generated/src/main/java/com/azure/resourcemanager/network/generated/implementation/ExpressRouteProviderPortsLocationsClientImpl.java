...
public final class ExpressRouteProviderPortsLocationsClientImpl implements ExpressRouteProviderPortsLocationsClient {
    ...
    public interface ExpressRouteProviderPortsLocationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteProviderPortListResultInner> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$filter") String filter, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ExpressRouteProviderPortListResultInner> listWithResponse(String filter, Context context) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listSync(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), filter, accept,
            context);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ExpressRouteProviderPortsLocationsClientImpl.class);
}
