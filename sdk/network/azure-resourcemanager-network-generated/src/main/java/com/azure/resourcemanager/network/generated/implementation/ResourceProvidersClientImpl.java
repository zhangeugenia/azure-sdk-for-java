...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> putBastionShareableLinkSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkListRequest bslRequest,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> deleteBastionShareableLinkSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkListRequest bslRequest,
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> deleteBastionShareableLinkByTokenSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkTokenListRequest bslTokenRequest,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionShareableLinkListResult> getBastionShareableLinkSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkListRequest bslRequest,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> getActiveSessionsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionSessionDeleteResult> disconnectActiveSessionsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") SessionIds sessionIds,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<DnsNameAvailabilityResultInner> checkDnsNameAvailabilitySync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("domainNameLabel") String domainNameLabel,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteProviderPortInner> expressRouteProviderPortSync(@HostParam("$host") String endpoint,
            @PathParam("providerport") String providerport, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ActiveConnectivityConfigurationsListResultInner> listActiveConnectivityConfigurationsSync(
            @HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkManagerName") String networkManagerName, @QueryParam("$top") Integer top,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ActiveSecurityAdminRulesListResultInner> listActiveSecurityAdminRulesSync(
            @HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkManagerName") String networkManagerName, @QueryParam("$top") Integer top,
        ...
        Response<NetworkManagerEffectiveConnectivityConfigurationListResultInner>
            listNetworkManagerEffectiveConnectivityConfigurationsSync(@HostParam("$host") String endpoint,
                @PathParam("subscriptionId") String subscriptionId,
                @PathParam("resourceGroupName") String resourceGroupName,
                @PathParam("virtualNetworkName") String virtualNetworkName,
                @QueryParam("api-version") String apiVersion, @QueryParam("$top") Integer top,
        ...
        Response<NetworkManagerEffectiveSecurityAdminRulesListResultInner>
            listNetworkManagerEffectiveSecurityAdminRulesSync(@HostParam("$host") String endpoint,
                @PathParam("subscriptionId") String subscriptionId,
                @PathParam("resourceGroupName") String resourceGroupName,
                @PathParam("virtualNetworkName") String virtualNetworkName,
                @QueryParam("api-version") String apiVersion, @QueryParam("$top") Integer top,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualWanSecurityProvidersInner> supportedSecurityProvidersSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualWANName") String virtualWanName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> generatevirtualwanvpnserverconfigurationvpnprofileSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualWANName") String virtualWanName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") VirtualWanVpnProfileParameters vpnClientParams,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionShareableLinkListResult> putBastionShareableLinkNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionShareableLinkListResult> getBastionShareableLinkNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionActiveSessionListResult> getActiveSessionsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BastionSessionDeleteResult> disconnectActiveSessionsNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for all the Bastion Shareable Link endpoints along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionShareableLinkInner> putBastionShareableLinkSinglePage(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest) {
        if (this.client.getEndpoint() == null) {
        ...
        if (bslRequest == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter bslRequest is required and cannot be null."));
        } else {
            bslRequest.validate();
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<BinaryData> res = service.putBastionShareableLinkSync(this.client.getEndpoint(), resourceGroupName,
            bastionHostname, apiVersion, this.client.getSubscriptionId(), bslRequest, accept, Context.NONE);
        BastionShareableLinkListResult lroPageableResult = this.client
            .<BastionShareableLinkListResult, BastionShareableLinkListResult>getLroResult(res,
                BastionShareableLinkListResult.class, BastionShareableLinkListResult.class, Context.NONE)
            .getFinalResult();
    ...
    private PagedResponse<BastionShareableLinkInner> putBastionShareableLinkSinglePage(String resourceGroupName,
        ...
        BastionShareableLinkListResult lroPageableResult
            = this.client
                .<BastionShareableLinkListResult, BastionShareableLinkListResult>getLroResult(res,
                    BastionShareableLinkListResult.class, BastionShareableLinkListResult.class, context)
                .getFinalResult();
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            lroPageableResult.value(), lroPageableResult.nextLink(), null);
    }
    ...
    public PagedIterable<BastionShareableLinkInner> putBastionShareableLink(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> putBastionShareableLinkSinglePage(resourceGroupName, bastionHostname, bslRequest),
            nextLink -> putBastionShareableLinkNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<BastionShareableLinkInner> putBastionShareableLink(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest, Context context) {
        return new PagedIterable<>(
            () -> putBastionShareableLinkSinglePage(resourceGroupName, bastionHostname, bslRequest, context),
            nextLink -> putBastionShareableLinkNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteBastionShareableLinkWithResponse(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteBastionShareableLinkSync(this.client.getEndpoint(), resourceGroupName, bastionHostname,
            apiVersion, this.client.getSubscriptionId(), bslRequest, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteBastionShareableLink(String resourceGroupName,
        ...
        Response<BinaryData> response
            = deleteBastionShareableLinkWithResponse(resourceGroupName, bastionHostname, bslRequest);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteBastionShareableLink(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest, Context context) {
        Response<BinaryData> response
            = deleteBastionShareableLinkWithResponse(resourceGroupName, bastionHostname, bslRequest, context);
    ...
    public void deleteBastionShareableLink(String resourceGroupName, String bastionHostname,
        BastionShareableLinkListRequest bslRequest) {
        beginDeleteBastionShareableLink(resourceGroupName, bastionHostname, bslRequest).getFinalResult();
    }
    ...
    public void deleteBastionShareableLink(String resourceGroupName, String bastionHostname,
        ...
        beginDeleteBastionShareableLink(resourceGroupName, bastionHostname, bslRequest, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> deleteBastionShareableLinkByTokenWithResponse(String resourceGroupName,
        ...
        if (bslTokenRequest == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter bslTokenRequest is required and cannot be null."));
        } else {
            bslTokenRequest.validate();
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteBastionShareableLinkByTokenSync(this.client.getEndpoint(), resourceGroupName,
            bastionHostname, apiVersion, this.client.getSubscriptionId(), bslTokenRequest, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteBastionShareableLinkByToken(String resourceGroupName,
        String bastionHostname, BastionShareableLinkTokenListRequest bslTokenRequest) {
        Response<BinaryData> response
            = deleteBastionShareableLinkByTokenWithResponse(resourceGroupName, bastionHostname, bslTokenRequest);
        return this.client.<Void, Void>getLroResult(response, Void.class, Void.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteBastionShareableLinkByToken(String resourceGroupName,
        String bastionHostname, BastionShareableLinkTokenListRequest bslTokenRequest, Context context) {
        Response<BinaryData> response = deleteBastionShareableLinkByTokenWithResponse(resourceGroupName,
    ...
    public void deleteBastionShareableLinkByToken(String resourceGroupName, String bastionHostname,
        BastionShareableLinkTokenListRequest bslTokenRequest) {
        beginDeleteBastionShareableLinkByToken(resourceGroupName, bastionHostname, bslTokenRequest).getFinalResult();
    }
    ...
    public void deleteBastionShareableLinkByToken(String resourceGroupName, String bastionHostname,
        ...
        beginDeleteBastionShareableLinkByToken(resourceGroupName, bastionHostname, bslTokenRequest, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionShareableLinkInner> getBastionShareableLinkSinglePage(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        Response<BastionShareableLinkListResult> res
            = service.getBastionShareableLinkSync(this.client.getEndpoint(), resourceGroupName, bastionHostname,
                apiVersion, this.client.getSubscriptionId(), bslRequest, accept, Context.NONE);
    ...
    public PagedIterable<BastionShareableLinkInner> getBastionShareableLink(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest) {
        return new PagedIterable<>(
            () -> getBastionShareableLinkSinglePage(resourceGroupName, bastionHostname, bslRequest),
            nextLink -> getBastionShareableLinkNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<BastionShareableLinkInner> getBastionShareableLink(String resourceGroupName,
        String bastionHostname, BastionShareableLinkListRequest bslRequest, Context context) {
        return new PagedIterable<>(
            () -> getBastionShareableLinkSinglePage(resourceGroupName, bastionHostname, bslRequest, context),
            nextLink -> getBastionShareableLinkNextSinglePage(nextLink, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for GetActiveSessions along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionActiveSessionInner> getActiveSessionsSinglePage(String resourceGroupName,
        String bastionHostname) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<BinaryData> res = service.getActiveSessionsSync(this.client.getEndpoint(), resourceGroupName,
            bastionHostname, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        BastionActiveSessionListResult lroPageableResult = this.client
            .<BastionActiveSessionListResult, BastionActiveSessionListResult>getLroResult(res,
                BastionActiveSessionListResult.class, BastionActiveSessionListResult.class, Context.NONE)
            .getFinalResult();
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            lroPageableResult.value(), lroPageableResult.nextLink(), null);
    }
    ...
    private PagedResponse<BastionActiveSessionInner> getActiveSessionsSinglePage(String resourceGroupName,
        ...
        BastionActiveSessionListResult lroPageableResult
            = this.client
                .<BastionActiveSessionListResult, BastionActiveSessionListResult>getLroResult(res,
                    BastionActiveSessionListResult.class, BastionActiveSessionListResult.class, context)
                .getFinalResult();
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            lroPageableResult.value(), lroPageableResult.nextLink(), null);
    }
    ...
    public PagedIterable<BastionActiveSessionInner> getActiveSessions(String resourceGroupName,
        String bastionHostname) {
        return new PagedIterable<>(() -> getActiveSessionsSinglePage(resourceGroupName, bastionHostname),
            nextLink -> getActiveSessionsNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<BastionActiveSessionInner> getActiveSessions(String resourceGroupName, String bastionHostname,
        Context context) {
        return new PagedIterable<>(() -> getActiveSessionsSinglePage(resourceGroupName, bastionHostname, context),
            nextLink -> getActiveSessionsNextSinglePage(nextLink, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for DisconnectActiveSessions along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionSessionStateInner> disconnectActiveSessionsSinglePage(String resourceGroupName,
        String bastionHostname, SessionIds sessionIds) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        if (sessionIds == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter sessionIds is required and cannot be null."));
        } else {
            sessionIds.validate();
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<BastionSessionDeleteResult> res
            = service.disconnectActiveSessionsSync(this.client.getEndpoint(), resourceGroupName, bastionHostname,
                apiVersion, this.client.getSubscriptionId(), sessionIds, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<BastionSessionStateInner> disconnectActiveSessionsSinglePage(String resourceGroupName,
        ...
        Response<BastionSessionDeleteResult> res
            = service.disconnectActiveSessionsSync(this.client.getEndpoint(), resourceGroupName, bastionHostname,
                apiVersion, this.client.getSubscriptionId(), sessionIds, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<BastionSessionStateInner> disconnectActiveSessions(String resourceGroupName,
        String bastionHostname, SessionIds sessionIds) {
        return new PagedIterable<>(
            () -> disconnectActiveSessionsSinglePage(resourceGroupName, bastionHostname, sessionIds),
            nextLink -> disconnectActiveSessionsNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<BastionSessionStateInner> disconnectActiveSessions(String resourceGroupName,
        String bastionHostname, SessionIds sessionIds, Context context) {
        return new PagedIterable<>(
            () -> disconnectActiveSessionsSinglePage(resourceGroupName, bastionHostname, sessionIds, context),
            nextLink -> disconnectActiveSessionsNextSinglePage(nextLink, context));
    }
    ...
    public Response<DnsNameAvailabilityResultInner> checkDnsNameAvailabilityWithResponse(String location,
        ...
        if (domainNameLabel == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter domainNameLabel is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.checkDnsNameAvailabilitySync(this.client.getEndpoint(), location, domainNameLabel, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<ExpressRouteProviderPortInner> expressRouteProviderPortWithResponse(String providerport,
        ...
        if (providerport == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter providerport is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.expressRouteProviderPortSync(this.client.getEndpoint(), providerport, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    public Response<ActiveConnectivityConfigurationsListResultInner> listActiveConnectivityConfigurationsWithResponse(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listActiveConnectivityConfigurationsSync(this.client.getEndpoint(), apiVersion,
    ...
    public Response<ActiveSecurityAdminRulesListResultInner> listActiveSecurityAdminRulesWithResponse(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listActiveSecurityAdminRulesSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, networkManagerName, top, parameters, accept, context);
    }
    ...
    public Response<NetworkManagerEffectiveConnectivityConfigurationListResultInner>
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listNetworkManagerEffectiveConnectivityConfigurationsSync(this.client.getEndpoint(),
    ...
    public Response<NetworkManagerEffectiveSecurityAdminRulesListResultInner>
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listNetworkManagerEffectiveSecurityAdminRulesSync(this.client.getEndpoint(),
            this.client.getSubscriptionId(), resourceGroupName, virtualNetworkName, apiVersion, top, parameters, accept,
            context);
    }
    ...
    public Response<VirtualWanSecurityProvidersInner> supportedSecurityProvidersWithResponse(String resourceGroupName,
        ...
        if (virtualWanName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter virtualWanName is required and cannot be null."));
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.supportedSecurityProvidersSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return vpn Profile Response for package generation along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> generatevirtualwanvpnserverconfigurationvpnprofileWithResponse(
        String resourceGroupName, String virtualWanName, VirtualWanVpnProfileParameters vpnClientParams) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        if (vpnClientParams == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter vpnClientParams is required and cannot be null."));
        } else {
            vpnClientParams.validate();
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.generatevirtualwanvpnserverconfigurationvpnprofileSync(this.client.getEndpoint(),
    ...
    public SyncPoller<PollResult<VpnProfileResponseInner>, VpnProfileResponseInner>
        beginGeneratevirtualwanvpnserverconfigurationvpnprofile(String resourceGroupName, String virtualWanName,
            VirtualWanVpnProfileParameters vpnClientParams) {
        Response<BinaryData> response = generatevirtualwanvpnserverconfigurationvpnprofileWithResponse(
            resourceGroupName, virtualWanName, vpnClientParams);
        return this.client.<VpnProfileResponseInner, VpnProfileResponseInner>getLroResult(response,
            VpnProfileResponseInner.class, VpnProfileResponseInner.class, Context.NONE);
    }
    ...
    public VpnProfileResponseInner generatevirtualwanvpnserverconfigurationvpnprofile(String resourceGroupName,
        ...
        return beginGeneratevirtualwanvpnserverconfigurationvpnprofile(resourceGroupName, virtualWanName,
            vpnClientParams).getFinalResult();
    }
    ...
    public VpnProfileResponseInner generatevirtualwanvpnserverconfigurationvpnprofile(String resourceGroupName,
        ...
        return beginGeneratevirtualwanvpnserverconfigurationvpnprofile(resourceGroupName, virtualWanName,
            vpnClientParams, context).getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionShareableLinkInner> putBastionShareableLinkNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<BastionShareableLinkListResult> res
            = service.putBastionShareableLinkNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<BastionShareableLinkInner> putBastionShareableLinkNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<BastionShareableLinkListResult> res
            = service.putBastionShareableLinkNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionShareableLinkInner> getBastionShareableLinkNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<BastionShareableLinkListResult> res
            = service.getBastionShareableLinkNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<BastionShareableLinkInner> getBastionShareableLinkNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<BastionShareableLinkListResult> res
            = service.getBastionShareableLinkNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionActiveSessionInner> getActiveSessionsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        Response<BastionActiveSessionListResult> res
            = service.getActiveSessionsNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionActiveSessionInner> getActiveSessionsNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<BastionActiveSessionListResult> res
            = service.getActiveSessionsNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BastionSessionStateInner> disconnectActiveSessionsNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<BastionSessionDeleteResult> res
            = service.disconnectActiveSessionsNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<BastionSessionStateInner> disconnectActiveSessionsNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<BastionSessionDeleteResult> res
            = service.disconnectActiveSessionsNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
