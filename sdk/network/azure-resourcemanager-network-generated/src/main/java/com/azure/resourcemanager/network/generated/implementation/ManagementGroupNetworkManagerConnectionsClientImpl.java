...
public final class ManagementGroupNetworkManagerConnectionsClientImpl
    ...
    public interface ManagementGroupNetworkManagerConnectionsService {
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkManagerConnectionInner> createOrUpdateSync(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId,
            @PathParam("networkManagerConnectionName") String networkManagerConnectionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") NetworkManagerConnectionInner parameters,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkManagerConnectionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId,
            @PathParam("networkManagerConnectionName") String networkManagerConnectionName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkManagerConnectionListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId, @QueryParam("api-version") String apiVersion,
            @QueryParam("$top") Integer top, @QueryParam("$skipToken") String skipToken,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkManagerConnectionListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<NetworkManagerConnectionInner> createOrUpdateWithResponse(String managementGroupId,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), managementGroupId, networkManagerConnectionName,
    ...
    public Response<NetworkManagerConnectionInner> getWithResponse(String managementGroupId,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), managementGroupId, networkManagerConnectionName, apiVersion,
            accept, context);
    }
    ...
    public Response<Void> deleteWithResponse(String managementGroupId, String networkManagerConnectionName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), managementGroupId, networkManagerConnectionName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of network manager connections along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<NetworkManagerConnectionInner> listSinglePage(String managementGroupId, Integer top,
        String skipToken) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<NetworkManagerConnectionListResult> res = service.listSync(this.client.getEndpoint(),
            managementGroupId, apiVersion, top, skipToken, accept, Context.NONE);
    ...
    private PagedResponse<NetworkManagerConnectionInner> listSinglePage(String managementGroupId, Integer top,
        ...
        final String accept = "application/json";
        Response<NetworkManagerConnectionListResult> res = service.listSync(this.client.getEndpoint(),
            managementGroupId, apiVersion, top, skipToken, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<NetworkManagerConnectionInner> list(String managementGroupId) {
        final Integer top = null;
        final String skipToken = null;
        return new PagedIterable<>(() -> listSinglePage(managementGroupId, top, skipToken),
    ...
    public PagedIterable<NetworkManagerConnectionInner> list(String managementGroupId, Integer top, String skipToken,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(managementGroupId, top, skipToken, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<NetworkManagerConnectionInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<NetworkManagerConnectionListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<NetworkManagerConnectionInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(ManagementGroupNetworkManagerConnectionsClientImpl.class);
}
