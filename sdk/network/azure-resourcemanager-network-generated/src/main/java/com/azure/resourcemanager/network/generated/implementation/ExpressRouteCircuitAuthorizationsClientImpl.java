...
public final class ExpressRouteCircuitAuthorizationsClientImpl implements ExpressRouteCircuitAuthorizationsClient {
    ...
    public interface ExpressRouteCircuitAuthorizationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExpressRouteCircuitAuthorizationInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName,
            @PathParam("authorizationName") String authorizationName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AuthorizationListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<AuthorizationListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String circuitName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, circuitName, authorizationName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String circuitName,
        String authorizationName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, circuitName, authorizationName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String circuitName,
        String authorizationName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, circuitName, authorizationName, context);
    ...
    public void delete(String resourceGroupName, String circuitName, String authorizationName) {
        beginDelete(resourceGroupName, circuitName, authorizationName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String circuitName, String authorizationName, Context context) {
        beginDelete(resourceGroupName, circuitName, authorizationName, context).getFinalResult();
    }
    ...
    public Response<ExpressRouteCircuitAuthorizationInner> getWithResponse(String resourceGroupName, String circuitName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, circuitName, authorizationName, apiVersion,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return authorization in an ExpressRouteCircuit resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String circuitName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, circuitName, authorizationName,
            apiVersion, this.client.getSubscriptionId(), authorizationParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCircuitAuthorizationInner>, ExpressRouteCircuitAuthorizationInner>
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, circuitName, authorizationName, authorizationParameters);
        return this.client.<ExpressRouteCircuitAuthorizationInner, ExpressRouteCircuitAuthorizationInner>getLroResult(
            response, ExpressRouteCircuitAuthorizationInner.class, ExpressRouteCircuitAuthorizationInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExpressRouteCircuitAuthorizationInner>, ExpressRouteCircuitAuthorizationInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, circuitName, authorizationName,
    ...
    public ExpressRouteCircuitAuthorizationInner createOrUpdate(String resourceGroupName, String circuitName,
        String authorizationName, ExpressRouteCircuitAuthorizationInner authorizationParameters) {
        return beginCreateOrUpdate(resourceGroupName, circuitName, authorizationName, authorizationParameters)
            .getFinalResult();
    }
    ...
    public ExpressRouteCircuitAuthorizationInner createOrUpdate(String resourceGroupName, String circuitName,
        String authorizationName, ExpressRouteCircuitAuthorizationInner authorizationParameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, circuitName, authorizationName, authorizationParameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all authorizations in an express route circuit along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitAuthorizationInner> listSinglePage(String resourceGroupName,
        String circuitName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<AuthorizationListResult> res = service.listSync(this.client.getEndpoint(), resourceGroupName,
            circuitName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListAuthorizations API service call retrieves all authorizations that belongs to an
     * ExpressRouteCircuit along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitAuthorizationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<AuthorizationListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExpressRouteCircuitAuthorizationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
