...
public final class InboundSecurityRuleOperationsClientImpl implements InboundSecurityRuleOperationsClient {
    ...
    public interface InboundSecurityRuleOperationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<InboundSecurityRuleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkVirtualApplianceName") String networkVirtualApplianceName,
            @PathParam("ruleCollectionName") String ruleCollectionName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName,
            ruleCollectionName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<InboundSecurityRuleInner>, InboundSecurityRuleInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, networkVirtualApplianceName,
            ruleCollectionName, parameters);
        return this.client.<InboundSecurityRuleInner, InboundSecurityRuleInner>getLroResult(response,
            InboundSecurityRuleInner.class, InboundSecurityRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<InboundSecurityRuleInner>, InboundSecurityRuleInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, networkVirtualApplianceName,
            ruleCollectionName, parameters, context);
        return this.client.<InboundSecurityRuleInner, InboundSecurityRuleInner>getLroResult(response,
            InboundSecurityRuleInner.class, InboundSecurityRuleInner.class, context);
    }
    ...
    public InboundSecurityRuleInner createOrUpdate(String resourceGroupName, String networkVirtualApplianceName,
        ...
        return beginCreateOrUpdate(resourceGroupName, networkVirtualApplianceName, ruleCollectionName, parameters)
            .getFinalResult();
    }
    ...
    public Response<InboundSecurityRuleInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName,
            ruleCollectionName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
