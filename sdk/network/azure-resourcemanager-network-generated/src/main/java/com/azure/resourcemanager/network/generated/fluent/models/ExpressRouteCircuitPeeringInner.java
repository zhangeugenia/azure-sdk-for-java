...
public final class ExpressRouteCircuitPeeringInner extends SubResource {
     ...
     * @return An instance of ExpressRouteCircuitPeeringInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ExpressRouteCircuitPeeringInner.
     */
    public static ExpressRouteCircuitPeeringInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ExpressRouteCircuitPeeringInner deserializedExpressRouteCircuitPeeringInner
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedExpressRouteCircuitPeeringInner.withId(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedExpressRouteCircuitPeeringInner.innerProperties
                        = ExpressRouteCircuitPeeringPropertiesFormatInner.fromJson(reader);
                } else if ("name".equals(fieldName)) {
                    deserializedExpressRouteCircuitPeeringInner.name = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedExpressRouteCircuitPeeringInner.etag = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedExpressRouteCircuitPeeringInner.type = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedExpressRouteCircuitPeeringInner;
        });
    }
}
