...
public final class VpnLinkConnectionsClientImpl implements VpnLinkConnectionsClient {
    ...
    public interface VpnLinkConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionSharedKeyResultList> getAllSharedKeysSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionSharedKeyResultInner> getDefaultSharedKeySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> setOrInitDefaultSharedKeySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionSharedKeyResultInner> listDefaultSharedKeySync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnSiteLinkConnectionsResult> listByVpnConnectionSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ConnectionSharedKeyResultList> getAllSharedKeysNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVpnSiteLinkConnectionsResult> listByVpnConnectionNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> resetConnectionWithResponse(String resourceGroupName, String gatewayName,
        ...
        if (linkConnectionName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter linkConnectionName is required and cannot be null."));
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.resetConnectionSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginResetConnection(String resourceGroupName, String gatewayName,
        ...
        Response<BinaryData> response
            = resetConnectionWithResponse(resourceGroupName, gatewayName, connectionName, linkConnectionName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginResetConnection(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, Context context) {
        Response<BinaryData> response
            = resetConnectionWithResponse(resourceGroupName, gatewayName, connectionName, linkConnectionName, context);
    ...
    public void resetConnection(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName) {
        beginResetConnection(resourceGroupName, gatewayName, connectionName, linkConnectionName).getFinalResult();
    }
    ...
    public void resetConnection(String resourceGroupName, String gatewayName, String connectionName,
        ...
        beginResetConnection(resourceGroupName, gatewayName, connectionName, linkConnectionName, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of shared keys for the vpn link connection along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectionSharedKeyResultInner> getAllSharedKeysSinglePage(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ConnectionSharedKeyResultList> res
            = service.getAllSharedKeysSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, accept, Context.NONE);
    ...
    public PagedIterable<ConnectionSharedKeyResultInner> getAllSharedKeys(String resourceGroupName, String gatewayName,
        ...
        return new PagedIterable<>(
            () -> getAllSharedKeysSinglePage(resourceGroupName, gatewayName, connectionName, linkConnectionName),
            nextLink -> getAllSharedKeysNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<ConnectionSharedKeyResultInner> getAllSharedKeys(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, Context context) {
        return new PagedIterable<>(() -> getAllSharedKeysSinglePage(resourceGroupName, gatewayName, connectionName,
            linkConnectionName, context), nextLink -> getAllSharedKeysNextSinglePage(nextLink, context));
    }
    ...
    public Response<ConnectionSharedKeyResultInner> getDefaultSharedKeyWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getDefaultSharedKeySync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return sharedKey Resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> setOrInitDefaultSharedKeyWithResponse(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName,
        ConnectionSharedKeyResultInner connectionSharedKeyParameters) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.setOrInitDefaultSharedKeySync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion,
            connectionSharedKeyParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectionSharedKeyResultInner>, ConnectionSharedKeyResultInner>
        beginSetOrInitDefaultSharedKey(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionSharedKeyResultInner connectionSharedKeyParameters) {
        Response<BinaryData> response = setOrInitDefaultSharedKeyWithResponse(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, connectionSharedKeyParameters);
        return this.client.<ConnectionSharedKeyResultInner, ConnectionSharedKeyResultInner>getLroResult(response,
            ConnectionSharedKeyResultInner.class, ConnectionSharedKeyResultInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ConnectionSharedKeyResultInner>, ConnectionSharedKeyResultInner>
        ...
        Response<BinaryData> response = setOrInitDefaultSharedKeyWithResponse(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, connectionSharedKeyParameters, context);
        return this.client.<ConnectionSharedKeyResultInner, ConnectionSharedKeyResultInner>getLroResult(response,
            ConnectionSharedKeyResultInner.class, ConnectionSharedKeyResultInner.class, context);
    }
    ...
    public ConnectionSharedKeyResultInner setOrInitDefaultSharedKey(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName,
        ConnectionSharedKeyResultInner connectionSharedKeyParameters) {
        return beginSetOrInitDefaultSharedKey(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            connectionSharedKeyParameters).getFinalResult();
    }
    ...
    public ConnectionSharedKeyResultInner setOrInitDefaultSharedKey(String resourceGroupName, String gatewayName,
        ...
        Context context) {
        return beginSetOrInitDefaultSharedKey(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            connectionSharedKeyParameters, context).getFinalResult();
    }
    ...
    public Response<ConnectionSharedKeyResultInner> listDefaultSharedKeyWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.listDefaultSharedKeySync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> getIkeSasWithResponse(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getIkeSasSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<String>, String> beginGetIkeSas(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName) {
        Response<BinaryData> response
            = getIkeSasWithResponse(resourceGroupName, gatewayName, connectionName, linkConnectionName);
    ...
    public SyncPoller<PollResult<String>, String> beginGetIkeSas(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, Context context) {
        Response<BinaryData> response
            = getIkeSasWithResponse(resourceGroupName, gatewayName, connectionName, linkConnectionName, context);
    ...
    public String getIkeSas(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName) {
        return beginGetIkeSas(resourceGroupName, gatewayName, connectionName, linkConnectionName).getFinalResult();
    }
    ...
    public String getIkeSas(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, Context context) {
        return beginGetIkeSas(resourceGroupName, gatewayName, connectionName, linkConnectionName, context)
            .getFinalResult();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnSiteLinkConnectionInner> listByVpnConnectionSinglePage(String resourceGroupName,
        String gatewayName, String connectionName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListVpnSiteLinkConnectionsResult> res
            = service.listByVpnConnectionSync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, apiVersion, accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<VpnSiteLinkConnectionInner> listByVpnConnection(String resourceGroupName, String gatewayName,
        String connectionName) {
        return new PagedIterable<>(() -> listByVpnConnectionSinglePage(resourceGroupName, gatewayName, connectionName),
            nextLink -> listByVpnConnectionNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<VpnSiteLinkConnectionInner> listByVpnConnection(String resourceGroupName, String gatewayName,
        ...
        return new PagedIterable<>(
            () -> listByVpnConnectionSinglePage(resourceGroupName, gatewayName, connectionName, context),
            nextLink -> listByVpnConnectionNextSinglePage(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ConnectionSharedKeyResultInner> getAllSharedKeysNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ConnectionSharedKeyResultList> res
            = service.getAllSharedKeysNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<ConnectionSharedKeyResultInner> getAllSharedKeysNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<ConnectionSharedKeyResultList> res
            = service.getAllSharedKeysNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VpnSiteLinkConnectionInner> listByVpnConnectionNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<ListVpnSiteLinkConnectionsResult> res
            = service.listByVpnConnectionNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<VpnSiteLinkConnectionInner> listByVpnConnectionNextSinglePage(String nextLink,
        ...
        final String accept = "application/json";
        Response<ListVpnSiteLinkConnectionsResult> res
            = service.listByVpnConnectionNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
