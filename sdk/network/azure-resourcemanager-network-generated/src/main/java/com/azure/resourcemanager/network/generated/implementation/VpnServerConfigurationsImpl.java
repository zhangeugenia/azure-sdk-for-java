...
public final class VpnServerConfigurationsImpl implements VpnServerConfigurations {
    ...
    public Response<List<RadiusAuthServer>> listRadiusSecretsWithResponse(String resourceGroupName,
        String vpnServerConfigurationName, Context context) {
        Response<List<RadiusAuthServerInner>> inner = this.serviceClient()
            .listRadiusSecretsWithResponse(resourceGroupName, vpnServerConfigurationName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                inner.getValue()
                    .stream()
    ...
    public List<RadiusAuthServer> listRadiusSecrets(String resourceGroupName, String vpnServerConfigurationName) {
        List<RadiusAuthServerInner> inner
            = this.serviceClient().listRadiusSecrets(resourceGroupName, vpnServerConfigurationName);
        if (inner != null) {
