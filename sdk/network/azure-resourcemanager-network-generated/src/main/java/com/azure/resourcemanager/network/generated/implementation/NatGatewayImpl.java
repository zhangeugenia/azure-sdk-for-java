...
public final class NatGatewayImpl implements NatGateway, NatGateway.Definition, NatGateway.Update {
    ...
    public List<SubResource> publicIpAddressesV6() {
        List<SubResource> inner = this.innerModel().publicIpAddressesV6();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public List<SubResource> publicIpPrefixesV6() {
        List<SubResource> inner = this.innerModel().publicIpPrefixesV6();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public NatGatewayImpl withPublicIpAddressesV6(List<SubResource> publicIpAddressesV6) {
        this.innerModel().withPublicIpAddressesV6(publicIpAddressesV6);
        return this;
    }
    ...
    public NatGatewayImpl withPublicIpPrefixesV6(List<SubResource> publicIpPrefixesV6) {
        this.innerModel().withPublicIpPrefixesV6(publicIpPrefixesV6);
        return this;
    }
