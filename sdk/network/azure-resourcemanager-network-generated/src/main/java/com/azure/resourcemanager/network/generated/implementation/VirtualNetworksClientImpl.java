...
public final class VirtualNetworksClientImpl implements VirtualNetworksClient {
    ...
    public interface VirtualNetworksService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkInner> getByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("$expand") String expand,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkInner> updateTagsSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") TagsObject parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<IpAddressAvailabilityResultInner> checkIpAddressAvailabilitySync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName, @QueryParam("ipAddress") String ipAddress,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListUsageResult> listUsageSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> listDdosProtectionStatusSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName, @QueryParam("top") Integer top,
            @QueryParam("skipToken") String skipToken, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListResult> listAllNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkListUsageResult> listUsageNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualNetworkDdosProtectionStatusResult> listDdosProtectionStatusNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String virtualNetworkName) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, virtualNetworkName, apiVersion,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualNetworkName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualNetworkName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualNetworkName,
        Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualNetworkName, context);
    ...
    public void delete(String resourceGroupName, String virtualNetworkName) {
        beginDelete(resourceGroupName, virtualNetworkName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String virtualNetworkName, Context context) {
        beginDelete(resourceGroupName, virtualNetworkName, context).getFinalResult();
    }
    ...
    public Response<VirtualNetworkInner> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, virtualNetworkName,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualNetworkName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, virtualNetworkName, apiVersion,
    ...
    public SyncPoller<PollResult<VirtualNetworkInner>, VirtualNetworkInner>
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, virtualNetworkName, parameters);
    ...
    public SyncPoller<PollResult<VirtualNetworkInner>, VirtualNetworkInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualNetworkName, parameters, context);
        return this.client.<VirtualNetworkInner, VirtualNetworkInner>getLroResult(response, VirtualNetworkInner.class,
    ...
    public VirtualNetworkInner createOrUpdate(String resourceGroupName, String virtualNetworkName,
        VirtualNetworkInner parameters) {
        return beginCreateOrUpdate(resourceGroupName, virtualNetworkName, parameters).getFinalResult();
    }
    ...
    public VirtualNetworkInner createOrUpdate(String resourceGroupName, String virtualNetworkName,
        VirtualNetworkInner parameters, Context context) {
        return beginCreateOrUpdate(resourceGroupName, virtualNetworkName, parameters, context).getFinalResult();
    }
    ...
    public Response<VirtualNetworkInner> updateTagsWithResponse(String resourceGroupName, String virtualNetworkName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.updateTagsSync(this.client.getEndpoint(), resourceGroupName, virtualNetworkName, apiVersion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all virtual networks in a subscription along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkInner> listSinglePage() {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<VirtualNetworkListResult> res = service.listSync(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), accept, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkInner> listSinglePage(Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<VirtualNetworkListResult> res
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all virtual networks in a resource group along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkInner> listByResourceGroupSinglePage(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<VirtualNetworkListResult> res = service.listByResourceGroupSync(this.client.getEndpoint(),
    ...
    public Response<IpAddressAvailabilityResultInner> checkIpAddressAvailabilityWithResponse(String resourceGroupName,
        ...
        if (ipAddress == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter ipAddress is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.checkIpAddressAvailabilitySync(this.client.getEndpoint(), resourceGroupName, virtualNetworkName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for the virtual networks GetUsage API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkUsageInner> listUsageSinglePage(String resourceGroupName,
        String virtualNetworkName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<VirtualNetworkListUsageResult> res = service.listUsageSync(this.client.getEndpoint(),
            resourceGroupName, virtualNetworkName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    private PagedResponse<VirtualNetworkUsageInner> listUsageSinglePage(String resourceGroupName,
        ...
        final String accept = "application/json";
        Response<VirtualNetworkListUsageResult> res = service.listUsageSync(this.client.getEndpoint(),
            resourceGroupName, virtualNetworkName, apiVersion, this.client.getSubscriptionId(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<VirtualNetworkUsageInner> listUsage(String resourceGroupName, String virtualNetworkName) {
        return new PagedIterable<>(() -> listUsageSinglePage(resourceGroupName, virtualNetworkName),
            nextLink -> listUsageNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<VirtualNetworkUsageInner> listUsage(String resourceGroupName, String virtualNetworkName,
        Context context) {
        return new PagedIterable<>(() -> listUsageSinglePage(resourceGroupName, virtualNetworkName, context),
            nextLink -> listUsageNextSinglePage(nextLink, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Ddos Protection Status of all IP Addresses under the Virtual Network along with
     * {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpDdosProtectionStatusResultInner> listDdosProtectionStatusSinglePage(
        String resourceGroupName, String virtualNetworkName, Integer top, String skipToken) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<BinaryData> res = service.listDdosProtectionStatusSync(this.client.getEndpoint(), resourceGroupName,
            virtualNetworkName, top, skipToken, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
        VirtualNetworkDdosProtectionStatusResult lroPageableResult = this.client
            .<VirtualNetworkDdosProtectionStatusResult, VirtualNetworkDdosProtectionStatusResult>getLroResult(res,
                VirtualNetworkDdosProtectionStatusResult.class, VirtualNetworkDdosProtectionStatusResult.class,
                Context.NONE)
            .getFinalResult();
    ...
    private PagedResponse<PublicIpDdosProtectionStatusResultInner> listDdosProtectionStatusSinglePage(
        ...
        final String accept = "application/json";
        Response<BinaryData> res = service.listDdosProtectionStatusSync(this.client.getEndpoint(), resourceGroupName,
            virtualNetworkName, top, skipToken, apiVersion, this.client.getSubscriptionId(), accept, context);
        VirtualNetworkDdosProtectionStatusResult lroPageableResult = this.client
            .<VirtualNetworkDdosProtectionStatusResult, VirtualNetworkDdosProtectionStatusResult>getLroResult(res,
                VirtualNetworkDdosProtectionStatusResult.class, VirtualNetworkDdosProtectionStatusResult.class, context)
            .getFinalResult();
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
            lroPageableResult.value(), lroPageableResult.nextLink(), null);
    }
    ...
    public PagedIterable<PublicIpDdosProtectionStatusResultInner> listDdosProtectionStatus(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listDdosProtectionStatusSinglePage(resourceGroupName, virtualNetworkName, top, skipToken),
            nextLink -> listDdosProtectionStatusNextSinglePage(nextLink));
    }
    ...
    public PagedIterable<PublicIpDdosProtectionStatusResultInner> listDdosProtectionStatus(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listDdosProtectionStatusSinglePage(resourceGroupName, virtualNetworkName, top, skipToken, context),
            nextLink -> listDdosProtectionStatusNextSinglePage(nextLink, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for the ListVirtualNetworks API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkInner> listAllNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkInner> listAllNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkUsageInner> listUsageNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<VirtualNetworkListUsageResult> res
            = service.listUsageNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualNetworkUsageInner> listUsageNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<VirtualNetworkListUsageResult> res
            = service.listUsageNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for GetVirtualNetworkDdosProtectionStatusOperation along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpDdosProtectionStatusResultInner>
        listDdosProtectionStatusNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<VirtualNetworkDdosProtectionStatusResult> res
            = service.listDdosProtectionStatusNextSync(nextLink, this.client.getEndpoint(), accept, Context.NONE);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<PublicIpDdosProtectionStatusResultInner>
        listDdosProtectionStatusNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        Response<VirtualNetworkDdosProtectionStatusResult> res
            = service.listDdosProtectionStatusNextSync(nextLink, this.client.getEndpoint(), accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
