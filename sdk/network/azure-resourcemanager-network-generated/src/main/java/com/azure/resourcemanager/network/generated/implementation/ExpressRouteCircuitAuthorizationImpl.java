...
public final class ExpressRouteCircuitAuthorizationImpl implements ExpressRouteCircuitAuthorization,
    ...
    public Response<ExpressRouteCircuitAuthorization> getWithResponse(Context context) {
        return serviceManager.expressRouteCircuitAuthorizations()
            .getWithResponse(resourceGroupName, circuitName, authorizationName, context);
    }
    ...
    public ExpressRouteCircuitAuthorization
        createOrUpdate(ExpressRouteCircuitAuthorizationInner authorizationParameters) {
        return serviceManager.expressRouteCircuitAuthorizations()
            .createOrUpdate(resourceGroupName, circuitName, authorizationName, authorizationParameters);
    }

    public ExpressRouteCircuitAuthorization
        createOrUpdate(ExpressRouteCircuitAuthorizationInner authorizationParameters, Context context) {
        return serviceManager.expressRouteCircuitAuthorizations()
