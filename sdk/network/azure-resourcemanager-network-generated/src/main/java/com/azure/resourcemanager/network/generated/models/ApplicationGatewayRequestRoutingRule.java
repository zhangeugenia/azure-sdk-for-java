...
public final class ApplicationGatewayRequestRoutingRule extends SubResource {
    ...
    /**
     * Reads an instance of ApplicationGatewayRequestRoutingRule from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApplicationGatewayRequestRoutingRule if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApplicationGatewayRequestRoutingRule.
     */
    public static ApplicationGatewayRequestRoutingRule fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApplicationGatewayRequestRoutingRule deserializedApplicationGatewayRequestRoutingRule
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedApplicationGatewayRequestRoutingRule.withId(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedApplicationGatewayRequestRoutingRule.innerProperties
                        = ApplicationGatewayRequestRoutingRulePropertiesFormat.fromJson(reader);
                } else if ("name".equals(fieldName)) {
                    deserializedApplicationGatewayRequestRoutingRule.name = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedApplicationGatewayRequestRoutingRule.etag = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedApplicationGatewayRequestRoutingRule.type = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedApplicationGatewayRequestRoutingRule;
        });
    }
}
