...
public final class VirtualApplianceSitesClientImpl implements VirtualApplianceSitesClient {
    ...
    public interface VirtualApplianceSitesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<VirtualApplianceSiteInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkVirtualApplianceName") String networkVirtualApplianceName,
            @PathParam("siteName") String siteName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkVirtualApplianceSiteListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkVirtualApplianceName") String networkVirtualApplianceName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<NetworkVirtualApplianceSiteListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String networkVirtualApplianceName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName, siteName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkVirtualApplianceName,
        String siteName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, networkVirtualApplianceName, siteName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkVirtualApplianceName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, networkVirtualApplianceName, siteName, context);
    ...
    public void delete(String resourceGroupName, String networkVirtualApplianceName, String siteName) {
        beginDelete(resourceGroupName, networkVirtualApplianceName, siteName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String networkVirtualApplianceName, String siteName, Context context) {
        beginDelete(resourceGroupName, networkVirtualApplianceName, siteName, context).getFinalResult();
    }
    ...
    public Response<VirtualApplianceSiteInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName, siteName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName,
            siteName, apiVersion, this.client.getSubscriptionId(), parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualApplianceSiteInner>, VirtualApplianceSiteInner> beginCreateOrUpdate(
        ...
        VirtualApplianceSiteInner parameters) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, networkVirtualApplianceName, siteName, parameters);
        return this.client.<VirtualApplianceSiteInner, VirtualApplianceSiteInner>getLroResult(response,
            VirtualApplianceSiteInner.class, VirtualApplianceSiteInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<VirtualApplianceSiteInner>, VirtualApplianceSiteInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, networkVirtualApplianceName, siteName, parameters, context);
        return this.client.<VirtualApplianceSiteInner, VirtualApplianceSiteInner>getLroResult(response,
            VirtualApplianceSiteInner.class, VirtualApplianceSiteInner.class, context);
    }
    ...
    public VirtualApplianceSiteInner createOrUpdate(String resourceGroupName, String networkVirtualApplianceName,
        ...
        return beginCreateOrUpdate(resourceGroupName, networkVirtualApplianceName, siteName, parameters)
            .getFinalResult();
    }
    ...
    public VirtualApplianceSiteInner createOrUpdate(String resourceGroupName, String networkVirtualApplianceName,
        ...
        return beginCreateOrUpdate(resourceGroupName, networkVirtualApplianceName, siteName, parameters, context)
            .getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListNetworkVirtualApplianceSites API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualApplianceSiteInner> listSinglePage(String resourceGroupName,
        String networkVirtualApplianceName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<NetworkVirtualApplianceSiteListResult> res
            = service.listSync(this.client.getEndpoint(), resourceGroupName, networkVirtualApplianceName, apiVersion,
    ...
    public PagedIterable<VirtualApplianceSiteInner> list(String resourceGroupName, String networkVirtualApplianceName) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, networkVirtualApplianceName),
    ...
    public PagedIterable<VirtualApplianceSiteInner> list(String resourceGroupName, String networkVirtualApplianceName,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(resourceGroupName, networkVirtualApplianceName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualApplianceSiteInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<VirtualApplianceSiteInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VirtualApplianceSitesClientImpl.class);
}
