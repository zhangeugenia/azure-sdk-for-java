...
public final class VpnSitesConfigurationsClientImpl implements VpnSitesConfigurationsClient {
    ...
    public interface VpnSitesConfigurationsService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> downloadSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualWANName") String virtualWanName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") GetVpnSitesConfigurationRequest request,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> downloadWithResponse(String resourceGroupName, String virtualWanName,
        GetVpnSitesConfigurationRequest request) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.downloadSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualWanName, apiVersion, request, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDownload(String resourceGroupName, String virtualWanName,
        GetVpnSitesConfigurationRequest request) {
        Response<BinaryData> response = downloadWithResponse(resourceGroupName, virtualWanName, request);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDownload(String resourceGroupName, String virtualWanName,
        GetVpnSitesConfigurationRequest request, Context context) {
        Response<BinaryData> response = downloadWithResponse(resourceGroupName, virtualWanName, request, context);
    ...
    public void download(String resourceGroupName, String virtualWanName, GetVpnSitesConfigurationRequest request) {
        beginDownload(resourceGroupName, virtualWanName, request).getFinalResult();
    }
    ...
    public void download(String resourceGroupName, String virtualWanName, GetVpnSitesConfigurationRequest request,
        Context context) {
        beginDownload(resourceGroupName, virtualWanName, request, context).getFinalResult();
    }
