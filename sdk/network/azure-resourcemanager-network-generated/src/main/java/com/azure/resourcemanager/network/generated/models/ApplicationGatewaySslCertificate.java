...
public final class ApplicationGatewaySslCertificate extends SubResource {
    ...
    /**
     * Reads an instance of ApplicationGatewaySslCertificate from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApplicationGatewaySslCertificate if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApplicationGatewaySslCertificate.
     */
    public static ApplicationGatewaySslCertificate fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApplicationGatewaySslCertificate deserializedApplicationGatewaySslCertificate
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedApplicationGatewaySslCertificate.withId(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedApplicationGatewaySslCertificate.innerProperties
                        = ApplicationGatewaySslCertificatePropertiesFormat.fromJson(reader);
                } else if ("name".equals(fieldName)) {
                    deserializedApplicationGatewaySslCertificate.name = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedApplicationGatewaySslCertificate.etag = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedApplicationGatewaySslCertificate.type = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedApplicationGatewaySslCertificate;
        });
    }
}
