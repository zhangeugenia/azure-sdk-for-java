...
/**
 * Resource collection API of RoutingRules.
 */
public interface RoutingRules {
     ...
     */
    PagedIterable<RoutingRule> list(String resourceGroupName, String networkManagerName, String configurationName,
     ...
     */
    Response<RoutingRule> getWithResponse(String resourceGroupName, String networkManagerName, String configurationName,
        String ruleCollectionName, String ruleName, Context context);
     ...
     */
    RoutingRule get(String resourceGroupName, String networkManagerName, String configurationName,
     ...
     * @return a network manager routing configuration routing rule along with {@link Response}.
     */
    Response<RoutingRule> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new RoutingRule resource.
     * 
     * @param name resource name.
     * @return the first stage of the new RoutingRule definition.
     */
    RoutingRule.DefinitionStages.Blank define(String name);
}
