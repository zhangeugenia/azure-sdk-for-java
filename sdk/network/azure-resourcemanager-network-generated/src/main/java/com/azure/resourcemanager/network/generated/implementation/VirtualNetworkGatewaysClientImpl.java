...
public final class VirtualNetworkGatewaysClientImpl implements VirtualNetworkGatewaysClient {
    ...
    public interface VirtualNetworkGatewaysService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<RadiusAuthServerInner>>> listRadiusSecrets(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkGatewayName") String virtualNetworkGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return virtual Network Gateway Radius servers with respective radius secret Object along with {@link Response}
     * on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<RadiusAuthServerInner>>> listRadiusSecretsWithResponseAsync(String resourceGroupName,
        String virtualNetworkGatewayName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<Response<List<RadiusAuthServerInner>>> listRadiusSecretsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listRadiusSecrets(this.client.getEndpoint(), resourceGroupName, virtualNetworkGatewayName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return virtual Network Gateway Radius servers with respective radius secret Object on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<RadiusAuthServerInner>> listRadiusSecretsAsync(String resourceGroupName,
        String virtualNetworkGatewayName) {
        return listRadiusSecretsWithResponseAsync(resourceGroupName, virtualNetworkGatewayName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<RadiusAuthServerInner>> listRadiusSecretsWithResponse(String resourceGroupName,
        String virtualNetworkGatewayName, Context context) {
        return listRadiusSecretsWithResponseAsync(resourceGroupName, virtualNetworkGatewayName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return virtual Network Gateway Radius servers with respective radius secret Object.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<RadiusAuthServerInner> listRadiusSecrets(String resourceGroupName, String virtualNetworkGatewayName) {
        return listRadiusSecretsWithResponse(resourceGroupName, virtualNetworkGatewayName, Context.NONE).getValue();
    }
