...
public final class ServiceTagInformationsClientImpl implements ServiceTagInformationsClient {
    ...
    public interface ServiceTagInformationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServiceTagInformationListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("noAddressPrefixes") Boolean noAddressPrefixes, @QueryParam("tagName") String tagName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServiceTagInformationListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of service tag information resources with pagination along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceTagInformationInner> listSinglePage(String location, Boolean noAddressPrefixes,
        String tagName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ServiceTagInformationListResult> res = service.listSync(this.client.getEndpoint(), location,
            apiVersion, this.client.getSubscriptionId(), noAddressPrefixes, tagName, accept, Context.NONE);
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceTagInformationInner> listSinglePage(String location, Boolean noAddressPrefixes,
        String tagName, Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        Response<ServiceTagInformationListResult> res = service.listSync(this.client.getEndpoint(), location,
            apiVersion, this.client.getSubscriptionId(), noAddressPrefixes, tagName, accept, context);
        return new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(),
            res.getValue().nextLink(), null);
    }
    ...
    public PagedIterable<ServiceTagInformationInner> list(String location) {
        final Boolean noAddressPrefixes = null;
        final String tagName = null;
        return new PagedIterable<>(() -> listSinglePage(location, noAddressPrefixes, tagName),
    ...
    public PagedIterable<ServiceTagInformationInner> list(String location, Boolean noAddressPrefixes, String tagName,
        Context context) {
        return new PagedIterable<>(() -> listSinglePage(location, noAddressPrefixes, tagName, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for Get ServiceTagInformation API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceTagInformationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ServiceTagInformationListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceTagInformationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
