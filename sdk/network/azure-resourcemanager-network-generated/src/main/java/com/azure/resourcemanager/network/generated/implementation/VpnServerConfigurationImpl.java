...
public final class VpnServerConfigurationImpl
    ...
    public Response<List<RadiusAuthServer>> listRadiusSecretsWithResponse(Context context) {
        return serviceManager.vpnServerConfigurations()
            .listRadiusSecretsWithResponse(resourceGroupName, vpnServerConfigurationName, context);
    }

    public List<RadiusAuthServer> listRadiusSecrets() {
        return serviceManager.vpnServerConfigurations()
            .listRadiusSecrets(resourceGroupName, vpnServerConfigurationName);
    }
