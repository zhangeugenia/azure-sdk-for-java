...
public final class ApplicationGatewayWafDynamicManifestsDefaultsClientImpl
    ...
    public interface ApplicationGatewayWafDynamicManifestsDefaultsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ApplicationGatewayWafDynamicManifestResultInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<ApplicationGatewayWafDynamicManifestResultInner> getWithResponse(String location, Context context) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), location, apiVersion, this.client.getSubscriptionId(), accept,
            context);
    }
    ...
    private static final ClientLogger LOGGER
        = new ClientLogger(ApplicationGatewayWafDynamicManifestsDefaultsClientImpl.class);
}
