...
public final class VirtualHubIpConfigurationsClientImpl implements VirtualHubIpConfigurationsClient {
    ...
    public interface VirtualHubIpConfigurationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<HubIpConfigurationInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @PathParam("ipConfigName") String ipConfigName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVirtualHubIpConfigurationResults> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListVirtualHubIpConfigurationResults> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    public Response<HubIpConfigurationInner> getWithResponse(String resourceGroupName, String virtualHubName,
        ...
        if (ipConfigName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter ipConfigName is required and cannot be null."));
        }
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, ipConfigName, apiVersion, parameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<HubIpConfigurationInner>, HubIpConfigurationInner> beginCreateOrUpdate(
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, ipConfigName, parameters);
        return this.client.<HubIpConfigurationInner, HubIpConfigurationInner>getLroResult(response,
            HubIpConfigurationInner.class, HubIpConfigurationInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<HubIpConfigurationInner>, HubIpConfigurationInner> beginCreateOrUpdate(
        ...
        Context context) {
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, ipConfigName, parameters, context);
        return this.client.<HubIpConfigurationInner, HubIpConfigurationInner>getLroResult(response,
            HubIpConfigurationInner.class, HubIpConfigurationInner.class, context);
    }
    ...
    public HubIpConfigurationInner createOrUpdate(String resourceGroupName, String virtualHubName, String ipConfigName,
        ...
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, ipConfigName, parameters).getFinalResult();
    }
    ...
    public HubIpConfigurationInner createOrUpdate(String resourceGroupName, String virtualHubName, String ipConfigName,
        ...
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, ipConfigName, parameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, ipConfigName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String ipConfigName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, ipConfigName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String ipConfigName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, ipConfigName, context);
    ...
    public void delete(String resourceGroupName, String virtualHubName, String ipConfigName) {
        beginDelete(resourceGroupName, virtualHubName, ipConfigName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String virtualHubName, String ipConfigName, Context context) {
        beginDelete(resourceGroupName, virtualHubName, ipConfigName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return virtualHubIpConfigurations list along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubIpConfigurationInner> listSinglePage(String resourceGroupName, String virtualHubName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListVirtualHubIpConfigurationResults> res = service.listSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubIpConfigurationInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListVirtualHubIpConfigurationResults> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubIpConfigurationInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
