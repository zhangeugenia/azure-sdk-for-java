...
public final class HubRouteTablesClientImpl implements HubRouteTablesClient {
    ...
    public interface HubRouteTablesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<HubRouteTableInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @PathParam("routeTableName") String routeTableName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListHubRouteTablesResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ListHubRouteTablesResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String virtualHubName,
        ...
        if (routeTableParameters == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter routeTableParameters is required and cannot be null."));
        } else {
            routeTableParameters.validate();
        }
        final String apiVersion = "2024-07-01";
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routeTableName, apiVersion, routeTableParameters, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<HubRouteTableInner>, HubRouteTableInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response
            = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routeTableName, routeTableParameters);
        return this.client.<HubRouteTableInner, HubRouteTableInner>getLroResult(response, HubRouteTableInner.class,
            HubRouteTableInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<HubRouteTableInner>, HubRouteTableInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, virtualHubName, routeTableName,
            routeTableParameters, context);
        return this.client.<HubRouteTableInner, HubRouteTableInner>getLroResult(response, HubRouteTableInner.class,
            HubRouteTableInner.class, context);
    }
    ...
    public HubRouteTableInner createOrUpdate(String resourceGroupName, String virtualHubName, String routeTableName,
        HubRouteTableInner routeTableParameters) {
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routeTableName, routeTableParameters)
            .getFinalResult();
    }
    ...
    public HubRouteTableInner createOrUpdate(String resourceGroupName, String virtualHubName, String routeTableName,
        ...
        return beginCreateOrUpdate(resourceGroupName, virtualHubName, routeTableName, routeTableParameters, context)
            .getFinalResult();
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String virtualHubName,
        ...
        return service.deleteSync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            virtualHubName, routeTableName, apiVersion, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routeTableName) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, routeTableName);
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String virtualHubName,
        String routeTableName, Context context) {
        Response<BinaryData> response = deleteWithResponse(resourceGroupName, virtualHubName, routeTableName, context);
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routeTableName) {
        beginDelete(resourceGroupName, virtualHubName, routeTableName).getFinalResult();
    }
    ...
    public void delete(String resourceGroupName, String virtualHubName, String routeTableName, Context context) {
        beginDelete(resourceGroupName, virtualHubName, routeTableName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of RouteTables and a URL nextLink to get the next set of results along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubRouteTableInner> listSinglePage(String resourceGroupName, String virtualHubName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ListHubRouteTablesResult> res = service.listSync(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubRouteTableInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<ListHubRouteTablesResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<HubRouteTableInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(HubRouteTablesClientImpl.class);
}
