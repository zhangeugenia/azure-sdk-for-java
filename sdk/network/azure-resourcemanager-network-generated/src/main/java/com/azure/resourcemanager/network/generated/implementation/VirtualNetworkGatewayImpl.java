...
public final class VirtualNetworkGatewayImpl
    ...
    public Response<List<RadiusAuthServer>> listRadiusSecretsWithResponse(Context context) {
        return serviceManager.virtualNetworkGateways()
            .listRadiusSecretsWithResponse(resourceGroupName, virtualNetworkGatewayName, context);
    }

    public List<RadiusAuthServer> listRadiusSecrets() {
        return serviceManager.virtualNetworkGateways().listRadiusSecrets(resourceGroupName, virtualNetworkGatewayName);
    }
