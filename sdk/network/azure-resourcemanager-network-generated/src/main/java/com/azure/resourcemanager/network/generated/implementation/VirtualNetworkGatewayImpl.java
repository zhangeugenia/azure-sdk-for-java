...
public final class VirtualNetworkGatewayImpl
    ...
    public VirtualNetworkGatewayMigrationStatus virtualNetworkGatewayMigrationStatus() {
        return this.innerModel().virtualNetworkGatewayMigrationStatus();
    }
    ...
    public void invokePrepareMigration(VirtualNetworkGatewayMigrationParameters migrationParams) {
        serviceManager.virtualNetworkGateways()
            .invokePrepareMigration(resourceGroupName, virtualNetworkGatewayName, migrationParams);
    }

    public void invokePrepareMigration(VirtualNetworkGatewayMigrationParameters migrationParams, Context context) {
        serviceManager.virtualNetworkGateways()
            .invokePrepareMigration(resourceGroupName, virtualNetworkGatewayName, migrationParams, context);
    }

    public void invokeExecuteMigration() {
        serviceManager.virtualNetworkGateways().invokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeExecuteMigration(Context context) {
        serviceManager.virtualNetworkGateways()
            .invokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }

    public void invokeCommitMigration() {
        serviceManager.virtualNetworkGateways().invokeCommitMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeCommitMigration(Context context) {
        serviceManager.virtualNetworkGateways()
            .invokeCommitMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }

    public void invokeAbortMigration() {
        serviceManager.virtualNetworkGateways().invokeAbortMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeAbortMigration(Context context) {
        serviceManager.virtualNetworkGateways()
            .invokeAbortMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }
    ...
    public VirtualNetworkGatewayImpl withVirtualNetworkGatewayMigrationStatus(
        VirtualNetworkGatewayMigrationStatus virtualNetworkGatewayMigrationStatus) {
        this.innerModel().withVirtualNetworkGatewayMigrationStatus(virtualNetworkGatewayMigrationStatus);
        return this;
    }
