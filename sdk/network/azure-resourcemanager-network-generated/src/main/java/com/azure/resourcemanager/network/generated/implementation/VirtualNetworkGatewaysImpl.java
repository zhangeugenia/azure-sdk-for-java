...
public final class VirtualNetworkGatewaysImpl implements VirtualNetworkGateways {
    ...
    public Response<List<RadiusAuthServer>> listRadiusSecretsWithResponse(String resourceGroupName,
        String virtualNetworkGatewayName, Context context) {
        Response<List<RadiusAuthServerInner>> inner
            = this.serviceClient().listRadiusSecretsWithResponse(resourceGroupName, virtualNetworkGatewayName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                inner.getValue()
                    .stream()
                    .map(inner1 -> new RadiusAuthServerImpl(inner1, this.manager()))
    ...
    public List<RadiusAuthServer> listRadiusSecrets(String resourceGroupName, String virtualNetworkGatewayName) {
        List<RadiusAuthServerInner> inner
            = this.serviceClient().listRadiusSecrets(resourceGroupName, virtualNetworkGatewayName);
        if (inner != null) {
