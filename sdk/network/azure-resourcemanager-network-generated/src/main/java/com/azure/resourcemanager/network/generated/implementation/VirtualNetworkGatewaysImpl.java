...
public final class VirtualNetworkGatewaysImpl implements VirtualNetworkGateways {
    ...
    public void invokePrepareMigration(String resourceGroupName, String virtualNetworkGatewayName,
        ...
        this.serviceClient().invokePrepareMigration(resourceGroupName, virtualNetworkGatewayName, migrationParams);
    }
    ...
    public void invokeExecuteMigration(String resourceGroupName, String virtualNetworkGatewayName) {
        this.serviceClient().invokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeExecuteMigration(String resourceGroupName, String virtualNetworkGatewayName, Context context) {
        this.serviceClient().invokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }

    public void invokeCommitMigration(String resourceGroupName, String virtualNetworkGatewayName) {
        this.serviceClient().invokeCommitMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeCommitMigration(String resourceGroupName, String virtualNetworkGatewayName, Context context) {
        this.serviceClient().invokeCommitMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }

    public void invokeAbortMigration(String resourceGroupName, String virtualNetworkGatewayName) {
        this.serviceClient().invokeAbortMigration(resourceGroupName, virtualNetworkGatewayName);
    }

    public void invokeAbortMigration(String resourceGroupName, String virtualNetworkGatewayName, Context context) {
        this.serviceClient().invokeAbortMigration(resourceGroupName, virtualNetworkGatewayName, context);
    }
