...
public interface NetworkVirtualAppliance {
     ...
     * @return specifies a list of virtual machine instance IDs from the Network Virtual Appliance VM instances.
     */
    NetworkVirtualApplianceInstanceIds reimage();
     ...
     * @return the response.
     */
    NetworkVirtualApplianceInstanceId getBootDiagnosticLogs(NetworkVirtualApplianceBootDiagnosticParameters request);
