...
public final class LoadBalancerLoadBalancingRulesClientImpl implements LoadBalancerLoadBalancingRulesClient {
    ...
    public interface LoadBalancerLoadBalancingRulesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerLoadBalancingRuleListResult> listSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancingRuleInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
            @PathParam("loadBalancingRuleName") String loadBalancingRuleName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<BinaryData> healthSync(@HostParam("$host") String endpoint, @PathParam("groupName") String groupName,
            @PathParam("loadBalancerName") String loadBalancerName,
            @PathParam("loadBalancingRuleName") String loadBalancingRuleName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<LoadBalancerLoadBalancingRuleListResult> listNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the load balancing rules in a load balancer along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancingRuleInner> listSinglePage(String resourceGroupName, String loadBalancerName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<LoadBalancerLoadBalancingRuleListResult> res = service.listSync(this.client.getEndpoint(),
    ...
    public Response<LoadBalancingRuleInner> getWithResponse(String resourceGroupName, String loadBalancerName,
        ...
        if (loadBalancingRuleName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter loadBalancingRuleName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, loadBalancerName, loadBalancingRuleName,
            apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return health details of a load balancing rule along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> healthWithResponse(String groupName, String loadBalancerName,
        String loadBalancingRuleName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.healthSync(this.client.getEndpoint(), groupName, loadBalancerName, loadBalancingRuleName,
    ...
    public SyncPoller<PollResult<LoadBalancerHealthPerRuleInner>, LoadBalancerHealthPerRuleInner>
        ...
        Response<BinaryData> response = healthWithResponse(groupName, loadBalancerName, loadBalancingRuleName);
        return this.client.<LoadBalancerHealthPerRuleInner, LoadBalancerHealthPerRuleInner>getLroResult(response,
            LoadBalancerHealthPerRuleInner.class, LoadBalancerHealthPerRuleInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<LoadBalancerHealthPerRuleInner>, LoadBalancerHealthPerRuleInner>
        ...
        Response<BinaryData> response = healthWithResponse(groupName, loadBalancerName, loadBalancingRuleName, context);
        return this.client.<LoadBalancerHealthPerRuleInner, LoadBalancerHealthPerRuleInner>getLroResult(response,
            LoadBalancerHealthPerRuleInner.class, LoadBalancerHealthPerRuleInner.class, context);
    }
    ...
    public LoadBalancerHealthPerRuleInner health(String groupName, String loadBalancerName,
        String loadBalancingRuleName) {
        return beginHealth(groupName, loadBalancerName, loadBalancingRuleName).getFinalResult();
    }
    ...
    public LoadBalancerHealthPerRuleInner health(String groupName, String loadBalancerName,
        String loadBalancingRuleName, Context context) {
        return beginHealth(groupName, loadBalancerName, loadBalancingRuleName, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListLoadBalancingRule API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancingRuleInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
        ...
        final String accept = "application/json";
        Response<LoadBalancerLoadBalancingRuleListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<LoadBalancingRuleInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LoadBalancerLoadBalancingRulesClientImpl.class);
}
