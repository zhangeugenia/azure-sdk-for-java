...
public interface VpnServerConfigurationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<List<RadiusAuthServerInner>> listRadiusSecretsWithResponse(String resourceGroupName,
        String vpnServerConfigurationName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<RadiusAuthServerInner> listRadiusSecrets(String resourceGroupName, String vpnServerConfigurationName);
}
