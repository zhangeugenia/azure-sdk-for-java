...
public final class ServiceEndpointPolicyDefinitionsClientImpl implements ServiceEndpointPolicyDefinitionsClient {
    ...
    public interface ServiceEndpointPolicyDefinitionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServiceEndpointPolicyDefinitionInner> getSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceEndpointPolicyName") String serviceEndpointPolicyName,
            @PathParam("serviceEndpointPolicyDefinitionName") String serviceEndpointPolicyDefinitionName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServiceEndpointPolicyDefinitionListResult> listByResourceGroupSync(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceEndpointPolicyName") String serviceEndpointPolicyName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ServiceEndpointPolicyDefinitionListResult> listByResourceGroupNextSync(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Response<BinaryData> deleteWithResponse(String resourceGroupName, String serviceEndpointPolicyName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.deleteSync(this.client.getEndpoint(), resourceGroupName, serviceEndpointPolicyName,
            serviceEndpointPolicyDefinitionName, apiVersion, this.client.getSubscriptionId(), accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String serviceEndpointPolicyName,
        ...
        Response<BinaryData> response
            = deleteWithResponse(resourceGroupName, serviceEndpointPolicyName, serviceEndpointPolicyDefinitionName);
    ...
    public void delete(String resourceGroupName, String serviceEndpointPolicyName,
        String serviceEndpointPolicyDefinitionName) {
        beginDelete(resourceGroupName, serviceEndpointPolicyName, serviceEndpointPolicyDefinitionName).getFinalResult();
    }
    ...
    public Response<ServiceEndpointPolicyDefinitionInner> getWithResponse(String resourceGroupName,
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        return service.getSync(this.client.getEndpoint(), resourceGroupName, serviceEndpointPolicyName,
            serviceEndpointPolicyDefinitionName, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return service Endpoint policy definitions along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> createOrUpdateWithResponse(String resourceGroupName, String serviceEndpointPolicyName,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), resourceGroupName, serviceEndpointPolicyName,
            ...
            serviceEndpointPolicyDefinitions, accept, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServiceEndpointPolicyDefinitionInner>, ServiceEndpointPolicyDefinitionInner>
        beginCreateOrUpdate(String resourceGroupName, String serviceEndpointPolicyName,
            String serviceEndpointPolicyDefinitionName,
            ServiceEndpointPolicyDefinitionInner serviceEndpointPolicyDefinitions) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, serviceEndpointPolicyName,
            serviceEndpointPolicyDefinitionName, serviceEndpointPolicyDefinitions);
        return this.client.<ServiceEndpointPolicyDefinitionInner, ServiceEndpointPolicyDefinitionInner>getLroResult(
            response, ServiceEndpointPolicyDefinitionInner.class, ServiceEndpointPolicyDefinitionInner.class,
            Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ServiceEndpointPolicyDefinitionInner>, ServiceEndpointPolicyDefinitionInner>
        beginCreateOrUpdate(String resourceGroupName, String serviceEndpointPolicyName,
            ...
            ServiceEndpointPolicyDefinitionInner serviceEndpointPolicyDefinitions, Context context) {
        Response<BinaryData> response = createOrUpdateWithResponse(resourceGroupName, serviceEndpointPolicyName,
            serviceEndpointPolicyDefinitionName, serviceEndpointPolicyDefinitions, context);
        return this.client.<ServiceEndpointPolicyDefinitionInner, ServiceEndpointPolicyDefinitionInner>getLroResult(
            response, ServiceEndpointPolicyDefinitionInner.class, ServiceEndpointPolicyDefinitionInner.class, context);
    }
    ...
    public ServiceEndpointPolicyDefinitionInner createOrUpdate(String resourceGroupName,
        String serviceEndpointPolicyName, String serviceEndpointPolicyDefinitionName,
        ServiceEndpointPolicyDefinitionInner serviceEndpointPolicyDefinitions) {
        return beginCreateOrUpdate(resourceGroupName, serviceEndpointPolicyName, serviceEndpointPolicyDefinitionName,
            serviceEndpointPolicyDefinitions).getFinalResult();
    }
    ...
    public ServiceEndpointPolicyDefinitionInner createOrUpdate(String resourceGroupName,
        ...
        ServiceEndpointPolicyDefinitionInner serviceEndpointPolicyDefinitions, Context context) {
        return beginCreateOrUpdate(resourceGroupName, serviceEndpointPolicyName, serviceEndpointPolicyDefinitionName,
            serviceEndpointPolicyDefinitions, context).getFinalResult();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all service endpoint policy definitions in a service end point policy along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceEndpointPolicyDefinitionInner> listByResourceGroupSinglePage(String resourceGroupName,
        String serviceEndpointPolicyName) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
        ...
        final String apiVersion = "2024-07-01";
        final String accept = "application/json";
        Response<ServiceEndpointPolicyDefinitionListResult> res
            = service.listByResourceGroupSync(this.client.getEndpoint(), resourceGroupName, serviceEndpointPolicyName,
    ...
    public PagedIterable<ServiceEndpointPolicyDefinitionInner> listByResourceGroup(String resourceGroupName,
        String serviceEndpointPolicyName) {
        return new PagedIterable<>(() -> listByResourceGroupSinglePage(resourceGroupName, serviceEndpointPolicyName),
    ...
    public PagedIterable<ServiceEndpointPolicyDefinitionInner> listByResourceGroup(String resourceGroupName,
        ...
        return new PagedIterable<>(
            () -> listByResourceGroupSinglePage(resourceGroupName, serviceEndpointPolicyName, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for ListServiceEndpointPolicyDefinition API service call along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ServiceEndpointPolicyDefinitionInner> listByResourceGroupNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
