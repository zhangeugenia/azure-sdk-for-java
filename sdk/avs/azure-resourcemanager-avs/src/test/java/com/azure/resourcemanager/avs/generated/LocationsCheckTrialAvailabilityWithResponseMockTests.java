...
public final class LocationsCheckTrialAvailabilityWithResponseMockTests {
    ...
    public void testCheckTrialAvailabilityWithResponse() throws Exception {
        String responseStr = "{\"status\":\"TrialUsed\",\"availableHosts\":1575776706}";
        ...
        Trial response = manager.locations()
            .checkTrialAvailabilityWithResponse("whslwkoj",
                new Sku().withName("llndnpd")
                    .withTier(SkuTier.PREMIUM)
                    .withSize("afgfugsnn")
                    .withFamily("yetefyp")
                    .withCapacity(1953030957),
