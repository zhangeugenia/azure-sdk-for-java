...
public final class PlacementPoliciesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"type\":\"PlacementPolicyProperties\",\"state\":\"Enabled\",\"displayName\":\"fxof\",\"provisioningState\":\"Succeeded\"},\"id\":\"gdirazf\",\"name\":\"xejw\",\"type\":\"bmdujtmvcopexc\"}";
        ...
        PlacementPolicy response = manager.placementPolicies()
            .define("eg")
            .withExistingCluster("ctqhamzjrwdk", "zeqyjleziun", "xdfzantkw")
            .withProperties(
                new PlacementPolicyProperties().withState(PlacementPolicyState.ENABLED).withDisplayName("nseqacjjvp"))
            .create();

        Assertions.assertEquals(PlacementPolicyState.ENABLED, response.properties().state());
        Assertions.assertEquals("fxof", response.properties().displayName());
    }
}
