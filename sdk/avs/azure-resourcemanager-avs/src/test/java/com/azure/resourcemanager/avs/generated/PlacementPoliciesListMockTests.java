...
public final class PlacementPoliciesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"type\":\"PlacementPolicyProperties\",\"state\":\"Disabled\",\"displayName\":\"vvf\",\"provisioningState\":\"Deleting\"},\"id\":\"lghktuidvrm\",\"name\":\"zlpdwwex\",\"type\":\"mzvlazipbh\"}]}";
        ...
        PagedIterable<PlacementPolicy> response = manager.placementPolicies()
            .list("rduczkgofxyfs", "uc", "crrpcjttbstvje", com.azure.core.util.Context.NONE);

        Assertions.assertEquals(PlacementPolicyState.DISABLED, response.iterator().next().properties().state());
        Assertions.assertEquals("vvf", response.iterator().next().properties().displayName());
    }
}
