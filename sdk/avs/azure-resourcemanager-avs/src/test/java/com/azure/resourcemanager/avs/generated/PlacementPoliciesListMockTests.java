...
public final class PlacementPoliciesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"type\":\"PlacementPolicyProperties\",\"state\":\"Enabled\",\"displayName\":\"nekhenlusfnrdtj\",\"provisioningState\":\"Updating\"},\"id\":\"dcqtjvidttge\",\"name\":\"uslvyjtcvuwkasi\",\"type\":\"iesfuug\"}]}";
        ...
        PagedIterable<PlacementPolicy> response = manager.placementPolicies()
            .list("szonwpngajinn", "xjawrt", "jfjmyccxlzh", com.azure.core.util.Context.NONE);

        Assertions.assertEquals(PlacementPolicyState.ENABLED, response.iterator().next().properties().state());
        Assertions.assertEquals("nekhenlusfnrdtj", response.iterator().next().properties().displayName());
    }
}
