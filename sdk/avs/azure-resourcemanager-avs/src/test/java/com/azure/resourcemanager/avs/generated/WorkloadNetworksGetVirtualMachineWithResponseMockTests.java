...
public final class WorkloadNetworksGetVirtualMachineWithResponseMockTests {
    ...
    public void testGetVirtualMachineWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Failed\",\"displayName\":\"spofapvuhry\",\"vmType\":\"SERVICE\"},\"id\":\"frzgbzjed\",\"name\":\"st\",\"type\":\"vnlvxbcuiiznktwf\"}";
        ...
        WorkloadNetworkVirtualMachine response = manager.workloadNetworks()
            .getVirtualMachineWithResponse("izvcjfe", "isdju", "ggbqi", "kxkbsazgakgacyr",
                com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("spofapvuhry", response.properties().displayName());
    }
}
