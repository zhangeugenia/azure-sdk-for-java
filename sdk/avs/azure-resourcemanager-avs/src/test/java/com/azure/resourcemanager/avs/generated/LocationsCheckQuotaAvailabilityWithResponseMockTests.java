...
public final class LocationsCheckQuotaAvailabilityWithResponseMockTests {
    ...
    public void testCheckQuotaAvailabilityWithResponse() throws Exception {
        String responseStr
            = "{\"hostsRemaining\":{\"ntkwcegy\":1729459550,\"lbnseqac\":1790694932,\"vpilg\":967864658},\"quotaEnabled\":\"Enabled\"}";
        ...
        Quota response = manager.locations()
            .checkQuotaAvailabilityWithResponse("yjleziunjx", com.azure.core.util.Context.NONE)
            .getValue();
