...
public final class LocationsCheckQuotaAvailabilityWithResponseMockTests {
    ...
    public void testCheckQuotaAvailabilityWithResponse() throws Exception {
        String responseStr
            = "{\"hostsRemaining\":{\"vzuyturmlmu\":1163986546,\"olbauirop\":1311601904},\"quotaEnabled\":\"Disabled\"}";
        ...
        Quota response
            = manager.locations().checkQuotaAvailabilityWithResponse("gt", com.azure.core.util.Context.NONE).getValue();
