...
public final class ClustersListZonesWithResponseMockTests {
    ...
    public void testListZonesWithResponse() throws Exception {
        String responseStr
            = "{\"zones\":[{\"hosts\":[\"pjrtws\",\"hv\"],\"zone\":\"icphvtrrmhw\"},{\"hosts\":[\"dpyflubhv\",\"glrocuy\",\"lw\"],\"zone\":\"memhooclutnpq\"},{\"hosts\":[\"czj\",\"mmyky\"],\"zone\":\"xsglh\"}]}";
        ...
        ClusterZoneList response = manager.clusters()
            .listZonesWithResponse("dfjmzsyzfhotlh", "k", "yych", com.azure.core.util.Context.NONE)
            .getValue();
