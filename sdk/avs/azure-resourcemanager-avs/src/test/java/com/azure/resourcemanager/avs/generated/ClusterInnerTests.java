...
public final class ClusterInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(1288567604, model.properties().clusterSize());
        Assertions.assertEquals("yb", model.properties().hosts().get(0));
        Assertions.assertEquals("qedqytbciqfoufl", model.properties().vsanDatastoreName());
    ...
    public void testSerialize() throws Exception {
        ClusterInner model = new ClusterInner()
            .withProperties(new ClusterProperties().withClusterSize(1288567604)
