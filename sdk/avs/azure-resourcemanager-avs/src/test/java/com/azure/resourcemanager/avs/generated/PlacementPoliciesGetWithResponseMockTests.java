...
public final class PlacementPoliciesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"type\":\"PlacementPolicyProperties\",\"state\":\"Disabled\",\"displayName\":\"gpdohzj\",\"provisioningState\":\"Succeeded\"},\"id\":\"coi\",\"name\":\"e\",\"type\":\"xncnwfe\"}";
        ...
        PlacementPolicy response = manager.placementPolicies()
            .getWithResponse("tuqfecjxeygtu", "xu", "cbuewmrswnjlxuz", "hwpusxj", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(PlacementPolicyState.DISABLED, response.properties().state());
        Assertions.assertEquals("gpdohzj", response.properties().displayName());
    }
}
