...
public final class PlacementPoliciesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"type\":\"PlacementPolicyProperties\",\"state\":\"Disabled\",\"displayName\":\"nbnxwcdomm\",\"provisioningState\":\"Failed\"},\"id\":\"awz\",\"name\":\"gbrt\",\"type\":\"uiaclkiexhajlfn\"}";
        ...
        PlacementPolicy response = manager.placementPolicies()
            .getWithResponse("wvqsgny", "uuzivensrpmeyyvp", "patlbijp", "gsksrfhf", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(PlacementPolicyState.DISABLED, response.properties().state());
        Assertions.assertEquals("nbnxwcdomm", response.properties().displayName());
    }
}
