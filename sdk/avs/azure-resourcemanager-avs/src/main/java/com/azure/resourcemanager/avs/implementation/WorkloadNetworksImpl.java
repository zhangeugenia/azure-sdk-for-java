...
public final class WorkloadNetworksImpl implements WorkloadNetworks {
    ...
    public PagedIterable<WorkloadNetworkDnsService> listDnsService(String resourceGroupName, String privateCloudName,
        String workloadNetworkName) {
        PagedIterable<WorkloadNetworkDnsServiceInner> inner
            = this.serviceClient().listDnsService(resourceGroupName, privateCloudName, workloadNetworkName);
    ...
    public PagedIterable<WorkloadNetworkDnsService> listDnsService(String resourceGroupName, String privateCloudName,
        String workloadNetworkName, Context context) {
        PagedIterable<WorkloadNetworkDnsServiceInner> inner
            = this.serviceClient().listDnsService(resourceGroupName, privateCloudName, workloadNetworkName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new WorkloadNetworkDnsServiceImpl(inner1, this.manager()));
    }
