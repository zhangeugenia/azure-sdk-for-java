...
public final class WorkloadNetworkDnsZoneInner extends ProxyResource {
     ...
     */
    private WorkloadNetworkDnsZoneProperties properties;
     ...
     */
    public WorkloadNetworkDnsZoneInner withProperties(WorkloadNetworkDnsZoneProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedWorkloadNetworkDnsZoneInner.properties
