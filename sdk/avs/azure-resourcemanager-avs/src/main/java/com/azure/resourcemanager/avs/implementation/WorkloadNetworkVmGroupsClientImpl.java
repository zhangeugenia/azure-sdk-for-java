...
public final class WorkloadNetworkVmGroupsClientImpl implements WorkloadNetworkVmGroupsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateCloudName, vmGroupId, contentType, accept, workloadNetworkVMGroup, context);
    }
    ...
    private PollerFlux<PollResult<WorkloadNetworkVMGroupInner>, WorkloadNetworkVMGroupInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup);
    ...
    private PollerFlux<PollResult<WorkloadNetworkVMGroupInner>, WorkloadNetworkVMGroupInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup, context);
        return this.client.<WorkloadNetworkVMGroupInner, WorkloadNetworkVMGroupInner>getLroResult(mono,
            this.client.getHttpPipeline(), WorkloadNetworkVMGroupInner.class, WorkloadNetworkVMGroupInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<WorkloadNetworkVMGroupInner>, WorkloadNetworkVMGroupInner> beginCreate(
        String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupInner workloadNetworkVMGroup) {
        return this.beginCreateAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<WorkloadNetworkVMGroupInner>, WorkloadNetworkVMGroupInner> beginCreate(
        String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupInner workloadNetworkVMGroup, Context context) {
        return this.beginCreateAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup, context)
            .getSyncPoller();
    }
    ...
    private Mono<WorkloadNetworkVMGroupInner> createAsync(String resourceGroupName, String privateCloudName,
        String vmGroupId, WorkloadNetworkVMGroupInner workloadNetworkVMGroup) {
        return beginCreateAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup).last()
    ...
    private Mono<WorkloadNetworkVMGroupInner> createAsync(String resourceGroupName, String privateCloudName,
        String vmGroupId, WorkloadNetworkVMGroupInner workloadNetworkVMGroup, Context context) {
        return beginCreateAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public WorkloadNetworkVMGroupInner create(String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupInner workloadNetworkVMGroup) {
        return createAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup).block();
    }
    ...
    public WorkloadNetworkVMGroupInner create(String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupInner workloadNetworkVMGroup, Context context) {
        return createAsync(resourceGroupName, privateCloudName, vmGroupId, workloadNetworkVMGroup, context).block();
    }
