...
public final class WorkloadNetworkDnsServiceInner extends ProxyResource {
     ...
     */
    private WorkloadNetworkDnsServiceProperties properties;
     ...
     */
    public WorkloadNetworkDnsServiceInner withProperties(WorkloadNetworkDnsServiceProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedWorkloadNetworkDnsServiceInner.properties
