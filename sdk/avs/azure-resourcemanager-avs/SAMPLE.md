...
- [ListDnsService](#workloadnetworks_listdnsservice)
...
public final class IscsiPathsCreateOrUpdateSamples {
    ...
    public static void iscsiPathsCreateOrUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.iscsiPaths()
            ...
            .withProperties(new IscsiPathProperties().withNetworkBlock("192.168.0.0/24"))
            .create();
    }
}
```
...
```java
/**
 * Samples for WorkloadNetworks ListDnsService.
 */
public final class WorkloadNetworksListDnsServiceSamples {
    /*
    ...
    public static void workloadNetworksListDnsServices(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.workloadNetworks().listDnsService("group1", "cloud1", null, com.azure.core.util.Context.NONE);
    }
}
```
...
### WorkloadNetworks_ListDnsService
