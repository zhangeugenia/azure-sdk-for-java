...
public final class ServicesClientImpl implements ServicesClient {
    ...
    public interface ServicesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SupportedServerVersions>> listSupportedServerVersions(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SupportedServerVersionInner>> listSupportedServerVersionsSinglePageAsync(
        String resourceGroupName, String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listSupportedServerVersions(
                            ...
                            accept,
                            context))
            .<PagedResponse<SupportedServerVersionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SupportedServerVersionInner> listSupportedServerVersionsAsync(
        String resourceGroupName, String serviceName) {
        return new PagedFlux<>(
            () -> listSupportedServerVersionsSinglePageAsync(resourceGroupName, serviceName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SupportedServerVersionInner> listSupportedServerVersions(
        String resourceGroupName, String serviceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SupportedServerVersionInner>> listSupportedServerVersionsNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listSupportedServerVersionsNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<SupportedServerVersionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<SupportedServerVersionInner>> listSupportedServerVersionsNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listSupportedServerVersionsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
