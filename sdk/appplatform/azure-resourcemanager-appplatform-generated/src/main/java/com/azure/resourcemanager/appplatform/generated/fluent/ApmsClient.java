...
public interface ApmsClient {
    ...
    Response<ApmResourceInner> getWithResponse(
    ...
    SyncPoller<PollResult<ApmResourceInner>, ApmResourceInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ApmResourceInner createOrUpdate(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApmSecretKeysInner> listSecretKeysWithResponse(
        String resourceGroupName, String serviceName, String apmName, Context context);
