...
public interface PredefinedAcceleratorsClient {
    ...
    PagedIterable<PredefinedAcceleratorResourceInner> list(
    ...
    Response<PredefinedAcceleratorResourceInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PredefinedAcceleratorResourceInner get(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String predefinedAcceleratorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginEnable(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String predefinedAcceleratorName);
