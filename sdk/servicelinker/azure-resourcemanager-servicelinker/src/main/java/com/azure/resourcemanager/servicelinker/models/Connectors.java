...
public interface Connectors {
     ...
     */
    PagedIterable<LinkerResource> list(String resourceGroupName, String location);
     ...
     * @return the list of Linker as paginated response with {@link PagedIterable}.
     */
    PagedIterable<LinkerResource> list(String resourceGroupName, String location, Context context);
     ...
     */
    Response<LinkerResource> getWithResponse(String resourceGroupName, String location, String connectorName,
        Context context);
     ...
     */
    LinkerResource get(String resourceGroupName, String location, String connectorName);
     ...
     * {@link Response}.
     */
    Response<ConfigurationResult> generateConfigurationsWithResponse(String resourceGroupName, String location,
     ...
     */
    ConfigurationResult generateConfigurations(String resourceGroupName, String location, String connectorName);
     ...
     */
    ValidateOperationResult validate(String resourceGroupName, String location, String connectorName);
     ...
     * @return the validation operation result for a Linker.
     */
    ValidateOperationResult validate(String resourceGroupName, String location, String connectorName, Context context);
     ...
     */
    PagedIterable<DryrunResource> listDryrun(String resourceGroupName, String location);
     ...
     * @return the list of dryrun as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DryrunResource> listDryrun(String resourceGroupName, String location, Context context);
     ...
     */
    Response<DryrunResource> getDryrunWithResponse(String resourceGroupName, String location, String dryrunName,
        Context context);
     ...
     * @return a dryrun job.
     */
    DryrunResource getDryrun(String resourceGroupName, String location, String dryrunName);
