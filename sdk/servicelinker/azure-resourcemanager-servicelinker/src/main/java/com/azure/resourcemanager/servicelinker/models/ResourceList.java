...
public final class ResourceList implements JsonSerializable<ResourceList> {
    ...
    /**
     * Get the value property: The LinkerResource items on this page.
     * 
    ...
    /**
     * Set the value property: The LinkerResource items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ResourceList"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ResourceList.class);
