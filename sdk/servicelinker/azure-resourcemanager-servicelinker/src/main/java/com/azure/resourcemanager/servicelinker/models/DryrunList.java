...
public final class DryrunList implements JsonSerializable<DryrunList> {
    ...
    /**
     * Get the value property: The DryrunResource items on this page.
     * 
    ...
    /**
     * Set the value property: The DryrunResource items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model DryrunList"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DryrunList.class);
