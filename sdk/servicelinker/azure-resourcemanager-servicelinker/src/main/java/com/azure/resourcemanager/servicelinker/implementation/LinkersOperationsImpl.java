...
public final class LinkersOperationsImpl implements LinkersOperations {
    ...
    public PagedIterable<DryrunResource> listDryrun(String providers, String resourceUri) {
        PagedIterable<DryrunResourceInner> inner = this.serviceClient().listDryrun(providers, resourceUri);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DryrunResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<DryrunResource> listDryrun(String providers, String resourceUri, Context context) {
        PagedIterable<DryrunResourceInner> inner = this.serviceClient().listDryrun(providers, resourceUri, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DryrunResourceImpl(inner1, this.manager()));
    }

    public Response<DryrunResource> getDryrunWithResponse(String providers, String dryruns, String resourceUri,
        String dryrunName, Context context) {
        Response<DryrunResourceInner> inner
            = this.serviceClient().getDryrunWithResponse(providers, dryruns, resourceUri, dryrunName, context);
        if (inner != null) {
    ...
    public DryrunResource getDryrun(String providers, String dryruns, String resourceUri, String dryrunName) {
        DryrunResourceInner inner = this.serviceClient().getDryrun(providers, dryruns, resourceUri, dryrunName);
        if (inner != null) {
    ...
    public DryrunResource createDryrun(String providers, String dryruns, String resourceUri, String dryrunName,
        DryrunResourceInner parameters) {
        DryrunResourceInner inner
            = this.serviceClient().createDryrun(providers, dryruns, resourceUri, dryrunName, parameters);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DryrunResource createDryrun(String providers, String dryruns, String resourceUri, String dryrunName,
        ...
        DryrunResourceInner inner
            = this.serviceClient().createDryrun(providers, dryruns, resourceUri, dryrunName, parameters, context);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DryrunResource updateDryrun(String providers, String dryruns, String resourceUri, String dryrunName,
        DryrunPatch parameters) {
        DryrunResourceInner inner
            = this.serviceClient().updateDryrun(providers, dryruns, resourceUri, dryrunName, parameters);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DryrunResource updateDryrun(String providers, String dryruns, String resourceUri, String dryrunName,
        ...
        DryrunResourceInner inner
            = this.serviceClient().updateDryrun(providers, dryruns, resourceUri, dryrunName, parameters, context);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Void> deleteDryrunWithResponse(String providers, String dryruns, String resourceUri,
        String dryrunName, Context context) {
        return this.serviceClient().deleteDryrunWithResponse(providers, dryruns, resourceUri, dryrunName, context);
    }

    public void deleteDryrun(String providers, String dryruns, String resourceUri, String dryrunName) {
        this.serviceClient().deleteDryrun(providers, dryruns, resourceUri, dryrunName);
    }

    public Response<ConfigurationResult> generateConfigurationsWithResponse(String providers, String linkers,
        ...
        Response<ConfigurationResultInner> inner = this.serviceClient()
            .generateConfigurationsWithResponse(providers, linkers, resourceUri, linkerName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ConfigurationResult generateConfigurations(String providers, String linkers, String resourceUri,
        String linkerName) {
        ConfigurationResultInner inner
            = this.serviceClient().generateConfigurations(providers, linkers, resourceUri, linkerName);
        if (inner != null) {
