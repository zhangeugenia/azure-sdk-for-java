...
public final class LinkerResourceImpl implements LinkerResource, LinkerResource.Definition, LinkerResource.Update {
    ...
    public LinkerResourceImpl withExistingLocation(String resourceGroupName, String location) {
    ...
    public LinkerResource create() {
        this.innerObject = serviceManager.serviceClient()
            .getConnectors()
            .createOrUpdate(resourceGroupName, location, connectorName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public LinkerResource create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getConnectors()
            .createOrUpdate(resourceGroupName, location, connectorName, this.innerModel(), context);
        return this;
    }
    ...
    public LinkerResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getConnectors()
            .update(resourceGroupName, location, connectorName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public LinkerResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getConnectors()
            .update(resourceGroupName, location, connectorName, updateParameters, context);
        return this;
    }
    ...
    public LinkerResource refresh() {
        this.innerObject = serviceManager.serviceClient()
            .getConnectors()
            .getWithResponse(resourceGroupName, location, connectorName, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ConfigurationResult generateConfigurations() {
        return serviceManager.connectors().generateConfigurations(resourceGroupName, location, connectorName);
    }

    public ValidateOperationResult validate() {
        return serviceManager.connectors().validate(resourceGroupName, location, connectorName);
    }

    public ValidateOperationResult validate(Context context) {
        return serviceManager.connectors().validate(resourceGroupName, location, connectorName, context);
    }
